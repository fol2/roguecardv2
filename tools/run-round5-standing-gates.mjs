...
export const STANDING_GATE_PROFILES = Object.freeze({
  ...
  // Tasks 10+: browser/progression fidelity lives on GitHub check `p2-base`.
  // Local standing residual is Node + wait; p2+ only adds Node-cheap profile extras.
  'p2-base': freezeProfile([CI, NODE, WAIT_P2_BASE]),
  p2: freezeProfile([CI, NODE, WAIT_P2_BASE, REGISTRATIONS, ACT_COUPLING]),
  p3: freezeProfile([CI, NODE, WAIT_P2_BASE, REGISTRATIONS, ACT_COUPLING, PRODUCTION_SURFACE, CONTENT_DISK]),
  p4: freezeProfile([CI, NODE, WAIT_P2_BASE, REGISTRATIONS, ACT_COUPLING, PRODUCTION_SURFACE, CONTENT_DISK, WEBKIT, PERF, BUNDLE]),
  p5: freezeProfile([CI, NODE, WAIT_P2_BASE, REGISTRATIONS, ACT_COUPLING, PRODUCTION_SURFACE, CONTENT_DISK, WEBKIT, PERF, BUNDLE, LEAK]),
  p6: freezeProfile([CI, NODE, WAIT_P2_BASE, REGISTRATIONS, ACT_COUPLING, PRODUCTION_SURFACE, CONTENT_DISK, WEBKIT, PERF, BUNDLE, LEAK, P6_SCREENS]),
  full: freezeProfile([CI, NODE, WAIT_P2_BASE, REGISTRATIONS, ACT_COUPLING, PRODUCTION_SURFACE, CONTENT_DISK, WEBKIT, PERF, BUNDLE, LEAK, P6_SCREENS, VISUAL]),
});
