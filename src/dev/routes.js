...
const ROUTES = Object.freeze([
  // Shell routes (standalone tools, lazy-loaded)
  {
    ...
    group: 'Simulation',
    kind: 'shell',
    load: async () => (await import('./sim-lab.js')).initSimLab,
  ...
  },
  {
    ...
    group: 'Content',
    kind: 'shell',
    load: async () => (await import('./doctor.js')).initDoctor,
  },
  {
    param: 'contentedit',
    ...
    group: 'Content',
    kind: 'shell',
    load: async () => (await import('./content-manager.js')).initContentManager,
  },
  {
    param: 'dev',
    label: 'Dev Hub',
    ...
    kind: 'shell',
    load: async () => (await import('./hub.js')).initDevShell,
  },
  {
    param: 'charedit',
    ...
    group: 'Editors',
    kind: 'shell',
    load: async () => (await import('./char-editor.js')).initCharEditor,
  ...
  },
  {
    ...
    group: 'Editors',
    kind: 'shell',
    load: async () => (await import('./vfx-editor.js')).initVfxEditor,
    exclusiveBoot: true, // boots stage+mesh inside the editor; skips normal boot
  },
