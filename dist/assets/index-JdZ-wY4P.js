...
`;function $p(e,t,n,r){let i=new Da(2,2,_p,vp),a={geo:i,base:i.attributes.position.array.slice(),profile:t,seed:n,el:null,aspect:Jp(r,null)||2/3,sites:[],death:0,glass:null,fire:null,beams:null,bodyPx:null,outline:null,aimOn:!1,ward:null,wardOn:!1,wardGrow:0,wardGrowFrom:0,wardT0:0,wardSites:null,wardSitesUsed:-1,wardAlphaUsed:-1,wardOutline:null,wardOutlineKey:null,wardShapeSeed:null,wardSiteF:1,wardSiteFrom:1,wardSiteTo:1,wardSiteT0:0,wardSitePhase:null},o=qp(e,e=>{a.aspect=Jp(r,e)});a.tex=o;let s=new La({uniforms:{map:{value:o},uFlash:{value:0},uCut:{value:0}},vertexShader:Xp,fragmentShader:Zp,transparent:!0,depthTest:!1,depthWrite:!1});a.mat=s;let c=new Ui(i,s);c.renderOrder=1,Rp.add(c),a.mesh=c;let l=new La({uniforms:{map:{value:o},uColor:{value:new H(`#fff6ec`)},uWidth:{value:.018},uStyle:{value:1},uSpeed:{value:1},uTime:{value:0},uBeams:{value:1},uDashes:{value:2}},vertexShader:Xp,fragmentShader:Qp,transparent:!0,depthTest:!1,depthWrite:!1}),u=new Ui(i,l);return u.visible=!1,u.renderOrder=0,Rp.add(u),a.outline=u,a.aimMat=l,r&&!r.complete&&r.addEventListener(`load`,()=>{a.aspect=Jp(r,o)},{once:!0}),a}function em(e){if(e.bodyPx)return e.bodyPx;let t=e.tex?.image;if(!t?.width)return null;let n=Object.assign(document.createElement(`canvas`),{width:jp,height:jp}).getContext(`2d`);return n.drawImage(t,0,0,jp,jp),e.bodyPx=n.getImageData(0,0,jp,jp).data,e.bodyPx}var tm=(e,t=e.sites)=>(t||[]).map(e=>({x:e.u*jp,y:(1-e.v)*jp}));function nm(e){let t=jp,n=em(e),r=Object.assign(document.createElement(`canvas`),{width:t,height:t}),i=r.getContext(`2d`),a=i.createImageData(t,t),o=tm(e),s=wp*t,c=s*(1-.9*Tp);for(let e=0;e<t;e++)for(let r=0;r<t;r++){let i=(e*t+r)*4,l=0;if(n[i+3]>90){let t=0xe8d4a51000;for(let n of o){let i=r-n.x,a=e-n.y,o=i*i+a*a;o<t&&(t=o)}let n=Math.sqrt(t);l=n<=c?1:n>=s?0:1-(n-c)/(s-c),l=l*l*(3-2*l)}let u=Math.round(255*l);a.data[i]=a.data[i+1]=a.data[i+2]=u,a.data[i+3]=255}return i.putImageData(a,0,0),r}function rm(e){let t=jp,n=Object.assign(document.createElement(`canvas`),{width:t,height:t}),r=n.getContext(`2d`),i=r.createImageData(t,t),a=tm(e);for(let e=0;e<t;e++)for(let n=0;n<t;n++){let r=0xe8d4a51000,o=0xe8d4a51000,s=null,c=null;for(let t of a){let i=n-t.x,a=e-t.y,l=i*i+a*a;l<r?(o=r,c=s,r=l,s=t):l<o&&(o=l,c=t)}let l=0,u=0,d=Math.sqrt(o)-Math.sqrt(r),f=t*.0137;if(c&&d<f){let e=s.x-c.x,t=s.y-c.y,n=Math.hypot(e,t)||1,r=(1-d/f)*.95;l=e/n*r,u=-(t/n)*r}let p=Math.sqrt(Math.max(.05,1-l*l-u*u)),m=(e*t+n)*4;i.data[m]=(l*.5+.5)*255,i.data[m+1]=(u*.5+.5)*255,i.data[m+2]=(p*.5+.5)*255,i.data[m+3]=255}return r.putImageData(i,0,0),n}function im(e){let t=jp,n=em(e),r=Object.assign(document.createElement(`canvas`),{width:t,height:t}),i=r.getContext(`2d`),a=i.createImageData(t,t),o=tm(e);if(o.length>=2){let e=wp*t,r=e*(1-.9*Tp),i=t*.0102,s=t*.0215;for(let c=0;c<t;c++)for(let l=0;l<t;l++){let u=(c*t+l)*4;if(n[u+3]<=90)continue;let d=0xe8d4a51000,f=0xe8d4a51000;for(let e of o){let t=l-e.x,n=c-e.y,r=t*t+n*n;r<d?(f=d,d=r):r<f&&(f=r)}let p=Math.sqrt(d),m=p<=r?1:p>=e?0:1-(p-r)/(e-r);if(m=m*m*(3-2*m),m<=0)continue;let h=Math.sqrt(f)-p,g=Math.max(0,1-h/i),_=Math.max(0,1-h/s)*.2,v=Math.min(1,g+_)*m;v<=.02||(a.data[u]=Math.round(255*v),a.data[u+1]=Math.round(158*v),a.data[u+2]=Math.round(56*v),a.data[u+3]=255)}}return i.putImageData(a,0,0),r}function am(e){let t=im(e),n=Math.round(jp*Ap),r=(n-jp)/2,i=Object.assign(document.createElement(`canvas`),{width:n,height:n}),a=i.getContext(`2d`),o=.5,s=.5;e.sites.length&&(o=e.sites.reduce((e,t)=>e+t.u,0)/e.sites.length,s=1-e.sites.reduce((e,t)=>e+t.v,0)/e.sites.length);let c=r+o*jp,l=r+s*jp;a.globalCompositeOperation=`lighter`;for(let e=1;e<=26;e++){let n=e/26,i=1+n*Op;a.globalAlpha=Math.min(1,.06*Dp*(1-n)**kp),a.setTransform(i,0,0,i,c-c*i,l-l*i),a.drawImage(t,r,r)}return a.setTransform(1,0,0,1,0,0),a.globalAlpha=1,i}function om(e){let t=Math.max(3,Math.round(Number(Mp.sites)||gp.sites));if(e.wardSites?.length&&e.wardSitesN===t)return e.wardSites;let n=[],r=Number.isFinite(e.wardShapeSeed)?e.wardShapeSeed:e.seed||0;for(let e=0;e<t;e++){let i=e/t*Math.PI*2+r*.17,a=.28+cm(r,e+40)*.12;n.push({u:Lm(.5+Math.cos(i)*a),v:Lm(.52+Math.sin(i)*a*.92)})}for(let e=0;e<5;e++){let t=r+e*1.7;n.push({u:Lm(.5+Math.cos(t)*.12),v:Lm(.5+Math.sin(t)*.14)})}return e.wardSites=n,e.wardSitesN=t,e.wardSitesUsed=-1,n}function sm(e,t){let n=om(e),r=e.wardSitePhase?e.wardSiteF??1:Math.max(0,Math.min(1,Number(t)||0));return Math.max(0,Math.round(n.length*r))}function cm(e,t){let n=Math.sin(e*12.9898+t*78.233)*43758.5453;return n-Math.floor(n)}function lm(e){let t=Math.max(5,Math.min(16,Math.round(Number(Mp.shapeVerts)||8))),n=Math.max(0,Math.min(1,Number(Mp.shapeJitter)||0)),r=Number.isFinite(e.wardShapeSeed)?e.wardShapeSeed:e.seed||0,i=`${t}|${n.toFixed(3)}|${r.toFixed(4)}`;if(e.wardOutlineKey===i&&e.wardOutline?.length)return e.wardOutline;let a=[];for(let e=0;e<t;e++){let i=e/t,o=(cm(r,e)-.5)*n*.55,s=i*Math.PI*2+r*.31+o,c=.78+(cm(r,e+17)-.5)*n*.42+.1*Math.sin(e*2.15+r)+.06*Math.cos(e*3.7-r*.7);a.push({x:Math.cos(s)*Math.max(.55,Math.min(1.18,c)),y:Math.sin(s)*Math.max(.55,Math.min(1.18,c))*1.06})}return e.wardOutline=a,e.wardOutlineKey=i,a}function um(e){e.wardShapeSeed=Math.random()*1e4,e.wardOutline=null,e.wardOutlineKey=null,e.wardSites=null,e.wardSitesN=void 0,e.wardSitesUsed=-1,e.wardAlphaUsed=-1}function dm(e,t,n){let r=!1,i=0xe8d4a51000,a=n.length;for(let o=0,s=a-1;o<a;s=o++){let a=n[o],c=n[s];a.y>t!=c.y>t&&e<(c.x-a.x)*(t-a.y)/(c.y-a.y||1e-9)+a.x&&(r=!r);let l=c.x-a.x,u=c.y-a.y,d=e-a.x,f=t-a.y,p=l*l+u*u||1e-9,m=Math.max(0,Math.min(1,(d*l+f*u)/p)),h=d-l*m,g=f-u*m;i=Math.min(i,Math.hypot(h,g))}return r?-i:i}function fm(e,t=1){let n=jp,r=Object.assign(document.createElement(`canvas`),{width:n,height:n}),i=r.getContext(`2d`),a=i.createImageData(n,n),o=n*.5,s=n*.52,c=n*.46,l=n*.48,u=Math.max(0,Math.min(.5,Number(Mp.edgeSoftness)||0)),d=Math.max(0,Math.min(1,Number(Mp.centerDip)||0)),f=Math.max(.05,1-Math.max(0,Math.min(1,Number(Mp.transparency)||0))),p=Math.max(0,Math.min(1,Number(t)||0)),m=lm(e);for(let e=0;e<n;e++)for(let t=0;t<n;t++){let r=(e*n+t)*4,i=(t-o)/c,h=(e-s)/l,g=dm(i,h,m),_;if(u<=.001?_=+(g<=0):g<=-u?_=1:g>=0?_=0:(_=1-(g+u)/u,_=_*_*(3-2*_)),d>0&&_>0){let e=Math.hypot(i/.62,h/.66);e<.55&&(_*=1-d+e/.55*d)}_*=f*p;let v=Math.round(255*Math.max(0,Math.min(1,_)));a.data[r]=a.data[r+1]=a.data[r+2]=v,a.data[r+3]=255}return i.putImageData(a,0,0),r}function pm(e,t){let n=jp,r=Object.assign(document.createElement(`canvas`),{width:n,height:n}),i=r.getContext(`2d`),a=i.createImageData(n,n),o=om(e),s=t==null?o.length:Math.max(0,Math.min(o.length,Math.round(t))),c=tm(e,o.slice(0,s));for(let e=0;e<n;e++)for(let t=0;t<n;t++){let r=0,i=0;if(c.length>=2){let a=0xe8d4a51000,o=0xe8d4a51000,s=null,l=null;for(let n of c){let r=t-n.x,i=e-n.y,c=r*r+i*i;c<a?(o=a,l=s,a=c,s=n):c<o&&(o=c,l=n)}let u=Math.sqrt(o)-Math.sqrt(a),d=n*.016;if(l&&u<d){let e=s.x-l.x,t=s.y-l.y,n=Math.hypot(e,t)||1,a=(1-u/d)*1.05;r=e/n*a,i=-(t/n)*a}}let o=Math.sqrt(Math.max(.05,1-r*r-i*i)),s=(e*n+t)*4;a.data[s]=(r*.5+.5)*255,a.data[s+1]=(i*.5+.5)*255,a.data[s+2]=(o*.5+.5)*255,a.data[s+3]=255}return i.putImageData(a,0,0),r}function mm(e,t){if(!e?.ward?.material)return;let n=sm(e,t);if(n===e.wardSitesUsed)return;e.wardSitesUsed=n;let r=e.ward.material,i=r.normalMap;r.normalMap=ym(pm(e,n)),i?.dispose?.(),r.needsUpdate=!0}function hm(e,t){if(!e?.ward?.material)return;let n=e.wardSitePhase?1:Math.max(0,Math.min(1,Number(t)||0)),r=Math.round(n*20);if(r===e.wardAlphaUsed)return;e.wardAlphaUsed=r;let i=e.ward.material,a=i.alphaMap;i.alphaMap=ym(fm(e,r/20)),a?.dispose?.(),i.needsUpdate=!0}function gm(e,t){if(e?.mat){if(t){e.mat.uniforms.uCut.value===0&&(e.mat.uniforms.uCut.value=.35,e.mat.transparent=!1,e.mat.needsUpdate=!0);return}e.sites.length||e.death>0||(e.mat.uniforms.uCut.value=0,e.mat.transparent=!0,e.mat.needsUpdate=!0)}}function _m(e){vm(),bm(e,`ward`);let t=e.wardGrow||0,n=sm(e,t);e.wardSitesUsed=n,e.wardAlphaUsed=Math.round(Math.max(0,Math.min(1,t))*20);let r=new Ba({color:new H(Mp.tint||gp.tint),transmission:0,ior:Math.max(1,Number(Mp.ior)||1.4),thickness:0,roughness:Math.min(1,Math.max(0,Number(Mp.roughness)||0)),metalness:0,normalMap:ym(pm(e,n)),normalScale:new R(0,0),alphaMap:ym(fm(e,t)),transparent:!0,alphaTest:.01,opacity:Math.max(0,Math.min(1,Number(Mp.opacity)||0)),clearcoat:0,clearcoatRoughness:1,envMapIntensity:0,depthTest:!1,depthWrite:!1}),i=new Ui(new Da(2,2),r);i.visible=!1,i.renderOrder=5,Rp.add(i),e.ward=i}function vm(){if(Wp||!Lp)return;Wp=!0;let e=new ys(Lp);Rp.environment=e.fromScene(new np,.04).texture,Rp.environmentIntensity=.45;let t=new ko(14674687,1.8);t.position.set(-1.4,1.8,2),Rp.add(t),Rp.add(new Ao(2765894,.6))}var ym=(e,t=!1)=>{let n=new va(e);return t&&(n.colorSpace=dt),n};function bm(e,t){let n=e[t];if(n){Rp.remove(n);for(let e of[`map`,`alphaMap`,`normalMap`])n.material[e]?.dispose?.();n.material.dispose(),n.geometry&&n.geometry!==e.geo&&n.geometry.dispose(),e[t]=null,t===`ward`&&(e.wardSitesUsed=-1,e.wardAlphaUsed=-1)}}function xm(e){vm(),bm(e,`glass`);let t=new Ba({transmission:1,ior:1.4,thickness:.12,roughness:.03,metalness:0,normalMap:ym(rm(e)),normalScale:new R(1.3,1.3),alphaMap:ym(nm(e)),transparent:!0,alphaTest:.01,opacity:Ep,clearcoat:.3,clearcoatRoughness:.2,envMapIntensity:.4,depthTest:!1,depthWrite:!1}),n=new Ui(e.geo,t);n.renderOrder=3,Rp.add(n),e.glass=n}function Sm(e){bm(e,`fire`);let t=new ji({map:ym(im(e),!0),transparent:!1,blending:2,depthTest:!1,depthWrite:!1});t.color.setScalar(0);let n=new Ui(e.geo,t);n.renderOrder=2,Rp.add(n),e.fire=n}function Cm(e){bm(e,`beams`);let t=new ji({map:ym(am(e),!0),transparent:!0,blending:2,depthTest:!1,depthWrite:!1,opacity:0}),n=new Ui(new Da(2,2),t);n.renderOrder=4,Rp.add(n),e.beams=n}function wm(e,t){let n=e.geo.attributes.position,r=e.profile;for(let i=0;i<n.count;i++){let a=e.base[i*3],o=e.base[i*3+1],s=(o+1)/2,c=s**+(r.pin??1.6),l=0,u=0;l+=.028*c*r.sway*Math.sin(t*.9+e.seed),l+=.01*c*c*r.sway*Math.sin(t*1.7+1+e.seed*.3);let d=Fp(s,.62,.12);l+=a*.02*d*r.breathe*Math.sin(t*2.2+e.seed*.5),u+=.012*d*r.breathe*Math.sin(t*2.2+e.seed*.5),u+=.014*c*r.bob*Math.sin(t*1.1+.4+e.seed),l+=.012*Math.max(0,(s-.8)/.2)*r.head*Math.sin(t*.7+e.seed),l+=.01*Math.max(0,(.45-s)/.45)*c*r.cloth*Math.sin(s*12-t*2.5+e.seed),n.array[i*3]=a+l*yp,n.array[i*3+1]=o+u*yp}n.needsUpdate=!0}function Tm(e){return[e.outline,e.mesh,e.fire,e.glass,e.beams,e.ward].filter(Boolean)}function Em(e){return[e.mesh,e.fire,e.glass,e.beams].filter(Boolean)}var Dm=()=>{let e=Lp?C(Lp.domElement):{left:0,top:0};return{left:e.left,top:e.top}};function Om(e,t=0,n={left:0,top:0}){let r=t=>{for(let n of Em(e))n.visible=t;e.outline&&(e.outline.visible=t&&!!e.aimOn),e.ward&&(e.ward.visible=t&&!!e.wardOn&&(e.wardGrow||0)>.02)};if(!e.el.isConnected||!(e.el.checkVisibility?.({visibilityProperty:!0})??!0)){r(!1);return}let i=C(e.el);if(i.width<2||i.height<2){r(!1);return}e.aspect=Jp(e.el.querySelector(`.raster-art`),e.tex)||e.aspect||1;let{w:a,h:o}=Yp(i.width,i.height,e.aspect),s=(e.profile.float||0)*Math.sin(t*1.15+e.seed*.7)*12*yp,c=i.left-n.left+i.width/2-Hp/2,l=-(i.top-n.top+i.height-o/2-Up/2)+s,u=(e.flip?-1:1)*a/2,d=o/2;r(!0);let f=Math.round(i.bottom);e.outline&&(e.outline.renderOrder=f*4),Em(e).forEach((e,t)=>{e.renderOrder=f*4+1+t}),e.ward&&(e.ward.renderOrder=f*4+8);let p=0;for(let n of Tm(e)){let r=n===e.ward;n.position.set(c,l,r?p+.5:p);let i=1;if(n===e.beams)i=Ap;else if(r){let r=e.wardGrow||0;i=Number(Mp.pad)||gp.pad,Mp.idleWobble?n.rotation.z=Math.sin(t*1.4+e.seed)*.04:n.rotation.z=0,r>.02&&gm(e,!0),hm(e,r),mm(e,r),Pp(n.material),n.visible=(!!e.wardOn||r>0)&&r>.02}n.scale.set(u*i,d*i,1),p+=.01}}function km(){Hp=_(),Up=v(),Lp.setPixelRatio(Math.min(devicePixelRatio*y(),2)),Lp.setSize(Hp,Up,!1),zp.left=-Hp/2,zp.right=Hp/2,zp.top=Up/2,zp.bottom=-Up/2,zp.updateProjectionMatrix()}function Am(e){if(!Bp.length)return;let t=e*.001,n=Dm();for(let r of Bp){let i=Math.max(80,Number(Mp.growMs)||gp.growMs);if(r.wardSitePhase===`shrink`){let t=i*.45,n=Math.min(1,(e-r.wardSiteT0)/t),a=n*n*(3-2*n);r.wardSiteF=r.wardSiteFrom+(r.wardSiteTo-r.wardSiteFrom)*a,n>=1&&(r.wardSitePhase=`grow`,r.wardSiteFrom=r.wardSiteF,r.wardSiteTo=1,r.wardSiteT0=e)}else if(r.wardSitePhase===`grow`){let t=i*.55,n=Math.min(1,(e-r.wardSiteT0)/t),a=n*n*(3-2*n);r.wardSiteF=r.wardSiteFrom+(r.wardSiteTo-r.wardSiteFrom)*a,n>=1&&(r.wardSiteF=1,r.wardSitePhase=null)}else if(r.wardOn&&r.wardGrow<1){let t=Math.min(1,(e-r.wardT0)/i),n=t*t*(3-2*t);r.wardGrow=r.wardGrowFrom+(1-r.wardGrowFrom)*n,r.wardSiteF=r.wardGrow}else if(!r.wardOn&&r.wardGrow>0){let t=Math.min(1,(e-r.wardT0)/i),n=t*t*(3-2*t);r.wardGrow=r.wardGrowFrom*(1-n),r.wardSiteF=r.wardGrow,r.wardGrow<.02&&(r.wardGrow=0,r.wardSiteF=0,r.wardSitePhase=null,bm(r,`ward`),gm(r,!1))}else r.wardOn&&(r.wardSiteF=1);wm(r,t),Om(r,t,n),r.aimMat&&r.aimOn&&(r.aimMat.uniforms.uTime.value=t)}Lp.render(Rp,zp)}function jm(){let e=document.getElementById(`mesh`);!e||Lp||(Lp=new fu({canvas:e,alpha:!0,antialias:!0,powerPreference:`high-performance`}),Lp.setClearColor(0,0),Lp.toneMapping=4,Lp.toneMappingExposure=1.1,Rp=new sr,zp=new Do(-1,1,1,-1,.1,100),zp.position.z=10,km(),addEventListener(`resize`,km))}function Mm(e){e.el?.classList.remove(`mesh-live`),bm(e,`glass`),bm(e,`fire`),bm(e,`beams`),bm(e,`ward`),e.outline&&(Rp.remove(e.outline),e.aimMat?.dispose(),e.outline=null,e.aimMat=null),Rp.remove(e.mesh),e.geo.dispose(),e.mesh.material.dispose()}function Nm(){cancelAnimationFrame(Vp),Vp=0;for(let e of Bp)Mm(e);Bp=[],document.documentElement.classList.remove(`mesh-on`),Lp?.render(Rp,zp)}function Pm(e){let t=Bp.findIndex(t=>t.el===e||t.el&&e.contains&&e.contains(t.el));t<0||(Mm(Bp[t]),Bp.splice(t,1),Bp.length||document.documentElement.classList.remove(`mesh-on`),Lp?.render(Rp,zp))}function Fm(e,t=160){let n=Rm(e);n&&(n.mat.uniforms.uFlash.value=.9,setTimeout(()=>{n.mat&&(n.mat.uniforms.uFlash.value=0)},t))}var Im=56,Lm=e=>Math.max(.05,Math.min(.95,e));function Rm(e){return Bp.find(t=>t.el===e||e.contains&&e.contains(t.el))}function zm(e,t=.32+Math.random()*.36,n=.3+Math.random()*.4){if(Sp)return!1;let r=Rm(e);if(!r||!em(r))return!1;let i=5+(Math.random()*3|0);for(let e=0;e<i;e++){let e=Math.random()*Math.PI*2,i=Math.random()*.052;if(r.sites.length>=Im)break;r.sites.push({u:Lm(t+Math.cos(e)*i),v:Lm(n+Math.sin(e)*i)})}return gm(r,!0),xm(r),r.death>0&&Sm(r),!0}function Bm(e,t){if(Sp)return!1;let n=Rm(e);return n?(t>0&&!n.fire&&(Sm(n),Cm(n)),n.death=t,n.fire&&n.fire.material.color.setScalar(t),n.beams&&(n.beams.material.opacity=Math.min(1,Math.max(0,t*1.35-.35))),!0):!1}function Vm(e){let t=Rm(e);return t?t.sites.map(e=>({u:e.u,v:e.v})):[]}function Hm(e){let t=Rm(e);if(!t||!Lp||Sp)return null;let n=performance.now()*.001,r=Dm(),i=new Set(Tm(t)),a=[];Rp.traverse(e=>{e.isMesh&&(a.push([e,e.visible]),e.visible=i.has(e)&&e!==t.beams)}),wm(t,n),Om(t,n,r),t.beams&&(t.beams.visible=!1),Lp.render(Rp,zp);for(let[e,t]of a)e.visible=t;let o=C(t.el),{w:s,h:c}=Yp(o.width,o.height,t.aspect),l=Lp.getPixelRatio(),u=(o.left-r.left+o.width/2-s/2)*l,d=(o.top-r.top+o.height-c)*l,f=Math.max(1,Math.round(s*l)),p=Math.max(1,Math.round(c*l)),m=document.createElement(`canvas`);m.width=f,m.height=p,m.getContext(`2d`).drawImage(Lp.domElement,u,d,f,p,0,0,f,p);let h=Vm(e),g={left:o.left,top:o.top,width:o.width,height:o.height},_=t.beams;if(_){t.beams=null;let e=performance.now(),n=_.material.opacity,r=t=>{let i=Math.min(1,(t-e)/200);_.material.opacity=n*(1-i),i<1?(Bp.length||Lp?.render(Rp,zp),requestAnimationFrame(r)):(Rp.remove(_),_.material.map?.dispose(),_.material.dispose(),Lp?.render(Rp,zp))};requestAnimationFrame(r)}return Pm(e),{capture:m.toDataURL(`image/png`),sites:h,rect:g}}function Um(e,t){let n=Ip[e]||Ip.humanoid,r=t?pp(t):{};return Object.keys(r).length?{...n,...r}:n}function Wm(e){if(Nm(),!Cp()||(Lp||jm(),!Lp))return;for(let{el:t,url:n,kind:r,id:i,flip:a}of e){if(!n||!t)continue;let e=t.querySelector(`.raster-art`);if(!e)continue;t.classList.add(`mesh-live`);let o=Um(r,i),s=$p(n,o,Math.random()*10,e);s.el=t,s.flip=!!a,s.profile=o,Bp.push(s)}if(!Bp.length)return;document.documentElement.classList.add(`mesh-on`);let t=e=>{Vp=requestAnimationFrame(t),Am(e)};Vp=requestAnimationFrame(t)}function Gm(e){let t=Rm(e);if(!t)return 0;let n=performance.now()*.001;return Math.max(0,(t.profile.float||0)*Math.sin(n*1.15+t.seed*.7)*12*yp)}function Km(e,t,n=null){let r=Rm(e);if(!r?.outline)return!1;if(r.aimOn=!!t,r.outline.visible=!!t,t&&r.aimMat&&n){let e=n.style===`chase`?2:n.style===`solid`?0:1;r.aimMat.uniforms.uStyle.value=e,r.aimMat.uniforms.uSpeed.value=Number.isFinite(n.speed)?n.speed:1,r.aimMat.uniforms.uColor.value.set(n.color||`#fff6ec`);let t=Number.isFinite(n.width)?n.width:.018;r.aimMat.uniforms.uWidth.value=Math.min(.06,Math.max(.006,t));let i=Number.isInteger(n.beams)?n.beams:1,a=Number.isInteger(n.dashes)?n.dashes:2;r.aimMat.uniforms.uBeams.value=Math.min(4,Math.max(1,i)),r.aimMat.uniforms.uDashes.value=Math.min(4,Math.max(1,a))}return!0}function qm(e,t,{grow:n=!0}={}){if(Sp||!Cp())return!1;let r=Rm(e);return r?t?r.wardOn&&r.ward?n?(r.wardGrow=1,r.wardGrowFrom=1,r.wardSitePhase=`shrink`,r.wardSiteFrom=r.wardSiteF??1,r.wardSiteTo=.12,r.wardSiteT0=performance.now(),r.wardSitesUsed=-1,!0):!0:(um(r),_m(r),r.wardOn=!0,r.wardSitePhase=null,r.wardT0=performance.now(),n?(r.wardGrow=0,r.wardGrowFrom=0,r.wardSiteF=0,r.wardSitesUsed=-1,r.wardAlphaUsed=-1):(r.wardGrow=1,r.wardGrowFrom=1,r.wardSiteF=1,r.wardAlphaUsed=-1),!0):r.wardOn?(r.wardOn=!1,r.wardSitePhase=null,r.wardGrowFrom=r.wardGrow||0,r.wardT0=performance.now(),!0):!0:!1}function Jm(){for(let e of Bp)e.aimOn=!1,e.outline&&(e.outline.visible=!1)}var Ym=()=>({enabled:Cp(),planes:Bp.length,renderer:!!Lp,looping:!!Vp,intensity:yp,sites:Bp.reduce((e,t)=>Math.max(e,t.sites.length),0),death:Bp.reduce((e,t)=>Math.max(e,t.death),0),glass:Bp.filter(e=>e.glass).length}),Xm=t({MAP_COLS:()=>7,MAP_ROWS:()=>15,addCardToDeck:()=>Sg,addStatus:()=>Uh,applyEventOps:()=>Ng,applyNodeEventChoice:()=>Ah,availableNodes:()=>uh,canKindle:()=>$h,canPlay:()=>ug,canUseArt:()=>Xh,cardData:()=>sh,cardPool:()=>hh,claimBossRelic:()=>jh,claimMonument:()=>fh,claimTreasure:()=>kh,clamp:()=>eh,clearSave:()=>Ag,drawCards:()=>og,duplicateCardInDeck:()=>Tg,effCost:()=>lg,endTurn:()=>hg,enemyMove:()=>Gh,finalizeNodeEventChoice:()=>Oh,gainEmbers:()=>Kh,gainPotion:()=>Mh,gainRelic:()=>vh,genCombatRewards:()=>Fh,genMap:()=>lh,genShop:()=>Lh,hasRelic:()=>ph,healPlayer:()=>_h,kindleFromHand:()=>tg,loadRun:()=>kg,loadStats:()=>jg,makeCard:()=>oh,makeRng:()=>Zm,newRun:()=>th,nodeEventInFlight:()=>Dh,nodeRewardClaimed:()=>Eh,omenMods:()=>ih,playCard:()=>dg,previewAttack:()=>vg,previewBlock:()=>yg,previewEnemyDmg:()=>bg,previewPlay:()=>xg,randomRelic:()=>yh,recordRunEnd:()=>Mg,relicPool:()=>gh,removeCardFromDeck:()=>Cg,restHealFrac:()=>ah,rollBossRelics:()=>Ih,rollCardReward:()=>Nh,rollEncounter:()=>zh,rollEvent:()=>Rh,rollEventCards:()=>Ph,rollOmen:()=>rh,runRevealed:()=>mh,runRng:()=>ch,saveRun:()=>Og,startCombat:()=>Bh,upgradeCardInDeck:()=>wg,useArt:()=>Zh,usePotion:()=>mg,visitNode:()=>dh,vowMods:()=>nh});function Zm(e){let t=()=>{e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296};return t.getState=()=>e,t}var Qm=(e,t)=>t[Math.floor(e()*t.length)],$m=(e,[t,n])=>t+Math.floor(e()*(n-t+1)),eh=(e,t,n)=>Math.max(t,Math.min(n,e));function th(e=Math.random()*2**31|0,t={}){let n=eh(t.aspect||0,0,qu.length-1),r=qu[n],i={v:2,seed:e,rngState:e,uid:1,act:0,nodeId:null,floorsClimbed:0,bossRelicAct:-1,orphanRewardClaimed:!1,orphanRewardResolving:!1,aspect:n,vow:eh(t.vow||0,0,Ju.length),art:t.art||r.art||`flare`,omens:[],boon:t.boon||null,unlocks:[...t.unlocks||[]],reveals:t.reveals?[...t.reveals]:null,monument:t.monument?{...t.monument,claimed:!1}:null,player:{hp:r.maxHp,maxHp:r.maxHp,gold:r.startGold,energyMax:r.energy,relics:[r.startRelic],potions:Array(r.potionSlots||3).fill(null),deck:[]},stats:{slain:0,elites:0,bosses:0,dmgDealt:0,dmgTaken:0,cardsPlayed:0,goldEarned:0,shatters:0,kindles:0,perfects:0,smolderKills:0,unlitVisited:0,embersSpent:0,start:Date.now()},map:null};t.lamplighter&&(i.pendingLamplighter=!0);for(let e of r.startDeck)i.player.deck.push(oh(i,e));return nh(i).startHex&&i.player.deck.push(oh(i,`hex`)),i.omens.push(mh(i,`omens`)?rh(i):null),i.map=lh(i),i}function nh(e){let t={hpMult:1,enemyDmgBonus:0,bossFacetDelta:0,startHex:!1},n=eh(e.vow||0,0,Ju.length);for(let e=0;e<n;e++){let n=Ju[e].mods;n.hpMult&&(t.hpMult*=n.hpMult),n.enemyDmgBonus&&(t.enemyDmgBonus+=n.enemyDmgBonus),n.bossFacetDelta&&(t.bossFacetDelta+=n.bossFacetDelta),n.startHex&&(t.startHex=!0),n.restHealFrac!=null&&(t.restHealFrac=Math.min(t.restHealFrac??1,n.restHealFrac))}return t}function rh(e){return Qm(ch(e),Object.keys(Bu))}function ih(e){return Bu[e.omens?.[e.act]]?.mods||{}}function ah(e){return Math.min(.3,ih(e).restHealFrac??.3,nh(e).restHealFrac??.3)}function oh(e,t,n=!1){return{uid:e.uid++,id:t,up:n,bonus:0}}function sh(e){let t=ku[e.id];return e.up&&t.up?{...t,...t.up,name:t.name+`+`}:t}function ch(e){let t=Zm(e.rngState);return()=>{let n=t();return e.rngState=t.getState(),n}}function lh(e){let t=ch(e),n={},r=(e,t)=>`${e},${t}`,i=(e,i)=>(n[r(e,i)]||(n[r(e,i)]={id:r(e,i),row:e,col:i,type:`monster`,next:[],jx:(t()-.5)*.5,jy:(t()-.5)*.4}),n[r(e,i)]),a=new Set;for(let e=0;e<6;e++){let n;do n=Math.floor(t()*7);while(e<2&&a.has(n));a.add(n);let r=i(0,n);for(let e=1;e<14;e++){let n=eh(r.col+(Math.floor(t()*3)-1),0,6),a=i(e,n);r.next.includes(a.id)||r.next.push(a.id),r=a}let o=i(14,3);r.next.includes(o.id)||r.next.push(o.id)}let o=Object.values(n),s=!1;for(let e of o){if(e.row===0)e.type=`monster`;else if(e.row===14)e.type=`boss`;else if(e.row===13)e.type=`rest`;else if(e.row===8)e.type=`treasure`;else{let n=t();n<.46?e.type=`monster`:n<.68?e.type=`event`:n<.81&&e.row>=5?e.type=`elite`:n<.91&&e.row>=4&&e.row<12?e.type=`rest`:e.row>=4?e.type=`shop`:e.type=`monster`}e.type===`shop`&&(s=!0)}if(!s){let e=o.filter(e=>e.type===`monster`&&e.row>=5&&e.row<=11);e.length&&(Qm(t,e).type=`shop`)}for(let n of o)n.row===0||n.row===8||n.row>=13||t()<.15&&(n.unlit=!0,n.bounty=$m(t,[12,22])+e.act*6);if(e.monument&&!e.monument.claimed&&e.monument.act===e.act){let t=eh(e.monument.row||5,1,12),n=o.filter(e=>e.type===`shop`).length===1,r=o.filter(e=>e.row>0&&e.row<13&&e.row!==8&&e.type!==`boss`&&!(n&&e.type===`shop`));if(r.length){let e=r.reduce((e,n)=>Math.abs(n.row-t)<Math.abs(e.row-t)?n:e);e.type=`monument`,delete e.unlit,delete e.bounty}}return{nodes:o,visited:[]}}function uh(e){let{nodes:t,visited:n}=e.map;if(!e.nodeId)return t.filter(e=>e.row===0);let r=t.find(t=>t.id===e.nodeId);return t.filter(e=>r.next.includes(e.id))}function dh(e,t){e.nodeId=t.id,e.orphanRewardClaimed&&=(t.rewardClaimed=!0,!1),e.orphanRewardResolving&&=(t.rewardResolving=!0,!1),e.floorsClimbed=t.row+1,e.map.visited.includes(t.id)||e.map.visited.push(t.id);let n=0;return t.unlit&&(delete t.unlit,n=(t.bounty||0)*(ph(e,`thiefOfWicks`)?2:1),delete t.bounty,e.player.gold+=n,e.stats.goldEarned+=n,e.stats.unlitVisited++),{type:t.type,bounty:n}}function fh(e){let t=e.monument;if(!t||t.claimed||!t.bequest)return null;t.claimed=!0;let n=t.bequest;return n.kind===`card`?Sg(e,n.id,n.up):n.kind===`relic`?vh(e,n.id):n.kind===`gold`&&(e.player.gold+=n.amount,e.stats.goldEarned+=n.amount),n}var ph=(e,t)=>e.player.relics.includes(t),mh=(e,t)=>e.reveals==null||e.reveals.includes(t);function hh(e,t){let n=(e.unlocks||[]).filter(e=>e.startsWith(`card:`)).map(e=>e.slice(5)).filter(e=>ku[e]&&ku[e].rarity===t),r=Au[t];return e.reveals!=null&&(r=r.filter(t=>!Ku.cards[t]||e.reveals.includes(Ku.cards[t]))),n.length?[...r,...n]:r}function gh(e,t){let n=(e.unlocks||[]).filter(e=>e.startsWith(`relic:`)).map(e=>e.slice(6)).filter(e=>Mu[e]&&Mu[e].rarity===t),r=Nu[t];return e.reveals!=null&&(r=r.filter(t=>!Ku.relics[t]||e.reveals.includes(Ku.relics[t]))),n.length?[...r,...n]:r}function _h(e,t,n=null){ph(e,`sunBlossom`)&&(t=Math.round(t*1.5));let r=n?n.player:e.player,i=r.hp;r.hp=eh(r.hp+t,0,r.maxHp);let a=r.hp-i;return n&&a>0&&n.queue.push({t:`heal`,who:`player`,n:a}),a}function vh(e,t,n=null){let r=Mu[t];if(r){if(r.replaces){let t=e.player.relics.indexOf(r.replaces);t>=0&&e.player.relics.splice(t,1)}e.player.relics.push(t),t===`sweetRoot`&&(e.player.maxHp+=8,e.player.hp+=8),t===`hollowCrown`&&(e.player.energyMax+=1,e.player.maxHp=Math.max(1,e.player.maxHp-10),e.player.hp=Math.min(e.player.hp,e.player.maxHp))}}function yh(e,t={common:.5,uncommon:.35,rare:.15}){let n=ch(e),r=new Set(e.player.relics),i=[`common`,`uncommon`,`rare`],a=n(),o=`common`,s=0;for(let e of i)if(s+=t[e]||0,a<s){o=e;break}let c=i.indexOf(o);for(let t=0;t<i.length;t++){let a=i[(c+t)%i.length],o=gh(e,a).filter(e=>!r.has(e));if(o.length)return Qm(n,o)}return null}function bh(e){return!e.nodeId||!e.map?.nodes?null:e.map.nodes.find(t=>t.id===e.nodeId)||null}function xh(e){let t=bh(e);return t?!!t.rewardClaimed:!!e.orphanRewardClaimed}function Sh(e){let t=bh(e);return t?!!t.rewardResolving:!!e.orphanRewardResolving}function Ch(e){return xh(e)||Sh(e)}function wh(e){let t=bh(e);t?t.rewardResolving=!0:e.orphanRewardResolving=!0}function Th(e){let t=bh(e);t?(t.rewardClaimed=!0,delete t.rewardResolving):(e.orphanRewardClaimed=!0,e.orphanRewardResolving=!1)}function Eh(e){return xh(e)}function Dh(e){return Sh(e)}function Oh(e){Th(e)}function kh(e,t={common:.55,uncommon:.35,rare:.1}){if(xh(e))return{already:!0,relicId:null,gold:0};let n=yh(e,t);return n?vh(e,n):e.player.gold+=60,Th(e),{already:!1,relicId:n,gold:n?0:60}}function Ah(e,t,n=ch(e)){if(Ch(e))return{pending:[],log:[],already:!0};let{pending:r,log:i}=Ng(e,t,n);return wh(e),{pending:r,log:i,already:!1}}function jh(e,t){return e.bossRelicAct===e.act?{already:!0,id:null}:(e.bossRelicAct=e.act,t&&vh(e,t),{already:!1,id:t||null})}function Mh(e,t){if(!mh(e,`phials`))return!1;t===`random`&&(t=Qm(ch(e),Object.keys(Pu)));let n=e.player.potions.indexOf(null);return n<0?!1:(e.player.potions[n]=t,!0)}function Nh(e,t=`normal`){let n=ch(e),r=3+ +!!ph(e,`seersOrb`)+(ih(e).rewardChoiceBonus||0),i=[],a=new Set;for(;i.length<r&&a.size<40;){let r;if(t===`boss`)r=`rare`;else{let e=n();r=t===`elite`?e<.45?`common`:e<.85?`uncommon`:`rare`:e<.6?`common`:e<.92?`uncommon`:`rare`}let o=Qm(n,hh(e,r));a.add(o+Math.floor(n()*4)),i.includes(o)||i.push(o)}return i}function Ph(e,t){let n=ch(e),r=[...hh(e,`common`),...hh(e,`common`),...hh(e,`uncommon`),...hh(e,`uncommon`),...hh(e,`rare`)],i=[],a=0;for(;i.length<t&&a++<60;){let e=r[Math.floor(n()*r.length)];i.includes(e)||i.push(e)}return i}function Fh(e,t,n=null){let r=ch(e),i=$m(r,Ru[e.act][t===`boss`?`boss`:t===`elite`?`elite`:`normal`]);i=Math.round(i*(ih(e).goldMult||1)*(Vu[n]?.mods.goldMult||1));let a={gold:i,cards:Nh(e,t),potion:null,relic:null};return t!==`boss`&&r()<.4&&mh(e,`phials`)&&(a.potion=Qm(r,Object.keys(Pu))),t===`elite`&&(a.relic=yh(e)),a}function Ih(e){let t=ch(e),n=new Set(e.player.relics),r=gh(e,`boss`).filter(e=>!n.has(e)),i=[];for(;i.length<Math.min(3,r.length);){let e=Qm(t,r);i.includes(e)||i.push(e)}return i}function Lh(e){let t=ch(e),n=([e,n],r)=>Math.round($m(t,[e,n])*r),r=(ph(e,`merchantsMark`)?.75:1)*(ih(e).shopMult||1),i=[];for(let a of[`common`,`common`,`uncommon`,`uncommon`,`rare`]){let o,s=0;do o=Qm(t,hh(e,a));while(i.some(e=>e.id===o)&&++s<20);i.push({id:o,price:n(zu.cardPrice[a],r),sold:!1})}let a=new Set(e.player.relics),o=[];for(let i of[`common`,`uncommon`]){let s=gh(e,i).filter(e=>!a.has(e)&&!o.some(t=>t.id===e));s.length&&o.push({id:Qm(t,s),price:n(zu.relicPrice[i],r),sold:!1})}let s=[];if(mh(e,`phials`))for(let e=0;e<2;e++)s.push({id:Qm(t,Object.keys(Pu)),price:n(zu.potionPrice,r),sold:!1});return{cards:i,relics:o,potions:s,removeCost:Math.round(zu.removeCost*r),removed:!1}}function Rh(e){let t=ch(e),n=e.seenEvents||=[],r=Object.keys(Lu).filter(e=>!n.includes(e));r.length||(e.seenEvents=[],r=Object.keys(Lu));let i=Qm(t,r);return n.push(i),i}function zh(e,t,n){let r=ch(e),i=Iu[e.act],a=t===`boss`?i.boss:t===`elite`?i.elite:n<3?i.weak:i.normal,o=e.lastEnc,s,c=0;do s=Qm(r,a);while(a.length>1&&s.join()===o&&++c<8);return e.lastEnc=s.join(),s}function Bh(e,t,n=`normal`,r={}){let i=ch(e),a=ih(e),o=nh(e),s=n===`elite`?r.affix||Qm(i,Object.keys(Vu)):null,c=s?Vu[s].mods:{},l={kind:n,affix:s,turn:0,over:!1,result:null,queue:[],player:{hp:e.player.hp,maxHp:e.player.maxHp,block:0,energy:0,energyMax:e.player.energyMax,statuses:{}},enemies:t.map((e,t)=>{let n=Fu[e];return{key:e,idx:t,name:n.name,maxHp:Math.round($m(i,n.hp)*(a.hpMult||1)*(c.hpMult||1)*(o.hpMult||1)),block:c.startBlock||0,statuses:{...n.startStatus||{}},flags:c.adamant?{adamant:!0}:{},lastMoves:[],moveKey:null,elite:!!n.elite,boss:!!n.boss,facetMax:Math.max(2,(n.facets??(n.boss?6:n.elite?5:4))+(a.facetDelta||0)+(c.facetDelta||0)+(n.boss&&o.bossFacetDelta||0)),chips:0}}),draw:[],hand:[],discard:[],exhaust:[],embers:0,emberCap:9,artUsedTurn:0,kindledTurn:0,kindlesThisTurn:0,pendingChips:null,counters:{played:0,attacks:0,firstCardPlayed:!1,hpLost:0}};l.enemies.forEach(e=>e.hp=e.maxHp);for(let e of l.enemies)for(let[t,n]of Object.entries({...a.enemyStartStatus||{},...c.startStatus||{}}))e.statuses[t]=(e.statuses[t]||0)+n;a.startEmbers&&(l.embers=eh(a.startEmbers,0,l.emberCap)),l.draw=e.player.deck.map(e=>({...e,bonus:0})),Vh(i,l.draw);let u=l.player;return ph(e,`basaltIdol`)&&(u.block+=10,Hh(l,`basaltIdol`)),ph(e,`warFetish`)&&(Uh(l,u,`str`,1),Hh(l,`warFetish`)),ph(e,`riverPearl`)&&(Uh(l,u,`dex`,1),Hh(l,`riverPearl`)),ph(e,`thornBand`)&&(Uh(l,u,`thorns`,2),Hh(l,`thornBand`)),ph(e,`vialOfLife`)&&(_h(e,2,l),Hh(l,`vialOfLife`)),ph(e,`crownOfCinders`)&&(l.emberCap=12,l.embers=eh(l.embers+2,0,l.emberCap),Hh(l,`crownOfCinders`)),ph(e,`shatterersCrown`)&&(l.enemies.forEach(e=>{e.facetMax=Math.max(2,e.facetMax-1),e.statuses.str=(e.statuses.str||0)+1}),Hh(l,`shatterersCrown`)),ph(e,`smolderingCoal`)&&(l.enemies.forEach(e=>e.statuses.poison=(e.statuses.poison||0)+2),Hh(l,`smolderingCoal`)),ph(e,`ashenCore`)&&(l.enemies.forEach(e=>e.statuses.poison=(e.statuses.poison||0)+3),Hh(l,`ashenCore`)),Wh(e,l),cg(e,l),l}function Vh(e,t){for(let n=t.length-1;n>0;n--){let r=Math.floor(e()*(n+1));[t[n],t[r]]=[t[r],t[n]]}}function Hh(e,t){e.queue.push({t:`relicProc`,id:t})}function Uh(e,t,n,r){t.statuses[n]=(t.statuses[n]||0)+r,t.statuses[n]===0&&delete t.statuses[n],e.queue.push({t:`status`,who:t===e.player?`player`:t.idx,id:n,n:r})}function Wh(e,t){let n=ch(e);for(let e of t.enemies)e.hp<=0||(e.moveKey=Fu[e.key].ai({turn:t.turn+1,last:e.lastMoves[e.lastMoves.length-1],prev:e.lastMoves[e.lastMoves.length-2],rng:n,hpFrac:e.hp/e.maxHp,self:e}),t.queue.push({t:`intent`,idx:e.idx,move:e.moveKey}))}function Gh(e){return Fu[e.key].moves[e.moveKey]}function Kh(e,t,n){let r=eh(t.embers+n,0,t.emberCap),i=r-t.embers;return i?(t.embers=r,t.queue.push({t:`ember`,n:i,total:t.embers}),i):0}function qh(e,t,n,r){if(!(t.over||n.hp<=0||r<=0))for(n.chips+=r,t.queue.push({t:`chip`,idx:n.idx,n:r,chips:Math.min(n.chips,n.facetMax),facetMax:n.facetMax});n.chips>=n.facetMax&&n.hp>0;)n.chips-=n.facetMax,Jh(e,t,n)}function Jh(e,t,n){if(n.facetMax+=1,n.flags.adamant&&!n.flags.adamantSpent){n.flags.adamantSpent=!0,t.queue.push({t:`adamantHold`,idx:n.idx});return}e.stats.shatters++,n.flags.staggered=!0,t.queue.push({t:`shatter`,idx:n.idx,facetMax:n.facetMax}),Uh(t,n,`vulnerable`,2),Kh(e,t,2),ph(e,`prismCharm`)&&!t.prismProcd&&(t.prismProcd=!0,Kh(e,t,2),Hh(t,`prismCharm`));let r=n.statuses.poison||0;if(r&&t.enemies.some(e=>e!==n&&e.hp>0)&&(delete n.statuses.poison,Yh(e,t,n,r)),ph(e,`bellOfEndings`)){Hh(t,`bellOfEndings`);for(let r of t.enemies.filter(e=>e!==n&&e.hp>0)){if(t.over)break;ng(e,t,r,4,{isAttack:!1})}}}function Yh(e,t,n,r){if(!r)return;let i=t.enemies.filter(e=>e!==n&&e.hp>0);if(!i.length)return;let a=Qm(ch(e),i);Uh(t,a,`poison`,r),t.queue.push({t:`smolderJump`,from:n.idx,to:a.idx,n:r})}function Xh(e,t){let n=Hu[e.art];return!!n&&!t.over&&t.artUsedTurn!==t.turn&&t.embers>=n.cost}function Zh(e,t){if(!Xh(e,t))return!1;let n=Hu[e.art];t.artUsedTurn=t.turn,e.stats.embersSpent+=n.cost,Kh(e,t,-n.cost),t.queue.push({t:`art`,id:e.art});for(let r of n.effects){if(t.over)break;Qh(e,t,r)}return!0}function Qh(e,t,n){let r=t.player,i=()=>t.enemies.filter(e=>e.hp>0);switch(n.kind){case`dmg`:for(let r of i())t.over||ng(e,t,r,n.n,{isAttack:!1});break;case`status`:if(n.who===`self`)Uh(t,r,n.id,n.n);else for(let e of i())Uh(t,e,n.id,n.n);break;case`block`:ag(e,t,r,n.n,!1);break;case`heal`:_h(e,n.n,t);break;case`energy`:r.energy+=n.n,t.queue.push({t:`energy`,n:r.energy});break;case`draw`:og(e,t,n.n);break;case`chip`:for(let r of i())qh(e,t,r,n.n);break;case`ember`:Kh(e,t,n.n);break}}function $h(e,t,n){return!n||t.over||sh(n).type===`curse`?!1:!(t.kindledTurn===t.turn&&t.kindlesThisTurn>=eg(e))}function eg(e){return ph(e,`crownOfTithes`)?2:1}function tg(e,t,n){let r=t.hand.findIndex(e=>e.uid===n);if(r<0)return!1;let i=t.hand[r];return $h(e,t,i)?(t.kindledTurn!==t.turn&&(t.kindledTurn=t.turn,t.kindlesThisTurn=0),t.kindlesThisTurn++,t.hand.splice(r,1),e.stats.kindles++,t.queue.push({t:`kindle`,uid:i.uid,id:i.id}),sg(e,t,i),ph(e,`crownOfTithes`)&&(ag(e,t,t.player,3,!1),Hh(t,`crownOfTithes`)),!0):!1}function ng(e,t,n,r,{isAttack:i=!0,mult:a=1}={}){if(n.hp<=0||t.over)return 0;let o=t.player,s=r;i&&(s+=o.statuses.str||0,o.statuses.weak&&(s=Math.floor(s*.75)),n.statuses.vulnerable&&(s=Math.floor(s*1.5))),s=Math.max(0,Math.floor(s*a));let c=Math.min(n.block,s);n.block-=c;let l=s-c;if(n.hp-=l,e.stats.dmgDealt+=l,t.queue.push({t:`hitEnemy`,idx:n.idx,amount:l,blocked:c,hpAfter:Math.max(0,n.hp),dead:n.hp<=0,killingBlow:n.hp<=0&&l>0,overkill:Math.max(0,-n.hp)}),t.pendingChips&&i&&l>0){let e=t.pendingChips.get(n.idx)||{hit:!1,extra:0};e.hit=!0,t.pendingChips.set(n.idx,e)}return i&&n.statuses.thorns&&n.hp>0&&ig(e,t,n.statuses.thorns,{source:`thorns`,isAttack:!1}),n.hp<=0&&rg(e,t,n),l}function rg(e,t,n){n.hp=0;let r=n.statuses.poison||0;if(n.statuses={},n.flags.staggered=!1,t.queue.push({t:`die`,idx:n.idx}),e.stats.slain++,n.elite&&e.stats.elites++,n.boss&&e.stats.bosses++,t.enemies.every(e=>e.hp<=0)){gg(e,t);return}Kh(e,t,1),Yh(e,t,n,r),ph(e,`reapersBell`)&&(t.player.energy+=1,og(e,t,1),Hh(t,`reapersBell`),t.queue.push({t:`energy`,n:t.player.energy}))}function ig(e,t,n,{source:r=`self`,isAttack:i=!1,attacker:a=null}={}){if(t.over)return 0;let o=t.player,s=n;i&&a&&(s+=(a.statuses.str||0)+(a.flags.rampBonus||0)+(ih(e).enemyDmgBonus||0)+(nh(e).enemyDmgBonus||0),a.statuses.weak&&(s=Math.floor(s*.75)),o.statuses.vulnerable&&(s=Math.floor(s*1.5)),ph(e,`wardingCharm`)&&s<=5&&s>0&&(s=1,Hh(t,`wardingCharm`))),s=Math.max(0,s);let c=0;(i||r===`thorns`)&&(c=Math.min(o.block,s),o.block-=c);let l=s-c;if(o.hp-=l,e.stats.dmgTaken+=Math.max(0,l),t.counters.hpLost+=Math.max(0,l),t.queue.push({t:`hitPlayer`,amount:l,blocked:c,hpAfter:Math.max(0,o.hp),source:r}),o.hp<=0)return _g(e,t),l;if(i&&a){let n={...ih(e).playerHitApplies||{},...t.affix&&Vu[t.affix].mods.attackApplies||{}};for(let[e,r]of Object.entries(n))Uh(t,o,e,r);o.statuses.thorns&&a.hp>0&&ng(e,t,a,o.statuses.thorns,{isAttack:!1})}return l}function ag(e,t,n,r,i=!0){let a=r;return n===t.player&&i&&(a+=n.statuses.dex||0,n.statuses.frail&&(a=Math.floor(a*.75))),a=Math.round(Math.max(0,a)*(ih(e).wardMult||1)),n.block+=a,t.queue.push({t:`blockGain`,who:n===t.player?`player`:n.idx,n:a,total:n.block}),a}function og(e,t,n){let r=ch(e);for(let e=0;e<n&&!(t.hand.length>=10);e++){if(!t.draw.length){if(!t.discard.length)break;let e=t.discard.length;t.draw=t.discard,t.discard=[],Vh(r,t.draw),t.queue.push({t:`reshuffle`,n:e})}let e=t.draw.pop();t.hand.push(e),t.queue.push({t:`draw`,uid:e.uid,id:e.id})}}function sg(e,t,n){t.exhaust.push(n),t.queue.push({t:`exhaust`,uid:n.uid}),Kh(e,t,1),ph(e,`verdantBranch`)&&(og(e,t,1),Hh(t,`verdantBranch`))}function cg(e,t){if(t.over)return;t.turn++;let n=t.player;if(t.queue.push({t:`turn`,n:t.turn}),n.statuses.poison&&(ig(e,t,n.statuses.poison,{source:`poison`}),n.statuses.poison--,n.statuses.poison||delete n.statuses.poison,t.over))return;n.statuses.barricade||(n.block=0),n.statuses.ritual&&Uh(t,n,`str`,n.statuses.ritual),n.statuses.emberflow&&Kh(e,t,n.statuses.emberflow);let r=n.energyMax+(n.statuses.energized||0);t.turn===1&&ph(e,`emberLantern`)&&(r+=1,Hh(t,`emberLantern`)),n.energy=(ph(e,`frozenCore`)?n.energy:0)+r,t.counters.firstCardPlayed=!1,t.queue.push({t:`energy`,n:n.energy});let i=5+(n.statuses.nightsight||0)+(ih(e).drawDelta||0);t.turn===1&&ph(e,`travelersPack`)&&(i+=2,Hh(t,`travelersPack`)),og(e,t,Math.max(1,i))}function lg(e,t,n){let r=sh(n);return r.cost==null?null:ph(e,`duskmirror`)&&!t.counters.firstCardPlayed?0:ih(e).firstCardDiscount&&!t.counters.firstCardPlayed?Math.max(0,r.cost-ih(e).firstCardDiscount):r.cost}function ug(e,t,n,r){if(t.over)return!1;let i=sh(n);return!(i.unplayable||lg(e,t,n)>t.player.energy||i.target===`enemy`&&(r==null||!t.enemies[r]||t.enemies[r].hp<=0))}function dg(e,t,n,r=null){let i=t.hand.findIndex(e=>e.uid===n);if(i<0)return!1;let a=t.hand[i],o=sh(a);if(!ug(e,t,a,r))return!1;let s=t.player,c=lg(e,t,a);s.energy-=c,ph(e,`duskmirror`)&&!t.counters.firstCardPlayed&&o.cost>0&&Hh(t,`duskmirror`),t.counters.firstCardPlayed=!0,t.hand.splice(i,1),t.counters.played++,e.stats.cardsPlayed++,t.queue.push({t:`play`,uid:a.uid,id:a.id,targetIdx:r}),t.queue.push({t:`energy`,n:s.energy});let l=1;o.type===`attack`&&(t.counters.attacks++,ph(e,`ironTalisman`)&&t.counters.attacks%3==0&&(Uh(t,s,`str`,1),Hh(t,`ironTalisman`)),ph(e,`executionersSeal`)&&t.counters.attacks%10==0&&(l=2,Hh(t,`executionersSeal`)));let u=r==null?null:t.enemies[r],d=()=>t.enemies.filter(e=>e.hp>0);t.pendingChips=new Map;for(let n of o.effects){if(t.over)break;fg(e,t,a,o,n,u,l)}if(t.pendingChips&&!t.over){let n=o.type===`attack`?1+(o.chip||0)+(s.statuses.beacon||0):0;for(let[r,i]of t.pendingChips){let a=t.enemies[r];if(!a||a.hp<=0||t.over)continue;let o=(i.hit?n:0)+i.extra;o>0&&qh(e,t,a,o)}}if(t.pendingChips=null,!t.over&&o.type===`attack`&&s.statuses.venomous){let e=o.target===`allEnemies`?d():u&&u.hp>0?[u]:[];for(let n of e)Uh(t,n,`poison`,s.statuses.venomous)}return!t.over&&ph(e,`silkFan`)&&t.counters.played%3==0&&(ag(e,t,s,3,!1),Hh(t,`silkFan`)),o.type===`power`?t.queue.push({t:`powerConsumed`,uid:a.uid}):o.exhaust?sg(e,t,a):(t.discard.push(a),t.queue.push({t:`toDiscard`,uid:a.uid})),!0}function fg(e,t,n,r,i,a,o){let s=t.player,c=r.target===`allEnemies`?t.enemies.filter(e=>e.hp>0):a?[a]:[];switch(i.kind){case`dmg`:{let n=i.times||1;for(let a=0;a<n;a++)for(let n of r.target===`allEnemies`?t.enemies.filter(e=>e.hp>0):c){if(t.over)return;ng(e,t,n,i.n,{mult:o})}break}case`block`:ag(e,t,s,i.n);break;case`draw`:og(e,t,i.n);break;case`energy`:s.energy+=i.n,t.queue.push({t:`energy`,n:s.energy});break;case`heal`:_h(e,i.n,t);break;case`loseHp`:ig(e,t,i.n,{source:`self`});break;case`status`:if(i.who===`self`)Uh(t,s,i.id,i.n);else if(i.who===`allEnemies`)for(let e of t.enemies.filter(e=>e.hp>0))Uh(t,e,i.id,i.n);else a&&a.hp>0&&Uh(t,a,i.id,i.n);break;case`addCard`:for(let n=0;n<(i.n||1);n++){let n={uid:e.uid++,id:i.id,up:!1,bonus:0};(i.where===`hand`&&t.hand.length<10?t.hand:t.discard).push(n),t.queue.push({t:`addCard`,id:i.id,where:i.where||`discard`})}break;case`chip`:for(let n of c)if(!(n.hp<=0))if(t.pendingChips){let e=t.pendingChips.get(n.idx)||{hit:!1,extra:0};e.extra+=i.n,t.pendingChips.set(n.idx,e)}else qh(e,t,n,i.n);break;case`ember`:Kh(e,t,i.n);break;case`special`:pg(e,t,n,r,i,a,o)}}function pg(e,t,n,r,i,a,o){let s=t.player;switch(i.id){case`leech`:{let n=ng(e,t,a,i.n,{mult:o});n>0&&_h(e,Math.floor(n/2),t);break}case`execute`:{let n=a.statuses.vulnerable?i.bonus:0;ng(e,t,a,i.n+n,{mult:o});break}case`momentum`:ng(e,t,a,i.n+n.bonus,{mult:o}),n.bonus+=i.grow;break;case`phantom`:ng(e,t,a,i.n*t.hand.length,{mult:o});break;case`devour`:ng(e,t,a,i.n,{mult:o}),a.hp<=0&&(t.over?_h(e,i.heal):(Kh(e,t,i.embers),_h(e,i.heal,t)));break;case`doubleBlock`:ag(e,t,s,s.block,!1);break;case`catalyst`:a.statuses.poison&&Uh(t,a,`poison`,a.statuses.poison*(i.n-1));break;case`shatterEcho`:{let n=a.flags.staggered||a.statuses.vulnerable?2:1;ng(e,t,a,i.n*n,{mult:o});break}case`emberNova`:ng(e,t,a,i.n*t.embers,{mult:o});break;case`pyreTithe`:for(let r of[...t.hand]){if(r===n)continue;let i=t.hand.indexOf(r);t.hand.splice(i,1),t.queue.push({t:`kindle`,uid:r.uid,id:r.id}),sg(e,t,r)}og(e,t,i.draw);break;case`flawless`:ag(e,t,s,i.n),t.counters.hpLost===0&&ag(e,t,s,i.n);break;case`emberdance`:{let n=t.embers;n>0&&(e.stats.embersSpent+=n,Kh(e,t,-n),ag(e,t,s,i.n*n,!1));break}}}function mg(e,t,n,r=null){let i=e.player.potions[n];if(!i)return!1;let a=Pu[i];if(a.combatOnly&&(!t||t.over)||a.needsTarget&&(r==null||!t.enemies[r]||t.enemies[r].hp<=0))return!1;switch(e.player.potions[n]=null,t&&t.queue.push({t:`potion`,id:i}),i){case`healing`:_h(e,20,t),t||(e.player.hp=eh(e.player.hp,0,e.player.maxHp));break;case`strength`:Uh(t,t.player,`str`,2);break;case`swift`:og(e,t,3);break;case`block`:ag(e,t,t.player,12,!1);break;case`fire`:ng(e,t,t.enemies[r],20,{isAttack:!1});break;case`venom`:Uh(t,t.enemies[r],`poison`,7);break;case`energy`:Kh(e,t,3);break}return!0}function hg(e,t){if(t.over)return;let n=t.player;t.queue.push({t:`endTurn`});for(let n of[...t.hand]){let r=sh(n);if(r.endTurnDmg&&ig(e,t,r.endTurnDmg,{source:`burn`}),r.endTurnLoseHp&&ig(e,t,r.endTurnLoseHp,{source:`burn`}),t.over)return}n.statuses.metallicize&&ag(e,t,n,n.statuses.metallicize,!1),n.statuses.regen&&_h(e,n.statuses.regen,t);let r=t.hand.map(e=>e.uid);t.discard.push(...t.hand),t.hand=[],t.queue.push({t:`discardHand`,uids:r});for(let e of[`vulnerable`,`weak`,`frail`,`beacon`])n.statuses[e]&&(n.statuses[e]--,n.statuses[e]||delete n.statuses[e]);for(let r of t.enemies)if(!(r.hp<=0||t.over)){if(r.statuses.poison){let n=r.statuses.poison;if(r.hp-=n,e.stats.dmgDealt+=n,t.queue.push({t:`hitEnemy`,idx:r.idx,amount:n,blocked:0,hpAfter:Math.max(0,r.hp),dead:r.hp<=0,poison:!0}),r.statuses.poison--,r.statuses.poison||delete r.statuses.poison,r.hp<=0){e.stats.smolderKills++,rg(e,t,r);continue}}if(r.block=0,r.flags.staggered)r.flags.staggered=!1,r.lastMoves.push(r.moveKey),t.queue.push({t:`staggered`,idx:r.idx});else{let i=Gh(r);if(t.queue.push({t:`enemyAct`,idx:r.idx,move:r.moveKey,name:i.name}),r.lastMoves.push(r.moveKey),i.dmg!=null){for(let n=0;n<(i.times||1)&&!t.over;n++)ig(e,t,i.dmg,{source:r.idx,isAttack:!0,attacker:r});i.ramp&&(r.flags.rampBonus=(r.flags.rampBonus||0)+i.ramp)}if(t.over)return;if(i.block&&ag(e,t,r,i.block,!1),i.heal&&(r.hp=Math.min(r.maxHp,r.hp+i.heal),t.queue.push({t:`heal`,who:r.idx,n:i.heal})),i.fx){for(let e of i.fx)if(e.who===`player`)Uh(t,n,e.id,e.n);else if(e.who===`self`)Uh(t,r,e.id,e.n);else if(e.who===`allies`)for(let n of t.enemies.filter(e=>e.hp>0))Uh(t,n,e.id,e.n)}if(i.addCards)for(let n=0;n<i.addCards.n;n++)t.discard.push({uid:e.uid++,id:i.addCards.id,up:!1,bonus:0}),t.queue.push({t:`addCard`,id:i.addCards.id,where:`discard`})}r.statuses.ritual&&Uh(t,r,`str`,r.statuses.ritual);for(let e of[`vulnerable`,`weak`])r.statuses[e]&&(r.statuses[e]--,r.statuses[e]||delete r.statuses[e])}t.over||(Wh(e,t),cg(e,t))}function gg(e,t){t.over=!0,t.result=`win`,e.player.hp=eh(t.player.hp,1,e.player.maxHp),ph(e,`emberHeart`)&&(_h(e,6),Hh(t,`emberHeart`)),ph(e,`crownOfTheHearth`)&&t.embers>0&&(_h(e,t.embers*3),Hh(t,`crownOfTheHearth`)),ph(e,`gravebloom`)&&e.player.hp<=e.player.maxHp*.5&&(_h(e,10),Hh(t,`gravebloom`)),e.player.hp=eh(e.player.hp,1,e.player.maxHp),t.queue.push({t:`victory`,perfect:t.counters.hpLost===0})}function _g(e,t){t.over=!0,t.result=`loss`,t.player.hp=0,e.player.hp=0,t.queue.push({t:`defeat`})}function vg(e,t,n=null){let r=e.player,i=t+(r.statuses.str||0);r.statuses.weak&&(i=Math.floor(i*.75));let a=n==null?null:e.enemies[n];return a&&a.statuses.vulnerable&&(i=Math.floor(i*1.5)),Math.max(0,i)}function yg(e,t,n){let r=t.player,i=n+(r.statuses.dex||0);return r.statuses.frail&&(i=Math.floor(i*.75)),Math.round(Math.max(0,i)*(ih(e).wardMult||1))}function bg(e,t,n){let r=Gh(n);if(r.dmg==null)return null;let i=r.dmg+(n.statuses.str||0)+(n.flags.rampBonus||0)+(ih(e).enemyDmgBonus||0)+(nh(e).enemyDmgBonus||0);return n.statuses.weak&&(i=Math.floor(i*.75)),t.player.statuses.vulnerable&&(i=Math.floor(i*1.5)),{dmg:Math.max(0,i),times:r.times||1}}function xg(e,t,n,r=null){let i=sh(n),a=t.player,o=r==null?null:t.enemies[r],s=ph(e,`executionersSeal`)&&i.type===`attack`&&(t.counters.attacks+1)%10==0?2:1,c=e=>{let t=e+(a.statuses.str||0);return a.statuses.weak&&(t=Math.floor(t*.75)),o&&o.statuses.vulnerable&&(t=Math.floor(t*1.5)),Math.max(0,Math.floor(t*s))},l=[],u=0;for(let r of i.effects)r.kind===`dmg`?l.push({dmg:c(r.n),times:r.times||1}):r.kind===`block`?u+=yg(e,t,r.n):r.kind===`special`&&(r.id===`leech`||r.id===`devour`?l.push({dmg:c(r.n),times:1}):r.id===`execute`?l.push({dmg:c(r.n+(o?.statuses.vulnerable?r.bonus:0)),times:1}):r.id===`momentum`?l.push({dmg:c(r.n+(n.bonus||0)),times:1}):r.id===`phantom`?l.push({dmg:c(r.n*Math.max(0,t.hand.length-+!!t.hand.includes(n))),times:1}):r.id===`shatterEcho`?l.push({dmg:c(r.n*(o&&(o.flags.staggered||o.statuses.vulnerable)?2:1)),times:1}):r.id===`emberNova`?l.push({dmg:c(r.n*t.embers),times:1}):r.id===`doubleBlock`?u+=a.block:r.id===`flawless`?u+=yg(e,t,r.n)*(t.counters.hpLost===0?2:1):r.id===`emberdance`&&(u+=r.n*t.embers));let d=0;for(let e of i.effects)e.kind===`chip`&&(d+=e.n);if(!l.length&&!u&&!d)return null;let f=l.reduce((e,t)=>e+t.dmg*t.times,0),p=f,m=!1,h=0,g=!1;if(o){let e=o.block;p=0;for(let t of l)for(let n=0;n<t.times;n++){let n=Math.min(e,t.dmg);e-=n,p+=t.dmg-n}m=p>=o.hp;let t=i.type===`attack`?1+(i.chip||0)+(a.statuses.beacon||0):0;h=(l.length&&p>0?t:0)+d,g=h>0&&o.chips+h>=o.facetMax&&!m}return{hits:l,total:f,loss:p,lethal:m,block:u,chips:h,willShatter:g}}function Sg(e,t,n=!1){let r=oh(e,t,n);return e.player.deck.push(r),r}function Cg(e,t){let n=e.player.deck.findIndex(e=>e.uid===t);n>=0&&e.player.deck.splice(n,1)}function wg(e,t){let n=e.player.deck.find(e=>e.uid===t);n&&(n.up=!0)}function Tg(e,t){let n=e.player.deck.find(e=>e.uid===t);n&&e.player.deck.push(oh(e,n.id,n.up))}var Eg=`spirebound_save_v2`,Dg=`spirebound_stats_v1`;function Og(e){try{localStorage.setItem(Eg,JSON.stringify(e))}catch{}}function kg(){try{let e=localStorage.getItem(Eg);if(!e)return null;let t=JSON.parse(e);if(!t||t.v!==2||!t.player||!t.map||!t.player.deck.every(e=>ku[e.id])||!t.player.relics.every(e=>Mu[e])||!t.player.potions.every(e=>e==null||Pu[e])||t.art!=null&&!Hu[t.art]||!(t.omens||[]).every(e=>e==null||Bu[e])||(t.art??=`flare`,t.aspect=eh(t.aspect??0,0,qu.length-1),t.vow=eh(t.vow??0,0,Ju.length),t.unlocks??=[],t.omens??=[],t.boon??=null,t.bossRelicAct??=-1,t.orphanRewardClaimed??=!1,t.orphanRewardResolving??=!1,t.reveals??=null,t.reveals!=null&&!(Array.isArray(t.reveals)&&t.reveals.every(e=>Gu.some(t=>t.id===e)))))return null;for(;t.omens.length<=t.act;)t.omens.push(mh(t,`omens`)?rh(t):null);for(let e of[`shatters`,`kindles`,`perfects`,`smolderKills`,`unlitVisited`,`embersSpent`])t.stats[e]??=0;return t}catch{return null}}function Ag(){try{localStorage.removeItem(Eg),localStorage.removeItem(`spirebound_save_v1`)}catch{}}function jg(){try{return JSON.parse(localStorage.getItem(Dg))||{runs:0,wins:0,best:0}}catch{return{runs:0,wins:0,best:0}}}function Mg(e,t){let n=jg();n.runs++,t&&n.wins++,n.best=Math.max(n.best,e.act*15+e.floorsClimbed);try{localStorage.setItem(Dg,JSON.stringify(n))}catch{}Ag()}function Ng(e,t,n=ch(e)){let r=[],i=[];for(let a of t){if(a.gold&&(e.player.gold=Math.max(0,e.player.gold+a.gold),a.gold>0&&(e.stats.goldEarned+=a.gold)),a.hp&&(e.player.hp=eh(e.player.hp+a.hp,1,e.player.maxHp)),a.maxHp&&(e.player.maxHp=Math.max(1,e.player.maxHp+a.maxHp),e.player.hp=eh(e.player.hp+Math.max(0,a.maxHp),1,e.player.maxHp)),a.heal&&_h(e,Math.round(e.player.maxHp*a.heal)),a.addCard&&Sg(e,a.addCard),a.addRelic){let t=a.addRelic===`random`?yh(e):a.addRelic;t?(vh(e,t),i.push({relic:t})):(e.player.gold+=50,i.push({text:`You find 50 gold instead.`}))}if(a.potion&&Mh(e,a.potion),a.pickRemove&&r.push(`remove`),a.pickUpgrade&&r.push(`upgrade`),a.pickDuplicate&&r.push(`duplicate`),a.pickCard&&r.push({pickCard:a.pickCard}),a.roll){let t=n(),o=0;for(let s of a.roll)if(o+=s.p,t<o){i.push({text:s.text});let t=Ng(e,s.ops,n);r.push(...t.pending),i.push(...t.log);break}}}return{pending:r,log:i}}var Pg=Object.assign({"./assets/arts/ashfall.png":`/assets/ashfall-C0Z9oihA.png`,"./assets/arts/beacon.png":`/assets/beacon-CfpI4NvN.png`,"./assets/arts/emberveil.png":`/assets/emberveil-DRPFSPHg.png`,"./assets/arts/flare.png":`/assets/flare-Ca-5NBfJ.png`,"./assets/arts/mendglass.png":`/assets/mendglass-MxKA-x9I.png`,"./assets/arts/stoke.png":`/assets/stoke-D5pz9eOt.png`,"./assets/bequests/card.png":`/assets/card-CHxK2GTL.png`,"./assets/bequests/gold.png":`/assets/gold-CNm8Tont.png`,"./assets/bequests/relic.png":`/assets/relic-Bo0IZDwg.png`,"./assets/boons/emberFlask.png":`/assets/emberFlask-BlP1krpU.png`,"./assets/boons/fullPurse.png":`/assets/fullPurse-DcTqZ-nz.png`,"./assets/boons/keenEye.png":`/assets/keenEye-DPefaPGL.png`,"./assets/boons/pilgrimsCache.png":`/assets/pilgrimsCache-CsIcQUYT.png`,"./assets/boons/temperedGlass.png":`/assets/temperedGlass-BVjobJFG.png`,"./assets/boons/twinPhials.png":`/assets/twinPhials-D5-9T5W2.png`,"./assets/boons/venomPouch.png":`/assets/venomPouch-9GhvdgzC.png`,"./assets/boons/warmHearth.png":`/assets/warmHearth-DTnVpfFw.png`,"./assets/cards/aegis.jpg":`/assets/aegis-D665L0sd.jpg`,"./assets/cards/agility.jpg":`/assets/agility-CUG3xKOo.jpg`,"./assets/cards/annihilate.jpg":`/assets/annihilate-CXlkbExQ.jpg`,"./assets/cards/ascension.jpg":`/assets/ascension-S4GAfpbx.jpg`,"./assets/cards/ashBite.jpg":`/assets/ashBite-BYzdJfb7.jpg`,"./assets/cards/ashenChoir.jpg":`/assets/ashenChoir-DTfq4XXZ.jpg`,"./assets/cards/bastion.jpg":`/assets/bastion-CM0wK4Yy.jpg`,"./assets/cards/bloodRite.jpg":`/assets/bloodRite-ou1XgXoc.jpg`,"./assets/cards/brace.jpg":`/assets/brace-Dc4SYgdF.jpg`,"./assets/cards/bulwark.jpg":`/assets/bulwark-CjEcWZ-i.jpg`,"./assets/cards/burn.jpg":`/assets/burn-DJ4EegTp.jpg`,"./assets/cards/catalyst.jpg":`/assets/catalyst-ClagfpN0.jpg`,"./assets/cards/chisel.jpg":`/assets/chisel-DGrQWYAc.jpg`,"./assets/cards/cleave.jpg":`/assets/cleave-CvexqRxg.jpg`,"./assets/cards/cripple.jpg":`/assets/cripple-CRxGKuS4.jpg`,"./assets/cards/defend.jpg":`/assets/defend-mmYA7HKX.jpg`,"./assets/cards/deflect.jpg":`/assets/deflect-BKgfxyAn.jpg`,"./assets/cards/devour.jpg":`/assets/devour-CST2E0aP.jpg`,"./assets/cards/eclipseSlash.jpg":`/assets/eclipseSlash-DEA5FgEC.jpg`,"./assets/cards/emberdance.jpg":`/assets/emberdance-B_CKT6sd.jpg`,"./assets/cards/empower.jpg":`/assets/empower-D4P9cm_V.jpg`,"./assets/cards/executioner.jpg":`/assets/executioner-BOy4ovki.jpg`,"./assets/cards/firstSpark.jpg":`/assets/firstSpark-BpDCHsPu.jpg`,"./assets/cards/flawlessForm.jpg":`/assets/flawlessForm-Di6668jF.jpg`,"./assets/cards/flurry.jpg":`/assets/flurry-BgnBaWD-.jpg`,"./assets/cards/fortify.jpg":`/assets/fortify-BzU364vJ.jpg`,"./assets/cards/frenzy.jpg":`/assets/frenzy-qaLdgJOP.jpg`,"./assets/cards/guardedStrike.jpg":`/assets/guardedStrike-CesH5DLC.jpg`,"./assets/cards/heavyBlow.jpg":`/assets/heavyBlow-XGOXUeSq.jpg`,"./assets/cards/hex.jpg":`/assets/hex-CzQLIJW1.jpg`,"./assets/cards/ironSkin.jpg":`/assets/ironSkin-BOE1a1BZ.jpg`,"./assets/cards/leechBlade.jpg":`/assets/leechBlade-CFp6z-JI.jpg`,"./assets/cards/limitBreak.jpg":`/assets/limitBreak-BU_PNCuK.jpg`,"./assets/cards/lunge.jpg":`/assets/lunge-D9lgqjTD.jpg`,"./assets/cards/momentum.jpg":`/assets/momentum-Clbqs0on.jpg`,"./assets/cards/nightSight.jpg":`/assets/nightSight-DuZK4KbA.jpg`,"./assets/cards/novaflare.jpg":`/assets/novaflare-Dwvtjr_D.jpg`,"./assets/cards/oblivionStrike.jpg":`/assets/oblivionStrike-CXq1522m.jpg`,"./assets/cards/offering.jpg":`/assets/offering-BaVvule_.jpg`,"./assets/cards/phantomBlades.jpg":`/assets/phantomBlades-Bck63olt.jpg`,"./assets/cards/preparation.jpg":`/assets/preparation-BkmwWzr3.jpg`,"./assets/cards/pyreheart.jpg":`/assets/pyreheart-Cf86Pj1Y.jpg`,"./assets/cards/quakeblow.jpg":`/assets/quakeblow-DZPTH_O8.jpg`,"./assets/cards/quickSlash.jpg":`/assets/quickSlash-DMRFz6rj.jpg`,"./assets/cards/regrowth.jpg":`/assets/regrowth-C0gMpqIX.jpg`,"./assets/cards/resonantLance.jpg":`/assets/resonantLance-CCStaA3R.jpg`,"./assets/cards/shardstorm.jpg":`/assets/shardstorm-DIKHFs35.jpg`,"./assets/cards/sidestep.jpg":`/assets/sidestep-CeDzy6bs.jpg`,"./assets/cards/smother.jpg":`/assets/smother-DFWDS6kH.jpg`,"./assets/cards/strike.jpg":`/assets/strike-DfYIx_7x.jpg`,"./assets/cards/surge.jpg":`/assets/surge-Ci44wXor.jpg`,"./assets/cards/tempest.jpg":`/assets/tempest-K9Ub9Fd7.jpg`,"./assets/cards/tithe.jpg":`/assets/tithe-DvZ_GGtQ.jpg`,"./assets/cards/toxicMist.jpg":`/assets/toxicMist-DMOH0JOL.jpg`,"./assets/cards/twinFangs.jpg":`/assets/twinFangs-C0lavWO6.jpg`,"./assets/cards/uppercut.jpg":`/assets/uppercut-CY7mUqmx.jpg`,"./assets/cards/venomStrike.jpg":`/assets/venomStrike-DGTk3cTA.jpg`,"./assets/cards/virulence.jpg":`/assets/virulence-vlHxYWHm.jpg`,"./assets/cards/warCry.jpg":`/assets/warCry-BO21yVwc.jpg`,"./assets/cards/wound.jpg":`/assets/wound-B5mKVM4_.jpg`,"./assets/deeds/ashSermon.png":`/assets/ashSermon-CQLTV0YC.png`,"./assets/deeds/darkWalker.png":`/assets/darkWalker-BcUgRerv.png`,"./assets/deeds/firstDawn.png":`/assets/firstDawn-BGaCCejS.png`,"./assets/deeds/hundredShards.png":`/assets/hundredShards-BbMyoK2V.png`,"./assets/deeds/lanternFed.png":`/assets/lanternFed-BdesJDJD.png`,"./assets/deeds/paneBreaker.png":`/assets/paneBreaker-h0dWvGCV.png`,"./assets/deeds/spendthrift.png":`/assets/spendthrift-OT3LxCNB.png`,"./assets/deeds/untouched.png":`/assets/untouched-Q4-Em2Wy.png`,"./assets/enemies/abyssalKnight.png":`/assets/abyssalKnight-BA9qPzL_.png`,"./assets/enemies/alphaFang.png":`/assets/alphaFang-CYs2MfQS.png`,"./assets/enemies/ashAcolyte.png":`/assets/ashAcolyte-W7Bx9eY3.png`,"./assets/enemies/chaosHound.png":`/assets/chaosHound-Cu1tbGXO.png`,"./assets/enemies/deepmaw.png":`/assets/deepmaw-BuZMfyUW.png`,"./assets/enemies/drownedOne.png":`/assets/drownedOne-762yKbrK.png`,"./assets/enemies/duskfang.png":`/assets/duskfang-kVQE2Vbx.png`,"./assets/enemies/gloomslime.png":`/assets/gloomslime-BYNIQKkd.png`,"./assets/enemies/gravewarden.png":`/assets/gravewarden-CYbqq2Uz.png`,"./assets/enemies/heraldOfEnd.png":`/assets/heraldOfEnd-B5j76nBL.png`,"./assets/enemies/leviathan.png":`/assets/leviathan-DUX2Oy2k.png`,"./assets/enemies/mirelurker.png":`/assets/mirelurker-Cs0-ryPe.png`,"./assets/enemies/obsidianGolem.png":`/assets/obsidianGolem-B2_vm835.png`,"./assets/enemies/rootheart.png":`/assets/rootheart-CoZqsgKs.png`,"./assets/enemies/shade.png":`/assets/shade-cFzxMAwm.png`,"./assets/enemies/shellback.png":`/assets/shellback-9j9gwuRI.png`,"./assets/enemies/siren.png":`/assets/siren-Boj63opF.png`,"./assets/enemies/sovereign.png":`/assets/sovereign-DlFMbPOe.png`,"./assets/enemies/sporeling.png":`/assets/sporeling-B8wAP_1e.png`,"./assets/enemies/starCultist.png":`/assets/starCultist-DrQ9SosS.png`,"./assets/enemies/thornling.png":`/assets/thornling-BJhkzjJz.png`,"./assets/enemies/tidecaller.png":`/assets/tidecaller-C3FvvD8d.png`,"./assets/enemies/voidColossus.png":`/assets/voidColossus-D1BBPiCC.png`,"./assets/enemies/voidWisp.png":`/assets/voidWisp-DqB4mImW.png`,"./assets/enemies/voltEel.png":`/assets/voltEel-BxcD87LR.png`,"./assets/enemies/watcherEye.png":`/assets/watcherEye-Cx0FZXO4.png`,"./assets/enemies/waylayer.png":`/assets/waylayer-DkHd5xp-.png`,"./assets/events/cursedIdol.png":`/assets/cursedIdol--s0qHWso.png`,"./assets/events/emberFountain.png":`/assets/emberFountain-D_Q0157p.png`,"./assets/events/fleshTrader.png":`/assets/fleshTrader-q8lAx2oa.png`,"./assets/events/forge.png":`/assets/forge-i5xE2DIv.png`,"./assets/events/forgottenShrine.png":`/assets/forgottenShrine-CYFo9R9B.png`,"./assets/events/gambler.png":`/assets/gambler-D4lmA3Yw.png`,"./assets/events/library.png":`/assets/library-CstvhNks.png`,"./assets/events/mirror.png":`/assets/mirror-Hp5O4ZPJ.png`,"./assets/events/ruinedCamp.png":`/assets/ruinedCamp-BvAZgrK0.png`,"./assets/events/voidChest.png":`/assets/voidChest-B34oBTge.png`,"./assets/events/woundedKnight.png":`/assets/woundedKnight-JN7kYI1u.png`,"./assets/heroes/ashwarden.png":`/assets/ashwarden-D21mg7QM.png`,"./assets/heroes/duskblade.png":`/assets/duskblade-DupP5i2p.png`,"./assets/meta/ascended.png":`/assets/ascended-BmNUkA_D.png`,"./assets/meta/fallen.png":`/assets/fallen-D70fZZUD.png`,"./assets/meta/monument-node.png":`/assets/monument-node-CtuHi8tA.png`,"./assets/omens/ashfall.png":`/assets/ashfall-T4uYvK8I.png`,"./assets/omens/emberWind.png":`/assets/emberWind-Cw83yf4v.png`,"./assets/omens/heavyAir.png":`/assets/heavyAir-CjAuZn0d.png`,"./assets/omens/hungryDark.png":`/assets/hungryDark-JCDxnDj4.png`,"./assets/omens/longNight.png":`/assets/longNight-C2g4JuMB.png`,"./assets/omens/thinGlass.png":`/assets/thinGlass-CCNgzO1U.png`,"./assets/omens/waningMoon.png":`/assets/waningMoon-DyGgMjmd.png`,"./assets/piles/ashes.png":`/assets/ashes-Cs59Tc_o.png`,"./assets/piles/discard.png":`/assets/discard-B0VECG-U.png`,"./assets/piles/draw.png":`/assets/draw-DzcytXDB.png`,"./assets/potions/block.png":`/assets/block-DybnuP3a.png`,"./assets/potions/energy.png":`/assets/energy-CWJoumcv.png`,"./assets/potions/fire.png":`/assets/fire-Bc2Edgqg.png`,"./assets/potions/healing.png":`/assets/healing-Bf7MtUhk.png`,"./assets/potions/strength.png":`/assets/strength-Bp64zOFp.png`,"./assets/potions/swift.png":`/assets/swift-Da4aGqnZ.png`,"./assets/potions/venom.png":`/assets/venom-DzAfe6ZB.png`,"./assets/props/campfire.png":`/assets/campfire-C5hpDY2a.png`,"./assets/props/chest-open.png":`/assets/chest-open-D2mfQAex.png`,"./assets/props/chest.png":`/assets/chest-Dz-t7vgq.png`,"./assets/props/merchant.png":`/assets/merchant-CRCPVNlm.png`,"./assets/relics/ashenCore.png":`/assets/ashenCore-BHw_xmlT.png`,"./assets/relics/basaltIdol.png":`/assets/basaltIdol-BLUsj7rE.png`,"./assets/relics/bellOfEndings.png":`/assets/bellOfEndings-CMuMud-J.png`,"./assets/relics/crownOfCinders.png":`/assets/crownOfCinders-B4iyR0zw.png`,"./assets/relics/crownOfTheHearth.png":`/assets/crownOfTheHearth-Cz96lab0.png`,"./assets/relics/crownOfTithes.png":`/assets/crownOfTithes-BCSNj05m.png`,"./assets/relics/duskmirror.png":`/assets/duskmirror-ChDahFDy.png`,"./assets/relics/emberHeart.png":`/assets/emberHeart-D8pWC_qd.png`,"./assets/relics/emberLantern.png":`/assets/emberLantern-CzFc-ESn.png`,"./assets/relics/executionersSeal.png":`/assets/executionersSeal-B-n0EUgT.png`,"./assets/relics/frozenCore.png":`/assets/frozenCore-JuT4c4Zg.png`,"./assets/relics/gravebloom.png":`/assets/gravebloom-CR3cDZz9.png`,"./assets/relics/hollowCrown.png":`/assets/hollowCrown-CHl2KxBg.png`,"./assets/relics/ironTalisman.png":`/assets/ironTalisman-CLgSHgbT.png`,"./assets/relics/merchantsMark.png":`/assets/merchantsMark-YaAPSe2m.png`,"./assets/relics/prismCharm.png":`/assets/prismCharm-CWUUYnXM.png`,"./assets/relics/reapersBell.png":`/assets/reapersBell-DK7zj2uj.png`,"./assets/relics/riverPearl.png":`/assets/riverPearl-1k1ZwvLB.png`,"./assets/relics/seersOrb.png":`/assets/seersOrb--o7V7uP4.png`,"./assets/relics/shatterersCrown.png":`/assets/shatterersCrown-VlDF7CT4.png`,"./assets/relics/silkFan.png":`/assets/silkFan-Co6ZNxqb.png`,"./assets/relics/smolderingCoal.png":`/assets/smolderingCoal-ESDuOXE3.png`,"./assets/relics/sunBlossom.png":`/assets/sunBlossom-GItTIWOb.png`,"./assets/relics/sweetRoot.png":`/assets/sweetRoot-DVIYyMAo.png`,"./assets/relics/thiefOfWicks.png":`/assets/thiefOfWicks-WD5HQJ9E.png`,"./assets/relics/thornBand.png":`/assets/thornBand-1rbgbbpR.png`,"./assets/relics/travelersPack.png":`/assets/travelersPack-Ctq6FXOL.png`,"./assets/relics/verdantBranch.png":`/assets/verdantBranch-BpapOPVN.png`,"./assets/relics/vialOfLife.png":`/assets/vialOfLife-CqH_Yzkc.png`,"./assets/relics/warFetish.png":`/assets/warFetish-BphYE_UB.png`,"./assets/relics/wardingCharm.png":`/assets/wardingCharm-DcyucUO6.png`,"./assets/stage/act1-backdrop.png":`/assets/act1-backdrop-CC5kcu8K.png`,"./assets/stage/act1-ledge.png":`/assets/act1-ledge-Xknu1EDQ.png`,"./assets/stage/act1-mid.png":`/assets/act1-mid-B4s3OZuq.png`,"./assets/stage/act2-backdrop.png":`/assets/act2-backdrop-BtpNIaTG.png`,"./assets/stage/act2-ledge.png":`/assets/act2-ledge-CVAyrxfF.png`,"./assets/stage/act2-mid.png":`/assets/act2-mid-BAevK0Pb.png`,"./assets/stage/act3-backdrop.png":`/assets/act3-backdrop-DFsKREnY.png`,"./assets/stage/act3-ledge.png":`/assets/act3-ledge-DuyDX66N.png`,"./assets/stage/act3-mid.png":`/assets/act3-mid-CukJ38oi.png`,"./assets/statuses/barricade.png":`/assets/barricade-TKMR6Ae6.png`,"./assets/statuses/beacon.png":`/assets/beacon-D6Cit09D.png`,"./assets/statuses/dex.png":`/assets/dex-N8ZMyTH1.png`,"./assets/statuses/emberflow.png":`/assets/emberflow-WaDB__mJ.png`,"./assets/statuses/energized.png":`/assets/energized-tpMiHiHG.png`,"./assets/statuses/frail.png":`/assets/frail-C1xWDqHa.png`,"./assets/statuses/metallicize.png":`/assets/metallicize-D8bZ-dPU.png`,"./assets/statuses/nightsight.png":`/assets/nightsight-bIBKLafH.png`,"./assets/statuses/poison.png":`/assets/poison-eOT81JHw.png`,"./assets/statuses/rampage.png":`/assets/rampage-ePkPHo3b.png`,"./assets/statuses/regen.png":`/assets/regen-3glMdJ9C.png`,"./assets/statuses/ritual.png":`/assets/ritual--xxBwmXw.png`,"./assets/statuses/str.png":`/assets/str-BceaR6bB.png`,"./assets/statuses/thorns.png":`/assets/thorns-tG3JnxUb.png`,"./assets/statuses/venomous.png":`/assets/venomous-C-ybwq21.png`,"./assets/statuses/vulnerable.png":`/assets/vulnerable-BQp8gTZ1.png`,"./assets/statuses/weak.png":`/assets/weak-BVqZWBOd.png`,"./assets/title/title.png":`/assets/title-BZbtHJmc.png`,"./assets/title-background/background.png":`/assets/background-cEVCcaPg.png`,"./assets-legacy/cards/aegis.png":`/assets/aegis-BbAK7DRy.png`,"./assets-legacy/cards/agility.png":`/assets/agility-D28Eu8MG.png`,"./assets-legacy/cards/annihilate.png":`/assets/annihilate-M3mspBDm.png`,"./assets-legacy/cards/ascension.png":`/assets/ascension-C2Pll28_.png`,"./assets-legacy/cards/ashBite.png":`/assets/ashBite-BBZrYNBt.png`,"./assets-legacy/cards/ashenChoir.png":`/assets/ashenChoir-Cjfn-BY1.png`,"./assets-legacy/cards/bastion.png":`/assets/bastion-D4uvW6Yu.png`,"./assets-legacy/cards/bloodRite.png":`/assets/bloodRite-xNaIV6FC.png`,"./assets-legacy/cards/brace.png":`/assets/brace-CDbc3WSx.png`,"./assets-legacy/cards/bulwark.png":`/assets/bulwark-DvQ82Xby.png`,"./assets-legacy/cards/burn.png":`/assets/burn-BVJa4vLy.png`,"./assets-legacy/cards/catalyst.png":`/assets/catalyst-C9UJqVfa.png`,"./assets-legacy/cards/chisel.png":`/assets/chisel-BHUdyvP2.png`,"./assets-legacy/cards/cleave.png":`/assets/cleave-Cs444Dst.png`,"./assets-legacy/cards/cripple.png":`/assets/cripple-CtSZS_Jx.png`,"./assets-legacy/cards/defend.png":`/assets/defend-BT8TAbMa.png`,"./assets-legacy/cards/deflect.png":`/assets/deflect-C25gbOwx.png`,"./assets-legacy/cards/devour.png":`/assets/devour-CXvHmKvA.png`,"./assets-legacy/cards/eclipseSlash.png":`/assets/eclipseSlash-B5W8xu8L.png`,"./assets-legacy/cards/emberdance.png":`/assets/emberdance-CBOqWIEl.png`,"./assets-legacy/cards/empower.png":`/assets/empower-DauCte29.png`,"./assets-legacy/cards/executioner.png":`/assets/executioner-DI8vj7EW.png`,"./assets-legacy/cards/firstSpark.png":`/assets/firstSpark-CaQ5-JAc.png`,"./assets-legacy/cards/flawlessForm.png":`/assets/flawlessForm-C34QTET6.png`,"./assets-legacy/cards/flurry.png":`/assets/flurry-D8kOQQ9x.png`,"./assets-legacy/cards/fortify.png":`/assets/fortify-DEACu-Zo.png`,"./assets-legacy/cards/frenzy.png":`/assets/frenzy-BgGGtYpf.png`,"./assets-legacy/cards/guardedStrike.png":`/assets/guardedStrike-BBAeWagI.png`,"./assets-legacy/cards/heavyBlow.png":`/assets/heavyBlow-Btb1hEmS.png`,"./assets-legacy/cards/hex.png":`/assets/hex-D3QIN_GY.png`,"./assets-legacy/cards/ironSkin.png":`/assets/ironSkin-DIcLMutG.png`,"./assets-legacy/cards/leechBlade.png":`/assets/leechBlade-BgoitLbP.png`,"./assets-legacy/cards/limitBreak.png":`/assets/limitBreak-D3VHagIC.png`,"./assets-legacy/cards/lunge.png":`/assets/lunge-BKNULJcP.png`,"./assets-legacy/cards/momentum.png":`/assets/momentum-D0hGLm2N.png`,"./assets-legacy/cards/nightSight.png":`/assets/nightSight-1ggiNsUe.png`,"./assets-legacy/cards/novaflare.png":`/assets/novaflare-BtAOF5B2.png`,"./assets-legacy/cards/oblivionStrike.png":`/assets/oblivionStrike-Ck8D7viT.png`,"./assets-legacy/cards/offering.png":`/assets/offering-BDnzVcbS.png`,"./assets-legacy/cards/phantomBlades.png":`/assets/phantomBlades-CZgzKQZJ.png`,"./assets-legacy/cards/preparation.png":`/assets/preparation-B0_lrDKo.png`,"./assets-legacy/cards/pyreheart.png":`/assets/pyreheart-BzRCI95J.png`,"./assets-legacy/cards/quakeblow.png":`/assets/quakeblow-DZuM_zei.png`,"./assets-legacy/cards/quickSlash.png":`/assets/quickSlash-BHIEN7hF.png`,"./assets-legacy/cards/regrowth.png":`/assets/regrowth-DCr6zV9b.png`,"./assets-legacy/cards/resonantLance.png":`/assets/resonantLance-DFyDlcY4.png`,"./assets-legacy/cards/shardstorm.png":`/assets/shardstorm-CtSThqM0.png`,"./assets-legacy/cards/sidestep.png":`/assets/sidestep-D-t2UoHV.png`,"./assets-legacy/cards/smother.png":`/assets/smother-Boa7xrCA.png`,"./assets-legacy/cards/strike.png":`/assets/strike-CmEr2qad.png`,"./assets-legacy/cards/surge.png":`/assets/surge-D5JDOylt.png`,"./assets-legacy/cards/tempest.png":`/assets/tempest-DosF7X1A.png`,"./assets-legacy/cards/tithe.png":`/assets/tithe-BNvDlR3N.png`,"./assets-legacy/cards/toxicMist.png":`/assets/toxicMist-BUGxQeK0.png`,"./assets-legacy/cards/twinFangs.png":`/assets/twinFangs-BUW2V2Kq.png`,"./assets-legacy/cards/uppercut.png":`/assets/uppercut-C0A2yndn.png`,"./assets-legacy/cards/venomStrike.png":`/assets/venomStrike-CXIglW-b.png`,"./assets-legacy/cards/virulence.png":`/assets/virulence-pwX1yrdH.png`,"./assets-legacy/cards/warCry.png":`/assets/warCry-C7Rsrd4u.png`,"./assets-legacy/cards/wound.png":`/assets/wound-BTcmqSFC.png`,"./assets-legacy/enemies/abyssalKnight.png":`/assets/abyssalKnight-C-E-itbM.png`,"./assets-legacy/enemies/alphaFang.png":`/assets/alphaFang-DdGpQqF8.png`,"./assets-legacy/enemies/ashAcolyte.png":`/assets/ashAcolyte-BBrUUe1I.png`,"./assets-legacy/enemies/chaosHound.png":`/assets/chaosHound-D1R2CoW1.png`,"./assets-legacy/enemies/deepmaw.png":`/assets/deepmaw-la4seO5f.png`,"./assets-legacy/enemies/drownedOne.png":`/assets/drownedOne-BUBzJWlu.png`,"./assets-legacy/enemies/duskfang.png":`/assets/duskfang-CHUmjhPP.png`,"./assets-legacy/enemies/gloomslime.png":`/assets/gloomslime-BNhQuFFa.png`,"./assets-legacy/enemies/gravewarden.png":`/assets/gravewarden-BC9T04oe.png`,"./assets-legacy/enemies/heraldOfEnd.png":`/assets/heraldOfEnd-DZZiCKi_.png`,"./assets-legacy/enemies/leviathan.png":`/assets/leviathan-BhXEnJxl.png`,"./assets-legacy/enemies/mirelurker.png":`/assets/mirelurker-DidtJkek.png`,"./assets-legacy/enemies/obsidianGolem.png":`/assets/obsidianGolem-DkurqVoj.png`,"./assets-legacy/enemies/rootheart.png":`/assets/rootheart-B4o9Bf9P.png`,"./assets-legacy/enemies/shade.png":`/assets/shade-C2XrmBs-.png`,"./assets-legacy/enemies/shellback.png":`/assets/shellback-DCHXMl3u.png`,"./assets-legacy/enemies/siren.png":`/assets/siren-GVK3WWGi.png`,"./assets-legacy/enemies/sovereign.png":`/assets/sovereign-0p3wfa6T.png`,"./assets-legacy/enemies/sporeling.png":`/assets/sporeling-BeOaEEL0.png`,"./assets-legacy/enemies/starCultist.png":`/assets/starCultist-DQHXdHm5.png`,"./assets-legacy/enemies/thornling.png":`/assets/thornling-CqSviePj.png`,"./assets-legacy/enemies/tidecaller.png":`/assets/tidecaller-tGjufTlQ.png`,"./assets-legacy/enemies/voidColossus.png":`/assets/voidColossus-yr_eofA0.png`,"./assets-legacy/enemies/voidWisp.png":`/assets/voidWisp-D_7XlB9X.png`,"./assets-legacy/enemies/voltEel.png":`/assets/voltEel-CJeHty9B.png`,"./assets-legacy/enemies/watcherEye.png":`/assets/watcherEye---WypZip.png`,"./assets-legacy/enemies/waylayer.png":`/assets/waylayer-qynHTjuH.png`,"./assets-legacy/events/cursedIdol.png":`/assets/cursedIdol--s0qHWso.png`,"./assets-legacy/events/emberFountain.png":`/assets/emberFountain-D_Q0157p.png`,"./assets-legacy/events/fleshTrader.png":`/assets/fleshTrader-q8lAx2oa.png`,"./assets-legacy/events/forge.png":`/assets/forge-i5xE2DIv.png`,"./assets-legacy/events/forgottenShrine.png":`/assets/forgottenShrine-CYFo9R9B.png`,"./assets-legacy/events/gambler.png":`/assets/gambler-D4lmA3Yw.png`,"./assets-legacy/events/library.png":`/assets/library-CstvhNks.png`,"./assets-legacy/events/mirror.png":`/assets/mirror-Hp5O4ZPJ.png`,"./assets-legacy/events/ruinedCamp.png":`/assets/ruinedCamp-BvAZgrK0.png`,"./assets-legacy/events/voidChest.png":`/assets/voidChest-B34oBTge.png`,"./assets-legacy/events/woundedKnight.png":`/assets/woundedKnight-JN7kYI1u.png`,"./assets-legacy/heroes/ashwarden.png":`/assets/ashwarden-BjFdmgoK.png`,"./assets-legacy/heroes/duskblade.png":`/assets/duskblade-DBhvpfoa.png`,"./assets-legacy/potions/block.png":`/assets/block-CkTqIuTb.png`,"./assets-legacy/potions/energy.png":`/assets/energy-BNM23nR-.png`,"./assets-legacy/potions/fire.png":`/assets/fire-CAaEe0xi.png`,"./assets-legacy/potions/healing.png":`/assets/healing-KDHGTVtG.png`,"./assets-legacy/potions/strength.png":`/assets/strength-CIdQsSW6.png`,"./assets-legacy/potions/swift.png":`/assets/swift-xz-qROFX.png`,"./assets-legacy/potions/venom.png":`/assets/venom-D3l_eMKx.png`,"./assets-legacy/props/campfire.png":`/assets/campfire-B-OrO4zT.png`,"./assets-legacy/props/chest-open.png":`/assets/chest-open-B5Uzt-_6.png`,"./assets-legacy/props/chest.png":`/assets/chest-b-PO08AA.png`,"./assets-legacy/props/merchant.png":`/assets/merchant-COlFp5u3.png`,"./assets-legacy/title-background/background.png":`/assets/background-CqhrXvXS.png`}),Fg=[`png`,`jpg`,`jpeg`,`webp`],Ig={live:{label:`Live`,root:`assets`},legacy:{label:`Legacy`,root:`assets-legacy`}},Lg=`live`,Rg=(e=Lg)=>Ig[e]??Ig[Lg],zg=()=>Object.keys(Ig),Bg=(e=Lg)=>Rg(e).label,Vg=(e,t,n=Lg)=>{let{root:r}=Rg(n);for(let n of Fg){let i=Pg[`./${r}/${e}/${t}.${n}`];if(i)return i}return null},Hg=(e,t=Lg)=>{let{root:n}=Rg(t);return Object.entries(Pg).filter(([t])=>t.startsWith(`./${n}/${e}/`)).map(([,e])=>e)},Ug=0,Wg=()=>`g${++Ug}`,K=(e,t,n,r=1)=>`hsla(${e},${t}%,${n}%,${r})`;function Gg(e,t,n){return`<defs>
    ...
    <div class="title-btns">
      ...
      <button class="btn" data-a="embark">${t?`Begin Anew`:`Begin the Climb`}</button>
  ...
  </div>`,s.onclick=r=>{let i=r.target.closest(`[data-a]`);if(!i||i.disabled)return;let a=i.dataset.a;if(G_(),X.click(),a===`asp`)n.aspect=+i.dataset.i,ny();else if(a===`vow-`)n.vow=Math.max(0,n.vow-1),ny();else if(a===`vow+`)n.vow=Math.min(e.vowUnlocked,n.vow+1),ny();else if(a===`back`)$v(`title`);else if(a===`begin`){t&&(M_(t),Mg(t,!1),Z.run=null,Z.cb=null);let e=k_();iy(th(void 0,{aspect:n.aspect,vow:n.vow,lamplighter:A_(e,`lamplighter`),monument:e.lastFall,unlocks:e.unlocks,reveals:j_(e)}))}}}function ry(){Q_(),nf(0);let e=N_(),t=Object.entries(Uu).map(([t,n])=>{let r=e.deeds[n.stat]||0,i=r>=n.n,a=Math.min(100,Math.round(r/n.n*100)),o=n.unlocks.map(e=>{if(e===`aspect2`)return`The Ashwarden`;let[t,n]=e.split(`:`);return t===`card`?ku[n]?.name||n:Mu[n]?.name||n}).join(`, `),s=Vg(`deeds`,t),c=s?`<img class="deed-art" src="${s}" alt="">`:`<span class="deed-art-fallback">${J(`deed-${t}`,40)}</span>`;return`<div class="deed-row${i?` done`:``}">
      ${c}
      <div class="deed-body">
    ...
    <div class="battlefield">
      <div class="player-zone">
        ...
        <div class="cplate">
          <div class="hero-name">${qu[Z.run.aspect].name.toUpperCase()}</div>
    ...
    <div class="hand-zone"></div>
      ...
      </div>`,n.appendChild(l),r.enemies.push({root:l,art:Q(`.enemy-art`,l),intent:Q(`.intent`,l),fill:Q(`.fill`,l),ghost:Q(`.ghost`,l),hp:Q(`.hp-label`,l),block:Q(`.block-chip`,l),statuses:Q(`.status-row`,l),pv:Q(`.pv`,l),prev:Q(`.dmg-preview`,l),facets:Q(`.facet-row`,l)}),r.enemies[t].facets._tip={title:`Facets`,body:`Every creature is glass. Attacks that draw unblocked blood chip a facet; fill the gauge and the glass <b>shatters</b> — it loses its next action, is Cracked, and spills Embers into your lantern.`},i&&(Q(`.name`,l)._tip={title:`${i.name} — an elite's title`,body:i.text}),l.onclick=()=>Wy(t),l.addEventListener(`pointerenter`,e=>{e.pointerType===`mouse`&&Z.targeting&&(l.classList.add(`target-hover`),Hy())}),l.addEventListener(`pointerleave`,()=>{l.classList.remove(`target-hover`),Hy()})}),r.pHp=Q(`.p-hp`,t),r.pFill=Q(`.player-zone .fill`,t),r.pGhost=Q(`.player-zone .ghost`,t),r.pBlock=Q(`.p-block`,t),r.pStatus=Q(`.p-status`,t),r.hero=Q(`.hero-wrap`,t),r.energy=Q(`.energy-orb`,t),r.endTurn=Q(`.end-turn`,t),r.hand=Q(`.hand-zone`,t),r.draw=Q(`.pile-draw`,t),r.discard=Q(`.pile-discard`,t),r.exhaust=Q(`.pile-exhaust`,t),r.lantern=Q(`.lantern-btn`,t);let s=Hu[Z.run.art];s&&(Q(`.lb-art`,r.lantern).innerHTML=`<i>${J(`art-${Z.run.art}`,16)}</i>${s.cost}`,Q(`.lb-art`,r.lantern).style.color=s.tone),r.lantern._tip={title:s?`Lantern Art — ${s.name}`:`The Lantern`,body:`${s?`<b>${s.cost} Embers, once a turn:</b> ${s.text}<br><br>`:``}The lantern holds the <b>Embers</b> spilled by shattered and slain glass. Drag any card onto it to <b>kindle</b> — burn the card away for an ember, once a turn. Curses refuse the fire.`,sub:`A · use Art`},r.lantern.onclick=async()=>{if(!(Z.busy||!Z.cb||Z.cb.over)){if(G_(),!Xh(Z.run,Z.cb)){r.lantern.classList.add(`nope`),setTimeout(()=>r.lantern.classList.remove(`nope`),350),X.debuff();return}Ky(),Zh(Z.run,Z.cb),await Fb(),Vb()}},Z.ce=r,hy(a),gb(),vb(),setTimeout(()=>r.root.classList.remove(`intro`),1300),r.endTurn.onclick=Yy,r.draw.onclick=()=>{X.click(),Jv(`Draw Pile`,e.draw,{sub:`Order hidden — shown alphabetically`,inCombat:!0})},r.discard.onclick=()=>{X.click(),Jv(`Discard Pile`,e.discard,{inCombat:!0})},r.exhaust.onclick=()=>{X.click(),Jv(`The Ashes`,e.exhaust,{sub:`Burned away — each fed the lantern an ember`,inCombat:!0})},r.root.addEventListener(`pointerdown`,e=>{e.target.closest(`.enemy`)||e.target.closest(`.card`)||(Z.targeting?Ky():Z.hoveredCard!=null&&(Z.hoveredCard=null,Py()))}),Ay(e),xy(),Ny()}var py=e=>qf(Z.ce.enemies[e].art),my=()=>qf(Z.ce.hero);function hy(e){let t=Z.cb,n=Z.ce;if(!t||!n||Z.screen!==`combat`)return;let r=e??sv(x().shape,Z.run.act);n.root.style.setProperty(`--ground-y`,`${r.groundY}px`),n.root.style.setProperty(`--ledge-lip`,`${r.ledgeLip}px`);for(let e of[`backdrop`,`mid`,`ledge`]){let t=n.root.querySelector(`.sl-${e}`);if(!t)continue;let i=r.layers[e];t.style.height=`${i.h}px`,t.style.left=i.x?`calc(50% + ${i.x}px)`:``,t.style.bottom=e===`ledge`?`${Math.max(0,r.groundY+r.ledgeLip-i.h+i.y)}px`:`${i.y}px`,t.style.opacity=i.opacity,t.style.scale=i.zoom===1?``:String(i.zoom),t.style.objectPosition=`${i.posX}% ${i.posY}%`,t.style.setProperty(`--amp`,`${i.drift}px`)}let i=lv(`heroes`,qu[Z.run.aspect].id),a=Math.round(r.hero.w*i.scale),o=Math.round(r.hero.h*i.scale),s=n.root.querySelector(`.player-zone`);s.style.width=`${a}px`,s.style.height=`${o}px`,s.style.left=`${Math.round(r.hero.x-a/2)}px`,s.style.bottom=`${cv(r)+i.footY}px`;let c=uv(r,t.enemies.length),l=pv(c,t.enemies.map(e=>e.key));t.enemies.forEach((e,t)=>{let i=Fu[e.key],a=i.boss?`boss`:i.elite?`elite`:`normal`,o=mv(r,e.key,a,c[t],_(),v()),s=n.enemies[t].root;s.style.left=`${Math.round(c[t].x-o/2+dv(c[t],e.key))}px`,s.style.bottom=`${(c[t].y??0)+fv(c[t],e.key)}px`,s.style.width=s.style.height=`${o}px`,s.style.zIndex=String(l[t]),n.enemies[t].art.style.width=n.enemies[t].art.style.height=`${o}px`})}function gy(){hy(),Py(),vb()}var _y=0;addEventListener(`resize`,()=>{clearTimeout(_y),_y=setTimeout(()=>{Z.cb&&Z.ce&&Z.screen===`combat`&&gy()},120)});function vy(e,t,n){e.innerHTML=``;for(let[n,r]of Object.entries(t)){if(!r)continue;let t=ju[n]||{name:n,icon:`?`,kind:`buff`,desc:``},i=n===`str`&&r<0?`debuff`:t.kind,a=Vg(`statuses`,n),o=a?`<img class="schip-art" src="${a}" alt="">`:c_(`st-${n}`)?J(`st-${n}`,32):t.icon,s=Math.abs(r)>=2?`<span class="n">${r}</span>`:``,c=$(`span`,`schip ${i}`,`${o}${s}`);c._tip={title:t.name,body:t.desc.replace(/\bN\b/g,Math.abs(r)),sub:i===`debuff`?`Debuff`:`Buff`},e.appendChild(c)}}function yy(e){let t=Z.cb,n=Gh(e),r=bg(Z.run,t,e),i={attack:J(`sword`,19),block:J(`shield`,19),buff:J(`up`,19),debuff:J(`cloud`,19),heal:J(`plus`,19)}[n.intent]||J(`sword`,19),a=``;n.intent.startsWith(`attack`)&&(i=J(`sword`,19),a=r.times>1?`${r.dmg}×${r.times}`:`${r.dmg}`,n.intent===`attack_debuff`&&(i+=J(`cloud`,14)),n.intent===`attack_block`&&(i+=J(`shield`,14)),n.intent===`attack_buff`&&(i+=J(`up`,14)));let o=[];return r&&o.push(`attack for <b>${r.dmg}${r.times>1?`×${r.times}`:``}</b>`),n.block&&o.push(`gain Ward`),n.heal&&o.push(`heal itself`),n.fx?.some(e=>e.who===`player`)&&o.push(`afflict you`),n.fx?.some(e=>e.who!==`player`)&&o.push(`empower`),n.addCards&&o.push(`add ${n.addCards.n} ${ku[n.addCards.id].name}s to your discard`),{icon:i,txt:a,tip:{title:n.name,body:`Intends to ${o.join(`, `)||`act`}.`}}}function by(e,t=0){if(e.facetMax>8)return`<span class="pipnum">${J(`facet`,11)} ${e.chips}${t?`<i>+${t}</i>`:``}/${e.facetMax}</span>`;let n=``;for(let r=0;r<e.facetMax;r++)n+=`<span class="pip${r<e.chips?` filled`:r<e.chips+t?` willchip`:``}"></span>`;return n}function xy(){let e=Z.cb,t=Z.ce;if(!t)return;e.enemies.forEach((e,n)=>{let r=t.enemies[n],i=`${100*Math.max(0,e.hp)/e.maxHp}%`;if(r.fill.style.width=i,r.ghost.style.width=i,r.hp.textContent=`${Math.max(0,e.hp)}/${e.maxHp}`,r.block.classList.toggle(`zero`,e.block<=0),r.block.innerHTML=`${J(`shield`,13)} ${e.block}`,r.art.classList.toggle(`warded`,e.block>0),e.block<=0&&kv(r.art,!1),r.root.classList.toggle(`lowhp`,e.hp>0&&e.hp/e.maxHp<=.3),vy(r.statuses,e.statuses,!1),e.hp>0?r.facets.innerHTML=by(e):r.facets.innerHTML=``,e.hp<=0&&r.reaped&&r.root.classList.add(`gone`),e.hp>0&&e.flags.staggered)r.intent.className=`intent i-staggered`,r.intent.innerHTML=`<span class="ic">${J(`stagger`,19)}</span>STAGGERED`,r.intent._tip={title:`Staggered`,body:`The glass has shattered — this creature loses its next action while it reseams.`};else if(e.hp>0&&e.moveKey){let t=yy(e);r.intent.className=`intent i-${Gh(e).intent}`,r.intent.innerHTML=`<span class="ic">${t.icon}</span>${t.txt}`,r.intent._tip=t.tip}else r.intent.innerHTML=``}),t.lantern&&(Q(`.lb-count`,t.lantern).textContent=e.embers,Q(`.lb-pips`,t.lantern).innerHTML=Array.from({length:e.emberCap},(t,n)=>`<span class="lbp${n<e.embers?` lit`:``}" style="--a:${Math.round(n/(e.emberCap-1)*280-140)}deg"></span>`).join(``),t.lantern.classList.toggle(`unlit`,e.embers===0),t.lantern.classList.toggle(`ready`,Xh(Z.run,e)),t.lantern.classList.toggle(`art-spent`,e.artUsedTurn===e.turn&&!e.over));let n=e.player,r=`${100*Math.max(0,n.hp)/n.maxHp}%`;t.pFill.style.width=r,t.pGhost.style.width=r,t.pHp.textContent=`${Math.max(0,n.hp)}/${n.maxHp}`,t.pBlock.classList.toggle(`zero`,n.block<=0),t.pBlock.innerHTML=`${J(`shield`,13)} ${n.block}`,t.hero.classList.toggle(`warded`,n.block>0),n.block<=0&&kv(t.hero,!1),t.hero.classList.toggle(`lowhp`,n.hp/n.maxHp<=.3),vy(t.pStatus,n.statuses,!0),Q(`.num`,t.energy).textContent=n.energy,t.energy.classList.toggle(`spent`,n.energy===0);let i=Q(`.candles`,t.energy),a=Math.max(n.energyMax,n.energy);i.children.length!==a&&(i.innerHTML=Array.from({length:a},()=>`<span class="candle"></span>`).join(``)),[...i.children].forEach((e,t)=>e.classList.toggle(`lit`,t<n.energy)),Sy(e)}function Sy(e){let t=Z.ce;if(!t)return;let n=wy||{},r=[[t.draw,`draw`,n.draw==null?Math.max(0,e.draw.length-(Cy.draw||0)):n.draw],[t.discard,`discard`,n.discard==null?Math.max(0,e.discard.length-(Cy.discard||0)):n.discard],[t.exhaust,`ashes`,Math.max(0,e.exhaust.length-(Cy.ashes||0))]];for(let[e,t,n]of r){if(!e)continue;let r=f_(n),i=p_(n),a=e.querySelector(`.pile-stack`);if(Q(`.cnt`,e).textContent=n,!a||Number(a.dataset.count)===n)continue;a.dataset.count=String(n),a.dataset.tier=String(r);let o=Vg(`piles`,h_(t));if(a.replaceChildren(),a.classList.toggle(`is-empty`,i===0),!o){a.classList.add(`pile-stack-fallback`);continue}a.classList.remove(`pile-stack-fallback`);for(let e=0;e<i;e++){let t=document.createElement(`img`);t.src=o,t.alt=``,t.className=`pile-layer`,t.style.setProperty(`--rot`,`${m_(e,i)}deg`),a.appendChild(t)}}}var Cy={draw:0,discard:0,ashes:0},wy=null;function Ty(e,t=1){Cy[e]||(Cy[e]=0),Cy[e]+=Math.max(0,t|0)}function Ey(e,t=1){Cy[e]=Math.max(0,(Cy[e]||0)-Math.max(0,t|0))}function Dy(e,t){for(let n of e.queue)n.uid==null||String(n.uid)!==String(t)||(n.t===`toDiscard`&&Ty(`discard`,1),n.t===`exhaust`&&Ty(`ashes`,1))}var Oy=new Map;function ky(e){let t=[],n=0;for(;n<e.length&&(e[n].t===`draw`||e[n].t===`reshuffle`);)if(e[n].t===`reshuffle`)t.push({t:`reshuffle`,ev:e[n]}),n++;else{let r=[];for(;n<e.length&&e[n].t===`draw`;)r.push(e[n++]);t.push({t:`draws`,draws:r})}return t}function Ay(e){if(ub||!e?.queue?.length)return;let t=ky(e.queue);if(!t.length)return;let n=t.find(e=>e.t===`reshuffle`),r=t[0]?.t===`draws`?t[0].draws.length:0;wy={draw:t[0]?.t===`draws`?n?r:e.draw.length+r:0,discard:n&&n.ev.n||0};let i=0;for(let e of t)if(e.t===`draws`)for(let t of e.draws){let e=String(t.uid);Oy.has(e)||Oy.set(e,{landAt:null,seq:i++})}}function jy(e){let t=new Set;for(let n of e.queue)(n.t===`toDiscard`||n.t===`exhaust`||n.t===`powerConsumed`)&&n.uid!=null&&t.add(String(n.uid));return t}function My(e,t){setTimeout(()=>{e.isConnected&&(e.classList.remove(`draw-pending`),e.classList.add(`draw-in`),Py(),setTimeout(()=>e.classList.remove(`draw-in`),240))},t)}function Ny(){let e=Z.cb,t=Z.ce;if(!t)return;let n=t.hand,r=new Map(vv(`.card`,n).map(e=>[e.dataset.uid,e])),i=new Set(e.hand.map(e=>String(e.uid))),a=jy(e);for(let[e,t]of r)!i.has(e)&&!a.has(e)&&t.remove();for(let t of e.hand)if(r.has(String(t.uid))){let e=Lv(t,{inCombat:!0}),n=r.get(String(t.uid)),i=[`armed`,`draw-pending`,`draw-in`,`lifted`,`dragging`,`will-cast`,`will-burn`,`played-up`].filter(e=>n.classList.contains(e));n.replaceChildren(...e.childNodes),n.className=[e.className,...i].filter(Boolean).join(` `),n.onclick=e=>{e.stopPropagation(),Uy(t.uid)},_v&&(n.onmouseenter=()=>{Z.hoveredCard=t.uid,Py()},n.onmouseleave=()=>{Z.hoveredCard===t.uid&&(Z.hoveredCard=null),Py()})}else{let r=Lv(t,{inCombat:!0}),i=String(t.uid),a=Oy.get(i),o=e.queue.some(e=>e.t===`draw`&&String(e.uid)===i);if(!ub&&(a!=null||o)){typeof a==`object`&&a?.seq!=null&&(r.dataset.drawSeq=String(a.seq)),r.classList.add(`draw-pending`);let e=a==null?null:typeof a==`number`?a:a.landAt;e!=null&&(Oy.delete(i),My(r,e))}r.onclick=e=>{e.stopPropagation(),Uy(t.uid)},_v&&(r.onmouseenter=()=>{Z.hoveredCard=t.uid,X.hover(),Py()},r.onmouseleave=()=>{Z.hoveredCard===t.uid&&(Z.hoveredCard=null),Py()}),Iy(r,t.uid),n.appendChild(r)}Py()}function Py(){let e=Z.cb,t=Z.ce;if(!t)return;let n=e.hand.map(e=>String(e.uid)),r=new Map(vv(`.card`,t.hand).map(e=>[e.dataset.uid,e])),i=n.filter(e=>{let t=r.get(e);return t&&!t.classList.contains(`draw-pending`)}),a=i.length,o=Math.min(112,640/Math.max(a,1),(_()-246)/Math.max(a-1,1));n.forEach(t=>{let n=r.get(t);if(!n)return;let s=e.hand.find(e=>String(e.uid)===t);if(!s)return;let c=!sh(s).unplayable&&(lg(Z.run,e,s)??99)<=e.player.energy;n.classList.toggle(`unplayable-now`,!c);let l=Z.targeting?.kind===`card`&&String(Z.targeting.uid)===t,u=Z.hoveredCard!=null&&String(Z.hoveredCard)===t;if(n.classList.toggle(`armed`,l),n.classList.toggle(`lifted`,u&&!Z.busy&&!l),n.classList.contains(`draw-pending`)){n.style.transform=`translateX(-50%) translateY(26px) rotate(0deg)`,n.style.zIndex=15;return}let d=i.indexOf(t),f=a>1?(d-(a-1)/2)*Math.min(5,42/a):0,p=(d-(a-1)/2)*o,m=Math.abs(f)*3.2;n.style.transform=`translateX(calc(-50% + ${l?p*.4:p}px)) translateY(${m+26}px) rotate(${l?f*.5:f}deg)`,n.style.zIndex=u||l?40:20+d}),Hy()}var Fy=0;function Iy(e,t){e.addEventListener(`pointerdown`,n=>{if(!(Z.busy||!Z.cb||Z.cb.over||!n.isPrimary||Z.drag)){Z.drag={uid:t,id:n.pointerId,x0:n.clientX,y0:n.clientY,live:!1,free:!1};try{e.setPointerCapture(n.pointerId)}catch{}}}),e.addEventListener(`pointermove`,n=>{let r=Z.drag;if(!(!r||r.uid!==t||n.pointerId!==r.id)){if(!r.live){r.y0-n.clientY>26&&zy(r,e);return}if(r.free){let t=S(n.clientX,n.clientY);e.style.transform=`translate(calc(-50% + ${t.x-_()/2}px), ${t.y-v()+130}px) scale(1.12)`;let i=!!Ry(n.clientX,n.clientY)?.closest(`.lantern-btn`);e.classList.toggle(`will-burn`,i),e.classList.toggle(`will-cast`,!r.kindleOnly&&!i&&t.y<Ly())}else qy(n),Vy(n.clientX,n.clientY)}});let n=(n,r)=>{let i=Z.drag;if(!i||i.uid!==t||n.pointerId!==i.id||(!r&&i.live&&eb(t,e,{fromDrag:!0}),Z.drag=null,!i.live))return;if(Fy=performance.now(),e.classList.remove(`dragging`,`will-cast`,`will-burn`),Z.ce?.lantern?.classList.remove(`kindle-target`),r){Ky(),Py();return}if(Ry(n.clientX,n.clientY)?.closest(`.lantern-btn`)){let e=Z.cb.hand.find(e=>e.uid===t);if(e&&$h(Z.run,Z.cb,e)){Ky(),By(t);return}Ky(),Py();return}if(i.kindleOnly){Z.hoveredCard=null,Py();return}if(i.free){S(n.clientX,n.clientY).y<Ly()?Jy(t,null):(Z.hoveredCard=null,Py());return}let a=document.elementFromPoint(n.clientX,n.clientY)?.closest(`.enemy`),o=a?+a.dataset.idx:-1,s=Z.cb.enemies.filter(e=>e.hp>0);o>=0&&Z.cb.enemies[o].hp>0?Jy(t,o):s.length===1&&S(n.clientX,n.clientY).y<Ly()?Jy(t,s[0].idx):(Ky(),Py())};e.addEventListener(`pointerup`,e=>n(e,!1)),e.addEventListener(`pointercancel`,e=>n(e,!0))}var Ly=()=>Z.ce?.hand?C(Z.ce.hand).top-24:v()-260,Ry=(e,t)=>document.elementsFromPoint(e,t).find(e=>!e.closest(`.card`));function zy(e,t){let n=Z.cb,r=n.hand.find(t=>t.uid===e.uid);if(!r){Z.drag=null;return}let i=sh(r);if(i.unplayable||lg(Z.run,n,r)>n.player.energy){if($h(Z.run,n,r)){e.live=!0,e.free=!0,e.kindleOnly=!0,Z.hoveredCard=null,X.hover(),t.classList.add(`dragging`),Z.ce?.lantern?.classList.add(`kindle-target`);return}Z.drag=null,t.classList.add(`nope`),setTimeout(()=>t.classList.remove(`nope`),350),X.debuff();return}e.live=!0,Z.hoveredCard=null,X.hover(),$h(Z.run,n,r)&&Z.ce?.lantern?.classList.add(`kindle-target`),i.target===`enemy`?Gy({kind:`card`,uid:e.uid}):(e.free=!0,Ky(),t.classList.add(`dragging`))}async function By(e){if(Z.hoveredCard=null,!tg(Z.run,Z.cb,e)){Py();return}await Fb(),Vb()}function Vy(e,t){let n=document.elementFromPoint(e,t)?.closest(`.enemy`);Z.ce?.enemies.forEach(e=>e.root.classList.toggle(`target-hover`,e.root===n&&e.root.classList.contains(`targetable`))),Hy()}function Hy(){let e=Z.ce,t=Z.cb;if(!e||!t)return;let n=null;Z.targeting?.kind===`card`?n=t.hand.find(e=>e.uid===Z.targeting.uid):Z.drag?.live?n=t.hand.find(e=>e.uid===Z.drag.uid):Z.hoveredCard!=null&&!Z.busy&&(n=t.hand.find(e=>e.uid===Z.hoveredCard));let r=n?sh(n):null,i=Z.targeting?.kind===`card`||Z.drag?.live&&!Z.drag.free,a=t.enemies.filter(e=>e.hp>0).length,o=!!(n&&!t.over&&!r.unplayable&&!i);Jm();let s=o&&r.target===`self`;if(e.hero?.classList.toggle(`aim-target`,s),s){let t=Q(`.hero-sprite`,e.hero)||e.hero,n=qu[Z.run.aspect].id;Km(t,!0,hp(n))?e.hero.classList.add(`aim-mesh`):e.hero.classList.remove(`aim-mesh`)}else e.hero?.classList.remove(`aim-mesh`);t.enemies.forEach((s,c)=>{let l=e.enemies[c],u=null,d=!1;n&&!t.over&&s.hp>0&&!r.unplayable&&(r.target===`allEnemies`?u=xg(Z.run,t,n,c):r.target===`enemy`&&(i||a===1)&&(u=xg(Z.run,t,n,c),d=i&&a>1&&!l.root.classList.contains(`target-hover`)));let f=l.root.classList.contains(`target-hover`),p=r?.target===`allEnemies`&&(o||Z.drag?.live&&Z.drag.free),m=r?.target===`enemy`&&(a===1||i&&f),h=!!(n&&!t.over&&!r.unplayable&&s.hp>0&&(p||m));if(l.root.classList.toggle(`aim-target`,h),h&&Km(Q(`.enemy-sprite`,l.art)||l.art,!0,hp(s.key))?l.root.classList.add(`aim-mesh`):l.root.classList.remove(`aim-mesh`),u&&(u.total>0||u.chips>0)){l.prev.classList.remove(`show`,`lethal`,`dim`),l.prev.innerHTML=``,l.root.classList.toggle(`marked`,u.lethal&&!d);let e=Math.min(s.hp,u.loss)/s.maxHp;l.pv.style.left=`${Math.max(0,s.hp-u.loss)/s.maxHp*100}%`,l.pv.style.width=`${e*100}%`,l.pv.classList.toggle(`show`,u.loss>0),l.facets.innerHTML=by(s,d?0:u.chips),l.facets.classList.toggle(`willshatter`,u.willShatter&&!d)}else l.prev.classList.remove(`show`,`lethal`,`dim`),l.root.classList.remove(`marked`),l.pv.classList.remove(`show`),s.hp>0&&(l.facets.innerHTML=by(s)),l.facets.classList.remove(`willshatter`)})}function Uy(e){if(Z.busy||!Z.cb||Z.cb.over||performance.now()-Fy<350)return;let t=Z.cb,n=t.hand.find(t=>t.uid===e);if(!n)return;if(gv&&Z.hoveredCard!==e&&!(Z.targeting?.kind===`card`&&Z.targeting.uid===e)){Z.hoveredCard=e,X.hover(),Py();return}let r=sh(n),i=lg(Z.run,t,n),a=Q(`.card[data-uid="${e}"]`,Z.ce.hand);if(r.unplayable||i>t.player.energy){a?.classList.add(`nope`),setTimeout(()=>a?.classList.remove(`nope`),350),X.debuff();return}if(Z.targeting?.kind===`card`&&Z.targeting.uid===e)return Ky();if(r.target===`enemy`){let n=t.enemies.filter(e=>e.hp>0);if(n.length===1)return void Jy(e,n[0].idx);Gy({kind:`card`,uid:e})}else Jy(e,null)}function Wy(e){if(!Z.targeting||Z.busy)return;let t=Z.cb.enemies[e];if(!t||t.hp<=0)return;let n=Z.targeting;n.kind===`card`?Jy(n.uid,e):n.kind===`potion`&&Wv(n.slot,e)}function Gy(e){if(Z.targeting=e,Z.ce.root.classList.add(`targeting`),Z.cb.enemies.forEach((e,t)=>Z.ce.enemies[t].root.classList.toggle(`targetable`,e.hp>0)),Py(),document.addEventListener(`pointermove`,qy),qy._last)qy(qy._last);else{let e=Z.cb.enemies.findIndex(e=>e.hp>0);if(e>=0){let t=py(e);qy({clientX:t.x,clientY:t.y,synthetic:!0})}}}function Ky(){Z.targeting=null,Q(`#aim`).innerHTML=``,document.removeEventListener(`pointermove`,qy),Jm(),Z.ce&&(Z.ce.root.classList.remove(`targeting`),Z.ce.enemies.forEach(e=>e.root.classList.remove(`targetable`,`target-hover`,`aim-target`,`aim-mesh`)),Z.ce.hero?.classList.remove(`aim-target`,`aim-mesh`),Py()),Rv()}function qy(e){if(e.synthetic||(qy._last=e),!Z.targeting)return;let t;if(Z.targeting.kind===`card`){let e=Q(`.card[data-uid="${Z.targeting.uid}"]`);t=e?qf(e):{x:_()/2,y:v()-200}}else t={x:_()/2,y:60};let{x:n,y:r}=e.synthetic?{x:e.clientX,y:e.clientY}:S(e.clientX,e.clientY),i=(t.x+n)/2,a=Math.min(t.y,r)-120;if(Q(`#aim`).innerHTML=`<path d="M${t.x} ${t.y-80} Q${i} ${a} ${n} ${r}" fill="none" stroke="rgba(255,89,100,.85)" stroke-width="4" stroke-dasharray="4 10" stroke-linecap="round"/>
    <circle cx="${n}" cy="${r}" r="9" fill="none" stroke="rgba(255,89,100,.95)" stroke-width="3"/>`,Z.ce?.hero){let e=qf(Z.ce.hero),t=Q(`#lantern`);t.style.setProperty(`--lx`,`${Math.round(e.x+(n-e.x)*.3)}px`),t.style.setProperty(`--ly`,`${Math.round(e.y+(r-e.y)*.3)}px`)}}async function Jy(e,t){if(!$y.has(String(e))){let t=Q(`.card[data-uid="${e}"]`,Z.ce?.hand);t&&eb(e,t)}Ky(),Z.hoveredCard=null,dg(Z.run,Z.cb,e,t)&&(await Fb(t),Vb())}async function Yy(){Z.busy||!Z.cb||Z.cb.over||(Ky(),X.click(),hg(Z.run,Z.cb),await Fb(),Vb())}function Xy(e){let t=$(`div`,`turn-banner`,e);bv().appendChild(t),setTimeout(()=>t.remove(),1150)}function Zy(e,t,n,r,{n:i=6,color:a=`#ffe9ac`,size:o=8,dur:s=640,glyph:c=``,cls:l=`flymote`,done:u=null}={}){let d=Q(`#floaties`);for(let f=0;f<i;f++){let p=$(`div`,l,c);p.style.left=`${e}px`,p.style.top=`${t}px`,c?p.style.color=a:(p.style.width=`${o}px`,p.style.height=`${o}px`,p.style.background=`radial-gradient(circle at 35% 30%, #fff, ${a} 55%, transparent 85%)`),d.appendChild(p);let m=(e+n)/2+(Math.random()-.5)*140,h=Math.min(t,r)-50-Math.random()*80,g=p.animate([{transform:`translate(-50%,-50%) scale(0.5)`,opacity:0},{transform:`translate(calc(-50% + ${m-e}px), calc(-50% + ${h-t}px)) scale(1.05)`,opacity:1,offset:.45},{transform:`translate(calc(-50% + ${n-e}px), calc(-50% + ${r-t}px)) scale(0.55)`,opacity:.95}],{duration:s,delay:f*46,easing:`cubic-bezier(.32,.05,.35,1)`});g.onfinish=()=>{p.remove(),f===i-1&&u&&u()}}}function Qy(e){!e||ub||(e.classList.remove(`pile-bump`),e.offsetWidth,e.classList.add(`pile-bump`))}var $y=new Map;function eb(e,t,n={}){if(e==null||!t)return;let r=C(t);r.width<2||$y.set(String(e),{x:r.left+r.width/2,y:r.top+r.height/2,w:r.width,h:r.height,fromDrag:!!n.fromDrag})}function tb(e){return $y.get(String(e))||null}function nb(e){let t=String(e),n=$y.get(t);return $y.delete(t),n||null}function rb(e){let t=e?.querySelector(`.pile-layer`);if(t){let e=C(t);if(e.width>2&&e.height>2)return{w:e.width,h:e.height}}let n=e?.querySelector(`.pile-stack`);if(n){let e=C(n);if(e.width>2)return{w:e.width,h:e.width*(148/96)}}return{w:96,h:130}}function ib(){let e=Z.ce?.hand?.querySelector(`.card:not(.played-up):not(.draw-pending):not(.lifted):not(.armed):not(.dragging)`)||Z.ce?.hand?.querySelector(`.card:not(.played-up):not(.draw-pending)`);if(e){let t=parseFloat(getComputedStyle(e).getPropertyValue(`--cw`));if(t>2)return{w:t,h:Math.round(t*1.42)};if(e.offsetWidth>2)return{w:e.offsetWidth,h:e.offsetHeight||Math.round(e.offsetWidth*1.42)}}return{w:152,h:216}}function ab(){let e=Z.ce?.hand?.querySelector(`.card`);if(e){let t=parseFloat(getComputedStyle(e).bottom);if(Number.isFinite(t))return t}return 8}function ob(e,t){let n=Math.max(1,t|0),r=Math.max(0,Math.min(n-1,e|0)),i=Math.min(112,640/n,(_()-246)/Math.max(n-1,1)),a=n>1?(r-(n-1)/2)*Math.min(5,42/n):0,o=(r-(n-1)/2)*i,s=Math.abs(a)*3.2+26,c=ib(),l=v()-ab(),u=Z.ce?.hand;if(u){let e=C(u);e.height>2&&(l=e.bottom-ab())}return{x:_()/2+o,y:l-c.h/2+s}}function sb(e,{pileBtn:t,src:n,fallback:r}={}){if(e&&typeof e==`object`&&e.w)return{w:e.w,h:e.h};if(e===`hand`)return ib();if(e===`src`&&n?.w)return{w:n.w,h:n.h};if(e===`src`&&n?.el){let e=C(n.el);if(e.width>2)return{w:e.width,h:e.height}}return e===`pile`||e==null?rb(t):r||rb(t)}function cb(e,t,n,r={}){let i=Q(`#floaties`),a=qf(t),o=e.length,{stagger:s,flightDur:c,awaitMs:l}=r.schedule||g_(o,n);if(ub||o===0)return Promise.resolve(0);let u=r.sizePile||t,d=r.face===`back`||r.face===`card`?null:Vg(`piles`,h_(r.pileArt||`draw`));return e.forEach((e,t)=>{let n=e.el?(()=>{let t=C(e.el);return{x:t.left+t.width/2,y:t.top+t.height/2,w:t.width,h:t.height}})():e,o=e.dest||a,l=sb(r.fromSize||`pile`,{pileBtn:u,src:n}),f=r.toSize==null?l:sb(r.toSize,{pileBtn:u,src:n,fallback:l}),p=l.w>0?f.w/l.w:1,m=e.inst||r.cardInst,h,g=1,_=p;if(r.face===`card`&&m){let e=ib(),r=e.w,i=e.h;g=r>0?l.w/r:1,_=r>0?f.w/r:p,h=Lv(m,{inCombat:!0,size:r}),h.classList.add(`flycard-face`),Object.assign(h.style,{position:`absolute`,left:`${n.x}px`,top:`${n.y}px`,width:`${r}px`,height:`${i}px`,margin:0,transform:`translate(-50%,-50%) scale(${g})`,zIndex:58+t,pointerEvents:`none`})}else h=$(`div`,d?`flycard flycard-pile`:`flycard flycard-back`),h.style.left=`${n.x}px`,h.style.top=`${n.y}px`,h.style.width=`${l.w}px`,h.style.height=`${l.h}px`,h.style.zIndex=String(58+t),d&&(h.style.backgroundImage=`url(${d})`);i.appendChild(h);let v=r.arc===`smooth`,y=r.easing||(v?`cubic-bezier(.22,.7,.28,1)`:`cubic-bezier(.32,.05,.35,1)`),b=v?n.x+(o.x-n.x)*.42+(Math.random()-.5)*18:(n.x+o.x)/2+(Math.random()-.5)*80,x=v?Math.min(n.y,o.y)-18-Math.random()*16:Math.min(n.y,o.y)-40-Math.random()*50,S=b-n.x,w=x-n.y,T=o.x-n.x,E=o.y-n.y,D=g+(_-g)*(v?.55:.45),O=v?[{transform:`translate(-50%,-50%) scale(${g})`,opacity:1,offset:0},{transform:`translate(calc(-50% + ${S*.55}px), calc(-50% + ${w*.55}px)) scale(${g+(D-g)*.5})`,opacity:1,offset:.35},{transform:`translate(calc(-50% + ${S}px), calc(-50% + ${w}px)) scale(${D})`,opacity:.98,offset:.62},{transform:`translate(calc(-50% + ${T}px), calc(-50% + ${E}px)) scale(${_})`,opacity:.92,offset:1}]:[{transform:`translate(-50%,-50%) scale(${g})`,opacity:.95},{transform:`translate(calc(-50% + ${S}px), calc(-50% + ${w}px)) scale(${D})`,opacity:1,offset:.45},{transform:`translate(calc(-50% + ${T}px), calc(-50% + ${E}px)) scale(${_})`,opacity:.9}];h.animate(O,{duration:c,delay:t*s,easing:y,fill:`forwards`}).onfinish=()=>h.remove()}),yv(l)}function lb(e,t){return(e||[]).find(e=>String(e.uid)===String(t))||null}var ub=matchMedia(`(prefers-reduced-motion: reduce)`).matches;function db(e,t,n,r=640){if(t=Math.round(t),n=Math.round(n),ub||t===n){e.textContent=n;return}let i=performance.now(),a=o=>{let s=Math.min(1,(o-i)/r),c=1-(1-s)**3;e.textContent=Math.round(t+(n-t)*c),s<1?requestAnimationFrame(a):(e.textContent=n,e.classList.remove(`tick`),e.offsetWidth,e.classList.add(`tick`))};requestAnimationFrame(a)}function fb(e){let t=getComputedStyle(e).transform;if(!t||t===`none`)return 0;let n=t.match(/matrix(?:3d)?\(([^)]+)\)/);if(!n)return 0;let r=n[1].split(`,`).map(e=>parseFloat(e.trim())),i=r.length===16?r[13]:r[5];return Math.max(0,-i)}function pb(e,t){let n=$(`div`,`cast-shadow`);if(e){let t=document.createElement(`img`);t.src=e,t.alt=``,t.setAttribute(`aria-hidden`,`true`),n.appendChild(t)}else if(t){let e=t.cloneNode(!0);e.setAttribute(`aria-hidden`,`true`),n.appendChild(e)}else n.classList.add(`cast-shadow-blob`);return n}function mb(e){if(!e.shadow||!e.art)return;let t=C(e.art);e.shadow.style.left=`${t.left}px`,e.shadow.style.top=`${t.top}px`,e.shadow.style.width=`${t.width}px`,e.shadow.style.height=`${t.height}px`}function hb(e,t){if(!e.shadow||!e.shadowId)return;mb(e);let n=fp(e.shadowId),r=e.shadowMax||16,i=Math.min(1,t/r),a=n.sx*(1-i*.26),o=n.sy*(1-i*.5),s=n.opacity*(1-i*.55),c=n.blur+i*2.8,l=n.skew*(1-i*.35),u=n.dx+n.skew*.35*(1-i*.5),d=n.dy;e.shadow.style.setProperty(`--foot-ox`,`${n.ox}%`),e.shadow.style.setProperty(`--foot-oy`,`${n.oy}%`),e.shadow.style.setProperty(`--sh-sx`,a.toFixed(3)),e.shadow.style.setProperty(`--sh-sy`,o.toFixed(3)),e.shadow.style.setProperty(`--sh-o`,s.toFixed(3)),e.shadow.style.setProperty(`--sh-blur`,`${c.toFixed(1)}px`),e.shadow.style.setProperty(`--sh-skew`,`${l.toFixed(2)}deg`),e.shadow.style.setProperty(`--sh-x`,`${u.toFixed(1)}px`),e.shadow.style.setProperty(`--sh-y`,`${d}px`)}function gb(){let e=Z.ce,t=Z.cb;e.rig=[];let n=Q(`.cast-shadow-layer`,e.root);n&&(n.innerHTML=``);let r=(t,r,i,a,o,s,c=0,l=``,u=``,d=0)=>{let f=Q(`svg`,r),p=Q(`.enemy-sprite`,r)||r,m=Q(`.raster-art`,p);if(!f&&!m)return;let h=Math.random()*100;if(f){let e=Q(`.breathe`,f);e&&(e.style.animationDuration=`${(2.5+h%1.9).toFixed(2)}s`,e.style.animationDelay=`${(-(h%3.1)).toFixed(2)}s`,e.style.setProperty(`--brY`,(1.022+h%.024).toFixed(3)),e.style.setProperty(`--sw`,`${(h*7%1.7-.85).toFixed(2)}deg`)),vv(`.hover-float`,f).forEach(e=>e.style.animationDelay=`${(-(h%2.7)).toFixed(2)}s`)}else if(s){p.classList.add(`idle-${s}`),p.style.animationDelay=`${(-(h%2.8)).toFixed(2)}s`;let e=u?mp(u):null;if(e!=null&&p.style.setProperty(`--float-y`,`${e}px`),s===`wisp`||s===`plant`){let e=$(`div`,`idle-motes`);e.style.setProperty(`--mote`,`hsla(${c},85%,62%,0.6)`),p.appendChild(e)}}let g=pb(l||m?.src||``,f);(n||r).appendChild(g);let _={root:t,art:r,sprite:p,svg:f,eyes:f?vv(`.eye`,f):[],fire:f?Q(`.innerfire`,f):null,pool:null,shadow:g,shadowId:u,footY:d,shadowMax:{wisp:20,eye:20,siren:14,shade:14,plant:10,slime:6}[s]||12,seed:h,isHero:a,idx:o,dx:0,dy:0};e.rig.push(_),hb(_,0)},i=uv(sv(x().shape,Z.run.act),t.enemies.length);t.enemies.forEach((t,n)=>{let a=Fu[t.key].art;r(e.enemies[n].root,e.enemies[n].art,`hsla(${a.hue},90%,66%,.72)`,!1,n,a.kind,a.hue,Vg(`enemies`,t.key),t.key,fv(i[n],t.key))});let a=qu[Z.run.aspect].id;r(e.hero,e.hero,`rgba(127,212,255,.62)`,!0,0,`humanoid`,0,Vg(`heroes`,a),a,lv(`heroes`,a).footY)}function _b(){if(!Cp())return;let e=Z.ce,t=Z.cb;if(!e||!t)return;let n=[],r=Vg(`heroes`,qu[Z.run.aspect].id),i=e.hero&&(Q(`.hero-sprite`,e.hero)||e.hero);r&&i&&n.push({el:i,url:r,kind:`humanoid`,id:qu[Z.run.aspect].id}),t.enemies.forEach((t,r)=>{let i=Vg(`enemies`,t.key),a=e.enemies[r]?.art,o=a&&(Q(`.enemy-sprite`,a)||a);i&&o&&n.push({el:o,url:i,kind:Fu[t.key].art.kind,id:t.key})}),Wm(n),t.player.block>0&&i&&kv(i,!0,!0),t.enemies.forEach((t,n)=>{if(t.block<=0)return;let r=e.enemies[n]?.art,i=r&&(Q(`.enemy-sprite`,r)||r);i&&kv(i,!0,!0)})}function vb(){requestAnimationFrame(()=>requestAnimationFrame(_b))}function yb(){Nm()}var bb=!1;function xb(e){if(bb)return;requestAnimationFrame(xb);let t=Z.ce,n=Z.cb;if(ub||!n||Z.screen!==`combat`||!t?.rig)return;let r=null,i=n.enemies.findIndex(e=>e.hp>0);Z.targeting&&qy._last?r=S(qy._last.clientX,qy._last.clientY):i>=0&&(r=py(i));let a=my();for(let i of t.rig){let t=i.isHero?n.player:n.enemies[i.idx];if(!i.isHero&&t.hp<=0){i.pool&&(i.pool.style.opacity=0),i.shadow&&(i.shadow.style.opacity=0);continue}let o=fb(i.sprite);i.sprite.classList.contains(`mesh-live`)&&(o+=Gm(i.sprite)),hb(i,o);let s=i.isHero?r:a;if(s&&i.eyes.length){let e=qf(i.art),t=Math.atan2(s.y-e.y,s.x-e.x);i.dx+=(Math.cos(t)*2.4-i.dx)*.08,i.dy+=(Math.sin(t)*1.6-i.dy)*.08;let n=`translate(${i.dx.toFixed(2)}px,${i.dy.toFixed(2)}px)`;for(let e of i.eyes)e.style.transform=n}let c=.45+.55*(Math.max(0,t.hp)/t.maxHp);i.root.dataset.choreo===`attack`&&(c+=1.1),(t.statuses?.str||0)>0&&(c+=.3);let l=.86+.14*Math.sin(e*.006+i.seed)*Math.sin(e*.0021+i.seed*3);i.fire&&(i.fire.style.opacity=Math.min(.55,(.05+.13*c)*l).toFixed(3)),i.pool&&(i.pool.style.opacity=Math.min(.85,(.3+.4*c)*l).toFixed(3))}}var Sb=!1,Cb={archetype:`slash`,cardId:null,enemyIdx:null},wb=!1,Tb=!1,Eb=0,Db={beast:`slash`,rogue:`slash`,knight:`slash`,sovereign:`slash`,golem:`blunt`,treeboss:`blunt`,crab:`blunt`,leviathan:`blunt`,zombie:`blunt`,serpent:`pierce`,crawler:`pierce`,maw:`pierce`,plant:`pierce`,wisp:`void`,shade:`void`,eye:`void`,siren:`void`,cultist:`void`,slime:`poison`},Ob=matchMedia(`(prefers-reduced-motion: reduce)`).matches,kb=new Set([`golem`,`treeboss`,`leviathan`,`crab`]),Ab=new Set([`wisp`,`shade`,`siren`,`eye`,`cultist`]);function jb(e,t=1,n=`humanoid`){if(Ob||!e)return Promise.resolve();let r=kb.has(n),i=Ab.has(n),a=r?[{transform:`translateX(0) scale(1,1)`},{transform:`translateX(0) scale(1.08,0.86)`,offset:.35},{transform:`translateX(0) scale(1,1)`}]:i?[{transform:`translateX(0) translateY(0) scale(1,1)`},{transform:`translateX(${6*t}px) translateY(-5px) scale(0.98,1.02)`,offset:.4},{transform:`translateX(${10*t}px) translateY(-2px) scale(1,1)`,offset:.7},{transform:`translateX(0) translateY(0) scale(1,1)`}]:[{transform:`translateX(0) scale(1,1)`},{transform:`translateX(${-8*t}px) scale(0.97,1.02)`,offset:.3},{transform:`translateX(${34*t}px) scale(1.02,0.99)`,offset:.62},{transform:`translateX(0) scale(1,1)`}];return e.dataset.choreo=`attack`,e.animate(a,{duration:r?420:i?380:330,easing:`cubic-bezier(0.34, 1.56, 0.64, 1)`}).finished.finally(()=>{delete e.dataset.choreo}).catch(()=>{})}function Mb(e,t=1){Ob||!e||(Fm(e),e.animate([{transform:`translateX(0) scale(1,1)`,filter:`brightness(1)`},{transform:`translateX(${9*t}px) scale(0.97,1.03)`,filter:`brightness(1.9)`,offset:.25},{transform:`translateX(0) scale(1,1)`,filter:`brightness(1)`}],{duration:300,easing:`cubic-bezier(0.22, 1, 0.36, 1)`}))}function Nb(e){return Ob||!e?Promise.resolve():e.animate([{transform:`translateY(0) rotate(0deg)`,filter:`brightness(1)`},{transform:`translateY(5px) rotate(-2.5deg)`,filter:`brightness(0.6)`}],{duration:360,easing:`cubic-bezier(0.22, 1, 0.36, 1)`,fill:`forwards`}).finished.catch(()=>{})}function Pb(e,t=200){if(Cp()&&Bm(e.root,0)){for(let t=0;t<3;t++)zm(e.art);let n=performance.now(),r=()=>{let i=Math.min(1,(performance.now()-n)/t),a=i*i*(3-2*i);Bm(e.root,a)&&i<1&&requestAnimationFrame(r)};requestAnimationFrame(r);return}Pm(e.root);let n=e.art&&Q(`.cracks`,e.art);n&&(n.insertAdjacentHTML(`beforeend`,Jg(!0)),n.children.length<9&&n.insertAdjacentHTML(`beforeend`,Jg(!0))),e.root.classList.add(`igniting`)}async function Fb(e=null){let t=Z.cb,n=Z.ce;Z.busy=!0,n.endTurn.classList.add(`enemy-phase`);let r=t.queue;for(;r.length;){let t=r[0];try{t.t===`draw`||t.t===`reshuffle`?await Rb(r):(r.shift(),await Bb(t,e))}catch(e){console.error(`vfx event error`,t,e)}}Z.busy=!1,t.over||n.endTurn.classList.remove(`enemy-phase`),wy=null,xy(),Ny(),zv()}function Ib(e){let t=[];for(;e[0]?.t===`draw`||e[0]?.t===`reshuffle`;)if(e[0].t===`reshuffle`)t.push({t:`reshuffle`,ev:e.shift()});else{let n=[];for(;e[0]?.t===`draw`;)n.push(e.shift());t.push({t:`draws`,draws:n})}return t}async function Lb(e){let t=Z.cb,n=Z.ce;X.card();let r=e.n||6;wy?(wy.discard=r,wy.draw=0,Sy(t)):(Ty(`draw`,r),Sy(t)),await cb(Array.from({length:r},()=>qf(n.discard)),n.draw,560,{fromSize:`pile`,sizePile:n.discard,pileArt:`discard`}),wy?(wy.discard=0,wy.draw=r):Ey(`draw`,r),Qy(n.draw),Bf(qf(n.draw).x,qf(n.draw).y-46,`Reshuffle`,`notice`),Sy(t)}async function Rb(e){let t=Z.cb,n=Z.ce,r=Ib(e),i=r.find(e=>e.t===`reshuffle`);Z.hoveredCard!=null&&(Z.hoveredCard=null);let a=r[0]?.t===`draws`?r[0].draws.length:0;wy={draw:r[0]?.t===`draws`?i?a:t.draw.length+a:0,discard:i&&i.ev.n||0},Oy.clear();let o=0;for(let e of r)if(e.t===`draws`)for(let t of e.draws)Oy.set(String(t.uid),{landAt:null,seq:o++});Ny(),Sy(t);let s=vv(`.card`,n.hand).filter(e=>!e.classList.contains(`draw-pending`)).length,c=0;for(let e of r){if(e.t===`reshuffle`){await Lb(e.ev);continue}let r=e.draws,i=r.length;if(!i)continue;let a=__(i,500);if(r.forEach((e,t)=>{let r=String(e.uid),i=ub?0:a.flightDur+t*a.stagger;Oy.delete(r);let o=Q(`.card[data-uid="${r}"]`,n.hand);o&&!ub?My(o,i):o&&o.classList.remove(`draw-pending`)}),ub)Py(),await yv(40);else{let e=qf(n.draw),i=r.map((n,r)=>{let i=t.hand.find(e=>String(e.uid)===String(n.uid))||{uid:n.uid,id:n.id,up:!1,bonus:0},a=ob(s+c+r,s+c+r+1);return{x:e.x,y:e.y,inst:i,dest:a}});r.forEach((e,n)=>{setTimeout(()=>{wy&&(wy.draw=Math.max(0,(wy.draw||0)-1),Sy(t))},n*a.stagger)}),cb(i,n.hand,500,{fromSize:`pile`,toSize:`hand`,sizePile:n.draw,face:`card`,schedule:a}),Qy(n.draw),r.forEach((e,t)=>setTimeout(()=>X.draw(),t*a.stagger)),await yv(a.awaitMs)}c+=i,wy&&(wy.draw=Math.max(0,wy.draw||0)),Sy(t)}wy=null,xy()}var zb=null;async function Bb(e,t){let n=Z.cb,r=Z.ce;switch(e.t){case`chip`:{let t=r.enemies[e.idx],{x:n,y:i}=py(e.idx);X.chip(),If(n,i,{color:`#e8f4ff`,n:5,speed:190,size:1.8,grav:240,kind:`spark`}),xy(),t.facets.classList.remove(`pop`),t.facets.offsetWidth,t.facets.classList.add(`pop`),await yv(110);break}case`shatter`:{let t=r.enemies[e.idx],{x:n,y:i}=py(e.idx);zb={x:n,y:i},X.shatter(),Pf(90),Lf(n,i,`#dfeaff`,10,700,5),If(n,i,{color:`#dfeaff`,n:26,speed:430,size:2.4,grav:300,kind:`spark`}),Bf(n,i-58,`${J(`stagger`,20)} SHATTER`,`shatterf`),Nf(10),af(.9),t.art,t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),xy(),await yv(380);break}case`adamantHold`:{let{x:t,y:n}=py(e.idx);X.blocked(),Bf(t,n-52,`THE GLASS HOLDS`,`blockedf`),Lf(t,n,`#d8c27a`,8,480,4),xy(),await yv(260);break}case`ember`:if(e.n>0&&r.lantern){let t=zb||my(),n=qf(r.lantern);Zy(t.x,t.y,n.x,n.y,{n:Math.min(e.n*2,5),color:`#ffb35a`,size:6,dur:460}),X.ember(),setTimeout(()=>{r.lantern.classList.remove(`pop`),r.lantern.offsetWidth,r.lantern.classList.add(`pop`),xy()},440),await yv(300)}else xy();zb=null;break;case`kindle`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand);t&&(zb=qf(t)),X.kindle(),await yv(60);break}case`art`:{Cb={archetype:`fire`,cardId:`art:${e.id}`,enemyIdx:null},wb=!1;{let{x:t,y:n}=qf(r.lantern);tp[`art:${e.id}`]?.(t,n),wb=!0}let t=Hu[e.id],{x:n,y:i}=my(),a=r.lantern?qf(r.lantern):{x:n,y:i};X.art(),Ff(t.tone,.12,.5),Lf(a.x,a.y,t.tone,10,620,5),zf(n,i,t.tone,12),Bf(n,i-84,t.name.toUpperCase(),`artf`);let o=Vg(`arts`,e.id);if(o){let e=$(`img`,`art-cast`);e.src=o,Q(`#floaties`).appendChild(e),e.style.left=`${n}px`,e.style.top=`${i-30}px`,e.animate([{transform:`translate(-50%,-50%) scale(0.4)`,opacity:0},{transform:`translate(-50%,-58%) scale(1)`,opacity:1,offset:.3},{transform:`translate(-50%,-70%) scale(1.05)`,opacity:0}],{duration:900,easing:`cubic-bezier(.2,.7,.3,1)`}).onfinish=()=>e.remove()}af(.7),xy(),await yv(420);break}case`staggered`:{let t=r.enemies[e.idx],{x:n,y:i}=py(e.idx);X.stagger(),Bf(n,i-76,`STAGGERED`,`staggerf`),t.root.classList.add(`reseaming`),setTimeout(()=>t.root.classList.remove(`reseaming`),720),xy(),await yv(520);break}case`smolderJump`:{let t=py(e.from),n=py(e.to);X.poison(),Zy(t.x,t.y,n.x,n.y,{n:5,color:`#d3a15a`,size:7,dur:460}),await yv(400);break}case`turn`:e.n>1&&(Xy(`YOUR TURN`),X.turn()),xy(),await yv(e.n>1?500:120);break;case`endTurn`:Sb=!1,Xy(`ENEMY TURN`),await yv(480);break;case`draw`:await Rb([e]);break;case`reshuffle`:await Lb(e),xy();break;case`play`:{let i=Q(`.card[data-uid="${e.uid}"]`,r.hand);if(X.card(),Sb=!0,Eb=0,Cb={archetype:ku[e.id]?.vfx||`slash`,cardId:e.id,enemyIdx:null},wb=!1,Tb=!1,!wb&&tp[e.id]&&[`ascension`,`pyreheart`,`emberdance`,`limitBreak`].includes(e.id)){let t=n.enemies.findIndex(e=>e.hp>0),r=e.id===`limitBreak`&&t>=0?py(t):my();tp[e.id](r.x,r.y),wb=!0}if(i&&t!=null&&n.enemies[t]){let n=C(i),{x:r,y:a}=py(t);$y.set(String(e.uid),{x:r,y:a,w:n.width*.22,h:n.height*.22});let o=i.cloneNode(!0);Object.assign(o.style,{position:`fixed`,left:`${n.left}px`,top:`${n.top}px`,width:`${n.width}px`,height:`${n.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(o),i.remove(),o.animate([{transform:`none`,opacity:1},{transform:`translate(${r-n.left-n.width/2}px,${a-n.top-n.height/2}px) scale(0.22) rotate(14deg)`,opacity:0}],{duration:270,easing:`cubic-bezier(.45,0,.9,.5)`}).onfinish=()=>o.remove()}else i&&(i.classList.add(`played-up`),i.offsetWidth,tb(e.uid)?.fromDrag||eb(e.uid,i));Dy(n,e.uid),xy(),await yv(200);break}case`hitEnemy`:{let t=r.enemies[e.idx],{x:i,y:a}=py(e.idx);if(e.poison)X.poison(),zf(i,a,`#d3a15a`,14),Bf(i,a-20,`${e.amount}`,`poisonf`);else{let o=e.amount>=16;if(Sb&&Cb.cardId&&!String(Cb.cardId).startsWith(`art:`)&&(Tb||=(await jb(r.hero,1,`humanoid`),!0)),X.slash(),e.amount>0&&X.hit(),!wb&&Cb.cardId&&tp[Cb.cardId]&&(tp[Cb.cardId](i,a),wb=!0),$f(i,a,Cb.archetype,Math.min(1,e.amount/24)),Mb(t.root,1),e.blocked>0&&(X.blocked(),Bf(i,a+26,`${J(`shield`,19)}${e.blocked}`,`blockedf`),If(i,a+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`}),n.enemies[e.idx].block===0&&e.amount===0&&(Bf(i,a-2,`GUARD SHATTERED`,`shatterf`),Qf(i,a,`#9fd4ff`,14))),e.amount>0){let t=e.killingBlow&&e.overkill>=8?`dmg-overkill`:e.killingBlow?`dmg-kill`:o?`dmg-big`:`dmg`;Bf(i,a-24,`${e.amount}`,t,{tint:Jf[Cb.archetype]||``,dx:(Eb++%3-1)*34})}else e.blocked||Bf(i,a-24,`0`,`blockedf`);Nf(Math.min(4+e.amount*.5,15)),af(Math.min(.2+e.amount/26,1)),o&&(Pf(70),Lf(i,a,`#ffd8a0`,10,620,5)),e.killingBlow&&(Pf(e.overkill>=8?130:90),af(Math.min(1.6,.6+e.overkill*.06)),Lf(i,a,`#ffffff`,8,780,5),Lf(i,a,`#ffd8a0`,14,900,4),Ff(`#ffe6b0`,.09,.28),e.overkill>=8&&(Ff(`#ffffff`,.12,.24),If(i,a,{color:`#fff3d6`,n:26,speed:620,size:2.6,grav:200,kind:`spark`}),If(i,a,{color:`#ffd76e`,n:12,speed:300,size:3.4,grav:120,kind:`spark`}))),e.amount>0&&t.art}t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),xy(),await yv(230);break}case`die`:{let t=r.enemies[e.idx],i=n.enemies[e.idx],{x:a,y:o}=py(e.idx);zb={x:a,y:o},i.boss&&(document.body.classList.add(`worldstop`),t.root.classList.add(`doomed`),Pf(110),await yv(820),document.body.classList.remove(`worldstop`),t.root.classList.remove(`doomed`)),await Nb(t.art);let s=i.boss?320:200;ub||(Pb(t,s),await yv(s)),(i.boss||i.elite?X.bigDeath:X.death)(),ub||Bm(t.root,1);let c=Cp()?Hm(t.root):null;c||Pm(t.root),Kf(t.art,c||{}),If(a,o,{color:`#dfeaff`,n:30,speed:480,size:2.6,grav:340,kind:`spark`}),If(a,o,{color:`#c9b0ff`,n:26,speed:380,size:3.2,grav:60}),Lf(a,o,`#e8dcff`,12,720,6),Ff(`#ffffff`,i.boss?.24:.1,.3),Nf(i.boss?22:12),af(i.boss?2:.9),t.root.classList.add(`dying`),setTimeout(()=>{t.root.classList.remove(`dying`),t.root.classList.add(`gone`),t.reaped=!0},830),await yv(i.boss?900:500);break}case`hitPlayer`:{let{x:t,y:i}=my();if(e.source===`poison`?(X.poison(),zf(t,i,`#d3a15a`,14)):e.source===`burn`||e.source===`self`?X.debuff():e.source===`thorns`?X.blocked():(X.slash(),e.amount>0&&(X.hit(),Ff(`#ff2233`,Math.min(.05+e.amount*.012,.3),.3)),$f(t,i,Cb.archetype,Math.min(1,e.amount/24)),Mb(r.hero,-1)),e.blocked>0&&(X.blocked(),Bf(t,i+30,`${J(`shield`,19)}${e.blocked}`,`blockedf`),If(t,i+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`}),n.player.block===0&&e.amount===0&&(Bf(t,i-2,`GUARD SHATTERED`,`shatterf`),Qf(t,i,`#9fd4ff`,14))),e.amount>0){let n=e.amount>=16;Bf(t,i-30,`${e.amount}`,n?`dmg-big`:`dmg`,{tint:Jf[Cb.archetype]||``,dx:(Eb++%3-1)*34}),Nf(Math.min(5+e.amount*.6,18)),af(Math.min(.3+e.amount/22,1.2))}else e.blocked||Bf(t,i-30,`0`,`blockedf`);xy(),zv(),await yv(240);break}case`blockGain`:{let t=e.who===`player`,{x:n,y:i}=t?my():py(e.who);X.block(),kv(t?Q(`.hero-sprite`,r.hero)||r.hero:Q(`.enemy-sprite`,r.enemies[e.who]?.art)||r.enemies[e.who]?.art,!0,!0),Bf(n,i-10,`${J(`shield`,22)} ${e.n}`,`blockf`);let a=t?r.pBlock:r.enemies[e.who].block;a.classList.remove(`pulse`),a.offsetWidth,a.classList.add(`pulse`),xy(),await yv(140);break}case`status`:{let{x:t,y:n}=e.who===`player`?my():py(e.who),r=ju[e.id]||{name:e.id,kind:`buff`},i=r.kind===`debuff`||e.id===`str`&&e.n<0;(e.id===`poison`?X.poison:i?X.debuff:X.buff)(),Bf(t,n-46,`${e.n>0?`+`:``}${e.n} ${r.name}`,i?`debufff`:`bufff`),i||zf(t,n,`#9fc8ff`,6),xy(),await yv(170);break}case`heal`:{let{x:t,y:n}=e.who===`player`?my():py(e.who);X.heal(),zf(t,n,`#8fe8a0`,14),Bf(t,n-30,`+${e.n}`,`healf`),xy(),zv(),await yv(200);break}case`energy`:xy(),r.energy.classList.remove(`pop`),r.energy.offsetWidth,r.energy.classList.add(`pop`);break;case`exhaust`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand),i=nb(e.uid),a=lb(n.exhaust,e.uid);if(ub){t&&t.remove(),Ey(`ashes`,1),xy();break}if(i?.fromDrag||t?.classList.contains(`played-up`)||!t&&i){let e=null;if(i?.fromDrag)e={...i,inst:a};else if(t){let n=C(t);n.width>2&&(e={x:n.left+n.width/2,y:n.top+n.height/2,w:n.width,h:n.height,inst:a})}!e&&i&&(e={...i,inst:a}),!e&&a&&(e={...qf(r.hand),...ib(),inst:a}),t&&(t.classList.add(`draw-pending`),Py()),a&&e&&await cb([{...e,inst:a}],r.exhaust,200,{fromSize:`src`,toSize:`pile`,sizePile:r.exhaust,face:`card`,cardInst:a,schedule:{stagger:0,flightDur:200,awaitMs:200},arc:`smooth`,easing:`cubic-bezier(.22,.7,.28,1)`}),t&&t.remove(),Ey(`ashes`,1),Qy(r.exhaust),xy();break}let o=t?C(t):null,s=o&&o.width>2?{x:o.left+o.width/2,y:o.top+o.height/2,w:o.width,h:o.height}:i;if(t&&s){let e=t.cloneNode(!0);Object.assign(e.style,{position:`fixed`,left:`${s.x-s.w/2}px`,top:`${s.y-s.h/2}px`,width:`${s.w}px`,height:`${s.h}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`,opacity:`1`}),document.getElementById(`floaties`).appendChild(e),t.remove(),e.animate([{clipPath:`circle(80% at 50% 55%)`,filter:`brightness(1)`},{clipPath:`circle(44% at 50% 55%)`,filter:`brightness(1.8) saturate(1.6) sepia(0.45)`,offset:.45},{clipPath:`circle(0% at 50% 55%)`,filter:`brightness(2.6) saturate(2) sepia(0.85)`}],{duration:540,easing:`ease-in`}).onfinish=()=>e.remove(),If(s.x,s.y,{color:`#ffb066`,n:22,speed:190,grav:-150,size:2.4,life:.85});let n=qf(r.exhaust);Zy(s.x,s.y,n.x,n.y,{n:8,color:`#ffb066`,size:5,dur:480}),Qy(r.exhaust),await yv(260)}else t&&t.remove();Ey(`ashes`,1),xy();break}case`discardHand`:{let t=e.uids||[],i=t.length;if(X.card(),!i){xy();break}if(ub){t.forEach(e=>{nb(e),Q(`.card[data-uid="${e}"]`,r.hand)?.remove()}),xy();break}Ty(`discard`,i);let a=__(i,500),o=[];for(let e of t){let t=Q(`.card[data-uid="${e}"]`,r.hand),i=lb(n.discard,e)||{uid:e,id:t?.dataset?.id,up:!1,bonus:0},a=nb(e),s;if(a)s={x:a.x,y:a.y,w:a.w,h:a.h};else if(t){let e=C(t);s={x:e.left+e.width/2,y:e.top+e.height/2,w:e.width,h:e.height}}else s={...qf(r.hand),...ib()};o.push({...s,inst:i,el:t})}for(let e of o)e.el&&e.el.classList.add(`draw-pending`);if(Py(),o.length){let e=Q(`#floaties`),t=qf(r.discard),s=rb(r.discard);o.forEach((i,o)=>{let c=i.w>2?i.w:ib().w,l=i.h>2?i.h:ib().h,u=c>0?s.w/c:.65,d;if(i.el)d=i.el.cloneNode(!0),d.classList.remove(`draw-pending`,`lifted`,`armed`,`dragging`,`will-cast`,`will-burn`,`played-up`,`unplayable-now`),d.classList.add(`flycard-face`),d.removeAttribute(`style`),Object.assign(d.style,{position:`absolute`,left:`${i.x}px`,top:`${i.y}px`,width:`${c}px`,height:`${l}px`,margin:0,transform:`translate(-50%,-50%) scale(1)`,zIndex:58+o,pointerEvents:`none`,opacity:`1`});else if(i.inst?.id)d=Lv(i.inst,{inCombat:!0,size:c}),d.classList.add(`flycard-face`),Object.assign(d.style,{position:`absolute`,left:`${i.x}px`,top:`${i.y}px`,width:`${c}px`,height:`${l}px`,margin:0,transform:`translate(-50%,-50%) scale(1)`,zIndex:58+o,pointerEvents:`none`});else return;e.appendChild(d);let f=i.x+(t.x-i.x)*.45+(Math.random()-.5)*24,p=Math.min(i.y,t.y)-28-Math.random()*20,m=f-i.x,h=p-i.y,g=t.x-i.x,_=t.y-i.y,v=1+(u-1)*.5;d.animate([{transform:`translate(-50%,-50%) scale(1)`,opacity:1,offset:0},{transform:`translate(calc(-50% + ${m}px), calc(-50% + ${h}px)) scale(${v})`,opacity:1,offset:.5},{transform:`translate(calc(-50% + ${g}px), calc(-50% + ${_}px)) scale(${u})`,opacity:.92,offset:1}],{duration:a.flightDur,delay:o*a.stagger,easing:`cubic-bezier(.22,.7,.28,1)`,fill:`forwards`}).onfinish=()=>d.remove(),setTimeout(()=>{Ey(`discard`,1),Sy(n),Qy(r.discard),X.card()},a.flightDur+o*a.stagger)}),await yv(a.awaitMs);let c=i-o.length;c>0&&Ey(`discard`,c)}else Ey(`discard`,i);t.forEach(e=>Q(`.card[data-uid="${e}"]`,r.hand)?.remove()),xy();break}case`toDiscard`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand),i=nb(e.uid),a=lb(n.discard,e.uid);if(!ub&&a&&(t||i)){let e=null;if(i?.fromDrag)e={...i,inst:a};else if(t){let n=C(t);n.width>2&&(e={x:n.left+n.width/2,y:n.top+n.height/2,w:n.width,h:n.height,inst:a})}if(!e&&i&&(e={...i,inst:a}),!e){Ey(`discard`,1),Qy(r.discard),xy();break}t&&(t.classList.add(`draw-pending`),Py()),await cb([e],r.discard,200,{fromSize:`src`,toSize:`pile`,sizePile:r.discard,face:`card`,cardInst:a,schedule:{stagger:0,flightDur:200,awaitMs:200},arc:`smooth`,easing:`cubic-bezier(.22,.7,.28,1)`}),t&&t.remove()}else t?t.remove():!ub&&a&&await cb([{...qf(r.hand),...ib(),inst:a}],r.discard,200,{fromSize:`hand`,toSize:`pile`,sizePile:r.discard,face:`card`,cardInst:a,schedule:{stagger:0,flightDur:200,awaitMs:200},arc:`smooth`,easing:`cubic-bezier(.22,.7,.28,1)`});Ey(`discard`,1),Qy(r.discard),xy();break}case`enemyAct`:{let t=r.enemies[e.idx],{x:i,y:a}=py(e.idx);Eb=0;let o=Fu[n.enemies[e.idx].key]?.moves?.[e.move],s=Db[Fu[n.enemies[e.idx].key]?.art?.kind]||`slash`;Cb={archetype:o?.intent?.startsWith(`attack`)?s:o?.intent===`debuff`?`void`:o?.intent===`buff`||o?.intent===`block`?`ward`:s,cardId:null,enemyIdx:e.idx},wb=!1,Tb=!1,t.intent.classList.remove(`telegraph`),t.intent.offsetWidth,t.intent.classList.add(`telegraph`),Bf(i,a-90,e.name,`movef`),await yv(300),o?.intent?.startsWith(`attack`)?(await jb(t.root,-1,Fu[n.enemies[e.idx].key]?.art?.kind),Tb=!0):await yv(320),t.intent.classList.remove(`telegraph`);break}case`intent`:xy();break;case`addCard`:Bf(_()/2,v()*.62,`${ku[e.id].name} added to ${e.where===`hand`?`hand`:`discard`}`,`notice`),X.debuff(),xy(),Ny(),await yv(240);break;case`relicProc`:{let t=Q(`.hud-relic[data-relic="${e.id}"]`);t&&(t.classList.remove(`proc`),t.offsetWidth,t.classList.add(`proc`)),await yv(90);break}case`maxHp`:{let{x:t,y:n}=my();Bf(t,n-60,`+${e.n} MAX HP`,`healf`),X.buff(),await yv(160);break}case`potion`:X.potion(),await yv(120);break;case`powerConsumed`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand),n=t?qf(t):{x:_()/2,y:v()-180};t&&t.remove();let{x:i,y:a}=my();ub||(Zy(n.x,n.y,i,a,{n:7,color:`#c9a8ff`,size:7,dur:560}),setTimeout(()=>{Lf(i,a,`#c9a8ff`,12,460,4),zf(i,a,`#c9a8ff`,8)},560)),X.buff(),await yv(ub?40:300);break}case`victory`:if(Z.lastPerfect=!!e.perfect,await yv(320),X.victory(),Ff(`#ffe9ac`,.16,.6),e.perfect){let e=$(`div`,`turn-banner perfect-banner`,`PERFECT`);bv().appendChild(e),setTimeout(()=>e.remove(),1400),await yv(500)}break;case`defeat`:{await yv(400),X.defeat(),Ff(`#300`,.5,1.2);let e=Q(`#lantern`);e.classList.add(`gutter`),e.style.setProperty(`--la`,`1`),e.style.setProperty(`--lr`,`160px`),await yv(900);break}}}function Vb(){let e=Z.cb;!e||!e.over||(e.result===`win`?Hb():Ub())}function Hb(){Qv(`victory-out`);let e=Z.run,t=Z.cb.kind,n=Z.cb.affix;if(Z.cb=null,e.pendingCombat=null,t===`boss`&&e.act>=2){let{newUnlocks:t}=P_(e,!0);M_(e),Mg(e,!0),$v(`end`,{won:!0,newUnlocks:t});return}$v(`reward`,{kind:t,rewards:Fh(e,t,n)})}function Ub(){Qv(`defeat`);let e=Z.run,t=R_(e),n=e.map.nodes.find(t=>t.id===e.nodeId),r=n?n.row:Math.max(1,e.floorsClimbed-1),{newUnlocks:i}=P_(e,!1);M_(e),Mg(e,!1),$v(`end`,{won:!1,newUnlocks:i,offers:t,fallAct:e.act,fallRow:r})}function Wb({kind:e,rewards:t}){let n=Z.run,r=bv(),i=e===`boss`?`BOSS VANQUISHED`:e===`elite`?`ELITE SLAIN`:`VICTORY`,a=Z.lastPerfect?`<div class="perfect-seal">✦ PERFECT — the glass untouched ✦</div>`:`<div class="ornament">✦ ✦ ✦</div>`;Z.lastPerfect=!1,r.innerHTML=`<div class="center-panel screen-enter">${Cv()}<div class="panel">
  ...
  </div></div>`;let r=Q(`.big-choices`,n),i=!1,a=()=>{r.querySelectorAll(`button`).forEach(e=>{e.disabled=!0,e.onclick=null,e.style.pointerEvents=`none`})},o=t=>{if(!i){if(i=!0,a(),jh(e,t).already){Kb();return}t?X.relic():X.click(),Og(e),Kb()}};for(let e of t){let t=Mu[e],n=$(`button`,`relic-pick`);n.innerHTML=`<span class="relic-chip" style="--tone:${t.tone}">${Tv(e,26)}</span><span><b>${t.name}</b><span class="rd">${t.text}</span></span>`,n.onclick=()=>o(e),r.appendChild(n)}let s=$(`button`,`btn ghost`,`Take none`);s.style.marginTop=`10px`,s.onclick=()=>o(null),r.appendChild(s)}function Kb(){let e=Z.run;e.act++,e.omens.push(mh(e,`omens`)?rh(e):null),e.nodeId=null,e.map=lh(e),_h(e,Math.round(e.player.maxHp*.35)),nf(e.act),Ud(e.act,0),Z_(e.act),Og(e),Qv(`act-change`),$v(`map`),X.victory()}function qb(e){let t=Bu[e.omens?.[e.act]];if(!t||Z.screen!==`map`)return;let n=e.omens[e.act],r=Vg(`omens`,n),i=$(`div`,`turn-banner omen-banner`,`${r?`<img class="ob-art" src="${r}" alt="">`:`<span class="ob-glyph" style="color:${t.tone}">${J(`omen-${n}`,22)}</span>`} OMEN — ${t.name.toUpperCase()}<div class="ob-sub">${t.text}</div>`);bv().appendChild(i),X.omen(),setTimeout(()=>i.remove(),4200)}function Jb(){let e=Z.run,t=e.player.deck.some(e=>!e.up&&ku[e.id].up);bv().innerHTML=`<div class="center-panel screen-enter">${Cv()}<div class="panel">
