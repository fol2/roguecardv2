...
void main() {
  ...
  </defs>`}var sp=`stroke="#070a12" stroke-width="3.6" paint-order="stroke" stroke-linejoin="round"`;function cp(e){return e.replace(/<path(?![^>]*stroke=)(?![^>]*fill="none")([^>]*?)\/>/g,`<path$1 ${sp}/>`).replace(/<(circle|ellipse)([^>]*fill="url\(#[^"]+[bd]\)"[^>]*?)\/>/g,(e,t,n)=>n.includes(`stroke=`)?e:`<${t}${n} ${sp}/>`)}function lp(e=!1){let t=58+Math.random()*84,n=55+Math.random()*80,r=``,i=e?5:3;for(let a=0;a<i;a++){let i=Math.random()*Math.PI*2,a=t,o=n;r+=`M${a.toFixed(1)} ${o.toFixed(1)}`;let s=3+Math.floor(Math.random()*3);for(let t=0;t<s;t++){let t=(e?15:10)*(.6+Math.random());i+=(Math.random()-.5)*1.15,a+=Math.cos(i)*t,o+=Math.sin(i)*t,r+=`L${a.toFixed(1)} ${o.toFixed(1)}`}}return`<g class="crack"><path d="${r}" stroke="#0a0d18" stroke-width="3" fill="none" opacity=".75"/><path d="${r}" stroke="#dfeaff" stroke-width="1.3" fill="none" opacity=".8"/></g>`}var J=(e,t,n,r)=>`<circle class="eye" cx="${e}" cy="${t}" r="${n}" fill="${r}"/><circle cx="${e}" cy="${t}" r="${n*2.2}" fill="${r}" opacity="0.18"/>`,up={wisp(e,t,n){return`<g class="breathe">
    ...
    </g>`}};function dp(e){let t=ap(),n=q(e.hue,90,66),r=cp((up[e.kind]||up.slime)(t,e.hue,n));return`<svg class="enemy-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${op(t,e.hue,n)}
    ...
    ${r}
    <g class="cracks"></g>
  </svg>`}var fp=[{hue:225,glow:`#7fd4ff`},{hue:26,glow:`#ffb15a`}];function pp(e=0){let t=ap(),n=fp[e]||fp[0],r=n.hue,i=n.glow;return`<svg class="hero-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${op(t,r,i)}
    ...
    <g class="cracks"></g>
  </svg>`}var mp={strike:`⚔`,defend:`⛨`,eclipseSlash:`☾`,twinFangs:`⑂`,quickSlash:`≫`,heavyBlow:`⬇`,cleave:`⋔`,venomStrike:`☠`,lunge:`➹`,guardedStrike:`⛊`,brace:`⛨`,sidestep:`↯`,preparation:`♻`,deflect:`⛉`,leechBlade:`♆`,tempest:`≋`,uppercut:`⇑`,flurry:`⁂`,executioner:`✠`,momentum:`⤴`,bulwark:`☗`,surge:`✦`,toxicMist:`☁`,cripple:`⛓`,warCry:`♯`,fortify:`⧉`,bloodRite:`♥`,empower:`⚔`,agility:`❥`,ironSkin:`⬡`,regrowth:`❋`,oblivionStrike:`✸`,phantomBlades:`⚚`,devour:`♅`,annihilate:`✹`,aegis:`⛨`,offering:`♱`,limitBreak:`⚡`,catalyst:`⚗`,ascension:`☽`,bastion:`♜`,frenzy:`※`,virulence:`☣`,wound:`✂`,burn:`✹`,hex:`♄`,chisel:`◬`,firstSpark:`✧`,ashBite:`☄`,smother:`☁`,quakeblow:`⬲`,resonantLance:`↟`,tithe:`⚖`,pyreheart:`♥`,ashenChoir:`♬`,flawlessForm:`❖`,nightSight:`☾`,novaflare:`✺`,emberdance:`❂`,shardstorm:`❉`},hp=e=>{let t=9;for(let n of e)t=Math.imul(t^n.charCodeAt(0),387420489);return(t^t>>>9)>>>0};function gp(e,t){let n=ap(),r=hp(e),i={attack:356,skill:205,power:268,status:160,curse:300}[t]??205,a=(i+30+r%40)%360,o=q(i,85,66),s=q(a,80,60),c=r%360,l=``;if(t===`attack`)l=`<path d="M30 120 Q75 40 150 28" stroke="${o}" stroke-width="7" fill="none" opacity=".9"/>
      ...
      <path d="M62 106 L118 50" stroke="${s}" stroke-width="5" opacity=".7"/>`;let u=mp[e]||`✦`;return`<svg viewBox="0 0 180 150" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}function _p(e){let t=ap();return`<svg viewBox="0 0 40 52" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function vp(e=!1){let t=ap();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function yp(){let e=ap();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}function bp(){let e=ap();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    ${op(e,40,`#ffd166`)}
  ...
  </svg>`}function xp(e,t){let n=ap(),r=q(t,80,66);return`<svg viewBox="0 0 220 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}var Sp={sword:`<path d="M18.5 5 L10 13.5" stroke-width="3"/><path d="M6.8 11.6 L12.4 17.2" stroke-width="2.2"/><path d="M8.6 15.4 L4.8 19.2" stroke-width="2.6"/>`,skull:`<path d="M12 3.2 a6.8 6.8 0 0 1 6.8 6.8 c0 2.6-1.4 4.4-3 5.5 V18.5 h-7.6 V15.5 c-1.6-1.1-3-2.9-3-5.5 A6.8 6.8 0 0 1 12 3.2 Z" fill="currentColor" stroke="none"/><circle cx="9.4" cy="10" r="1.7" fill="rgba(0,0,0,.8)" stroke="none"/><circle cx="14.6" cy="10" r="1.7" fill="rgba(0,0,0,.8)" stroke="none"/><path d="M10.5 20.8 v-2 M13.5 20.8 v-2" stroke-width="1.8"/>`,crown:`<path d="M4.5 17.5 L5.2 8.5 L9 12 L12 6 L15 12 L18.8 8.5 L19.5 17.5 Z" fill="currentColor" stroke="none"/><path d="M4.5 20 h15" stroke-width="2.2"/>`,chest:`<rect x="4" y="6.5" width="16" height="13" rx="2.2" fill="none" stroke-width="2.2"/><path d="M4 12 h16" stroke-width="1.8"/><rect x="10.4" y="10.2" width="3.2" height="4.4" rx="1" fill="currentColor" stroke="none"/>`,flame:`<path d="M12 2.8 C9.4 7.4 6.8 9.8 6.8 13.6 a5.2 5.2 0 0 0 10.4 0 C17.2 9.8 14.6 7.4 12 2.8 Z" fill="currentColor" stroke="none"/><path d="M12 11.4 c-1.7 2.3-1.7 3.9 0 5.4 1.7-1.5 1.7-3.1 0-5.4 Z" fill="rgba(0,0,0,.5)" stroke="none"/>`,coin:`<circle cx="12" cy="12" r="5.6" fill="none" stroke-width="2.2"/><path d="M5.4 5.4 L8 8 M18.6 5.4 L16 8 M5.4 18.6 L8 16 M18.6 18.6 L16 16" stroke-width="2"/>`,shield:`<path d="M12 2.8 L19 5.8 v5.6 c0 4.6-3.1 7.6-7 9.8 -3.9-2.2-7-5.2-7-9.8 V5.8 Z" fill="none" stroke-width="2.3"/><path d="M12 6.4 v11" stroke-width="1.6" opacity=".55"/>`,cloud:`<path d="M7.2 16.5 a3.9 3.9 0 1 1 .7-7.7 A4.9 4.9 0 0 1 17.4 9.6 a3.4 3.4 0 0 1 -.6 6.9 Z" fill="currentColor" stroke="none"/>`,plus:`<path d="M12 5.2 v13.6 M5.2 12 h13.6" stroke-width="3.4"/>`,up:`<path d="M12 4 L19 12 h-4.1 v8 h-5.8 v-8 H5 Z" fill="currentColor" stroke="none"/>`,cards:`<rect x="4.4" y="5.6" width="9.4" height="13.4" rx="1.8" transform="rotate(-8 9 12.5)" fill="none" stroke-width="2"/><rect x="10.6" y="5" width="9.4" height="13.4" rx="1.8" transform="rotate(7 15.5 11.5)" fill="none" stroke-width="2"/>`,hammer:`<rect x="9.6" y="3.4" width="9.6" height="5.4" rx="1.2" transform="rotate(22 14.5 6)" fill="currentColor" stroke="none"/><path d="M11.6 10.2 L5.2 20" stroke-width="2.6"/>`,scissors:`<path d="M7.6 7.6 L17.5 17.8 M16.4 7.6 L6.5 17.8" stroke-width="2.2"/><circle cx="6" cy="19.2" r="2.2" fill="none" stroke-width="1.8"/><circle cx="18" cy="19.2" r="2.2" fill="none" stroke-width="1.8"/>`,question:`<path d="M8.6 8.6 a3.4 3.4 0 1 1 5 3 c-1.1 .7-1.6 1.4-1.6 2.8" fill="none" stroke-width="2.6"/><circle cx="12" cy="18.6" r="1.7" fill="currentColor" stroke="none"/>`,facet:`<path d="M12 3.4 L20 12 L12 20.6 L4 12 Z" fill="none" stroke-width="2.3"/><path d="M12 3.4 v17.2 M4 12 h16" stroke-width="1.2" opacity=".55"/>`,ember:`<path d="M12 3.4 C10 7 8.2 8.8 8.2 11.6 a3.8 3.8 0 0 0 7.6 0 C15.8 8.8 14 7 12 3.4 Z" fill="currentColor" stroke="none"/><circle cx="7" cy="18.4" r="1.4" fill="currentColor" stroke="none" opacity=".8"/><circle cx="12" cy="20" r="1.7" fill="currentColor" stroke="none"/><circle cx="17" cy="18.4" r="1.4" fill="currentColor" stroke="none" opacity=".8"/>`,lantern:`<path d="M9 6.2 h6 M8 6.2 L8 15.6 a4 3 0 0 0 8 0 V6.2" fill="none" stroke-width="2"/><path d="M12 8.4 c-1.5 2-1.5 3.4 0 4.7 1.5-1.3 1.5-2.7 0-4.7 Z" fill="currentColor" stroke="none"/><path d="M10.6 3.6 h2.8 v2.6 h-2.8 Z M10 19.8 h4" stroke-width="1.8"/>`,stagger:`<path d="M12 2.8 L13.8 8.6 L19.8 7 L15.6 11.6 L21 14.8 L14.6 14.9 L15.8 21 L11.9 16.2 L8 21 L9.2 14.9 L3 14.8 L8.4 11.6 L4.2 7 L10.2 8.6 Z" fill="currentColor" stroke="none"/>`,unlitLantern:`<path d="M9 6.2 h6 M8 6.2 L8 15.6 a4 3 0 0 0 8 0 V6.2" fill="none" stroke-width="2" opacity=".65"/><path d="M10.6 3.6 h2.8 v2.6 h-2.8 Z M10 19.8 h4" stroke-width="1.8" opacity=".65"/><path d="M10 10 L14 14 M14 10 L10 14" stroke-width="1.6" opacity=".8"/>`,monument:`<path d="M9.5 20 L10.2 6.5 L12 3.4 L13.8 6.5 L14.5 20 Z" fill="currentColor" stroke="none"/><path d="M6 20.6 h12" stroke-width="2.2"/><path d="M12 8.6 c-1.2 1.6-1.2 2.7 0 3.8 1.2-1.1 1.2-2.2 0-3.8 Z" fill="rgba(0,0,0,.55)" stroke="none"/>`},Cp=e=>`<g fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">${Sp[e]||``}</g>`;function wp(e,t=18){return`<svg class="gicon" width="${t}" height="${t}" viewBox="0 0 24 24" aria-hidden="true">${Cp(e)}</svg>`}function Tp(e,t=18){let n=t/24;return`<g transform="translate(${-t/2},${-t/2}) scale(${n})">${Cp(e)}</g>`}var Ep=`spirebound_vigil_v1`,Dp=`spirebound_stats_v1`,Op=null,kp=new Map;function Ap(){if(Op)return Op;try{if(typeof localStorage<`u`)return Op=localStorage}catch{}return Op={getItem:e=>kp.has(e)?kp.get(e):null,setItem:(e,t)=>kp.set(e,t),removeItem:e=>kp.delete(e)}}var jp={runs:0,wins:0,slain:0,shatters:0,kindles:0,perfects:0,smolderKills:0,unlitVisited:0,embersSpent:0,bestVow:0,bestFloor:0};function Mp(){let e=null;try{e=Ap().getItem(Ep)}catch{}let t=null;try{t=JSON.parse(e)}catch{}let n={v:1,deeds:{},unlocks:[],vowUnlocked:0,lastFall:null,...t||{}};if(n.deeds={...jp,...n.deeds||{}},Array.isArray(n.unlocks)||(n.unlocks=[]),e==null){try{let e=JSON.parse(Ap().getItem(Dp));e&&(n.deeds.runs=e.runs||0,n.deeds.wins=e.wins||0)}catch{}n.deeds.wins>0&&(n.vowUnlocked=1)}return n}function Np(e){try{Ap().setItem(Ep,JSON.stringify(e))}catch{}}function Pp(e){let t=[];for(let n of Object.values(Kl))if((e.deeds[n.stat]||0)>=n.n)for(let r of n.unlocks)!e.unlocks.includes(r)&&!t.includes(r)&&t.push(r);return t}function Fp(){let e=Mp(),t=Pp(e);return t.length&&(e.unlocks.push(...t),Np(e)),e}function Ip(e,t){if(e.vigilCommitted)return{vigil:Mp(),newUnlocks:[]};e.vigilCommitted=!0;let n=Mp();n.deeds.runs++,t&&(n.deeds.wins++,n.deeds.bestVow=Math.max(n.deeds.bestVow,e.vow||0),n.vowUnlocked=Math.max(n.vowUnlocked,Math.min(5,(e.vow||0)+1))),n.deeds.bestFloor=Math.max(n.deeds.bestFloor,e.act*15+e.floorsClimbed),n.deeds.slain+=e.stats.slain||0;for(let t of[`shatters`,`kindles`,`perfects`,`smolderKills`,`unlitVisited`,`embersSpent`])n.deeds[t]+=e.stats[t]||0;let r=Pp(n);return n.unlocks.push(...r),Np(n),{vigil:n,newUnlocks:r}}function Lp(e,t,n){let r=Mp();r.lastFall={act:e,row:t,bequest:n},Np(r)}function Rp(){let e=Mp();e.lastFall=null,Np(e)}var zp={starter:0,special:0,common:1,uncommon:2,rare:3,boss:4};function Bp(e){let t=[],n=e.player.relics.filter(e=>Fl[e]&&Fl[e].rarity!==`starter`);if(n.length){let e=[...n].sort((e,t)=>zp[Fl[t].rarity]-zp[Fl[e].rarity])[0];t.push({kind:`relic`,id:e})}let r=e.player.deck.filter(e=>{let t=Ml[e.id];return t&&t.rarity!==`starter`&&t.rarity!==`special`});if(r.length){let e=[...r].sort((e,t)=>zp[Ml[t.id].rarity]-zp[Ml[e.id].rarity]||(t.up===e.up?0:t.up?1:-1))[0];t.push({kind:`card`,id:e.id,up:!!e.up})}return e.player.gold>=25&&t.push({kind:`gold`,amount:Math.min(e.player.gold,75)}),t}var Vp=null,Hp=null,Up=null,Wp=[],Gp=localStorage.getItem(`spirebound_mute`)===`1`;function Kp(){if(Vp)return!0;try{Vp=new(window.AudioContext||window.webkitAudioContext),Hp=Vp.createGain(),Hp.gain.value=Gp?0:.5,Hp.connect(Vp.destination)}catch{return!1}return!0}function qp(){Kp()&&Vp.state===`suspended`&&Vp.resume()}function Jp(){return Gp}function Yp(){return Gp=!Gp,localStorage.setItem(`spirebound_mute`,Gp?`1`:`0`),Hp&&Hp.gain.linearRampToValueAtTime(Gp?0:.5,Vp.currentTime+.1),Gp}function Xp(e,t,n,r,i){e.gain.setValueAtTime(1e-4,t),e.gain.exponentialRampToValueAtTime(r,t+n),e.gain.exponentialRampToValueAtTime(1e-4,t+n+i)}function Y(e,{type:t=`sine`,a:n=.005,d:r=.2,peak:i=.3,slide:a=0,delay:o=0}={}){if(!Kp())return;let s=Vp.currentTime+o,c=Vp.createOscillator(),l=Vp.createGain();c.type=t,c.frequency.setValueAtTime(e,s),a&&c.frequency.exponentialRampToValueAtTime(Math.max(20,e+a),s+n+r),Xp(l,s,n,i,r),c.connect(l).connect(Hp),c.start(s),c.stop(s+n+r+.05)}function Zp({a:e=.002,d:t=.15,peak:n=.25,f0:r=800,f1:i=300,q:a=1,type:o=`bandpass`,delay:s=0}={}){if(!Kp())return;let c=Vp.currentTime+s,l=Math.ceil(Vp.sampleRate*(e+t+.05)),u=Vp.createBuffer(1,l,Vp.sampleRate),d=u.getChannelData(0);for(let e=0;e<l;e++)d[e]=Math.random()*2-1;let f=Vp.createBufferSource();f.buffer=u;let p=Vp.createBiquadFilter();p.type=o,p.Q.value=a,p.frequency.setValueAtTime(r,c),p.frequency.exponentialRampToValueAtTime(Math.max(40,i),c+e+t);let m=Vp.createGain();Xp(m,c,e,n,t),f.connect(p).connect(m).connect(Hp),f.start(c),f.stop(c+e+t+.05)}var X={click:()=>{Y(660,{type:`triangle`,d:.05,peak:.12})},hover:()=>{Y(880,{type:`sine`,d:.03,peak:.05})},card:()=>{Zp({d:.12,f0:1800,f1:500,peak:.14})},draw:()=>{Zp({d:.08,f0:2400,f1:900,peak:.08})},slash:()=>{Zp({d:.18,f0:3200,f1:300,peak:.3,q:1.4}),Y(180,{type:`sine`,d:.12,peak:.25,slide:-120})},hit:()=>{Y(120,{type:`sine`,d:.22,peak:.4,slide:-70}),Zp({d:.1,f0:500,f1:120,peak:.2,type:`lowpass`})},blocked:()=>{Y(320,{type:`square`,d:.08,peak:.1}),Zp({d:.1,f0:4e3,f1:2e3,peak:.1,q:6})},block:()=>{Y(240,{type:`triangle`,d:.12,peak:.18}),Y(360,{type:`triangle`,d:.1,peak:.1,delay:.03})},poison:()=>{Y(300,{type:`sine`,d:.2,peak:.14,slide:-160}),Zp({d:.22,f0:900,f1:300,peak:.08,q:3})},debuff:()=>{Y(420,{type:`sawtooth`,d:.25,peak:.08,slide:-220})},buff:()=>{Y(392,{type:`triangle`,d:.14,peak:.14}),Y(523,{type:`triangle`,d:.16,peak:.14,delay:.07})},heal:()=>{Y(523,{type:`sine`,d:.2,peak:.14}),Y(659,{type:`sine`,d:.24,peak:.12,delay:.09}),Y(784,{type:`sine`,d:.3,peak:.1,delay:.18})},energy:()=>{Y(700,{type:`triangle`,d:.1,peak:.12,slide:300})},coin:()=>{Y(988,{type:`square`,d:.06,peak:.08}),Y(1319,{type:`square`,d:.12,peak:.08,delay:.06})},potion:()=>{Y(500,{type:`sine`,d:.12,peak:.14,slide:300}),Zp({d:.14,f0:1200,f1:2600,peak:.06})},death:()=>{Y(90,{type:`sawtooth`,d:.5,peak:.22,slide:-50}),Zp({d:.4,f0:600,f1:60,peak:.18,type:`lowpass`})},bigDeath:()=>{Y(60,{type:`sawtooth`,d:1.1,peak:.32,slide:-30}),Zp({d:.9,f0:900,f1:40,peak:.26,type:`lowpass`})},turn:()=>{Y(392,{type:`triangle`,d:.1,peak:.1}),Y(587,{type:`triangle`,d:.14,peak:.1,delay:.08})},victory:()=>{[523,659,784,1047].forEach((e,t)=>Y(e,{type:`triangle`,d:.35,peak:.16,delay:t*.13}))},defeat:()=>{[330,277,220,165].forEach((e,t)=>Y(e,{type:`sawtooth`,d:.5,peak:.12,delay:t*.22}))},relic:()=>{[659,831,988].forEach((e,t)=>Y(e,{type:`sine`,d:.3,peak:.12,delay:t*.09}))},upgrade:()=>{Y(440,{type:`triangle`,d:.15,peak:.14}),Y(880,{type:`triangle`,d:.3,peak:.12,delay:.1})},map:()=>{Zp({d:.25,f0:500,f1:1500,peak:.06}),Y(330,{type:`sine`,d:.2,peak:.08})},chip:()=>{Y(1420,{type:`triangle`,d:.05,peak:.14}),Zp({d:.06,f0:5200,f1:3200,peak:.1,q:5})},shatter:()=>{Zp({d:.42,f0:4200,f1:260,peak:.3,q:3.5}),Y(220,{type:`sine`,d:.3,peak:.24,slide:-140}),Y(1760,{type:`triangle`,d:.18,peak:.1,delay:.03})},ember:()=>{Y(520,{type:`sine`,d:.12,peak:.12,slide:220})},kindle:()=>{Zp({d:.3,f0:900,f1:2600,peak:.1}),Y(392,{type:`sine`,d:.22,peak:.1,slide:140})},stagger:()=>{Y(233,{type:`sawtooth`,d:.38,peak:.1}),Y(247,{type:`sawtooth`,d:.38,peak:.1,delay:.02})},art:()=>{[392,494,587].forEach((e,t)=>Y(e,{type:`triangle`,d:.28,peak:.13,delay:t*.07})),Zp({d:.35,f0:1400,f1:3200,peak:.07})},omen:()=>{Y(98,{type:`sine`,d:1.1,peak:.2}),Y(196,{type:`sine`,d:.9,peak:.1,delay:.12}),Y(147,{type:`triangle`,d:.8,peak:.06,delay:.3})}},Qp=[55,49,41.2];function $p(e){if(!Kp())return;em(),Up=Vp.createGain(),Up.gain.value=0,Up.connect(Hp);let t=Qp[e]||55,n=Vp.createBiquadFilter();n.type=`lowpass`,n.frequency.value=320,n.Q.value=.6,n.connect(Up);for(let[e,r,i]of[[1,0,.5],[1.5,3,.22],[2,-4,.3],[3,2,.1]]){let a=Vp.createOscillator(),o=Vp.createGain();a.type=`sawtooth`,a.frequency.value=t*e,a.detune.value=r,o.gain.value=i,a.connect(o).connect(n),a.start(),Wp.push(a,o)}let r=Vp.createOscillator(),i=Vp.createGain();r.frequency.value=.07,i.gain.value=90,r.connect(i).connect(n.frequency),r.start(),Wp.push(r,i,n),Up.gain.linearRampToValueAtTime(.11,Vp.currentTime+3)}function em(){if(!Up)return;let e=Up,t=Wp;e.gain.linearRampToValueAtTime(0,Vp.currentTime+1.2),setTimeout(()=>{t.forEach(e=>{try{e.stop?.()}catch{}try{e.disconnect()}catch{}});try{e.disconnect()}catch{}},1500),Up=null,Wp=[]}var Z={run:null,cb:null,screen:`title`,targeting:null,busy:!1,hoveredCard:null,ce:null,drag:null},tm=new URLSearchParams(location.search).get(`input`),nm=tm?tm===`touch`:matchMedia(`(pointer: coarse)`).matches,rm=tm?tm===`mouse`:matchMedia(`(hover: hover) and (pointer: fine)`).matches,Q=(e,t=document)=>t.querySelector(e),im=(e,t=document)=>[...t.querySelectorAll(e)],am=e=>new Promise(t=>setTimeout(t,e)),om=()=>Q(`#screen`);function $(e,t=``,n=``){let r=document.createElement(e);return t&&(r.className=t),n&&(r.innerHTML=n),r}var sm=`Every creature is glass with a Facet gauge. Fill it and the glass Shatters — the creature loses its next action, is Cracked, and spills Embers into your lantern.`,cm={Cracked:Pl.vulnerable.desc,Dimmed:Pl.weak.desc,Brittle:Pl.frail.desc,Smolder:Pl.poison.desc,Fervor:Pl.str.desc,Poise:Pl.dex.desc,Kindle:`Burned away for the rest of this combat — and the lantern gains 1 Ember.`,Ward:`Held light that prevents damage. Expires at the start of your turn.`,Energy:`Spent to play cards. Refreshes each turn.`,Ember:`Fuel for your Lantern Art. Spilled by shatters, deaths and kindling; held in the lantern.`,Embers:`Fuel for your Lantern Art. Spilled by shatters, deaths and kindling; held in the lantern.`,Chip:`Strike at the glass itself: adds toward a Shatter, no blood required.`,Facet:sm,Facets:sm,Shatter:sm,Shatters:sm,Staggered:`Shattered glass loses its next action while it reseams.`,Unplayable:`This card cannot be played.`,Shard:`Unplayable junk glass. It can still be kindled.`,Hex:`Curse: lose 1 HP at end of turn while in hand. Cannot be kindled.`,Cinder:`Take 2 damage at end of turn while in hand.`};function lm(){let e=Q(`#tooltip`),t=t=>{let n=t._tip;e.innerHTML=`${n.title?`<div class="tt-title">${n.title}</div>`:``}<div class="tt-body">${n.body||``}</div>${n.sub?`<div class="tt-sub">${n.sub}</div>`:``}`,e.style.display=`block`},n=e=>{let t=e;for(;t&&t!==document.body&&!t._tip;)t=t.parentElement;return t&&t._tip?t:null},r=(t,n,r)=>{if(e.style.display!==`block`)return;let i=e.offsetWidth,a=e.offsetHeight;r?(e.style.left=`${Math.max(8,Math.min(innerWidth-i-8,t-i/2))}px`,e.style.top=`${Math.max(8,n-a-26)}px`):(e.style.left=`${Math.min(innerWidth-i-12,t+16)}px`,e.style.top=`${Math.max(8,Math.min(innerHeight-a-12,n-a/2))}px`)};document.addEventListener(`pointerover`,i=>{if(!rm||i.pointerType!==`mouse`)return;let a=n(i.target);a?(t(a),r(i.clientX,i.clientY,!1)):e.style.display=`none`}),document.addEventListener(`pointermove`,e=>{rm&&e.pointerType===`mouse`?r(e.clientX,e.clientY,!1):i&&Math.hypot(e.clientX-a,e.clientY-o)>12&&(clearTimeout(i),i=0)});let i=0,a=0,o=0,s=0;document.addEventListener(`pointerdown`,c=>{if(c.pointerType===`mouse`)return;e.style.display=`none`,clearTimeout(s);let l=n(c.target);l&&(a=c.clientX,o=c.clientY,clearTimeout(i),i=setTimeout(()=>{i=0,t(l),r(a,o,!0)},380))},!0);let c=t=>{t.pointerType!==`mouse`&&(i&&=(clearTimeout(i),0),clearTimeout(s),s=setTimeout(()=>e.style.display=`none`,1700))};document.addEventListener(`pointerup`,c),document.addEventListener(`pointercancel`,c)}function um(e,t){let n=e.replace(/@(\d+)@/g,(e,n)=>{let r=+n,i=t&&Z.cb?Hf(Z.cb,r):r;return`<span class="val ${i>r?`boosted`:i<r?`reduced`:``}">${i}</span>`}).replace(/#(\d+)#/g,(e,n)=>{let r=+n,i=t&&Z.cb?Uf(Z.run,Z.cb,r):r;return`<span class="val ${i>r?`boosted`:i<r?`reduced`:``}">${i}</span>`});return n=n.replace(/\b(Cracked|Dimmed|Brittle|Smolder|Fervor|Poise|Kindle|Ward|Energy|Embers?|Chip|Facets?|Shatters?|Staggered|Unplayable|Shard|Hex|Cinder)\b/g,`<span class="kw">$1</span>`),n}function dm(e,{inCombat:t=!1,size:n=null}={}){let r=Ud(e),i=$(`div`,`card t-${r.type} r-${r.rarity}${e.up?` upgraded`:``}`);n&&i.style.setProperty(`--cw`,`${n}px`),e.uid!=null&&(i.dataset.uid=e.uid);let a=``;if(r.cost!=null){let n=t&&Z.cb?Nf(Z.run,Z.cb,e):r.cost;a=`<div class="card-cost ${n===0?`free`:``}">${n}</div>`}let o=um(r.text,t);return e.bonus&&(o=o.replace(/<span class="val[^"]*">(\d+)<\/span>/,(t,n)=>t.replace(n,+n+e.bonus))),i.innerHTML=`${a}<div class="card-inner">
    <div class="card-art">${gp(e.id,r.type)}</div>
    <div class="card-name">${r.name}</div>
    <div class="card-type">${r.type}</div>
    <div class="card-text"><span class="ct-inner">${o}</span></div>
    <div class="card-rarity"></div>
  </div>`,im(`.kw`,i).forEach(e=>e._tip={title:e.textContent,body:cm[e.textContent]||``}),rm&&i.addEventListener(`mousemove`,e=>{let t=i.getBoundingClientRect(),n=(e.clientX-t.left)/t.width,r=(e.clientY-t.top)/t.height,a=Q(`.card-inner`,i);a.style.setProperty(`--ry`,`${(n-.5)*16}deg`),a.style.setProperty(`--rx`,`${(.5-r)*12}deg`),a.style.setProperty(`--mx`,`${n*100}%`),a.style.setProperty(`--my`,`${r*100}%`),a.style.setProperty(`--gx`,(n-.5)*60)}),i.addEventListener(`mouseleave`,()=>{let e=Q(`.card-inner`,i);e.style.setProperty(`--ry`,`0deg`),e.style.setProperty(`--rx`,`0deg`)}),i}function fm(){let e=Q(`#lantern`);if(!Z.run||Z.screen===`title`||Z.screen===`end`||Z.screen===`lamplighter`){e.style.setProperty(`--la`,0),e.classList.remove(`gutter`);return}let t=Z.run.player,n=Z.cb&&!Z.cb.over?Z.cb.player.hp:t.hp,r=Math.max(0,Math.min(1,(.68-n/t.maxHp)/.53));e.style.setProperty(`--la`,(r*.82).toFixed(3)),e.style.setProperty(`--lr`,`${Math.round(1500-r*1e3)}px`);let i=`50%`,a=`55%`;if(Z.screen===`combat`&&Z.ce?.hero){let e=jd(Z.ce.hero);i=`${Math.round(e.x)}px`,a=`${Math.round(e.y)}px`}e.style.setProperty(`--lx`,i),e.style.setProperty(`--ly`,a),e.classList.toggle(`gutter`,r>.55)}function pm(){fm();let e=Q(`#hud`);if(!Z.run||Z.screen===`title`||Z.screen===`end`||Z.screen===`lamplighter`){e.classList.remove(`show`),document.body.classList.remove(`low-hp`);return}e.classList.add(`show`);let t=Z.run.player,n=Z.cb&&!Z.cb.over?Z.cb.player.hp:t.hp;document.body.classList.toggle(`low-hp`,n/t.maxHp<=.3);let r=jl[Z.run.act];e.innerHTML=`<div class="hud-bar">
      ...
      <div class="hud-right">
        ${t.potions.map((e,t)=>`<button class="potion-slot ${e?`full`:``}" data-slot="${t}">${e?_p(Ll[e].tone):``}</button>`).join(``)}
        <button class="icon-btn" data-act="deck">${wp(`cards`,19)}<span style="font-size:11px">${t.deck.length}</span></button>
        <button class="icon-btn" data-act="menu">≡</button>
      </div>
    </div>
    <div id="relicbar"></div>`;let i=Q(`#relicbar`,e),a=Ul[Z.run.omens?.[Z.run.act]];if(a){let e=$(`div`,`relic-chip omen-chip`,a.glyph);e.style.setProperty(`--tone`,a.tone),e._tip={title:`Omen — ${a.name}`,body:a.text,sub:`hangs over Act ${Z.run.act+1}`},i.appendChild(e)}for(let e of t.relics){let t=Fl[e],n=$(`div`,`relic-chip`,t.glyph);n.style.setProperty(`--tone`,t.tone),n.dataset.relic=e,n._tip={title:t.name,body:t.text,sub:t.rarity},i.appendChild(n)}t.potions.forEach((t,n)=>{if(!t)return;let r=Q(`.potion-slot[data-slot="${n}"]`,e);r._tip={title:Ll[t].name,body:Ll[t].text,sub:`Click to use or toss`}}),Q(`[data-act="deck"]`,e).onclick=()=>{X.click(),Sm(`Your Deck`,Z.run.player.deck,{sub:`${Z.run.player.deck.length} cards`})},Q(`[data-act="menu"]`,e).onclick=e=>{X.click(),mm(e.clientX,e.clientY)},im(`.potion-slot.full`,e).forEach(e=>e.onclick=t=>_m(+e.dataset.slot,t))}function mm(e,t){hm();let n=$(`div`,`pop-menu`);n.innerHTML=`<button data-m="help">How to Play</button><button data-m="mute">${Jp()?`Unmute`:`Mute`} Sound</button><button data-m="abandon" style="color:#ff8d8d">Abandon Run</button>`,document.body.appendChild(n),n.style.left=`${Math.min(e,innerWidth-200)}px`,n.style.top=`${t+8}px`,n.onclick=e=>{let t=e.target.dataset.m;hm(),t===`help`&&Cm(),t===`mute`&&Yp(),t===`abandon`&&ym()},setTimeout(()=>document.addEventListener(`pointerdown`,gm,{once:!0}),0)}var hm=()=>im(`.pop-menu`).forEach(e=>e.remove()),gm=e=>{e.target.closest(`.pop-menu`)||hm()};function _m(e,t){if(Z.busy)return;hm();let n=Z.run.player.potions[e];if(!n)return;let r=Ll[n],i=Z.cb&&!Z.cb.over&&Z.screen===`combat`,a=!r.combatOnly||i,o=$(`div`,`pop-menu`);o.innerHTML=`<button data-m="use" ${a?``:`disabled style="opacity:.4"`}>Use ${r.name}</button><button data-m="toss">Toss it</button>`,document.body.appendChild(o),o.style.left=`${Math.min(t.clientX-60,innerWidth-220)}px`,o.style.top=`${t.clientY+10}px`,o.onclick=async t=>{let n=t.target.dataset.m;if(hm(),n===`toss`&&(Z.run.player.potions[e]=null,X.card(),pm(),Qf(Z.run)),n===`use`&&a)if(r.needsTarget&&i){let t=Z.cb.enemies.filter(e=>e.hp>0);if(t.length===1)return vm(e,t[0].idx);ih({kind:`potion`,slot:e})}else vm(e,null)},setTimeout(()=>document.addEventListener(`pointerdown`,gm,{once:!0}),0)}async function vm(e,t){ah(),X.potion(),Z.cb&&!Z.cb.over&&Z.screen===`combat`?(Rf(Z.run,Z.cb,e,t),await _h(),bh()):(Rf(Z.run,null,e,null),pm(),Qf(Z.run))}function ym(){bm(`<div class="panel ov-panel" style="text-align:center">
  ...
  </div>`,e=>{e.onclick=e=>{let t=e.target.dataset.a;t===`yes`&&(np(Z.run,!1),Z.run=null,Z.cb=null,xm(),em(),Tm(`title`)),t===`no`&&xm()}})}function bm(e,t=null,n=!1){let r=Q(`#overlay`);r.innerHTML=e,r.classList.add(`open`),r._closable=n,t&&t(r.firstElementChild)}function xm(){let e=Q(`#overlay`);e.classList.remove(`open`),e.innerHTML=``}function Sm(e,t,{sub:n=``,pick:r=null,canSkip:i=!1,skipLabel:a=`Skip`,inCombat:o=!1}={}){let s=$(`div`,`panel ov-panel`);s.innerHTML=`<div class="ov-title">${e}</div>${n?`<div class="ov-sub">${n}</div>`:``}`;let c=$(`div`,`card-grid ${r?`choice-cards`:``}`),l=r?t:[...t].sort((e,t)=>Ud(e).name.localeCompare(Ud(t).name));for(let e of l){let t=dm(e,{inCombat:o});r&&(t.onclick=()=>{X.click(),t.classList.add(`picked`),setTimeout(()=>{xm(),r(e)},240)}),c.appendChild(t)}s.appendChild(c);let u=$(`div`,`ov-actions`);if(i&&r){let e=$(`button`,`btn ghost`,a);e.onclick=()=>{X.click(),xm(),r(null)},u.appendChild(e)}if(!r){let e=$(`button`,`btn ghost`,`Close`);e.onclick=()=>{X.click(),xm()},u.appendChild(e)}s.appendChild(u),bm(``,null,!r),Q(`#overlay`).appendChild(s)}function Cm(){bm(`<div class="panel ov-panel howto">
    ...
    <div class="ov-actions"><button class="btn" data-a="ok">Fight On</button></div>
  </div>`,e=>{Q(`[data-a="ok"]`,e).onclick=()=>{X.click(),xm()}},!0)}function wm(){if(dh)return;let e=Q(`#wipe`);e.classList.remove(`go`),e.offsetWidth,e.classList.add(`go`),setTimeout(()=>e.classList.remove(`go`),620)}function Tm(e,t){Z.screen!==e&&Z.run&&wm(),Z.screen=e,hm(),Q(`#tooltip`).style.display=`none`,e!==`map`&&(Gu(),Xu());let n=om();n.className=``,n.onclick=null,{title:Dm,map:Nm,combat:()=>{},reward:Ch,rest:Dh,shop:kh,event:Ah,treasure:Oh,bossRelic:wh,end:Ph}[e](t),pm()}var Em=[`0`,`I`,`II`,`III`,`IV`,`V`];function Dm(){em(),nd(0);let e=Fp(),t=$f(),n=Z.title||={aspect:0,vow:0};n.aspect>0&&ql[n.aspect].unlock&&!e.unlocks.includes(ql[n.aspect].unlock)&&(n.aspect=0),n.vow=Math.max(0,Math.min(n.vow|0,e.vowUnlocked));let r=e.deeds,i=ql.map((t,r)=>{let i=r>0&&t.unlock&&!e.unlocks.includes(t.unlock);return`<button class="aspect-card${n.aspect===r?` on`:``}${i?` locked`:``}" data-a="asp" data-i="${r}"${i?` disabled`:``}>
      <div class="asp-hero">${pp(r)}</div>
      ...
      <div class="vow-stepper">
        ...
        <div class="vow-level">VOW ${Em[n.vow]}<span class="vow-max"> / ${Em[e.vowUnlocked]||`0`}</span></div>
        <button class="vow-btn" data-a="vow+"${n.vow<e.vowUnlocked?``:` disabled`}>+</button>
      </div>
      <div class="vow-desc">${a}</div>
    </div>`:``,s=om();s.innerHTML=`<div class="title-screen screen-enter">
    ...
    <div class="title-btns">
      ...
      <button class="btn ghost" data-a="mute">${Jp()?`Unmute`:`Mute`}</button>
    </div>
    <div class="title-stats">${r.runs} climbs · ${r.wins} dawns · ${r.slain} slain${e.unlocks.length?` · ${e.unlocks.length} secrets unearthed`:``}</div>
  </div>`,s.onclick=r=>{let i=r.target.closest(`[data-a]`);if(!i||i.disabled)return;let a=i.dataset.a;qp(),X.click(),a===`asp`?(n.aspect=+i.dataset.i,Dm()):a===`vow-`?(n.vow=Math.max(0,n.vow-1),Dm()):a===`vow+`?(n.vow=Math.min(e.vowUnlocked,n.vow+1),Dm()):a===`new`?(t&&ep(),km(Ld(void 0,{aspect:n.aspect,vow:n.vow,lamplighter:!0,monument:e.lastFall}))):a===`continue`&&t?km(t,!0):a===`vigil`?Om():a===`help`?Cm():a===`mute`&&(Yp(),Dm())}}function Om(){let e=Mp(),t=Object.values(Kl).map(t=>{let n=e.deeds[t.stat]||0,r=n>=t.n,i=Math.min(100,Math.round(n/t.n*100)),a=t.unlocks.map(e=>{if(e===`aspect2`)return`The Ashwarden`;let[t,n]=e.split(`:`);return t===`card`?Ml[n]?.name||n:Fl[n]?.name||n}).join(`, `);return`<div class="deed-row${r?` done`:``}">
    ...
    </div>`}).join(``);bm(`<div class="panel ov-panel vigil-panel">
    <div class="ov-title">The Vigil</div>
    <div class="ov-sub">${e.deeds.runs} climbs · ${e.deeds.wins} dawns · deepest Vow: ${Em[e.deeds.bestVow]||`—`}</div>
    <div class="deed-list">${t}</div>
    <div class="ov-actions"><button class="btn" data-a="ok">Close</button></div>
  </div>`,e=>{Q(`[data-a="ok"]`,e).onclick=()=>{X.click(),xm()}},!0)}function km(e,t=!1){Z.run=e,Z.cb=null,nd(e.act);let n=e.nodeId?e.map.nodes.find(t=>t.id===e.nodeId):null;if(Uu(e.act,n?n.row:0),$p(e.act),t||Qf(e),t&&e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);Z.screen=`combat`,Im(lf(e,e.pendingCombat,t?t.row:5),e.pendingCombat),pm();return}if(e.pendingLamplighter){Am();return}Tm(`map`),t||setTimeout(()=>Eh(e),900)}function Am(){let e=Z.run;if(Z.screen!==`lamplighter`&&wm(),Z.screen=`lamplighter`,hm(),Xu(),nd(0),om().className=``,!Z.lamp){let t=Wd(e),n=Object.keys(Yl),r=[];for(;r.length<3&&n.length;)r.push(n.splice(Math.floor(t()*n.length),1)[0]);Z.lamp={boons:r,boon:null,art:e.art},Qf(e)}let t=Z.lamp,n=ql[e.aspect],r=t.boons.map(e=>{let n=Yl[e];return`<button class="lamp-boon${t.boon===e?` on`:``}" data-a="boon" data-i="${e}">
      <div class="lb-name">${n.name}</div><div class="lb-text">${um(n.text)}</div>
    ...
    </button>`}).join(``),a=Gl[t.art],o=om();o.innerHTML=`<div class="lamp-screen screen-enter">
    <div class="lamp-hero">${pp(e.aspect)}</div>
    ...
    <div class="lamp-art-desc">${a?`<b style="color:${a.tone}">${a.glyph} ${a.name}</b> · ${um(a.text)}`:``}</div>
    <div class="lamp-actions"><button class="btn" data-a="begin"${t.boon?``:` disabled`}>${t.boon?`Light the Way`:`Choose a boon`}</button></div>
  </div>`,pm(),o.onclick=e=>{let n=e.target.closest(`[data-a]`);if(!n||n.disabled)return;let r=n.dataset.a;qp(),X.click(),r===`boon`?(t.boon=n.dataset.i,Am()):r===`art`?(t.art=n.dataset.i,X.hover(),Am()):r===`begin`&&t.boon&&jm()}}function jm(){let e=Z.run,t=Z.lamp;e.art=t.art,e.boon=t.boon,rp(e,Yl[t.boon].ops),delete e.pendingLamplighter,Z.lamp=null,X.relic(),Qf(e),Tm(`map`),setTimeout(()=>Eh(e),900)}var Mm={monster:`sword`,elite:`skull`,event:`question`,rest:`flame`,shop:`coin`,treasure:`chest`,boss:`crown`,monument:`monument`};function Nm(){let e=Z.run;if(e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);Z.screen=`combat`,Im(lf(e,e.pendingCombat,t?t.row:5),e.pendingCombat);return}Qf(e),Z.cb=null;let{nodes:t}=e.map,n=new Set(Kd(e).map(e=>e.id)),r=new Set(e.map.visited),i=e.nodeId?t.find(t=>t.id===e.nodeId).row:-1,a=``,o=``;for(let e of t)for(let t of e.next){let n=r.has(e.id)&&r.has(t)?`walked`:``;a+=`<path class="medge ${n}" style="--d:${e.row*34}ms" data-a="${e.id}" data-b="${t}" d="M0 0"/>`}for(let i of t){let t=i.unlit&&!r.has(i.id),a=[`mnode`,`type-${i.type}`,t?`unlit`:``,r.has(i.id)?`visited`:``,i.id===e.nodeId?`current`:``,n.has(i.id)?`avail`:``].join(` `),s=nm?1.3:1,c=(i.type===`boss`?26:i.type===`elite`||i.type===`treasure`?19:16)*s,l=Math.round((i.type===`boss`?26:i.type===`elite`||i.type===`treasure`?20:17)*s);o+=`<g class="${a}" data-node="${i.id}" style="--d:${i.row*34}ms">
      <g class="nwrap"><circle class="bg" r="${t?16*s:c}"/><g class="icg">${Tp(t?`unlitLantern`:Mm[i.type],t?Math.round(17*s):l)}</g></g>
    </g>`}let s=jl[e.act],c=Ul[e.omens?.[e.act]];om().innerHTML=`
    ...
    <div class="map-screen screen-enter">
      ...
      <div class="map-hint">${nm?`drag`:`scroll`} to survey the Spire</div>
    </div>`;let l=Q(`.map-svg`),u=!1;l.onclick=e=>{if(u)return;let n=e.target.closest(`.mnode.avail`);!n||Z.busy||(qp(),Pm(t.find(e=>e.id===n.dataset.node)))},im(`.mnode`,l).forEach(i=>{let a=t.find(e=>e.id===i.dataset.node),o={monster:`Monster`,elite:`Elite — beware`,event:`Unknown event`,rest:`Rest site`,shop:`Merchant`,treasure:`Treasure`,boss:jl[e.act].bossName};i._tip=a.unlit&&!r.has(a.id)?{title:`An unlit lantern`,body:`What waits here is unknown — but first light pays a bounty of gold.${n.has(a.id)?` ${nm?`Tap`:`Click`} to travel here.`:``}`}:{title:o[a.type],body:n.has(a.id)?`${nm?`Tap`:`Click`} to travel here.`:``}});let d=t.map(t=>({id:t.id,pos:ku(e.act,t)})),f=new Map(im(`.mnode`,l).map(e=>[e.dataset.node,e])),p=new Set(t.filter(e=>!n.has(e.id)&&!r.has(e.id)).map(e=>e.id)),m=im(`.medge`,l).map(e=>({p:e,a:e.dataset.a,b:e.dataset.b}));Wu(e.act,Math.max(0,i)),Yu(d,e=>{let t=new Map(e.map(e=>[e.id,e]));for(let[e,n]of f){let r=t.get(e);n.setAttribute(`transform`,`translate(${r.x.toFixed(1)},${r.y.toFixed(1)}) scale(${r.s.toFixed(3)})`),n.style.opacity=(r.fade*(p.has(e)?.4:1)).toFixed(3)}for(let{p:e,a:n,b:r}of m){let i=t.get(n),a=t.get(r),o=9*(i.s+a.s)/2;e.setAttribute(`d`,`M${i.x.toFixed(1)} ${i.y.toFixed(1)} Q${((i.x+a.x)/2).toFixed(1)} ${((i.y+a.y)/2+o).toFixed(1)} ${a.x.toFixed(1)} ${a.y.toFixed(1)}`),e.style.opacity=Math.min(i.fade,a.fade).toFixed(3)}});let h=Q(`.map-screen`);h.addEventListener(`wheel`,e=>{e.preventDefault(),Ku(-e.deltaY*.006)},{passive:!1});let g=null,_=0,v=0,y=0;h.addEventListener(`pointerdown`,e=>{e.pointerType!==`mouse`&&(cancelAnimationFrame(v),g=e.clientY,_=0,y=0,u=!1)}),h.addEventListener(`pointermove`,e=>{if(g==null||e.pointerType===`mouse`)return;let t=e.clientY-g;g=e.clientY,y+=Math.abs(t),y>14&&(u=!0),_=t,Ku(t*.014)});let b=e=>{if(g==null||e.pointerType===`mouse`)return;g=null;let t=()=>{_*=.93,!(Math.abs(_)<.5||Z.screen!==`map`)&&(Ku(_*.014),v=requestAnimationFrame(t))};v=requestAnimationFrame(t),setTimeout(()=>u=!1,80)};h.addEventListener(`pointerup`,b),h.addEventListener(`pointercancel`,b)}function Pm(e){let t=Z.run;X.map(),Uu(t.act,e.row);let{type:n,bounty:r}=qd(t,e);if(Qf(t),r){X.coin();let t=Q(`.mnode[data-node="${e.id}"]`),n=t?(()=>{let e=t.getBoundingClientRect();return{x:e.left+e.width/2,y:e.top+e.height/2}})():{x:innerWidth/2,y:innerHeight/2};kd(n.x,n.y-34,`+${r} ¤`,`goldf`),uh(n.x,n.y,120,30,{n:5,color:`#ffe9ac`,size:7,dur:620})}n===`monster`||n===`elite`||n===`boss`?(t.pendingCombat=n,Qf(t),Im(lf(t,n,e.row),n)):n===`rest`?Tm(`rest`):n===`shop`?Tm(`shop`):n===`treasure`?Tm(`treasure`):n===`event`?Tm(`event`,cf(t)):n===`monument`&&Fm(e)}function Fm(e){let t=Z.run,n=Jd(t);if(n&&Rp(),Qf(t),n){X.relic();let t=n.kind===`relic`?Fl[n.id]?.name:n.kind===`card`?Ml[n.id]?.name:`${n.amount} gold`,r=Q(`.mnode[data-node="${e.id}"]`),i=r?(()=>{let e=r.getBoundingClientRect();return{x:e.left+e.width/2,y:e.top+e.height/2}})():{x:innerWidth/2,y:innerHeight/2};kd(i.x,i.y-34,`✦ ${t}`,`goldf`),uh(i.x,i.y,innerWidth/2,innerHeight*.5,{n:8,color:`#ffe9ac`,size:8,dur:720}),lh(`THE STONE REMEMBERS`)}Tm(`map`)}function Im(e,t){if(Gu(),Xu(),Q(`#tooltip`).style.display=`none`,Z.screen!==`combat`&&wm(),Z.cb=uf(Z.run,e,t),Z.screen=`combat`,Lm(),pm(),t===`boss`){let e=$(`div`,`rose-window`,`<div class="rw-rings"></div><div class="rw-spokes"></div>`);om().appendChild(e),setTimeout(()=>e.remove(),2300);let t=$(`div`,`turn-banner boss-banner`,Z.cb.enemies[0].name.toUpperCase());om().appendChild(t),setTimeout(()=>t.remove(),2100),wd(`#1a0a20`,.5,.9),id(1.6),X.bigDeath()}_h().then(bh)}function Lm(){let e=Z.cb,t=om();t.onclick=null,t.innerHTML=`<div class="combat-screen screen-enter intro">
    <div class="stage-ledge" style="--ledge:${`#${jl[Z.run.act].theme.glow.toString(16).padStart(6,`0`)}`}"></div>
    <div class="battlefield">
      <div class="player-zone">
        <div class="hero-wrap">${pp(Z.run.aspect)}</div>
        <div class="hpbar-wrap"><span class="block-chip zero p-block">${wp(`shield`,13)} 0</span><div class="hpbar"><div class="ghost"></div><div class="fill"></div></div><span class="hp-label p-hp"></span></div>
    ...
    <button class="lantern-btn"><span class="lb-ic">${wp(`lantern`,26)}</span><span class="lb-count">0</span><div class="lb-pips"></div><span class="lb-art"></span></button>
  ...
  </div>`;let n=Q(`.enemy-zone`,t),r={enemies:[],root:Q(`.combat-screen`,t)},i=e.affix?Wl[e.affix]:null;e.enemies.forEach((t,a)=>{let o=Rl[t.key],s=Bm(o,e.enemies.length),c=$(`div`,`enemy${o.elite?` elite-e`:``}${o.boss?` boss-e`:``}${i?` affixed`:``}`);i&&c.style.setProperty(`--affix-tone`,i.tone),c.dataset.idx=a,c.style.animationDelay=`${160+a*130}ms`,c.innerHTML=`<div class="intent"></div>
      <div class="enemy-art" style="width:${s}px;height:${s}px">${dp(o.art)}<div class="dmg-preview"></div></div>
      <div class="name">${i?`<span class="affix-name" style="color:${i.tone}">${i.name.toUpperCase()}</span> `:``}${t.name.toUpperCase()}</div>
      <div class="hpbar-wrap"><span class="block-chip zero">${wp(`shield`,13)} 0</span><div class="hpbar"><div class="ghost"></div><div class="fill"></div><div class="pv"></div></div><span class="hp-label"></span></div>
      <div class="facet-row"></div>
      <div class="status-row"></div>`,n.appendChild(c),r.enemies.push({root:c,art:Q(`.enemy-art`,c),intent:Q(`.intent`,c),fill:Q(`.fill`,c),ghost:Q(`.ghost`,c),hp:Q(`.hp-label`,c),block:Q(`.block-chip`,c),statuses:Q(`.status-row`,c),pv:Q(`.pv`,c),prev:Q(`.dmg-preview`,c),facets:Q(`.facet-row`,c)}),r.enemies[a].facets._tip={title:`Facets`,body:`Every creature is glass. Attacks that draw unblocked blood chip a facet; fill the gauge and the glass <b>shatters</b> — it loses its next action, is Cracked, and spills Embers into your lantern.`},i&&(Q(`.name`,c)._tip={title:`${i.name} — an elite's title`,body:i.text}),c.onclick=()=>rh(a),c.addEventListener(`pointerenter`,e=>{e.pointerType===`mouse`&&Z.targeting&&(c.classList.add(`target-hover`),th())}),c.addEventListener(`pointerleave`,()=>{c.classList.remove(`target-hover`),th()})}),r.pHp=Q(`.p-hp`,t),r.pFill=Q(`.player-zone .fill`,t),r.pGhost=Q(`.player-zone .ghost`,t),r.pBlock=Q(`.p-block`,t),r.pStatus=Q(`.p-status`,t),r.hero=Q(`.hero-wrap`,t),r.energy=Q(`.energy-orb`,t),r.endTurn=Q(`.end-turn`,t),r.hand=Q(`.hand-zone`,t),r.draw=Q(`.pile-draw`,t),r.discard=Q(`.pile-discard`,t),r.exhaust=Q(`.pile-exhaust`,t),r.lantern=Q(`.lantern-btn`,t);let a=Gl[Z.run.art];a&&(Q(`.lb-art`,r.lantern).innerHTML=`<i>${a.glyph}</i>${a.cost}`,Q(`.lb-art`,r.lantern).style.color=a.tone),r.lantern._tip={title:a?`Lantern Art — ${a.name}`:`The Lantern`,body:`${a?`<b>${a.cost} Embers, once a turn:</b> ${a.text}<br><br>`:``}The lantern holds the <b>Embers</b> spilled by shattered and slain glass. Drag any card onto it to <b>kindle</b> — burn the card away for an ember, once a turn. Curses refuse the fire.`,sub:`A · use Art`},r.lantern.onclick=async()=>{if(!(Z.busy||!Z.cb||Z.cb.over)){if(qp(),!bf(Z.run,Z.cb)){r.lantern.classList.add(`nope`),setTimeout(()=>r.lantern.classList.remove(`nope`),350),X.debuff();return}ah(),xf(Z.run,Z.cb),await _h(),bh()}},Z.ce=r,ph(),setTimeout(()=>r.root.classList.remove(`intro`),1300),r.endTurn.onclick=ch,r.draw.onclick=()=>{X.click(),Sm(`Draw Pile`,e.draw,{sub:`Order hidden — shown alphabetically`,inCombat:!0})},r.discard.onclick=()=>{X.click(),Sm(`Discard Pile`,e.discard,{inCombat:!0})},r.exhaust.onclick=()=>{X.click(),Sm(`The Ashes`,e.exhaust,{sub:`Burned away — each fed the lantern an ember`,inCombat:!0})},r.root.addEventListener(`pointerdown`,e=>{e.target.closest(`.enemy`)||e.target.closest(`.card`)||(Z.targeting?ah():Z.hoveredCard!=null&&(Z.hoveredCard=null,qm()))}),Gm(),Km()}var Rm=e=>jd(Z.ce.enemies[e].art),zm=()=>jd(Z.ce.hero);function Bm(e,t){let n=Math.min(innerWidth*.31,240),r=(innerWidth-n-innerWidth*.08)/t-12,i=(e.boss?280:e.elite?230:185)*(e.art.size>=1.4?1:e.art.size<.8?.86:.95)*Math.min(e.art.size,1.45);return Math.round(Math.min(i,innerHeight*(e.boss?.34:.3),Math.max(72,r*(e.boss?1.12:1))))}var Vm=0;addEventListener(`resize`,()=>{clearTimeout(Vm),Vm=setTimeout(()=>{let e=Z.cb,t=Z.ce;!e||!t||Z.screen!==`combat`||(e.enemies.forEach((n,r)=>{let i=Bm(Rl[n.key],e.enemies.length);t.enemies[r].art.style.width=t.enemies[r].art.style.height=`${i}px`}),qm())},120)});function Hm(e,t,n){e.innerHTML=``;for(let[n,r]of Object.entries(t)){if(!r)continue;let t=Pl[n]||{name:n,icon:`?`,kind:`buff`,desc:``},i=n===`str`&&r<0?`debuff`:t.kind,a=$(`span`,`schip ${i}`,`${t.icon} <span class="n">${r}</span>`);a._tip={title:t.name,body:t.desc.replace(/\bN\b/g,r),sub:i===`debuff`?`Debuff`:`Buff`},e.appendChild(a)}}function Um(e){let t=Z.cb,n=hf(e),r=Wf(Z.run,t,e),i={attack:wp(`sword`,19),block:wp(`shield`,19),buff:wp(`up`,19),debuff:wp(`cloud`,19),heal:wp(`plus`,19)}[n.intent]||wp(`sword`,19),a=``;n.intent.startsWith(`attack`)&&(i=wp(`sword`,19),a=r.times>1?`${r.dmg}×${r.times}`:`${r.dmg}`,n.intent===`attack_debuff`&&(i+=wp(`cloud`,14)),n.intent===`attack_block`&&(i+=wp(`shield`,14)),n.intent===`attack_buff`&&(i+=wp(`up`,14)));let o=[];return r&&o.push(`attack for <b>${r.dmg}${r.times>1?`×${r.times}`:``}</b>`),n.block&&o.push(`gain Ward`),n.heal&&o.push(`heal itself`),n.fx?.some(e=>e.who===`player`)&&o.push(`afflict you`),n.fx?.some(e=>e.who!==`player`)&&o.push(`empower`),n.addCards&&o.push(`add ${n.addCards.n} ${Ml[n.addCards.id].name}s to your discard`),{icon:i,txt:a,tip:{title:n.name,body:`Intends to ${o.join(`, `)||`act`}.`}}}function Wm(e,t=0){if(e.facetMax>8)return`<span class="pipnum">${wp(`facet`,11)} ${e.chips}${t?`<i>+${t}</i>`:``}/${e.facetMax}</span>`;let n=``;for(let r=0;r<e.facetMax;r++)n+=`<span class="pip${r<e.chips?` filled`:r<e.chips+t?` willchip`:``}"></span>`;return n}function Gm(){let e=Z.cb,t=Z.ce;if(!t)return;e.enemies.forEach((e,n)=>{let r=t.enemies[n],i=`${100*Math.max(0,e.hp)/e.maxHp}%`;if(r.fill.style.width=i,r.ghost.style.width=i,r.hp.textContent=`${Math.max(0,e.hp)}/${e.maxHp}`,r.block.classList.toggle(`zero`,e.block<=0),r.block.innerHTML=`${wp(`shield`,13)} ${e.block}`,r.art.classList.toggle(`warded`,e.block>0),r.root.classList.toggle(`lowhp`,e.hp>0&&e.hp/e.maxHp<=.3),Hm(r.statuses,e.statuses,!1),e.hp>0?r.facets.innerHTML=Wm(e):r.facets.innerHTML=``,e.hp<=0&&r.root.classList.add(`gone`),e.hp>0&&e.flags.staggered)r.intent.className=`intent i-staggered`,r.intent.innerHTML=`<span class="ic">${wp(`stagger`,19)}</span>STAGGERED`,r.intent._tip={title:`Staggered`,body:`The glass has shattered — this creature loses its next action while it reseams.`};else if(e.hp>0&&e.moveKey){let t=Um(e);r.intent.className=`intent i-${hf(e).intent}`,r.intent.innerHTML=`<span class="ic">${t.icon}</span>${t.txt}`,r.intent._tip=t.tip}else r.intent.innerHTML=``}),t.lantern&&(Q(`.lb-count`,t.lantern).textContent=e.embers,Q(`.lb-pips`,t.lantern).innerHTML=Array.from({length:e.emberCap},(t,n)=>`<span class="lbp${n<e.embers?` lit`:``}" style="--a:${Math.round(n/(e.emberCap-1)*280-140)}deg"></span>`).join(``),t.lantern.classList.toggle(`unlit`,e.embers===0),t.lantern.classList.toggle(`ready`,bf(Z.run,e)),t.lantern.classList.toggle(`art-spent`,e.artUsedTurn===e.turn&&!e.over));let n=e.player,r=`${100*Math.max(0,n.hp)/n.maxHp}%`;t.pFill.style.width=r,t.pGhost.style.width=r,t.pHp.textContent=`${Math.max(0,n.hp)}/${n.maxHp}`,t.pBlock.classList.toggle(`zero`,n.block<=0),t.pBlock.innerHTML=`${wp(`shield`,13)} ${n.block}`,t.hero.classList.toggle(`warded`,n.block>0),t.hero.classList.toggle(`lowhp`,n.hp/n.maxHp<=.3),Hm(t.pStatus,n.statuses,!0),Q(`.num`,t.energy).textContent=n.energy,t.energy.classList.toggle(`spent`,n.energy===0);let i=Q(`.candles`,t.energy),a=Math.max(n.energyMax,n.energy);i.children.length!==a&&(i.innerHTML=Array.from({length:a},()=>`<span class="candle"></span>`).join(``)),[...i.children].forEach((e,t)=>e.classList.toggle(`lit`,t<n.energy)),Q(`.cnt`,t.draw).textContent=e.draw.length,Q(`.cnt`,t.discard).textContent=e.discard.length,Q(`.cnt`,t.exhaust).textContent=e.exhaust.length}function Km(){let e=Z.cb,t=Z.ce;if(!t)return;let n=t.hand,r=new Map(im(`.card`,n).map(e=>[e.dataset.uid,e])),i=new Set(e.hand.map(e=>String(e.uid)));for(let[e,t]of r)i.has(e)||t.remove();for(let t of e.hand)if(r.has(String(t.uid))){let e=dm(t,{inCombat:!0}),n=r.get(String(t.uid));n.replaceChildren(...e.childNodes),n.className=e.className+(n.classList.contains(`armed`)?` armed`:``),n.onclick=e=>{e.stopPropagation(),nh(t.uid)},rm&&(n.onmouseenter=()=>{Z.hoveredCard=t.uid,qm()},n.onmouseleave=()=>{Z.hoveredCard===t.uid&&(Z.hoveredCard=null),qm()})}else{let e=dm(t,{inCombat:!0});e.classList.add(`draw-in`),setTimeout(()=>e.classList.remove(`draw-in`),400),e.onclick=e=>{e.stopPropagation(),nh(t.uid)},rm&&(e.onmouseenter=()=>{Z.hoveredCard=t.uid,X.hover(),qm()},e.onmouseleave=()=>{Z.hoveredCard===t.uid&&(Z.hoveredCard=null),qm()}),Ym(e,t.uid),n.appendChild(e)}qm()}function qm(){let e=Z.cb,t=Z.ce;if(!t)return;let n=e.hand.map(e=>String(e.uid)),r=new Map(im(`.card`,t.hand).map(e=>[e.dataset.uid,e])),i=n.length,a=Math.min(112,640/Math.max(i,1),(innerWidth-246)/Math.max(i-1,1));n.forEach((t,n)=>{let o=r.get(t);if(!o)return;let s=e.hand[n],c=!Ud(s).unplayable&&(Nf(Z.run,e,s)??99)<=e.player.energy;o.classList.toggle(`unplayable-now`,!c);let l=Z.targeting?.kind===`card`&&String(Z.targeting.uid)===t,u=Z.hoveredCard!=null&&String(Z.hoveredCard)===t,d=i>1?(n-(i-1)/2)*Math.min(5,42/i):0,f=(n-(i-1)/2)*a,p=Math.abs(d)*3.2;o.classList.toggle(`armed`,l),l?o.style.transform=`translateX(calc(-50% + ${f*.4}px)) translateY(-150px) scale(1.24)`:u&&!Z.busy?o.style.transform=`translateX(calc(-50% + ${f}px)) translateY(-92px) scale(1.38)`:o.style.transform=`translateX(calc(-50% + ${f}px)) translateY(${p+26}px) rotate(${d}deg)`,o.style.zIndex=u||l?40:20+n}),th()}var Jm=0;function Ym(e,t){e.addEventListener(`pointerdown`,n=>{if(!(Z.busy||!Z.cb||Z.cb.over||!n.isPrimary||Z.drag)){Z.drag={uid:t,id:n.pointerId,x0:n.clientX,y0:n.clientY,live:!1,free:!1};try{e.setPointerCapture(n.pointerId)}catch{}}}),e.addEventListener(`pointermove`,n=>{let r=Z.drag;if(!(!r||r.uid!==t||n.pointerId!==r.id)){if(!r.live){r.y0-n.clientY>26&&Qm(r,e);return}if(r.free){e.style.transform=`translate(calc(-50% + ${n.clientX-innerWidth/2}px), ${n.clientY-innerHeight+130}px) scale(1.12)`;let t=!!Zm(n.clientX,n.clientY)?.closest(`.lantern-btn`);e.classList.toggle(`will-burn`,t),e.classList.toggle(`will-cast`,!r.kindleOnly&&!t&&n.clientY<Xm())}else oh(n),eh(n.clientX,n.clientY)}});let n=(n,r)=>{let i=Z.drag;if(!i||i.uid!==t||n.pointerId!==i.id||(Z.drag=null,!i.live))return;if(Jm=performance.now(),e.classList.remove(`dragging`,`will-cast`,`will-burn`),Z.ce?.lantern?.classList.remove(`kindle-target`),r){ah(),qm();return}if(Zm(n.clientX,n.clientY)?.closest(`.lantern-btn`)){let e=Z.cb.hand.find(e=>e.uid===t);if(e&&Cf(Z.run,Z.cb,e)){ah(),$m(t);return}ah(),qm();return}if(i.kindleOnly){Z.hoveredCard=null,qm();return}if(i.free){n.clientY<Xm()?sh(t,null):(Z.hoveredCard=null,qm());return}let a=document.elementFromPoint(n.clientX,n.clientY)?.closest(`.enemy`),o=a?+a.dataset.idx:-1,s=Z.cb.enemies.filter(e=>e.hp>0);o>=0&&Z.cb.enemies[o].hp>0?sh(t,o):s.length===1&&n.clientY<Xm()?sh(t,s[0].idx):(ah(),qm())};e.addEventListener(`pointerup`,e=>n(e,!1)),e.addEventListener(`pointercancel`,e=>n(e,!0))}var Xm=()=>Z.ce?.hand?Z.ce.hand.getBoundingClientRect().top-24:innerHeight-260,Zm=(e,t)=>document.elementsFromPoint(e,t).find(e=>!e.closest(`.card`));function Qm(e,t){let n=Z.cb,r=n.hand.find(t=>t.uid===e.uid);if(!r){Z.drag=null;return}let i=Ud(r);if(i.unplayable||Nf(Z.run,n,r)>n.player.energy){if(Cf(Z.run,n,r)){e.live=!0,e.free=!0,e.kindleOnly=!0,Z.hoveredCard=null,X.hover(),t.classList.add(`dragging`),Z.ce?.lantern?.classList.add(`kindle-target`);return}Z.drag=null,t.classList.add(`nope`),setTimeout(()=>t.classList.remove(`nope`),350),X.debuff();return}e.live=!0,Z.hoveredCard=null,X.hover(),Cf(Z.run,n,r)&&Z.ce?.lantern?.classList.add(`kindle-target`),i.target===`enemy`?ih({kind:`card`,uid:e.uid}):(e.free=!0,ah(),t.classList.add(`dragging`))}async function $m(e){if(Z.hoveredCard=null,!Tf(Z.run,Z.cb,e)){qm();return}await _h(),bh()}function eh(e,t){let n=document.elementFromPoint(e,t)?.closest(`.enemy`);Z.ce?.enemies.forEach(e=>e.root.classList.toggle(`target-hover`,e.root===n&&e.root.classList.contains(`targetable`))),th()}function th(){let e=Z.ce,t=Z.cb;if(!e||!t)return;let n=null;Z.targeting?.kind===`card`?n=t.hand.find(e=>e.uid===Z.targeting.uid):Z.drag?.live?n=t.hand.find(e=>e.uid===Z.drag.uid):Z.hoveredCard!=null&&!Z.busy&&(n=t.hand.find(e=>e.uid===Z.hoveredCard));let r=n?Ud(n):null,i=Z.targeting?.kind===`card`||Z.drag?.live&&!Z.drag.free,a=t.enemies.filter(e=>e.hp>0).length;t.enemies.forEach((o,s)=>{let c=e.enemies[s],l=null,u=!1;if(n&&!t.over&&o.hp>0&&!r.unplayable&&(r.target===`allEnemies`?l=Gf(Z.run,t,n,s):r.target===`enemy`&&(i||a===1)&&(l=Gf(Z.run,t,n,s),u=i&&a>1&&!c.root.classList.contains(`target-hover`))),l&&(l.total>0||l.chips>0)){let e=l.hits[0],t=l.hits.length===1&&e&&e.times>1?`${e.dmg}×${e.times}`:`${l.total}`;c.prev.innerHTML=(l.lethal?`${wp(`skull`,15)} `:``)+(l.total>0?t:``)+(l.willShatter&&!u?` <span class="pv-shatter">${wp(`stagger`,14)}</span>`:``),c.prev.classList.add(`show`),c.prev.classList.toggle(`dim`,u),c.prev.classList.toggle(`lethal`,l.lethal),c.root.classList.toggle(`marked`,l.lethal&&!u);let n=Math.min(o.hp,l.loss)/o.maxHp;c.pv.style.left=`${Math.max(0,o.hp-l.loss)/o.maxHp*100}%`,c.pv.style.width=`${n*100}%`,c.pv.classList.toggle(`show`,l.loss>0),c.facets.innerHTML=Wm(o,u?0:l.chips),c.facets.classList.toggle(`willshatter`,l.willShatter&&!u)}else c.prev.classList.remove(`show`,`lethal`,`dim`),c.root.classList.remove(`marked`),c.pv.classList.remove(`show`),o.hp>0&&(c.facets.innerHTML=Wm(o)),c.facets.classList.remove(`willshatter`)})}function nh(e){if(Z.busy||!Z.cb||Z.cb.over||performance.now()-Jm<350)return;let t=Z.cb,n=t.hand.find(t=>t.uid===e);if(!n)return;if(nm&&Z.hoveredCard!==e&&!(Z.targeting?.kind===`card`&&Z.targeting.uid===e)){Z.hoveredCard=e,X.hover(),qm();return}let r=Ud(n),i=Nf(Z.run,t,n),a=Q(`.card[data-uid="${e}"]`,Z.ce.hand);if(r.unplayable||i>t.player.energy){a?.classList.add(`nope`),setTimeout(()=>a?.classList.remove(`nope`),350),X.debuff();return}if(Z.targeting?.kind===`card`&&Z.targeting.uid===e)return ah();if(r.target===`enemy`){let n=t.enemies.filter(e=>e.hp>0);if(n.length===1)return void sh(e,n[0].idx);ih({kind:`card`,uid:e})}else sh(e,null)}function rh(e){if(!Z.targeting||Z.busy)return;let t=Z.cb.enemies[e];if(!t||t.hp<=0)return;let n=Z.targeting;n.kind===`card`?sh(n.uid,e):n.kind===`potion`&&vm(n.slot,e)}function ih(e){if(Z.targeting=e,Z.ce.root.classList.add(`targeting`),Z.cb.enemies.forEach((e,t)=>Z.ce.enemies[t].root.classList.toggle(`targetable`,e.hp>0)),qm(),document.addEventListener(`pointermove`,oh),oh._last)oh(oh._last);else{let e=Z.cb.enemies.findIndex(e=>e.hp>0);if(e>=0){let t=Rm(e);oh({clientX:t.x,clientY:t.y,synthetic:!0})}}}function ah(){Z.targeting=null,Q(`#aim`).innerHTML=``,document.removeEventListener(`pointermove`,oh),Z.ce&&(Z.ce.root.classList.remove(`targeting`),Z.ce.enemies.forEach(e=>e.root.classList.remove(`targetable`,`target-hover`)),qm()),fm()}function oh(e){if(e.synthetic||(oh._last=e),!Z.targeting)return;let t;if(Z.targeting.kind===`card`){let e=Q(`.card[data-uid="${Z.targeting.uid}"]`);t=e?jd(e):{x:innerWidth/2,y:innerHeight-200}}else t={x:innerWidth/2,y:60};let n=e.clientX,r=e.clientY,i=(t.x+n)/2,a=Math.min(t.y,r)-120;if(Q(`#aim`).innerHTML=`<path d="M${t.x} ${t.y-80} Q${i} ${a} ${n} ${r}" fill="none" stroke="rgba(255,89,100,.85)" stroke-width="4" stroke-dasharray="4 10" stroke-linecap="round"/>
    <circle cx="${n}" cy="${r}" r="9" fill="none" stroke="rgba(255,89,100,.95)" stroke-width="3"/>`,Z.ce?.hero){let e=jd(Z.ce.hero),t=Q(`#lantern`);t.style.setProperty(`--lx`,`${Math.round(e.x+(n-e.x)*.3)}px`),t.style.setProperty(`--ly`,`${Math.round(e.y+(r-e.y)*.3)}px`)}}async function sh(e,t){ah(),Z.hoveredCard=null,Ff(Z.run,Z.cb,e,t)&&(await _h(t),bh())}async function ch(){Z.busy||!Z.cb||Z.cb.over||(ah(),X.click(),zf(Z.run,Z.cb),await _h(),bh())}function lh(e){let t=$(`div`,`turn-banner`,e);om().appendChild(t),setTimeout(()=>t.remove(),1150)}function uh(e,t,n,r,{n:i=6,color:a=`#ffe9ac`,size:o=8,dur:s=640,glyph:c=``,cls:l=`flymote`,done:u=null}={}){let d=Q(`#floaties`);for(let f=0;f<i;f++){let p=$(`div`,l,c);p.style.left=`${e}px`,p.style.top=`${t}px`,c?p.style.color=a:(p.style.width=`${o}px`,p.style.height=`${o}px`,p.style.background=`radial-gradient(circle at 35% 30%, #fff, ${a} 55%, transparent 85%)`),d.appendChild(p);let m=(e+n)/2+(Math.random()-.5)*140,h=Math.min(t,r)-50-Math.random()*80,g=p.animate([{transform:`translate(-50%,-50%) scale(0.5)`,opacity:0},{transform:`translate(calc(-50% + ${m-e}px), calc(-50% + ${h-t}px)) scale(1.05)`,opacity:1,offset:.45},{transform:`translate(calc(-50% + ${n-e}px), calc(-50% + ${r-t}px)) scale(0.55)`,opacity:.95}],{duration:s,delay:f*46,easing:`cubic-bezier(.32,.05,.35,1)`});g.onfinish=()=>{p.remove(),f===i-1&&u&&u()}}}var dh=matchMedia(`(prefers-reduced-motion: reduce)`).matches;function fh(e,t,n,r=640){if(t=Math.round(t),n=Math.round(n),dh||t===n){e.textContent=n;return}let i=performance.now(),a=o=>{let s=Math.min(1,(o-i)/r),c=1-(1-s)**3;e.textContent=Math.round(t+(n-t)*c),s<1?requestAnimationFrame(a):(e.textContent=n,e.classList.remove(`tick`),e.offsetWidth,e.classList.add(`tick`))};requestAnimationFrame(a)}function ph(){let e=Z.ce,t=Z.cb;e.rig=[];let n=(t,n,r,i,a)=>{let o=Q(`svg`,n);if(!o)return;let s=Math.random()*100,c=Q(`.breathe`,o);c&&(c.style.animationDuration=`${(2.5+s%1.9).toFixed(2)}s`,c.style.animationDelay=`${(-(s%3.1)).toFixed(2)}s`,c.style.setProperty(`--brY`,(1.022+s%.024).toFixed(3)),c.style.setProperty(`--sw`,`${(s*7%1.7-.85).toFixed(2)}deg`)),im(`.hover-float`,o).forEach(e=>e.style.animationDelay=`${(-(s%2.7)).toFixed(2)}s`);let l=$(`div`,`lightpool`);l.style.background=`radial-gradient(ellipse at 50% 50%, ${r}, transparent 72%)`,n.appendChild(l),e.rig.push({root:t,art:n,svg:o,eyes:im(`.eye`,o),fire:Q(`.innerfire`,o),pool:l,seed:s,isHero:i,idx:a,dx:0,dy:0})};t.enemies.forEach((t,r)=>n(e.enemies[r].root,e.enemies[r].art,`hsla(${Rl[t.key].art.hue},90%,66%,.72)`,!1,r)),n(e.hero,e.hero,`rgba(127,212,255,.62)`,!0,0)}function mh(e){requestAnimationFrame(mh);let t=Z.ce,n=Z.cb;if(dh||!n||Z.screen!==`combat`||!t?.rig)return;let r=null,i=n.enemies.findIndex(e=>e.hp>0);Z.targeting&&oh._last?r={x:oh._last.clientX,y:oh._last.clientY}:i>=0&&(r=Rm(i));let a=zm();for(let i of t.rig){let t=i.isHero?n.player:n.enemies[i.idx];if(!i.isHero&&t.hp<=0){i.pool.style.opacity=0;continue}let o=i.isHero?r:a;if(o&&i.eyes.length){let e=jd(i.art),t=Math.atan2(o.y-e.y,o.x-e.x);i.dx+=(Math.cos(t)*2.4-i.dx)*.08,i.dy+=(Math.sin(t)*1.6-i.dy)*.08;let n=`translate(${i.dx.toFixed(2)}px,${i.dy.toFixed(2)}px)`;for(let e of i.eyes)e.style.transform=n}let s=.45+.55*(Math.max(0,t.hp)/t.maxHp);i.root.classList.contains(i.isHero?`lunge`:`acting`)&&(s+=1.1),(t.statuses?.str||0)>0&&(s+=.3);let c=.86+.14*Math.sin(e*.006+i.seed)*Math.sin(e*.0021+i.seed*3);i.fire&&(i.fire.style.opacity=Math.min(.55,(.05+.13*s)*c).toFixed(3)),i.pool.style.opacity=Math.min(.85,(.3+.4*s)*c).toFixed(3)}}var hh=!1;function gh(e,t){let n=e&&Q(`.cracks`,e);n&&n.children.length<8&&n.insertAdjacentHTML(`beforeend`,lp(t))}async function _h(e=null){let t=Z.cb,n=Z.ce;Z.busy=!0,n.endTurn.classList.add(`enemy-phase`);let r=t.queue;for(;r.length;){let t=r.shift();try{await yh(t,e)}catch(e){console.error(`vfx event error`,t,e)}}Z.busy=!1,t.over||n.endTurn.classList.remove(`enemy-phase`),Gm(),Km(),pm()}var vh=null;async function yh(e,t){let n=Z.cb,r=Z.ce;switch(e.t){case`chip`:{let t=r.enemies[e.idx],{x:n,y:i}=Rm(e.idx);X.chip(),Td(n,i,{color:`#e8f4ff`,n:5,speed:190,size:1.8,grav:240,kind:`spark`}),Gm(),t.facets.classList.remove(`pop`),t.facets.offsetWidth,t.facets.classList.add(`pop`),await am(110);break}case`shatter`:{let t=r.enemies[e.idx],{x:n,y:i}=Rm(e.idx);vh={x:n,y:i},X.shatter(),Cd(90),Ed(n,i,`#dfeaff`,10,700,5),Td(n,i,{color:`#dfeaff`,n:26,speed:430,size:2.4,grav:300,kind:`spark`}),kd(n,i-58,`${wp(`stagger`,20)} SHATTER`,`shatterf`),Sd(10),id(.9),gh(t.art,!0),t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),Gm(),await am(380);break}case`adamantHold`:{let{x:t,y:n}=Rm(e.idx);X.blocked(),kd(t,n-52,`THE GLASS HOLDS`,`blockedf`),Ed(t,n,`#d8c27a`,8,480,4),Gm(),await am(260);break}case`ember`:if(e.n>0&&r.lantern){let t=vh||zm(),n=jd(r.lantern);uh(t.x,t.y,n.x,n.y,{n:Math.min(e.n*2,5),color:`#ffb35a`,size:6,dur:460}),X.ember(),setTimeout(()=>{r.lantern.classList.remove(`pop`),r.lantern.offsetWidth,r.lantern.classList.add(`pop`),Gm()},440),await am(300)}else Gm();vh=null;break;case`kindle`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand);t&&(vh=jd(t)),X.kindle(),await am(60);break}case`art`:{let t=Gl[e.id],{x:n,y:i}=zm(),a=r.lantern?jd(r.lantern):{x:n,y:i};X.art(),wd(t.tone,.12,.5),Ed(a.x,a.y,t.tone,10,620,5),Od(n,i,t.tone,12),kd(n,i-84,t.name.toUpperCase(),`artf`),id(.7),Gm(),await am(420);break}case`staggered`:{let t=r.enemies[e.idx],{x:n,y:i}=Rm(e.idx);X.stagger(),kd(n,i-76,`STAGGERED`,`staggerf`),t.root.classList.add(`reseaming`),setTimeout(()=>t.root.classList.remove(`reseaming`),720),Gm(),await am(520);break}case`smolderJump`:{let t=Rm(e.from),n=Rm(e.to);X.poison(),uh(t.x,t.y,n.x,n.y,{n:5,color:`#a3e06c`,size:7,dur:460}),await am(400);break}case`turn`:e.n>1&&(lh(`YOUR TURN`),X.turn()),Gm(),await am(e.n>1?500:120);break;case`endTurn`:hh=!1,lh(`ENEMY TURN`),await am(480);break;case`draw`:Km(),Gm(),X.draw(),await am(75);break;case`reshuffle`:{X.card();let e=jd(r.discard),t=jd(r.draw);uh(e.x,e.y,t.x,t.y,{n:6,cls:`flycard`,dur:520}),kd(t.x,t.y-46,`Reshuffle`,`notice`),await am(420);break}case`play`:{let i=Q(`.card[data-uid="${e.uid}"]`,r.hand);if(X.card(),hh=!0,i&&t!=null&&n.enemies[t]){let e=i.getBoundingClientRect(),{x:n,y:r}=Rm(t),a=i.cloneNode(!0);Object.assign(a.style,{position:`fixed`,left:`${e.left}px`,top:`${e.top}px`,width:`${e.width}px`,height:`${e.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(a),i.remove(),a.animate([{transform:`none`,opacity:1},{transform:`translate(${n-e.left-e.width/2}px,${r-e.top-e.height/2}px) scale(0.22) rotate(14deg)`,opacity:0}],{duration:270,easing:`cubic-bezier(.45,0,.9,.5)`}).onfinish=()=>a.remove()}else i&&(i.classList.add(`played-up`),setTimeout(()=>i.remove(),320));Gm(),await am(200);break}case`hitEnemy`:{let t=r.enemies[e.idx],{x:n,y:i}=Rm(e.idx);if(e.poison)X.poison(),Od(n,i,`#a3e06c`,14),kd(n,i-20,`${e.amount}`,`poisonf`);else{let a=e.amount>=16;hh&&(r.hero.classList.remove(`lunge`),r.hero.offsetWidth,r.hero.classList.add(`lunge`)),X.slash(),e.amount>0&&X.hit(),Dd(n,i,a?`#ffd8a0`:`#ffffff`),Td(n,i,{color:`#ff9a6a`,n:a?30:14,speed:a?420:260}),e.blocked>0&&(X.blocked(),kd(n,i+26,`${wp(`shield`,19)}${e.blocked}`,`blockedf`),Td(n,i+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`})),e.amount>0?kd(n,i-24,`${e.amount}`,e.killingBlow||a?`crit`:`dmg`):e.blocked||kd(n,i-24,`0`,`blockedf`),Sd(Math.min(4+e.amount*.5,15)),id(Math.min(.2+e.amount/26,1)),a&&(Cd(70),Ed(n,i,`#ffd8a0`,10,620,5)),e.killingBlow&&(Cd(e.overkill>=8?130:90),id(Math.min(1.6,.6+e.overkill*.06)),Ed(n,i,`#ffffff`,8,780,5),Ed(n,i,`#ffd8a0`,14,900,4),wd(`#ffe6b0`,.09,.28),e.overkill>=8&&(wd(`#ffffff`,.12,.24),Td(n,i,{color:`#fff3d6`,n:26,speed:620,size:2.6,grav:200,kind:`spark`}),Td(n,i,{color:`#ffd76e`,n:12,speed:300,size:3.4,grav:120,kind:`spark`}))),e.amount>0&&gh(t.art,a)}t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),Gm(),await am(230);break}case`die`:{let t=r.enemies[e.idx],i=n.enemies[e.idx],{x:a,y:o}=Rm(e.idx);vh={x:a,y:o},i.boss&&(document.body.classList.add(`worldstop`),t.root.classList.add(`doomed`),Cd(110),await am(820),document.body.classList.remove(`worldstop`),t.root.classList.remove(`doomed`)),(i.boss||i.elite?X.bigDeath:X.death)(),Ad(t.art),Td(a,o,{color:`#dfeaff`,n:30,speed:480,size:2.6,grav:340,kind:`spark`}),Td(a,o,{color:`#c9b0ff`,n:26,speed:380,size:3.2,grav:60}),Ed(a,o,`#e8dcff`,12,720,6),wd(`#ffffff`,i.boss?.24:.1,.3),Sd(i.boss?22:12),id(i.boss?2:.9),t.root.classList.add(`dying`),setTimeout(()=>{t.root.classList.remove(`dying`),t.root.classList.add(`gone`)},830),await am(i.boss?900:500);break}case`hitPlayer`:{let{x:t,y:n}=zm();e.source===`poison`?(X.poison(),Od(t,n,`#a3e06c`,14)):e.source===`burn`||e.source===`self`?X.debuff():e.source===`thorns`?X.blocked():(X.slash(),e.amount>0&&(X.hit(),wd(`#ff2233`,Math.min(.05+e.amount*.012,.3),.3)),Dd(t,n,`#ff8888`)),e.blocked>0&&(X.blocked(),kd(t,n+30,`${wp(`shield`,19)}${e.blocked}`,`blockedf`),Td(t,n+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`})),e.amount>0?(kd(t,n-30,`${e.amount}`,e.amount>=16?`crit`:`dmg`),Sd(Math.min(5+e.amount*.6,18)),id(Math.min(.3+e.amount/22,1.2)),gh(r.hero,e.amount>=16)):e.blocked||kd(t,n-30,`0`,`blockedf`),Gm(),pm(),await am(240);break}case`blockGain`:{let t=e.who===`player`,{x:n,y:i}=t?zm():Rm(e.who);X.block(),kd(n,i-10,`${wp(`shield`,22)} ${e.n}`,`blockf`);let a=t?r.pBlock:r.enemies[e.who].block;a.classList.remove(`pulse`),a.offsetWidth,a.classList.add(`pulse`),Gm(),await am(140);break}case`status`:{let{x:t,y:n}=e.who===`player`?zm():Rm(e.who),r=Pl[e.id]||{name:e.id,kind:`buff`},i=r.kind===`debuff`||e.id===`str`&&e.n<0;(e.id===`poison`?X.poison:i?X.debuff:X.buff)(),kd(t,n-46,`${e.n>0?`+`:``}${e.n} ${r.name}`,i?`debufff`:`bufff`),i||Od(t,n,`#9fc8ff`,6),Gm(),await am(170);break}case`heal`:{let{x:t,y:n}=e.who===`player`?zm():Rm(e.who);X.heal(),Od(t,n,`#8fe8a0`,14),kd(t,n-30,`+${e.n}`,`healf`),Gm(),pm(),await am(200);break}case`energy`:Gm(),r.energy.classList.remove(`pop`),r.energy.offsetWidth,r.energy.classList.add(`pop`);break;case`exhaust`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand);if(t){let e=t.getBoundingClientRect(),n=t.cloneNode(!0);Object.assign(n.style,{position:`fixed`,left:`${e.left}px`,top:`${e.top}px`,width:`${e.width}px`,height:`${e.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(n),t.remove(),n.animate([{clipPath:`circle(80% at 50% 55%)`,filter:`brightness(1)`},{clipPath:`circle(44% at 50% 55%)`,filter:`brightness(1.8) saturate(1.6) sepia(0.45)`,offset:.45},{clipPath:`circle(0% at 50% 55%)`,filter:`brightness(2.6) saturate(2) sepia(0.85)`}],{duration:540,easing:`ease-in`}).onfinish=()=>n.remove(),Td(e.left+e.width/2,e.top+e.height/2,{color:`#ffb066`,n:22,speed:190,grav:-150,size:2.4,life:.85}),await am(260)}Gm();break}case`discardHand`:{let e=im(`.card`,r.hand);e.length&&(X.card(),e.forEach((e,t)=>{e.animate([{opacity:1},{transform:`${e.style.transform} translateX(340px) rotate(20deg)`,opacity:0}],{duration:260,delay:t*28,easing:`ease-in`}).onfinish=()=>e.remove()}),await am(280+e.length*28)),Gm();break}case`enemyAct`:{let t=r.enemies[e.idx],{x:n,y:i}=Rm(e.idx);t.intent.classList.remove(`telegraph`),t.intent.offsetWidth,t.intent.classList.add(`telegraph`),t.root.classList.add(`acting`),setTimeout(()=>{t.root.classList.remove(`acting`),t.intent.classList.remove(`telegraph`)},650),kd(n,i-90,e.name,`notice`),await am(620);break}case`intent`:Gm();break;case`addCard`:kd(innerWidth/2,innerHeight*.62,`${Ml[e.id].name} added to ${e.where===`hand`?`hand`:`discard`}`,`notice`),X.debuff(),Gm(),Km(),await am(240);break;case`relicProc`:{let t=Q(`.relic-chip[data-relic="${e.id}"]`);t&&(t.classList.remove(`proc`),t.offsetWidth,t.classList.add(`proc`)),await am(90);break}case`maxHp`:{let{x:t,y:n}=zm();kd(t,n-60,`+${e.n} MAX HP`,`healf`),X.buff(),await am(160);break}case`potion`:X.potion(),await am(120);break;case`powerConsumed`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand),n=t?jd(t):{x:innerWidth/2,y:innerHeight-180},{x:i,y:a}=zm();uh(n.x,n.y,i,a,{n:7,color:`#c9a8ff`,size:7,dur:560}),X.buff(),setTimeout(()=>{Ed(i,a,`#c9a8ff`,12,460,4),Od(i,a,`#c9a8ff`,8)},560),await am(300);break}case`victory`:if(Z.lastPerfect=!!e.perfect,await am(320),X.victory(),wd(`#ffe9ac`,.16,.6),e.perfect){let e=$(`div`,`turn-banner perfect-banner`,`PERFECT`);om().appendChild(e),setTimeout(()=>e.remove(),1400),await am(500)}break;case`defeat`:{await am(400),X.defeat(),wd(`#300`,.5,1.2);let e=Q(`#lantern`);e.classList.add(`gutter`),e.style.setProperty(`--la`,`1`),e.style.setProperty(`--lr`,`160px`),await am(900);break}}}function bh(){let e=Z.cb;!e||!e.over||(e.result===`win`?xh():Sh())}function xh(){let e=Z.run,t=Z.cb.kind,n=Z.cb.affix;if(Z.cb=null,e.pendingCombat=null,t===`boss`&&e.act>=2){let{newUnlocks:t}=Ip(e,!0);np(e,!0),Tm(`end`,{won:!0,newUnlocks:t});return}Tm(`reward`,{kind:t,rewards:af(e,t,n)})}function Sh(){let e=Z.run,t=Bp(e),n=e.map.nodes.find(t=>t.id===e.nodeId),r=n?n.row:Math.max(1,e.floorsClimbed-1),{newUnlocks:i}=Ip(e,!1);np(e,!1),Tm(`end`,{won:!1,newUnlocks:i,offers:t,fallAct:e.act,fallRow:r})}function Ch({kind:e,rewards:t}){let n=Z.run,r=om(),i=e===`boss`?`BOSS VANQUISHED`:e===`elite`?`ELITE SLAIN`:`VICTORY`,a=Z.lastPerfect?`<div class="perfect-seal">✦ PERFECT — the glass untouched ✦</div>`:`<div class="ornament">✦ ✦ ✦</div>`;Z.lastPerfect=!1,r.innerHTML=`<div class="center-panel screen-enter"><div class="panel">
  ...
  </div></div>`;let o=Q(`.reward-list`,r),s=(e,t,r,i=null)=>{let a=$(`button`,`reward-row`,`<span class="ric">${e}</span><span>${t}</span>`);return i&&(a._tip=i),a.onclick=()=>{r()!==!1&&(a.classList.add(`taken`),Qf(n),pm())},o.appendChild(a),a};if(s(`¤`,`<b class="gold-num">${t.gold}</b> gold`,()=>{n.player.gold+=t.gold,n.stats.goldEarned+=t.gold,X.coin(),requestAnimationFrame(()=>{let e=Q(`#hud .gold-num`),r={x:innerWidth/2,y:innerHeight/2-40},i=e?jd(e):{x:120,y:24},a=n.player.gold-t.gold;e&&(e.textContent=a),uh(r.x,r.y,i.x,i.y,{n:Math.min(9,4+Math.floor(t.gold/12)),color:`#ffd76e`,dur:600,done:()=>X.coin()}),e&&fh(e,a,n.player.gold,640)})}),t.potion){let e=Ll[t.potion];s(_p(e.tone),`${e.name}`,()=>{if(!tf(n,t.potion))return kd(innerWidth/2,innerHeight/2,`Potion slots full!`,`notice`),!1;X.potion()},{title:e.name,body:e.text})}if(t.relic){let e=Fl[t.relic];s(`<span style="color:${e.tone};text-shadow:0 0 8px ${e.tone}">${e.glyph}</span>`,`<b>${e.name}</b>`,()=>{$d(n,t.relic),X.relic(),requestAnimationFrame(()=>{let n=Q(`.relic-chip[data-relic="${t.relic}"]`);if(!n)return;let r=jd(n);uh(innerWidth/2,innerHeight/2-40,r.x,r.y,{n:1,glyph:e.glyph,color:e.tone,dur:680,done:()=>{n.classList.remove(`proc`),n.offsetWidth,n.classList.add(`proc`)}})})},{title:e.name,body:e.text})}s(wp(`cards`,26),`Add a card to your deck`,()=>(l(t.cards,()=>{}),!1));let c=o.lastElementChild;c.dataset.cardrow=`1`,Q(`[data-a="continue"]`,r).onclick=()=>{X.click(),Qf(n),Tm(e===`boss`?`bossRelic`:`map`)};function l(e,t){Sm(`Choose a Card`,e.map(e=>({id:e,up:!1,uid:null})),{sub:`Add one card to your deck — or skip to keep it lean.`,pick:e=>{e&&(Kf(n,e.id),X.upgrade(),kd(innerWidth/2,innerHeight/2,`${Ud(e).name} added`,`notice`)),c.classList.add(`taken`),Qf(n),t()},canSkip:!0})}}function wh(){let e=Z.run,t=of(e),n=om();n.innerHTML=`<div class="center-panel screen-enter"><div class="panel" style="width:min(620px,94vw)">
  ...
  </div></div>`;let r=Q(`.big-choices`,n);for(let n of t){let t=Fl[n],i=$(`button`,`relic-pick`);i.innerHTML=`<span class="relic-chip" style="--tone:${t.tone}">${t.glyph}</span><span><b>${t.name}</b><span class="rd">${t.text}</span></span>`,i.onclick=()=>{X.relic(),$d(e,n),Th()},r.appendChild(i)}let i=$(`button`,`btn ghost`,`Take none`);i.style.marginTop=`10px`,i.onclick=()=>{X.click(),Th()},r.appendChild(i)}function Th(){let e=Z.run;e.act++,e.omens.push(zd(e)),e.nodeId=null,e.map=Gd(e),Qd(e,Math.round(e.player.maxHp*.35)),nd(e.act),Uu(e.act,0),$p(e.act),Qf(e),Tm(`map`),lh(`ACT ${e.act+1}`),X.victory(),setTimeout(()=>Eh(e),1400)}function Eh(e){let t=Ul[e.omens?.[e.act]];if(!t||Z.screen!==`map`)return;let n=$(`div`,`turn-banner omen-banner`,`<span class="ob-glyph" style="color:${t.tone}">${t.glyph}</span> OMEN — ${t.name.toUpperCase()}<div class="ob-sub">${t.text}</div>`);om().appendChild(n),X.omen(),setTimeout(()=>n.remove(),4200)}function Dh(){let e=Z.run,t=e.player.deck.some(e=>!e.up&&Ml[e.id].up);om().innerHTML=`<div class="center-panel screen-enter"><div class="panel">
    <div class="ov-title">REST SITE</div>
    <div class="art-lg">${yp()}</div>
    <div class="ov-sub">The fire crackles. For a moment, the Spire is quiet.</div>
    <div class="big-choices">
      <button class="btn" data-a="rest">${wp(`flame`,18)} Rest <span style="font-size:13px;opacity:.8">— heal ${Math.round(e.player.maxHp*Vd(e))} HP</span></button>
      <button class="btn" data-a="smith" ${t?``:`disabled`}>${wp(`hammer`,18)} Smith <span style="font-size:13px;opacity:.8">— upgrade a card</span></button>
    </div>
  </div></div>`,Q(`[data-a="rest"]`).onclick=t=>{t.currentTarget.disabled=!0,Q(`[data-a="smith"]`).disabled=!0,X.heal();let n=Qd(e,Math.round(e.player.maxHp*Vd(e)));wd(`#ff9a4d`,.12,.8),kd(innerWidth/2,innerHeight/2-40,`+${n} HP`,`healf`),Od(innerWidth/2,innerHeight/2,`#8fe8a0`,22),Od(innerWidth/2,innerHeight/2+60,`#ffb066`,16),Qf(e),setTimeout(()=>{Z.screen===`rest`&&Tm(`map`)},900)},Q(`[data-a="smith"]`).onclick=()=>{X.click(),Sm(`Upgrade a Card`,e.player.deck.filter(e=>!e.up&&Ml[e.id].up),{sub:`Forge one card into its + form.`,pick:t=>{t&&(Jf(e,t.uid),X.upgrade(),wd(`#ffe9ac`,.12,.4),Sm(`Upgraded!`,[e.player.deck.find(e=>e.uid===t.uid)],{sub:`It gleams with new power.`}),Qf(e),setTimeout(()=>{Z.screen===`rest`&&(xm(),Tm(`map`))},1300))}})}}function Oh(){let e=Z.run;om().innerHTML=`<div class="center-panel screen-enter"><div class="panel">
    <div class="ov-title">TREASURE</div>
    <div class="art-lg" style="cursor:pointer" data-a="open">${vp(!1)}</div>
  ...
  </div></div>`;let t=()=>{let t=ef(e,{common:.55,uncommon:.35,rare:.1});Q(`.art-lg`).innerHTML=vp(!0),X.relic(),wd(`#ffe9ac`,.2,.5),Td(innerWidth/2,innerHeight/2,{color:`#ffd97a`,n:36,speed:380,grav:160});let n=Q(`.big-choices`);if(t){$d(e,t);let n=Fl[t];Q(`.ov-sub`).innerHTML=`You claim <b style="color:${n.tone}">${n.name}</b> — <i>${n.text}</i>`}else e.player.gold+=60,Q(`.ov-sub`).innerHTML=`Only coins remain — <b class="gold-num">+60 gold</b>.`,X.coin();pm(),Qf(e),n.innerHTML=``;let r=$(`button`,`btn`,`Continue`);r.onclick=()=>{X.click(),Tm(`map`)},n.appendChild(r)};im(`[data-a="open"]`).forEach(e=>e.onclick=t)}function kh(){let e=Z.run,t=Z.shopData||={};(Z.screen!==`shop`||!t.stock||t.forNode!==e.nodeId)&&(t.stock=sf(e),t.forNode=e.nodeId);let n=t.stock,r=om();r.innerHTML=`<div class="center-panel screen-enter"><div class="panel ov-panel" style="width:min(980px,96vw)">
    <div style="display:flex;align-items:center;justify-content:center;gap:18px">
      <div style="width:130px">${bp()}</div>
  ...
  </div></div>`;let i=Q(`.cards-row`,r),a=Q(`.misc-row`,r),o=Q(`.shop-grid`,r),s=!1,c=()=>e.player.gold,l=t=>{e.player.gold-=t,X.coin(),Qf(e),pm(),u()};function u(){o&&o.classList.toggle(`list-seq-done`,s),i.innerHTML=``,a.innerHTML=``;for(let t of n.cards){let n=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),r=dm({id:t.id,up:!1,uid:null},{size:138});r.onclick=()=>{if(t.sold||c()<t.price)return X.debuff();t.sold=!0,Kf(e,t.id),l(t.price)},n.appendChild(r),n.appendChild($(`div`,`price`,`¤ ${t.price}`)),i.appendChild(n)}for(let t of n.relics){let n=Fl[t.id],r=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),i=$(`button`,`shop-relic`,`<span class="relic-chip" style="--tone:${n.tone}">${n.glyph}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||c()<t.price)return X.debuff();t.sold=!0,$d(e,t.id),X.relic(),l(t.price)},r.appendChild(i),r.appendChild($(`div`,`price`,`¤ ${t.price}`)),a.appendChild(r)}for(let t of n.potions){let n=Ll[t.id],r=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),i=$(`button`,`shop-relic`,`<span style="width:34px;height:44px">${_p(n.tone)}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||c()<t.price)return X.debuff();if(!tf(e,t.id)){kd(innerWidth/2,innerHeight/2,`Potion slots full!`,`notice`);return}t.sold=!0,X.potion(),l(t.price)},r.appendChild(i),r.appendChild($(`div`,`price`,`¤ ${t.price}`)),a.appendChild(r)}let t=$(`div`,`shop-item ${n.removed?`sold`:``} ${c()<n.removeCost?`cant`:``}`),r=$(`button`,`shop-relic`,`<span style="width:34px;display:inline-flex;justify-content:center">${wp(`scissors`,26)}</span><b>Card Removal</b>Remove a card from your deck forever.`);r.onclick=()=>{if(n.removed||c()<n.removeCost)return X.debuff();Sm(`Remove a Card`,e.player.deck,{sub:`Cut the dead weight.`,pick:t=>{t&&(qf(e,t.uid),n.removed=!0,e.player.gold-=n.removeCost,X.card(),Qf(e),pm(),u())},canSkip:!0,skipLabel:`Cancel`})},t.appendChild(r),t.appendChild($(`div`,`price`,`¤ ${n.removeCost}`)),a.appendChild(t),s=!0}u(),Q(`[data-a="leave"]`,r).onclick=()=>{X.click(),Tm(`map`)}}function Ah(e){let t=Z.run,n=Bl[e],r=om();r.innerHTML=`<div class="center-panel screen-enter"><div class="panel event-panel">
    <div class="ov-title">${n.name.toUpperCase()}</div>
    <div class="event-art">${xp(n.glyph,n.hue)}</div>
    <div class="event-text">${n.text}</div>
    <div class="event-log"></div>
    <div class="event-choices"></div>
  </div></div>`;let i=Q(`.event-choices`,r);for(let e of n.choices){let n=$(`button`,`event-choice`,`<b>${e.label}</b>${e.sub?`<div class="sub">${e.sub}</div>`:``}`);e.needGold&&t.player.gold<e.needGold&&(n.disabled=!0),n.onclick=()=>a(e),i.appendChild(n)}async function a(e){X.click();let{pending:n,log:a}=rp(t,e.ops);pm();let s=Q(`.event-log`,r),c=[];for(let e of a)e.text&&c.push(e.text),e.relic&&c.push(`Gained <b style="color:${Fl[e.relic].tone}">${Fl[e.relic].name}</b> — <i>${Fl[e.relic].text}</i>`);c.length&&(s.innerHTML=c.join(`<br>`)),i.innerHTML=``;for(let e of n)await o(e);Qf(t),pm();let l=$(`button`,`btn`,`Continue`);l.onclick=()=>{X.click(),Tm(`map`)},i.appendChild(l),!c.length&&!n.length&&!e.ops.length&&Tm(`map`)}function o(e){return new Promise(n=>{if(e===`remove`)Sm(`Remove a Card`,t.player.deck,{sub:`Let it go.`,pick:e=>{e&&(qf(t,e.uid),X.card()),n()},canSkip:!1});else if(e===`upgrade`){let e=t.player.deck.filter(e=>!e.up&&Ml[e.id].up);if(!e.length)return n();Sm(`Upgrade a Card`,e,{sub:`The forge hungers.`,pick:e=>{e&&(Jf(t,e.uid),X.upgrade()),n()}})}else e===`duplicate`?Sm(`Duplicate a Card`,t.player.deck,{sub:`The mirror remembers.`,pick:e=>{e&&(Yf(t,e.uid),X.upgrade()),n()}}):e.pickCard?Sm(`Choose a Card`,rf(t,e.pickCard).map(e=>({id:e,up:!1,uid:null})),{sub:`One page still glows.`,pick:e=>{e&&(Kf(t,e.id),X.upgrade()),n()},canSkip:!0}):n()})}}function jh(e){return e.kind===`relic`?{icon:Fl[e.id]?.glyph||`◈`,name:Fl[e.id]?.name||e.id,note:`your rarest relic`}:e.kind===`card`?{icon:`🂠`,name:(Ml[e.id]?.name||e.id)+(e.up?`+`:``),note:`your finest card`}:{icon:`¤`,name:`${e.amount} gold`,note:`a cache of gold`}}function Mh(e){if(e===`aspect2`)return{kind:`Aspect Unlocked`,name:`The Ashwarden`};let[t,n]=e.split(`:`);return t===`card`?{kind:`Card Unlocked`,name:Ml[n]?.name||n}:{kind:`Relic Unlocked`,name:Fl[n]?.name||n}}function Nh(e=[]){if(!e.length)return;let t=Q(`#toasts`);t||(t=$(`div`),t.id=`toasts`,document.body.appendChild(t)),e.forEach((e,n)=>{let r=Mh(e);setTimeout(()=>{let e=$(`div`,`unlock-toast`,`<div class="ut-kind">✦ ${r.kind}</div><div class="ut-name">${r.name}</div>`);t.appendChild(e),requestAnimationFrame(()=>e.classList.add(`in`)),X.relic(),setTimeout(()=>{e.classList.remove(`in`),setTimeout(()=>e.remove(),500)},3800)},700+n*800)})}function Ph({won:e,newUnlocks:t=[],offers:n=[],fallAct:r=0,fallRow:i=1}){let a=Z.run;em();let o=a.stats,s=Math.max(1,Math.round((Date.now()-o.start)/6e4)),c=a.act*15+a.floorsClimbed,l=`<div class="stats-grid">
    ...
    </div>`;if(e){om().innerHTML=`<div class="end-screen screen-enter">
      ...
      ${l}${u}
    </div>`,rd(),X.victory(),wd(`#ffe9ac`,.25,1);let e=setInterval(()=>Td(Math.random()*innerWidth,innerHeight*.2,{color:[`#ffd97a`,`#c9b0ff`,`#8fe8a0`][Math.random()*3|0],n:16,speed:300,grav:260,life:1.2}),400);setTimeout(()=>clearInterval(e),4200)}else{let e=n.length?`<div class="bequest" id="bequest">
        <div class="bequest-title">Carve one thing into the stone — the next climb may recover it in <b>${jl[r].name}</b>.</div>
        <div class="bequest-opts">${n.map((e,t)=>{let n=jh(e);return`<button class="bequest-opt" data-a="bequest" data-i="${t}"><span class="bq-icon">${n.icon}</span><span class="bq-name">${n.name}</span><span class="bq-note">${n.note}</span></button>`}).join(``)}</div>
      </div>`:``,t=Array.from({length:14},()=>`<span class="ember" style="left:${(8+Math.random()*84).toFixed(1)}%;--ex:${((Math.random()-.5)*90).toFixed(0)}px;animation-delay:${(Math.random()*4).toFixed(2)}s;animation-duration:${(3+Math.random()*3).toFixed(2)}s"></span>`).join(``);om().innerHTML=`<div class="end-screen grave">
      <div class="monument">
    ...
    </div>`}om().onclick=e=>{let t=e.target.closest(`[data-a]`);if(!t)return;let o=t.dataset.a;if(o===`bequest`){X.relic();let e=n[+t.dataset.i];Lp(r,i,e);let a=jh(e);Q(`#bequest`).innerHTML=`<div class="bequest-done">✦ The stone keeps your <b>${a.name}</b>.<br>It will wait for you in ${jl[r].name}.</div>`;return}X.click(),o===`deck`&&Sm(`Final Deck`,a.player.deck,{}),o===`title`&&(Z.run=null,Z.lamp=null,Tm(`title`))},Nh(t)}function Fh(){lm(),document.addEventListener(`pointerdown`,()=>qp(),{once:!0}),document.addEventListener(`contextmenu`,e=>{Z.targeting&&(e.preventDefault(),ah())}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&(Z.targeting?ah():Q(`#overlay`).classList.contains(`open`)&&Q(`#overlay`)._closable&&xm()),(e.key===`e`||e.key===`E`)&&Z.screen===`combat`&&!Z.busy&&ch(),(e.key===`a`||e.key===`A`)&&Z.screen===`combat`&&!Z.busy&&Z.ce?.lantern?.click()}),Q(`#overlay`).addEventListener(`pointerdown`,e=>{e.target===Q(`#overlay`)&&Q(`#overlay`)._closable&&xm()}),window.spirebound={S:Z,E:Md,startCombatUI:Im,show:Tm},requestAnimationFrame(mh),Tm(`title`)}ed(),yd(),Fh();