...
void main() {
  ...
  </defs>`}var yf=`stroke="#070a12" stroke-width="3.6" paint-order="stroke" stroke-linejoin="round"`;function bf(e){return e.replace(/<path(?![^>]*stroke=)(?![^>]*fill="none")([^>]*?)\/>/g,`<path$1 ${yf}/>`).replace(/<(circle|ellipse)([^>]*fill="url\(#[^"]+[bd]\)"[^>]*?)\/>/g,(e,t,n)=>n.includes(`stroke=`)?e:`<${t}${n} ${yf}/>`)}function xf(e=!1){let t=58+Math.random()*84,n=55+Math.random()*80,r=``,i=e?5:3;for(let a=0;a<i;a++){let i=Math.random()*Math.PI*2,a=t,o=n;r+=`M${a.toFixed(1)} ${o.toFixed(1)}`;let s=3+Math.floor(Math.random()*3);for(let t=0;t<s;t++){let t=(e?15:10)*(.6+Math.random());i+=(Math.random()-.5)*1.15,a+=Math.cos(i)*t,o+=Math.sin(i)*t,r+=`L${a.toFixed(1)} ${o.toFixed(1)}`}}return`<g class="crack"><path d="${r}" stroke="#0a0d18" stroke-width="3" fill="none" opacity=".75"/><path d="${r}" stroke="#dfeaff" stroke-width="1.3" fill="none" opacity=".8"/></g>`}var X=(e,t,n,r)=>`<circle class="eye" cx="${e}" cy="${t}" r="${n}" fill="${r}"/><circle cx="${e}" cy="${t}" r="${n*2.2}" fill="${r}" opacity="0.18"/>`,Sf={wisp(e,t,n){return`<g class="breathe">
    ...
    </g>`}};function Cf(e){let t=_f(),n=Y(e.hue,90,66),r=bf((Sf[e.kind]||Sf.slime)(t,e.hue,n));return`<svg class="enemy-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${vf(t,e.hue,n)}
    <ellipse cx="100" cy="192" rx="62" ry="9" fill="#000" opacity=".45"/>
    <ellipse cx="100" cy="112" rx="64" ry="70" fill="url(#${t}g)" opacity=".14"/>
    ${r}
    <g class="cracks"></g>
  </svg>`}function wf(){let e=_f(),t=`#7fd4ff`;return`<svg class="hero-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${vf(e,225,t)}
    <ellipse cx="100" cy="192" rx="56" ry="9" fill="#000" opacity=".45"/>
    <ellipse cx="100" cy="118" rx="58" ry="66" fill="url(#${e}g)" opacity=".12"/>
    ${bf(`<g class="breathe">
    ...
    <g class="cracks"></g>
  </svg>`}var Tf={strike:`⚔`,defend:`⛨`,eclipseSlash:`☾`,twinFangs:`⑂`,quickSlash:`≫`,heavyBlow:`⬇`,cleave:`⋔`,venomStrike:`☠`,lunge:`➹`,guardedStrike:`⛊`,brace:`⛨`,sidestep:`↯`,preparation:`♻`,deflect:`⛉`,leechBlade:`♆`,tempest:`≋`,uppercut:`⇑`,flurry:`⁂`,executioner:`✠`,momentum:`⤴`,bulwark:`☗`,surge:`✦`,toxicMist:`☁`,cripple:`⛓`,warCry:`♯`,fortify:`⧉`,bloodRite:`♥`,empower:`⚔`,agility:`❥`,ironSkin:`⬡`,regrowth:`❋`,oblivionStrike:`✸`,phantomBlades:`⚚`,devour:`♅`,annihilate:`✹`,aegis:`⛨`,offering:`♱`,limitBreak:`⚡`,catalyst:`⚗`,ascension:`☽`,bastion:`♜`,frenzy:`※`,virulence:`☣`,wound:`✂`,burn:`✹`,hex:`♄`},Ef=e=>{let t=9;for(let n of e)t=Math.imul(t^n.charCodeAt(0),387420489);return(t^t>>>9)>>>0};function Df(e,t){let n=_f(),r=Ef(e),i={attack:356,skill:205,power:268,status:160,curse:300}[t]??205,a=(i+30+r%40)%360,o=Y(i,85,66),s=Y(a,80,60),c=r%360,l=``;if(t===`attack`)l=`<path d="M30 120 Q75 40 150 28" stroke="${o}" stroke-width="7" fill="none" opacity=".9"/>
      ...
      <path d="M62 106 L118 50" stroke="${s}" stroke-width="5" opacity=".7"/>`;let u=Tf[e]||`✦`;return`<svg viewBox="0 0 180 150" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}function Of(e){let t=_f();return`<svg viewBox="0 0 40 52" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function kf(e=!1){let t=_f();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function Af(){let e=_f();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}function jf(){let e=_f();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    ${vf(e,40,`#ffd166`)}
  ...
  </svg>`}function Mf(e,t){let n=_f(),r=Y(t,80,66);return`<svg viewBox="0 0 220 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}var Nf={sword:`<path d="M18.5 5 L10 13.5" stroke-width="3"/><path d="M6.8 11.6 L12.4 17.2" stroke-width="2.2"/><path d="M8.6 15.4 L4.8 19.2" stroke-width="2.6"/>`,skull:`<path d="M12 3.2 a6.8 6.8 0 0 1 6.8 6.8 c0 2.6-1.4 4.4-3 5.5 V18.5 h-7.6 V15.5 c-1.6-1.1-3-2.9-3-5.5 A6.8 6.8 0 0 1 12 3.2 Z" fill="currentColor" stroke="none"/><circle cx="9.4" cy="10" r="1.7" fill="rgba(0,0,0,.8)" stroke="none"/><circle cx="14.6" cy="10" r="1.7" fill="rgba(0,0,0,.8)" stroke="none"/><path d="M10.5 20.8 v-2 M13.5 20.8 v-2" stroke-width="1.8"/>`,crown:`<path d="M4.5 17.5 L5.2 8.5 L9 12 L12 6 L15 12 L18.8 8.5 L19.5 17.5 Z" fill="currentColor" stroke="none"/><path d="M4.5 20 h15" stroke-width="2.2"/>`,chest:`<rect x="4" y="6.5" width="16" height="13" rx="2.2" fill="none" stroke-width="2.2"/><path d="M4 12 h16" stroke-width="1.8"/><rect x="10.4" y="10.2" width="3.2" height="4.4" rx="1" fill="currentColor" stroke="none"/>`,flame:`<path d="M12 2.8 C9.4 7.4 6.8 9.8 6.8 13.6 a5.2 5.2 0 0 0 10.4 0 C17.2 9.8 14.6 7.4 12 2.8 Z" fill="currentColor" stroke="none"/><path d="M12 11.4 c-1.7 2.3-1.7 3.9 0 5.4 1.7-1.5 1.7-3.1 0-5.4 Z" fill="rgba(0,0,0,.5)" stroke="none"/>`,coin:`<circle cx="12" cy="12" r="5.6" fill="none" stroke-width="2.2"/><path d="M5.4 5.4 L8 8 M18.6 5.4 L16 8 M5.4 18.6 L8 16 M18.6 18.6 L16 16" stroke-width="2"/>`,shield:`<path d="M12 2.8 L19 5.8 v5.6 c0 4.6-3.1 7.6-7 9.8 -3.9-2.2-7-5.2-7-9.8 V5.8 Z" fill="none" stroke-width="2.3"/><path d="M12 6.4 v11" stroke-width="1.6" opacity=".55"/>`,cloud:`<path d="M7.2 16.5 a3.9 3.9 0 1 1 .7-7.7 A4.9 4.9 0 0 1 17.4 9.6 a3.4 3.4 0 0 1 -.6 6.9 Z" fill="currentColor" stroke="none"/>`,plus:`<path d="M12 5.2 v13.6 M5.2 12 h13.6" stroke-width="3.4"/>`,up:`<path d="M12 4 L19 12 h-4.1 v8 h-5.8 v-8 H5 Z" fill="currentColor" stroke="none"/>`,cards:`<rect x="4.4" y="5.6" width="9.4" height="13.4" rx="1.8" transform="rotate(-8 9 12.5)" fill="none" stroke-width="2"/><rect x="10.6" y="5" width="9.4" height="13.4" rx="1.8" transform="rotate(7 15.5 11.5)" fill="none" stroke-width="2"/>`,hammer:`<rect x="9.6" y="3.4" width="9.6" height="5.4" rx="1.2" transform="rotate(22 14.5 6)" fill="currentColor" stroke="none"/><path d="M11.6 10.2 L5.2 20" stroke-width="2.6"/>`,scissors:`<path d="M7.6 7.6 L17.5 17.8 M16.4 7.6 L6.5 17.8" stroke-width="2.2"/><circle cx="6" cy="19.2" r="2.2" fill="none" stroke-width="1.8"/><circle cx="18" cy="19.2" r="2.2" fill="none" stroke-width="1.8"/>`,question:`<path d="M8.6 8.6 a3.4 3.4 0 1 1 5 3 c-1.1 .7-1.6 1.4-1.6 2.8" fill="none" stroke-width="2.6"/><circle cx="12" cy="18.6" r="1.7" fill="currentColor" stroke="none"/>`},Pf=e=>`<g fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">${Nf[e]||``}</g>`;function Ff(e,t=18){return`<svg class="gicon" width="${t}" height="${t}" viewBox="0 0 24 24" aria-hidden="true">${Pf(e)}</svg>`}function If(e,t=18){let n=t/24;return`<g transform="translate(${-t/2},${-t/2}) scale(${n})">${Pf(e)}</g>`}var Lf=null,Rf=null,zf=null,Bf=[],Vf=localStorage.getItem(`spirebound_mute`)===`1`;function Hf(){if(Lf)return!0;try{Lf=new(window.AudioContext||window.webkitAudioContext),Rf=Lf.createGain(),Rf.gain.value=Vf?0:.5,Rf.connect(Lf.destination)}catch{return!1}return!0}function Uf(){Hf()&&Lf.state===`suspended`&&Lf.resume()}function Wf(){return Vf}function Gf(){return Vf=!Vf,localStorage.setItem(`spirebound_mute`,Vf?`1`:`0`),Rf&&Rf.gain.linearRampToValueAtTime(Vf?0:.5,Lf.currentTime+.1),Vf}function Kf(e,t,n,r,i){e.gain.setValueAtTime(1e-4,t),e.gain.exponentialRampToValueAtTime(r,t+n),e.gain.exponentialRampToValueAtTime(1e-4,t+n+i)}function qf(e,{type:t=`sine`,a:n=.005,d:r=.2,peak:i=.3,slide:a=0,delay:o=0}={}){if(!Hf())return;let s=Lf.currentTime+o,c=Lf.createOscillator(),l=Lf.createGain();c.type=t,c.frequency.setValueAtTime(e,s),a&&c.frequency.exponentialRampToValueAtTime(Math.max(20,e+a),s+n+r),Kf(l,s,n,i,r),c.connect(l).connect(Rf),c.start(s),c.stop(s+n+r+.05)}function Jf({a:e=.002,d:t=.15,peak:n=.25,f0:r=800,f1:i=300,q:a=1,type:o=`bandpass`,delay:s=0}={}){if(!Hf())return;let c=Lf.currentTime+s,l=Math.ceil(Lf.sampleRate*(e+t+.05)),u=Lf.createBuffer(1,l,Lf.sampleRate),d=u.getChannelData(0);for(let e=0;e<l;e++)d[e]=Math.random()*2-1;let f=Lf.createBufferSource();f.buffer=u;let p=Lf.createBiquadFilter();p.type=o,p.Q.value=a,p.frequency.setValueAtTime(r,c),p.frequency.exponentialRampToValueAtTime(Math.max(40,i),c+e+t);let m=Lf.createGain();Kf(m,c,e,n,t),f.connect(p).connect(m).connect(Rf),f.start(c),f.stop(c+e+t+.05)}var Z={click:()=>{qf(660,{type:`triangle`,d:.05,peak:.12})},hover:()=>{qf(880,{type:`sine`,d:.03,peak:.05})},card:()=>{Jf({d:.12,f0:1800,f1:500,peak:.14})},draw:()=>{Jf({d:.08,f0:2400,f1:900,peak:.08})},slash:()=>{Jf({d:.18,f0:3200,f1:300,peak:.3,q:1.4}),qf(180,{type:`sine`,d:.12,peak:.25,slide:-120})},hit:()=>{qf(120,{type:`sine`,d:.22,peak:.4,slide:-70}),Jf({d:.1,f0:500,f1:120,peak:.2,type:`lowpass`})},blocked:()=>{qf(320,{type:`square`,d:.08,peak:.1}),Jf({d:.1,f0:4e3,f1:2e3,peak:.1,q:6})},block:()=>{qf(240,{type:`triangle`,d:.12,peak:.18}),qf(360,{type:`triangle`,d:.1,peak:.1,delay:.03})},poison:()=>{qf(300,{type:`sine`,d:.2,peak:.14,slide:-160}),Jf({d:.22,f0:900,f1:300,peak:.08,q:3})},debuff:()=>{qf(420,{type:`sawtooth`,d:.25,peak:.08,slide:-220})},buff:()=>{qf(392,{type:`triangle`,d:.14,peak:.14}),qf(523,{type:`triangle`,d:.16,peak:.14,delay:.07})},heal:()=>{qf(523,{type:`sine`,d:.2,peak:.14}),qf(659,{type:`sine`,d:.24,peak:.12,delay:.09}),qf(784,{type:`sine`,d:.3,peak:.1,delay:.18})},energy:()=>{qf(700,{type:`triangle`,d:.1,peak:.12,slide:300})},coin:()=>{qf(988,{type:`square`,d:.06,peak:.08}),qf(1319,{type:`square`,d:.12,peak:.08,delay:.06})},potion:()=>{qf(500,{type:`sine`,d:.12,peak:.14,slide:300}),Jf({d:.14,f0:1200,f1:2600,peak:.06})},death:()=>{qf(90,{type:`sawtooth`,d:.5,peak:.22,slide:-50}),Jf({d:.4,f0:600,f1:60,peak:.18,type:`lowpass`})},bigDeath:()=>{qf(60,{type:`sawtooth`,d:1.1,peak:.32,slide:-30}),Jf({d:.9,f0:900,f1:40,peak:.26,type:`lowpass`})},turn:()=>{qf(392,{type:`triangle`,d:.1,peak:.1}),qf(587,{type:`triangle`,d:.14,peak:.1,delay:.08})},victory:()=>{[523,659,784,1047].forEach((e,t)=>qf(e,{type:`triangle`,d:.35,peak:.16,delay:t*.13}))},defeat:()=>{[330,277,220,165].forEach((e,t)=>qf(e,{type:`sawtooth`,d:.5,peak:.12,delay:t*.22}))},relic:()=>{[659,831,988].forEach((e,t)=>qf(e,{type:`sine`,d:.3,peak:.12,delay:t*.09}))},upgrade:()=>{qf(440,{type:`triangle`,d:.15,peak:.14}),qf(880,{type:`triangle`,d:.3,peak:.12,delay:.1})},map:()=>{Jf({d:.25,f0:500,f1:1500,peak:.06}),qf(330,{type:`sine`,d:.2,peak:.08})}},Yf=[55,49,41.2];function Xf(e){if(!Hf())return;Zf(),zf=Lf.createGain(),zf.gain.value=0,zf.connect(Rf);let t=Yf[e]||55,n=Lf.createBiquadFilter();n.type=`lowpass`,n.frequency.value=320,n.Q.value=.6,n.connect(zf);for(let[e,r,i]of[[1,0,.5],[1.5,3,.22],[2,-4,.3],[3,2,.1]]){let a=Lf.createOscillator(),o=Lf.createGain();a.type=`sawtooth`,a.frequency.value=t*e,a.detune.value=r,o.gain.value=i,a.connect(o).connect(n),a.start(),Bf.push(a,o)}let r=Lf.createOscillator(),i=Lf.createGain();r.frequency.value=.07,i.gain.value=90,r.connect(i).connect(n.frequency),r.start(),Bf.push(r,i,n),zf.gain.linearRampToValueAtTime(.11,Lf.currentTime+3)}function Zf(){if(!zf)return;let e=zf,t=Bf;e.gain.linearRampToValueAtTime(0,Lf.currentTime+1.2),setTimeout(()=>{t.forEach(e=>{try{e.stop?.()}catch{}try{e.disconnect()}catch{}});try{e.disconnect()}catch{}},1500),zf=null,Bf=[]}var Q={run:null,cb:null,screen:`title`,targeting:null,busy:!1,hoveredCard:null,ce:null},$=(e,t=document)=>t.querySelector(e),Qf=(e,t=document)=>[...t.querySelectorAll(e)],$f=e=>new Promise(t=>setTimeout(t,e)),ep=()=>$(`#screen`);function tp(e,t=``,n=``){let r=document.createElement(e);return t&&(r.className=t),n&&(r.innerHTML=n),r}var np={Vulnerable:Pl.vulnerable.desc,Weak:Pl.weak.desc,Frail:Pl.frail.desc,Poison:Pl.poison.desc,Strength:Pl.str.desc,Dexterity:Pl.dex.desc,Exhaust:`Removed from your deck for the rest of this combat.`,Block:`Prevents damage. Expires at the start of your turn.`,Energy:`Spent to play cards. Refreshes each turn.`,Unplayable:`This card cannot be played.`,Wound:`Unplayable junk card.`,Hex:`Curse: lose 1 HP at end of turn while in hand.`,Burn:`Take 2 damage at end of turn while in hand.`};function rp(){let e=$(`#tooltip`);document.addEventListener(`mouseover`,n=>{let r=n.target;for(;r&&r!==document.body&&!r._tip;)r=r.parentElement;if(r&&r._tip){let i=r._tip;e.innerHTML=`${i.title?`<div class="tt-title">${i.title}</div>`:``}<div class="tt-body">${i.body||``}</div>${i.sub?`<div class="tt-sub">${i.sub}</div>`:``}`,e.style.display=`block`,t(n)}else e.style.display=`none`}),document.addEventListener(`mousemove`,t);function t(t){if(e.style.display!==`block`)return;let n=e.offsetWidth,r=e.offsetHeight;e.style.left=`${Math.min(innerWidth-n-12,t.clientX+16)}px`,e.style.top=`${Math.max(8,Math.min(innerHeight-r-12,t.clientY-r/2))}px`}}function ip(e,t){let n=e.replace(/@(\d+)@/g,(e,n)=>{let r=+n,i=t&&Q.cb?ef(Q.cb,r):r;return`<span class="val ${i>r?`boosted`:i<r?`reduced`:``}">${i}</span>`}).replace(/#(\d+)#/g,(e,n)=>{let r=+n,i=t&&Q.cb?tf(Q.cb,r):r;return`<span class="val ${i>r?`boosted`:i<r?`reduced`:``}">${i}</span>`});return n=n.replace(/\b(Vulnerable|Weak|Frail|Poison|Strength|Dexterity|Exhaust|Block|Energy|Unplayable)\b/g,`<span class="kw">$1</span>`),n}function ap(e,{inCombat:t=!1,size:n=null}={}){let r=_d(e),i=tp(`div`,`card t-${r.type} r-${r.rarity}${e.up?` upgraded`:``}`);n&&i.style.setProperty(`--cw`,`${n}px`),e.uid!=null&&(i.dataset.uid=e.uid);let a=``;if(r.cost!=null){let n=t&&Q.cb?Gd(Q.run,Q.cb,e):r.cost;a=`<div class="card-cost ${n===0?`free`:``}">${n}</div>`}let o=ip(r.text,t);return e.bonus&&(o=o.replace(/<span class="val[^"]*">(\d+)<\/span>/,(t,n)=>t.replace(n,+n+e.bonus))),i.innerHTML=`${a}<div class="card-inner">
    <div class="card-art">${Df(e.id,r.type)}</div>
    <div class="card-name">${r.name}</div>
    <div class="card-type">${r.type}</div>
    <div class="card-text"><span class="ct-inner">${o}</span></div>
    <div class="card-rarity"></div>
  </div>`,Qf(`.kw`,i).forEach(e=>e._tip={title:e.textContent,body:np[e.textContent]||``}),i.addEventListener(`mousemove`,e=>{let t=i.getBoundingClientRect(),n=(e.clientX-t.left)/t.width,r=(e.clientY-t.top)/t.height,a=$(`.card-inner`,i);a.style.setProperty(`--ry`,`${(n-.5)*16}deg`),a.style.setProperty(`--rx`,`${(.5-r)*12}deg`),a.style.setProperty(`--mx`,`${n*100}%`),a.style.setProperty(`--my`,`${r*100}%`),a.style.setProperty(`--gx`,(n-.5)*60)}),i.addEventListener(`mouseleave`,()=>{let e=$(`.card-inner`,i);e.style.setProperty(`--ry`,`0deg`),e.style.setProperty(`--rx`,`0deg`)}),i}function op(){let e=$(`#lantern`);if(!Q.run||Q.screen===`title`||Q.screen===`end`){e.style.setProperty(`--la`,0),e.classList.remove(`gutter`);return}let t=Q.run.player,n=Q.cb&&!Q.cb.over?Q.cb.player.hp:t.hp,r=Math.max(0,Math.min(1,(.68-n/t.maxHp)/.53));e.style.setProperty(`--la`,(r*.82).toFixed(3)),e.style.setProperty(`--lr`,`${Math.round(1500-r*1e3)}px`);let i=`50%`,a=`55%`;if(Q.screen===`combat`&&Q.ce?.hero){let e=ld(Q.ce.hero);i=`${Math.round(e.x)}px`,a=`${Math.round(e.y)}px`}e.style.setProperty(`--lx`,i),e.style.setProperty(`--ly`,a),e.classList.toggle(`gutter`,r>.55)}function sp(){op();let e=$(`#hud`);if(!Q.run||Q.screen===`title`||Q.screen===`end`){e.classList.remove(`show`),document.body.classList.remove(`low-hp`);return}e.classList.add(`show`);let t=Q.run.player,n=Q.cb&&!Q.cb.over?Q.cb.player.hp:t.hp;document.body.classList.toggle(`low-hp`,n/t.maxHp<=.3);let r=jl[Q.run.act];e.innerHTML=`<div class="hud-bar">
      ...
      <div class="hud-right">
        ${t.potions.map((e,t)=>`<button class="potion-slot ${e?`full`:``}" data-slot="${t}">${e?Of(Ll[e].tone):``}</button>`).join(``)}
        <button class="icon-btn" data-act="deck">${Ff(`cards`,19)}<span style="font-size:11px">${t.deck.length}</span></button>
        <button class="icon-btn" data-act="menu">≡</button>
      </div>
    </div>
    <div id="relicbar"></div>`;let i=$(`#relicbar`,e);for(let e of t.relics){let t=Fl[e],n=tp(`div`,`relic-chip`,t.glyph);n.style.setProperty(`--tone`,t.tone),n.dataset.relic=e,n._tip={title:t.name,body:t.text,sub:t.rarity},i.appendChild(n)}t.potions.forEach((t,n)=>{if(!t)return;let r=$(`.potion-slot[data-slot="${n}"]`,e);r._tip={title:Ll[t].name,body:Ll[t].text,sub:`Click to use or toss`}}),$(`[data-act="deck"]`,e).onclick=()=>{Z.click(),gp(`Your Deck`,Q.run.player.deck,{sub:`${Q.run.player.deck.length} cards`})},$(`[data-act="menu"]`,e).onclick=e=>{Z.click(),cp(e.clientX,e.clientY)},Qf(`.potion-slot.full`,e).forEach(e=>e.onclick=t=>dp(+e.dataset.slot,t))}function cp(e,t){lp();let n=tp(`div`,`pop-menu`);n.innerHTML=`<button data-m="help">How to Play</button><button data-m="mute">${Wf()?`Unmute`:`Mute`} Sound</button><button data-m="abandon" style="color:#ff8d8d">Abandon Run</button>`,document.body.appendChild(n),n.style.left=`${Math.min(e,innerWidth-200)}px`,n.style.top=`${t+8}px`,n.onclick=e=>{let t=e.target.dataset.m;lp(),t===`help`&&_p(),t===`mute`&&Gf(),t===`abandon`&&pp()},setTimeout(()=>document.addEventListener(`pointerdown`,up,{once:!0}),0)}var lp=()=>Qf(`.pop-menu`).forEach(e=>e.remove()),up=e=>{e.target.closest(`.pop-menu`)||lp()};function dp(e,t){if(Q.busy)return;lp();let n=Q.run.player.potions[e];if(!n)return;let r=Ll[n],i=Q.cb&&!Q.cb.over&&Q.screen===`combat`,a=!r.combatOnly||i,o=tp(`div`,`pop-menu`);o.innerHTML=`<button data-m="use" ${a?``:`disabled style="opacity:.4"`}>Use ${r.name}</button><button data-m="toss">Toss it</button>`,document.body.appendChild(o),o.style.left=`${Math.min(t.clientX-60,innerWidth-220)}px`,o.style.top=`${t.clientY+10}px`,o.onclick=async t=>{let n=t.target.dataset.m;if(lp(),n===`toss`&&(Q.run.player.potions[e]=null,Z.card(),sp(),uf(Q.run)),n===`use`&&a)if(r.needsTarget&&i){let t=Q.cb.enemies.filter(e=>e.hp>0);if(t.length===1)return fp(e,t[0].idx);Fp({kind:`potion`,slot:e})}else fp(e,null)},setTimeout(()=>document.addEventListener(`pointerdown`,up,{once:!0}),0)}async function fp(e,t){Ip(),Z.potion(),Q.cb&&!Q.cb.over&&Q.screen===`combat`?(Xd(Q.run,Q.cb,e,t),await Up(),Gp()):(Xd(Q.run,null,e,null),sp(),uf(Q.run))}function pp(){mp(`<div class="panel ov-panel" style="text-align:center">
  ...
  </div>`,e=>{e.onclick=e=>{let t=e.target.dataset.a;t===`yes`&&(mf(Q.run,!1),Q.run=null,Q.cb=null,hp(),Zf(),vp(`title`)),t===`no`&&hp()}})}function mp(e,t=null,n=!1){let r=$(`#overlay`);r.innerHTML=e,r.classList.add(`open`),r._closable=n,t&&t(r.firstElementChild)}function hp(){let e=$(`#overlay`);e.classList.remove(`open`),e.innerHTML=``}function gp(e,t,{sub:n=``,pick:r=null,canSkip:i=!1,skipLabel:a=`Skip`,inCombat:o=!1}={}){let s=tp(`div`,`panel ov-panel`);s.innerHTML=`<div class="ov-title">${e}</div>${n?`<div class="ov-sub">${n}</div>`:``}`;let c=tp(`div`,`card-grid ${r?`choice-cards`:``}`),l=r?t:[...t].sort((e,t)=>_d(e).name.localeCompare(_d(t).name));for(let e of l){let t=ap(e,{inCombat:o});r&&(t.onclick=()=>{Z.click(),t.classList.add(`picked`),setTimeout(()=>{hp(),r(e)},240)}),c.appendChild(t)}s.appendChild(c);let u=tp(`div`,`ov-actions`);if(i&&r){let e=tp(`button`,`btn ghost`,a);e.onclick=()=>{Z.click(),hp(),r(null)},u.appendChild(e)}if(!r){let e=tp(`button`,`btn ghost`,`Close`);e.onclick=()=>{Z.click(),hp()},u.appendChild(e)}s.appendChild(u),mp(``,null,!r),$(`#overlay`).appendChild(s)}function _p(){mp(`<div class="panel ov-panel howto">
  ...
  </div>`,e=>{$(`[data-a="ok"]`,e).onclick=()=>{Z.click(),hp()}},!0)}function vp(e,t){Q.screen=e,lp(),e!==`map`&&(Du(),Mu());let n=ep();n.className=``,n.onclick=null,{title:yp,map:Sp,combat:()=>{},reward:Jp,rest:Zp,shop:$p,event:tm,treasure:Qp,bossRelic:Yp,end:nm}[e](t),sp()}function yp(){Zf(),Lu(0);let e=pf(),t=df(),n=ep();n.innerHTML=`<div class="title-screen screen-enter">
    ...
    <div class="title-btns">
      ...
      <button class="btn ghost" data-a="mute">${Wf()?`Unmute`:`Mute`} Sound</button>
    </div>
    <div class="title-stats">${e.runs} runs · ${e.wins} victories · deepest climb: floor ${e.best}</div>
  </div>`,n.onclick=e=>{let n=e.target.dataset?.a;n&&(Uf(),Z.click(),n===`new`&&(t&&ff(),bp(hd())),n===`continue`&&t&&bp(t,!0),n===`help`&&_p(),n===`mute`&&(Gf(),yp()))}}function bp(e,t=!1){Q.run=e,Q.cb=null,Lu(e.act);let n=e.nodeId?e.map.nodes.find(t=>t.id===e.nodeId):null;if(Tu(e.act,n?n.row:0),Xf(e.act),t||uf(e),t&&e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);Q.screen=`combat`,wp(jd(e,e.pendingCombat,t?t.row:5),e.pendingCombat),sp();return}vp(`map`)}var xp={monster:`sword`,elite:`skull`,event:`question`,rest:`flame`,shop:`coin`,treasure:`chest`,boss:`crown`};function Sp(){let e=Q.run;if(e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);Q.screen=`combat`,wp(jd(e,e.pendingCombat,t?t.row:5),e.pendingCombat);return}uf(e),Q.cb=null;let{nodes:t}=e.map,n=new Set(bd(e).map(e=>e.id)),r=new Set(e.map.visited),i=e.nodeId?t.find(t=>t.id===e.nodeId).row:-1,a=``,o=``;for(let e of t)for(let t of e.next){let n=r.has(e.id)&&r.has(t)?`walked`:``;a+=`<path class="medge ${n}" style="--d:${e.row*34}ms" data-a="${e.id}" data-b="${t}" d="M0 0"/>`}for(let i of t){let t=[`mnode`,`type-${i.type}`,r.has(i.id)?`visited`:``,i.id===e.nodeId?`current`:``,n.has(i.id)?`avail`:``].join(` `),a=i.type===`boss`?26:i.type===`elite`||i.type===`treasure`?19:16,s=i.type===`boss`?26:i.type===`elite`||i.type===`treasure`?20:17;o+=`<g class="${t}" data-node="${i.id}" style="--d:${i.row*34}ms">
      <g class="nwrap"><circle class="bg" r="${a}"/><g class="icg">${If(xp[i.type],s)}</g></g>
    </g>`}let s=jl[e.act];ep().innerHTML=`
    ...
    </div>`;let c=$(`.map-svg`);c.onclick=e=>{let n=e.target.closest(`.mnode.avail`);!n||Q.busy||(Uf(),Cp(t.find(e=>e.id===n.dataset.node)))},Qf(`.mnode`,c).forEach(r=>{let i=t.find(e=>e.id===r.dataset.node);r._tip={title:{monster:`Monster`,elite:`Elite — beware`,event:`Unknown event`,rest:`Rest site`,shop:`Merchant`,treasure:`Treasure`,boss:jl[e.act].bossName}[i.type],body:n.has(i.id)?`Click to travel here.`:``}});let l=t.map(t=>({id:t.id,pos:pu(e.act,t)})),u=new Map(Qf(`.mnode`,c).map(e=>[e.dataset.node,e])),d=new Set(t.filter(e=>!n.has(e.id)&&!r.has(e.id)).map(e=>e.id)),f=Qf(`.medge`,c).map(e=>({p:e,a:e.dataset.a,b:e.dataset.b}));Eu(e.act,Math.max(0,i)),ju(l,e=>{let t=new Map(e.map(e=>[e.id,e]));for(let[e,n]of u){let r=t.get(e);n.setAttribute(`transform`,`translate(${r.x.toFixed(1)},${r.y.toFixed(1)}) scale(${r.s.toFixed(3)})`),n.style.opacity=(r.fade*(d.has(e)?.4:1)).toFixed(3)}for(let{p:e,a:n,b:r}of f){let i=t.get(n),a=t.get(r),o=9*(i.s+a.s)/2;e.setAttribute(`d`,`M${i.x.toFixed(1)} ${i.y.toFixed(1)} Q${((i.x+a.x)/2).toFixed(1)} ${((i.y+a.y)/2+o).toFixed(1)} ${a.x.toFixed(1)} ${a.y.toFixed(1)}`),e.style.opacity=Math.min(i.fade,a.fade).toFixed(3)}}),$(`.map-screen`).addEventListener(`wheel`,e=>{e.preventDefault(),Ou(-e.deltaY*.006)},{passive:!1})}function Cp(e){let t=Q.run;Z.map(),Tu(t.act,e.row),t.nodeId=e.id,t.floorsClimbed=e.row+1,t.map.visited.push(e.id),uf(t),e.type===`monster`||e.type===`elite`||e.type===`boss`?(t.pendingCombat=e.type,uf(t),wp(jd(t,e.type,e.row),e.type)):e.type===`rest`?vp(`rest`):e.type===`shop`?vp(`shop`):e.type===`treasure`?vp(`treasure`):e.type===`event`&&vp(`event`,Ad(t))}function wp(e,t){if(Du(),Mu(),Q.cb=Md(Q.run,e,t),Q.screen=`combat`,Tp(),sp(),t===`boss`){let e=tp(`div`,`turn-banner boss-banner`,Q.cb.enemies[0].name.toUpperCase());ep().appendChild(e),setTimeout(()=>e.remove(),2100),nd(`#1a0a20`,.5,.9),zu(1.6),Z.bigDeath()}Up().then(Gp)}function Tp(){let e=Q.cb,t=ep();t.onclick=null,t.innerHTML=`<div class="combat-screen screen-enter intro">
    <div class="battlefield">
      <div class="player-zone">
        <div class="hero-wrap">${wf()}</div>
        <div class="hpbar-wrap"><span class="block-chip zero p-block">${Ff(`shield`,13)} 0</span><div class="hpbar"><div class="ghost"></div><div class="fill"></div></div><span class="hp-label p-hp"></span></div>
  ...
  </div>`;let n=$(`.enemy-zone`,t),r={enemies:[],root:$(`.combat-screen`,t)};e.enemies.forEach((e,t)=>{let i=Rl[e.key],a=(i.boss?280:i.elite?230:185)*(i.art.size>=1.4?1:i.art.size<.8?.86:.95)*Math.min(i.art.size,1.45),o=Math.round(Math.min(a,innerHeight*(i.boss?.34:.3))),s=tp(`div`,`enemy${i.elite?` elite-e`:``}${i.boss?` boss-e`:``}`);s.dataset.idx=t,s.style.animationDelay=`${160+t*130}ms`,s.innerHTML=`<div class="intent"></div>
      <div class="enemy-art" style="width:${o}px;height:${o}px">${Cf(i.art)}</div>
      <div class="name">${e.name.toUpperCase()}</div>
      <div class="hpbar-wrap"><span class="block-chip zero">${Ff(`shield`,13)} 0</span><div class="hpbar"><div class="ghost"></div><div class="fill"></div></div><span class="hp-label"></span></div>
      <div class="status-row"></div>`,n.appendChild(s),r.enemies.push({root:s,art:$(`.enemy-art`,s),intent:$(`.intent`,s),fill:$(`.fill`,s),ghost:$(`.ghost`,s),hp:$(`.hp-label`,s),block:$(`.block-chip`,s),statuses:$(`.status-row`,s)}),s.onclick=()=>Pp(t),s.onmouseenter=()=>{Q.targeting&&s.classList.add(`target-hover`)},s.onmouseleave=()=>s.classList.remove(`target-hover`)}),r.pHp=$(`.p-hp`,t),r.pFill=$(`.player-zone .fill`,t),r.pGhost=$(`.player-zone .ghost`,t),r.pBlock=$(`.p-block`,t),r.pStatus=$(`.p-status`,t),r.hero=$(`.hero-wrap`,t),r.energy=$(`.energy-orb`,t),r.endTurn=$(`.end-turn`,t),r.hand=$(`.hand-zone`,t),r.draw=$(`.pile-draw`,t),r.discard=$(`.pile-discard`,t),r.exhaust=$(`.pile-exhaust`,t),Q.ce=r,setTimeout(()=>r.root.classList.remove(`intro`),1300),r.endTurn.onclick=zp,r.draw.onclick=()=>{Z.click(),gp(`Draw Pile`,e.draw,{sub:`Order hidden — shown alphabetically`,inCombat:!0})},r.discard.onclick=()=>{Z.click(),gp(`Discard Pile`,e.discard,{inCombat:!0})},r.exhaust.onclick=()=>{Z.click(),gp(`Exhausted`,e.exhaust,{inCombat:!0})},r.root.addEventListener(`pointerdown`,e=>{Q.targeting&&!e.target.closest(`.enemy`)&&!e.target.closest(`.card`)&&Ip()}),Ap(),jp()}var Ep=e=>ld(Q.ce.enemies[e].art),Dp=()=>ld(Q.ce.hero);function Op(e,t,n){e.innerHTML=``;for(let[n,r]of Object.entries(t)){if(!r)continue;let t=Pl[n]||{name:n,icon:`?`,kind:`buff`,desc:``},i=n===`str`&&r<0?`debuff`:t.kind,a=tp(`span`,`schip ${i}`,`${t.icon} <span class="n">${r}</span>`);a._tip={title:t.name,body:t.desc.replace(/\bN\b/g,r),sub:i===`debuff`?`Debuff`:`Buff`},e.appendChild(a)}}function kp(e){let t=Q.cb,n=Ld(e),r=nf(t,e),i={attack:Ff(`sword`,19),block:Ff(`shield`,19),buff:Ff(`up`,19),debuff:Ff(`cloud`,19),heal:Ff(`plus`,19)}[n.intent]||Ff(`sword`,19),a=``;n.intent.startsWith(`attack`)&&(i=Ff(`sword`,19),a=r.times>1?`${r.dmg}×${r.times}`:`${r.dmg}`,n.intent===`attack_debuff`&&(i+=Ff(`cloud`,14)),n.intent===`attack_block`&&(i+=Ff(`shield`,14)),n.intent===`attack_buff`&&(i+=Ff(`up`,14)));let o=[];return r&&o.push(`attack for <b>${r.dmg}${r.times>1?`×${r.times}`:``}</b>`),n.block&&o.push(`gain Block`),n.heal&&o.push(`heal itself`),n.fx?.some(e=>e.who===`player`)&&o.push(`afflict you`),n.fx?.some(e=>e.who!==`player`)&&o.push(`empower`),n.addCards&&o.push(`add ${n.addCards.n} ${Ml[n.addCards.id].name}s to your discard`),{icon:i,txt:a,tip:{title:n.name,body:`Intends to ${o.join(`, `)||`act`}.`}}}function Ap(){let e=Q.cb,t=Q.ce;if(!t)return;e.enemies.forEach((e,n)=>{let r=t.enemies[n],i=`${100*Math.max(0,e.hp)/e.maxHp}%`;if(r.fill.style.width=i,r.ghost.style.width=i,r.hp.textContent=`${Math.max(0,e.hp)}/${e.maxHp}`,r.block.classList.toggle(`zero`,e.block<=0),r.block.innerHTML=`${Ff(`shield`,13)} ${e.block}`,r.art.classList.toggle(`warded`,e.block>0),Op(r.statuses,e.statuses,!1),e.hp<=0&&r.root.classList.add(`gone`),e.hp>0&&e.moveKey){let t=kp(e);r.intent.className=`intent i-${Ld(e).intent}`,r.intent.innerHTML=`<span class="ic">${t.icon}</span>${t.txt}`,r.intent._tip=t.tip}else r.intent.innerHTML=``});let n=e.player,r=`${100*Math.max(0,n.hp)/n.maxHp}%`;t.pFill.style.width=r,t.pGhost.style.width=r,t.pHp.textContent=`${Math.max(0,n.hp)}/${n.maxHp}`,t.pBlock.classList.toggle(`zero`,n.block<=0),t.pBlock.innerHTML=`${Ff(`shield`,13)} ${n.block}`,t.hero.classList.toggle(`warded`,n.block>0),Op(t.pStatus,n.statuses,!0),$(`.num`,t.energy).textContent=n.energy,t.energy.classList.toggle(`spent`,n.energy===0);let i=$(`.candles`,t.energy),a=Math.max(n.energyMax,n.energy);i.children.length!==a&&(i.innerHTML=Array.from({length:a},()=>`<span class="candle"></span>`).join(``)),[...i.children].forEach((e,t)=>e.classList.toggle(`lit`,t<n.energy)),$(`.cnt`,t.draw).textContent=e.draw.length,$(`.cnt`,t.discard).textContent=e.discard.length,$(`.cnt`,t.exhaust).textContent=e.exhaust.length}function jp(){let e=Q.cb,t=Q.ce;if(!t)return;let n=t.hand,r=new Map(Qf(`.card`,n).map(e=>[e.dataset.uid,e])),i=new Set(e.hand.map(e=>String(e.uid)));for(let[e,t]of r)i.has(e)||t.remove();for(let t of e.hand)if(r.has(String(t.uid))){let e=ap(t,{inCombat:!0}),n=r.get(String(t.uid));n.replaceChildren(...e.childNodes),n.className=e.className+(n.classList.contains(`armed`)?` armed`:``),n.onclick=e=>{e.stopPropagation(),Np(t.uid)},n.onmouseenter=()=>{Q.hoveredCard=t.uid,Mp()},n.onmouseleave=()=>{Q.hoveredCard===t.uid&&(Q.hoveredCard=null),Mp()}}else{let e=ap(t,{inCombat:!0});e.classList.add(`draw-in`),setTimeout(()=>e.classList.remove(`draw-in`),400),e.onclick=e=>{e.stopPropagation(),Np(t.uid)},e.onmouseenter=()=>{Q.hoveredCard=t.uid,Z.hover(),Mp()},e.onmouseleave=()=>{Q.hoveredCard===t.uid&&(Q.hoveredCard=null),Mp()},n.appendChild(e)}Mp()}function Mp(){let e=Q.cb,t=Q.ce;if(!t)return;let n=e.hand.map(e=>String(e.uid)),r=new Map(Qf(`.card`,t.hand).map(e=>[e.dataset.uid,e])),i=n.length,a=Math.min(112,640/Math.max(i,1));n.forEach((t,n)=>{let o=r.get(t);if(!o)return;let s=e.hand[n],c=!_d(s).unplayable&&(Gd(Q.run,e,s)??99)<=e.player.energy;o.classList.toggle(`unplayable-now`,!c);let l=Q.targeting?.kind===`card`&&String(Q.targeting.uid)===t,u=Q.hoveredCard!=null&&String(Q.hoveredCard)===t,d=i>1?(n-(i-1)/2)*Math.min(5,42/i):0,f=(n-(i-1)/2)*a,p=Math.abs(d)*3.2;o.classList.toggle(`armed`,l),l?o.style.transform=`translateX(calc(-50% + ${f*.4}px)) translateY(-150px) scale(1.24)`:u&&!Q.busy?o.style.transform=`translateX(calc(-50% + ${f}px)) translateY(-92px) scale(1.38)`:o.style.transform=`translateX(calc(-50% + ${f}px)) translateY(${p+26}px) rotate(${d}deg)`,o.style.zIndex=u||l?40:20+n})}function Np(e){if(Q.busy||!Q.cb||Q.cb.over)return;let t=Q.cb,n=t.hand.find(t=>t.uid===e);if(!n)return;let r=_d(n),i=Gd(Q.run,t,n),a=$(`.card[data-uid="${e}"]`,Q.ce.hand);if(r.unplayable||i>t.player.energy){a?.classList.add(`nope`),setTimeout(()=>a?.classList.remove(`nope`),350),Z.debuff();return}if(Q.targeting?.kind===`card`&&Q.targeting.uid===e)return Ip();if(r.target===`enemy`){let n=t.enemies.filter(e=>e.hp>0);if(n.length===1)return void Rp(e,n[0].idx);Fp({kind:`card`,uid:e})}else Rp(e,null)}function Pp(e){if(!Q.targeting||Q.busy)return;let t=Q.cb.enemies[e];if(!t||t.hp<=0)return;let n=Q.targeting;n.kind===`card`?Rp(n.uid,e):n.kind===`potion`&&fp(n.slot,e)}function Fp(e){Q.targeting=e,Q.ce.root.classList.add(`targeting`),Q.cb.enemies.forEach((e,t)=>Q.ce.enemies[t].root.classList.toggle(`targetable`,e.hp>0)),Mp(),document.addEventListener(`mousemove`,Lp),Lp._last&&Lp(Lp._last)}function Ip(){Q.targeting=null,$(`#aim`).innerHTML=``,document.removeEventListener(`mousemove`,Lp),Q.ce&&(Q.ce.root.classList.remove(`targeting`),Q.ce.enemies.forEach(e=>e.root.classList.remove(`targetable`,`target-hover`)),Mp())}function Lp(e){if(Lp._last=e,!Q.targeting)return;let t;if(Q.targeting.kind===`card`){let e=$(`.card[data-uid="${Q.targeting.uid}"]`);t=e?ld(e):{x:innerWidth/2,y:innerHeight-200}}else t={x:innerWidth/2,y:60};let n=e.clientX,r=e.clientY,i=(t.x+n)/2,a=Math.min(t.y,r)-120;$(`#aim`).innerHTML=`<path d="M${t.x} ${t.y-80} Q${i} ${a} ${n} ${r}" fill="none" stroke="rgba(255,89,100,.85)" stroke-width="4" stroke-dasharray="4 10" stroke-linecap="round"/>
    <circle cx="${n}" cy="${r}" r="9" fill="none" stroke="rgba(255,89,100,.95)" stroke-width="3"/>`}async function Rp(e,t){Ip(),qd(Q.run,Q.cb,e,t)&&(await Up(t),Gp())}async function zp(){Q.busy||!Q.cb||Q.cb.over||(Ip(),Z.click(),Zd(Q.run,Q.cb),await Up(),Gp())}function Bp(e){let t=tp(`div`,`turn-banner`,e);ep().appendChild(t),setTimeout(()=>t.remove(),1150)}var Vp=!1;function Hp(e,t){let n=e&&$(`.cracks`,e);n&&n.children.length<8&&n.insertAdjacentHTML(`beforeend`,xf(t))}async function Up(e=null){let t=Q.cb,n=Q.ce;Q.busy=!0,n.endTurn.classList.add(`enemy-phase`);let r=t.queue;for(;r.length;){let t=r.shift();try{await Wp(t,e)}catch(e){console.error(`vfx event error`,t,e)}}Q.busy=!1,t.over||n.endTurn.classList.remove(`enemy-phase`),Ap(),jp(),sp()}async function Wp(e,t){let n=Q.cb,r=Q.ce;switch(e.t){case`turn`:e.n>1&&(Bp(`YOUR TURN`),Z.turn()),Ap(),await $f(e.n>1?500:120);break;case`endTurn`:Vp=!1,Bp(`ENEMY TURN`),await $f(480);break;case`draw`:jp(),Ap(),Z.draw(),await $f(75);break;case`reshuffle`:Z.card(),sd(...Object.values(ld(r.draw)),`Reshuffle`,`notice`),await $f(240);break;case`play`:{let i=$(`.card[data-uid="${e.uid}"]`,r.hand);if(Z.card(),Vp=!0,i&&t!=null&&n.enemies[t]){let e=i.getBoundingClientRect(),{x:n,y:r}=Ep(t),a=i.cloneNode(!0);Object.assign(a.style,{position:`fixed`,left:`${e.left}px`,top:`${e.top}px`,width:`${e.width}px`,height:`${e.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(a),i.remove(),a.animate([{transform:`none`,opacity:1},{transform:`translate(${n-e.left-e.width/2}px,${r-e.top-e.height/2}px) scale(0.22) rotate(14deg)`,opacity:0}],{duration:270,easing:`cubic-bezier(.45,0,.9,.5)`}).onfinish=()=>a.remove()}else i&&(i.classList.add(`played-up`),setTimeout(()=>i.remove(),320));Ap(),await $f(200);break}case`hitEnemy`:{let t=r.enemies[e.idx],{x:n,y:i}=Ep(e.idx);if(e.poison)Z.poison(),od(n,i,`#a3e06c`,14),sd(n,i-20,`${e.amount}`,`poisonf`);else{let a=e.amount>=16;Vp&&(r.hero.classList.remove(`lunge`),r.hero.offsetWidth,r.hero.classList.add(`lunge`)),Z.slash(),e.amount>0&&Z.hit(),ad(n,i,a?`#ffd8a0`:`#ffffff`),rd(n,i,{color:`#ff9a6a`,n:a?30:14,speed:a?420:260}),e.blocked>0&&(Z.blocked(),sd(n,i+26,`${Ff(`shield`,19)}${e.blocked}`,`blockedf`)),e.amount>0?sd(n,i-24,`${e.amount}`,a?`crit`:`dmg`):e.blocked||sd(n,i-24,`0`,`blockedf`),ed(Math.min(4+e.amount*.5,15)),zu(Math.min(.2+e.amount/26,1)),a&&(td(70),id(n,i,`#ffd8a0`,10,620,5)),e.amount>0&&Hp(t.art,a)}t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),Ap(),await $f(230);break}case`die`:{let t=r.enemies[e.idx],i=n.enemies[e.idx],{x:a,y:o}=Ep(e.idx);i.boss&&(document.body.classList.add(`worldstop`),t.root.classList.add(`doomed`),td(110),await $f(820),document.body.classList.remove(`worldstop`),t.root.classList.remove(`doomed`)),(i.boss||i.elite?Z.bigDeath:Z.death)(),cd(t.art),rd(a,o,{color:`#dfeaff`,n:30,speed:480,size:2.6,grav:340,kind:`spark`}),rd(a,o,{color:`#c9b0ff`,n:26,speed:380,size:3.2,grav:60}),id(a,o,`#e8dcff`,12,720,6),nd(`#ffffff`,i.boss?.24:.1,.3),ed(i.boss?22:12),zu(i.boss?2:.9),t.root.classList.add(`dying`),setTimeout(()=>{t.root.classList.remove(`dying`),t.root.classList.add(`gone`)},830),await $f(i.boss?900:500);break}case`hitPlayer`:{let{x:t,y:n}=Dp();e.source===`poison`?(Z.poison(),od(t,n,`#a3e06c`,14)):e.source===`burn`||e.source===`self`?Z.debuff():e.source===`thorns`?Z.blocked():(Z.slash(),e.amount>0&&(Z.hit(),nd(`#ff2233`,Math.min(.05+e.amount*.012,.3),.3)),ad(t,n,`#ff8888`)),e.blocked>0&&(Z.blocked(),sd(t,n+30,`${Ff(`shield`,19)}${e.blocked}`,`blockedf`)),e.amount>0?(sd(t,n-30,`${e.amount}`,e.amount>=16?`crit`:`dmg`),ed(Math.min(5+e.amount*.6,18)),zu(Math.min(.3+e.amount/22,1.2)),Hp(r.hero,e.amount>=16)):e.blocked||sd(t,n-30,`0`,`blockedf`),Ap(),sp(),await $f(240);break}case`blockGain`:{let t=e.who===`player`,{x:n,y:i}=t?Dp():Ep(e.who);Z.block(),sd(n,i-10,`${Ff(`shield`,22)} ${e.n}`,`blockf`);let a=t?r.pBlock:r.enemies[e.who].block;a.classList.remove(`pulse`),a.offsetWidth,a.classList.add(`pulse`),Ap(),await $f(140);break}case`status`:{let{x:t,y:n}=e.who===`player`?Dp():Ep(e.who),r=Pl[e.id]||{name:e.id,kind:`buff`},i=r.kind===`debuff`||e.id===`str`&&e.n<0;(e.id===`poison`?Z.poison:i?Z.debuff:Z.buff)(),sd(t,n-46,`${e.n>0?`+`:``}${e.n} ${r.name}`,i?`debufff`:`bufff`),i||od(t,n,`#9fc8ff`,6),Ap(),await $f(170);break}case`heal`:{let{x:t,y:n}=e.who===`player`?Dp():Ep(e.who);Z.heal(),od(t,n,`#8fe8a0`,14),sd(t,n-30,`+${e.n}`,`healf`),Ap(),sp(),await $f(200);break}case`energy`:Ap(),r.energy.classList.remove(`pop`),r.energy.offsetWidth,r.energy.classList.add(`pop`);break;case`exhaust`:{let t=$(`.card[data-uid="${e.uid}"]`,r.hand);if(t){let e=t.getBoundingClientRect(),n=t.cloneNode(!0);Object.assign(n.style,{position:`fixed`,left:`${e.left}px`,top:`${e.top}px`,width:`${e.width}px`,height:`${e.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(n),t.remove(),n.animate([{clipPath:`circle(80% at 50% 55%)`,filter:`brightness(1)`},{clipPath:`circle(44% at 50% 55%)`,filter:`brightness(1.8) saturate(1.6) sepia(0.45)`,offset:.45},{clipPath:`circle(0% at 50% 55%)`,filter:`brightness(2.6) saturate(2) sepia(0.85)`}],{duration:540,easing:`ease-in`}).onfinish=()=>n.remove(),rd(e.left+e.width/2,e.top+e.height/2,{color:`#ffb066`,n:22,speed:190,grav:-150,size:2.4,life:.85}),await $f(260)}Ap();break}case`discardHand`:{let e=Qf(`.card`,r.hand);e.length&&(Z.card(),e.forEach((e,t)=>{e.animate([{opacity:1},{transform:`${e.style.transform} translateX(340px) rotate(20deg)`,opacity:0}],{duration:260,delay:t*28,easing:`ease-in`}).onfinish=()=>e.remove()}),await $f(280+e.length*28)),Ap();break}case`enemyAct`:{let t=r.enemies[e.idx],{x:n,y:i}=Ep(e.idx);t.root.classList.add(`acting`),setTimeout(()=>t.root.classList.remove(`acting`),420),sd(n,i-90,e.name,`notice`),await $f(430);break}case`intent`:Ap();break;case`addCard`:sd(innerWidth/2,innerHeight*.62,`${Ml[e.id].name} added to ${e.where===`hand`?`hand`:`discard`}`,`notice`),Z.debuff(),Ap(),jp(),await $f(240);break;case`relicProc`:{let t=$(`.relic-chip[data-relic="${e.id}"]`);t&&(t.classList.remove(`proc`),t.offsetWidth,t.classList.add(`proc`)),await $f(90);break}case`maxHp`:{let{x:t,y:n}=Dp();sd(t,n-60,`+${e.n} MAX HP`,`healf`),Z.buff(),await $f(160);break}case`potion`:Z.potion(),await $f(120);break;case`powerConsumed`:break;case`victory`:await $f(320),Z.victory(),nd(`#ffe9ac`,.16,.6);break;case`defeat`:{await $f(400),Z.defeat(),nd(`#300`,.5,1.2);let e=$(`#lantern`);e.classList.add(`gutter`),e.style.setProperty(`--la`,`1`),e.style.setProperty(`--lr`,`160px`),await $f(900);break}}}function Gp(){let e=Q.cb;!e||!e.over||(e.result===`win`?Kp():qp())}function Kp(){let e=Q.run,t=Q.cb.kind;if(Q.cb=null,e.pendingCombat=null,t===`boss`&&e.act>=2){mf(e,!0),vp(`end`,{won:!0});return}vp(`reward`,{kind:t,rewards:Dd(e,t)})}function qp(){mf(Q.run,!1),vp(`end`,{won:!1})}function Jp({kind:e,rewards:t}){let n=Q.run,r=ep();r.innerHTML=`<div class="center-panel screen-enter"><div class="panel">
  ...
  </div></div>`;let i=$(`.reward-list`,r),a=(e,t,r,a=null)=>{let o=tp(`button`,`reward-row`,`<span class="ric">${e}</span><span>${t}</span>`);return a&&(o._tip=a),o.onclick=()=>{r()!==!1&&(o.classList.add(`taken`),uf(n),sp())},i.appendChild(o),o};if(a(`¤`,`<b class="gold-num">${t.gold}</b> gold`,()=>{n.player.gold+=t.gold,n.stats.goldEarned+=t.gold,Z.coin(),sd(innerWidth/2,innerHeight/2-60,`+${t.gold} gold`,`goldf`)}),t.potion){let e=Ll[t.potion];a(Of(e.tone),`${e.name}`,()=>{if(!Td(n,t.potion))return sd(innerWidth/2,innerHeight/2,`Potion slots full!`,`notice`),!1;Z.potion()},{title:e.name,body:e.text})}if(t.relic){let e=Fl[t.relic];a(`<span style="color:${e.tone};text-shadow:0 0 8px ${e.tone}">${e.glyph}</span>`,`<b>${e.name}</b>`,()=>{Cd(n,t.relic),Z.relic()},{title:e.name,body:e.text})}a(Ff(`cards`,26),`Add a card to your deck`,()=>(s(t.cards,()=>{}),!1));let o=i.lastElementChild;o.dataset.cardrow=`1`,$(`[data-a="continue"]`,r).onclick=()=>{Z.click(),uf(n),vp(e===`boss`?`bossRelic`:`map`)};function s(e,t){gp(`Choose a Card`,e.map(e=>({id:e,up:!1,uid:null})),{sub:`Add one card to your deck — or skip to keep it lean.`,pick:e=>{e&&(rf(n,e.id),Z.upgrade(),sd(innerWidth/2,innerHeight/2,`${_d(e).name} added`,`notice`)),o.classList.add(`taken`),uf(n),t()},canSkip:!0})}}function Yp(){let e=Q.run,t=Od(e),n=ep();n.innerHTML=`<div class="center-panel screen-enter"><div class="panel" style="width:min(620px,94vw)">
  ...
  </div></div>`;let r=$(`.big-choices`,n);for(let n of t){let t=Fl[n],i=tp(`button`,`relic-pick`);i.innerHTML=`<span class="relic-chip" style="--tone:${t.tone}">${t.glyph}</span><span><b>${t.name}</b><span class="rd">${t.text}</span></span>`,i.onclick=()=>{Z.relic(),Cd(e,n),Xp()},r.appendChild(i)}let i=tp(`button`,`btn ghost`,`Take none`);i.style.marginTop=`10px`,i.onclick=()=>{Z.click(),Xp()},r.appendChild(i)}function Xp(){let e=Q.run;e.act++,e.nodeId=null,e.map=yd(e),Sd(e,Math.round(e.player.maxHp*.35)),Lu(e.act),Tu(e.act,0),Xf(e.act),uf(e),vp(`map`),Bp(`ACT ${e.act+1}`),Z.victory()}function Zp(){let e=Q.run,t=e.player.deck.some(e=>!e.up&&Ml[e.id].up);ep().innerHTML=`<div class="center-panel screen-enter"><div class="panel">
    <div class="ov-title">REST SITE</div>
    <div class="art-lg">${Af()}</div>
    <div class="ov-sub">The fire crackles. For a moment, the Spire is quiet.</div>
    <div class="big-choices">
      <button class="btn" data-a="rest">${Ff(`flame`,18)} Rest <span style="font-size:13px;opacity:.8">— heal ${Math.round(e.player.maxHp*.3)} HP</span></button>
      <button class="btn" data-a="smith" ${t?``:`disabled`}>${Ff(`hammer`,18)} Smith <span style="font-size:13px;opacity:.8">— upgrade a card</span></button>
    </div>
  </div></div>`,$(`[data-a="rest"]`).onclick=t=>{t.currentTarget.disabled=!0,$(`[data-a="smith"]`).disabled=!0,Z.heal();let n=Sd(e,Math.round(e.player.maxHp*.3));sd(innerWidth/2,innerHeight/2-40,`+${n} HP`,`healf`),od(innerWidth/2,innerHeight/2,`#8fe8a0`,22),uf(e),setTimeout(()=>{Q.screen===`rest`&&vp(`map`)},700)},$(`[data-a="smith"]`).onclick=()=>{Z.click(),gp(`Upgrade a Card`,e.player.deck.filter(e=>!e.up&&Ml[e.id].up),{sub:`Forge one card into its + form.`,pick:t=>{t&&(of(e,t.uid),Z.upgrade(),nd(`#ffe9ac`,.12,.4),gp(`Upgraded!`,[e.player.deck.find(e=>e.uid===t.uid)],{sub:`It gleams with new power.`}),uf(e),setTimeout(()=>{Q.screen===`rest`&&(hp(),vp(`map`))},1300))}})}}function Qp(){let e=Q.run;ep().innerHTML=`<div class="center-panel screen-enter"><div class="panel">
    <div class="ov-title">TREASURE</div>
    <div class="art-lg" style="cursor:pointer" data-a="open">${kf(!1)}</div>
  ...
  </div></div>`;let t=()=>{let t=wd(e,{common:.55,uncommon:.35,rare:.1});$(`.art-lg`).innerHTML=kf(!0),Z.relic(),nd(`#ffe9ac`,.2,.5),rd(innerWidth/2,innerHeight/2,{color:`#ffd97a`,n:36,speed:380,grav:160});let n=$(`.big-choices`);if(t){Cd(e,t);let n=Fl[t];$(`.ov-sub`).innerHTML=`You claim <b style="color:${n.tone}">${n.name}</b> — <i>${n.text}</i>`}else e.player.gold+=60,$(`.ov-sub`).innerHTML=`Only coins remain — <b class="gold-num">+60 gold</b>.`,Z.coin();sp(),uf(e),n.innerHTML=``;let r=tp(`button`,`btn`,`Continue`);r.onclick=()=>{Z.click(),vp(`map`)},n.appendChild(r)};Qf(`[data-a="open"]`).forEach(e=>e.onclick=t)}function $p(){let e=Q.run,t=Q.shopData||={};(Q.screen!==`shop`||!t.stock||t.forNode!==e.nodeId)&&(t.stock=kd(e),t.forNode=e.nodeId);let n=t.stock,r=ep();r.innerHTML=`<div class="center-panel screen-enter"><div class="panel ov-panel" style="width:min(980px,96vw)">
    <div style="display:flex;align-items:center;justify-content:center;gap:18px">
      <div style="width:130px">${jf()}</div>
  ...
  </div></div>`;let i=$(`.cards-row`,r),a=$(`.misc-row`,r),o=()=>e.player.gold,s=t=>{e.player.gold-=t,Z.coin(),uf(e),sp(),c()};function c(){i.innerHTML=``,a.innerHTML=``;for(let t of n.cards){let n=tp(`div`,`shop-item ${t.sold?`sold`:``} ${o()<t.price?`cant`:``}`),r=ap({id:t.id,up:!1,uid:null},{size:138});r.onclick=()=>{if(t.sold||o()<t.price)return Z.debuff();t.sold=!0,rf(e,t.id),s(t.price)},n.appendChild(r),n.appendChild(tp(`div`,`price`,`¤ ${t.price}`)),i.appendChild(n)}for(let t of n.relics){let n=Fl[t.id],r=tp(`div`,`shop-item ${t.sold?`sold`:``} ${o()<t.price?`cant`:``}`),i=tp(`button`,`shop-relic`,`<span class="relic-chip" style="--tone:${n.tone}">${n.glyph}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||o()<t.price)return Z.debuff();t.sold=!0,Cd(e,t.id),Z.relic(),s(t.price)},r.appendChild(i),r.appendChild(tp(`div`,`price`,`¤ ${t.price}`)),a.appendChild(r)}for(let t of n.potions){let n=Ll[t.id],r=tp(`div`,`shop-item ${t.sold?`sold`:``} ${o()<t.price?`cant`:``}`),i=tp(`button`,`shop-relic`,`<span style="width:34px;height:44px">${Of(n.tone)}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||o()<t.price)return Z.debuff();if(!Td(e,t.id)){sd(innerWidth/2,innerHeight/2,`Potion slots full!`,`notice`);return}t.sold=!0,Z.potion(),s(t.price)},r.appendChild(i),r.appendChild(tp(`div`,`price`,`¤ ${t.price}`)),a.appendChild(r)}let t=tp(`div`,`shop-item ${n.removed?`sold`:``} ${o()<n.removeCost?`cant`:``}`),r=tp(`button`,`shop-relic`,`<span style="width:34px;display:inline-flex;justify-content:center">${Ff(`scissors`,26)}</span><b>Card Removal</b>Remove a card from your deck forever.`);r.onclick=()=>{if(n.removed||o()<n.removeCost)return Z.debuff();gp(`Remove a Card`,e.player.deck,{sub:`Cut the dead weight.`,pick:t=>{t&&(af(e,t.uid),n.removed=!0,e.player.gold-=n.removeCost,Z.card(),uf(e),sp(),c())},canSkip:!0,skipLabel:`Cancel`})},t.appendChild(r),t.appendChild(tp(`div`,`price`,`¤ ${n.removeCost}`)),a.appendChild(t)}c(),$(`[data-a="leave"]`,r).onclick=()=>{Z.click(),vp(`map`)}}function em(e,t){let n=vd(e),r=[],i=[...Nl.common,...Nl.common,...Nl.uncommon,...Nl.uncommon,...Nl.rare],a=0;for(;r.length<t&&a++<60;){let e=i[Math.floor(n()*i.length)];r.includes(e)||r.push(e)}return r}function tm(e){let t=Q.run,n=Bl[e],r=ep();r.innerHTML=`<div class="center-panel screen-enter"><div class="panel event-panel">
    <div class="ov-title">${n.name.toUpperCase()}</div>
    <div class="event-art">${Mf(n.glyph,n.hue)}</div>
    <div class="event-text">${n.text}</div>
    <div class="event-log"></div>
    <div class="event-choices"></div>
  </div></div>`;let i=$(`.event-choices`,r);for(let e of n.choices){let n=tp(`button`,`event-choice`,`<b>${e.label}</b>${e.sub?`<div class="sub">${e.sub}</div>`:``}`);e.needGold&&t.player.gold<e.needGold&&(n.disabled=!0),n.onclick=()=>a(e),i.appendChild(n)}async function a(e){Z.click();let{pending:n,log:a}=hf(t,e.ops);sp();let s=$(`.event-log`,r),c=[];for(let e of a)e.text&&c.push(e.text),e.relic&&c.push(`Gained <b style="color:${Fl[e.relic].tone}">${Fl[e.relic].name}</b> — <i>${Fl[e.relic].text}</i>`);c.length&&(s.innerHTML=c.join(`<br>`)),i.innerHTML=``;for(let e of n)await o(e);uf(t),sp();let l=tp(`button`,`btn`,`Continue`);l.onclick=()=>{Z.click(),vp(`map`)},i.appendChild(l),!c.length&&!n.length&&!e.ops.length&&vp(`map`)}function o(e){return new Promise(n=>{if(e===`remove`)gp(`Remove a Card`,t.player.deck,{sub:`Let it go.`,pick:e=>{e&&(af(t,e.uid),Z.card()),n()},canSkip:!1});else if(e===`upgrade`){let e=t.player.deck.filter(e=>!e.up&&Ml[e.id].up);if(!e.length)return n();gp(`Upgrade a Card`,e,{sub:`The forge hungers.`,pick:e=>{e&&(of(t,e.uid),Z.upgrade()),n()}})}else e===`duplicate`?gp(`Duplicate a Card`,t.player.deck,{sub:`The mirror remembers.`,pick:e=>{e&&(sf(t,e.uid),Z.upgrade()),n()}}):e.pickCard?gp(`Choose a Card`,em(t,e.pickCard).map(e=>({id:e,up:!1,uid:null})),{sub:`One page still glows.`,pick:e=>{e&&(rf(t,e.id),Z.upgrade()),n()},canSkip:!0}):n()})}}function nm({won:e}){let t=Q.run;Zf();let n=t.stats,r=Math.max(1,Math.round((Date.now()-n.start)/6e4)),i=t.act*15+t.floorsClimbed,a=`<div class="stats-grid">
    ...
    </div>`;if(e){ep().innerHTML=`<div class="end-screen screen-enter">
      ...
      ${a}${o}
    </div>`,Ru(),Z.victory(),nd(`#ffe9ac`,.25,1);let e=setInterval(()=>rd(Math.random()*innerWidth,innerHeight*.2,{color:[`#ffd97a`,`#c9b0ff`,`#8fe8a0`][Math.random()*3|0],n:16,speed:300,grav:260,life:1.2}),400);setTimeout(()=>clearInterval(e),4200)}else{let e=Array.from({length:14},()=>`<span class="ember" style="left:${(8+Math.random()*84).toFixed(1)}%;--ex:${((Math.random()-.5)*90).toFixed(0)}px;animation-delay:${(Math.random()*4).toFixed(2)}s;animation-duration:${(3+Math.random()*3).toFixed(2)}s"></span>`).join(``);ep().innerHTML=`<div class="end-screen grave">
      <div class="monument">
    ...
    </div>`}ep().onclick=e=>{let n=e.target.dataset?.a;n&&(Z.click(),n===`deck`&&gp(`Final Deck`,t.player.deck,{}),n===`new`&&(Q.run=null,bp(hd())),n===`title`&&(Q.run=null,vp(`title`)))}}function rm(){rp(),document.addEventListener(`pointerdown`,()=>Uf(),{once:!0}),document.addEventListener(`contextmenu`,e=>{Q.targeting&&(e.preventDefault(),Ip())}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&(Q.targeting?Ip():$(`#overlay`).classList.contains(`open`)&&$(`#overlay`)._closable&&hp()),(e.key===`e`||e.key===`E`)&&Q.screen===`combat`&&!Q.busy&&zp()}),$(`#overlay`).addEventListener(`pointerdown`,e=>{e.target===$(`#overlay`)&&$(`#overlay`)._closable&&hp()}),window.spirebound={S:Q,E:ud,startCombatUI:wp,show:vp},vp(`title`)}Fu(),Zu(),rm();