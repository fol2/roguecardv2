...
`;function $p(e,t,n,r){let i=new Da(2,2,_p,vp),a={geo:i,base:i.attributes.position.array.slice(),profile:t,seed:n,el:null,aspect:Jp(r,null)||2/3,sites:[],death:0,glass:null,fire:null,beams:null,bodyPx:null,outline:null,aimOn:!1,ward:null,wardOn:!1,wardGrow:0,wardGrowFrom:0,wardT0:0,wardSites:null,wardSitesUsed:-1,wardAlphaUsed:-1,wardOutline:null,wardOutlineKey:null,wardShapeSeed:null,wardSiteF:1,wardSiteFrom:1,wardSiteTo:1,wardSiteT0:0,wardSitePhase:null},o=qp(e,e=>{a.aspect=Jp(r,e)});a.tex=o;let s=new La({uniforms:{map:{value:o},uFlash:{value:0},uCut:{value:0},uErode:{value:.0024}},vertexShader:Xp,fragmentShader:Zp,transparent:!0,depthTest:!1,depthWrite:!1});a.mat=s;let c=new Ui(i,s);c.renderOrder=1,Rp.add(c),a.mesh=c;let l=new La({uniforms:{map:{value:o},uColor:{value:new H(`#fff6ec`)},uWidth:{value:.018},uStyle:{value:1},uSpeed:{value:1},uTime:{value:0},uBeams:{value:1},uDashes:{value:2}},vertexShader:Xp,fragmentShader:Qp,transparent:!0,depthTest:!1,depthWrite:!1}),u=new Ui(i,l);return u.visible=!1,u.renderOrder=0,Rp.add(u),a.outline=u,a.aimMat=l,r&&!r.complete&&r.addEventListener(`load`,()=>{a.aspect=Jp(r,o)},{once:!0}),a}function em(e){if(e.bodyPx)return e.bodyPx;let t=e.tex?.image;if(!t?.width)return null;let n=Object.assign(document.createElement(`canvas`),{width:jp,height:jp}).getContext(`2d`);return n.drawImage(t,0,0,jp,jp),e.bodyPx=n.getImageData(0,0,jp,jp).data,e.bodyPx}var tm=(e,t=e.sites)=>(t||[]).map(e=>({x:e.u*jp,y:(1-e.v)*jp}));function nm(e){let t=jp,n=em(e),r=Object.assign(document.createElement(`canvas`),{width:t,height:t}),i=r.getContext(`2d`),a=i.createImageData(t,t),o=tm(e),s=wp*t,c=s*(1-.9*Tp);for(let e=0;e<t;e++)for(let r=0;r<t;r++){let i=(e*t+r)*4,l=0;if(n[i+3]>90){let t=0xe8d4a51000;for(let n of o){let i=r-n.x,a=e-n.y,o=i*i+a*a;o<t&&(t=o)}let n=Math.sqrt(t);l=n<=c?1:n>=s?0:1-(n-c)/(s-c),l=l*l*(3-2*l)}let u=Math.round(255*l);a.data[i]=a.data[i+1]=a.data[i+2]=u,a.data[i+3]=255}return i.putImageData(a,0,0),r}function rm(e){let t=jp,n=Object.assign(document.createElement(`canvas`),{width:t,height:t}),r=n.getContext(`2d`),i=r.createImageData(t,t),a=tm(e);for(let e=0;e<t;e++)for(let n=0;n<t;n++){let r=0xe8d4a51000,o=0xe8d4a51000,s=null,c=null;for(let t of a){let i=n-t.x,a=e-t.y,l=i*i+a*a;l<r?(o=r,c=s,r=l,s=t):l<o&&(o=l,c=t)}let l=0,u=0,d=Math.sqrt(o)-Math.sqrt(r),f=t*.0137;if(c&&d<f){let e=s.x-c.x,t=s.y-c.y,n=Math.hypot(e,t)||1,r=(1-d/f)*.95;l=e/n*r,u=-(t/n)*r}let p=Math.sqrt(Math.max(.05,1-l*l-u*u)),m=(e*t+n)*4;i.data[m]=(l*.5+.5)*255,i.data[m+1]=(u*.5+.5)*255,i.data[m+2]=(p*.5+.5)*255,i.data[m+3]=255}return r.putImageData(i,0,0),n}function im(e){let t=jp,n=em(e),r=Object.assign(document.createElement(`canvas`),{width:t,height:t}),i=r.getContext(`2d`),a=i.createImageData(t,t),o=tm(e);if(o.length>=2){let e=wp*t,r=e*(1-.9*Tp),i=t*.0102,s=t*.0215;for(let c=0;c<t;c++)for(let l=0;l<t;l++){let u=(c*t+l)*4;if(n[u+3]<=90)continue;let d=0xe8d4a51000,f=0xe8d4a51000;for(let e of o){let t=l-e.x,n=c-e.y,r=t*t+n*n;r<d?(f=d,d=r):r<f&&(f=r)}let p=Math.sqrt(d),m=p<=r?1:p>=e?0:1-(p-r)/(e-r);if(m=m*m*(3-2*m),m<=0)continue;let h=Math.sqrt(f)-p,g=Math.max(0,1-h/i),_=Math.max(0,1-h/s)*.2,v=Math.min(1,g+_)*m;v<=.02||(a.data[u]=Math.round(255*v),a.data[u+1]=Math.round(158*v),a.data[u+2]=Math.round(56*v),a.data[u+3]=255)}}return i.putImageData(a,0,0),r}function am(e){let t=im(e),n=Math.round(jp*Ap),r=(n-jp)/2,i=Object.assign(document.createElement(`canvas`),{width:n,height:n}),a=i.getContext(`2d`),o=.5,s=.5;e.sites.length&&(o=e.sites.reduce((e,t)=>e+t.u,0)/e.sites.length,s=1-e.sites.reduce((e,t)=>e+t.v,0)/e.sites.length);let c=r+o*jp,l=r+s*jp;a.globalCompositeOperation=`lighter`;for(let e=1;e<=26;e++){let n=e/26,i=1+n*Op;a.globalAlpha=Math.min(1,.06*Dp*(1-n)**kp),a.setTransform(i,0,0,i,c-c*i,l-l*i),a.drawImage(t,r,r)}return a.setTransform(1,0,0,1,0,0),a.globalAlpha=1,i}function om(e){let t=Math.max(3,Math.round(Number(Mp.sites)||gp.sites));if(e.wardSites?.length&&e.wardSitesN===t)return e.wardSites;let n=[],r=Number.isFinite(e.wardShapeSeed)?e.wardShapeSeed:e.seed||0;for(let e=0;e<t;e++){let i=e/t*Math.PI*2+r*.17,a=.28+cm(r,e+40)*.12;n.push({u:Lm(.5+Math.cos(i)*a),v:Lm(.52+Math.sin(i)*a*.92)})}for(let e=0;e<5;e++){let t=r+e*1.7;n.push({u:Lm(.5+Math.cos(t)*.12),v:Lm(.5+Math.sin(t)*.14)})}return e.wardSites=n,e.wardSitesN=t,e.wardSitesUsed=-1,n}function sm(e,t){let n=om(e),r=e.wardSitePhase?e.wardSiteF??1:Math.max(0,Math.min(1,Number(t)||0));return Math.max(0,Math.round(n.length*r))}function cm(e,t){let n=Math.sin(e*12.9898+t*78.233)*43758.5453;return n-Math.floor(n)}function lm(e){let t=Math.max(5,Math.min(16,Math.round(Number(Mp.shapeVerts)||8))),n=Math.max(0,Math.min(1,Number(Mp.shapeJitter)||0)),r=Number.isFinite(e.wardShapeSeed)?e.wardShapeSeed:e.seed||0,i=`${t}|${n.toFixed(3)}|${r.toFixed(4)}`;if(e.wardOutlineKey===i&&e.wardOutline?.length)return e.wardOutline;let a=[];for(let e=0;e<t;e++){let i=e/t,o=(cm(r,e)-.5)*n*.55,s=i*Math.PI*2+r*.31+o,c=.78+(cm(r,e+17)-.5)*n*.42+.1*Math.sin(e*2.15+r)+.06*Math.cos(e*3.7-r*.7);a.push({x:Math.cos(s)*Math.max(.55,Math.min(1.18,c)),y:Math.sin(s)*Math.max(.55,Math.min(1.18,c))*1.06})}return e.wardOutline=a,e.wardOutlineKey=i,a}function um(e){e.wardShapeSeed=Math.random()*1e4,e.wardOutline=null,e.wardOutlineKey=null,e.wardSites=null,e.wardSitesN=void 0,e.wardSitesUsed=-1,e.wardAlphaUsed=-1}function dm(e,t,n){let r=!1,i=0xe8d4a51000,a=n.length;for(let o=0,s=a-1;o<a;s=o++){let a=n[o],c=n[s];a.y>t!=c.y>t&&e<(c.x-a.x)*(t-a.y)/(c.y-a.y||1e-9)+a.x&&(r=!r);let l=c.x-a.x,u=c.y-a.y,d=e-a.x,f=t-a.y,p=l*l+u*u||1e-9,m=Math.max(0,Math.min(1,(d*l+f*u)/p)),h=d-l*m,g=f-u*m;i=Math.min(i,Math.hypot(h,g))}return r?-i:i}function fm(e,t=1){let n=jp,r=Object.assign(document.createElement(`canvas`),{width:n,height:n}),i=r.getContext(`2d`),a=i.createImageData(n,n),o=n*.5,s=n*.52,c=n*.46,l=n*.48,u=Math.max(0,Math.min(.5,Number(Mp.edgeSoftness)||0)),d=Math.max(0,Math.min(1,Number(Mp.centerDip)||0)),f=Math.max(.05,1-Math.max(0,Math.min(1,Number(Mp.transparency)||0))),p=Math.max(0,Math.min(1,Number(t)||0)),m=lm(e);for(let e=0;e<n;e++)for(let t=0;t<n;t++){let r=(e*n+t)*4,i=(t-o)/c,h=(e-s)/l,g=dm(i,h,m),_;if(u<=.001?_=+(g<=0):g<=-u?_=1:g>=0?_=0:(_=1-(g+u)/u,_=_*_*(3-2*_)),d>0&&_>0){let e=Math.hypot(i/.62,h/.66);e<.55&&(_*=1-d+e/.55*d)}_*=f*p;let v=Math.round(255*Math.max(0,Math.min(1,_)));a.data[r]=a.data[r+1]=a.data[r+2]=v,a.data[r+3]=255}return i.putImageData(a,0,0),r}function pm(e,t){let n=jp,r=Object.assign(document.createElement(`canvas`),{width:n,height:n}),i=r.getContext(`2d`),a=i.createImageData(n,n),o=om(e),s=t==null?o.length:Math.max(0,Math.min(o.length,Math.round(t))),c=tm(e,o.slice(0,s));for(let e=0;e<n;e++)for(let t=0;t<n;t++){let r=0,i=0;if(c.length>=2){let a=0xe8d4a51000,o=0xe8d4a51000,s=null,l=null;for(let n of c){let r=t-n.x,i=e-n.y,c=r*r+i*i;c<a?(o=a,l=s,a=c,s=n):c<o&&(o=c,l=n)}let u=Math.sqrt(o)-Math.sqrt(a),d=n*.016;if(l&&u<d){let e=s.x-l.x,t=s.y-l.y,n=Math.hypot(e,t)||1,a=(1-u/d)*1.05;r=e/n*a,i=-(t/n)*a}}let o=Math.sqrt(Math.max(.05,1-r*r-i*i)),s=(e*n+t)*4;a.data[s]=(r*.5+.5)*255,a.data[s+1]=(i*.5+.5)*255,a.data[s+2]=(o*.5+.5)*255,a.data[s+3]=255}return i.putImageData(a,0,0),r}function mm(e,t){if(!e?.ward?.material)return;let n=sm(e,t);if(n===e.wardSitesUsed)return;e.wardSitesUsed=n;let r=e.ward.material,i=r.normalMap;r.normalMap=ym(pm(e,n)),i?.dispose?.(),r.needsUpdate=!0}function hm(e,t){if(!e?.ward?.material)return;let n=e.wardSitePhase?1:Math.max(0,Math.min(1,Number(t)||0)),r=Math.round(n*20);if(r===e.wardAlphaUsed)return;e.wardAlphaUsed=r;let i=e.ward.material,a=i.alphaMap;i.alphaMap=ym(fm(e,r/20)),a?.dispose?.(),i.needsUpdate=!0}function gm(e,t){if(e?.mat){if(t){e.mat.uniforms.uCut.value===0&&(e.mat.uniforms.uCut.value=.35,e.mat.transparent=!1,e.mat.needsUpdate=!0);return}e.sites.length||e.death>0||(e.mat.uniforms.uCut.value=0,e.mat.transparent=!0,e.mat.needsUpdate=!0)}}function _m(e){vm(),bm(e,`ward`);let t=e.wardGrow||0,n=sm(e,t);e.wardSitesUsed=n,e.wardAlphaUsed=Math.round(Math.max(0,Math.min(1,t))*20);let r=new Ba({color:new H(Mp.tint||gp.tint),transmission:0,ior:Math.max(1,Number(Mp.ior)||1.4),thickness:0,roughness:Math.min(1,Math.max(0,Number(Mp.roughness)||0)),metalness:0,normalMap:ym(pm(e,n)),normalScale:new R(0,0),alphaMap:ym(fm(e,t)),transparent:!0,alphaTest:.01,opacity:Math.max(0,Math.min(1,Number(Mp.opacity)||0)),clearcoat:0,clearcoatRoughness:1,envMapIntensity:0,depthTest:!1,depthWrite:!1}),i=new Ui(new Da(2,2),r);i.visible=!1,i.renderOrder=5,Rp.add(i),e.ward=i}function vm(){if(Wp||!Lp)return;Wp=!0;let e=new ys(Lp);Rp.environment=e.fromScene(new np,.04).texture,Rp.environmentIntensity=.45;let t=new ko(14674687,1.8);t.position.set(-1.4,1.8,2),Rp.add(t),Rp.add(new Ao(2765894,.6))}var ym=(e,t=!1)=>{let n=new va(e);return t&&(n.colorSpace=dt),n};function bm(e,t){let n=e[t];if(n){Rp.remove(n);for(let e of[`map`,`alphaMap`,`normalMap`])n.material[e]?.dispose?.();n.material.dispose(),n.geometry&&n.geometry!==e.geo&&n.geometry.dispose(),e[t]=null,t===`ward`&&(e.wardSitesUsed=-1,e.wardAlphaUsed=-1)}}function xm(e){vm(),bm(e,`glass`);let t=new Ba({transmission:1,ior:1.4,thickness:.12,roughness:.03,metalness:0,normalMap:ym(rm(e)),normalScale:new R(1.3,1.3),alphaMap:ym(nm(e)),transparent:!0,alphaTest:.01,opacity:Ep,clearcoat:.3,clearcoatRoughness:.2,envMapIntensity:.4,depthTest:!1,depthWrite:!1}),n=new Ui(e.geo,t);n.renderOrder=3,Rp.add(n),e.glass=n}function Sm(e){bm(e,`fire`);let t=new ji({map:ym(im(e),!0),transparent:!1,blending:2,depthTest:!1,depthWrite:!1});t.color.setScalar(0);let n=new Ui(e.geo,t);n.renderOrder=2,Rp.add(n),e.fire=n}function Cm(e){bm(e,`beams`);let t=new ji({map:ym(am(e),!0),transparent:!0,blending:2,depthTest:!1,depthWrite:!1,opacity:0}),n=new Ui(new Da(2,2),t);n.renderOrder=4,Rp.add(n),e.beams=n}function wm(e,t){let n=e.geo.attributes.position,r=e.profile;for(let i=0;i<n.count;i++){let a=e.base[i*3],o=e.base[i*3+1],s=(o+1)/2,c=s**+(r.pin??1.6),l=0,u=0;l+=.028*c*r.sway*Math.sin(t*.9+e.seed),l+=.01*c*c*r.sway*Math.sin(t*1.7+1+e.seed*.3);let d=Fp(s,.62,.12);l+=a*.02*d*r.breathe*Math.sin(t*2.2+e.seed*.5),u+=.012*d*r.breathe*Math.sin(t*2.2+e.seed*.5),u+=.014*c*r.bob*Math.sin(t*1.1+.4+e.seed),l+=.012*Math.max(0,(s-.8)/.2)*r.head*Math.sin(t*.7+e.seed),l+=.01*Math.max(0,(.45-s)/.45)*c*r.cloth*Math.sin(s*12-t*2.5+e.seed),n.array[i*3]=a+l*yp,n.array[i*3+1]=o+u*yp}n.needsUpdate=!0}function Tm(e){return[e.outline,e.mesh,e.fire,e.glass,e.beams,e.ward].filter(Boolean)}function Em(e){return[e.mesh,e.fire,e.glass,e.beams].filter(Boolean)}var Dm=()=>{let e=Lp?C(Lp.domElement):{left:0,top:0};return{left:e.left,top:e.top}};function Om(e,t=0,n={left:0,top:0}){let r=t=>{for(let n of Em(e))n.visible=t;e.outline&&(e.outline.visible=t&&!!e.aimOn),e.ward&&(e.ward.visible=t&&!!e.wardOn&&(e.wardGrow||0)>.02)};if(!e.el.isConnected||!(e.el.checkVisibility?.({visibilityProperty:!0})??!0)){r(!1);return}let i=C(e.el);if(i.width<2||i.height<2){r(!1);return}e.aspect=Jp(e.el.querySelector(`.raster-art`),e.tex)||e.aspect||1;let{w:a,h:o}=Yp(i.width,i.height,e.aspect),s=(e.profile.float||0)*Math.sin(t*1.15+e.seed*.7)*12*yp,c=i.left-n.left+i.width/2-Hp/2,l=-(i.top-n.top+i.height-o/2-Up/2)+s,u=(e.flip?-1:1)*a/2,d=o/2;r(!0);let f=Math.round(i.bottom);e.outline&&(e.outline.renderOrder=f*4),Em(e).forEach((e,t)=>{e.renderOrder=f*4+1+t}),e.ward&&(e.ward.renderOrder=f*4+8);let p=0;for(let n of Tm(e)){let r=n===e.ward;n.position.set(c,l,r?p+.5:p);let i=1;if(n===e.beams)i=Ap;else if(r){let r=e.wardGrow||0;i=Number(Mp.pad)||gp.pad,Mp.idleWobble?n.rotation.z=Math.sin(t*1.4+e.seed)*.04:n.rotation.z=0,r>.02&&gm(e,!0),hm(e,r),mm(e,r),Pp(n.material),n.visible=(!!e.wardOn||r>0)&&r>.02}n.scale.set(u*i,d*i,1),p+=.01}}function km(){Hp=_(),Up=v(),Lp.setPixelRatio(Math.min(devicePixelRatio*y(),2)),Lp.setSize(Hp,Up,!1),zp.left=-Hp/2,zp.right=Hp/2,zp.top=Up/2,zp.bottom=-Up/2,zp.updateProjectionMatrix()}function Am(e){if(!Bp.length)return;let t=e*.001,n=Dm();for(let r of Bp){let i=Math.max(80,Number(Mp.growMs)||gp.growMs);if(r.wardSitePhase===`shrink`){let t=i*.45,n=Math.min(1,(e-r.wardSiteT0)/t),a=n*n*(3-2*n);r.wardSiteF=r.wardSiteFrom+(r.wardSiteTo-r.wardSiteFrom)*a,n>=1&&(r.wardSitePhase=`grow`,r.wardSiteFrom=r.wardSiteF,r.wardSiteTo=1,r.wardSiteT0=e)}else if(r.wardSitePhase===`grow`){let t=i*.55,n=Math.min(1,(e-r.wardSiteT0)/t),a=n*n*(3-2*n);r.wardSiteF=r.wardSiteFrom+(r.wardSiteTo-r.wardSiteFrom)*a,n>=1&&(r.wardSiteF=1,r.wardSitePhase=null)}else if(r.wardOn&&r.wardGrow<1){let t=Math.min(1,(e-r.wardT0)/i),n=t*t*(3-2*t);r.wardGrow=r.wardGrowFrom+(1-r.wardGrowFrom)*n,r.wardSiteF=r.wardGrow}else if(!r.wardOn&&r.wardGrow>0){let t=Math.min(1,(e-r.wardT0)/i),n=t*t*(3-2*t);r.wardGrow=r.wardGrowFrom*(1-n),r.wardSiteF=r.wardGrow,r.wardGrow<.02&&(r.wardGrow=0,r.wardSiteF=0,r.wardSitePhase=null,bm(r,`ward`),gm(r,!1))}else r.wardOn&&(r.wardSiteF=1);wm(r,t),Om(r,t,n),r.aimMat&&r.aimOn&&(r.aimMat.uniforms.uTime.value=t)}Lp.render(Rp,zp)}function jm(){let e=document.getElementById(`mesh`);!e||Lp||(Lp=new fu({canvas:e,alpha:!0,antialias:!0,powerPreference:`high-performance`}),Lp.setClearColor(0,0),Lp.toneMapping=4,Lp.toneMappingExposure=1.1,Rp=new sr,zp=new Do(-1,1,1,-1,.1,100),zp.position.z=10,km(),addEventListener(`resize`,km))}function Mm(e){e.el?.classList.remove(`mesh-live`),bm(e,`glass`),bm(e,`fire`),bm(e,`beams`),bm(e,`ward`),e.outline&&(Rp.remove(e.outline),e.aimMat?.dispose(),e.outline=null,e.aimMat=null),Rp.remove(e.mesh),e.geo.dispose(),e.mesh.material.dispose()}function Nm(){cancelAnimationFrame(Vp),Vp=0;for(let e of Bp)Mm(e);Bp=[],document.documentElement.classList.remove(`mesh-on`),Lp?.render(Rp,zp)}function Pm(e){let t=Bp.findIndex(t=>t.el===e||t.el&&e.contains&&e.contains(t.el));t<0||(Mm(Bp[t]),Bp.splice(t,1),Bp.length||document.documentElement.classList.remove(`mesh-on`),Lp?.render(Rp,zp))}function Fm(e,t=160){let n=Rm(e);n&&(n.mat.uniforms.uFlash.value=.9,setTimeout(()=>{n.mat&&(n.mat.uniforms.uFlash.value=0)},t))}var Im=56,Lm=e=>Math.max(.05,Math.min(.95,e));function Rm(e){return Bp.find(t=>t.el===e||e.contains&&e.contains(t.el))}function zm(e,t=.32+Math.random()*.36,n=.3+Math.random()*.4){if(Sp)return!1;let r=Rm(e);if(!r||!em(r))return!1;let i=5+(Math.random()*3|0);for(let e=0;e<i;e++){let e=Math.random()*Math.PI*2,i=Math.random()*.052;if(r.sites.length>=Im)break;r.sites.push({u:Lm(t+Math.cos(e)*i),v:Lm(n+Math.sin(e)*i)})}return gm(r,!0),xm(r),r.death>0&&Sm(r),!0}function Bm(e,t){if(Sp)return!1;let n=Rm(e);return n?(t>0&&!n.fire&&(Sm(n),Cm(n)),n.death=t,n.fire&&n.fire.material.color.setScalar(t),n.beams&&(n.beams.material.opacity=Math.min(1,Math.max(0,t*1.35-.35))),!0):!1}function Vm(e){let t=Rm(e);return t?t.sites.map(e=>({u:e.u,v:e.v})):[]}function Hm(e){let t=Rm(e);if(!t||!Lp||Sp)return null;let n=performance.now()*.001,r=Dm(),i=new Set(Tm(t)),a=[];Rp.traverse(e=>{e.isMesh&&(a.push([e,e.visible]),e.visible=i.has(e)&&e!==t.beams)}),wm(t,n),Om(t,n,r),t.beams&&(t.beams.visible=!1),Lp.render(Rp,zp);for(let[e,t]of a)e.visible=t;let o=C(t.el),{w:s,h:c}=Yp(o.width,o.height,t.aspect),l=Lp.getPixelRatio(),u=(o.left-r.left+o.width/2-s/2)*l,d=(o.top-r.top+o.height-c)*l,f=Math.max(1,Math.round(s*l)),p=Math.max(1,Math.round(c*l)),m=document.createElement(`canvas`);m.width=f,m.height=p,m.getContext(`2d`).drawImage(Lp.domElement,u,d,f,p,0,0,f,p);let h=Vm(e),g={left:o.left,top:o.top,width:o.width,height:o.height},_=t.beams;if(_){t.beams=null;let e=performance.now(),n=_.material.opacity,r=t=>{let i=Math.min(1,(t-e)/200);_.material.opacity=n*(1-i),i<1?(Bp.length||Lp?.render(Rp,zp),requestAnimationFrame(r)):(Rp.remove(_),_.material.map?.dispose(),_.material.dispose(),Lp?.render(Rp,zp))};requestAnimationFrame(r)}return Pm(e),{capture:m.toDataURL(`image/png`),sites:h,rect:g}}function Um(e,t){let n=Ip[e]||Ip.humanoid,r=t?pp(t):{};return Object.keys(r).length?{...n,...r}:n}function Wm(e){if(Nm(),!Cp()||(Lp||jm(),!Lp))return;for(let{el:t,url:n,kind:r,id:i,flip:a}of e){if(!n||!t)continue;let e=t.querySelector(`.raster-art`);if(!e)continue;t.classList.add(`mesh-live`);let o=Um(r,i),s=$p(n,o,Math.random()*10,e);s.el=t,s.flip=!!a,s.profile=o,Bp.push(s)}if(!Bp.length)return;document.documentElement.classList.add(`mesh-on`);let t=e=>{Vp=requestAnimationFrame(t),Am(e)};Vp=requestAnimationFrame(t)}function Gm(e){let t=Rm(e);if(!t)return 0;let n=performance.now()*.001;return Math.max(0,(t.profile.float||0)*Math.sin(n*1.15+t.seed*.7)*12*yp)}function Km(e,t,n=null){let r=Rm(e);if(!r?.outline)return!1;if(r.aimOn=!!t,r.outline.visible=!!t,t&&r.aimMat&&n){let e=n.style===`chase`?2:n.style===`solid`?0:1;r.aimMat.uniforms.uStyle.value=e,r.aimMat.uniforms.uSpeed.value=Number.isFinite(n.speed)?n.speed:1,r.aimMat.uniforms.uColor.value.set(n.color||`#fff6ec`);let t=Number.isFinite(n.width)?n.width:.018;r.aimMat.uniforms.uWidth.value=Math.min(.06,Math.max(.006,t));let i=Number.isInteger(n.beams)?n.beams:1,a=Number.isInteger(n.dashes)?n.dashes:2;r.aimMat.uniforms.uBeams.value=Math.min(4,Math.max(1,i)),r.aimMat.uniforms.uDashes.value=Math.min(4,Math.max(1,a))}return!0}function qm(e,t,{grow:n=!0}={}){if(Sp||!Cp())return!1;let r=Rm(e);return r?t?r.wardOn&&r.ward?n?(r.wardGrow=1,r.wardGrowFrom=1,r.wardSitePhase=`shrink`,r.wardSiteFrom=r.wardSiteF??1,r.wardSiteTo=.12,r.wardSiteT0=performance.now(),r.wardSitesUsed=-1,!0):!0:(um(r),_m(r),r.wardOn=!0,r.wardSitePhase=null,r.wardT0=performance.now(),n?(r.wardGrow=0,r.wardGrowFrom=0,r.wardSiteF=0,r.wardSitesUsed=-1,r.wardAlphaUsed=-1):(r.wardGrow=1,r.wardGrowFrom=1,r.wardSiteF=1,r.wardAlphaUsed=-1),!0):r.wardOn?(r.wardOn=!1,r.wardSitePhase=null,r.wardGrowFrom=r.wardGrow||0,r.wardT0=performance.now(),!0):!0:!1}function Jm(){for(let e of Bp)e.aimOn=!1,e.outline&&(e.outline.visible=!1)}var Ym=()=>({enabled:Cp(),planes:Bp.length,renderer:!!Lp,looping:!!Vp,intensity:yp,sites:Bp.reduce((e,t)=>Math.max(e,t.sites.length),0),death:Bp.reduce((e,t)=>Math.max(e,t.death),0),glass:Bp.filter(e=>e.glass).length}),Xm=t({MAP_COLS:()=>7,MAP_ROWS:()=>15,addCardToDeck:()=>Sg,addStatus:()=>Uh,applyEventOps:()=>Ng,applyNodeEventChoice:()=>Ah,availableNodes:()=>uh,canKindle:()=>$h,canPlay:()=>ug,canUseArt:()=>Xh,cardData:()=>sh,cardPool:()=>hh,claimBossRelic:()=>jh,claimMonument:()=>fh,claimTreasure:()=>kh,clamp:()=>eh,clearSave:()=>Ag,drawCards:()=>og,duplicateCardInDeck:()=>Tg,effCost:()=>lg,endTurn:()=>hg,enemyMove:()=>Gh,finalizeNodeEventChoice:()=>Oh,gainEmbers:()=>Kh,gainPotion:()=>Mh,gainRelic:()=>vh,genCombatRewards:()=>Fh,genMap:()=>lh,genShop:()=>Lh,hasRelic:()=>ph,healPlayer:()=>_h,kindleFromHand:()=>tg,loadRun:()=>kg,loadStats:()=>jg,makeCard:()=>oh,makeRng:()=>Zm,newRun:()=>th,nodeEventInFlight:()=>Dh,nodeRewardClaimed:()=>Eh,omenMods:()=>ih,playCard:()=>dg,previewAttack:()=>vg,previewBlock:()=>yg,previewEnemyDmg:()=>bg,previewPlay:()=>xg,randomRelic:()=>yh,recordRunEnd:()=>Mg,relicPool:()=>gh,removeCardFromDeck:()=>Cg,restHealFrac:()=>ah,rollBossRelics:()=>Ih,rollCardReward:()=>Nh,rollEncounter:()=>zh,rollEvent:()=>Rh,rollEventCards:()=>Ph,rollOmen:()=>rh,runRevealed:()=>mh,runRng:()=>ch,saveRun:()=>Og,startCombat:()=>Bh,upgradeCardInDeck:()=>wg,useArt:()=>Zh,usePotion:()=>mg,visitNode:()=>dh,vowMods:()=>nh});function Zm(e){let t=()=>{e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296};return t.getState=()=>e,t}var Qm=(e,t)=>t[Math.floor(e()*t.length)],$m=(e,[t,n])=>t+Math.floor(e()*(n-t+1)),eh=(e,t,n)=>Math.max(t,Math.min(n,e));function th(e=Math.random()*2**31|0,t={}){let n=eh(t.aspect||0,0,qu.length-1),r=qu[n],i={v:2,seed:e,rngState:e,uid:1,act:0,nodeId:null,floorsClimbed:0,bossRelicAct:-1,orphanRewardClaimed:!1,orphanRewardResolving:!1,aspect:n,vow:eh(t.vow||0,0,Ju.length),art:t.art||r.art||`flare`,omens:[],boon:t.boon||null,unlocks:[...t.unlocks||[]],reveals:t.reveals?[...t.reveals]:null,monument:t.monument?{...t.monument,claimed:!1}:null,player:{hp:r.maxHp,maxHp:r.maxHp,gold:r.startGold,energyMax:r.energy,relics:[r.startRelic],potions:Array(r.potionSlots||3).fill(null),deck:[]},stats:{slain:0,elites:0,bosses:0,dmgDealt:0,dmgTaken:0,cardsPlayed:0,goldEarned:0,shatters:0,kindles:0,perfects:0,smolderKills:0,unlitVisited:0,embersSpent:0,start:Date.now()},map:null};t.lamplighter&&(i.pendingLamplighter=!0);for(let e of r.startDeck)i.player.deck.push(oh(i,e));return nh(i).startHex&&i.player.deck.push(oh(i,`hex`)),i.omens.push(mh(i,`omens`)?rh(i):null),i.map=lh(i),i}function nh(e){let t={hpMult:1,enemyDmgBonus:0,bossFacetDelta:0,startHex:!1},n=eh(e.vow||0,0,Ju.length);for(let e=0;e<n;e++){let n=Ju[e].mods;n.hpMult&&(t.hpMult*=n.hpMult),n.enemyDmgBonus&&(t.enemyDmgBonus+=n.enemyDmgBonus),n.bossFacetDelta&&(t.bossFacetDelta+=n.bossFacetDelta),n.startHex&&(t.startHex=!0),n.restHealFrac!=null&&(t.restHealFrac=Math.min(t.restHealFrac??1,n.restHealFrac))}return t}function rh(e){return Qm(ch(e),Object.keys(Bu))}function ih(e){return Bu[e.omens?.[e.act]]?.mods||{}}function ah(e){return Math.min(.3,ih(e).restHealFrac??.3,nh(e).restHealFrac??.3)}function oh(e,t,n=!1){return{uid:e.uid++,id:t,up:n,bonus:0}}function sh(e){let t=ku[e.id];return e.up&&t.up?{...t,...t.up,name:t.name+`+`}:t}function ch(e){let t=Zm(e.rngState);return()=>{let n=t();return e.rngState=t.getState(),n}}function lh(e){let t=ch(e),n={},r=(e,t)=>`${e},${t}`,i=(e,i)=>(n[r(e,i)]||(n[r(e,i)]={id:r(e,i),row:e,col:i,type:`monster`,next:[],jx:(t()-.5)*.5,jy:(t()-.5)*.4}),n[r(e,i)]),a=new Set;for(let e=0;e<6;e++){let n;do n=Math.floor(t()*7);while(e<2&&a.has(n));a.add(n);let r=i(0,n);for(let e=1;e<14;e++){let n=eh(r.col+(Math.floor(t()*3)-1),0,6),a=i(e,n);r.next.includes(a.id)||r.next.push(a.id),r=a}let o=i(14,3);r.next.includes(o.id)||r.next.push(o.id)}let o=Object.values(n),s=!1;for(let e of o){if(e.row===0)e.type=`monster`;else if(e.row===14)e.type=`boss`;else if(e.row===13)e.type=`rest`;else if(e.row===8)e.type=`treasure`;else{let n=t();n<.46?e.type=`monster`:n<.68?e.type=`event`:n<.81&&e.row>=5?e.type=`elite`:n<.91&&e.row>=4&&e.row<12?e.type=`rest`:e.row>=4?e.type=`shop`:e.type=`monster`}e.type===`shop`&&(s=!0)}if(!s){let e=o.filter(e=>e.type===`monster`&&e.row>=5&&e.row<=11);e.length&&(Qm(t,e).type=`shop`)}for(let n of o)n.row===0||n.row===8||n.row>=13||t()<.15&&(n.unlit=!0,n.bounty=$m(t,[12,22])+e.act*6);if(e.monument&&!e.monument.claimed&&e.monument.act===e.act){let t=eh(e.monument.row||5,1,12),n=o.filter(e=>e.type===`shop`).length===1,r=o.filter(e=>e.row>0&&e.row<13&&e.row!==8&&e.type!==`boss`&&!(n&&e.type===`shop`));if(r.length){let e=r.reduce((e,n)=>Math.abs(n.row-t)<Math.abs(e.row-t)?n:e);e.type=`monument`,delete e.unlit,delete e.bounty}}return{nodes:o,visited:[]}}function uh(e){let{nodes:t,visited:n}=e.map;if(!e.nodeId)return t.filter(e=>e.row===0);let r=t.find(t=>t.id===e.nodeId);return t.filter(e=>r.next.includes(e.id))}function dh(e,t){e.nodeId=t.id,e.orphanRewardClaimed&&=(t.rewardClaimed=!0,!1),e.orphanRewardResolving&&=(t.rewardResolving=!0,!1),e.floorsClimbed=t.row+1,e.map.visited.includes(t.id)||e.map.visited.push(t.id);let n=0;return t.unlit&&(delete t.unlit,n=(t.bounty||0)*(ph(e,`thiefOfWicks`)?2:1),delete t.bounty,e.player.gold+=n,e.stats.goldEarned+=n,e.stats.unlitVisited++),{type:t.type,bounty:n}}function fh(e){let t=e.monument;if(!t||t.claimed||!t.bequest)return null;t.claimed=!0;let n=t.bequest;return n.kind===`card`?Sg(e,n.id,n.up):n.kind===`relic`?vh(e,n.id):n.kind===`gold`&&(e.player.gold+=n.amount,e.stats.goldEarned+=n.amount),n}var ph=(e,t)=>e.player.relics.includes(t),mh=(e,t)=>e.reveals==null||e.reveals.includes(t);function hh(e,t){let n=(e.unlocks||[]).filter(e=>e.startsWith(`card:`)).map(e=>e.slice(5)).filter(e=>ku[e]&&ku[e].rarity===t),r=Au[t];return e.reveals!=null&&(r=r.filter(t=>!Ku.cards[t]||e.reveals.includes(Ku.cards[t]))),n.length?[...r,...n]:r}function gh(e,t){let n=(e.unlocks||[]).filter(e=>e.startsWith(`relic:`)).map(e=>e.slice(6)).filter(e=>Mu[e]&&Mu[e].rarity===t),r=Nu[t];return e.reveals!=null&&(r=r.filter(t=>!Ku.relics[t]||e.reveals.includes(Ku.relics[t]))),n.length?[...r,...n]:r}function _h(e,t,n=null){ph(e,`sunBlossom`)&&(t=Math.round(t*1.5));let r=n?n.player:e.player,i=r.hp;r.hp=eh(r.hp+t,0,r.maxHp);let a=r.hp-i;return n&&a>0&&n.queue.push({t:`heal`,who:`player`,n:a}),a}function vh(e,t,n=null){let r=Mu[t];if(r){if(r.replaces){let t=e.player.relics.indexOf(r.replaces);t>=0&&e.player.relics.splice(t,1)}e.player.relics.push(t),t===`sweetRoot`&&(e.player.maxHp+=8,e.player.hp+=8),t===`hollowCrown`&&(e.player.energyMax+=1,e.player.maxHp=Math.max(1,e.player.maxHp-10),e.player.hp=Math.min(e.player.hp,e.player.maxHp))}}function yh(e,t={common:.5,uncommon:.35,rare:.15}){let n=ch(e),r=new Set(e.player.relics),i=[`common`,`uncommon`,`rare`],a=n(),o=`common`,s=0;for(let e of i)if(s+=t[e]||0,a<s){o=e;break}let c=i.indexOf(o);for(let t=0;t<i.length;t++){let a=i[(c+t)%i.length],o=gh(e,a).filter(e=>!r.has(e));if(o.length)return Qm(n,o)}return null}function bh(e){return!e.nodeId||!e.map?.nodes?null:e.map.nodes.find(t=>t.id===e.nodeId)||null}function xh(e){let t=bh(e);return t?!!t.rewardClaimed:!!e.orphanRewardClaimed}function Sh(e){let t=bh(e);return t?!!t.rewardResolving:!!e.orphanRewardResolving}function Ch(e){return xh(e)||Sh(e)}function wh(e){let t=bh(e);t?t.rewardResolving=!0:e.orphanRewardResolving=!0}function Th(e){let t=bh(e);t?(t.rewardClaimed=!0,delete t.rewardResolving):(e.orphanRewardClaimed=!0,e.orphanRewardResolving=!1)}function Eh(e){return xh(e)}function Dh(e){return Sh(e)}function Oh(e){Th(e)}function kh(e,t={common:.55,uncommon:.35,rare:.1}){if(xh(e))return{already:!0,relicId:null,gold:0};let n=yh(e,t);return n?vh(e,n):e.player.gold+=60,Th(e),{already:!1,relicId:n,gold:n?0:60}}function Ah(e,t,n=ch(e)){if(Ch(e))return{pending:[],log:[],already:!0};let{pending:r,log:i}=Ng(e,t,n);return wh(e),{pending:r,log:i,already:!1}}function jh(e,t){return e.bossRelicAct===e.act?{already:!0,id:null}:(e.bossRelicAct=e.act,t&&vh(e,t),{already:!1,id:t||null})}function Mh(e,t){if(!mh(e,`phials`))return!1;t===`random`&&(t=Qm(ch(e),Object.keys(Pu)));let n=e.player.potions.indexOf(null);return n<0?!1:(e.player.potions[n]=t,!0)}function Nh(e,t=`normal`){let n=ch(e),r=3+ +!!ph(e,`seersOrb`)+(ih(e).rewardChoiceBonus||0),i=[],a=new Set;for(;i.length<r&&a.size<40;){let r;if(t===`boss`)r=`rare`;else{let e=n();r=t===`elite`?e<.45?`common`:e<.85?`uncommon`:`rare`:e<.6?`common`:e<.92?`uncommon`:`rare`}let o=Qm(n,hh(e,r));a.add(o+Math.floor(n()*4)),i.includes(o)||i.push(o)}return i}function Ph(e,t){let n=ch(e),r=[...hh(e,`common`),...hh(e,`common`),...hh(e,`uncommon`),...hh(e,`uncommon`),...hh(e,`rare`)],i=[],a=0;for(;i.length<t&&a++<60;){let e=r[Math.floor(n()*r.length)];i.includes(e)||i.push(e)}return i}function Fh(e,t,n=null){let r=ch(e),i=$m(r,Ru[e.act][t===`boss`?`boss`:t===`elite`?`elite`:`normal`]);i=Math.round(i*(ih(e).goldMult||1)*(Vu[n]?.mods.goldMult||1));let a={gold:i,cards:Nh(e,t),potion:null,relic:null};return t!==`boss`&&r()<.4&&mh(e,`phials`)&&(a.potion=Qm(r,Object.keys(Pu))),t===`elite`&&(a.relic=yh(e)),a}function Ih(e){let t=ch(e),n=new Set(e.player.relics),r=gh(e,`boss`).filter(e=>!n.has(e)),i=[];for(;i.length<Math.min(3,r.length);){let e=Qm(t,r);i.includes(e)||i.push(e)}return i}function Lh(e){let t=ch(e),n=([e,n],r)=>Math.round($m(t,[e,n])*r),r=(ph(e,`merchantsMark`)?.75:1)*(ih(e).shopMult||1),i=[];for(let a of[`common`,`common`,`uncommon`,`uncommon`,`rare`]){let o,s=0;do o=Qm(t,hh(e,a));while(i.some(e=>e.id===o)&&++s<20);i.push({id:o,price:n(zu.cardPrice[a],r),sold:!1})}let a=new Set(e.player.relics),o=[];for(let i of[`common`,`uncommon`]){let s=gh(e,i).filter(e=>!a.has(e)&&!o.some(t=>t.id===e));s.length&&o.push({id:Qm(t,s),price:n(zu.relicPrice[i],r),sold:!1})}let s=[];if(mh(e,`phials`))for(let e=0;e<2;e++)s.push({id:Qm(t,Object.keys(Pu)),price:n(zu.potionPrice,r),sold:!1});return{cards:i,relics:o,potions:s,removeCost:Math.round(zu.removeCost*r),removed:!1}}function Rh(e){let t=ch(e),n=e.seenEvents||=[],r=Object.keys(Lu).filter(e=>!n.includes(e));r.length||(e.seenEvents=[],r=Object.keys(Lu));let i=Qm(t,r);return n.push(i),i}function zh(e,t,n){let r=ch(e),i=Iu[e.act],a=t===`boss`?i.boss:t===`elite`?i.elite:n<3?i.weak:i.normal,o=e.lastEnc,s,c=0;do s=Qm(r,a);while(a.length>1&&s.join()===o&&++c<8);return e.lastEnc=s.join(),s}function Bh(e,t,n=`normal`,r={}){let i=ch(e),a=ih(e),o=nh(e),s=n===`elite`?r.affix||Qm(i,Object.keys(Vu)):null,c=s?Vu[s].mods:{},l={kind:n,affix:s,turn:0,over:!1,result:null,queue:[],player:{hp:e.player.hp,maxHp:e.player.maxHp,block:0,energy:0,energyMax:e.player.energyMax,statuses:{}},enemies:t.map((e,t)=>{let n=Fu[e];return{key:e,idx:t,name:n.name,maxHp:Math.round($m(i,n.hp)*(a.hpMult||1)*(c.hpMult||1)*(o.hpMult||1)),block:c.startBlock||0,statuses:{...n.startStatus||{}},flags:c.adamant?{adamant:!0}:{},lastMoves:[],moveKey:null,elite:!!n.elite,boss:!!n.boss,facetMax:Math.max(2,(n.facets??(n.boss?6:n.elite?5:4))+(a.facetDelta||0)+(c.facetDelta||0)+(n.boss&&o.bossFacetDelta||0)),chips:0}}),draw:[],hand:[],discard:[],exhaust:[],embers:0,emberCap:9,artUsedTurn:0,kindledTurn:0,kindlesThisTurn:0,pendingChips:null,counters:{played:0,attacks:0,firstCardPlayed:!1,hpLost:0}};l.enemies.forEach(e=>e.hp=e.maxHp);for(let e of l.enemies)for(let[t,n]of Object.entries({...a.enemyStartStatus||{},...c.startStatus||{}}))e.statuses[t]=(e.statuses[t]||0)+n;a.startEmbers&&(l.embers=eh(a.startEmbers,0,l.emberCap)),l.draw=e.player.deck.map(e=>({...e,bonus:0})),Vh(i,l.draw);let u=l.player;return ph(e,`basaltIdol`)&&(u.block+=10,Hh(l,`basaltIdol`)),ph(e,`warFetish`)&&(Uh(l,u,`str`,1),Hh(l,`warFetish`)),ph(e,`riverPearl`)&&(Uh(l,u,`dex`,1),Hh(l,`riverPearl`)),ph(e,`thornBand`)&&(Uh(l,u,`thorns`,2),Hh(l,`thornBand`)),ph(e,`vialOfLife`)&&(_h(e,2,l),Hh(l,`vialOfLife`)),ph(e,`crownOfCinders`)&&(l.emberCap=12,l.embers=eh(l.embers+2,0,l.emberCap),Hh(l,`crownOfCinders`)),ph(e,`shatterersCrown`)&&(l.enemies.forEach(e=>{e.facetMax=Math.max(2,e.facetMax-1),e.statuses.str=(e.statuses.str||0)+1}),Hh(l,`shatterersCrown`)),ph(e,`smolderingCoal`)&&(l.enemies.forEach(e=>e.statuses.poison=(e.statuses.poison||0)+2),Hh(l,`smolderingCoal`)),ph(e,`ashenCore`)&&(l.enemies.forEach(e=>e.statuses.poison=(e.statuses.poison||0)+3),Hh(l,`ashenCore`)),Wh(e,l),cg(e,l),l}function Vh(e,t){for(let n=t.length-1;n>0;n--){let r=Math.floor(e()*(n+1));[t[n],t[r]]=[t[r],t[n]]}}function Hh(e,t){e.queue.push({t:`relicProc`,id:t})}function Uh(e,t,n,r){t.statuses[n]=(t.statuses[n]||0)+r,t.statuses[n]===0&&delete t.statuses[n],e.queue.push({t:`status`,who:t===e.player?`player`:t.idx,id:n,n:r})}function Wh(e,t){let n=ch(e);for(let e of t.enemies)e.hp<=0||(e.moveKey=Fu[e.key].ai({turn:t.turn+1,last:e.lastMoves[e.lastMoves.length-1],prev:e.lastMoves[e.lastMoves.length-2],rng:n,hpFrac:e.hp/e.maxHp,self:e}),t.queue.push({t:`intent`,idx:e.idx,move:e.moveKey}))}function Gh(e){return Fu[e.key].moves[e.moveKey]}function Kh(e,t,n){let r=eh(t.embers+n,0,t.emberCap),i=r-t.embers;return i?(t.embers=r,t.queue.push({t:`ember`,n:i,total:t.embers}),i):0}function qh(e,t,n,r){if(!(t.over||n.hp<=0||r<=0))for(n.chips+=r,t.queue.push({t:`chip`,idx:n.idx,n:r,chips:Math.min(n.chips,n.facetMax),facetMax:n.facetMax});n.chips>=n.facetMax&&n.hp>0;)n.chips-=n.facetMax,Jh(e,t,n)}function Jh(e,t,n){if(n.facetMax+=1,n.flags.adamant&&!n.flags.adamantSpent){n.flags.adamantSpent=!0,t.queue.push({t:`adamantHold`,idx:n.idx});return}e.stats.shatters++,n.flags.staggered=!0,t.queue.push({t:`shatter`,idx:n.idx,facetMax:n.facetMax}),Uh(t,n,`vulnerable`,2),Kh(e,t,2),ph(e,`prismCharm`)&&!t.prismProcd&&(t.prismProcd=!0,Kh(e,t,2),Hh(t,`prismCharm`));let r=n.statuses.poison||0;if(r&&t.enemies.some(e=>e!==n&&e.hp>0)&&(delete n.statuses.poison,Yh(e,t,n,r)),ph(e,`bellOfEndings`)){Hh(t,`bellOfEndings`);for(let r of t.enemies.filter(e=>e!==n&&e.hp>0)){if(t.over)break;ng(e,t,r,4,{isAttack:!1})}}}function Yh(e,t,n,r){if(!r)return;let i=t.enemies.filter(e=>e!==n&&e.hp>0);if(!i.length)return;let a=Qm(ch(e),i);Uh(t,a,`poison`,r),t.queue.push({t:`smolderJump`,from:n.idx,to:a.idx,n:r})}function Xh(e,t){let n=Hu[e.art];return!!n&&!t.over&&t.artUsedTurn!==t.turn&&t.embers>=n.cost}function Zh(e,t){if(!Xh(e,t))return!1;let n=Hu[e.art];t.artUsedTurn=t.turn,e.stats.embersSpent+=n.cost,Kh(e,t,-n.cost),t.queue.push({t:`art`,id:e.art});for(let r of n.effects){if(t.over)break;Qh(e,t,r)}return!0}function Qh(e,t,n){let r=t.player,i=()=>t.enemies.filter(e=>e.hp>0);switch(n.kind){case`dmg`:for(let r of i())t.over||ng(e,t,r,n.n,{isAttack:!1});break;case`status`:if(n.who===`self`)Uh(t,r,n.id,n.n);else for(let e of i())Uh(t,e,n.id,n.n);break;case`block`:ag(e,t,r,n.n,!1);break;case`heal`:_h(e,n.n,t);break;case`energy`:r.energy+=n.n,t.queue.push({t:`energy`,n:r.energy});break;case`draw`:og(e,t,n.n);break;case`chip`:for(let r of i())qh(e,t,r,n.n);break;case`ember`:Kh(e,t,n.n);break}}function $h(e,t,n){return!n||t.over||sh(n).type===`curse`?!1:!(t.kindledTurn===t.turn&&t.kindlesThisTurn>=eg(e))}function eg(e){return ph(e,`crownOfTithes`)?2:1}function tg(e,t,n){let r=t.hand.findIndex(e=>e.uid===n);if(r<0)return!1;let i=t.hand[r];return $h(e,t,i)?(t.kindledTurn!==t.turn&&(t.kindledTurn=t.turn,t.kindlesThisTurn=0),t.kindlesThisTurn++,t.hand.splice(r,1),e.stats.kindles++,t.queue.push({t:`kindle`,uid:i.uid,id:i.id}),sg(e,t,i),ph(e,`crownOfTithes`)&&(ag(e,t,t.player,3,!1),Hh(t,`crownOfTithes`)),!0):!1}function ng(e,t,n,r,{isAttack:i=!0,mult:a=1}={}){if(n.hp<=0||t.over)return 0;let o=t.player,s=r;i&&(s+=o.statuses.str||0,o.statuses.weak&&(s=Math.floor(s*.75)),n.statuses.vulnerable&&(s=Math.floor(s*1.5))),s=Math.max(0,Math.floor(s*a));let c=Math.min(n.block,s);n.block-=c;let l=s-c;if(n.hp-=l,e.stats.dmgDealt+=l,t.queue.push({t:`hitEnemy`,idx:n.idx,amount:l,blocked:c,hpAfter:Math.max(0,n.hp),dead:n.hp<=0,killingBlow:n.hp<=0&&l>0,overkill:Math.max(0,-n.hp)}),t.pendingChips&&i&&l>0){let e=t.pendingChips.get(n.idx)||{hit:!1,extra:0};e.hit=!0,t.pendingChips.set(n.idx,e)}return i&&n.statuses.thorns&&n.hp>0&&ig(e,t,n.statuses.thorns,{source:`thorns`,isAttack:!1}),n.hp<=0&&rg(e,t,n),l}function rg(e,t,n){n.hp=0;let r=n.statuses.poison||0;if(n.statuses={},n.flags.staggered=!1,t.queue.push({t:`die`,idx:n.idx}),e.stats.slain++,n.elite&&e.stats.elites++,n.boss&&e.stats.bosses++,t.enemies.every(e=>e.hp<=0)){gg(e,t);return}Kh(e,t,1),Yh(e,t,n,r),ph(e,`reapersBell`)&&(t.player.energy+=1,og(e,t,1),Hh(t,`reapersBell`),t.queue.push({t:`energy`,n:t.player.energy}))}function ig(e,t,n,{source:r=`self`,isAttack:i=!1,attacker:a=null}={}){if(t.over)return 0;let o=t.player,s=n;i&&a&&(s+=(a.statuses.str||0)+(a.flags.rampBonus||0)+(ih(e).enemyDmgBonus||0)+(nh(e).enemyDmgBonus||0),a.statuses.weak&&(s=Math.floor(s*.75)),o.statuses.vulnerable&&(s=Math.floor(s*1.5)),ph(e,`wardingCharm`)&&s<=5&&s>0&&(s=1,Hh(t,`wardingCharm`))),s=Math.max(0,s);let c=0;(i||r===`thorns`)&&(c=Math.min(o.block,s),o.block-=c);let l=s-c;if(o.hp-=l,e.stats.dmgTaken+=Math.max(0,l),t.counters.hpLost+=Math.max(0,l),t.queue.push({t:`hitPlayer`,amount:l,blocked:c,hpAfter:Math.max(0,o.hp),source:r}),o.hp<=0)return _g(e,t),l;if(i&&a){let n={...ih(e).playerHitApplies||{},...t.affix&&Vu[t.affix].mods.attackApplies||{}};for(let[e,r]of Object.entries(n))Uh(t,o,e,r);o.statuses.thorns&&a.hp>0&&ng(e,t,a,o.statuses.thorns,{isAttack:!1})}return l}function ag(e,t,n,r,i=!0){let a=r;return n===t.player&&i&&(a+=n.statuses.dex||0,n.statuses.frail&&(a=Math.floor(a*.75))),a=Math.round(Math.max(0,a)*(ih(e).wardMult||1)),n.block+=a,t.queue.push({t:`blockGain`,who:n===t.player?`player`:n.idx,n:a,total:n.block}),a}function og(e,t,n){let r=ch(e);for(let e=0;e<n&&!(t.hand.length>=10);e++){if(!t.draw.length){if(!t.discard.length)break;let e=t.discard.length;t.draw=t.discard,t.discard=[],Vh(r,t.draw),t.queue.push({t:`reshuffle`,n:e})}let e=t.draw.pop();t.hand.push(e),t.queue.push({t:`draw`,uid:e.uid,id:e.id})}}function sg(e,t,n){t.exhaust.push(n),t.queue.push({t:`exhaust`,uid:n.uid}),Kh(e,t,1),ph(e,`verdantBranch`)&&(og(e,t,1),Hh(t,`verdantBranch`))}function cg(e,t){if(t.over)return;t.turn++;let n=t.player;if(t.queue.push({t:`turn`,n:t.turn}),n.statuses.poison&&(ig(e,t,n.statuses.poison,{source:`poison`}),n.statuses.poison--,n.statuses.poison||delete n.statuses.poison,t.over))return;n.statuses.barricade||(n.block=0),n.statuses.ritual&&Uh(t,n,`str`,n.statuses.ritual),n.statuses.emberflow&&Kh(e,t,n.statuses.emberflow);let r=n.energyMax+(n.statuses.energized||0);t.turn===1&&ph(e,`emberLantern`)&&(r+=1,Hh(t,`emberLantern`)),n.energy=(ph(e,`frozenCore`)?n.energy:0)+r,t.counters.firstCardPlayed=!1,t.queue.push({t:`energy`,n:n.energy});let i=5+(n.statuses.nightsight||0)+(ih(e).drawDelta||0);t.turn===1&&ph(e,`travelersPack`)&&(i+=2,Hh(t,`travelersPack`)),og(e,t,Math.max(1,i))}function lg(e,t,n){let r=sh(n);return r.cost==null?null:ph(e,`duskmirror`)&&!t.counters.firstCardPlayed?0:ih(e).firstCardDiscount&&!t.counters.firstCardPlayed?Math.max(0,r.cost-ih(e).firstCardDiscount):r.cost}function ug(e,t,n,r){if(t.over)return!1;let i=sh(n);return!(i.unplayable||lg(e,t,n)>t.player.energy||i.target===`enemy`&&(r==null||!t.enemies[r]||t.enemies[r].hp<=0))}function dg(e,t,n,r=null){let i=t.hand.findIndex(e=>e.uid===n);if(i<0)return!1;let a=t.hand[i],o=sh(a);if(!ug(e,t,a,r))return!1;let s=t.player,c=lg(e,t,a);s.energy-=c,ph(e,`duskmirror`)&&!t.counters.firstCardPlayed&&o.cost>0&&Hh(t,`duskmirror`),t.counters.firstCardPlayed=!0,t.hand.splice(i,1),t.counters.played++,e.stats.cardsPlayed++,t.queue.push({t:`play`,uid:a.uid,id:a.id,targetIdx:r}),t.queue.push({t:`energy`,n:s.energy});let l=1;o.type===`attack`&&(t.counters.attacks++,ph(e,`ironTalisman`)&&t.counters.attacks%3==0&&(Uh(t,s,`str`,1),Hh(t,`ironTalisman`)),ph(e,`executionersSeal`)&&t.counters.attacks%10==0&&(l=2,Hh(t,`executionersSeal`)));let u=r==null?null:t.enemies[r],d=()=>t.enemies.filter(e=>e.hp>0);t.pendingChips=new Map;for(let n of o.effects){if(t.over)break;fg(e,t,a,o,n,u,l)}if(t.pendingChips&&!t.over){let n=o.type===`attack`?1+(o.chip||0)+(s.statuses.beacon||0):0;for(let[r,i]of t.pendingChips){let a=t.enemies[r];if(!a||a.hp<=0||t.over)continue;let o=(i.hit?n:0)+i.extra;o>0&&qh(e,t,a,o)}}if(t.pendingChips=null,!t.over&&o.type===`attack`&&s.statuses.venomous){let e=o.target===`allEnemies`?d():u&&u.hp>0?[u]:[];for(let n of e)Uh(t,n,`poison`,s.statuses.venomous)}return!t.over&&ph(e,`silkFan`)&&t.counters.played%3==0&&(ag(e,t,s,3,!1),Hh(t,`silkFan`)),o.type===`power`?t.queue.push({t:`powerConsumed`,uid:a.uid}):o.exhaust?sg(e,t,a):(t.discard.push(a),t.queue.push({t:`toDiscard`,uid:a.uid})),!0}function fg(e,t,n,r,i,a,o){let s=t.player,c=r.target===`allEnemies`?t.enemies.filter(e=>e.hp>0):a?[a]:[];switch(i.kind){case`dmg`:{let n=i.times||1;for(let a=0;a<n;a++)for(let n of r.target===`allEnemies`?t.enemies.filter(e=>e.hp>0):c){if(t.over)return;ng(e,t,n,i.n,{mult:o})}break}case`block`:ag(e,t,s,i.n);break;case`draw`:og(e,t,i.n);break;case`energy`:s.energy+=i.n,t.queue.push({t:`energy`,n:s.energy});break;case`heal`:_h(e,i.n,t);break;case`loseHp`:ig(e,t,i.n,{source:`self`});break;case`status`:if(i.who===`self`)Uh(t,s,i.id,i.n);else if(i.who===`allEnemies`)for(let e of t.enemies.filter(e=>e.hp>0))Uh(t,e,i.id,i.n);else a&&a.hp>0&&Uh(t,a,i.id,i.n);break;case`addCard`:for(let n=0;n<(i.n||1);n++){let n={uid:e.uid++,id:i.id,up:!1,bonus:0};(i.where===`hand`&&t.hand.length<10?t.hand:t.discard).push(n),t.queue.push({t:`addCard`,id:i.id,where:i.where||`discard`})}break;case`chip`:for(let n of c)if(!(n.hp<=0))if(t.pendingChips){let e=t.pendingChips.get(n.idx)||{hit:!1,extra:0};e.extra+=i.n,t.pendingChips.set(n.idx,e)}else qh(e,t,n,i.n);break;case`ember`:Kh(e,t,i.n);break;case`special`:pg(e,t,n,r,i,a,o)}}function pg(e,t,n,r,i,a,o){let s=t.player;switch(i.id){case`leech`:{let n=ng(e,t,a,i.n,{mult:o});n>0&&_h(e,Math.floor(n/2),t);break}case`execute`:{let n=a.statuses.vulnerable?i.bonus:0;ng(e,t,a,i.n+n,{mult:o});break}case`momentum`:ng(e,t,a,i.n+n.bonus,{mult:o}),n.bonus+=i.grow;break;case`phantom`:ng(e,t,a,i.n*t.hand.length,{mult:o});break;case`devour`:ng(e,t,a,i.n,{mult:o}),a.hp<=0&&(t.over?_h(e,i.heal):(Kh(e,t,i.embers),_h(e,i.heal,t)));break;case`doubleBlock`:ag(e,t,s,s.block,!1);break;case`catalyst`:a.statuses.poison&&Uh(t,a,`poison`,a.statuses.poison*(i.n-1));break;case`shatterEcho`:{let n=a.flags.staggered||a.statuses.vulnerable?2:1;ng(e,t,a,i.n*n,{mult:o});break}case`emberNova`:ng(e,t,a,i.n*t.embers,{mult:o});break;case`pyreTithe`:for(let r of[...t.hand]){if(r===n)continue;let i=t.hand.indexOf(r);t.hand.splice(i,1),t.queue.push({t:`kindle`,uid:r.uid,id:r.id}),sg(e,t,r)}og(e,t,i.draw);break;case`flawless`:ag(e,t,s,i.n),t.counters.hpLost===0&&ag(e,t,s,i.n);break;case`emberdance`:{let n=t.embers;n>0&&(e.stats.embersSpent+=n,Kh(e,t,-n),ag(e,t,s,i.n*n,!1));break}}}function mg(e,t,n,r=null){let i=e.player.potions[n];if(!i)return!1;let a=Pu[i];if(a.combatOnly&&(!t||t.over)||a.needsTarget&&(r==null||!t.enemies[r]||t.enemies[r].hp<=0))return!1;switch(e.player.potions[n]=null,t&&t.queue.push({t:`potion`,id:i}),i){case`healing`:_h(e,20,t),t||(e.player.hp=eh(e.player.hp,0,e.player.maxHp));break;case`strength`:Uh(t,t.player,`str`,2);break;case`swift`:og(e,t,3);break;case`block`:ag(e,t,t.player,12,!1);break;case`fire`:ng(e,t,t.enemies[r],20,{isAttack:!1});break;case`venom`:Uh(t,t.enemies[r],`poison`,7);break;case`energy`:Kh(e,t,3);break}return!0}function hg(e,t){if(t.over)return;let n=t.player;t.queue.push({t:`endTurn`});for(let n of[...t.hand]){let r=sh(n);if(r.endTurnDmg&&ig(e,t,r.endTurnDmg,{source:`burn`}),r.endTurnLoseHp&&ig(e,t,r.endTurnLoseHp,{source:`burn`}),t.over)return}n.statuses.metallicize&&ag(e,t,n,n.statuses.metallicize,!1),n.statuses.regen&&_h(e,n.statuses.regen,t);let r=t.hand.map(e=>e.uid);t.discard.push(...t.hand),t.hand=[],t.queue.push({t:`discardHand`,uids:r});for(let e of[`vulnerable`,`weak`,`frail`,`beacon`])n.statuses[e]&&(n.statuses[e]--,n.statuses[e]||delete n.statuses[e]);for(let r of t.enemies)if(!(r.hp<=0||t.over)){if(r.statuses.poison){let n=r.statuses.poison;if(r.hp-=n,e.stats.dmgDealt+=n,t.queue.push({t:`hitEnemy`,idx:r.idx,amount:n,blocked:0,hpAfter:Math.max(0,r.hp),dead:r.hp<=0,poison:!0}),r.statuses.poison--,r.statuses.poison||delete r.statuses.poison,r.hp<=0){e.stats.smolderKills++,rg(e,t,r);continue}}if(r.block=0,r.flags.staggered)r.flags.staggered=!1,r.lastMoves.push(r.moveKey),t.queue.push({t:`staggered`,idx:r.idx});else{let i=Gh(r);if(t.queue.push({t:`enemyAct`,idx:r.idx,move:r.moveKey,name:i.name}),r.lastMoves.push(r.moveKey),i.dmg!=null){for(let n=0;n<(i.times||1)&&!t.over;n++)ig(e,t,i.dmg,{source:r.idx,isAttack:!0,attacker:r});i.ramp&&(r.flags.rampBonus=(r.flags.rampBonus||0)+i.ramp)}if(t.over)return;if(i.block&&ag(e,t,r,i.block,!1),i.heal&&(r.hp=Math.min(r.maxHp,r.hp+i.heal),t.queue.push({t:`heal`,who:r.idx,n:i.heal})),i.fx){for(let e of i.fx)if(e.who===`player`)Uh(t,n,e.id,e.n);else if(e.who===`self`)Uh(t,r,e.id,e.n);else if(e.who===`allies`)for(let n of t.enemies.filter(e=>e.hp>0))Uh(t,n,e.id,e.n)}if(i.addCards)for(let n=0;n<i.addCards.n;n++)t.discard.push({uid:e.uid++,id:i.addCards.id,up:!1,bonus:0}),t.queue.push({t:`addCard`,id:i.addCards.id,where:`discard`})}r.statuses.ritual&&Uh(t,r,`str`,r.statuses.ritual);for(let e of[`vulnerable`,`weak`])r.statuses[e]&&(r.statuses[e]--,r.statuses[e]||delete r.statuses[e])}t.over||(Wh(e,t),cg(e,t))}function gg(e,t){t.over=!0,t.result=`win`,e.player.hp=eh(t.player.hp,1,e.player.maxHp),ph(e,`emberHeart`)&&(_h(e,6),Hh(t,`emberHeart`)),ph(e,`crownOfTheHearth`)&&t.embers>0&&(_h(e,t.embers*3),Hh(t,`crownOfTheHearth`)),ph(e,`gravebloom`)&&e.player.hp<=e.player.maxHp*.5&&(_h(e,10),Hh(t,`gravebloom`)),e.player.hp=eh(e.player.hp,1,e.player.maxHp),t.queue.push({t:`victory`,perfect:t.counters.hpLost===0})}function _g(e,t){t.over=!0,t.result=`loss`,t.player.hp=0,e.player.hp=0,t.queue.push({t:`defeat`})}function vg(e,t,n=null){let r=e.player,i=t+(r.statuses.str||0);r.statuses.weak&&(i=Math.floor(i*.75));let a=n==null?null:e.enemies[n];return a&&a.statuses.vulnerable&&(i=Math.floor(i*1.5)),Math.max(0,i)}function yg(e,t,n){let r=t.player,i=n+(r.statuses.dex||0);return r.statuses.frail&&(i=Math.floor(i*.75)),Math.round(Math.max(0,i)*(ih(e).wardMult||1))}function bg(e,t,n){let r=Gh(n);if(r.dmg==null)return null;let i=r.dmg+(n.statuses.str||0)+(n.flags.rampBonus||0)+(ih(e).enemyDmgBonus||0)+(nh(e).enemyDmgBonus||0);return n.statuses.weak&&(i=Math.floor(i*.75)),t.player.statuses.vulnerable&&(i=Math.floor(i*1.5)),{dmg:Math.max(0,i),times:r.times||1}}function xg(e,t,n,r=null){let i=sh(n),a=t.player,o=r==null?null:t.enemies[r],s=ph(e,`executionersSeal`)&&i.type===`attack`&&(t.counters.attacks+1)%10==0?2:1,c=e=>{let t=e+(a.statuses.str||0);return a.statuses.weak&&(t=Math.floor(t*.75)),o&&o.statuses.vulnerable&&(t=Math.floor(t*1.5)),Math.max(0,Math.floor(t*s))},l=[],u=0;for(let r of i.effects)r.kind===`dmg`?l.push({dmg:c(r.n),times:r.times||1}):r.kind===`block`?u+=yg(e,t,r.n):r.kind===`special`&&(r.id===`leech`||r.id===`devour`?l.push({dmg:c(r.n),times:1}):r.id===`execute`?l.push({dmg:c(r.n+(o?.statuses.vulnerable?r.bonus:0)),times:1}):r.id===`momentum`?l.push({dmg:c(r.n+(n.bonus||0)),times:1}):r.id===`phantom`?l.push({dmg:c(r.n*Math.max(0,t.hand.length-+!!t.hand.includes(n))),times:1}):r.id===`shatterEcho`?l.push({dmg:c(r.n*(o&&(o.flags.staggered||o.statuses.vulnerable)?2:1)),times:1}):r.id===`emberNova`?l.push({dmg:c(r.n*t.embers),times:1}):r.id===`doubleBlock`?u+=a.block:r.id===`flawless`?u+=yg(e,t,r.n)*(t.counters.hpLost===0?2:1):r.id===`emberdance`&&(u+=r.n*t.embers));let d=0;for(let e of i.effects)e.kind===`chip`&&(d+=e.n);if(!l.length&&!u&&!d)return null;let f=l.reduce((e,t)=>e+t.dmg*t.times,0),p=f,m=!1,h=0,g=!1;if(o){let e=o.block;p=0;for(let t of l)for(let n=0;n<t.times;n++){let n=Math.min(e,t.dmg);e-=n,p+=t.dmg-n}m=p>=o.hp;let t=i.type===`attack`?1+(i.chip||0)+(a.statuses.beacon||0):0;h=(l.length&&p>0?t:0)+d,g=h>0&&o.chips+h>=o.facetMax&&!m}return{hits:l,total:f,loss:p,lethal:m,block:u,chips:h,willShatter:g}}function Sg(e,t,n=!1){let r=oh(e,t,n);return e.player.deck.push(r),r}function Cg(e,t){let n=e.player.deck.findIndex(e=>e.uid===t);n>=0&&e.player.deck.splice(n,1)}function wg(e,t){let n=e.player.deck.find(e=>e.uid===t);n&&(n.up=!0)}function Tg(e,t){let n=e.player.deck.find(e=>e.uid===t);n&&e.player.deck.push(oh(e,n.id,n.up))}var Eg=`spirebound_save_v2`,Dg=`spirebound_stats_v1`;function Og(e){try{localStorage.setItem(Eg,JSON.stringify(e))}catch{}}function kg(){try{let e=localStorage.getItem(Eg);if(!e)return null;let t=JSON.parse(e);if(!t||t.v!==2||!t.player||!t.map||!t.player.deck.every(e=>ku[e.id])||!t.player.relics.every(e=>Mu[e])||!t.player.potions.every(e=>e==null||Pu[e])||t.art!=null&&!Hu[t.art]||!(t.omens||[]).every(e=>e==null||Bu[e])||(t.art??=`flare`,t.aspect=eh(t.aspect??0,0,qu.length-1),t.vow=eh(t.vow??0,0,Ju.length),t.unlocks??=[],t.omens??=[],t.boon??=null,t.bossRelicAct??=-1,t.orphanRewardClaimed??=!1,t.orphanRewardResolving??=!1,t.reveals??=null,t.reveals!=null&&!(Array.isArray(t.reveals)&&t.reveals.every(e=>Gu.some(t=>t.id===e)))))return null;for(;t.omens.length<=t.act;)t.omens.push(mh(t,`omens`)?rh(t):null);for(let e of[`shatters`,`kindles`,`perfects`,`smolderKills`,`unlitVisited`,`embersSpent`])t.stats[e]??=0;return t}catch{return null}}function Ag(){try{localStorage.removeItem(Eg),localStorage.removeItem(`spirebound_save_v1`)}catch{}}function jg(){try{return JSON.parse(localStorage.getItem(Dg))||{runs:0,wins:0,best:0}}catch{return{runs:0,wins:0,best:0}}}function Mg(e,t){let n=jg();n.runs++,t&&n.wins++,n.best=Math.max(n.best,e.act*15+e.floorsClimbed);try{localStorage.setItem(Dg,JSON.stringify(n))}catch{}Ag()}function Ng(e,t,n=ch(e)){let r=[],i=[];for(let a of t){if(a.gold&&(e.player.gold=Math.max(0,e.player.gold+a.gold),a.gold>0&&(e.stats.goldEarned+=a.gold)),a.hp&&(e.player.hp=eh(e.player.hp+a.hp,1,e.player.maxHp)),a.maxHp&&(e.player.maxHp=Math.max(1,e.player.maxHp+a.maxHp),e.player.hp=eh(e.player.hp+Math.max(0,a.maxHp),1,e.player.maxHp)),a.heal&&_h(e,Math.round(e.player.maxHp*a.heal)),a.addCard&&Sg(e,a.addCard),a.addRelic){let t=a.addRelic===`random`?yh(e):a.addRelic;t?(vh(e,t),i.push({relic:t})):(e.player.gold+=50,i.push({text:`You find 50 gold instead.`}))}if(a.potion&&Mh(e,a.potion),a.pickRemove&&r.push(`remove`),a.pickUpgrade&&r.push(`upgrade`),a.pickDuplicate&&r.push(`duplicate`),a.pickCard&&r.push({pickCard:a.pickCard}),a.roll){let t=n(),o=0;for(let s of a.roll)if(o+=s.p,t<o){i.push({text:s.text});let t=Ng(e,s.ops,n);r.push(...t.pending),i.push(...t.log);break}}}return{pending:r,log:i}}var Pg=`/assets/ashfall-C0Z9oihA.png`,Fg=`/assets/beacon-CfpI4NvN.png`,Ig=`/assets/emberveil-DRPFSPHg.png`,Lg=`/assets/flare-Ca-5NBfJ.png`,Rg=`/assets/mendglass-MxKA-x9I.png`,zg=`/assets/stoke-D5pz9eOt.png`,Bg=`/assets/card-CHxK2GTL.png`,Vg=`/assets/gold-CNm8Tont.png`,Hg=`/assets/relic-Bo0IZDwg.png`,Ug=`/assets/emberFlask-BlP1krpU.png`,Wg=`/assets/fullPurse-DcTqZ-nz.png`,Gg=`/assets/keenEye-DPefaPGL.png`,Kg=`/assets/pilgrimsCache-CsIcQUYT.png`,qg=`/assets/temperedGlass-BVjobJFG.png`,Jg=`/assets/twinPhials-D5-9T5W2.png`,Yg=`/assets/venomPouch-9GhvdgzC.png`,Xg=`/assets/warmHearth-DTnVpfFw.png`,Zg=`/assets/aegis-D665L0sd.jpg`,Qg=`/assets/agility-CUG3xKOo.jpg`,$g=`/assets/annihilate-CXlkbExQ.jpg`,e_=`/assets/ascension-S4GAfpbx.jpg`,t_=`/assets/ashBite-BYzdJfb7.jpg`,n_=`/assets/ashenChoir-DTfq4XXZ.jpg`,r_=`/assets/bastion-CM0wK4Yy.jpg`,i_=`/assets/bloodRite-ou1XgXoc.jpg`,a_=`/assets/brace-Dc4SYgdF.jpg`,o_=`/assets/bulwark-CjEcWZ-i.jpg`,s_=`/assets/burn-DJ4EegTp.jpg`,c_=`/assets/catalyst-ClagfpN0.jpg`,l_=`/assets/chisel-DGrQWYAc.jpg`,u_=`/assets/cleave-CvexqRxg.jpg`,d_=`/assets/cripple-CRxGKuS4.jpg`,f_=`/assets/defend-mmYA7HKX.jpg`,p_=`/assets/deflect-BKgfxyAn.jpg`,m_=`/assets/devour-CST2E0aP.jpg`,h_=`/assets/eclipseSlash-DEA5FgEC.jpg`,g_=`/assets/emberdance-B_CKT6sd.jpg`,__=`/assets/empower-D4P9cm_V.jpg`,v_=`/assets/executioner-BOy4ovki.jpg`,y_=`/assets/firstSpark-BpDCHsPu.jpg`,b_=`/assets/flawlessForm-Di6668jF.jpg`,x_=`/assets/flurry-BgnBaWD-.jpg`,S_=`/assets/fortify-BzU364vJ.jpg`,C_=`/assets/frenzy-qaLdgJOP.jpg`,w_=`/assets/guardedStrike-CesH5DLC.jpg`,T_=`/assets/heavyBlow-XGOXUeSq.jpg`,E_=`/assets/hex-CzQLIJW1.jpg`,D_=`/assets/ironSkin-BOE1a1BZ.jpg`,O_=`/assets/leechBlade-CFp6z-JI.jpg`,k_=`/assets/limitBreak-BU_PNCuK.jpg`,A_=`/assets/lunge-D9lgqjTD.jpg`,j_=`/assets/momentum-Clbqs0on.jpg`,M_=`/assets/nightSight-DuZK4KbA.jpg`,N_=`/assets/novaflare-Dwvtjr_D.jpg`,P_=`/assets/oblivionStrike-CXq1522m.jpg`,F_=`/assets/offering-BaVvule_.jpg`,I_=`/assets/phantomBlades-Bck63olt.jpg`,L_=`/assets/preparation-BkmwWzr3.jpg`,R_=`/assets/pyreheart-Cf86Pj1Y.jpg`,z_=`/assets/quakeblow-DZPTH_O8.jpg`,B_=`/assets/quickSlash-DMRFz6rj.jpg`,V_=`/assets/regrowth-C0gMpqIX.jpg`,H_=`/assets/resonantLance-CCStaA3R.jpg`,U_=`/assets/shardstorm-DIKHFs35.jpg`,W_=`/assets/sidestep-CeDzy6bs.jpg`,G_=`/assets/smother-DFWDS6kH.jpg`,K_=`/assets/strike-DfYIx_7x.jpg`,q_=`/assets/surge-Ci44wXor.jpg`,J_=`/assets/tempest-K9Ub9Fd7.jpg`,Y_=`/assets/tithe-DvZ_GGtQ.jpg`,X_=`/assets/toxicMist-DMOH0JOL.jpg`,Z_=`/assets/twinFangs-C0lavWO6.jpg`,Q_=`/assets/uppercut-CY7mUqmx.jpg`,$_=`/assets/venomStrike-DGTk3cTA.jpg`,ev=`/assets/virulence-vlHxYWHm.jpg`,tv=`/assets/warCry-BO21yVwc.jpg`,nv=`/assets/wound-B5mKVM4_.jpg`,rv=`/assets/ashSermon-CQLTV0YC.png`,iv=`/assets/darkWalker-BcUgRerv.png`,av=`/assets/firstDawn-BGaCCejS.png`,ov=`/assets/hundredShards-BbMyoK2V.png`,sv=`/assets/lanternFed-BdesJDJD.png`,cv=`/assets/paneBreaker-h0dWvGCV.png`,lv=`/assets/spendthrift-OT3LxCNB.png`,uv=`/assets/untouched-Q4-Em2Wy.png`,dv=`/assets/abyssalKnight-BA9qPzL_.png`,fv=`/assets/alphaFang-CYs2MfQS.png`,pv=`/assets/ashAcolyte-W7Bx9eY3.png`,mv=`/assets/chaosHound-Cu1tbGXO.png`,hv=`/assets/deepmaw-BuZMfyUW.png`,gv=`/assets/drownedOne-762yKbrK.png`,_v=`/assets/duskfang-kVQE2Vbx.png`,vv=`/assets/gloomslime-BYNIQKkd.png`,yv=`/assets/gravewarden-CYbqq2Uz.png`,bv=`/assets/heraldOfEnd-B5j76nBL.png`,xv=`/assets/leviathan-DUX2Oy2k.png`,Sv=`/assets/mirelurker-Cs0-ryPe.png`,Cv=`/assets/obsidianGolem-B2_vm835.png`,wv=`/assets/rootheart-CoZqsgKs.png`,Tv=`/assets/shade-cFzxMAwm.png`,Ev=`/assets/shellback-9j9gwuRI.png`,Dv=`/assets/siren-Boj63opF.png`,Ov=`/assets/sovereign-DlFMbPOe.png`,kv=`/assets/sporeling-B8wAP_1e.png`,Av=`/assets/starCultist-DrQ9SosS.png`,jv=`/assets/thornling-BJhkzjJz.png`,Mv=`/assets/tidecaller-C3FvvD8d.png`,Nv=`/assets/voidColossus-D1BBPiCC.png`,Pv=`/assets/voidWisp-DqB4mImW.png`,Fv=`/assets/voltEel-BxcD87LR.png`,Iv=`/assets/watcherEye-Cx0FZXO4.png`,Lv=`/assets/waylayer-DkHd5xp-.png`,Rv=`/assets/cursedIdol--s0qHWso.png`,zv=`/assets/emberFountain-D_Q0157p.png`,Bv=`/assets/fleshTrader-q8lAx2oa.png`,Vv=`/assets/forge-i5xE2DIv.png`,Hv=`/assets/forgottenShrine-CYFo9R9B.png`,Uv=`/assets/gambler-D4lmA3Yw.png`,Wv=`/assets/library-CstvhNks.png`,Gv=`/assets/mirror-Hp5O4ZPJ.png`,Kv=`/assets/ruinedCamp-BvAZgrK0.png`,qv=`/assets/voidChest-B34oBTge.png`,Jv=`/assets/woundedKnight-JN7kYI1u.png`,Yv=`/assets/ashwarden-D21mg7QM.png`,Xv=`/assets/duskblade-DupP5i2p.png`,Zv=`/assets/ascended-BmNUkA_D.png`,Qv=`/assets/fallen-D70fZZUD.png`,$v=`/assets/monument-node-CtuHi8tA.png`,ey=`/assets/ashfall-T4uYvK8I.png`,ty=`/assets/emberWind-Cw83yf4v.png`,ny=`/assets/heavyAir-CjAuZn0d.png`,ry=`/assets/hungryDark-JCDxnDj4.png`,iy=`/assets/longNight-C2g4JuMB.png`,ay=`/assets/thinGlass-CCNgzO1U.png`,oy=`/assets/waningMoon-DyGgMjmd.png`,sy=`/assets/ashes-Cs59Tc_o.png`,cy=`/assets/discard-B0VECG-U.png`,ly=`/assets/draw-dOoxDRW7.png`,uy=`/assets/block-DybnuP3a.png`,dy=`/assets/energy-CWJoumcv.png`,fy=`/assets/fire-Bc2Edgqg.png`,py=`/assets/healing-Bf7MtUhk.png`,my=`/assets/strength-Bp64zOFp.png`,hy=`/assets/swift-Da4aGqnZ.png`,gy=`/assets/venom-DzAfe6ZB.png`,_y=`/assets/campfire-C5hpDY2a.png`,vy=`/assets/chest-open-D2mfQAex.png`,yy=`/assets/chest-Dz-t7vgq.png`,by=`/assets/merchant-CRCPVNlm.png`,xy=`/assets/ashenCore-BHw_xmlT.png`,Sy=`/assets/basaltIdol-BLUsj7rE.png`,Cy=`/assets/bellOfEndings-CMuMud-J.png`,wy=`/assets/crownOfCinders-B4iyR0zw.png`,Ty=`/assets/crownOfTheHearth-Cz96lab0.png`,Ey=`/assets/crownOfTithes-BCSNj05m.png`,Dy=`/assets/duskmirror-ChDahFDy.png`,Oy=`/assets/emberHeart-D8pWC_qd.png`,ky=`/assets/emberLantern-CzFc-ESn.png`,Ay=`/assets/executionersSeal-B-n0EUgT.png`,jy=`/assets/frozenCore-JuT4c4Zg.png`,My=`/assets/gravebloom-CR3cDZz9.png`,Ny=`/assets/hollowCrown-CHl2KxBg.png`,Py=`/assets/ironTalisman-CLgSHgbT.png`,Fy=`/assets/merchantsMark-YaAPSe2m.png`,Iy=`/assets/prismCharm-CWUUYnXM.png`,Ly=`/assets/reapersBell-DK7zj2uj.png`,Ry=`/assets/riverPearl-1k1ZwvLB.png`,zy=`/assets/seersOrb--o7V7uP4.png`,By=`/assets/shatterersCrown-VlDF7CT4.png`,Vy=`/assets/silkFan-Co6ZNxqb.png`,Hy=`/assets/smolderingCoal-ESDuOXE3.png`,Uy=`/assets/sunBlossom-GItTIWOb.png`,Wy=`/assets/sweetRoot-DVIYyMAo.png`,Gy=`/assets/thiefOfWicks-WD5HQJ9E.png`,Ky=`/assets/thornBand-1rbgbbpR.png`,qy=`/assets/travelersPack-Ctq6FXOL.png`,Jy=`/assets/verdantBranch-BpapOPVN.png`,Yy=`/assets/vialOfLife-CqH_Yzkc.png`,Xy=`/assets/warFetish-BphYE_UB.png`,Zy=`/assets/wardingCharm-DcyucUO6.png`,Qy=`/assets/act1-backdrop-CC5kcu8K.png`,$y=`/assets/act1-ledge-Xknu1EDQ.png`,eb=`/assets/act1-mid-B4s3OZuq.png`,tb=`/assets/act2-backdrop-BtpNIaTG.png`,nb=`/assets/act2-ledge-CVAyrxfF.png`,rb=`/assets/act2-mid-BAevK0Pb.png`,ib=`/assets/act3-backdrop-DFsKREnY.png`,ab=`/assets/act3-ledge-DuyDX66N.png`,ob=`/assets/act3-mid-CukJ38oi.png`,sb=`/assets/barricade-TKMR6Ae6.png`,cb=`/assets/beacon-D6Cit09D.png`,lb=`/assets/dex-N8ZMyTH1.png`,ub=`/assets/emberflow-WaDB__mJ.png`,db=`/assets/energized-tpMiHiHG.png`,fb=`/assets/frail-C1xWDqHa.png`,pb=`/assets/metallicize-D8bZ-dPU.png`,mb=`/assets/nightsight-bIBKLafH.png`,hb=`/assets/poison-eOT81JHw.png`,gb=`/assets/rampage-ePkPHo3b.png`,_b=`/assets/regen-3glMdJ9C.png`,vb=`/assets/ritual--xxBwmXw.png`,yb=`/assets/str-BceaR6bB.png`,bb=`/assets/thorns-tG3JnxUb.png`,xb=`/assets/venomous-C-ybwq21.png`,Sb=`/assets/vulnerable-BQp8gTZ1.png`,Cb=`/assets/weak-BVqZWBOd.png`,wb=`/assets/title-BZbtHJmc.png`,Tb=`/assets/background-cEVCcaPg.png`,Eb=`/assets/candle-lit-D_mRgDpv.png`,Db=`/assets/candle-spent-CfNXC6HB.png`,Ob=`/assets/coin-BQjQ5onw.png`,kb=`/assets/deck-CvYhXvwm.png`,Ab=`/assets/end-turn-HdMF__c5.png`,jb=`/assets/facet-chipped-DDSAbh1q.png`,Mb=`/assets/facet-empty-QZk7eMK9.png`,Nb=`/assets/heart-BSYoVjUn.png`,Pb=`/assets/hp-vial-frame-DJr4Zhog.png`,Fb=`/assets/intent-attack-DANp6nBe.png`,Ib=`/assets/intent-block-BG1dKhL5.png`,Lb=`/assets/intent-buff-M0kZuu3S.png`,Rb=`/assets/intent-debuff-hDJICPcw.png`,zb=`/assets/intent-heal-CqiRtmrR.png`,Bb=`/assets/lantern-BxTZNPSF.png`,Vb=`/assets/menu-DFHeKgXq.png`,Hb=`/assets/node-boss-CLpbJCmF.png`,Ub=`/assets/node-elite-Dr8eXEgO.png`,Wb=`/assets/node-event-Dwi1rMhd.png`,Gb=`/assets/node-frame-Bu_aKgqQ.png`,Kb=`/assets/node-monster-C8U1vNJg.png`,qb=`/assets/node-monument-DgqXRiER.png`,Jb=`/assets/node-rest-CbI09k9u.png`,Yb=`/assets/node-shop-CNHOa5VI.png`,Xb=`/assets/node-treasure-BUoWHgzy.png`,Zb=`/assets/node-unlit-JPSMmZu0.png`,Qb=`/assets/ward-BbRNs_RB.png`,$b=`/assets/aegis-BbAK7DRy.png`,ex=`/assets/agility-D28Eu8MG.png`,tx=`/assets/annihilate-M3mspBDm.png`,nx=`/assets/ascension-C2Pll28_.png`,rx=`/assets/ashBite-BBZrYNBt.png`,ix=`/assets/ashenChoir-Cjfn-BY1.png`,ax=`/assets/bastion-D4uvW6Yu.png`,ox=`/assets/bloodRite-xNaIV6FC.png`,sx=`/assets/brace-CDbc3WSx.png`,cx=`/assets/bulwark-DvQ82Xby.png`,lx=`/assets/burn-BVJa4vLy.png`,ux=`/assets/catalyst-C9UJqVfa.png`,dx=`/assets/chisel-BHUdyvP2.png`,fx=`/assets/cleave-Cs444Dst.png`,px=`/assets/cripple-CtSZS_Jx.png`,mx=`/assets/defend-BT8TAbMa.png`,hx=`/assets/deflect-C25gbOwx.png`,gx=`/assets/devour-CXvHmKvA.png`,_x=`/assets/eclipseSlash-B5W8xu8L.png`,vx=`/assets/emberdance-CBOqWIEl.png`,yx=`/assets/empower-DauCte29.png`,bx=`/assets/executioner-DI8vj7EW.png`,xx=`/assets/firstSpark-CaQ5-JAc.png`,Sx=`/assets/flawlessForm-C34QTET6.png`,Cx=`/assets/flurry-D8kOQQ9x.png`,wx=`/assets/fortify-DEACu-Zo.png`,Tx=`/assets/frenzy-BgGGtYpf.png`,Ex=`/assets/guardedStrike-BBAeWagI.png`,Dx=`/assets/heavyBlow-Btb1hEmS.png`,Ox=`/assets/hex-D3QIN_GY.png`,kx=`/assets/ironSkin-DIcLMutG.png`,Ax=`/assets/leechBlade-BgoitLbP.png`,jx=`/assets/limitBreak-D3VHagIC.png`,Mx=`/assets/lunge-BKNULJcP.png`,Nx=`/assets/momentum-D0hGLm2N.png`,Px=`/assets/nightSight-1ggiNsUe.png`,Fx=`/assets/novaflare-BtAOF5B2.png`,Ix=`/assets/oblivionStrike-Ck8D7viT.png`,Lx=`/assets/offering-BDnzVcbS.png`,Rx=`/assets/phantomBlades-CZgzKQZJ.png`,zx=`/assets/preparation-B0_lrDKo.png`,Bx=`/assets/pyreheart-BzRCI95J.png`,Vx=`/assets/quakeblow-DZuM_zei.png`,Hx=`/assets/quickSlash-BHIEN7hF.png`,Ux=`/assets/regrowth-DCr6zV9b.png`,Wx=`/assets/resonantLance-DFyDlcY4.png`,Gx=`/assets/shardstorm-CtSThqM0.png`,Kx=`/assets/sidestep-D-t2UoHV.png`,qx=`/assets/smother-Boa7xrCA.png`,Jx=`/assets/strike-CmEr2qad.png`,Yx=`/assets/surge-D5JDOylt.png`,Xx=`/assets/tempest-DosF7X1A.png`,Zx=`/assets/tithe-BNvDlR3N.png`,Qx=`/assets/toxicMist-BUGxQeK0.png`,$x=`/assets/twinFangs-BUW2V2Kq.png`,eS=`/assets/uppercut-C0A2yndn.png`,tS=`/assets/venomStrike-CXIglW-b.png`,nS=`/assets/virulence-pwX1yrdH.png`,rS=`/assets/warCry-C7Rsrd4u.png`,iS=`/assets/wound-BTcmqSFC.png`,aS=`/assets/abyssalKnight-C-E-itbM.png`,oS=`/assets/alphaFang-DdGpQqF8.png`,sS=`/assets/ashAcolyte-BBrUUe1I.png`,cS=`/assets/chaosHound-D1R2CoW1.png`,lS=`/assets/deepmaw-la4seO5f.png`,uS=`/assets/drownedOne-BUBzJWlu.png`,dS=`/assets/duskfang-CHUmjhPP.png`,fS=`/assets/gloomslime-BNhQuFFa.png`,pS=`/assets/gravewarden-BC9T04oe.png`,mS=`/assets/heraldOfEnd-DZZiCKi_.png`,hS=`/assets/leviathan-BhXEnJxl.png`,gS=`/assets/mirelurker-DidtJkek.png`,_S=`/assets/obsidianGolem-DkurqVoj.png`,vS=`/assets/rootheart-B4o9Bf9P.png`,yS=`/assets/shade-C2XrmBs-.png`,bS=`/assets/shellback-DCHXMl3u.png`,xS=`/assets/siren-GVK3WWGi.png`,SS=`/assets/sovereign-0p3wfa6T.png`,CS=`/assets/sporeling-BeOaEEL0.png`,wS=`/assets/starCultist-DQHXdHm5.png`,TS=`/assets/thornling-CqSviePj.png`,ES=`/assets/tidecaller-tGjufTlQ.png`,DS=`/assets/voidColossus-yr_eofA0.png`,OS=`/assets/voidWisp-D_7XlB9X.png`,kS=`/assets/voltEel-CJeHty9B.png`,AS=`/assets/watcherEye---WypZip.png`,jS=`/assets/waylayer-qynHTjuH.png`,MS=`/assets/cursedIdol--s0qHWso.png`,NS=`/assets/emberFountain-D_Q0157p.png`,PS=`/assets/fleshTrader-q8lAx2oa.png`,FS=`/assets/forge-i5xE2DIv.png`,IS=`/assets/forgottenShrine-CYFo9R9B.png`,LS=`/assets/gambler-D4lmA3Yw.png`,RS=`/assets/library-CstvhNks.png`,zS=`/assets/mirror-Hp5O4ZPJ.png`,BS=`/assets/ruinedCamp-BvAZgrK0.png`,VS=`/assets/voidChest-B34oBTge.png`,HS=`/assets/woundedKnight-JN7kYI1u.png`,US=`/assets/ashwarden-BjFdmgoK.png`,WS=`/assets/duskblade-DBhvpfoa.png`,GS=`/assets/block-CkTqIuTb.png`,KS=`/assets/energy-BNM23nR-.png`,qS=`/assets/fire-CAaEe0xi.png`,JS=`/assets/healing-KDHGTVtG.png`,YS=`/assets/strength-CIdQsSW6.png`,XS=`/assets/swift-xz-qROFX.png`,ZS=`/assets/venom-D3l_eMKx.png`,QS=`/assets/campfire-B-OrO4zT.png`,$S=`/assets/chest-open-B5Uzt-_6.png`,eC=`/assets/chest-b-PO08AA.png`,tC=`/assets/merchant-COlFp5u3.png`,nC=`/assets/background-CqhrXvXS.png`,rC=`candle-lit.candle-spent.facet-empty.facet-chipped.hp-vial-frame.heart.coin.deck.menu.ward.end-turn.lantern.intent-attack.intent-block.intent-buff.intent-debuff.intent-heal.node-frame.node-monster.node-elite.node-event.node-rest.node-shop.node-treasure.node-boss.node-monument.node-unlit`.split(`.`),iC={heart:`heart`,coin:`coin`,deck:`cards`,menu:`menu`,ward:`shield`,lantern:`lantern`,"end-turn":`up`,"facet-empty":`facet`,"facet-chipped":`facet`,"intent-attack":`sword`,"intent-block":`shield`,"intent-buff":`up`,"intent-debuff":`cloud`,"intent-heal":`plus`};function aC(e){return Object.prototype.hasOwnProperty.call(iC,e)?iC[e]:null}function oC(e,t){let n=Math.max(0,Math.floor(Number(e)||0)),r=Math.max(n,Math.max(0,Math.floor(Number(t)||0)));return Array.from({length:r},(e,t)=>t<n?`lit`:`spent`)}function sC(e){let t=String(e||``);if(t===`block`)return[`intent-block`];if(t===`buff`)return[`intent-buff`];if(t===`debuff`)return[`intent-debuff`];if(t===`heal`)return[`intent-heal`];if(t.startsWith(`attack`)){let e=[`intent-attack`];return t===`attack_debuff`&&e.push(`intent-debuff`),t===`attack_block`&&e.push(`intent-block`),t===`attack_buff`&&e.push(`intent-buff`),e}return[`intent-attack`]}function cC(e,t){return t?`node-unlit`:`node-${String(e||`monster`)}`}var lC=Object.assign({"./assets/arts/ashfall.png":Pg,"./assets/arts/beacon.png":Fg,"./assets/arts/emberveil.png":Ig,"./assets/arts/flare.png":Lg,"./assets/arts/mendglass.png":Rg,"./assets/arts/stoke.png":zg,"./assets/bequests/card.png":Bg,"./assets/bequests/gold.png":Vg,"./assets/bequests/relic.png":Hg,"./assets/boons/emberFlask.png":Ug,"./assets/boons/fullPurse.png":Wg,"./assets/boons/keenEye.png":Gg,"./assets/boons/pilgrimsCache.png":Kg,"./assets/boons/temperedGlass.png":qg,"./assets/boons/twinPhials.png":Jg,"./assets/boons/venomPouch.png":Yg,"./assets/boons/warmHearth.png":Xg,"./assets/cards/aegis.jpg":Zg,"./assets/cards/agility.jpg":Qg,"./assets/cards/annihilate.jpg":$g,"./assets/cards/ascension.jpg":e_,"./assets/cards/ashBite.jpg":t_,"./assets/cards/ashenChoir.jpg":n_,"./assets/cards/bastion.jpg":r_,"./assets/cards/bloodRite.jpg":i_,"./assets/cards/brace.jpg":a_,"./assets/cards/bulwark.jpg":o_,"./assets/cards/burn.jpg":s_,"./assets/cards/catalyst.jpg":c_,"./assets/cards/chisel.jpg":l_,"./assets/cards/cleave.jpg":u_,"./assets/cards/cripple.jpg":d_,"./assets/cards/defend.jpg":f_,"./assets/cards/deflect.jpg":p_,"./assets/cards/devour.jpg":m_,"./assets/cards/eclipseSlash.jpg":h_,"./assets/cards/emberdance.jpg":g_,"./assets/cards/empower.jpg":__,"./assets/cards/executioner.jpg":v_,"./assets/cards/firstSpark.jpg":y_,"./assets/cards/flawlessForm.jpg":b_,"./assets/cards/flurry.jpg":x_,"./assets/cards/fortify.jpg":S_,"./assets/cards/frenzy.jpg":C_,"./assets/cards/guardedStrike.jpg":w_,"./assets/cards/heavyBlow.jpg":T_,"./assets/cards/hex.jpg":E_,"./assets/cards/ironSkin.jpg":D_,"./assets/cards/leechBlade.jpg":O_,"./assets/cards/limitBreak.jpg":k_,"./assets/cards/lunge.jpg":A_,"./assets/cards/momentum.jpg":j_,"./assets/cards/nightSight.jpg":M_,"./assets/cards/novaflare.jpg":N_,"./assets/cards/oblivionStrike.jpg":P_,"./assets/cards/offering.jpg":F_,"./assets/cards/phantomBlades.jpg":I_,"./assets/cards/preparation.jpg":L_,"./assets/cards/pyreheart.jpg":R_,"./assets/cards/quakeblow.jpg":z_,"./assets/cards/quickSlash.jpg":B_,"./assets/cards/regrowth.jpg":V_,"./assets/cards/resonantLance.jpg":H_,"./assets/cards/shardstorm.jpg":U_,"./assets/cards/sidestep.jpg":W_,"./assets/cards/smother.jpg":G_,"./assets/cards/strike.jpg":K_,"./assets/cards/surge.jpg":q_,"./assets/cards/tempest.jpg":J_,"./assets/cards/tithe.jpg":Y_,"./assets/cards/toxicMist.jpg":X_,"./assets/cards/twinFangs.jpg":Z_,"./assets/cards/uppercut.jpg":Q_,"./assets/cards/venomStrike.jpg":$_,"./assets/cards/virulence.jpg":ev,"./assets/cards/warCry.jpg":tv,"./assets/cards/wound.jpg":nv,"./assets/deeds/ashSermon.png":rv,"./assets/deeds/darkWalker.png":iv,"./assets/deeds/firstDawn.png":av,"./assets/deeds/hundredShards.png":ov,"./assets/deeds/lanternFed.png":sv,"./assets/deeds/paneBreaker.png":cv,"./assets/deeds/spendthrift.png":lv,"./assets/deeds/untouched.png":uv,"./assets/enemies/abyssalKnight.png":dv,"./assets/enemies/alphaFang.png":fv,"./assets/enemies/ashAcolyte.png":pv,"./assets/enemies/chaosHound.png":mv,"./assets/enemies/deepmaw.png":hv,"./assets/enemies/drownedOne.png":gv,"./assets/enemies/duskfang.png":_v,"./assets/enemies/gloomslime.png":vv,"./assets/enemies/gravewarden.png":yv,"./assets/enemies/heraldOfEnd.png":bv,"./assets/enemies/leviathan.png":xv,"./assets/enemies/mirelurker.png":Sv,"./assets/enemies/obsidianGolem.png":Cv,"./assets/enemies/rootheart.png":wv,"./assets/enemies/shade.png":Tv,"./assets/enemies/shellback.png":Ev,"./assets/enemies/siren.png":Dv,"./assets/enemies/sovereign.png":Ov,"./assets/enemies/sporeling.png":kv,"./assets/enemies/starCultist.png":Av,"./assets/enemies/thornling.png":jv,"./assets/enemies/tidecaller.png":Mv,"./assets/enemies/voidColossus.png":Nv,"./assets/enemies/voidWisp.png":Pv,"./assets/enemies/voltEel.png":Fv,"./assets/enemies/watcherEye.png":Iv,"./assets/enemies/waylayer.png":Lv,"./assets/events/cursedIdol.png":Rv,"./assets/events/emberFountain.png":zv,"./assets/events/fleshTrader.png":Bv,"./assets/events/forge.png":Vv,"./assets/events/forgottenShrine.png":Hv,"./assets/events/gambler.png":Uv,"./assets/events/library.png":Wv,"./assets/events/mirror.png":Gv,"./assets/events/ruinedCamp.png":Kv,"./assets/events/voidChest.png":qv,"./assets/events/woundedKnight.png":Jv,"./assets/heroes/ashwarden.png":Yv,"./assets/heroes/duskblade.png":Xv,"./assets/meta/ascended.png":Zv,"./assets/meta/fallen.png":Qv,"./assets/meta/monument-node.png":$v,"./assets/omens/ashfall.png":ey,"./assets/omens/emberWind.png":ty,"./assets/omens/heavyAir.png":ny,"./assets/omens/hungryDark.png":ry,"./assets/omens/longNight.png":iy,"./assets/omens/thinGlass.png":ay,"./assets/omens/waningMoon.png":oy,"./assets/piles/ashes.png":sy,"./assets/piles/discard.png":cy,"./assets/piles/draw.png":ly,"./assets/potions/block.png":uy,"./assets/potions/energy.png":dy,"./assets/potions/fire.png":fy,"./assets/potions/healing.png":py,"./assets/potions/strength.png":my,"./assets/potions/swift.png":hy,"./assets/potions/venom.png":gy,"./assets/props/campfire.png":_y,"./assets/props/chest-open.png":vy,"./assets/props/chest.png":yy,"./assets/props/merchant.png":by,"./assets/relics/ashenCore.png":xy,"./assets/relics/basaltIdol.png":Sy,"./assets/relics/bellOfEndings.png":Cy,"./assets/relics/crownOfCinders.png":wy,"./assets/relics/crownOfTheHearth.png":Ty,"./assets/relics/crownOfTithes.png":Ey,"./assets/relics/duskmirror.png":Dy,"./assets/relics/emberHeart.png":Oy,"./assets/relics/emberLantern.png":ky,"./assets/relics/executionersSeal.png":Ay,"./assets/relics/frozenCore.png":jy,"./assets/relics/gravebloom.png":My,"./assets/relics/hollowCrown.png":Ny,"./assets/relics/ironTalisman.png":Py,"./assets/relics/merchantsMark.png":Fy,"./assets/relics/prismCharm.png":Iy,"./assets/relics/reapersBell.png":Ly,"./assets/relics/riverPearl.png":Ry,"./assets/relics/seersOrb.png":zy,"./assets/relics/shatterersCrown.png":By,"./assets/relics/silkFan.png":Vy,"./assets/relics/smolderingCoal.png":Hy,"./assets/relics/sunBlossom.png":Uy,"./assets/relics/sweetRoot.png":Wy,"./assets/relics/thiefOfWicks.png":Gy,"./assets/relics/thornBand.png":Ky,"./assets/relics/travelersPack.png":qy,"./assets/relics/verdantBranch.png":Jy,"./assets/relics/vialOfLife.png":Yy,"./assets/relics/warFetish.png":Xy,"./assets/relics/wardingCharm.png":Zy,"./assets/stage/act1-backdrop.png":Qy,"./assets/stage/act1-ledge.png":$y,"./assets/stage/act1-mid.png":eb,"./assets/stage/act2-backdrop.png":tb,"./assets/stage/act2-ledge.png":nb,"./assets/stage/act2-mid.png":rb,"./assets/stage/act3-backdrop.png":ib,"./assets/stage/act3-ledge.png":ab,"./assets/stage/act3-mid.png":ob,"./assets/statuses/barricade.png":sb,"./assets/statuses/beacon.png":cb,"./assets/statuses/dex.png":lb,"./assets/statuses/emberflow.png":ub,"./assets/statuses/energized.png":db,"./assets/statuses/frail.png":fb,"./assets/statuses/metallicize.png":pb,"./assets/statuses/nightsight.png":mb,"./assets/statuses/poison.png":hb,"./assets/statuses/rampage.png":gb,"./assets/statuses/regen.png":_b,"./assets/statuses/ritual.png":vb,"./assets/statuses/str.png":yb,"./assets/statuses/thorns.png":bb,"./assets/statuses/venomous.png":xb,"./assets/statuses/vulnerable.png":Sb,"./assets/statuses/weak.png":Cb,"./assets/title/title.png":wb,"./assets/title-background/background.png":Tb,"./assets/ui/candle-lit.png":Eb,"./assets/ui/candle-spent.png":Db,"./assets/ui/coin.png":Ob,"./assets/ui/deck.png":kb,"./assets/ui/end-turn.png":Ab,"./assets/ui/facet-chipped.png":jb,"./assets/ui/facet-empty.png":Mb,"./assets/ui/heart.png":Nb,"./assets/ui/hp-vial-frame.png":Pb,"./assets/ui/intent-attack.png":Fb,"./assets/ui/intent-block.png":Ib,"./assets/ui/intent-buff.png":Lb,"./assets/ui/intent-debuff.png":Rb,"./assets/ui/intent-heal.png":zb,"./assets/ui/lantern.png":Bb,"./assets/ui/menu.png":Vb,"./assets/ui/node-boss.png":Hb,"./assets/ui/node-elite.png":Ub,"./assets/ui/node-event.png":Wb,"./assets/ui/node-frame.png":Gb,"./assets/ui/node-monster.png":Kb,"./assets/ui/node-monument.png":qb,"./assets/ui/node-rest.png":Jb,"./assets/ui/node-shop.png":Yb,"./assets/ui/node-treasure.png":Xb,"./assets/ui/node-unlit.png":Zb,"./assets/ui/ward.png":Qb,"./assets-legacy/cards/aegis.png":$b,"./assets-legacy/cards/agility.png":ex,"./assets-legacy/cards/annihilate.png":tx,"./assets-legacy/cards/ascension.png":nx,"./assets-legacy/cards/ashBite.png":rx,"./assets-legacy/cards/ashenChoir.png":ix,"./assets-legacy/cards/bastion.png":ax,"./assets-legacy/cards/bloodRite.png":ox,"./assets-legacy/cards/brace.png":sx,"./assets-legacy/cards/bulwark.png":cx,"./assets-legacy/cards/burn.png":lx,"./assets-legacy/cards/catalyst.png":ux,"./assets-legacy/cards/chisel.png":dx,"./assets-legacy/cards/cleave.png":fx,"./assets-legacy/cards/cripple.png":px,"./assets-legacy/cards/defend.png":mx,"./assets-legacy/cards/deflect.png":hx,"./assets-legacy/cards/devour.png":gx,"./assets-legacy/cards/eclipseSlash.png":_x,"./assets-legacy/cards/emberdance.png":vx,"./assets-legacy/cards/empower.png":yx,"./assets-legacy/cards/executioner.png":bx,"./assets-legacy/cards/firstSpark.png":xx,"./assets-legacy/cards/flawlessForm.png":Sx,"./assets-legacy/cards/flurry.png":Cx,"./assets-legacy/cards/fortify.png":wx,"./assets-legacy/cards/frenzy.png":Tx,"./assets-legacy/cards/guardedStrike.png":Ex,"./assets-legacy/cards/heavyBlow.png":Dx,"./assets-legacy/cards/hex.png":Ox,"./assets-legacy/cards/ironSkin.png":kx,"./assets-legacy/cards/leechBlade.png":Ax,"./assets-legacy/cards/limitBreak.png":jx,"./assets-legacy/cards/lunge.png":Mx,"./assets-legacy/cards/momentum.png":Nx,"./assets-legacy/cards/nightSight.png":Px,"./assets-legacy/cards/novaflare.png":Fx,"./assets-legacy/cards/oblivionStrike.png":Ix,"./assets-legacy/cards/offering.png":Lx,"./assets-legacy/cards/phantomBlades.png":Rx,"./assets-legacy/cards/preparation.png":zx,"./assets-legacy/cards/pyreheart.png":Bx,"./assets-legacy/cards/quakeblow.png":Vx,"./assets-legacy/cards/quickSlash.png":Hx,"./assets-legacy/cards/regrowth.png":Ux,"./assets-legacy/cards/resonantLance.png":Wx,"./assets-legacy/cards/shardstorm.png":Gx,"./assets-legacy/cards/sidestep.png":Kx,"./assets-legacy/cards/smother.png":qx,"./assets-legacy/cards/strike.png":Jx,"./assets-legacy/cards/surge.png":Yx,"./assets-legacy/cards/tempest.png":Xx,"./assets-legacy/cards/tithe.png":Zx,"./assets-legacy/cards/toxicMist.png":Qx,"./assets-legacy/cards/twinFangs.png":$x,"./assets-legacy/cards/uppercut.png":eS,"./assets-legacy/cards/venomStrike.png":tS,"./assets-legacy/cards/virulence.png":nS,"./assets-legacy/cards/warCry.png":rS,"./assets-legacy/cards/wound.png":iS,"./assets-legacy/enemies/abyssalKnight.png":aS,"./assets-legacy/enemies/alphaFang.png":oS,"./assets-legacy/enemies/ashAcolyte.png":sS,"./assets-legacy/enemies/chaosHound.png":cS,"./assets-legacy/enemies/deepmaw.png":lS,"./assets-legacy/enemies/drownedOne.png":uS,"./assets-legacy/enemies/duskfang.png":dS,"./assets-legacy/enemies/gloomslime.png":fS,"./assets-legacy/enemies/gravewarden.png":pS,"./assets-legacy/enemies/heraldOfEnd.png":mS,"./assets-legacy/enemies/leviathan.png":hS,"./assets-legacy/enemies/mirelurker.png":gS,"./assets-legacy/enemies/obsidianGolem.png":_S,"./assets-legacy/enemies/rootheart.png":vS,"./assets-legacy/enemies/shade.png":yS,"./assets-legacy/enemies/shellback.png":bS,"./assets-legacy/enemies/siren.png":xS,"./assets-legacy/enemies/sovereign.png":SS,"./assets-legacy/enemies/sporeling.png":CS,"./assets-legacy/enemies/starCultist.png":wS,"./assets-legacy/enemies/thornling.png":TS,"./assets-legacy/enemies/tidecaller.png":ES,"./assets-legacy/enemies/voidColossus.png":DS,"./assets-legacy/enemies/voidWisp.png":OS,"./assets-legacy/enemies/voltEel.png":kS,"./assets-legacy/enemies/watcherEye.png":AS,"./assets-legacy/enemies/waylayer.png":jS,"./assets-legacy/events/cursedIdol.png":MS,"./assets-legacy/events/emberFountain.png":NS,"./assets-legacy/events/fleshTrader.png":PS,"./assets-legacy/events/forge.png":FS,"./assets-legacy/events/forgottenShrine.png":IS,"./assets-legacy/events/gambler.png":LS,"./assets-legacy/events/library.png":RS,"./assets-legacy/events/mirror.png":zS,"./assets-legacy/events/ruinedCamp.png":BS,"./assets-legacy/events/voidChest.png":VS,"./assets-legacy/events/woundedKnight.png":HS,"./assets-legacy/heroes/ashwarden.png":US,"./assets-legacy/heroes/duskblade.png":WS,"./assets-legacy/potions/block.png":GS,"./assets-legacy/potions/energy.png":KS,"./assets-legacy/potions/fire.png":qS,"./assets-legacy/potions/healing.png":JS,"./assets-legacy/potions/strength.png":YS,"./assets-legacy/potions/swift.png":XS,"./assets-legacy/potions/venom.png":ZS,"./assets-legacy/props/campfire.png":QS,"./assets-legacy/props/chest-open.png":$S,"./assets-legacy/props/chest.png":eC,"./assets-legacy/props/merchant.png":tC,"./assets-legacy/title-background/background.png":nC}),uC=[`png`,`jpg`,`jpeg`,`webp`],dC={live:{label:`Live`,root:`assets`},legacy:{label:`Legacy`,root:`assets-legacy`}},fC=`live`,pC=(e=fC)=>dC[e]??dC[fC],mC=()=>Object.keys(dC),hC=(e=fC)=>pC(e).label,gC=(e,t,n=fC)=>{let{root:r}=pC(n);for(let n of uC){let i=lC[`./${r}/${e}/${t}.${n}`];if(i)return i}return null},_C=(e,t=fC)=>{let{root:n}=pC(t);return Object.entries(lC).filter(([t])=>t.startsWith(`./${n}/${e}/`)).map(([,e])=>e)},vC=0,yC=()=>`g${++vC}`,K=(e,t,n,r=1)=>`hsla(${e},${t}%,${n}%,${r})`;function bC(e,t,n){return`<defs>
    ...
    </g>`}};function TC(e){let t=yC(),n=K(e.hue,90,66),r=SC((wC[e.kind]||wC.slime)(t,e.hue,n));return`<svg class="enemy-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${bC(t,e.hue,n)}
    ...
    ${r}
    <g class="cracks"></g>
  </svg>`}var EC=[{hue:225,glow:`#7fd4ff`},{hue:26,glow:`#ffb15a`}];function DC(e=0){let t=yC(),n=EC[e]||EC[0],r=n.hue,i=n.glow;return`<svg class="hero-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${bC(t,r,i)}
    ...
    <g class="cracks"></g>
  </svg>`}var OC={strike:`⚔`,defend:`⛨`,eclipseSlash:`☾`,twinFangs:`⑂`,quickSlash:`≫`,heavyBlow:`⬇`,cleave:`⋔`,venomStrike:`☠`,lunge:`➹`,guardedStrike:`⛊`,brace:`⛨`,sidestep:`↯`,preparation:`♻`,deflect:`⛉`,leechBlade:`♆`,tempest:`≋`,uppercut:`⇑`,flurry:`⁂`,executioner:`✠`,momentum:`⤴`,bulwark:`☗`,surge:`✦`,toxicMist:`☁`,cripple:`⛓`,warCry:`♯`,fortify:`⧉`,bloodRite:`♥`,empower:`⚔`,agility:`❥`,ironSkin:`⬡`,regrowth:`❋`,oblivionStrike:`✸`,phantomBlades:`⚚`,devour:`♅`,annihilate:`✹`,aegis:`⛨`,offering:`♱`,limitBreak:`⚡`,catalyst:`⚗`,ascension:`☽`,bastion:`♜`,frenzy:`※`,virulence:`☣`,wound:`✂`,burn:`✹`,hex:`♄`,chisel:`◬`,firstSpark:`✧`,ashBite:`☄`,smother:`☁`,quakeblow:`⬲`,resonantLance:`↟`,tithe:`⚖`,pyreheart:`♥`,ashenChoir:`♬`,flawlessForm:`❖`,nightSight:`☾`,novaflare:`✺`,emberdance:`❂`,shardstorm:`❉`},kC=e=>{let t=9;for(let n of e)t=Math.imul(t^n.charCodeAt(0),387420489);return(t^t>>>9)>>>0};function AC(e,t){let n=yC(),r=kC(e),i={attack:356,skill:205,power:268,status:160,curse:300}[t]??205,a=(i+30+r%40)%360,o=K(i,85,66),s=K(a,80,60),c=r%360,l=``;if(t===`attack`)l=`<path d="M30 120 Q75 40 150 28" stroke="${o}" stroke-width="7" fill="none" opacity=".9"/>
      ...
      <path d="M62 106 L118 50" stroke="${s}" stroke-width="5" opacity=".7"/>`;let u=OC[e]||`✦`;return`<svg viewBox="0 0 180 150" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}function jC(e){let t=yC();return`<svg viewBox="0 0 40 52" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function MC(e=!1){let t=yC();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function NC(){let e=yC();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}function PC(){let e=yC();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    ${bC(e,40,`#ffd166`)}
  ...
  </svg>`}function FC(e,t){let n=yC(),r=K(t,80,66);return`<svg viewBox="0 0 220 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}var IC={sword:`<path d="M18.5 5 L10 13.5" stroke-width="3"/><path d="M6.8 11.6 L12.4 17.2" stroke-width="2.2"/><path d="M8.6 15.4 L4.8 19.2" stroke-width="2.6"/>`,skull:`<path d="M12 3.2 a6.8 6.8 0 0 1 6.8 6.8 c0 2.6-1.4 4.4-3 5.5 V18.5 h-7.6 V15.5 c-1.6-1.1-3-2.9-3-5.5 A6.8 6.8 0 0 1 12 3.2 Z" fill="currentColor" stroke="none"/><circle cx="9.4" cy="10" r="1.7" fill="rgba(0,0,0,.8)" stroke="none"/><circle cx="14.6" cy="10" r="1.7" fill="rgba(0,0,0,.8)" stroke="none"/><path d="M10.5 20.8 v-2 M13.5 20.8 v-2" stroke-width="1.8"/>`,crown:`<path d="M4.5 17.5 L5.2 8.5 L9 12 L12 6 L15 12 L18.8 8.5 L19.5 17.5 Z" fill="currentColor" stroke="none"/><path d="M4.5 20 h15" stroke-width="2.2"/>`,chest:`<rect x="4" y="6.5" width="16" height="13" rx="2.2" fill="none" stroke-width="2.2"/><path d="M4 12 h16" stroke-width="1.8"/><rect x="10.4" y="10.2" width="3.2" height="4.4" rx="1" fill="currentColor" stroke="none"/>`,flame:`<path d="M12 2.8 C9.4 7.4 6.8 9.8 6.8 13.6 a5.2 5.2 0 0 0 10.4 0 C17.2 9.8 14.6 7.4 12 2.8 Z" fill="currentColor" stroke="none"/><path d="M12 11.4 c-1.7 2.3-1.7 3.9 0 5.4 1.7-1.5 1.7-3.1 0-5.4 Z" fill="rgba(0,0,0,.5)" stroke="none"/>`,coin:`<circle cx="12" cy="12" r="5.6" fill="none" stroke-width="2.2"/><path d="M5.4 5.4 L8 8 M18.6 5.4 L16 8 M5.4 18.6 L8 16 M18.6 18.6 L16 16" stroke-width="2"/>`,shield:`<path d="M12 2.8 L19 5.8 v5.6 c0 4.6-3.1 7.6-7 9.8 -3.9-2.2-7-5.2-7-9.8 V5.8 Z" fill="none" stroke-width="2.3"/><path d="M12 6.4 v11" stroke-width="1.6" opacity=".55"/>`,cloud:`<path d="M7.2 16.5 a3.9 3.9 0 1 1 .7-7.7 A4.9 4.9 0 0 1 17.4 9.6 a3.4 3.4 0 0 1 -.6 6.9 Z" fill="currentColor" stroke="none"/>`,plus:`<path d="M12 5.2 v13.6 M5.2 12 h13.6" stroke-width="3.4"/>`,up:`<path d="M12 4 L19 12 h-4.1 v8 h-5.8 v-8 H5 Z" fill="currentColor" stroke="none"/>`,cards:`<rect x="4.4" y="5.6" width="9.4" height="13.4" rx="1.8" transform="rotate(-8 9 12.5)" fill="none" stroke-width="2"/><rect x="10.6" y="5" width="9.4" height="13.4" rx="1.8" transform="rotate(7 15.5 11.5)" fill="none" stroke-width="2"/>`,menu:`<path d="M5 7.5 h14 M5 12 h14 M5 16.5 h14" stroke-width="2.4"/>`,hammer:`<rect x="9.6" y="3.4" width="9.6" height="5.4" rx="1.2" transform="rotate(22 14.5 6)" fill="currentColor" stroke="none"/><path d="M11.6 10.2 L5.2 20" stroke-width="2.6"/>`,scissors:`<path d="M7.6 7.6 L17.5 17.8 M16.4 7.6 L6.5 17.8" stroke-width="2.2"/><circle cx="6" cy="19.2" r="2.2" fill="none" stroke-width="1.8"/><circle cx="18" cy="19.2" r="2.2" fill="none" stroke-width="1.8"/>`,question:`<path d="M8.6 8.6 a3.4 3.4 0 1 1 5 3 c-1.1 .7-1.6 1.4-1.6 2.8" fill="none" stroke-width="2.6"/><circle cx="12" cy="18.6" r="1.7" fill="currentColor" stroke="none"/>`,facet:`<path d="M12 3.4 L20 12 L12 20.6 L4 12 Z" fill="none" stroke-width="2.3"/><path d="M12 3.4 v17.2 M4 12 h16" stroke-width="1.2" opacity=".55"/>`,ember:`<path d="M12 3.4 C10 7 8.2 8.8 8.2 11.6 a3.8 3.8 0 0 0 7.6 0 C15.8 8.8 14 7 12 3.4 Z" fill="currentColor" stroke="none"/><circle cx="7" cy="18.4" r="1.4" fill="currentColor" stroke="none" opacity=".8"/><circle cx="12" cy="20" r="1.7" fill="currentColor" stroke="none"/><circle cx="17" cy="18.4" r="1.4" fill="currentColor" stroke="none" opacity=".8"/>`,lantern:`<path d="M9 6.2 h6 M8 6.2 L8 15.6 a4 3 0 0 0 8 0 V6.2" fill="none" stroke-width="2"/><path d="M12 8.4 c-1.5 2-1.5 3.4 0 4.7 1.5-1.3 1.5-2.7 0-4.7 Z" fill="currentColor" stroke="none"/><path d="M10.6 3.6 h2.8 v2.6 h-2.8 Z M10 19.8 h4" stroke-width="1.8"/>`,stagger:`<path d="M12 2.8 L13.8 8.6 L19.8 7 L15.6 11.6 L21 14.8 L14.6 14.9 L15.8 21 L11.9 16.2 L8 21 L9.2 14.9 L3 14.8 L8.4 11.6 L4.2 7 L10.2 8.6 Z" fill="currentColor" stroke="none"/>`,unlitLantern:`<path d="M9 6.2 h6 M8 6.2 L8 15.6 a4 3 0 0 0 8 0 V6.2" fill="none" stroke-width="2" opacity=".65"/><path d="M10.6 3.6 h2.8 v2.6 h-2.8 Z M10 19.8 h4" stroke-width="1.8" opacity=".65"/><path d="M10 10 L14 14 M14 10 L10 14" stroke-width="1.6" opacity=".8"/>`,monument:`<path d="M9.5 20 L10.2 6.5 L12 3.4 L13.8 6.5 L14.5 20 Z" fill="currentColor" stroke="none"/><path d="M6 20.6 h12" stroke-width="2.2"/><path d="M12 8.6 c-1.2 1.6-1.2 2.7 0 3.8 1.2-1.1 1.2-2.2 0-3.8 Z" fill="rgba(0,0,0,.55)" stroke="none"/>`,"deed-paneBreaker":`<path d="M12 3.4 L20 12 L12 20.6 L4 12 Z" fill="none" stroke-width="2"/><path d="M9 9 L15 15 M15 9 L9 15 M12 3.4 L11 10" stroke-width="1.6"/>`,"deed-lanternFed":`<path d="M9 5 h6 M8 5 v8 a4 3 0 0 0 8 0 V5" fill="none" stroke-width="2"/><path d="M10 14 h4 v5 h-4 Z" fill="currentColor" stroke="none"/>`,"deed-ashSermon":`<path d="M7 18 L12 6 L17 18 Z" fill="none" stroke-width="2"/><path d="M9 14 q3 -4 6 0" fill="none" stroke-width="1.6"/>`,"deed-untouched":`<path d="M12 3.4 L20 12 L12 20.6 L4 12 Z" fill="none" stroke-width="2.2"/><circle cx="12" cy="12" r="3" fill="currentColor" stroke="none"/>`,"deed-darkWalker":`<path d="M9 4 h6 M8 4 v9 a4 3 0 0 0 8 0 V4" fill="none" stroke-width="2"/><path d="M6 20 h12" stroke-width="2"/>`,"deed-spendthrift":`<circle cx="12" cy="10" r="3" fill="currentColor" stroke="none"/><path d="M12 13 L8 20 M12 13 L12 21 M12 13 L16 20" stroke-width="1.8"/>`,"deed-hundredShards":`<path d="M6 8 L9 4 L12 8 Z M12 10 L15 6 L18 10 Z M8 16 L11 12 L14 16 Z M14 18 L17 14 L20 18 Z" fill="currentColor" stroke="none"/>`,"deed-firstDawn":`<path d="M4 16 h16 M6 16 a6 6 0 0 1 12 0" fill="none" stroke-width="2"/><circle cx="12" cy="10" r="2.2" fill="currentColor" stroke="none"/>`,"bequest-relic":`<path d="M8 20 V9 L12 4 L16 9 V20 Z" fill="none" stroke-width="2"/><circle cx="12" cy="12" r="2" fill="currentColor" stroke="none"/>`,"bequest-card":`<rect x="7" y="4" width="10" height="16" rx="1.5" fill="none" stroke-width="2"/><path d="M9 8 h6 M9 12 h6" stroke-width="1.6"/>`,"bequest-gold":`<ellipse cx="12" cy="14" rx="7" ry="4" fill="none" stroke-width="2"/><circle cx="10" cy="12" r="2" fill="currentColor" stroke="none"/><circle cx="14" cy="13" r="2" fill="currentColor" stroke="none"/>`,heart:`<path d="M12 6.4 C9.4 3.6 5.2 5.6 5.2 9.4 a4.8 4.8 0 0 0 7 4.2 4.8 4.8 0 0 0 7-4.2 C19.2 5.6 15 3.6 12 6.4 Z" fill="currentColor" stroke="none"/>`,"st-str":`<path d="M12 3 C9 8 7 10 7 13.6 a5 5 0 0 0 10 0 C17 10 15 8 12 3 Z" fill="currentColor" stroke="none"/><path d="M8.5 19.5 L15.5 15.5 M8.5 15.5 L15.5 19.5" stroke-width="2.4"/>`,"st-dex":`<path d="M12 3.4 L18.5 6.2 v5.2 c0 4.2-2.9 7-6.5 9 -3.6-2-6.5-4.8-6.5-9 V6.2 Z" fill="none" stroke-width="2.2"/><path d="M12 7.5 L14 11 L12 14.5 L10 11 Z" fill="currentColor" stroke="none"/>`,"st-vulnerable":`<path d="M12 3.4 L20 12 L12 20.6 L4 12 Z" fill="none" stroke-width="2.2"/><path d="M9 9 L15 15 M15 9 L9 15" stroke-width="1.8"/>`,"st-weak":`<path d="M12 4 v10 M12 20 L7.5 14.5 M12 20 L16.5 14.5" stroke-width="2.6"/>`,"st-frail":`<path d="M12 3.4 L20 12 L12 20.6 L4 12 Z" fill="none" stroke-width="2"/><path d="M12 3.4 L10 9 L14 13 L11 17 L12 20.6" fill="none" stroke-width="1.6"/>`,"st-poison":`<path d="M12 3.6 C9.5 8 7.6 10.4 7.6 13.4 a4.4 4.4 0 0 0 8.8 0 C16.4 10.4 14.5 8 12 3.6 Z" fill="currentColor" stroke="none"/><circle cx="8" cy="19.6" r="1.5" fill="currentColor" stroke="none"/><circle cx="13" cy="20.4" r="1.2" fill="currentColor" stroke="none" opacity=".8"/>`,"st-thorns":`<circle cx="12" cy="12" r="4.2" fill="none" stroke-width="2"/><path d="M12 7.8 V3.4 M12 16.2 V20.6 M7.8 12 H3.4 M16.2 12 H20.6 M9 9 L6 6 M15 15 L18 18 M15 9 L18 6 M9 15 L6 18" stroke-width="2"/>`,"st-ritual":`<path d="M15.5 3.8 a8.6 8.6 0 1 0 4.7 12 a7 7 0 1 1 -4.7 -12 Z" fill="currentColor" stroke="none"/>`,"st-metallicize":`<path d="M12 3.2 L19.4 7.5 v9 L12 20.8 L4.6 16.5 v-9 Z" fill="none" stroke-width="2.3"/><path d="M12 8 L15.5 10 v4 L12 16 L8.5 14 v-4 Z" fill="currentColor" stroke="none"/>`,"st-regen":`<path d="M12 4.2 C8 8.4 6.2 10.6 6.2 13.8 a5.8 5.8 0 0 0 11.6 0 C17.8 10.6 16 8.4 12 4.2 Z" fill="none" stroke-width="2.2"/><path d="M12 9 v6 M9 12 h6" stroke-width="2"/>`,"st-barricade":`<path d="M5 20 v-9 L12 4 l7 7 v9 h-4.6 v-5.4 h-4.8 V20 Z" fill="currentColor" stroke="none"/>`,"st-energized":`<path d="M13.4 3 L6 13.4 h4.4 L10 21 L18 10.6 h-4.4 Z" fill="currentColor" stroke="none"/>`,"st-venomous":`<path d="M7 5 q5 3 10 0 q-1 5 -3.4 7 L15 19 a3 3 0 1 1 -6 0 l1.4-7 Q8 10 7 5 Z" fill="currentColor" stroke="none"/><circle cx="12" cy="18" r="1.4" fill="rgba(0,0,0,.7)" stroke="none"/>`,"st-rampage":`<path d="M4 18 L10 12 L13 15 L20 7" fill="none" stroke-width="2.6"/><path d="M15.5 6.5 H20.5 V11.5" fill="none" stroke-width="2.4"/>`,"st-beacon":`<circle cx="12" cy="12" r="3.4" fill="currentColor" stroke="none"/><path d="M12 5.4 V2.8 M12 21.2 V18.6 M5.4 12 H2.8 M21.2 12 H18.6 M7.4 7.4 L5.6 5.6 M16.6 16.6 L18.4 18.4 M16.6 7.4 L18.4 5.6 M7.4 16.6 L5.6 18.4" stroke-width="2"/>`,"st-emberflow":`<path d="M12 4 C10 7.4 8.6 9.2 8.6 11.6 a3.4 3.4 0 0 0 6.8 0 C15.4 9.2 14 7.4 12 4 Z" fill="currentColor" stroke="none"/><path d="M7 17.5 q2.5 2 5 0 q2.5 -2 5 0 M7 20.5 q2.5 2 5 0 q2.5 -2 5 0" fill="none" stroke-width="1.7"/>`,"st-nightsight":`<path d="M16.8 4 a9 9 0 1 0 3.4 13 a7.4 7.4 0 1 1 -3.4 -13 Z" fill="currentColor" stroke="none"/><circle cx="15.6" cy="9" r="1.6" fill="currentColor" stroke="none"/>`,"art-flare":`<circle cx="12" cy="12" r="3" fill="currentColor" stroke="none"/><path d="M12 6.6 L13.4 9.4 M12 6.6 L10.6 9.4 M12 6.6 V2.8 M17.4 12 h3.8 M12 17.4 v3.8 M2.8 12 h3.8 M15.8 8.2 L18.4 5.6 M15.8 15.8 L18.4 18.4 M8.2 15.8 L5.6 18.4 M8.2 8.2 L5.6 5.6" stroke-width="2"/>`,"art-mendglass":`<path d="M12 3.4 L19 12 L12 20.6 L5 12 Z" fill="none" stroke-width="2"/><path d="M12 8.4 v7.2 M8.4 12 h7.2" stroke-width="2.2"/>`,"art-beacon":`<path d="M9 6 h6 M8 6 v9.4 a4 3.2 0 0 0 8 0 V6" fill="none" stroke-width="2"/><path d="M12 8.2 c-1.6 2.1-1.6 3.6 0 5 1.6-1.4 1.6-2.9 0-5 Z" fill="currentColor" stroke="none"/><path d="M4.5 10 L2.5 9 M19.5 10 L21.5 9 M10 20 h4" stroke-width="1.8"/>`,"art-emberveil":`<path d="M12 3.2 L19 6 v5.6 c0 4.6-3.1 7.6-7 9.8 -3.9-2.2-7-5.2-7-9.8 V6 Z" fill="none" stroke-width="2.2"/><path d="M12 8 c-1.8 2.4-1.8 4 0 5.6 1.8-1.6 1.8-3.2 0-5.6 Z" fill="currentColor" stroke="none"/>`,"art-stoke":`<path d="M12 3.4 C9.2 8 7.4 10.2 7.4 13.4 a4.6 4.6 0 0 0 9.2 0 C16.6 10.2 14.8 8 12 3.4 Z" fill="currentColor" stroke="none"/><path d="M6 20.6 h12" stroke-width="2.4"/><path d="M9 17.8 L7 20.6 M15 17.8 L17 20.6" stroke-width="1.8"/>`,"art-ashfall":`<path d="M7.4 13.5 a3.9 3.9 0 1 1 .7-7.7 A4.9 4.9 0 0 1 17.6 6.6 a3.4 3.4 0 0 1 -.6 6.9 Z" fill="currentColor" stroke="none"/><path d="M8 16.5 v1.6 M12 16.5 v2.6 M16 16.5 v1.6 M10 20.2 v1 M14 20.2 v1" stroke-width="1.9"/>`,"boon-fullPurse":`<path d="M8 7 q4 -4 8 0 l2.4 8.6 a3 3 0 0 1 -2.9 3.8 H8.5 a3 3 0 0 1 -2.9 -3.8 Z" fill="currentColor" stroke="none"/><path d="M9.5 7 h5" stroke-width="2"/><circle cx="12" cy="13.5" r="2.2" fill="rgba(0,0,0,.6)" stroke="none"/>`,"boon-temperedGlass":`<path d="M12 3.4 L20 12 L12 20.6 L4 12 Z" fill="none" stroke-width="2.4"/><path d="M12 7 L16.5 12 L12 17 L7.5 12 Z" fill="currentColor" stroke="none"/>`,"boon-keenEye":`<path d="M2.8 12 q4.6 -6.4 9.2 -6.4 q4.6 0 9.2 6.4 q-4.6 6.4 -9.2 6.4 q-4.6 0 -9.2 -6.4 Z" fill="none" stroke-width="2"/><circle cx="12" cy="12" r="2.8" fill="currentColor" stroke="none"/>`,"boon-warmHearth":`<path d="M5 20 v-8.5 L12 5 l7 6.5 V20 h-5 v-5 h-4 v5 Z" fill="none" stroke-width="2.2"/><path d="M12 11.4 c-1.2 1.6-1.2 2.8 0 4 1.2-1.2 1.2-2.4 0-4 Z" fill="currentColor" stroke="none"/>`,"boon-emberFlask":`<path d="M10 3.4 h4 M11 3.4 v4.2 L6.8 15 a3.6 3.6 0 0 0 3.2 5.4 h4 A3.6 3.6 0 0 0 17.2 15 L13 7.6 V3.4" fill="none" stroke-width="2"/><path d="M12 11 c-1.4 1.8-1.4 3.2 0 4.6 1.4-1.4 1.4-2.8 0-4.6 Z" fill="currentColor" stroke="none"/>`,"boon-twinPhials":`<path d="M7.6 3.8 h3 M9.1 3.8 v3.4 L6.4 13 a2.8 2.8 0 0 0 2.5 4.1 h0.4 A2.8 2.8 0 0 0 11.8 13 L9.1 7.2" fill="none" stroke-width="1.8"/><path d="M13.4 6.8 h3 M14.9 6.8 v3.4 L12.2 16 a2.8 2.8 0 0 0 2.5 4.1 h0.4 A2.8 2.8 0 0 0 17.6 16 L14.9 10.2" fill="none" stroke-width="1.8"/>`,"boon-pilgrimsCache":`<rect x="4.5" y="8" width="15" height="11" rx="2" fill="none" stroke-width="2.2"/><path d="M4.5 12.5 h15 M9 8 q3 -5 6 0" fill="none" stroke-width="1.8"/><rect x="10.6" y="11" width="2.8" height="3.6" rx="0.8" fill="currentColor" stroke="none"/>`,"boon-venomPouch":`<path d="M7.5 6.5 q4.5 -3.4 9 0 l1.6 9.1 a3 3 0 0 1 -3 3.5 H8.9 a3 3 0 0 1 -3 -3.5 Z" fill="none" stroke-width="2.1"/><path d="M12 9.6 c-1.5 2-1.5 3.4 0 4.8 1.5-1.4 1.5-2.8 0-4.8 Z" fill="currentColor" stroke="none"/><circle cx="12" cy="17.4" r="1" fill="currentColor" stroke="none"/>`,"omen-ashfall":`<path d="M7.2 12.5 a3.9 3.9 0 1 1 .7-7.7 A4.9 4.9 0 0 1 17.4 5.6 a3.4 3.4 0 0 1 -.6 6.9 Z" fill="currentColor" stroke="none"/><circle cx="8" cy="16.4" r="1.1" fill="currentColor" stroke="none"/><circle cx="12" cy="18.8" r="1.3" fill="currentColor" stroke="none"/><circle cx="16" cy="16.4" r="1.1" fill="currentColor" stroke="none"/>`,"omen-heavyAir":`<path d="M4 6.5 h16 M6 10.5 h12 M8 14.5 h8" stroke-width="2.2"/><path d="M12 21 L8.5 16.8 h7 Z" fill="currentColor" stroke="none"/>`,"omen-thinGlass":`<path d="M12 3.4 L20 12 L12 20.6 L4 12 Z" fill="none" stroke-width="1.4"/><path d="M12 3.4 L11 8.5 L13.5 11 L10.5 14 L12 20.6 M4 12 L8.5 11 M20 12 L15 13.5" fill="none" stroke-width="1.2"/>`,"omen-hungryDark":`<path d="M17 3.6 a9.4 9.4 0 1 0 3.6 14 a7.6 7.6 0 1 1 -3.6 -14 Z" fill="currentColor" stroke="none"/><circle cx="14.8" cy="8.4" r="1" fill="currentColor" stroke="none"/><circle cx="17.8" cy="12.8" r="0.8" fill="currentColor" stroke="none"/>`,"omen-emberWind":`<path d="M3.5 9 q6 -2.4 10 0 q3 1.8 7 0.4" fill="none" stroke-width="2"/><path d="M3.5 14 q6 -2.4 10 0 q3 1.8 7 0.4" fill="none" stroke-width="2" opacity=".7"/><circle cx="17.5" cy="6.4" r="1.3" fill="currentColor" stroke="none"/><circle cx="6.5" cy="17.6" r="1.1" fill="currentColor" stroke="none"/>`,"omen-longNight":`<path d="M12 2.8 L13.7 8 L19 8.1 L14.8 11.3 L16.3 16.5 L12 13.4 L7.7 16.5 L9.2 11.3 L5 8.1 L10.3 8 Z" fill="currentColor" stroke="none"/><path d="M5 20.6 h14" stroke-width="1.8" opacity=".7"/>`,"omen-waningMoon":`<circle cx="12" cy="12" r="8" fill="none" stroke-width="2"/><path d="M12 4 a8 8 0 0 1 0 16 a11 11 0 0 0 0 -16 Z" fill="currentColor" stroke="none"/>`},LC=e=>!!IC[e],RC=e=>`<g fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">${IC[e]||``}</g>`;function zC(e,t=18){return`<svg class="gicon" width="${t}" height="${t}" viewBox="0 0 24 24" aria-hidden="true">${RC(e)}</svg>`}function BC(e){return gC(`ui`,e)}function VC(e,t=18){let n=gC(`ui`,e);if(n)return`<img class="ui-icon" src="${n}" width="${t}" height="${t}" alt="" draggable="false">`;let r=aC(e);return r?zC(r,t):``}function HC(e,t=18){let n=t/24;return`<g transform="translate(${-t/2},${-t/2}) scale(${n})">${RC(e)}</g>`}var UC=[`draw`,`discard`,`ashes`];function WC(e){let t=Math.max(0,Math.floor(Number(e)||0));return t<=0?0:t>=5?5:t}function GC(e){let t=Math.max(0,Math.floor(Number(e)||0));return t<=0?0:Math.min(t,16)}function KC(e,t){let n=Math.max(0,Math.floor(t)||0),r=Math.max(0,Math.floor(e)||0);if(n<=1)return 0;let i=Math.min((n-1)*5,30),a=i/(n-1);return-i/2+r*a}function qC(e){return UC.includes(e)?e:`draw`}function JC(e,t,{maxStagger:n=48,minStagger:r=8,flightDur:i}={}){let a=Math.max(0,Math.floor(e)||0),o=Math.max(120,t|0);if(a<=0)return{stagger:0,flightDur:0,awaitMs:0};let s=a===1?0:Math.max(r,Math.min(n,Math.floor(o/a))),c=i??Math.max(160,Math.min(420,o-s*Math.min(a-1,6)));return{stagger:s,flightDur:c,awaitMs:Math.min(o+80,s*(a-1)+c)}}function YC(e,t=500){let n=Math.max(0,Math.floor(e)||0),r=Math.max(160,t|0);if(n<=0)return{stagger:0,flightDur:0,awaitMs:0};if(n===1){let e=Math.min(280,r);return{stagger:0,flightDur:e,awaitMs:e}}let i=Math.max(40,Math.floor(r/n)),a=Math.max(160,Math.min(280,r-i));return{stagger:i,flightDur:a,awaitMs:a+i*(n-1)}}var XC=`spirebound_vigil_v2`,ZC=`spirebound_vigil_v1`,QC=`spirebound_stats_v1`,$C=null,ew=new Map;function tw(){if($C)return $C;try{if(typeof localStorage<`u`)return $C=localStorage}catch{}return $C={getItem:e=>ew.has(e)?ew.get(e):null,setItem:(e,t)=>ew.set(e,t),removeItem:e=>ew.delete(e)}}var nw={runs:0,wins:0,slain:0,shatters:0,kindles:0,perfects:0,smolderKills:0,unlitVisited:0,embersSpent:0,bestVow:0,bestFloor:0};function rw(){let e=null;try{e=tw().getItem(XC)}catch{}let t=null;try{t=JSON.parse(e)}catch{}t||=iw();let n={v:2,deeds:{},unlocks:[],vowUnlocked:0,lastFall:null,runsPlayed:0,quests:{},shards:[],whispers:0,news:!1,...t||{}};return n.v=2,n.deeds={...nw,...n.deeds||{}},Array.isArray(n.unlocks)||(n.unlocks=[]),Array.isArray(n.shards)||(n.shards=[]),(!n.quests||typeof n.quests!=`object`)&&(n.quests={}),n}function iw(){let e=null,t=null;try{e=JSON.parse(tw().getItem(ZC))}catch{}try{t=JSON.parse(tw().getItem(QC))}catch{}let n={v:2,deeds:{...nw},unlocks:[],vowUnlocked:0,lastFall:null,runsPlayed:0,quests:{},shards:[],whispers:0,news:!1};return e?(n.deeds={...nw,...e.deeds||{}},n.unlocks=Array.isArray(e.unlocks)?[...e.unlocks]:[],n.vowUnlocked=e.vowUnlocked||0,n.lastFall=e.lastFall||null,n.news=!0):t&&(n.deeds.runs=t.runs||0,n.deeds.wins=t.wins||0,n.deeds.wins>0&&(n.vowUnlocked=1)),n.runsPlayed=Math.max(n.deeds.runs||0,t?.runs||0),aw(n),n}function aw(e){try{tw().setItem(XC,JSON.stringify(e))}catch{}}function ow(){try{let e=tw();e.removeItem(XC),e.removeItem(ZC),e.removeItem(QC)}catch{}}function sw(e){let t=[];for(let n of Object.values(Uu))if((e.deeds[n.stat]||0)>=n.n)for(let r of n.unlocks)!e.unlocks.includes(r)&&!t.includes(r)&&t.push(r);return t}function cw(){let e=rw(),t=sw(e);return t.length&&(e.unlocks.push(...t),e.news=!0,aw(e)),e}function lw(e,t){let n=Gu.find(e=>e.id===t);if(!n)return!1;let r=n.trigger;return!(r.runsPlayed!=null&&(e.runsPlayed||0)<r.runsPlayed||r.wins!=null&&(e.deeds.wins||0)<r.wins)}function uw(e){return Gu.filter(t=>lw(e,t.id)).map(e=>e.id)}function dw(e){if(e.runEndCommitted)return rw();e.runEndCommitted=!0;let t=rw(),n=uw(t).length;return t.runsPlayed++,uw(t).length>n&&(t.news=!0),aw(t),t}function fw(){let e=rw();return e.news&&(e.news=!1,aw(e)),e}function pw(e,t){if(e.vigilCommitted)return{vigil:rw(),newUnlocks:[]};e.vigilCommitted=!0;let n=rw(),r={...n.deeds};n.deeds.runs++,t&&(n.deeds.wins++,n.deeds.bestVow=Math.max(n.deeds.bestVow,e.vow||0),n.vowUnlocked=Math.max(n.vowUnlocked,Math.min(5,(e.vow||0)+1))),n.deeds.bestFloor=Math.max(n.deeds.bestFloor,e.act*15+e.floorsClimbed),n.deeds.slain+=e.stats.slain||0;for(let t of[`shatters`,`kindles`,`perfects`,`smolderKills`,`unlitVisited`,`embersSpent`])n.deeds[t]+=e.stats[t]||0;let i=sw(n);return n.unlocks.push(...i),(Object.keys(nw).some(e=>n.deeds[e]!==r[e])||i.length)&&(n.news=!0),aw(n),{vigil:n,newUnlocks:i}}function mw(e,t,n){let r=rw();r.lastFall={act:e,row:t,bequest:n},aw(r)}function hw(){let e=rw();e.lastFall=null,aw(e)}var gw={starter:0,special:0,common:1,uncommon:2,rare:3,boss:4};function _w(e){let t=[],n=e.player.relics.filter(e=>Mu[e]&&Mu[e].rarity!==`starter`);if(n.length){let e=[...n].sort((e,t)=>gw[Mu[t].rarity]-gw[Mu[e].rarity])[0];t.push({kind:`relic`,id:e})}let r=e.player.deck.filter(e=>{let t=ku[e.id];return t&&t.rarity!==`starter`&&t.rarity!==`special`});if(r.length){let e=[...r].sort((e,t)=>gw[ku[t.id].rarity]-gw[ku[e.id].rarity]||(t.up===e.up?0:t.up?1:-1))[0];t.push({kind:`card`,id:e.id,up:!!e.up})}return e.player.gold>=25&&t.push({kind:`gold`,amount:Math.min(e.player.gold,75)}),t}var vw=[{id:`click`,group:`UI`,use:`Buttons, menus, title / embark / vigil actions`,note:`stained-glass crystal tick`},{id:`hover`,group:`UI`,use:`Card / option / lamplighter hover`,note:`quieter than click; rapid-safe`},{id:`card`,group:`Cards`,use:`Card play motion, toss, discard/exhaust fidget, remove`},{id:`draw`,group:`Cards`,use:`Draw-to-hand (staggered per card)`},{id:`atkHeroLight`,group:`Attack`,use:`Hero hit, light (amount+blocked ≤ 5)`,play:`attack`,attack:{who:`hero`,amount:3}},{id:`atkHeroMed`,group:`Attack`,use:`Hero hit, medium (6–15)`,play:`attack`,attack:{who:`hero`,amount:10}},{id:`atkHeroHeavy`,group:`Attack`,use:`Hero hit, heavy (≥ 16)`,play:`attack`,attack:{who:`hero`,amount:20}},{id:`atkEnemyLight`,group:`Attack`,use:`Enemy hit on player, light (≤ 5)`,play:`attack`,attack:{who:`enemy`,amount:3}},{id:`atkEnemyMed`,group:`Attack`,use:`Enemy hit on player, medium (6–15)`,play:`attack`,attack:{who:`enemy`,amount:10}},{id:`atkEnemyHeavy`,group:`Attack`,use:`Enemy hit on player, heavy (≥ 16)`,play:`attack`,attack:{who:`enemy`,amount:20}},{id:`slash`,group:`Attack (legacy)`,use:`Routes to medium hero attack; sample kept for compatibility`,note:`Legacy`},{id:`hit`,group:`Attack (legacy)`,use:`No-op wrapper; sample kept for compatibility`,note:`Legacy`},{id:`blocked`,group:`Combat`,use:`Hit stopped by Ward / thorns / adamant`,note:`impact stopped ≠ block gain`},{id:`block`,group:`Combat`,use:`Gain Ward`,note:`softer / more positive than blocked`},{id:`poison`,group:`Combat`,use:`Smolder / poison apply or tick`,note:`ember-like Smolder, not swamp toxic`},{id:`debuff`,group:`Combat`,use:`Debuff apply, burn/self damage, can’t-afford feedback`},{id:`buff`,group:`Combat`,use:`Buff apply; power settle into glass`},{id:`heal`,group:`Combat`,use:`Combat heal / rest heal feedback`},{id:`energy`,group:`Combat`,use:`Energy gain event (candle pop)`},{id:`coin`,group:`Meta`,use:`Gold pickup / shop spend / reward gold fly`},{id:`potion`,group:`Meta`,use:`Use / gain phial`},{id:`death`,group:`Combat`,use:`Normal enemy death`,note:`shatter family, smaller than shatter`},{id:`bigDeath`,group:`Combat`,use:`Elite / boss death; also boss intro sting`,note:`shatter family, lower = bigger`},{id:`turn`,group:`Combat`,use:`Your turn banner (turn > 1)`},{id:`victory`,group:`Combat`,use:`Fight-won SFX sting (BGM victory is run-end only)`},{id:`defeat`,group:`Combat`,use:`Fight-lost SFX sting (BGM defeat is run-end only)`},{id:`relic`,group:`Meta`,use:`Relic gain / lamplighter confirm / unlock / monument`},{id:`upgrade`,group:`Meta`,use:`Card upgrade at rest / forge / event / reward`},{id:`map`,group:`Meta`,use:`Map enter / node travel one-shot (not map BGM)`},{id:`chip`,group:`SHATTER`,use:`Facet chip tick`},{id:`shatter`,group:`SHATTER`,use:`Shatter burst — brand signature`},{id:`ember`,group:`SHATTER`,use:`Ember gain`},{id:`kindle`,group:`SHATTER`,use:`Kindle / lantern feed`},{id:`stagger`,group:`SHATTER`,use:`Enemy staggered`},{id:`art`,group:`SHATTER`,use:`Lantern Art cast`},{id:`omen`,group:`Meta`,use:`Omen banner / omen reveal on act entry`}],yw=[{id:`title`,title:`Stained Glass Inscription`,use:`Title screen`,wired:!0},{id:`embark`,title:`Light Your Lantern`,use:`Embark / Begin the Climb`,wired:!0},{id:`vigil`,title:`Monuments in the Dark`,use:`The Vigil (meta hall)`,wired:!0},{id:`roseWindow`,title:`Six Dark Panes`,use:`Emberglass / Rose Window (future)`,wired:!1},{id:`map`,title:`Lanterns on the Face of the Spire`,use:`Node-pick map (not reward/bossRelic)`,wired:!0},{id:`safeNodes`,title:`Cold Goods, Warm Price`,use:`Shop, rest, treasure`,wired:!0},{id:`act1Combat`,title:`Ashen Woods Scherzo`,use:`Act 1 normal fights`,wired:!0},{id:`act1Boss`,title:`The Rootheart Awakens`,use:`Act 1 boss — Rootheart`,wired:!0},{id:`act2Combat`,title:`Sunken City Waltz`,use:`Act 2 normal fights`,wired:!0},{id:`act2Boss`,title:`Leviathan's Maw`,use:`Act 2 boss — Leviathan`,wired:!0},{id:`act3Combat`,title:`The Cracked Astral Court`,use:`Act 3 normal fights`,wired:!0},{id:`act3Boss`,title:`The Eternal Sovereign`,use:`Act 3 boss — Eternal Sovereign`,wired:!0},{id:`elite`,title:`Named Afflictions`,use:`Elite fights (all acts)`,wired:!0},{id:`paleOnes`,title:`Witchlight Motes`,use:`Hidden quest — Pale Ones (future)`,wired:!1},{id:`shadeDuel`,title:`The Duel That Remembers`,use:`Hidden quest — shade duel (future)`,wired:!1},{id:`usurper`,title:`Lantern With No Flame`,use:`Hidden quest — Usurper boss (future)`,wired:!1},{id:`eighthOmen`,title:`Broken Glyph Run`,use:`Hidden quest — Eighth Omen run (future)`,wired:!1},{id:`unreadablePage`,title:`It Reads Itself`,use:`Hidden quest — Unreadable Page (future)`,wired:!1},{id:`hollowLamplighter`,title:`The Unlit Way`,use:`Hidden quest — hollow lamplighter (future)`,wired:!1},{id:`sealedDoor`,title:`The Climb Continues`,use:`Sealed Act 4 door reveal (future)`,wired:!1},{id:`victory`,title:`The Only Sunrise`,use:`Act 1/2 boss kill ceremony + final run victory / end(won)`,wired:!0},{id:`defeat`,title:`A Mark in the Dark`,use:`Run defeat / end(!won)`,wired:!0}],bw=[`music`,`sfx`],xw=Object.freeze({music:`stained-glass-v1`,sfx:`ashglass-v1`}),Sw=Object.freeze({music:Object.freeze({version:xw.music,overrides:Object.freeze({})}),sfx:Object.freeze({version:xw.sfx,overrides:Object.freeze({})})}),Cw={music:new Set(yw.map(e=>e.id)),sfx:new Set(vw.map(e=>e.id))},ww=e=>!!e&&typeof e==`object`&&!Array.isArray(e);function Tw(e,t){return Cw[e]?.has(t)?e===`sfx`?`${t}.mp3`:`${t.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase()}.mp3`:null}function Ew(e,t){if(!Cw[e]||typeof t!=`string`)return null;let n=e===`music`?`./assets/musics/`:`./assets/sfx/`;if(!t.startsWith(n))return null;let r=t.slice(n.length).split(`/`);if(r.length<1||r.length>2)return null;let i=r.at(-1);if(!/^[A-Za-z0-9][A-Za-z0-9._-]*\.mp3$/.test(i))return null;if(r.length===1)return`${xw[e]}/${i}`;let a=r[0];return!/^[a-z0-9][a-z0-9-]*$/.test(a)||a===xw[e]?null:`${a}/${i}`}function Dw(e,t,n,r){let i=Tw(e,t);if(!i)return null;let a=new Set(n?.[e]??[]),o=r?.[e]?.overrides?.[t];if(o&&a.has(o))return o;let s=`${r?.[e]?.version??xw[e]}/${i}`;if(a.has(s))return s;let c=`${xw[e]}/${i}`;return a.has(c)?c:null}function Ow(e,t,{completeOnly:n=!1}={}){if(!Cw[e])return[];let r=new Set(t?.[e]??[]),i=[...new Set([...r].map(e=>String(e).split(`/`,1)[0]).filter(Boolean))].sort();return n?i.filter(t=>[...Cw[e]].every(n=>{let i=Tw(e,n);return r.has(`${t}/${i}`)})):i}function kw(e,t){let n=[];if(!ww(e))return[`selection: expected object`];for(let t of Object.keys(e))bw.includes(t)||n.push(`selection.${t}: unknown key`);for(let r of bw){let i=e[r];if(!ww(i)){n.push(`${r}: expected object`);continue}for(let e of Object.keys(i))[`version`,`overrides`].includes(e)||n.push(`${r}.${e}: unknown key`);let{version:a,overrides:o}=i,s=new Set(t?.[r]??[]);if(typeof a!=`string`||!a?n.push(`${r}.version: expected non-empty string`):Ow(r,t,{completeOnly:!0}).includes(a)||n.push(`${r}.version: unknown or incomplete pack ${a}`),!ww(o)){n.push(`${r}.overrides: expected object`);continue}for(let[e,t]of Object.entries(o))Cw[r].has(e)?(typeof t!=`string`||!s.has(t))&&n.push(`${r}.overrides.${e}: unavailable asset ${t}`):n.push(`${r}.overrides.${e}: unknown id`)}return n}function Aw(e,t){let n=kw(e,t);return n.length?{selection:Sw,problems:n}:{selection:{music:{version:e.music.version,overrides:{...e.music.overrides}},sfx:{version:e.sfx.version,overrides:{...e.sfx.overrides}}},problems:[]}}var jw=`/assets/act1-boss-D2JY_LAX.mp3`,Mw=`/assets/act1-combat-DHeomuQb.mp3`,Nw=`/assets/act2-boss-w-0YrDvC.mp3`,Pw=`/assets/act2-combat-BUNQDo8X.mp3`,Fw=`/assets/act3-boss-DRjer9Eo.mp3`,Iw=`/assets/act3-combat-BCoJsj3d.mp3`,Lw=`/assets/defeat-CEYEW4hp.mp3`,Rw=`/assets/eighth-omen-Drh_Dj1R.mp3`,zw=`/assets/elite-D1pGH3Ls.mp3`,Bw=`/assets/embark-DAYrumtx.mp3`,Vw=`/assets/hollow-lamplighter-DXIDnoeJ.mp3`,Hw=`/assets/map-9gUttaCg.mp3`,Uw=`/assets/pale-ones-CooxJYDP.mp3`,Ww=`/assets/rose-window-DWw8_7-Y.mp3`,Gw=`/assets/safe-nodes-Cs7dJK8Q.mp3`,Kw=`/assets/sealed-door-7U9D2ofu.mp3`,qw=`/assets/shade-duel-BGm5xwqQ.mp3`,Jw=`/assets/act1-boss-CqfpN7Ko.mp3`,Yw=`/assets/act1-combat-CiwkVtEu.mp3`,Xw=`/assets/act2-boss-CTW81FyJ.mp3`,Zw=`/assets/act2-combat-M9UtKBbD.mp3`,Qw=`/assets/act3-boss-BFnVKPis.mp3`,$w=`/assets/act3-combat-DMu4_W_9.mp3`,eT=`/assets/defeat-BxUtlw4G.mp3`,tT=`/assets/eighth-omen-CJ_m6Jqh.mp3`,nT=`/assets/elite-Q_vE2JI3.mp3`,rT=`/assets/embark-V_Gw1r-c.mp3`,iT=`/assets/hollow-lamplighter-BFvWip3L.mp3`,aT=`/assets/map-BopFl7Fq.mp3`,oT=`/assets/pale-ones-yhihsV-C.mp3`,sT=`/assets/rose-window-DXDmOViX.mp3`,cT=`/assets/safe-nodes-DOSXc6gD.mp3`,lT=`/assets/sealed-door-YEcRrA4c.mp3`,uT=`/assets/shade-duel-MihYVBxe.mp3`,dT=`/assets/title-BqrnMEbM.mp3`,fT=`/assets/unreadable-page-CkVruwva.mp3`,pT=`/assets/usurper-DYM-GXSk.mp3`,mT=`/assets/victory-BU24Vbtl.mp3`,hT=`/assets/vigil-jcr6py6L.mp3`,gT=`/assets/title-hv_nR6fm.mp3`,_T=`/assets/unreadable-page-BkTiAYR4.mp3`,vT=`/assets/usurper-DtKClUxf.mp3`,yT=`/assets/victory-CTShuLyZ.mp3`,bT=`/assets/vigil-nm1lAxi4.mp3`,xT=`/assets/art-B9obLzic.mp3`,ST=`/assets/atkEnemyHeavy-BksNGQUf.mp3`,CT=`/assets/atkEnemyLight-Ce2Qoi6L.mp3`,wT=`/assets/atkEnemyMed-C0SjG0e2.mp3`,TT=`/assets/atkHeroHeavy-_Ol1Hbvl.mp3`,ET=`/assets/atkHeroLight-CBWWYXlD.mp3`,DT=`/assets/atkHeroMed-N5zpHLF1.mp3`,OT=`/assets/bigDeath-jxGWL0e_.mp3`,kT=`/assets/block-CjOzqJwq.mp3`,AT=`/assets/blocked-CQ-bPhTt.mp3`,jT=`/assets/buff-DMiXbcc2.mp3`,MT=`/assets/card-W2n1s1ZV.mp3`,NT=`/assets/chip-CwQrpHtB.mp3`,PT=`/assets/click-C-NJ9zIz.mp3`,FT=`/assets/coin-COo3Nwb2.mp3`,IT=`/assets/death-BB_F1LYd.mp3`,LT=`/assets/debuff-SgQ90Ldc.mp3`,RT=`/assets/defeat-D2ITiVl3.mp3`,zT=`/assets/draw-UcQdKOmc.mp3`,BT=`/assets/ember-B4hnZ43g.mp3`,VT=`/assets/energy-Do-lg_yL.mp3`,HT=`/assets/heal-CS_GECeM.mp3`,UT=`/assets/hover-BLCguDdE.mp3`,WT=`/assets/kindle-PVLpoiWq.mp3`,GT=`/assets/map-DFAkHBjg.mp3`,KT=`/assets/omen-Dsv0uBvZ.mp3`,qT=`/assets/poison-Bu1KYUff.mp3`,JT=`/assets/potion-C7yS78Tl.mp3`,YT=`/assets/relic-WuNmhq9D.mp3`,XT=`/assets/shatter-7cmbaDBU.mp3`,ZT=`/assets/stagger-DifqHquB.mp3`,QT=`/assets/turn-OBdLSj7N.mp3`,$T=`/assets/upgrade-YGY8Zkvz.mp3`,eE=`/assets/victory-DRj4EJVH.mp3`,tE=`/assets/art-B3P6zACg.mp3`,nE=`/assets/art-C_nzCTRu.mp3`,rE=`/assets/atkEnemyHeavy-B3Jt29Kw.mp3`,iE=`/assets/atkEnemyLight-KcqAx3pc.mp3`,aE=`/assets/atkEnemyMed-DdTibTTZ.mp3`,oE=`/assets/atkHeroHeavy-CW3VoD-f.mp3`,sE=`/assets/atkHeroLight-DF_tGDgU.mp3`,cE=`/assets/atkHeroMed-ScjFI8zb.mp3`,lE=`/assets/bigDeath-BnVZAO3z.mp3`,uE=`/assets/block-CNsJAkRG.mp3`,dE=`/assets/blocked-BPD_-h4x.mp3`,fE=`/assets/buff-DaQlFCR9.mp3`,pE=`/assets/card-FjXTSjOg.mp3`,mE=`data:audio/mpeg;base64,`,hE=`data:audio/mpeg;base64,`,gE=`/assets/coin-fW81wzh6.mp3`,_E=`/assets/death-T_wE6Jim.mp3`,vE=`/assets/debuff-BeG6pgoL.mp3`,yE=`/assets/defeat-g5IvKocI.mp3`,bE=`/assets/draw-KZI867xo.mp3`,xE=`/assets/ember-BHhqC7i0.mp3`,SE=`/assets/energy-NKuuVcfp.mp3`,CE=`/assets/heal-YNP0RqGw.mp3`,wE=`/assets/hit-Bej1RH7R.mp3`,TE=`data:audio/mpeg;base64,`,EE=`/assets/kindle-woIxUXDP.mp3`,DE=`/assets/map-5MhiK7FB.mp3`,OE=`/assets/omen-B8CwcoBN.mp3`,kE=`/assets/poison-Ba0OZu-q.mp3`,AE=`/assets/potion-C3Om8NbL.mp3`,jE=`/assets/relic-De1VZPgU.mp3`,ME=`/assets/shatter-DdOTtITM.mp3`,NE=`/assets/slash-DA5Y3thL.mp3`,PE=`/assets/stagger-DXscKiEU.mp3`,FE=`/assets/turn-rzmsaT0T.mp3`,IE=`/assets/upgrade-DgymvFk-.mp3`,LE=`/assets/victory-DkYeNMBU.mp3`,RE=`/assets/atkEnemyHeavy-8R_F9kAp.mp3`,zE=`/assets/atkEnemyLight-CgN819nV.mp3`,BE=`/assets/atkEnemyMed-DY5UVB-V.mp3`,VE=`/assets/atkHeroHeavy-BOMyKavq.mp3`,HE=`/assets/atkHeroLight-v48w3yvY.mp3`,UE=`/assets/atkHeroMed-CyXLCy-c.mp3`,WE=`/assets/bigDeath-CBDcm0da.mp3`,GE=`/assets/block-CCnwLUAd.mp3`,KE=`/assets/blocked-CdMovvzs.mp3`,qE=`/assets/buff-CMo1FwrD.mp3`,JE=`/assets/card-BYdmO4a1.mp3`,YE=`/assets/chip-C-Ig6Vux.mp3`,XE=`/assets/click-BAWfT69x.mp3`,ZE=`/assets/coin-BNzFFE_a.mp3`,QE=`/assets/death-Bg_RTrC3.mp3`,$E=`/assets/debuff-BWg6Xh0H.mp3`,eD=`/assets/defeat-8wdCXKLg.mp3`,tD=`/assets/draw-BOLCXWxc.mp3`,nD=`/assets/ember-CrA19EQt.mp3`,rD=`/assets/energy-DBeci4G_.mp3`,iD=`/assets/heal-B6kepkxS.mp3`,aD=`/assets/hit-DQDE3tuP.mp3`,oD=`/assets/hover-Dg1EnA_N.mp3`,sD=`/assets/kindle-C4QiqFhA.mp3`,cD=`/assets/map-CUGVhYSR.mp3`,lD=`/assets/omen-Cc3JCQKQ.mp3`,uD=`/assets/poison-CObN6vDY.mp3`,dD=`/assets/potion-Biu0CGzP.mp3`,fD=`/assets/relic-DY4tcPPP.mp3`,pD=`/assets/shatter-CKCw-d9R.mp3`,mD=`/assets/slash-Bozb9WgA.mp3`,hD=`/assets/stagger-zz7sykzl.mp3`,gD=`/assets/turn-DgKHemIS.mp3`,_D=`/assets/upgrade-0VPiO6Tw.mp3`,vD=`/assets/victory-Bj-6HCUd.mp3`,yD=3e3;async function bD(e,{fetchImpl:t=globalThis.fetch,timeoutMs:n=yD}={}){if(typeof t!=`function`)throw TypeError(`fetch implementation is required`);if(!Number.isFinite(n)||n<=0)throw RangeError(`timeoutMs must be positive`);let r=new AbortController,i,a=new Promise((e,t)=>{i=setTimeout(()=>{t(Error(`timed out after ${n} ms`)),r.abort()},n)}),o=Promise.resolve().then(()=>t(e,{cache:`no-store`,signal:r.signal})).then(async e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()});try{return await Promise.race([o,a])}finally{clearTimeout(i)}}var xD=Object.assign({"./assets/musics/act1-boss.mp3":jw,"./assets/musics/act1-combat.mp3":Mw,"./assets/musics/act2-boss.mp3":Nw,"./assets/musics/act2-combat.mp3":Pw,"./assets/musics/act3-boss.mp3":Fw,"./assets/musics/act3-combat.mp3":Iw,"./assets/musics/defeat.mp3":Lw,"./assets/musics/eighth-omen.mp3":Rw,"./assets/musics/elite.mp3":zw,"./assets/musics/embark.mp3":Bw,"./assets/musics/hollow-lamplighter.mp3":Vw,"./assets/musics/map.mp3":Hw,"./assets/musics/pale-ones.mp3":Uw,"./assets/musics/rose-window.mp3":Ww,"./assets/musics/safe-nodes.mp3":Gw,"./assets/musics/sealed-door.mp3":Kw,"./assets/musics/shade-duel.mp3":qw,"./assets/musics/stained-glass-v2/act1-boss.mp3":Jw,"./assets/musics/stained-glass-v2/act1-combat.mp3":Yw,"./assets/musics/stained-glass-v2/act2-boss.mp3":Xw,"./assets/musics/stained-glass-v2/act2-combat.mp3":Zw,"./assets/musics/stained-glass-v2/act3-boss.mp3":Qw,"./assets/musics/stained-glass-v2/act3-combat.mp3":$w,"./assets/musics/stained-glass-v2/defeat.mp3":eT,"./assets/musics/stained-glass-v2/eighth-omen.mp3":tT,"./assets/musics/stained-glass-v2/elite.mp3":nT,"./assets/musics/stained-glass-v2/embark.mp3":rT,"./assets/musics/stained-glass-v2/hollow-lamplighter.mp3":iT,"./assets/musics/stained-glass-v2/map.mp3":aT,"./assets/musics/stained-glass-v2/pale-ones.mp3":oT,"./assets/musics/stained-glass-v2/rose-window.mp3":sT,"./assets/musics/stained-glass-v2/safe-nodes.mp3":cT,"./assets/musics/stained-glass-v2/sealed-door.mp3":lT,"./assets/musics/stained-glass-v2/shade-duel.mp3":uT,"./assets/musics/stained-glass-v2/title.mp3":dT,"./assets/musics/stained-glass-v2/unreadable-page.mp3":fT,"./assets/musics/stained-glass-v2/usurper.mp3":pT,"./assets/musics/stained-glass-v2/victory.mp3":mT,"./assets/musics/stained-glass-v2/vigil.mp3":hT,"./assets/musics/title.mp3":gT,"./assets/musics/unreadable-page.mp3":_T,"./assets/musics/usurper.mp3":vT,"./assets/musics/victory.mp3":yT,"./assets/musics/vigil.mp3":bT}),SD=Object.assign({"./assets/sfx/_raw/art.mp3":xT,"./assets/sfx/_raw/atkEnemyHeavy.mp3":ST,"./assets/sfx/_raw/atkEnemyLight.mp3":CT,"./assets/sfx/_raw/atkEnemyMed.mp3":wT,"./assets/sfx/_raw/atkHeroHeavy.mp3":TT,"./assets/sfx/_raw/atkHeroLight.mp3":ET,"./assets/sfx/_raw/atkHeroMed.mp3":DT,"./assets/sfx/_raw/bigDeath.mp3":OT,"./assets/sfx/_raw/block.mp3":kT,"./assets/sfx/_raw/blocked.mp3":AT,"./assets/sfx/_raw/buff.mp3":jT,"./assets/sfx/_raw/card.mp3":MT,"./assets/sfx/_raw/chip.mp3":NT,"./assets/sfx/_raw/click.mp3":PT,"./assets/sfx/_raw/coin.mp3":FT,"./assets/sfx/_raw/death.mp3":IT,"./assets/sfx/_raw/debuff.mp3":LT,"./assets/sfx/_raw/defeat.mp3":RT,"./assets/sfx/_raw/draw.mp3":zT,"./assets/sfx/_raw/ember.mp3":BT,"./assets/sfx/_raw/energy.mp3":VT,"./assets/sfx/_raw/heal.mp3":HT,"./assets/sfx/_raw/hover.mp3":UT,"./assets/sfx/_raw/kindle.mp3":WT,"./assets/sfx/_raw/map.mp3":GT,"./assets/sfx/_raw/omen.mp3":KT,"./assets/sfx/_raw/poison.mp3":qT,"./assets/sfx/_raw/potion.mp3":JT,"./assets/sfx/_raw/relic.mp3":YT,"./assets/sfx/_raw/shatter.mp3":XT,"./assets/sfx/_raw/stagger.mp3":ZT,"./assets/sfx/_raw/turn.mp3":QT,"./assets/sfx/_raw/upgrade.mp3":$T,"./assets/sfx/_raw/victory.mp3":eE,"./assets/sfx/art.mp3":tE,"./assets/sfx/ashglass-v2/art.mp3":nE,"./assets/sfx/ashglass-v2/atkEnemyHeavy.mp3":rE,"./assets/sfx/ashglass-v2/atkEnemyLight.mp3":iE,"./assets/sfx/ashglass-v2/atkEnemyMed.mp3":aE,"./assets/sfx/ashglass-v2/atkHeroHeavy.mp3":oE,"./assets/sfx/ashglass-v2/atkHeroLight.mp3":sE,"./assets/sfx/ashglass-v2/atkHeroMed.mp3":cE,"./assets/sfx/ashglass-v2/bigDeath.mp3":lE,"./assets/sfx/ashglass-v2/block.mp3":uE,"./assets/sfx/ashglass-v2/blocked.mp3":dE,"./assets/sfx/ashglass-v2/buff.mp3":fE,"./assets/sfx/ashglass-v2/card.mp3":pE,"./assets/sfx/ashglass-v2/chip.mp3":mE,"./assets/sfx/ashglass-v2/click.mp3":hE,"./assets/sfx/ashglass-v2/coin.mp3":gE,"./assets/sfx/ashglass-v2/death.mp3":_E,"./assets/sfx/ashglass-v2/debuff.mp3":vE,"./assets/sfx/ashglass-v2/defeat.mp3":yE,"./assets/sfx/ashglass-v2/draw.mp3":bE,"./assets/sfx/ashglass-v2/ember.mp3":xE,"./assets/sfx/ashglass-v2/energy.mp3":SE,"./assets/sfx/ashglass-v2/heal.mp3":CE,"./assets/sfx/ashglass-v2/hit.mp3":wE,"./assets/sfx/ashglass-v2/hover.mp3":TE,"./assets/sfx/ashglass-v2/kindle.mp3":EE,"./assets/sfx/ashglass-v2/map.mp3":DE,"./assets/sfx/ashglass-v2/omen.mp3":OE,"./assets/sfx/ashglass-v2/poison.mp3":kE,"./assets/sfx/ashglass-v2/potion.mp3":AE,"./assets/sfx/ashglass-v2/relic.mp3":jE,"./assets/sfx/ashglass-v2/shatter.mp3":ME,"./assets/sfx/ashglass-v2/slash.mp3":NE,"./assets/sfx/ashglass-v2/stagger.mp3":PE,"./assets/sfx/ashglass-v2/turn.mp3":FE,"./assets/sfx/ashglass-v2/upgrade.mp3":IE,"./assets/sfx/ashglass-v2/victory.mp3":LE,"./assets/sfx/atkEnemyHeavy.mp3":RE,"./assets/sfx/atkEnemyLight.mp3":zE,"./assets/sfx/atkEnemyMed.mp3":BE,"./assets/sfx/atkHeroHeavy.mp3":VE,"./assets/sfx/atkHeroLight.mp3":HE,"./assets/sfx/atkHeroMed.mp3":UE,"./assets/sfx/bigDeath.mp3":WE,"./assets/sfx/block.mp3":GE,"./assets/sfx/blocked.mp3":KE,"./assets/sfx/buff.mp3":qE,"./assets/sfx/card.mp3":JE,"./assets/sfx/chip.mp3":YE,"./assets/sfx/click.mp3":XE,"./assets/sfx/coin.mp3":ZE,"./assets/sfx/death.mp3":QE,"./assets/sfx/debuff.mp3":$E,"./assets/sfx/defeat.mp3":eD,"./assets/sfx/draw.mp3":tD,"./assets/sfx/ember.mp3":nD,"./assets/sfx/energy.mp3":rD,"./assets/sfx/heal.mp3":iD,"./assets/sfx/hit.mp3":aD,"./assets/sfx/hover.mp3":oD,"./assets/sfx/kindle.mp3":sD,"./assets/sfx/map.mp3":cD,"./assets/sfx/omen.mp3":lD,"./assets/sfx/poison.mp3":uD,"./assets/sfx/potion.mp3":dD,"./assets/sfx/relic.mp3":fD,"./assets/sfx/shatter.mp3":pD,"./assets/sfx/slash.mp3":mD,"./assets/sfx/stagger.mp3":hD,"./assets/sfx/turn.mp3":gD,"./assets/sfx/upgrade.mp3":_D,"./assets/sfx/victory.mp3":vD});function CD(e,t){let n=Object.create(null);for(let[r,i]of Object.entries(t)){let t=Ew(e,r);if(t){if(n[t])throw Error(`duplicate ${e} asset ref: ${t}`);n[t]=i}}return n}var wD={music:CD(`music`,xD),sfx:CD(`sfx`,SD)},TD=Object.freeze({music:Object.freeze(Object.keys(wD.music).sort()),sfx:Object.freeze(Object.keys(wD.sfx).sort())}),ED=Sw,DD=[];async function OD(e=`/audio-selection.json`){try{return kD(await bD(e))}catch(e){return ED=Sw,DD=[`audio-selection.json: ${String(e?.message??e)}`],DD.length&&console.warn(`[audio-selection]`,...DD),ED}}function kD(e){let t=Aw(e,TD);return ED=t.selection,DD=t.problems,DD.length&&console.warn(`[audio-selection]`,...DD),ED}function AD(){return ED}function jD(){return[...DD]}function MD(e,t,n=ED){let r=Dw(e,t,TD,n);if(!r)return null;let i=n?.[e]?.overrides?.[t],a=xw[e];return{ref:r,url:wD[e]?.[r]??null,overridden:r===i,fallback:!i&&n?.[e]?.version!==a&&r.startsWith(`${a}/`)}}var ND=.55,PD=`spirebound_vol_sfx`,FD=`spirebound_mute_sfx`;function ID(){let e=parseFloat(localStorage.getItem(PD));return Number.isFinite(e)?Math.min(1,Math.max(0,e)):ND}function LD(){let e=localStorage.getItem(`spirebound_mute`);return localStorage.getItem(FD)==null&&e===`1`?!0:localStorage.getItem(FD)===`1`}var RD=null,zD=null,BD=ID(),VD=LD(),HD=Object.create(null),UD=Object.create(null),WD=Object.create(null),GD=Object.freeze(vw.map(e=>e.id));function KD(){if(RD)return!0;try{RD=new(window.AudioContext||window.webkitAudioContext),zD=RD.createGain(),zD.gain.value=VD?0:BD,zD.connect(RD.destination)}catch{return!1}return!0}function qD(){return RD}function JD(e=.08){if(!zD||!RD)return;let t=VD?0:BD;zD.gain.cancelScheduledValues(RD.currentTime),zD.gain.linearRampToValueAtTime(t,RD.currentTime+e)}function YD(){KD()&&(RD.state===`suspended`&&RD.resume(),sO())}function XD(){return BD}function ZD(){return VD}function QD(e){return BD=Math.min(1,Math.max(0,+e||0)),localStorage.setItem(PD,String(BD)),JD(),BD}function $D(e){return VD=!!e,localStorage.setItem(FD,VD?`1`:`0`),JD(),VD}function eO(e,t,n,r,i){e.gain.setValueAtTime(1e-4,t),e.gain.exponentialRampToValueAtTime(r,t+n),e.gain.exponentialRampToValueAtTime(1e-4,t+n+i)}function J(e,{type:t=`sine`,a:n=.005,d:r=.2,peak:i=.3,slide:a=0,delay:o=0}={}){if(!KD())return;let s=RD.currentTime+o,c=RD.createOscillator(),l=RD.createGain();c.type=t,c.frequency.setValueAtTime(e,s),a&&c.frequency.exponentialRampToValueAtTime(Math.max(20,e+a),s+n+r),eO(l,s,n,i,r),c.connect(l).connect(zD),c.start(s),c.stop(s+n+r+.05)}function tO({a:e=.002,d:t=.15,peak:n=.25,f0:r=800,f1:i=300,q:a=1,type:o=`bandpass`,delay:s=0}={}){if(!KD())return;let c=RD.currentTime+s,l=Math.ceil(RD.sampleRate*(e+t+.05)),u=RD.createBuffer(1,l,RD.sampleRate),d=u.getChannelData(0);for(let e=0;e<l;e++)d[e]=Math.random()*2-1;let f=RD.createBufferSource();f.buffer=u;let p=RD.createBiquadFilter();p.type=o,p.Q.value=a,p.frequency.setValueAtTime(r,c),p.frequency.exponentialRampToValueAtTime(Math.max(40,i),c+e+t);let m=RD.createGain();eO(m,c,e,n,t),f.connect(p).connect(m).connect(zD),f.start(c),f.stop(c+e+t+.05)}async function nO(e){return!e?.ref||!e.url?null:HD[e.ref]?HD[e.ref]:(UD[e.ref]||(UD[e.ref]=(async()=>{if(!KD())return null;try{let t=await fetch(e.url);if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.arrayBuffer();return HD[e.ref]=await RD.decodeAudioData(n.slice(0)),HD[e.ref]}catch{return HD[e.ref]=null,null}finally{delete UD[e.ref]}})()),UD[e.ref])}async function rO(e){let t=MD(`sfx`,e),n=MD(`sfx`,e,Sw);for(let r of[t,n]){if(!r||r!==t&&r.ref===t?.ref)continue;let n=await nO(r);if(n)return WD[e]=r.ref,n}return null}function iO(e,{gain:t=.85}={}){if(!KD())return!1;let n=HD[WD[e]];if(!n)return rO(e),!1;let r=RD.createBufferSource();r.buffer=n;let i=RD.createGain();return i.gain.value=t,r.connect(i).connect(zD),r.start(),!0}function aO(e,t,n){iO(e,n)||(t(),rO(e))}async function oO(e,t){if(!KD()||typeof e!=`string`)return!1;let n=MD(`sfx`,e,t),r=MD(`sfx`,e,Sw),i=null;for(let e of[n,r])if(!(!e||e!==n&&e.ref===n?.ref)&&(i=await nO(e),i))break;if(!i)return cO[e]?.(),!1;let a=RD.createBufferSource();a.buffer=i;let o=RD.createGain();return o.gain.value=.85,a.connect(o).connect(zD),a.start(),!0}function sO(){KD()&&GD.forEach(e=>{rO(e)})}var cO={click:()=>{J(520,{type:`triangle`,d:.045,peak:.13}),J(780,{type:`sine`,d:.035,peak:.06,delay:.008})},hover:()=>{J(640,{type:`sine`,d:.03,peak:.045})},card:()=>{tO({d:.12,f0:1800,f1:500,peak:.14})},draw:()=>{tO({d:.08,f0:2400,f1:900,peak:.08})},slash:()=>{tO({d:.18,f0:3200,f1:300,peak:.3,q:1.4}),J(180,{type:`sine`,d:.12,peak:.25,slide:-120})},hit:()=>{J(120,{type:`sine`,d:.22,peak:.4,slide:-70}),tO({d:.1,f0:500,f1:120,peak:.2,type:`lowpass`})},atkHeroLight:()=>{tO({d:.1,f0:3600,f1:700,peak:.18,q:1.2}),J(220,{type:`sine`,d:.08,peak:.16,slide:-80})},atkHeroMed:()=>{tO({d:.16,f0:3e3,f1:350,peak:.28,q:1.3}),J(160,{type:`sine`,d:.14,peak:.28,slide:-100})},atkHeroHeavy:()=>{tO({d:.22,f0:2800,f1:220,peak:.34,q:1.5}),J(110,{type:`sine`,d:.2,peak:.38,slide:-70}),J(90,{type:`triangle`,d:.12,peak:.16,delay:.02})},atkEnemyLight:()=>{tO({d:.11,f0:2400,f1:500,peak:.2,q:1.1}),J(180,{type:`sawtooth`,d:.09,peak:.1,slide:-90})},atkEnemyMed:()=>{tO({d:.18,f0:2e3,f1:280,peak:.3,q:1.2}),J(130,{type:`sine`,d:.16,peak:.3,slide:-60})},atkEnemyHeavy:()=>{tO({d:.26,f0:1600,f1:140,peak:.36,type:`lowpass`}),J(80,{type:`sawtooth`,d:.24,peak:.28,slide:-40})},blocked:()=>{J(180,{type:`square`,d:.1,peak:.16}),tO({d:.14,f0:1800,f1:400,peak:.22,q:2})},block:()=>{J(280,{type:`triangle`,d:.08,peak:.16}),J(420,{type:`triangle`,d:.1,peak:.14,delay:.04}),J(560,{type:`sine`,d:.08,peak:.08,delay:.08})},poison:()=>{tO({d:.22,f0:700,f1:220,peak:.14,q:2.5}),J(260,{type:`sine`,d:.18,peak:.1,slide:-120})},debuff:()=>{J(360,{type:`sawtooth`,d:.16,peak:.1,slide:-180})},buff:()=>{J(360,{type:`triangle`,d:.1,peak:.12}),J(480,{type:`triangle`,d:.12,peak:.12,delay:.05})},heal:()=>{J(523,{type:`sine`,d:.2,peak:.14}),J(659,{type:`sine`,d:.24,peak:.12,delay:.09}),J(784,{type:`sine`,d:.3,peak:.1,delay:.18})},energy:()=>{J(700,{type:`triangle`,d:.1,peak:.12,slide:300})},coin:()=>{J(988,{type:`square`,d:.06,peak:.08}),J(1319,{type:`square`,d:.12,peak:.08,delay:.06})},potion:()=>{J(500,{type:`sine`,d:.12,peak:.14,slide:300}),tO({d:.14,f0:1200,f1:2600,peak:.06})},death:()=>{J(90,{type:`sawtooth`,d:.5,peak:.22,slide:-50}),tO({d:.4,f0:600,f1:60,peak:.18,type:`lowpass`})},bigDeath:()=>{J(60,{type:`sawtooth`,d:1.1,peak:.32,slide:-30}),tO({d:.9,f0:900,f1:40,peak:.26,type:`lowpass`})},turn:()=>{J(392,{type:`triangle`,d:.1,peak:.1}),J(587,{type:`triangle`,d:.14,peak:.1,delay:.08})},victory:()=>{[523,659,784,1047].forEach((e,t)=>J(e,{type:`triangle`,d:.35,peak:.16,delay:t*.13}))},defeat:()=>{[330,277,220,165].forEach((e,t)=>J(e,{type:`sawtooth`,d:.5,peak:.12,delay:t*.22}))},relic:()=>{[659,831,988].forEach((e,t)=>J(e,{type:`sine`,d:.3,peak:.12,delay:t*.09}))},upgrade:()=>{J(440,{type:`triangle`,d:.15,peak:.14}),J(880,{type:`triangle`,d:.3,peak:.12,delay:.1})},map:()=>{tO({d:.25,f0:500,f1:1500,peak:.06}),J(330,{type:`sine`,d:.2,peak:.08})},chip:()=>{J(1420,{type:`triangle`,d:.05,peak:.14}),tO({d:.06,f0:5200,f1:3200,peak:.1,q:5})},shatter:()=>{tO({d:.42,f0:4200,f1:260,peak:.3,q:3.5}),J(220,{type:`sine`,d:.3,peak:.24,slide:-140}),J(1760,{type:`triangle`,d:.18,peak:.1,delay:.03})},ember:()=>{J(520,{type:`sine`,d:.12,peak:.12,slide:220})},kindle:()=>{tO({d:.3,f0:900,f1:2600,peak:.1}),J(392,{type:`sine`,d:.22,peak:.1,slide:140})},stagger:()=>{J(233,{type:`sawtooth`,d:.38,peak:.1}),J(247,{type:`sawtooth`,d:.38,peak:.1,delay:.02})},art:()=>{[392,494,587].forEach((e,t)=>J(e,{type:`triangle`,d:.28,peak:.13,delay:t*.07})),tO({d:.35,f0:1400,f1:3200,peak:.07})},omen:()=>{J(98,{type:`sine`,d:1.1,peak:.2}),J(196,{type:`sine`,d:.9,peak:.1,delay:.12}),J(147,{type:`triangle`,d:.8,peak:.06,delay:.3})}};function lO(e,t=0,n=0){let r=Math.max(0,(t|0)+(n|0));return`${e===`enemy`?`atkEnemy`:`atkHero`}${r>=16?`Heavy`:r<=5?`Light`:`Med`}`}function uO({who:e=`hero`,amount:t=0,blocked:n=0}={}){let r=lO(e,t,n);aO(r,cO[r]||cO.slash)}var Y=Object.fromEntries(Object.keys(cO).map(e=>[e,()=>aO(e,cO[e])]));Y.attack=uO,Y.slash=()=>uO({who:`hero`,amount:8}),Y.hit=()=>{};var dO=.8,fO=.35,pO=`spirebound_vol_music`,mO=`spirebound_mute_music`;function hO(){let e=parseFloat(localStorage.getItem(pO));return Number.isFinite(e)?Math.min(1,Math.max(0,e)):fO}function gO(){let e=localStorage.getItem(`spirebound_mute`);return localStorage.getItem(mO)==null&&e===`1`?!0:localStorage.getItem(mO)===`1`}var _O=hO(),vO=gO(),yO=null,bO=null,xO=null,SO=null,CO=null,wO=0,TO=Object.create(null),EO=Object.create(null),DO=new Set,OO={title:[`embark`,`vigil`],embark:[`map`],vigil:[`title`],map:[`act1Combat`,`safeNodes`,`elite`],safeNodes:[`map`],act1Combat:[`act1Boss`,`map`,`elite`],act1Boss:[`map`,`victory`],act2Combat:[`act2Boss`,`map`,`elite`],act2Boss:[`map`,`victory`],act3Combat:[`act3Boss`,`map`,`elite`],act3Boss:[`victory`,`defeat`],elite:[`map`],victory:[`title`,`vigil`],defeat:[`title`,`vigil`]},kO=Object.fromEntries(yw.map(e=>[e.id,{title:e.title,wired:e.wired,...OO[e.id]?{warmWith:OO[e.id]}:{}}]));function AO(){if(!KD())return null;if(yO)return yO;let e=qD();return yO=e.createGain(),yO.gain.value=vO?0:_O,yO.connect(e.destination),yO}function jO(e=.08){if(!yO)return;let t=qD(),n=vO?0:_O;yO.gain.cancelScheduledValues(t.currentTime),yO.gain.linearRampToValueAtTime(n,t.currentTime+e)}function MO(){return _O}function NO(){return vO}function PO(e){return _O=Math.min(1,Math.max(0,+e||0)),localStorage.setItem(pO,String(_O)),jO(),_O}function FO(e){return vO=!!e,localStorage.setItem(mO,vO?`1`:`0`),jO(),vO}async function IO(e){return!e?.ref||!e.url||DO.has(e.ref)?null:TO[e.ref]?TO[e.ref]:(EO[e.ref]||(EO[e.ref]=(async()=>{if(!KD())return null;try{let t=await fetch(e.url);if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.arrayBuffer();return TO[e.ref]=await qD().decodeAudioData(n.slice(0)),TO[e.ref]}catch{return DO.add(e.ref),TO[e.ref]=null,null}finally{delete EO[e.ref]}})()),EO[e.ref])}async function LO(e,t){if(!kO[e])return null;let n=MD(`music`,e,t),r=MD(`music`,e,Sw);for(let e of[n,r]){if(!e||e!==n&&e.ref===n?.ref)continue;let t=await IO(e);if(t)return{buffer:t,source:e}}return null}function RO(...e){e.flat().forEach(e=>{kO[e]&&LO(e)})}function zO(){if(!SO||!CO)return;let e=qD(),t=SO,n=CO;SO=null,CO=null,xO=null;try{n.gain.cancelScheduledValues(e.currentTime),n.gain.linearRampToValueAtTime(1e-4,e.currentTime+dO),t.stop(e.currentTime+dO+.05)}catch{}setTimeout(()=>{try{t.disconnect()}catch{}try{n.disconnect()}catch{}},.9*1e3)}async function BO(e,{force:t=!1,selection:n}={}){let r=kO[e];if(!r||!r.wired&&!t)return;let i=MD(`music`,e,n);if(!i)return;if(e===bO&&xO===i.ref&&SO){r.warmWith&&RO(r.warmWith);return}if(!AO())return;let a=++wO,o=await LO(e,n);if(a!==wO||!o)return;let s=qD();zO();let c=s.createBufferSource();c.buffer=o.buffer,c.loop=!0;let l=s.createGain();l.gain.setValueAtTime(1e-4,s.currentTime),l.gain.linearRampToValueAtTime(1,s.currentTime+dO),c.connect(l).connect(yO),c.start(),bO=e,o.source.ref,xO=i.ref,SO=c,CO=l,r.warmWith&&RO(r.warmWith)}function VO(e){return BO(e)}function HO(e,t){return BO(e,{force:!0,selection:t})}function UO(){wO++,bO=null,xO=null,zO()}var WO={title:`title`,embark:`embark`,vigil:`vigil`,map:`map`,shop:`safeNodes`,rest:`safeNodes`,treasure:`safeNodes`,event:`map`,lamplighter:`map`};function GO(e){let t=WO[e];if(t)return VO(t)}function KO(e,t){let n=Math.max(0,Math.min(2,t|0))+1;return VO(e===`boss`?`act${n}Boss`:e===`elite`?`elite`:`act${n}Combat`)}function qO(e){return VO(e?`victory`:`defeat`)}var JO={shared:{sizes:{normal:185,elite:230,boss:280},heroes:{},enemies:{}},base:{groundY:232,ledgeLip:14,hero:{x:179,w:190,h:285},slots:{1:[{x:980,s:1}],2:[{x:820,s:1},{x:1035,s:1}],3:[{x:698,y:42,s:1},{x:845,y:-18,s:1},{x:996,y:26,s:1}]},layers:{backdrop:{h:640,y:0,zoom:1,posX:50,opacity:.85},mid:{h:1e3,y:300,x:100,zoom:.4,posX:100,opacity:.95},ledge:{h:450,y:0,zoom:1,posX:100,opacity:1}}},shapes:{"phone-portrait":{groundY:250,hero:{x:42,w:80,h:130},slots:{1:[{x:300,s:.5,footX:0,footY:0}],2:[{x:248,s:.65},{x:349,s:.7}],3:[{x:218,s:.5},{x:298,y:32,s:.5},{x:357,s:.55}]},layers:{backdrop:{h:658,y:315,x:100,zoom:.9,posX:50,opacity:.6,drift:20},mid:{h:489,y:315,zoom:.5,posX:50,opacity:.95,drift:5},ledge:{h:600,y:0,zoom:.7,posX:50,opacity:1}},acts:{1:{slots:{1:[{x:300,s:.5,footX:0,footY:-30}]},layers:{backdrop:{x:0},ledge:{h:500,opacity:.6}}},2:{layers:{backdrop:{h:1e3},mid:{y:260,x:-50},ledge:{h:450,opacity:.8}}}}},"phone-landscape":{groundY:132,hero:{x:135,w:100,h:150},slots:{1:[{x:730,s:.5,footX:-150,footY:-40}],2:[{x:590,s:.62},{x:730,s:.62}],3:[{x:503,y:19,s:.55},{x:628,y:-2,s:.55},{x:740,y:19,s:.55}]},layers:{backdrop:{h:700,y:150,zoom:1,posX:100,opacity:.85,drift:20},mid:{h:600,y:170,zoom:.4,posX:100,opacity:.95,drift:10},ledge:{h:275,y:0,zoom:1,posX:50,opacity:1}},acts:{1:{groundY:132,layers:{backdrop:{h:1e3,y:180,zoom:.6,opacity:.6},mid:{zoom:.5},ledge:{h:220,opacity:.7}}},2:{groundY:160,layers:{backdrop:{zoom:.8},mid:{y:160,x:-200},ledge:{h:200}}}}},"pad-portrait":{groundY:359,hero:{x:102},slots:{1:[{x:655,s:1,footX:0}],2:[{x:505,s:.95},{x:710,s:1}],3:[{x:410,y:34,s:.85},{x:560,y:-87,s:.85},{x:730,y:2,s:.9}]},layers:{backdrop:{h:920,y:450,zoom:.8,posX:50,opacity:.85,drift:30},mid:{h:684,y:430,x:50,zoom:.6,posX:50,opacity:.95,drift:10},ledge:{h:400,y:0,zoom:1.5,posX:50,opacity:1}},acts:{1:{layers:{backdrop:{opacity:.55},mid:{y:460},ledge:{h:400,zoom:1.3,opacity:.6}}},2:{layers:{backdrop:{h:1600,opacity:.7},mid:{y:400,x:-150},ledge:{h:410,zoom:1.2,opacity:.6}}}}},"pad-landscape":{hero:{x:200},slots:{3:[{x:698,y:42,s:1},{x:850,y:-18,s:1},{x:996,y:26,s:1}]},layers:{backdrop:{y:0,drift:30}},acts:{0:{layers:{backdrop:{y:280},mid:{y:300,drift:10}}},1:{groundY:220,layers:{backdrop:{h:800,y:280,x:-50,zoom:.9},mid:{zoom:.5,drift:10},ledge:{h:350,opacity:.7}}},2:{layers:{backdrop:{h:800,y:300},mid:{y:200,x:-300,zoom:.5,drift:10},ledge:{h:320,opacity:.9}}}}},"desktop-landscape":{groundY:216,hero:{x:212},slots:{1:[{x:1164,y:-16,s:1}],2:[{x:1066,y:5,s:1},{x:1197,y:-39,s:1}],3:[{x:940,y:17,s:1},{x:1095,y:-50,s:1},{x:1260,y:22,s:1}]},layers:{backdrop:{h:1527,y:273,x:-42,zoom:.6},mid:{h:1e3,y:308,x:189,zoom:.4,drift:0},ledge:{h:480,y:0,posY:0}},acts:{0:{layers:{backdrop:{h:1e3,y:280,x:-100,zoom:.9,posX:100,opacity:.7,drift:30},mid:{drift:10}}},1:{layers:{backdrop:{h:1200,y:250,x:-150,zoom:.8,posX:100,opacity:.5,drift:30},mid:{y:280,x:100,zoom:.6,opacity:.9,drift:10},ledge:{h:360,opacity:.4}}},2:{layers:{backdrop:{h:1100,y:270,zoom:1,drift:30},mid:{y:200,x:-300,zoom:.5,drift:15},ledge:{h:330,posX:100,opacity:.8}}}}}}},YO=new Set;function XO(e){return YO.add(e),()=>YO.delete(e)}var ZO=e=>e&&typeof e==`object`&&!Array.isArray(e);function QO(e,t){if(t===void 0)return e;if(!ZO(e)||!ZO(t))return t;let n={...e};for(let r of Object.keys(t))n[r]=QO(e[r],t[r]);return n}var $O={backdrop:{x:0,posY:100,drift:6},mid:{x:0,posY:100,drift:3},ledge:{x:0,posY:0,drift:0}};function ek(e){if(!e||typeof e!=`object`)return e;let{acts:t,...n}=e;return n}function tk(e,t){let n=String(t);return JO.shapes?.[e]?.acts?.[n]??(e===`pad-landscape`?JO.base?.acts?.[n]:void 0)??JO.acts?.[n]}function nk(e,t=0){let n=ek(JO.shapes?.[e]),r=QO(QO(ek(JO.base),n),tk(e,t)),i={};for(let e of[`backdrop`,`mid`,`ledge`])i[e]={...$O[e],...r.layers?.[e]??{}};return{...r,layers:i,shared:JO.shared}}function rk(e){return e.hero?.y??0}function ik(e,t){return up(t)}function ak(e,t){let n=e.slots?.[t];if(n)return n;let r=Object.keys(e.slots??{}).map(Number).filter(Number.isFinite).sort((e,t)=>e-t);if(!r.length)return Array.from({length:t},(e,t)=>({x:200+t*200,s:1}));let i=e.slots[r[r.length-1]],a=i[0],o=i[i.length-1];return Array.from({length:t},(e,n)=>{let r=t===1?1:n/(t-1);return{x:Math.round(a.x+(o.x-a.x)*r),s:Math.min(a.s??1,o.s??1),y:Math.round((a.y??0)+((o.y??0)-(a.y??0))*r)}})}function ok(e,t){return e?.footX??ik(`enemies`,t).footX}function sk(e,t){return e?.footY??ik(`enemies`,t).footY}function ck(e,t){let n=e.map((e,n)=>({i:n,bottom:(e?.y??0)+sk(e,t[n])}));n.sort((e,t)=>t.bottom-e.bottom);let r=Array(e.length);return n.forEach((e,t)=>{r[e.i]=t+1}),r}function lk(e,t,n,r,i,a){let o=ik(`enemies`,t),s=(e.shared.sizes?.[n]??185)*o.scale*(r?.s??1);return Math.round(Math.max(8,s))}var uk={base:{energy:{left:24,bottom:148},lantern:{left:42,bottom:262,w:104,h:104},endTurn:{right:22,bottom:128,w:120,h:120},draw:{left:16,bottom:14,w:96,h:148},discard:{right:22,bottom:14,w:96,h:148},ashes:{right:132,bottom:14,w:96,h:148},hud:{height:56,scale:1},omen:{left:16,top:62,scale:1},relics:{left:66,top:62,scale:1},hand:{left:0,bottom:-12,scale:1}},shapes:{"phone-portrait":{energy:{left:5,bottom:575},lantern:{left:5,bottom:476,w:78,h:78},endTurn:{right:296,bottom:359,w:96,h:96},draw:{left:317,bottom:634,w:68,h:108},discard:{right:5,bottom:526,w:68,h:108},ashes:{right:5,bottom:418,w:68,h:108},hud:{height:47,scale:1},omen:{left:10,top:52,scale:1},relics:{left:52,top:52,scale:1},hand:{left:0,bottom:-6,scale:1}},"phone-landscape":{energy:{left:0,bottom:133},lantern:{left:2,bottom:236,w:68,h:68},endTurn:{right:0,bottom:264,w:84,h:84},draw:{left:5,bottom:5,w:64,h:102},discard:{right:5,bottom:105,w:64,h:102},ashes:{right:5,bottom:5,w:64,h:102},hud:{height:34,scale:1},omen:{left:12,top:40,scale:1},relics:{left:56,top:40,scale:1},hand:{left:0,bottom:-33,scale:1}},"pad-portrait":{energy:{left:6,bottom:665},lantern:{left:10,bottom:772,w:94,h:94},endTurn:{right:9,bottom:654,w:104,h:104},draw:{left:0,bottom:140,w:96,h:148},discard:{right:0,bottom:140,w:96,h:148},ashes:{right:0,bottom:0,w:96,h:148}},"pad-landscape":{energy:{left:0,bottom:162},lantern:{left:18,bottom:268,w:104,h:104},endTurn:{right:0,bottom:163,w:120,h:120}},"desktop-landscape":{energy:{left:4,bottom:161},lantern:{left:18,bottom:267,w:104,h:104},endTurn:{right:7,bottom:162,w:120,h:120},draw:{left:17,bottom:14,w:96,h:148}}}},dk=new Set;function fk(e){return dk.add(e),()=>dk.delete(e)}var pk=e=>e&&typeof e==`object`&&!Array.isArray(e);function mk(e,t){if(t===void 0)return e;if(!pk(e)||!pk(t))return t;let n={...e};for(let r of Object.keys(t))n[r]=mk(e[r],t[r]);return n}function hk(e){return mk(uk.base,uk.shapes?.[e])}var X={run:null,cb:null,screen:`title`,targeting:null,busy:!1,hoveredCard:null,ce:null,drag:null},gk=new URLSearchParams(location.search).get(`input`),_k=gk?gk===`touch`:matchMedia(`(pointer: coarse)`).matches,vk=gk?gk===`mouse`:matchMedia(`(hover: hover) and (pointer: fine)`).matches,Z=(e,t=document)=>t.querySelector(e),yk=(e,t=document)=>[...t.querySelectorAll(e)],Q=e=>new Promise(t=>setTimeout(t,e)),bk=()=>Z(`#screen`);function $(e,t=``,n=``){let r=document.createElement(e);return t&&(r.className=t),n&&(r.innerHTML=n),r}var xk=e=>String(e).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),Sk=(e,t,n)=>{let r=gC(e,t);return r?`<img class="raster-art" src="${r}" alt="">`:n};function Ck(){let e=gC(`stage`,`act${(X.run?.act??0)+1}-backdrop`);return e?`<div class="scene-bg" style="background-image:url('${e}')"></div>`:``}function wk(e){let t=gC(`meta`,e);return t?`<div class="meta-bg" style="background-image:url('${t}')"></div>`:``}var Tk=(e,t=22)=>{let n=gC(`relics`,e);return n?`<img class="raster-art relic-art" src="${n}" alt="" style="width:${t}px;height:${t}px">`:Mu[e]?.glyph||`◈`},Ek=e=>{let t=gC(`relics`,e);return t?`<img class="relic-art hud-relic-art" src="${t}" alt="">`:`<span class="hud-relic-fallback">${Mu[e]?.glyph||`◈`}</span>`},Dk=(e,t,n,r=22)=>{let i=gC(`omens`,e);return i?`<img class="${t}" src="${i}" alt="">`:`<span class="${n}">${zC(`omen-${e}`,r)}</span>`},Ok=(e,t)=>e?`<svg class="aim-ring" aria-hidden="true"><image href="${xk(e)}" x="0" y="0" width="100%" height="100%" preserveAspectRatio="xMidYMax meet" filter="url(#aim-outline-${t})"/></svg>`:``;function kk(e,t,n=!1){e&&qm(e.classList?.contains(`hero-sprite`)||e.classList?.contains(`enemy-sprite`)?e:Z(`.hero-sprite, .enemy-sprite`,e)||e,!!t,{grow:n})}var Ak=e=>{let t=gC(`heroes`,qu[e].id);return t?`<div class="hero-sprite">${Ok(t,`self`)}${Sk(`heroes`,qu[e].id,DC(e))}<svg class="cracks-overlay" viewBox="0 0 200 200"><g class="cracks"></g></svg></div>`:`<div class="hero-sprite">${DC(e)}</div>`},jk=!1;function Mk(){if(!jk){jk=!0;for(let e of[..._C(`enemies`),..._C(`heroes`)])new Image().src=e}}var Nk=`Every creature is glass with a Facet gauge. Fill it and the glass Shatters — the creature loses its next action, is Cracked, and spills Embers into your lantern.`,Pk={Cracked:ju.vulnerable.desc,Dimmed:ju.weak.desc,Brittle:ju.frail.desc,Smolder:ju.poison.desc,Fervor:ju.str.desc,Poise:ju.dex.desc,Kindle:`Burned away for the rest of this combat — and the lantern gains 1 Ember.`,Ward:`Held light that prevents damage. Expires at the start of your turn.`,Energy:`Spent to play cards. Refreshes each turn.`,Ember:`Fuel for your Lantern Art. Spilled by shatters, deaths and kindling; held in the lantern.`,Embers:`Fuel for your Lantern Art. Spilled by shatters, deaths and kindling; held in the lantern.`,Chip:`Strike at the glass itself: adds toward a Shatter, no blood required.`,Facet:Nk,Facets:Nk,Shatter:Nk,Shatters:Nk,Staggered:`Shattered glass loses its next action while it reseams.`,Unplayable:`This card cannot be played.`,Shard:`Unplayable junk glass. It can still be kindled.`,Hex:`Curse: lose 1 HP at end of turn while in hand. Cannot be kindled.`,Cinder:`Take 2 damage at end of turn while in hand.`};function Fk(){let e=Z(`#tooltip`),t=t=>{let n=t._tip;e.innerHTML=`${n.title?`<div class="tt-title">${n.title}</div>`:``}<div class="tt-body">${n.body||``}</div>${n.sub?`<div class="tt-sub">${n.sub}</div>`:``}`,e.style.display=`block`},n=e=>{let t=e;for(;t&&t!==document.body&&!t._tip;)t=t.parentElement;return t&&t._tip?t:null},r=(t,n,r)=>{if(e.style.display!==`block`)return;let{x:i,y:a}=S(t,n),o=e.offsetWidth,s=e.offsetHeight;r?(e.style.left=`${Math.max(8,Math.min(_()-o-8,i-o/2))}px`,e.style.top=`${Math.max(8,a-s-26)}px`):(e.style.left=`${Math.min(_()-o-12,i+16)}px`,e.style.top=`${Math.max(8,Math.min(v()-s-12,a-s/2))}px`)};document.addEventListener(`pointerover`,i=>{if(!vk||i.pointerType!==`mouse`)return;let a=n(i.target);a?(t(a),r(i.clientX,i.clientY,!1)):e.style.display=`none`}),document.addEventListener(`pointermove`,e=>{vk&&e.pointerType===`mouse`?r(e.clientX,e.clientY,!1):i&&Math.hypot(e.clientX-a,e.clientY-o)>12&&(clearTimeout(i),i=0)});let i=0,a=0,o=0,s=0;document.addEventListener(`pointerdown`,c=>{if(c.pointerType===`mouse`)return;e.style.display=`none`,clearTimeout(s);let l=n(c.target);l&&(a=c.clientX,o=c.clientY,clearTimeout(i),i=setTimeout(()=>{i=0,t(l),r(a,o,!0)},380))},!0);let c=t=>{t.pointerType!==`mouse`&&(i&&=(clearTimeout(i),0),clearTimeout(s),s=setTimeout(()=>e.style.display=`none`,1700))};document.addEventListener(`pointerup`,c),document.addEventListener(`pointercancel`,c)}function Ik(e,t){let n=e.replace(/@(\d+)@/g,(e,n)=>{let r=+n,i=t&&X.cb?vg(X.cb,r):r;return`<span class="val ${i>r?`boosted`:i<r?`reduced`:``}">${i}</span>`}).replace(/#(\d+)#/g,(e,n)=>{let r=+n,i=t&&X.cb?yg(X.run,X.cb,r):r;return`<span class="val ${i>r?`boosted`:i<r?`reduced`:``}">${i}</span>`});return n=n.replace(/\b(Cracked|Dimmed|Brittle|Smolder|Fervor|Poise|Kindle|Ward|Energy|Embers?|Chip|Facets?|Shatters?|Staggered|Unplayable|Shard|Hex|Cinder)\b/g,`<span class="kw">$1</span>`),n}function Lk(e,{inCombat:t=!1,size:n=null}={}){let r=sh(e),i=$(`div`,`card t-${r.type} r-${r.rarity}${e.up?` upgraded`:``}`);n&&i.style.setProperty(`--cw`,`${n}px`),e.uid!=null&&(i.dataset.uid=e.uid);let a=``;if(r.cost!=null){let n=t&&X.cb?lg(X.run,X.cb,e):r.cost;a=`<div class="card-cost ${n===0?`free`:``}">${n}</div>`}let o=Ik(r.text,t);return e.bonus&&(o=o.replace(/<span class="val[^"]*">(\d+)<\/span>/,(t,n)=>t.replace(n,+n+e.bonus))),i.innerHTML=`<div class="card-lift">${a}<div class="card-inner">
    <div class="card-art">${Sk(`cards`,e.id,AC(e.id,r.type))}</div>
    <div class="card-name">${r.name}</div>
    <div class="card-type">${r.type}</div>
    <div class="card-text"><span class="ct-inner">${o}</span></div>
    <div class="card-rarity"></div>
  </div></div>`,yk(`.kw`,i).forEach(e=>e._tip={title:e.textContent,body:Pk[e.textContent]||``}),vk&&i.addEventListener(`mousemove`,e=>{let t=i.getBoundingClientRect(),n=(e.clientX-t.left)/t.width,r=(e.clientY-t.top)/t.height,a=Z(`.card-inner`,i);a.style.setProperty(`--ry`,`${(n-.5)*16}deg`),a.style.setProperty(`--rx`,`${(.5-r)*12}deg`),a.style.setProperty(`--mx`,`${n*100}%`),a.style.setProperty(`--my`,`${r*100}%`),a.style.setProperty(`--gx`,(n-.5)*60)}),i.addEventListener(`mouseleave`,()=>{let e=Z(`.card-inner`,i);e.style.setProperty(`--ry`,`0deg`),e.style.setProperty(`--rx`,`0deg`)}),i}function Rk(){let e=Z(`#lantern`),t=X.screen===`combat`?Z(`.combat-screen .stage-dim`):null;if(!X.run||X.screen===`title`||X.screen===`end`||X.screen===`lamplighter`){e.style.setProperty(`--la`,0),e.classList.remove(`gutter`,`snuff`),t&&(t.style.setProperty(`--la`,0),t.classList.remove(`gutter`));return}let n=X.run.player,r=X.cb&&!X.cb.over?X.cb.player.hp:n.hp,i=Math.max(0,Math.min(1,(.68-r/n.maxHp)/.53)),a=(i*.82).toFixed(3),o=`${Math.round(1500-i*1e3)}px`,s=`50%`,c=`55%`;if(X.screen===`combat`&&X.ce?.hero){let e=qf(X.ce.hero);s=`${Math.round(e.x)}px`,c=`${Math.round(e.y)}px`}e.style.setProperty(`--la`,a),e.style.setProperty(`--lr`,o),e.style.setProperty(`--lx`,s),e.style.setProperty(`--ly`,c),e.classList.toggle(`gutter`,i>.55&&!e.classList.contains(`snuff`)),t&&(t.style.setProperty(`--la`,a),t.style.setProperty(`--lr`,o),t.style.setProperty(`--lx`,s),t.style.setProperty(`--ly`,c),t.classList.toggle(`gutter`,i>.55))}function zk(){Rk();let e=Z(`#hud`);if(!X.run||X.screen===`title`||X.screen===`embark`||X.screen===`vigil`||X.screen===`end`||X.screen===`lamplighter`){e.classList.remove(`show`),document.body.classList.remove(`low-hp`);return}e.classList.add(`show`);let t=X.run.player,n=X.cb&&!X.cb.over?X.cb.player.hp:t.hp;document.body.classList.toggle(`low-hp`,n/t.maxHp<=.3);let r=Ou[X.run.act];e.innerHTML=`<div class="hud-bar">
      <div class="hud-hp-wrap">
        <div class="hud-stat">${VC(`heart`,14)} <span class="hp-num">${n} / ${t.maxHp}</span></div>
        <div class="hud-hpbar"><div style="width:${100*n/t.maxHp}%"></div></div>
      </div>
      <div class="hud-stat">${VC(`coin`,14)} <span class="gold-num">${t.gold}</span></div>
      <div class="hud-mid"><b>${r.name.toUpperCase()}</b> &nbsp;·&nbsp; Act ${X.run.act+1} &nbsp;·&nbsp; Floor ${X.run.floorsClimbed} &nbsp;·&nbsp; ${r.bossName}</div>
      <div class="hud-right">
        ${mh(X.run,`phials`)?t.potions.map((e,t)=>`<button class="potion-slot ${e?`full`:``}" data-slot="${t}">${e?Sk(`potions`,e,jC(Pu[e].tone)):``}</button>`).join(``):``}
        <button class="icon-btn deck-btn" data-act="deck" aria-label="Deck">${VC(`deck`,32)}<span class="deck-count">${t.deck.length}</span></button>
        <button class="icon-btn" data-act="menu" aria-label="Menu">${VC(`menu`,19)}</button>
      </div>
    </div>
    <div id="omen-slot"></div>
    <div id="relicbar"></div>`;let i=Z(`#omen-slot`,e),a=Z(`#relicbar`,e),o=X.run.omens?.[X.run.act],s=Bu[o];if(s){let e=$(`div`,`relic-chip omen-chip`,Dk(o,`hud-omen-art`,`hud-omen-fallback`,24));e.style.setProperty(`--tone`,s.tone),e._tip={title:`Omen — ${s.name}`,body:s.text,sub:`hangs over Act ${X.run.act+1}`},i.appendChild(e)}for(let e of t.relics){let t=Mu[e],n=$(`div`,`hud-relic`,Ek(e));n.style.setProperty(`--tone`,t.tone),n.dataset.relic=e,n._tip={title:t.name,body:t.text,sub:t.rarity},a.appendChild(n)}t.potions.forEach((t,n)=>{if(!t)return;let r=Z(`.potion-slot[data-slot="${n}"]`,e);r&&(r._tip={title:Pu[t].name,body:Pu[t].text,sub:`Click to use or toss`})}),Z(`[data-act="deck"]`,e).onclick=()=>{Y.click(),Xk(`Your Deck`,X.run.player.deck,{sub:`${X.run.player.deck.length} cards`})},Z(`[data-act="menu"]`,e).onclick=e=>{Y.click(),Bk(e.clientX,e.clientY)},yk(`.potion-slot.full`,e).forEach(e=>e.onclick=t=>Gk(+e.dataset.slot,t)),vA()}function Bk(e,t){Vk();let{x:n,y:r}=S(e,t),i=$(`div`,`pop-menu`);i.innerHTML=`<button data-m="help">How to Play</button><button data-m="settings">Settings</button><button data-m="abandon" style="color:#ff8d8d">Abandon Run</button>`,b().appendChild(i),i.style.left=`${Math.min(n,_()-200)}px`,i.style.top=`${r+8}px`,i.onclick=e=>{let t=e.target.dataset.m;Vk(),t===`help`&&Zk(),t===`settings`&&Uk(),t===`abandon`&&qk()},setTimeout(()=>document.addEventListener(`pointerdown`,Hk,{once:!0}),0)}var Vk=()=>yk(`.pop-menu, .audio-panel, .settings-panel`).forEach(e=>e.remove()),Hk=e=>{e.target.closest(`.pop-menu, .audio-panel, .settings-panel`)||Vk()};function Uk(){Vk();let e=$(`div`,`settings-panel audio-panel`),t=(e,t,n,r)=>`
    ...
    <button type="button" class="audio-close" data-a="close">Close</button>`,b().appendChild(e);let n=t=>{let n=Z(`.audio-row[data-bus="${t}"]`,e),r=Z(`.audio-vol`,n),i=Z(`.audio-mute`,n),a=t===`music`?MO:XD,o=t===`music`?PO:QD,s=t===`music`?NO:ZD,c=t===`music`?FO:$D;r.oninput=()=>{o(r.value/100),t===`sfx`&&Y.click()},i.onclick=()=>{let e=c(!s());i.textContent=e?`Unmute`:`Mute`,r.disabled=e,r.value=String(Math.round(a()*100)),Y.click()}};n(`music`),n(`sfx`),Z(`[data-a="close"]`,e).onclick=()=>Vk(),Z(`[data-a="reset"]`,e).onclick=()=>{Vk(),Wk()},setTimeout(()=>document.addEventListener(`pointerdown`,Hk,{once:!0}),0)}function Wk(){Jk(`<div class="panel ov-panel" style="text-align:center">
  ...
  </div>`,e=>{e.onclick=e=>{let t=e.target.dataset.a;t===`yes`&&(Ag(),ow(),X.run=null,X.cb=null,X.embark=null,Yk(),Y.click(),tA(`title`)),t===`no`&&Yk()}})}function Gk(e,t){if(X.busy)return;Vk();let n=X.run.player.potions[e];if(!n)return;let r=Pu[n],i=X.cb&&!X.cb.over&&X.screen===`combat`,a=!r.combatOnly||i,o=$(`div`,`pop-menu`);o.innerHTML=`<button data-m="use" ${a?``:`disabled style="opacity:.4"`}>Use ${r.name}</button><button data-m="toss">Toss it</button>`,b().appendChild(o);let s=S(t.clientX,t.clientY);o.style.left=`${Math.min(s.x-60,_()-220)}px`,o.style.top=`${s.y+10}px`,o.onclick=async t=>{let n=t.target.dataset.m;if(Vk(),n===`toss`&&(X.run.player.potions[e]=null,Y.card(),zk(),Og(X.run)),n===`use`&&a)if(r.needsTarget&&i){let t=X.cb.enemies.filter(e=>e.hp>0);if(t.length===1)return Kk(e,t[0].idx);tj({kind:`potion`,slot:e})}else Kk(e,null)},setTimeout(()=>document.addEventListener(`pointerdown`,Hk,{once:!0}),0)}async function Kk(e,t){nj(),Y.potion(),X.cb&&!X.cb.over&&X.screen===`combat`?(mg(X.run,X.cb,e,t),await Kj(),Qj()):(mg(X.run,null,e,null),zk(),Og(X.run))}function qk(){Jk(`<div class="panel ov-panel" style="text-align:center">
  ...
  </div>`,e=>{e.onclick=e=>{let t=e.target.dataset.a;t===`yes`&&(dw(X.run),Mg(X.run,!1),X.run=null,X.cb=null,Yk(),tA(`title`)),t===`no`&&Yk()}})}function Jk(e,t=null,n=!1){let r=Z(`#overlay`);r.innerHTML=e,r.classList.add(`open`),r._closable=n,t&&t(r.firstElementChild)}function Yk(){let e=Z(`#overlay`);e.classList.remove(`open`),e.innerHTML=``}function Xk(e,t,{sub:n=``,pick:r=null,canSkip:i=!1,skipLabel:a=`Skip`,inCombat:o=!1}={}){let s=$(`div`,`panel ov-panel`);s.innerHTML=`<div class="ov-title">${e}</div>${n?`<div class="ov-sub">${n}</div>`:``}`;let c=$(`div`,`card-grid ${r?`choice-cards`:``}`),l=r?t:[...t].sort((e,t)=>sh(e).name.localeCompare(sh(t).name));for(let e of l){let t=Lk(e,{inCombat:o});r&&(t.onclick=()=>{Y.click(),t.classList.add(`picked`),setTimeout(()=>{Yk(),r(e)},240)}),c.appendChild(t)}s.appendChild(c);let u=$(`div`,`ov-actions`);if(i&&r){let e=$(`button`,`btn ghost`,a);e.onclick=()=>{Y.click(),Yk(),r(null)},u.appendChild(e)}if(!r){let e=$(`button`,`btn ghost`,`Close`);e.onclick=()=>{Y.click(),Yk()},u.appendChild(e)}s.appendChild(u),Jk(``,null,!r),Z(`#overlay`).appendChild(s)}function Zk(){Jk(`<div class="panel ov-panel howto">
  ...
  </div>`,e=>{Z(`[data-a="ok"]`,e).onclick=()=>{Y.click(),Yk()}},!0)}function Qk(){if(xj)return;let e=Z(`#wipe`);e.classList.remove(`go`),e.offsetWidth,e.classList.add(`go`),setTimeout(()=>e.classList.remove(`go`),620)}var $k=0;async function eA(e,t={}){if(xj)return;let n=Z(`#transit`);if(!n)return;let r=++$k,i=(e,t,i)=>(n.innerHTML=e,n.classList.add(`on`),n.firstElementChild.animate(t,{duration:i,easing:`cubic-bezier(0.4, 0, 0.2, 1)`}).finished.catch(()=>{}).finally(()=>{r===$k&&(n.classList.remove(`on`),n.innerHTML=``)}));if(e===`combat-in`){let e=t.x??_()/2,n=t.y??v()/2;return i(`<div class="tr-iris"></div>`,[{clipPath:`circle(150% at ${e}px ${n}px)`},{clipPath:`circle(0% at ${e}px ${n}px)`}],480)}if(e===`victory-out`)return i(`<div class="tr-bloom"></div>`,[{opacity:0},{opacity:1,offset:.4},{opacity:0}],900);if(e===`defeat`)return i(`<div class="tr-crack"></div>`,[{opacity:0},{opacity:1}],700);if(e===`act-change`){let e=Bu[X.run.omens?.[X.run.act]];return i(`<div class="tr-plate"><div class="tp-act">ACT ${X.run.act+1} - ${Ou[X.run.act].name.toUpperCase()}</div>
      ${e?`<div class="tp-omen" style="color:${e.tone}">${zC(`omen-${X.run.omens[X.run.act]}`,16)} OMEN - ${e.name.toUpperCase()}</div>`:``}</div>`,[{opacity:0},{opacity:1,offset:.15},{opacity:1,offset:.8},{opacity:0}],2200)}}function tA(e,t){X.screen!==e&&X.run&&Qk(),X.screen=e,Vk(),Z(`#tooltip`).style.display=`none`,e!==`map`&&(Gd(),Xd()),Af(null);let n=bk();if(n.className=``,n.onclick=null,{title:rA,embark:iA,vigil:aA,map:uA,combat:()=>{},reward:tM,rest:aM,shop:sM,event:cM,treasure:oM,bossRelic:nM,end:fM}[e](t),e===`map`&&Mk(),e!==`combat`&&e!==`title`&&Nm(),X.screen===e&&e!==`combat`&&e!==`end`&&GO(e),X.screen===`map`&&X.run){let e=(X.run.act|0)+1;RO(`act${e}Combat`,`act${e}Boss`,`elite`,`safeNodes`)}zk()}var nA=[`0`,`I`,`II`,`III`,`IV`,`V`];function rA(){nf(0);let e=cw(),t=kg(),n=e.deeds,r=gC(`title-background`,`background`),i=gC(`title`,`title`),a=bk();a.innerHTML=`<div class="title-screen screen-enter">
    ...
    <div class="title-btns">
      ...
      <button class="btn ghost${e.news&&!xj?` news`:``}" data-a="vigil">The Vigil</button>
  ...
  </div>`,a.onclick=e=>{let n=e.target.closest(`[data-a]`);if(!n||n.disabled)return;let r=n.dataset.a;YD(),Y.click(),r===`embark`?tA(`embark`):r===`continue`&&t?oA(t,!0):r===`vigil`?tA(`vigil`):r===`help`?Zk():r===`settings`&&Uk()},Aj()}function iA(){nf(0);let e=cw(),t=kg(),n=X.embark||={aspect:0,vow:0},r=e.unlocks.includes(`aspect2`);r||(n.aspect=0),n.vow=Math.max(0,Math.min(n.vow|0,e.vowUnlocked));let i=r?`<div class="embark-label">Who carries the lantern</div>
    <div class="aspect-row">${qu.map((e,t)=>`
      <button class="aspect-card${n.aspect===t?` on`:``}" data-a="asp" data-i="${t}">
        <div class="asp-hero">${Ak(t)}</div>
        <div class="asp-name">${e.name}</div>
        <div class="asp-blurb">${e.blurb}</div>
      </button>`).join(``)}</div>`:``,a=n.vow===0?`The Spire as it is. No vows sworn.`:Ju.slice(0,n.vow).map(e=>`<b style="color:#ff9a4d">${e.name}</b> — ${e.desc}`).join(`<br>`),o=e.vowUnlocked>0?`<div class="vow-block">
      <div class="vow-stepper">
        <button class="vow-btn" data-a="vow-"${n.vow===0?` disabled`:``}>−</button>
        <div class="vow-level">VOW ${nA[n.vow]}<span class="vow-max"> / ${nA[e.vowUnlocked]||`0`}</span></div>
        <button class="vow-btn" data-a="vow+"${n.vow<e.vowUnlocked?``:` disabled`}>+</button>
      </div>
      <div class="vow-desc">${a}</div>
    </div>`:``,s=bk();s.innerHTML=`<div class="embark-screen screen-enter">
    ...
    <div class="title-btns">
  ...
  </div>`;let c=()=>{let e=cw();oA(th(void 0,{aspect:n.aspect,vow:n.vow,lamplighter:lw(e,`lamplighter`),monument:e.lastFall,unlocks:e.unlocks,reveals:uw(e)}))};s.onclick=r=>{let i=r.target.closest(`[data-a]`);if(!i||i.disabled)return;let a=i.dataset.a;if(YD(),Y.click(),a===`asp`)n.aspect=+i.dataset.i,iA();else if(a===`vow-`)n.vow=Math.max(0,n.vow-1),iA();else if(a===`vow+`)n.vow=Math.min(e.vowUnlocked,n.vow+1),iA();else if(a===`back`)tA(`title`);else if(a===`begin`){if(!t){c();return}Jk(`<div class="panel ov-panel" style="text-align:center">
      ...
      </div>`,e=>{e.onclick=e=>{let t=e.target.dataset.a;if(t===`yes`){let e=kg();e&&(dw(e),Mg(e,!1)),X.run=null,X.cb=null,Yk(),c()}t===`no`&&Yk()}})}}}function aA(){nf(0);let e=fw(),t=Object.entries(Uu).map(([t,n])=>{let r=e.deeds[n.stat]||0,i=r>=n.n,a=Math.min(100,Math.round(r/n.n*100)),o=n.unlocks.map(e=>{if(e===`aspect2`)return`The Ashwarden`;let[t,n]=e.split(`:`);return t===`card`?ku[n]?.name||n:Mu[n]?.name||n}).join(`, `),s=gC(`deeds`,t),c=s?`<img class="deed-art" src="${s}" alt="">`:`<span class="deed-art-fallback">${zC(`deed-${t}`,40)}</span>`;return`<div class="deed-row${i?` done`:``}">
      ${c}
      <div class="deed-body">
    ...
    </div>`}).join(``),n=bk();n.innerHTML=`<div class="center-panel screen-enter"><div class="panel vigil-panel">
    <div class="ov-title">The Vigil</div>
    <div class="ov-sub">${e.deeds.runs} climbs · ${e.deeds.wins} dawns · deepest Vow: ${nA[e.deeds.bestVow]||`—`}</div>
  ...
  </div></div>`,n.onclick=e=>{let t=e.target.closest(`[data-a]`);t&&(Y.click(),t.dataset.a===`back`&&tA(`title`))}}function oA(e,t=!1){X.run=e,X.cb=null,nf(e.act);let n=e.nodeId?e.map.nodes.find(t=>t.id===e.nodeId):null;if(Ud(e.act,n?n.row:0),t||Og(e),t&&e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);X.screen=`combat`,pA(zh(e,e.pendingCombat,t?t.row:5),e.pendingCombat),zk();return}if(e.pendingLamplighter){sA();return}tA(`map`),t||setTimeout(()=>iM(e),900)}function sA(){let e=X.run;if(X.screen!==`lamplighter`&&Qk(),X.screen=`lamplighter`,GO(`lamplighter`),Vk(),Xd(),nf(0),bk().className=``,!X.lamp){let t=ch(e),n=Object.keys(Yu).filter(t=>mh(e,`phials`)||!Yu[t].ops.some(e=>e.potion)),r=[];for(;r.length<3&&n.length;)r.push(n.splice(Math.floor(t()*n.length),1)[0]);X.lamp={boons:r,boon:null,art:e.art},Og(e)}let t=X.lamp,n=qu[e.aspect],r=t.boons.map(e=>{let n=Yu[e],r=gC(`boons`,e);return`<button class="lamp-boon${t.boon===e?` on`:``}" data-a="boon" data-i="${e}">
      ${r?`<img class="lb-art-img" src="${r}" alt="">`:``}
      <div class="lb-name">${zC(`boon-${e}`,20)} ${n.name}</div><div class="lb-text">${Ik(n.text)}</div>
    </button>`}).join(``),i=Object.keys(Hu).map(e=>{let n=Hu[e],r=gC(`arts`,e);return`<button class="lamp-art${t.art===e?` on`:``}" data-a="art" data-i="${e}">
      ${r?`<img class="la-art-img" src="${r}" alt="">`:`<span class="la-glyph" style="color:${n.tone}">${zC(`art-${e}`,18)}</span>`}<span class="la-name">${n.name}</span>
    </button>`}).join(``),a=Hu[t.art],o=bk();o.innerHTML=`<div class="lamp-screen screen-enter">
    ${Ck()}
    <div class="lamp-hero">${Ak(e.aspect)}</div>
    ...
    <div class="lamp-art-desc">${a?`<b style="color:${a.tone}">${zC(`art-${t.art}`,15)} ${a.name}</b> · ${Ik(a.text)}`:``}</div>
  ...
  </div>`,zk(),o.onclick=e=>{let n=e.target.closest(`[data-a]`);if(!n||n.disabled)return;let r=n.dataset.a;YD(),Y.click(),r===`boon`?(t.boon=n.dataset.i,sA()):r===`art`?(t.art=n.dataset.i,Y.hover(),sA()):r===`begin`&&t.boon&&cA()}}function cA(){let e=X.run,t=X.lamp;e.art=t.art,e.boon=t.boon,Ng(e,Yu[t.boon].ops),delete e.pendingLamplighter,X.lamp=null,Y.relic(),Og(e),tA(`map`),setTimeout(()=>iM(e),900)}var lA={monster:`sword`,elite:`skull`,event:`question`,rest:`flame`,shop:`coin`,treasure:`chest`,boss:`crown`,monument:`monument`};function uA(){let e=X.run;if(e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);X.screen=`combat`,pA(zh(e,e.pendingCombat,t?t.row:5),e.pendingCombat);return}Og(e),X.cb=null;let{nodes:t}=e.map,n=new Set(uh(e).map(e=>e.id)),r=new Set(e.map.visited),i=e.nodeId?t.find(t=>t.id===e.nodeId).row:-1,a=``,o=``;for(let e of t)for(let t of e.next){let n=r.has(e.id)&&r.has(t)?`walked`:``;a+=`<path class="medge ${n}" style="--d:${e.row*34}ms" data-a="${e.id}" data-b="${t}" d="M0 0"/>`}for(let i of t){let t=i.unlit&&!r.has(i.id),a=[`mnode`,`type-${i.type}`,t?`unlit`:``,r.has(i.id)?`visited`:``,i.id===e.nodeId?`current`:``,n.has(i.id)?`avail`:``].join(` `),s=_k?1.3:1,c=(i.type===`boss`?26:i.type===`elite`||i.type===`treasure`?19:16)*s,l=Math.round(c*2),u=Math.round(l*1.28),d=cC(i.type,t),f=BC(`node-frame`),p=BC(d),m=i.type===`monument`&&!p?gC(`meta`,`monument-node`):null,h=`<circle class="nhit" r="${Math.round(u/2)}" fill="transparent"/>`,g;g=f||p||m?`${f?`<image class="nframe" href="${f}" x="${-l/2}" y="${-l/2}" width="${l}" height="${l}" />`:`<circle class="bg" r="${t?16*s:c}"/>`}${p||m?`<image class="nglyph" href="${p||m}" x="${-u/2}" y="${-u/2}" width="${u}" height="${u}" />`:`<g class="icg">${HC(t?`unlitLantern`:lA[i.type],u)}</g>`}`:`<circle class="bg" r="${t?16*s:c}"/><g class="icg">${HC(t?`unlitLantern`:lA[i.type],u)}</g>`;let _=n.has(i.id)?`<g class="nsil">${g}</g>`:``;o+=`<g class="${a}" data-node="${i.id}" style="--d:${i.row*34}ms">
      ${h}<g class="nwrap">${_}${g}</g>
    </g>`}let s=Ou[e.act],c=e.omens?.[e.act],l=Bu[c];bk().innerHTML=`
    <div class="map-title">ACT ${e.act+1} — <b>${s.name.toUpperCase()}</b> — ${s.bossName} awaits${l?` &nbsp;·&nbsp; <span class="mt-omen" style="color:${l.tone}">${Dk(c,`mt-omen-art`,`mt-omen-fallback`,18)}<span class="mt-omen-name">${l.name}</span></span>`:``}</div>
    ...
    <feComposite in="fill" in2="ring" operator="in"/>
      ...
      <div class="map-hint">${_k?`drag`:`scroll`} to survey the Spire</div>
    </div>`;let u=Z(`.map-svg`),d=!1;u.onclick=e=>{if(d)return;let n=e.target.closest(`.mnode.avail`);!n||X.busy||(YD(),dA(t.find(e=>e.id===n.dataset.node)))},yk(`.mnode`,u).forEach(i=>{let a=t.find(e=>e.id===i.dataset.node),o={monster:`Monster`,elite:`Elite — beware`,event:`Unknown event`,rest:`Rest site`,shop:`Merchant`,treasure:`Treasure`,boss:Ou[e.act].bossName};i._tip=a.unlit&&!r.has(a.id)?{title:`An unlit lantern`,body:`What waits here is unknown — but first light pays a bounty of gold.${n.has(a.id)?` ${_k?`Tap`:`Click`} to travel here.`:``}`}:{title:o[a.type],body:n.has(a.id)?`${_k?`Tap`:`Click`} to travel here.`:``,sub:{monster:`A fight. Embers and gold for the swift.`,elite:`A titled foe - greater risk, a relic-grade purse.`,event:`Fate unwritten. Could be anything.`,rest:`Heal, or forge a card into its + form.`,shop:`Gold for cards, relics, phials.`,treasure:`A chest with no fight attached.`,boss:`The act ends here. Ready your deck.`}[a.type]}});let f=t.map(t=>({id:t.id,pos:kd(e.act,t)})),p=new Map(yk(`.mnode`,u).map(e=>[e.dataset.node,e])),m=new Set(t.filter(e=>!n.has(e.id)&&!r.has(e.id)).map(e=>e.id)),h=yk(`.medge`,u).map(e=>({p:e,a:e.dataset.a,b:e.dataset.b}));Wd(e.act,Math.max(0,i)),Yd(f,e=>{let t=new Map(e.map(e=>[e.id,e]));for(let[e,n]of p){let r=t.get(e);n.setAttribute(`transform`,`translate(${r.x.toFixed(1)},${r.y.toFixed(1)}) scale(${r.s.toFixed(3)})`);let i=n.classList.contains(`visited`)&&!n.classList.contains(`current`)?.78:1;n.style.opacity=(r.fade*(m.has(e)?.4:1)*i).toFixed(3)}for(let{p:e,a:n,b:r}of h){let i=t.get(n),a=t.get(r),o=9*(i.s+a.s)/2;e.setAttribute(`d`,`M${i.x.toFixed(1)} ${i.y.toFixed(1)} Q${((i.x+a.x)/2).toFixed(1)} ${((i.y+a.y)/2+o).toFixed(1)} ${a.x.toFixed(1)} ${a.y.toFixed(1)}`),e.style.opacity=Math.min(i.fade,a.fade).toFixed(3)}}),Af(e.act,{mult:.3});let g=Z(`.map-screen`);g.addEventListener(`wheel`,e=>{e.preventDefault(),Kd(-e.deltaY*.006)},{passive:!1});let _=null,v=0,y=0,b=0;g.addEventListener(`pointerdown`,e=>{e.pointerType!==`mouse`&&(cancelAnimationFrame(y),_=e.clientY,v=0,b=0,d=!1)}),g.addEventListener(`pointermove`,e=>{if(_==null||e.pointerType===`mouse`)return;let t=e.clientY-_;_=e.clientY,b+=Math.abs(t),b>14&&(d=!0),v=t,Kd(t*.014)});let x=e=>{if(_==null||e.pointerType===`mouse`)return;_=null;let t=()=>{v*=.93,!(Math.abs(v)<.5||X.screen!==`map`)&&(Kd(v*.014),y=requestAnimationFrame(t))};y=requestAnimationFrame(t),setTimeout(()=>d=!1,80)};g.addEventListener(`pointerup`,x),g.addEventListener(`pointercancel`,x)}function dA(e){let t=X.run;Y.map(),Ud(t.act,e.row);let{type:n,bounty:r}=dh(t,e);if(Og(t),r){Y.coin();let t=Z(`.mnode[data-node="${e.id}"]`),n=t?qf(t):{x:_()/2,y:v()/2};Bf(n.x,n.y-34,`${zC(`coin`,12)} +${r}`,`goldf`),sj(n.x,n.y,120,30,{n:5,color:`#ffe9ac`,size:7,dur:620})}if(n===`monster`||n===`elite`||n===`boss`){t.pendingCombat=n,Og(t);let r=Z(`.mnode[data-node="${e.id}"]`);eA(`combat-in`,r?qf(r):{}),pA(zh(t,n,e.row),n)}else n===`rest`?tA(`rest`):n===`shop`?tA(`shop`):n===`treasure`?tA(`treasure`):n===`event`?tA(`event`,Rh(t)):n===`monument`&&fA(e)}function fA(e){let t=X.run,n=fh(t);if(n&&hw(),Og(t),n){Y.relic();let t=n.kind===`relic`?Mu[n.id]?.name:n.kind===`card`?ku[n.id]?.name:`${n.amount} gold`,r=Z(`.mnode[data-node="${e.id}"]`),i=r?qf(r):{x:_()/2,y:v()/2};Bf(i.x,i.y-34,`✦ ${t}`,`goldf`),sj(i.x,i.y,_()/2,v()*.5,{n:8,color:`#ffe9ac`,size:8,dur:720}),oj(`THE STONE REMEMBERS`)}tA(`map`)}function pA(e,t){if(Gd(),Xd(),Z(`#tooltip`).style.display=`none`,X.screen!==`combat`&&Qk(),X.cb=Bh(X.run,e,t),X.screen=`combat`,KO(t,X.run.act),Af(X.run.act,{boss:t===`boss`}),mA(),zk(),t===`boss`){let e=X.cb.enemies[0].name.toUpperCase(),t=e.indexOf(` `),n=$(`div`,`turn-banner boss-banner`,`<span class="bb-name">${t<0?xk(e):`${xk(e.slice(0,t))}<br>${xk(e.slice(t+1))}`}</span>`);bk().appendChild(n),setTimeout(()=>n.remove(),2100),Ff(`#1a0a20`,.5,.9),af(1.6),Y.bigDeath()}Kj().then(Qj)}function mA(){let e=X.cb,t=bk();t.onclick=null,t.innerHTML=`<div class="combat-screen screen-enter intro" style="--ledge:${`#${Ou[X.run.act].theme.glow.toString(16).padStart(6,`0`)}`}">
    ${[`backdrop`,`mid`,`ledge`].map(e=>{let t=gC(`stage`,`act${X.run.act+1}-${e}`);return t?`<img class="sl sl-${e}" src="${t}" alt="" aria-hidden="true">`:``}).join(``)}
    ...
    <div class="battlefield">
      <div class="player-zone">
        ...
        <div class="cplate">
          <div class="hpbar-wrap"><span class="block-chip zero p-block"><span class="ic">${VC(`ward`,28)}</span> 0</span><div class="hp-vial"><div class="hpbar"><div class="ghost"></div><div class="fill"></div></div></div><span class="hp-label p-hp"></span></div>
        </div>
      </div>
    ...
    <button class="end-turn" type="button"><span class="et-ic">${VC(`end-turn`,120)}</span><span class="et-lbl">End</span></button>
  ...
  </div>`;let n=Z(`.enemy-zone`,t),r={enemies:[],root:Z(`.combat-screen`,t)},i=e.affix?Vu[e.affix]:null,a=nk(x().shape,X.run.act),o=ak(a,e.enemies.length);e.enemies.forEach((e,t)=>{let s=Fu[e.key],c=lk(a,e.key,s.boss?`boss`:s.elite?`elite`:`normal`,o[t],_(),v()),l=$(`div`,`enemy${s.elite?` elite-e`:``}${s.boss?` boss-e`:``}${i?` affixed`:``}`);i&&l.style.setProperty(`--affix-tone`,i.tone),l.dataset.idx=t,l.style.animationDelay=`${160+t*130}ms`,l.innerHTML=`<div class="top-chrome">
        <div class="intent"></div>
        <div class="status-row"></div>
      </div>
      <div class="enemy-art" style="width:${c}px;height:${c}px"><div class="enemy-sprite">${Ok(gC(`enemies`,e.key),`atk`)}${Sk(`enemies`,e.key,TC(s.art))}<div class="vessel-fire"></div>${gC(`enemies`,e.key)?`<svg class="cracks-overlay" viewBox="0 0 200 200"><g class="cracks"></g></svg>`:``}</div><div class="dmg-preview"></div></div>
      <div class="cplate">
        <div class="name">${i?`<span class="affix-name" style="color:${i.tone}">${i.name.toUpperCase()}</span> `:``}${e.name.toUpperCase()}</div>
        <div class="hpbar-wrap"><span class="block-chip zero"><span class="ic">${VC(`ward`,28)}</span> 0</span><div class="hp-vial"><div class="hpbar"><div class="ghost"></div><div class="fill"></div><div class="pv"></div></div></div><span class="hp-label"></span></div>
        <div class="facet-row"></div>
      </div>`,n.appendChild(l),r.enemies.push({root:l,art:Z(`.enemy-art`,l),intent:Z(`.intent`,l),topChrome:Z(`.top-chrome`,l),cplate:Z(`.cplate`,l),fill:Z(`.fill`,l),ghost:Z(`.ghost`,l),hp:Z(`.hp-label`,l),block:Z(`.block-chip`,l),statuses:Z(`.status-row`,l),pv:Z(`.pv`,l),prev:Z(`.dmg-preview`,l),facets:Z(`.facet-row`,l)}),r.enemies[t].facets._tip={title:`Facets`,body:`Every creature is glass. Attacks that draw unblocked blood chip a facet; fill the gauge and the glass <b>shatters</b> — it loses its next action, is Cracked, and spills Embers into your lantern.`},i&&(Z(`.name`,l)._tip={title:`${i.name} — an elite's title`,body:i.text}),l.onclick=()=>ej(t),l.addEventListener(`pointerenter`,e=>{e.pointerType===`mouse`&&X.targeting&&(l.classList.add(`target-hover`),QA())}),l.addEventListener(`pointerleave`,()=>{l.classList.remove(`target-hover`),QA()})}),r.pHp=Z(`.p-hp`,t),r.pFill=Z(`.player-zone .fill`,t),r.pGhost=Z(`.player-zone .ghost`,t),r.pBlock=Z(`.p-block`,t),r.pStatus=Z(`.p-status`,t),r.hero=Z(`.hero-wrap`,t),r.playerZone=Z(`.player-zone`,t),r.pTopChrome=Z(`.player-zone .top-chrome`,t),r.pCplate=Z(`.player-zone .cplate`,t),r.energy=Z(`.energy-orb`,t),r.endTurn=Z(`.end-turn`,t),r.hand=Z(`.hand-zone`,t),r.draw=Z(`.pile-draw`,t),r.discard=Z(`.pile-discard`,t),r.exhaust=Z(`.pile-exhaust`,t),r.lantern=Z(`.lantern-btn`,t);let s=X.run.art,c=Hu[s];{let e=s?gC(`arts`,s):null,t=e?`<img class="ui-icon" src="${e}" width="64" height="64" alt="" draggable="false">`:s&&LC(`art-${s}`)?zC(`art-${s}`,64):VC(`lantern`,64);Z(`.lb-ic`,r.lantern).innerHTML=t,c&&(r.lantern.style.color=c.tone)}r.lantern._tip={title:c?`Lantern Art — ${c.name}`:`The Lantern`,body:`${c?`<b>${c.cost} Embers, once a turn:</b> ${c.text}<br><br>`:``}The lantern holds the <b>Embers</b> spilled by shattered and slain glass. Drag any card onto it to <b>kindle</b> — burn the card away for an ember, once a turn. Curses refuse the fire.`,sub:`A · use Art`},r.lantern.onclick=async()=>{if(!(X.busy||!X.cb||X.cb.over)){if(YD(),!Xh(X.run,X.cb)){r.lantern.classList.add(`nope`),setTimeout(()=>r.lantern.classList.remove(`nope`),350),Y.debuff();return}nj(),Zh(X.run,X.cb),await Kj(),Qj()}},X.ce=r,_A(a),Dj(),kj(),setTimeout(()=>r.root.classList.remove(`intro`),1300),r.endTurn.onclick=aj,r.draw.onclick=()=>{Y.click(),Xk(`Draw Pile`,e.draw,{sub:`Order hidden — shown alphabetically`,inCombat:!0})},r.discard.onclick=()=>{Y.click(),Xk(`Discard Pile`,e.discard,{inCombat:!0})},r.exhaust.onclick=()=>{Y.click(),Xk(`The Ashes`,e.exhaust,{sub:`Burned away — each fed the lantern an ember`,inCombat:!0})},r.root.addEventListener(`pointerdown`,e=>{e.target.closest(`.enemy`)||e.target.closest(`.card`)||(X.targeting?nj():X.hoveredCard!=null&&(X.hoveredCard=null,WA()))}),BA(e),jA(),UA()}var hA=e=>qf(X.ce.enemies[e].art),gA=()=>qf(X.ce.hero);function _A(e){let t=X.cb,n=X.ce;if(!t||!n||X.screen!==`combat`)return;let r=e??nk(x().shape,X.run.act);n.root.style.setProperty(`--ground-y`,`${r.groundY}px`),n.root.style.setProperty(`--ledge-lip`,`${r.ledgeLip}px`);for(let e of[`backdrop`,`mid`,`ledge`]){let t=n.root.querySelector(`.sl-${e}`);if(!t)continue;let i=r.layers[e];t.style.height=`${i.h}px`,t.style.left=i.x?`calc(50% + ${i.x}px)`:``,t.style.bottom=e===`ledge`?`${Math.max(0,r.groundY+r.ledgeLip-i.h+i.y)}px`:`${i.y}px`,t.style.opacity=i.opacity,t.style.scale=i.zoom===1?``:String(i.zoom),t.style.objectPosition=`${i.posX}% ${i.posY}%`,t.style.setProperty(`--amp`,`${i.drift}px`)}let i=ik(`heroes`,qu[X.run.aspect].id),a=Math.round(r.hero.w*i.scale),o=Math.round(r.hero.h*i.scale),s=n.root.querySelector(`.player-zone`);s.style.width=`${a}px`,s.style.height=`${o}px`,s.style.left=`${Math.round(r.hero.x-a/2)}px`,s.style.bottom=`${rk(r)+i.footY}px`;let c=ak(r,t.enemies.length),l=ck(c,t.enemies.map(e=>e.key));t.enemies.forEach((e,t)=>{let i=Fu[e.key],a=i.boss?`boss`:i.elite?`elite`:`normal`,o=lk(r,e.key,a,c[t],_(),v()),s=n.enemies[t].root;s.style.left=`${Math.round(c[t].x-o/2+ok(c[t],e.key))}px`,s.style.bottom=`${(c[t].y??0)+sk(c[t],e.key)}px`,s.style.width=s.style.height=`${o}px`,s.style.zIndex=String(l[t]),n.enemies[t].art.style.width=n.enemies[t].art.style.height=`${o}px`}),CA(),vA()}function vA(){let e=hk(x().shape),t=Z(`#hud .hud-bar`);t&&e.hud&&(t.style.height=`${e.hud.height}px`,t.style.transformOrigin=`top center`,t.style.transform=e.hud.scale===1?``:`scale(${e.hud.scale})`);let n=(e,t)=>{if(!e||!t)return;t.left===void 0?t.right!==void 0&&(e.style.right=`${t.right}px`,e.style.left=``):(e.style.left=`${t.left}px`,e.style.right=``),t.top!==void 0&&(e.style.top=`${t.top}px`);let n=t.scale??1;e.style.transformOrigin=t.left===void 0?`top right`:`top left`,e.style.transform=n===1?``:`scale(${n})`};if(n(Z(`#omen-slot`),e.omen),n(Z(`#relicbar`),e.relics),!X.ce||X.screen!==`combat`)return;let r=(e,t)=>{!e||!t||(t.left===void 0?t.right!==void 0&&(e.style.right=`${t.right}px`,e.style.left=``):(e.style.left=`${t.left}px`,e.style.right=``),t.bottom!==void 0&&(e.style.bottom=`${t.bottom}px`),t.w!==void 0&&(e.style.width=`${t.w}px`),t.h!==void 0&&(e.style.height=`${t.h}px`))};r(X.ce.energy,e.energy),r(X.ce.lantern,e.lantern),r(X.ce.endTurn,e.endTurn),r(X.ce.draw,e.draw),r(X.ce.discard,e.discard),r(X.ce.exhaust,e.ashes),X.ce.hand&&e.hand&&xA(e.hand)}function yA(e,t,n){let r=Math.max(1,e|0),i=Math.min(112,640/r,(t-246)/Math.max(r-1,1)),a=r<=1?n:(r-1)*i+n;return Math.min(t-24,Math.max(n+16,Math.ceil(a+20)))}function bA(e,t,n){let r=(n-t)/2;return e.left===void 0?Math.round(r-(e.right??0)):Math.round(r+e.left)}function xA(e){let t=X.ce?.hand;if(!t||!e)return;let n=x();t.style.setProperty(`--hand-scale`,String(e.scale??1));let r=(X.cb?.hand?X.cb.hand.filter(e=>{let n=t.querySelector(`.card[data-uid="${e.uid}"]`);return n&&!n.classList.contains(`draw-pending`)}).length:0)||5,i=hj().w,a=yA(r,n.w,i),o=bA(e,a,n.w);t.style.width=`${a}px`,t.style.left=`${o}px`,t.style.right=`auto`,t.style.marginLeft=`0`,e.bottom!==void 0&&(t.style.bottom=`${e.bottom}px`)}function SA(){let e=X.ce?.hand;if(!e)return v()-8;let t=1/0;for(let n of e.querySelectorAll(`.card:not(.draw-pending)`)){let e=C(n);e.height>2&&(t=Math.min(t,e.top))}if(t<1/0)return t;let n=C(e),r=hj(),i=gj();return n.height>2?n.bottom-i-r.h:v()-i-r.h}function CA(){let e=X.ce;if(!e||X.screen!==`combat`)return;let t=Z(`#hud.show .hud-bar`)||Z(`#hud .hud-bar`),n=t?C(t).bottom:0,r=Math.max(6,Math.round(n)+4),i=SA()-4,a=(e,t)=>{if(e){e.style.setProperty(`--chrome-dy`,`0px`);let t=C(e);t.height>1&&t.top<r&&e.style.setProperty(`--chrome-dy`,`${Math.round(r-t.top)}px`)}if(t){t.style.setProperty(`--chrome-dy`,`0px`);let e=C(t);e.height>1&&e.bottom>i&&t.style.setProperty(`--chrome-dy`,`${Math.round(i-e.bottom)}px`)}};for(let t of e.enemies)a(t.topChrome,t.cplate);a(e.pTopChrome,e.pCplate)}var wA=0;function TA(){wA||=requestAnimationFrame(()=>{wA=0,CA()})}function EA(){_A(),WA(),TA(),kj()}var DA=0;addEventListener(`resize`,()=>{clearTimeout(DA),DA=setTimeout(()=>{X.cb&&X.ce&&X.screen===`combat`&&EA()},120)});function OA(e,t,n){e.innerHTML=``;for(let[n,r]of Object.entries(t)){if(!r)continue;let t=ju[n]||{name:n,icon:`?`,kind:`buff`,desc:``},i=n===`str`&&r<0?`debuff`:t.kind,a=gC(`statuses`,n),o=a?`<img class="schip-art" src="${a}" alt="">`:LC(`st-${n}`)?zC(`st-${n}`,32):t.icon,s=Math.abs(r)>=2?`<span class="n">${r}</span>`:``,c=$(`span`,`schip ${i}`,`${o}${s}`);c._tip={title:t.name,body:t.desc.replace(/\bN\b/g,Math.abs(r)),sub:i===`debuff`?`Debuff`:`Buff`},e.appendChild(c)}}function kA(e){let t=X.cb,n=Gh(e),r=bg(X.run,t,e),i=sC(n.intent).map((e,t)=>VC(e,t===0?38:28)).join(``),a=``;n.intent.startsWith(`attack`)&&(a=r.times>1?`${r.dmg}×${r.times}`:`${r.dmg}`);let o=[];return r&&o.push(`attack for <b>${r.dmg}${r.times>1?`×${r.times}`:``}</b>`),n.block&&o.push(`gain Ward`),n.heal&&o.push(`heal itself`),n.fx?.some(e=>e.who===`player`)&&o.push(`afflict you`),n.fx?.some(e=>e.who!==`player`)&&o.push(`empower`),n.addCards&&o.push(`add ${n.addCards.n} ${ku[n.addCards.id].name}s to your discard`),{icon:i,txt:a,tip:{title:n.name,body:`Intends to ${o.join(`, `)||`act`}.`}}}function AA(e,t=0){if(e.facetMax>8)return`<span class="pipnum">${VC(`facet-empty`,11)} ${e.chips}${t?`<i>+${t}</i>`:``}/${e.facetMax}</span>`;let n=BC(`facet-chipped`),r=BC(`facet-empty`),i=``;for(let a=0;a<e.facetMax;a++){let o=a<e.chips,s=!o&&a<e.chips+t,c=`pip${o?` filled`:``}${s?` willchip`:``}`;n||r?i+=`<span class="${c}"><img class="ui-icon facet-img" src="${o||s?r||n:n||r}" alt="" draggable="false"></span>`:i+=`<span class="${c}"></span>`}return i}function jA(){let e=X.cb,t=X.ce;if(!t)return;e.enemies.forEach((e,n)=>{let r=t.enemies[n],i=`${100*Math.max(0,e.hp)/e.maxHp}%`;if(r.fill.style.width=i,r.ghost.style.width=i,r.hp.textContent=`${Math.max(0,e.hp)}/${e.maxHp}`,r.block.classList.toggle(`zero`,e.block<=0),r.block.innerHTML=`<span class="ic">${VC(`ward`,28)}</span> ${e.block}`,r.art.classList.toggle(`warded`,e.block>0),e.block<=0&&kk(r.art,!1),r.root.classList.toggle(`lowhp`,e.hp>0&&e.hp/e.maxHp<=.3),OA(r.statuses,e.statuses,!1),e.hp>0?r.facets.innerHTML=AA(e):r.facets.innerHTML=``,e.hp<=0&&r.reaped&&r.root.classList.add(`gone`),e.hp>0&&e.flags.staggered)r.intent.className=`intent i-staggered`,r.intent.innerHTML=`<span class="ic">${zC(`stagger`,38)}</span><span class="num">STAGGERED</span>`,r.intent._tip={title:`Staggered`,body:`The glass has shattered — this creature loses its next action while it reseams.`};else if(e.hp>0&&e.moveKey){let t=kA(e);r.intent.className=`intent i-${Gh(e).intent}`,r.intent.innerHTML=t.txt?`<span class="ic">${t.icon}</span><span class="num">${t.txt}</span>`:`<span class="ic">${t.icon}</span>`,r.intent._tip=t.tip}else r.intent.innerHTML=``}),t.lantern&&(Z(`.lb-count`,t.lantern).textContent=e.embers,Z(`.lb-pips`,t.lantern).innerHTML=Array.from({length:e.emberCap},(t,n)=>`<span class="lbp${n<e.embers?` lit`:``}" style="--a:${Math.round(n/(e.emberCap-1)*280-140)}deg"></span>`).join(``),t.lantern.classList.toggle(`unlit`,e.embers===0),t.lantern.classList.toggle(`ready`,Xh(X.run,e)),t.lantern.classList.toggle(`art-spent`,e.artUsedTurn===e.turn&&!e.over));let n=e.player,r=`${100*Math.max(0,n.hp)/n.maxHp}%`;t.pFill.style.width=r,t.pGhost.style.width=r,t.pHp.textContent=`${Math.max(0,n.hp)}/${n.maxHp}`,t.pBlock.classList.toggle(`zero`,n.block<=0),t.pBlock.innerHTML=`<span class="ic">${VC(`ward`,28)}</span> ${n.block}`,t.hero.classList.toggle(`warded`,n.block>0),n.block<=0&&kk(t.hero,!1),t.hero.classList.toggle(`lowhp`,n.hp/n.maxHp<=.3),OA(t.pStatus,n.statuses,!0),Z(`.num`,t.energy).textContent=n.energy,t.energy.classList.toggle(`spent`,n.energy===0),t.endTurn.classList.toggle(`ready`,n.energy===0&&!e.over&&!X.busy);let i=Z(`.candles`,t.energy),a=oC(n.energy,n.energyMax),o=BC(`candle-lit`),s=BC(`candle-spent`);i.children.length===a.length&&[...i.children].every((e,t)=>e.dataset.state===a[t])?[...i.children].forEach((e,t)=>{let n=a[t];e.dataset.state=n,e.classList.toggle(`lit`,n===`lit`),e.classList.toggle(`is-lit`,n===`lit`),e.classList.toggle(`is-spent`,n===`spent`);let r=e.querySelector(`.candle-img`);if(r){let e=n===`lit`?o:s;e&&r.getAttribute(`src`)!==e&&r.setAttribute(`src`,e)}}):i.innerHTML=a.map(e=>{let t=e===`lit`?o:s,n=e===`lit`?` lit`:``;return t?`<span class="candle is-${e}${n}" data-state="${e}"><img class="ui-icon candle-img" src="${t}" alt="" draggable="false"></span>`:`<span class="candle${n} is-${e}" data-state="${e}"></span>`}).join(``),MA(e),TA()}function MA(e){let t=X.ce;if(!t)return;let n=PA||{},r=[[t.draw,`draw`,n.draw==null?Math.max(0,e.draw.length-(NA.draw||0)):n.draw],[t.discard,`discard`,n.discard==null?Math.max(0,e.discard.length-(NA.discard||0)):n.discard],[t.exhaust,`ashes`,Math.max(0,e.exhaust.length-(NA.ashes||0))]];for(let[e,t,n]of r){if(!e)continue;let r=WC(n),i=GC(n),a=e.querySelector(`.pile-stack`);if(e.classList.toggle(`is-empty`,n===0),Z(`.cnt`,e).textContent=n,!a||Number(a.dataset.count)===n)continue;a.dataset.count=String(n),a.dataset.tier=String(r);let o=gC(`piles`,qC(t));if(a.replaceChildren(),a.classList.toggle(`is-empty`,i===0),!o){a.classList.add(`pile-stack-fallback`);continue}a.classList.remove(`pile-stack-fallback`);for(let e=0;e<i;e++){let t=document.createElement(`img`);t.src=o,t.alt=``,t.className=`pile-layer`,t.style.setProperty(`--rot`,`${KC(e,i)}deg`),a.appendChild(t)}}}var NA={draw:0,discard:0,ashes:0},PA=null;function FA(e,t=1){NA[e]||(NA[e]=0),NA[e]+=Math.max(0,t|0)}function IA(e,t=1){NA[e]=Math.max(0,(NA[e]||0)-Math.max(0,t|0))}function LA(e,t){for(let n of e.queue)n.uid==null||String(n.uid)!==String(t)||(n.t===`toDiscard`&&FA(`discard`,1),n.t===`exhaust`&&FA(`ashes`,1))}var RA=new Map;function zA(e){let t=[],n=0;for(;n<e.length&&(e[n].t===`draw`||e[n].t===`reshuffle`);)if(e[n].t===`reshuffle`)t.push({t:`reshuffle`,ev:e[n]}),n++;else{let r=[];for(;n<e.length&&e[n].t===`draw`;)r.push(e[n++]);t.push({t:`draws`,draws:r})}return t}function BA(e){if(xj||!e?.queue?.length)return;let t=zA(e.queue);if(!t.length)return;let n=t.find(e=>e.t===`reshuffle`),r=t[0]?.t===`draws`?t[0].draws.length:0;PA={draw:t[0]?.t===`draws`?n?r:e.draw.length+r:0,discard:n&&n.ev.n||0};let i=0;for(let e of t)if(e.t===`draws`)for(let t of e.draws){let e=String(t.uid);RA.has(e)||RA.set(e,{landAt:null,seq:i++})}}function VA(e){let t=new Set;for(let n of e.queue)(n.t===`toDiscard`||n.t===`exhaust`||n.t===`powerConsumed`)&&n.uid!=null&&t.add(String(n.uid));return t}function HA(e,t){setTimeout(()=>{e.isConnected&&(e.classList.remove(`draw-pending`),e.classList.add(`draw-in`),WA(),setTimeout(()=>e.classList.remove(`draw-in`),240))},t)}function UA(){let e=X.cb,t=X.ce;if(!t)return;let n=t.hand,r=new Map(yk(`.card`,n).map(e=>[e.dataset.uid,e])),i=new Set(e.hand.map(e=>String(e.uid))),a=VA(e);for(let[e,t]of r)!i.has(e)&&!a.has(e)&&t.remove();for(let t of e.hand)if(r.has(String(t.uid))){let e=Lk(t,{inCombat:!0}),n=r.get(String(t.uid)),i=[`armed`,`draw-pending`,`draw-in`,`lifted`,`dragging`,`will-cast`,`will-burn`,`played-up`].filter(e=>n.classList.contains(e));n.replaceChildren(...e.childNodes),n.className=[e.className,...i].filter(Boolean).join(` `),n.onclick=e=>{e.stopPropagation(),$A(t.uid)},vk&&(n.onmouseenter=()=>{X.hoveredCard=t.uid,WA()},n.onmouseleave=()=>{X.hoveredCard===t.uid&&(X.hoveredCard=null),WA()})}else{let r=Lk(t,{inCombat:!0}),i=String(t.uid),a=RA.get(i),o=e.queue.some(e=>e.t===`draw`&&String(e.uid)===i);if(!xj&&(a!=null||o)){typeof a==`object`&&a?.seq!=null&&(r.dataset.drawSeq=String(a.seq)),r.classList.add(`draw-pending`);let e=a==null?null:typeof a==`number`?a:a.landAt;e!=null&&(RA.delete(i),HA(r,e))}r.onclick=e=>{e.stopPropagation(),$A(t.uid)},vk&&(r.onmouseenter=()=>{X.hoveredCard=t.uid,Y.hover(),WA()},r.onmouseleave=()=>{X.hoveredCard===t.uid&&(X.hoveredCard=null),WA()}),KA(r,t.uid),n.appendChild(r)}WA()}function WA(){let e=X.cb,t=X.ce;if(!t)return;let n=e.hand.map(e=>String(e.uid)),r=new Map(yk(`.card`,t.hand).map(e=>[e.dataset.uid,e])),i=n.filter(e=>{let t=r.get(e);return t&&!t.classList.contains(`draw-pending`)}),a=i.length,o=Math.min(112,640/Math.max(a,1),(_()-246)/Math.max(a-1,1));n.forEach(t=>{let n=r.get(t);if(!n)return;let s=e.hand.find(e=>String(e.uid)===t);if(!s)return;let c=!sh(s).unplayable&&(lg(X.run,e,s)??99)<=e.player.energy;n.classList.toggle(`unplayable-now`,!c);let l=X.targeting?.kind===`card`&&String(X.targeting.uid)===t,u=X.hoveredCard!=null&&String(X.hoveredCard)===t;if(n.classList.toggle(`armed`,l),n.classList.toggle(`lifted`,u&&!X.busy&&!l),n.classList.contains(`draw-pending`)){n.style.transform=`translateX(-50%) translateY(26px) rotate(0deg)`,n.style.zIndex=15;return}let d=i.indexOf(t),f=a>1?(d-(a-1)/2)*Math.min(5,42/a):0,p=(d-(a-1)/2)*o,m=Math.abs(f)*3.2;n.style.transform=`translateX(calc(-50% + ${l?p*.4:p}px)) translateY(${m+26}px) rotate(${l?f*.5:f}deg)`,n.style.zIndex=u||l?40:20+d});let s=hk(x().shape).hand;s&&xA(s),QA(),TA()}var GA=0;function KA(e,t){e.addEventListener(`pointerdown`,n=>{if(!(X.busy||!X.cb||X.cb.over||!n.isPrimary||X.drag)){X.drag={uid:t,id:n.pointerId,x0:n.clientX,y0:n.clientY,live:!1,free:!1};try{e.setPointerCapture(n.pointerId)}catch{}}}),e.addEventListener(`pointermove`,n=>{let r=X.drag;if(!(!r||r.uid!==t||n.pointerId!==r.id)){if(!r.live){r.y0-n.clientY>26&&YA(r,e);return}if(r.free){let t=S(n.clientX,n.clientY),i=X.ce?.hand?C(X.ce.hand):null,a=i&&i.width>2?i.left+i.width/2:_()/2;e.style.transform=`translate(calc(-50% + ${t.x-a}px), ${t.y-v()+130}px) scale(1.12)`;let o=!!JA(n.clientX,n.clientY)?.closest(`.lantern-btn`);e.classList.toggle(`will-burn`,o),e.classList.toggle(`will-cast`,!r.kindleOnly&&!o&&t.y<qA())}else rj(n),ZA(n.clientX,n.clientY)}});let n=(n,r)=>{let i=X.drag;if(!i||i.uid!==t||n.pointerId!==i.id||(!r&&i.live&&uj(t,e,{fromDrag:!0}),X.drag=null,!i.live))return;if(GA=performance.now(),e.classList.remove(`dragging`,`will-cast`,`will-burn`),X.ce?.lantern?.classList.remove(`kindle-target`),r){nj(),WA();return}if(JA(n.clientX,n.clientY)?.closest(`.lantern-btn`)){let e=X.cb.hand.find(e=>e.uid===t);if(e&&$h(X.run,X.cb,e)){nj(),XA(t);return}nj(),WA();return}if(i.kindleOnly){X.hoveredCard=null,WA();return}if(i.free){S(n.clientX,n.clientY).y<qA()?ij(t,null):(X.hoveredCard=null,WA());return}let a=document.elementFromPoint(n.clientX,n.clientY)?.closest(`.enemy`),o=a?+a.dataset.idx:-1,s=X.cb.enemies.filter(e=>e.hp>0);o>=0&&X.cb.enemies[o].hp>0?ij(t,o):s.length===1&&S(n.clientX,n.clientY).y<qA()?ij(t,s[0].idx):(nj(),WA())};e.addEventListener(`pointerup`,e=>n(e,!1)),e.addEventListener(`pointercancel`,e=>n(e,!0))}var qA=()=>X.ce?.hand?C(X.ce.hand).top-24:v()-260,JA=(e,t)=>document.elementsFromPoint(e,t).find(e=>!e.closest(`.card`));function YA(e,t){let n=X.cb,r=n.hand.find(t=>t.uid===e.uid);if(!r){X.drag=null;return}let i=sh(r);if(i.unplayable||lg(X.run,n,r)>n.player.energy){if($h(X.run,n,r)){e.live=!0,e.free=!0,e.kindleOnly=!0,X.hoveredCard=null,Y.hover(),t.classList.add(`dragging`),X.ce?.lantern?.classList.add(`kindle-target`);return}X.drag=null,t.classList.add(`nope`),setTimeout(()=>t.classList.remove(`nope`),350),Y.debuff();return}e.live=!0,X.hoveredCard=null,Y.hover(),$h(X.run,n,r)&&X.ce?.lantern?.classList.add(`kindle-target`),i.target===`enemy`?tj({kind:`card`,uid:e.uid}):(e.free=!0,nj(),t.classList.add(`dragging`))}async function XA(e){if(X.hoveredCard=null,!tg(X.run,X.cb,e)){WA();return}await Kj(),Qj()}function ZA(e,t){let n=document.elementFromPoint(e,t)?.closest(`.enemy`);X.ce?.enemies.forEach(e=>e.root.classList.toggle(`target-hover`,e.root===n&&e.root.classList.contains(`targetable`))),QA()}function QA(){let e=X.ce,t=X.cb;if(!e||!t)return;let n=null;X.targeting?.kind===`card`?n=t.hand.find(e=>e.uid===X.targeting.uid):X.drag?.live?n=t.hand.find(e=>e.uid===X.drag.uid):X.hoveredCard!=null&&!X.busy&&(n=t.hand.find(e=>e.uid===X.hoveredCard));let r=n?sh(n):null,i=X.targeting?.kind===`card`||X.drag?.live&&!X.drag.free,a=t.enemies.filter(e=>e.hp>0).length,o=!!(n&&!t.over&&!r.unplayable&&!i);Jm();let s=o&&r.target===`self`;if(e.hero?.classList.toggle(`aim-target`,s),s){let t=Z(`.hero-sprite`,e.hero)||e.hero,n=qu[X.run.aspect].id;Km(t,!0,hp(n))?e.hero.classList.add(`aim-mesh`):e.hero.classList.remove(`aim-mesh`)}else e.hero?.classList.remove(`aim-mesh`);t.enemies.forEach((s,c)=>{let l=e.enemies[c],u=null,d=!1;n&&!t.over&&s.hp>0&&!r.unplayable&&(r.target===`allEnemies`?u=xg(X.run,t,n,c):r.target===`enemy`&&(i||a===1)&&(u=xg(X.run,t,n,c),d=i&&a>1&&!l.root.classList.contains(`target-hover`)));let f=l.root.classList.contains(`target-hover`),p=r?.target===`allEnemies`&&(o||X.drag?.live&&X.drag.free),m=r?.target===`enemy`&&(a===1||i&&f),h=!!(n&&!t.over&&!r.unplayable&&s.hp>0&&(p||m));if(l.root.classList.toggle(`aim-target`,h),h&&Km(Z(`.enemy-sprite`,l.art)||l.art,!0,hp(s.key))?l.root.classList.add(`aim-mesh`):l.root.classList.remove(`aim-mesh`),u&&(u.total>0||u.chips>0)){l.prev.classList.remove(`show`,`lethal`,`dim`),l.prev.innerHTML=``,l.root.classList.toggle(`marked`,u.lethal&&!d);let e=Math.min(s.hp,u.loss)/s.maxHp;l.pv.style.left=`${Math.max(0,s.hp-u.loss)/s.maxHp*100}%`,l.pv.style.width=`${e*100}%`,l.pv.classList.toggle(`show`,u.loss>0),l.facets.innerHTML=AA(s,d?0:u.chips),l.facets.classList.toggle(`willshatter`,u.willShatter&&!d)}else l.prev.classList.remove(`show`,`lethal`,`dim`),l.root.classList.remove(`marked`),l.pv.classList.remove(`show`),s.hp>0&&(l.facets.innerHTML=AA(s)),l.facets.classList.remove(`willshatter`)})}function $A(e){if(X.busy||!X.cb||X.cb.over||performance.now()-GA<350)return;let t=X.cb,n=t.hand.find(t=>t.uid===e);if(!n)return;if(_k&&X.hoveredCard!==e&&!(X.targeting?.kind===`card`&&X.targeting.uid===e)){X.hoveredCard=e,Y.hover(),WA();return}let r=sh(n),i=lg(X.run,t,n),a=Z(`.card[data-uid="${e}"]`,X.ce.hand);if(r.unplayable||i>t.player.energy){a?.classList.add(`nope`),setTimeout(()=>a?.classList.remove(`nope`),350),Y.debuff();return}if(X.targeting?.kind===`card`&&X.targeting.uid===e)return nj();if(r.target===`enemy`){let n=t.enemies.filter(e=>e.hp>0);if(n.length===1)return void ij(e,n[0].idx);tj({kind:`card`,uid:e})}else ij(e,null)}function ej(e){if(!X.targeting||X.busy)return;let t=X.cb.enemies[e];if(!t||t.hp<=0)return;let n=X.targeting;n.kind===`card`?ij(n.uid,e):n.kind===`potion`&&Kk(n.slot,e)}function tj(e){if(X.targeting=e,X.ce.root.classList.add(`targeting`),X.cb.enemies.forEach((e,t)=>X.ce.enemies[t].root.classList.toggle(`targetable`,e.hp>0)),WA(),document.addEventListener(`pointermove`,rj),rj._last)rj(rj._last);else{let e=X.cb.enemies.findIndex(e=>e.hp>0);if(e>=0){let t=hA(e);rj({clientX:t.x,clientY:t.y,synthetic:!0})}}}function nj(){X.targeting=null,Z(`#aim`).innerHTML=``,document.removeEventListener(`pointermove`,rj),Jm(),X.ce&&(X.ce.root.classList.remove(`targeting`),X.ce.enemies.forEach(e=>e.root.classList.remove(`targetable`,`target-hover`,`aim-target`,`aim-mesh`)),X.ce.hero?.classList.remove(`aim-target`,`aim-mesh`),WA()),Rk()}function rj(e){if(e.synthetic||(rj._last=e),!X.targeting)return;let t;if(X.targeting.kind===`card`){let e=Z(`.card[data-uid="${X.targeting.uid}"]`);t=e?qf(e):{x:_()/2,y:v()-200}}else t={x:_()/2,y:60};let{x:n,y:r}=e.synthetic?{x:e.clientX,y:e.clientY}:S(e.clientX,e.clientY),i=(t.x+n)/2,a=Math.min(t.y,r)-120;if(Z(`#aim`).innerHTML=`<path d="M${t.x} ${t.y-80} Q${i} ${a} ${n} ${r}" fill="none" stroke="rgba(255,89,100,.85)" stroke-width="4" stroke-dasharray="4 10" stroke-linecap="round"/>
    <circle cx="${n}" cy="${r}" r="9" fill="none" stroke="rgba(255,89,100,.95)" stroke-width="3"/>`,X.ce?.hero){let e=qf(X.ce.hero),t=`${Math.round(e.x+(n-e.x)*.3)}px`,i=`${Math.round(e.y+(r-e.y)*.3)}px`,a=Z(`#lantern`);a.style.setProperty(`--lx`,t),a.style.setProperty(`--ly`,i);let o=Z(`.combat-screen .stage-dim`);o&&(o.style.setProperty(`--lx`,t),o.style.setProperty(`--ly`,i))}}async function ij(e,t){if(!lj.has(String(e))){let t=Z(`.card[data-uid="${e}"]`,X.ce?.hand);t&&uj(e,t)}nj(),X.hoveredCard=null,dg(X.run,X.cb,e,t)&&(await Kj(t),Qj())}async function aj(){X.busy||!X.cb||X.cb.over||(nj(),Y.click(),hg(X.run,X.cb),await Kj(),Qj())}function oj(e){let t=$(`div`,`turn-banner`,e);bk().appendChild(t),setTimeout(()=>t.remove(),1150)}function sj(e,t,n,r,{n:i=6,color:a=`#ffe9ac`,size:o=8,dur:s=640,glyph:c=``,cls:l=`flymote`,done:u=null}={}){let d=Z(`#floaties`);for(let f=0;f<i;f++){let p=$(`div`,l,c);p.style.left=`${e}px`,p.style.top=`${t}px`,c?p.style.color=a:(p.style.width=`${o}px`,p.style.height=`${o}px`,p.style.background=`radial-gradient(circle at 35% 30%, #fff, ${a} 55%, transparent 85%)`),d.appendChild(p);let m=(e+n)/2+(Math.random()-.5)*140,h=Math.min(t,r)-50-Math.random()*80,g=p.animate([{transform:`translate(-50%,-50%) scale(0.5)`,opacity:0},{transform:`translate(calc(-50% + ${m-e}px), calc(-50% + ${h-t}px)) scale(1.05)`,opacity:1,offset:.45},{transform:`translate(calc(-50% + ${n-e}px), calc(-50% + ${r-t}px)) scale(0.55)`,opacity:.95}],{duration:s,delay:f*46,easing:`cubic-bezier(.32,.05,.35,1)`});g.onfinish=()=>{p.remove(),f===i-1&&u&&u()}}}function cj(e){!e||xj||(e.classList.remove(`pile-bump`),e.offsetWidth,e.classList.add(`pile-bump`))}var lj=new Map;function uj(e,t,n={}){if(e==null||!t)return;let r=C(t);r.width<2||lj.set(String(e),{x:r.left+r.width/2,y:r.top+r.height/2,w:r.width,h:r.height,fromDrag:!!n.fromDrag})}function dj(e){return lj.get(String(e))||null}function fj(e){let t=String(e),n=lj.get(t);return lj.delete(t),n||null}function pj(e){let t=e?.querySelector(`.pile-layer`);if(t){let e=C(t);if(e.width>2&&e.height>2)return{w:e.width,h:e.height}}let n=e?.querySelector(`.pile-stack`);if(n){let e=C(n);if(e.width>2)return{w:e.width,h:e.width*(148/96)}}return{w:96,h:130}}function mj(){let e=X.ce?.hand?getComputedStyle(X.ce.hand).getPropertyValue(`--hand-scale`):``,t=parseFloat(e);return Number.isFinite(t)&&t>0?t:1}function hj(){let e=X.ce?.hand?.querySelector(`.card:not(.played-up):not(.draw-pending):not(.lifted):not(.armed):not(.dragging)`)||X.ce?.hand?.querySelector(`.card:not(.played-up):not(.draw-pending)`),t=mj();if(e){let n=parseFloat(getComputedStyle(e).getPropertyValue(`--cw`));if(n>2){let e=n*t;return{w:e,h:Math.round(e*1.42)}}if(e.offsetWidth>2)return{w:e.offsetWidth,h:e.offsetHeight||Math.round(e.offsetWidth*1.42)}}let n=152*t;return{w:n,h:Math.round(n*1.42)}}function gj(){let e=X.ce?.hand?.querySelector(`.card`);if(e){let t=parseFloat(getComputedStyle(e).bottom);if(Number.isFinite(t))return t}return 8}function _j(e,t){let n=Math.max(1,t|0),r=Math.max(0,Math.min(n-1,e|0)),i=Math.min(112,640/n,(_()-246)/Math.max(n-1,1)),a=n>1?(r-(n-1)/2)*Math.min(5,42/n):0,o=(r-(n-1)/2)*i,s=Math.abs(a)*3.2+26,c=hj(),l=v()-gj(),u=X.ce?.hand;if(u){let e=C(u);e.height>2&&(l=e.bottom-gj())}let d=_()/2;if(u){let e=C(u);e.width>2&&(d=e.left+e.width/2)}return{x:d+o,y:l-c.h/2+s}}function vj(e,{pileBtn:t,src:n,fallback:r}={}){if(e&&typeof e==`object`&&e.w)return{w:e.w,h:e.h};if(e===`hand`)return hj();if(e===`src`&&n?.w)return{w:n.w,h:n.h};if(e===`src`&&n?.el){let e=C(n.el);if(e.width>2)return{w:e.width,h:e.height}}return e===`pile`||e==null?pj(t):r||pj(t)}function yj(e,t,n,r={}){let i=Z(`#floaties`),a=qf(t),o=e.length,{stagger:s,flightDur:c,awaitMs:l}=r.schedule||JC(o,n);if(xj||o===0)return Promise.resolve(0);let u=r.sizePile||t,d=r.face===`back`||r.face===`card`?null:gC(`piles`,qC(r.pileArt||`draw`));return e.forEach((e,t)=>{let n=e.el?(()=>{let t=C(e.el);return{x:t.left+t.width/2,y:t.top+t.height/2,w:t.width,h:t.height}})():e,o=e.dest||a,l=vj(r.fromSize||`pile`,{pileBtn:u,src:n}),f=r.toSize==null?l:vj(r.toSize,{pileBtn:u,src:n,fallback:l}),p=l.w>0?f.w/l.w:1,m=e.inst||r.cardInst,h,g=1,_=p;if(r.face===`card`&&m){let e=hj(),r=e.w,i=e.h;g=r>0?l.w/r:1,_=r>0?f.w/r:p,h=Lk(m,{inCombat:!0,size:r}),h.classList.add(`flycard-face`),Object.assign(h.style,{position:`absolute`,left:`${n.x}px`,top:`${n.y}px`,width:`${r}px`,height:`${i}px`,margin:0,transform:`translate(-50%,-50%) scale(${g})`,zIndex:58+t,pointerEvents:`none`})}else h=$(`div`,d?`flycard flycard-pile`:`flycard flycard-back`),h.style.left=`${n.x}px`,h.style.top=`${n.y}px`,h.style.width=`${l.w}px`,h.style.height=`${l.h}px`,h.style.zIndex=String(58+t),d&&(h.style.backgroundImage=`url(${d})`);i.appendChild(h);let v=r.arc===`smooth`,y=r.easing||(v?`cubic-bezier(.22,.7,.28,1)`:`cubic-bezier(.32,.05,.35,1)`),b=v?n.x+(o.x-n.x)*.42+(Math.random()-.5)*18:(n.x+o.x)/2+(Math.random()-.5)*80,x=v?Math.min(n.y,o.y)-18-Math.random()*16:Math.min(n.y,o.y)-40-Math.random()*50,S=b-n.x,w=x-n.y,T=o.x-n.x,E=o.y-n.y,D=g+(_-g)*(v?.55:.45),O=v?[{transform:`translate(-50%,-50%) scale(${g})`,opacity:1,offset:0},{transform:`translate(calc(-50% + ${S*.55}px), calc(-50% + ${w*.55}px)) scale(${g+(D-g)*.5})`,opacity:1,offset:.35},{transform:`translate(calc(-50% + ${S}px), calc(-50% + ${w}px)) scale(${D})`,opacity:.98,offset:.62},{transform:`translate(calc(-50% + ${T}px), calc(-50% + ${E}px)) scale(${_})`,opacity:.92,offset:1}]:[{transform:`translate(-50%,-50%) scale(${g})`,opacity:.95},{transform:`translate(calc(-50% + ${S}px), calc(-50% + ${w}px)) scale(${D})`,opacity:1,offset:.45},{transform:`translate(calc(-50% + ${T}px), calc(-50% + ${E}px)) scale(${_})`,opacity:.9}];h.animate(O,{duration:c,delay:t*s,easing:y,fill:`forwards`}).onfinish=()=>h.remove()}),Q(l)}function bj(e,t){return(e||[]).find(e=>String(e.uid)===String(t))||null}var xj=matchMedia(`(prefers-reduced-motion: reduce)`).matches;function Sj(e,t,n,r=640){if(t=Math.round(t),n=Math.round(n),xj||t===n){e.textContent=n;return}let i=performance.now(),a=o=>{let s=Math.min(1,(o-i)/r),c=1-(1-s)**3;e.textContent=Math.round(t+(n-t)*c),s<1?requestAnimationFrame(a):(e.textContent=n,e.classList.remove(`tick`),e.offsetWidth,e.classList.add(`tick`))};requestAnimationFrame(a)}function Cj(e){let t=getComputedStyle(e).transform;if(!t||t===`none`)return 0;let n=t.match(/matrix(?:3d)?\(([^)]+)\)/);if(!n)return 0;let r=n[1].split(`,`).map(e=>parseFloat(e.trim())),i=r.length===16?r[13]:r[5];return Math.max(0,-i)}function wj(e,t){let n=$(`div`,`cast-shadow`);if(e){let t=document.createElement(`img`);t.src=e,t.alt=``,t.setAttribute(`aria-hidden`,`true`),n.appendChild(t)}else if(t){let e=t.cloneNode(!0);e.setAttribute(`aria-hidden`,`true`),n.appendChild(e)}else n.classList.add(`cast-shadow-blob`);return n}function Tj(e){if(!e.shadow||!e.art)return;let t=C(e.art);e.shadow.style.left=`${t.left}px`,e.shadow.style.top=`${t.top}px`,e.shadow.style.width=`${t.width}px`,e.shadow.style.height=`${t.height}px`}function Ej(e,t){if(!e.shadow||!e.shadowId)return;Tj(e);let n=fp(e.shadowId),r=e.shadowMax||16,i=Math.min(1,t/r),a=n.sx*(1-i*.26),o=n.sy*(1-i*.5),s=n.opacity*(1-i*.55),c=n.blur+i*2.8,l=n.skew*(1-i*.35),u=n.dx+n.skew*.35*(1-i*.5),d=n.dy;e.shadow.style.setProperty(`--foot-ox`,`${n.ox}%`),e.shadow.style.setProperty(`--foot-oy`,`${n.oy}%`),e.shadow.style.setProperty(`--sh-sx`,a.toFixed(3)),e.shadow.style.setProperty(`--sh-sy`,o.toFixed(3)),e.shadow.style.setProperty(`--sh-o`,s.toFixed(3)),e.shadow.style.setProperty(`--sh-blur`,`${c.toFixed(1)}px`),e.shadow.style.setProperty(`--sh-skew`,`${l.toFixed(2)}deg`),e.shadow.style.setProperty(`--sh-x`,`${u.toFixed(1)}px`),e.shadow.style.setProperty(`--sh-y`,`${d}px`)}function Dj(){let e=X.ce,t=X.cb;e.rig=[];let n=Z(`.cast-shadow-layer`,e.root);n&&(n.innerHTML=``);let r=(t,r,i,a,o,s,c=0,l=``,u=``,d=0)=>{let f=Z(`svg`,r),p=Z(`.enemy-sprite`,r)||r,m=Z(`.raster-art`,p);if(!f&&!m)return;let h=Math.random()*100;if(f){let e=Z(`.breathe`,f);e&&(e.style.animationDuration=`${(2.5+h%1.9).toFixed(2)}s`,e.style.animationDelay=`${(-(h%3.1)).toFixed(2)}s`,e.style.setProperty(`--brY`,(1.022+h%.024).toFixed(3)),e.style.setProperty(`--sw`,`${(h*7%1.7-.85).toFixed(2)}deg`)),yk(`.hover-float`,f).forEach(e=>e.style.animationDelay=`${(-(h%2.7)).toFixed(2)}s`)}else if(s){p.classList.add(`idle-${s}`),p.style.animationDelay=`${(-(h%2.8)).toFixed(2)}s`;let e=u?mp(u):null;if(e!=null&&p.style.setProperty(`--float-y`,`${e}px`),s===`wisp`||s===`plant`){let e=$(`div`,`idle-motes`);e.style.setProperty(`--mote`,`hsla(${c},85%,62%,0.6)`),p.appendChild(e)}}let g=wj(l||m?.src||``,f);(n||r).appendChild(g);let _={root:t,art:r,sprite:p,svg:f,eyes:f?yk(`.eye`,f):[],fire:f?Z(`.innerfire`,f):null,pool:null,shadow:g,shadowId:u,footY:d,shadowMax:{wisp:20,eye:20,siren:14,shade:14,plant:10,slime:6}[s]||12,seed:h,isHero:a,idx:o,dx:0,dy:0};e.rig.push(_),Ej(_,0)},i=ak(nk(x().shape,X.run.act),t.enemies.length);t.enemies.forEach((t,n)=>{let a=Fu[t.key].art;r(e.enemies[n].root,e.enemies[n].art,`hsla(${a.hue},90%,66%,.72)`,!1,n,a.kind,a.hue,gC(`enemies`,t.key),t.key,sk(i[n],t.key))});let a=qu[X.run.aspect].id;r(e.hero,e.hero,`rgba(127,212,255,.62)`,!0,0,`humanoid`,0,gC(`heroes`,a),a,ik(`heroes`,a).footY)}function Oj(){if(!Cp())return;let e=X.ce,t=X.cb;if(!e||!t)return;let n=[],r=gC(`heroes`,qu[X.run.aspect].id),i=e.hero&&(Z(`.hero-sprite`,e.hero)||e.hero);r&&i&&n.push({el:i,url:r,kind:`humanoid`,id:qu[X.run.aspect].id}),t.enemies.forEach((t,r)=>{let i=gC(`enemies`,t.key),a=e.enemies[r]?.art,o=a&&(Z(`.enemy-sprite`,a)||a);i&&o&&n.push({el:o,url:i,kind:Fu[t.key].art.kind,id:t.key})}),Wm(n),t.player.block>0&&i&&kk(i,!0,!0),t.enemies.forEach((t,n)=>{if(t.block<=0)return;let r=e.enemies[n]?.art,i=r&&(Z(`.enemy-sprite`,r)||r);i&&kk(i,!0,!0)})}function kj(){requestAnimationFrame(()=>requestAnimationFrame(Oj))}function Aj(){Nm()}var jj=!1;function Mj(e){if(jj)return;requestAnimationFrame(Mj);let t=X.ce,n=X.cb;if(xj||!n||X.screen!==`combat`||!t?.rig)return;let r=null,i=n.enemies.findIndex(e=>e.hp>0);X.targeting&&rj._last?r=S(rj._last.clientX,rj._last.clientY):i>=0&&(r=hA(i));let a=gA();for(let i of t.rig){let t=i.isHero?n.player:n.enemies[i.idx];if(!i.isHero&&t.hp<=0){i.pool&&(i.pool.style.opacity=0),i.shadow&&(i.shadow.style.opacity=0);continue}let o=Cj(i.sprite);i.sprite.classList.contains(`mesh-live`)&&(o+=Gm(i.sprite)),Ej(i,o);let s=i.isHero?r:a;if(s&&i.eyes.length){let e=qf(i.art),t=Math.atan2(s.y-e.y,s.x-e.x);i.dx+=(Math.cos(t)*2.4-i.dx)*.08,i.dy+=(Math.sin(t)*1.6-i.dy)*.08;let n=`translate(${i.dx.toFixed(2)}px,${i.dy.toFixed(2)}px)`;for(let e of i.eyes)e.style.transform=n}let c=.45+.55*(Math.max(0,t.hp)/t.maxHp);i.root.dataset.choreo===`attack`&&(c+=1.1),(t.statuses?.str||0)>0&&(c+=.3);let l=.86+.14*Math.sin(e*.006+i.seed)*Math.sin(e*.0021+i.seed*3);i.fire&&(i.fire.style.opacity=Math.min(.55,(.05+.13*c)*l).toFixed(3)),i.pool&&(i.pool.style.opacity=Math.min(.85,(.3+.4*c)*l).toFixed(3))}}var Nj=!1,Pj={archetype:`slash`,cardId:null,enemyIdx:null},Fj=!1,Ij=!1,Lj=0,Rj={beast:`slash`,rogue:`slash`,knight:`slash`,sovereign:`slash`,golem:`blunt`,treeboss:`blunt`,crab:`blunt`,leviathan:`blunt`,zombie:`blunt`,serpent:`pierce`,crawler:`pierce`,maw:`pierce`,plant:`pierce`,wisp:`void`,shade:`void`,eye:`void`,siren:`void`,cultist:`void`,slime:`poison`},zj=matchMedia(`(prefers-reduced-motion: reduce)`).matches,Bj=new Set([`golem`,`treeboss`,`leviathan`,`crab`]),Vj=new Set([`wisp`,`shade`,`siren`,`eye`,`cultist`]);function Hj(e,t=1,n=`humanoid`){if(zj||!e)return Promise.resolve();let r=Bj.has(n),i=Vj.has(n),a=r?[{transform:`translateX(0) scale(1,1)`},{transform:`translateX(0) scale(1.08,0.86)`,offset:.35},{transform:`translateX(0) scale(1,1)`}]:i?[{transform:`translateX(0) translateY(0) scale(1,1)`},{transform:`translateX(${6*t}px) translateY(-5px) scale(0.98,1.02)`,offset:.4},{transform:`translateX(${10*t}px) translateY(-2px) scale(1,1)`,offset:.7},{transform:`translateX(0) translateY(0) scale(1,1)`}]:[{transform:`translateX(0) scale(1,1)`},{transform:`translateX(${-8*t}px) scale(0.97,1.02)`,offset:.3},{transform:`translateX(${34*t}px) scale(1.02,0.99)`,offset:.62},{transform:`translateX(0) scale(1,1)`}];return e.dataset.choreo=`attack`,e.animate(a,{duration:r?420:i?380:330,easing:`cubic-bezier(0.34, 1.56, 0.64, 1)`}).finished.finally(()=>{delete e.dataset.choreo}).catch(()=>{})}function Uj(e,t=1){zj||!e||(Fm(e),e.animate([{transform:`translateX(0) scale(1,1)`,filter:`brightness(1)`},{transform:`translateX(${9*t}px) scale(0.97,1.03)`,filter:`brightness(1.9)`,offset:.25},{transform:`translateX(0) scale(1,1)`,filter:`brightness(1)`}],{duration:300,easing:`cubic-bezier(0.22, 1, 0.36, 1)`}))}function Wj(e){return zj||!e?Promise.resolve():e.animate([{transform:`translateY(0) rotate(0deg)`,filter:`brightness(1)`},{transform:`translateY(5px) rotate(-2.5deg)`,filter:`brightness(0.6)`}],{duration:360,easing:`cubic-bezier(0.22, 1, 0.36, 1)`,fill:`forwards`}).finished.catch(()=>{})}function Gj(e,t=200){if(Cp()&&Bm(e.root,0)){for(let t=0;t<3;t++)zm(e.art);let n=performance.now(),r=()=>{let i=Math.min(1,(performance.now()-n)/t),a=i*i*(3-2*i);Bm(e.root,a)&&i<1&&requestAnimationFrame(r)};requestAnimationFrame(r);return}Pm(e.root);let n=e.art&&Z(`.cracks`,e.art);n&&(n.insertAdjacentHTML(`beforeend`,CC(!0)),n.children.length<9&&n.insertAdjacentHTML(`beforeend`,CC(!0))),e.root.classList.add(`igniting`)}async function Kj(e=null){let t=X.cb,n=X.ce;X.busy=!0,n.endTurn.classList.add(`enemy-phase`);let r=t.queue;for(;r.length;){let t=r[0];try{t.t===`draw`||t.t===`reshuffle`?await Yj(r):(r.shift(),await Zj(t,e))}catch(e){console.error(`vfx event error`,t,e)}}X.busy=!1,t.over||n.endTurn.classList.remove(`enemy-phase`),PA=null,jA(),UA(),zk()}function qj(e){let t=[];for(;e[0]?.t===`draw`||e[0]?.t===`reshuffle`;)if(e[0].t===`reshuffle`)t.push({t:`reshuffle`,ev:e.shift()});else{let n=[];for(;e[0]?.t===`draw`;)n.push(e.shift());t.push({t:`draws`,draws:n})}return t}async function Jj(e){let t=X.cb,n=X.ce;Y.card();let r=e.n||6;PA?(PA.discard=r,PA.draw=0,MA(t)):(FA(`draw`,r),MA(t)),await yj(Array.from({length:r},()=>qf(n.discard)),n.draw,560,{fromSize:`pile`,sizePile:n.discard,pileArt:`discard`}),PA?(PA.discard=0,PA.draw=r):IA(`draw`,r),cj(n.draw),Bf(qf(n.draw).x,qf(n.draw).y-46,`Reshuffle`,`notice`),MA(t)}async function Yj(e){let t=X.cb,n=X.ce,r=qj(e),i=r.find(e=>e.t===`reshuffle`);X.hoveredCard!=null&&(X.hoveredCard=null);let a=r[0]?.t===`draws`?r[0].draws.length:0;PA={draw:r[0]?.t===`draws`?i?a:t.draw.length+a:0,discard:i&&i.ev.n||0},RA.clear();let o=0;for(let e of r)if(e.t===`draws`)for(let t of e.draws)RA.set(String(t.uid),{landAt:null,seq:o++});UA(),MA(t);let s=yk(`.card`,n.hand).filter(e=>!e.classList.contains(`draw-pending`)).length,c=0;for(let e of r){if(e.t===`reshuffle`){await Jj(e.ev);continue}let r=e.draws,i=r.length;if(!i)continue;let a=YC(i,500);if(r.forEach((e,t)=>{let r=String(e.uid),i=xj?0:a.flightDur+t*a.stagger;RA.delete(r);let o=Z(`.card[data-uid="${r}"]`,n.hand);o&&!xj?HA(o,i):o&&o.classList.remove(`draw-pending`)}),xj)WA(),await Q(40);else{let e=qf(n.draw),i=r.map((n,r)=>{let i=t.hand.find(e=>String(e.uid)===String(n.uid))||{uid:n.uid,id:n.id,up:!1,bonus:0},a=_j(s+c+r,s+c+r+1);return{x:e.x,y:e.y,inst:i,dest:a}});r.forEach((e,n)=>{setTimeout(()=>{PA&&(PA.draw=Math.max(0,(PA.draw||0)-1),MA(t))},n*a.stagger)}),yj(i,n.hand,500,{fromSize:`pile`,toSize:`hand`,sizePile:n.draw,face:`card`,schedule:a}),cj(n.draw),r.forEach((e,t)=>setTimeout(()=>Y.draw(),t*a.stagger)),await Q(a.awaitMs)}c+=i,PA&&(PA.draw=Math.max(0,PA.draw||0)),MA(t)}PA=null,jA()}var Xj=null;async function Zj(e,t){let n=X.cb,r=X.ce;switch(e.t){case`chip`:{let t=r.enemies[e.idx],{x:n,y:i}=hA(e.idx);Y.chip(),If(n,i,{color:`#e8f4ff`,n:5,speed:190,size:1.8,grav:240,kind:`spark`}),jA(),t.facets.classList.remove(`pop`),t.facets.offsetWidth,t.facets.classList.add(`pop`),await Q(110);break}case`shatter`:{let t=r.enemies[e.idx],{x:n,y:i}=hA(e.idx);Xj={x:n,y:i},Y.shatter(),Pf(90),Lf(n,i,`#dfeaff`,10,700,5),If(n,i,{color:`#dfeaff`,n:26,speed:430,size:2.4,grav:300,kind:`spark`}),Bf(n,i-58,`${zC(`stagger`,20)} SHATTER`,`shatterf`),Nf(10),af(.9),t.art,t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),jA(),await Q(380);break}case`adamantHold`:{let{x:t,y:n}=hA(e.idx);Y.blocked(),Bf(t,n-52,`THE GLASS HOLDS`,`blockedf`),Lf(t,n,`#d8c27a`,8,480,4),jA(),await Q(260);break}case`ember`:if(e.n>0&&r.lantern){let t=Xj||gA(),n=qf(r.lantern);sj(t.x,t.y,n.x,n.y,{n:Math.min(e.n*2,5),color:`#ffb35a`,size:6,dur:460}),Y.ember(),setTimeout(()=>{r.lantern.classList.remove(`pop`),r.lantern.offsetWidth,r.lantern.classList.add(`pop`),jA()},440),await Q(300)}else jA();Xj=null;break;case`kindle`:{let t=Z(`.card[data-uid="${e.uid}"]`,r.hand);t&&(Xj=qf(t)),Y.kindle(),await Q(60);break}case`art`:{Pj={archetype:`fire`,cardId:`art:${e.id}`,enemyIdx:null},Fj=!1;{let{x:t,y:n}=qf(r.lantern);tp[`art:${e.id}`]?.(t,n),Fj=!0}let t=Hu[e.id],{x:n,y:i}=gA(),a=r.lantern?qf(r.lantern):{x:n,y:i};Y.art(),Ff(t.tone,.12,.5),Lf(a.x,a.y,t.tone,10,620,5),zf(n,i,t.tone,12),Bf(n,i-84,t.name.toUpperCase(),`artf`);let o=gC(`arts`,e.id);if(o){let e=$(`img`,`art-cast`);e.src=o,Z(`#floaties`).appendChild(e),e.style.left=`${n}px`,e.style.top=`${i-30}px`,e.animate([{transform:`translate(-50%,-50%) scale(0.4)`,opacity:0},{transform:`translate(-50%,-58%) scale(1)`,opacity:1,offset:.3},{transform:`translate(-50%,-70%) scale(1.05)`,opacity:0}],{duration:900,easing:`cubic-bezier(.2,.7,.3,1)`}).onfinish=()=>e.remove()}af(.7),jA(),await Q(420);break}case`staggered`:{let t=r.enemies[e.idx],{x:n,y:i}=hA(e.idx);Y.stagger(),Bf(n,i-76,`STAGGERED`,`staggerf`),t.root.classList.add(`reseaming`),setTimeout(()=>t.root.classList.remove(`reseaming`),720),jA(),await Q(520);break}case`smolderJump`:{let t=hA(e.from),n=hA(e.to);Y.poison(),sj(t.x,t.y,n.x,n.y,{n:5,color:`#d3a15a`,size:7,dur:460}),await Q(400);break}case`turn`:e.n>1&&(oj(`YOUR TURN`),Y.turn()),jA(),await Q(e.n>1?500:120);break;case`endTurn`:Nj=!1,oj(`ENEMY TURN`),await Q(480);break;case`draw`:await Yj([e]);break;case`reshuffle`:await Jj(e),jA();break;case`play`:{let i=Z(`.card[data-uid="${e.uid}"]`,r.hand);if(Y.card(),Nj=!0,Lj=0,Pj={archetype:ku[e.id]?.vfx||`slash`,cardId:e.id,enemyIdx:null},Fj=!1,Ij=!1,!Fj&&tp[e.id]&&[`ascension`,`pyreheart`,`emberdance`,`limitBreak`].includes(e.id)){let t=n.enemies.findIndex(e=>e.hp>0),r=e.id===`limitBreak`&&t>=0?hA(t):gA();tp[e.id](r.x,r.y),Fj=!0}if(i&&t!=null&&n.enemies[t]){let n=C(i),{x:r,y:a}=hA(t);lj.set(String(e.uid),{x:r,y:a,w:n.width*.22,h:n.height*.22});let o=i.cloneNode(!0);Object.assign(o.style,{position:`fixed`,left:`${n.left}px`,top:`${n.top}px`,width:`${n.width}px`,height:`${n.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(o),i.remove(),o.animate([{transform:`none`,opacity:1},{transform:`translate(${r-n.left-n.width/2}px,${a-n.top-n.height/2}px) scale(0.22) rotate(14deg)`,opacity:0}],{duration:270,easing:`cubic-bezier(.45,0,.9,.5)`}).onfinish=()=>o.remove()}else i&&(i.classList.add(`played-up`),i.offsetWidth,dj(e.uid)?.fromDrag||uj(e.uid,i));LA(n,e.uid),jA(),await Q(200);break}case`hitEnemy`:{let t=r.enemies[e.idx],{x:i,y:a}=hA(e.idx);if(e.poison)Y.poison(),zf(i,a,`#d3a15a`,14),Bf(i,a-20,`${e.amount}`,`poisonf`);else{let o=e.amount>=16;if(Nj&&Pj.cardId&&!String(Pj.cardId).startsWith(`art:`)&&(Ij||=(await Hj(r.hero,1,`humanoid`),!0)),Y.attack({who:`hero`,amount:e.amount,blocked:e.blocked}),!Fj&&Pj.cardId&&tp[Pj.cardId]&&(tp[Pj.cardId](i,a),Fj=!0),$f(i,a,Pj.archetype,Math.min(1,e.amount/24)),Uj(t.root,1),e.blocked>0&&(Y.blocked(),Bf(i,a+26,`${zC(`shield`,19)}${e.blocked}`,`blockedf`),If(i,a+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`}),n.enemies[e.idx].block===0&&e.amount===0&&(Bf(i,a-2,`GUARD SHATTERED`,`shatterf`),Qf(i,a,`#9fd4ff`,14))),e.amount>0){let t=e.killingBlow&&e.overkill>=8?`dmg-overkill`:e.killingBlow?`dmg-kill`:o?`dmg-big`:`dmg`;Bf(i,a-24,`${e.amount}`,t,{tint:Jf[Pj.archetype]||``,dx:(Lj++%3-1)*34})}else e.blocked||Bf(i,a-24,`0`,`blockedf`);Nf(Math.min(4+e.amount*.5,15)),af(Math.min(.2+e.amount/26,1)),o&&(Pf(70),Lf(i,a,`#ffd8a0`,10,620,5)),e.killingBlow&&(Pf(e.overkill>=8?130:90),af(Math.min(1.6,.6+e.overkill*.06)),Lf(i,a,`#ffffff`,8,780,5),Lf(i,a,`#ffd8a0`,14,900,4),Ff(`#ffe6b0`,.09,.28),e.overkill>=8&&(Ff(`#ffffff`,.12,.24),If(i,a,{color:`#fff3d6`,n:26,speed:620,size:2.6,grav:200,kind:`spark`}),If(i,a,{color:`#ffd76e`,n:12,speed:300,size:3.4,grav:120,kind:`spark`}))),e.amount>0&&t.art}t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),jA(),await Q(230);break}case`die`:{let t=r.enemies[e.idx],i=n.enemies[e.idx],{x:a,y:o}=hA(e.idx);Xj={x:a,y:o},i.boss&&(document.body.classList.add(`worldstop`),t.root.classList.add(`doomed`),Pf(110),await Q(820),document.body.classList.remove(`worldstop`),t.root.classList.remove(`doomed`)),await Wj(t.art);let s=i.boss?320:200;xj||(Gj(t,s),await Q(s)),(i.boss||i.elite?Y.bigDeath:Y.death)(),xj||Bm(t.root,1);let c=Cp()?Hm(t.root):null;c||Pm(t.root),Kf(t.art,c||{}),If(a,o,{color:`#dfeaff`,n:30,speed:480,size:2.6,grav:340,kind:`spark`}),If(a,o,{color:`#c9b0ff`,n:26,speed:380,size:3.2,grav:60}),Lf(a,o,`#e8dcff`,12,720,6),Ff(`#ffffff`,i.boss?.24:.1,.3),Nf(i.boss?22:12),af(i.boss?2:.9),t.root.classList.add(`dying`),setTimeout(()=>{t.root.classList.remove(`dying`),t.root.classList.add(`gone`),t.reaped=!0},830),await Q(i.boss?900:500);break}case`hitPlayer`:{let{x:t,y:i}=gA();if(e.source===`poison`?(Y.poison(),zf(t,i,`#d3a15a`,14)):e.source===`burn`||e.source===`self`?Y.debuff():e.source===`thorns`?Y.blocked():(Y.attack({who:`enemy`,amount:e.amount,blocked:e.blocked}),e.amount>0&&Ff(`#ff2233`,Math.min(.05+e.amount*.012,.3),.3),$f(t,i,Pj.archetype,Math.min(1,e.amount/24)),Uj(r.hero,-1)),e.blocked>0&&(Y.blocked(),Bf(t,i+30,`${zC(`shield`,19)}${e.blocked}`,`blockedf`),If(t,i+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`}),n.player.block===0&&e.amount===0&&(Bf(t,i-2,`GUARD SHATTERED`,`shatterf`),Qf(t,i,`#9fd4ff`,14))),e.amount>0){let n=e.amount>=16;Bf(t,i-30,`${e.amount}`,n?`dmg-big`:`dmg`,{tint:Jf[Pj.archetype]||``,dx:(Lj++%3-1)*34}),Nf(Math.min(5+e.amount*.6,18)),af(Math.min(.3+e.amount/22,1.2))}else e.blocked||Bf(t,i-30,`0`,`blockedf`);jA(),zk(),await Q(240);break}case`blockGain`:{let t=e.who===`player`,{x:n,y:i}=t?gA():hA(e.who);Y.block(),kk(t?Z(`.hero-sprite`,r.hero)||r.hero:Z(`.enemy-sprite`,r.enemies[e.who]?.art)||r.enemies[e.who]?.art,!0,!0),Bf(n,i-10,`${zC(`shield`,22)} ${e.n}`,`blockf`);let a=t?r.pBlock:r.enemies[e.who].block;a.classList.remove(`pulse`),a.offsetWidth,a.classList.add(`pulse`),jA(),await Q(140);break}case`status`:{let{x:t,y:n}=e.who===`player`?gA():hA(e.who),r=ju[e.id]||{name:e.id,kind:`buff`},i=r.kind===`debuff`||e.id===`str`&&e.n<0;(e.id===`poison`?Y.poison:i?Y.debuff:Y.buff)(),Bf(t,n-46,`${e.n>0?`+`:``}${e.n} ${r.name}`,i?`debufff`:`bufff`),i||zf(t,n,`#9fc8ff`,6),jA(),await Q(170);break}case`heal`:{let{x:t,y:n}=e.who===`player`?gA():hA(e.who);Y.heal(),zf(t,n,`#8fe8a0`,14),Bf(t,n-30,`+${e.n}`,`healf`),jA(),zk(),await Q(200);break}case`energy`:Y.energy(),jA(),r.energy.classList.remove(`pop`),r.energy.offsetWidth,r.energy.classList.add(`pop`);break;case`exhaust`:{let t=Z(`.card[data-uid="${e.uid}"]`,r.hand),i=fj(e.uid),a=bj(n.exhaust,e.uid);if(xj){t&&t.remove(),IA(`ashes`,1),jA();break}if(i?.fromDrag||t?.classList.contains(`played-up`)||!t&&i){let e=null;if(i?.fromDrag)e={...i,inst:a};else if(t){let n=C(t);n.width>2&&(e={x:n.left+n.width/2,y:n.top+n.height/2,w:n.width,h:n.height,inst:a})}!e&&i&&(e={...i,inst:a}),!e&&a&&(e={...qf(r.hand),...hj(),inst:a}),t&&(t.classList.add(`draw-pending`),WA()),a&&e&&await yj([{...e,inst:a}],r.exhaust,200,{fromSize:`src`,toSize:`pile`,sizePile:r.exhaust,face:`card`,cardInst:a,schedule:{stagger:0,flightDur:200,awaitMs:200},arc:`smooth`,easing:`cubic-bezier(.22,.7,.28,1)`}),t&&t.remove(),IA(`ashes`,1),cj(r.exhaust),jA();break}let o=t?C(t):null,s=o&&o.width>2?{x:o.left+o.width/2,y:o.top+o.height/2,w:o.width,h:o.height}:i;if(t&&s){let e=t.cloneNode(!0);Object.assign(e.style,{position:`fixed`,left:`${s.x-s.w/2}px`,top:`${s.y-s.h/2}px`,width:`${s.w}px`,height:`${s.h}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`,opacity:`1`}),document.getElementById(`floaties`).appendChild(e),t.remove(),e.animate([{clipPath:`circle(80% at 50% 55%)`,filter:`brightness(1)`},{clipPath:`circle(44% at 50% 55%)`,filter:`brightness(1.8) saturate(1.6) sepia(0.45)`,offset:.45},{clipPath:`circle(0% at 50% 55%)`,filter:`brightness(2.6) saturate(2) sepia(0.85)`}],{duration:540,easing:`ease-in`}).onfinish=()=>e.remove(),If(s.x,s.y,{color:`#ffb066`,n:22,speed:190,grav:-150,size:2.4,life:.85});let n=qf(r.exhaust);sj(s.x,s.y,n.x,n.y,{n:8,color:`#ffb066`,size:5,dur:480}),cj(r.exhaust),await Q(260)}else t&&t.remove();IA(`ashes`,1),jA();break}case`discardHand`:{let t=e.uids||[],i=t.length;if(Y.card(),!i){jA();break}if(xj){t.forEach(e=>{fj(e),Z(`.card[data-uid="${e}"]`,r.hand)?.remove()}),jA();break}FA(`discard`,i);let a=YC(i,500),o=[];for(let e of t){let t=Z(`.card[data-uid="${e}"]`,r.hand),i=bj(n.discard,e)||{uid:e,id:t?.dataset?.id,up:!1,bonus:0},a=fj(e),s;if(a)s={x:a.x,y:a.y,w:a.w,h:a.h};else if(t){let e=C(t);s={x:e.left+e.width/2,y:e.top+e.height/2,w:e.width,h:e.height}}else s={...qf(r.hand),...hj()};o.push({...s,inst:i,el:t})}for(let e of o)e.el&&e.el.classList.add(`draw-pending`);if(WA(),o.length){let e=Z(`#floaties`),t=qf(r.discard),s=pj(r.discard);o.forEach((i,o)=>{let c=i.w>2?i.w:hj().w,l=i.h>2?i.h:hj().h,u=c>0?s.w/c:.65,d;if(i.el)d=i.el.cloneNode(!0),d.classList.remove(`draw-pending`,`lifted`,`armed`,`dragging`,`will-cast`,`will-burn`,`played-up`,`unplayable-now`),d.classList.add(`flycard-face`),d.removeAttribute(`style`),Object.assign(d.style,{position:`absolute`,left:`${i.x}px`,top:`${i.y}px`,width:`${c}px`,height:`${l}px`,margin:0,transform:`translate(-50%,-50%) scale(1)`,zIndex:58+o,pointerEvents:`none`,opacity:`1`});else if(i.inst?.id)d=Lk(i.inst,{inCombat:!0,size:c}),d.classList.add(`flycard-face`),Object.assign(d.style,{position:`absolute`,left:`${i.x}px`,top:`${i.y}px`,width:`${c}px`,height:`${l}px`,margin:0,transform:`translate(-50%,-50%) scale(1)`,zIndex:58+o,pointerEvents:`none`});else return;e.appendChild(d);let f=i.x+(t.x-i.x)*.45+(Math.random()-.5)*24,p=Math.min(i.y,t.y)-28-Math.random()*20,m=f-i.x,h=p-i.y,g=t.x-i.x,_=t.y-i.y,v=1+(u-1)*.5;d.animate([{transform:`translate(-50%,-50%) scale(1)`,opacity:1,offset:0},{transform:`translate(calc(-50% + ${m}px), calc(-50% + ${h}px)) scale(${v})`,opacity:1,offset:.5},{transform:`translate(calc(-50% + ${g}px), calc(-50% + ${_}px)) scale(${u})`,opacity:.92,offset:1}],{duration:a.flightDur,delay:o*a.stagger,easing:`cubic-bezier(.22,.7,.28,1)`,fill:`forwards`}).onfinish=()=>d.remove(),setTimeout(()=>{IA(`discard`,1),MA(n),cj(r.discard),Y.card()},a.flightDur+o*a.stagger)}),await Q(a.awaitMs);let c=i-o.length;c>0&&IA(`discard`,c)}else IA(`discard`,i);t.forEach(e=>Z(`.card[data-uid="${e}"]`,r.hand)?.remove()),jA();break}case`toDiscard`:{let t=Z(`.card[data-uid="${e.uid}"]`,r.hand),i=fj(e.uid),a=bj(n.discard,e.uid);if(!xj&&a&&(t||i)){let e=null;if(i?.fromDrag)e={...i,inst:a};else if(t){let n=C(t);n.width>2&&(e={x:n.left+n.width/2,y:n.top+n.height/2,w:n.width,h:n.height,inst:a})}if(!e&&i&&(e={...i,inst:a}),!e){IA(`discard`,1),cj(r.discard),jA();break}t&&(t.classList.add(`draw-pending`),WA()),await yj([e],r.discard,200,{fromSize:`src`,toSize:`pile`,sizePile:r.discard,face:`card`,cardInst:a,schedule:{stagger:0,flightDur:200,awaitMs:200},arc:`smooth`,easing:`cubic-bezier(.22,.7,.28,1)`}),t&&t.remove()}else t?t.remove():!xj&&a&&await yj([{...qf(r.hand),...hj(),inst:a}],r.discard,200,{fromSize:`hand`,toSize:`pile`,sizePile:r.discard,face:`card`,cardInst:a,schedule:{stagger:0,flightDur:200,awaitMs:200},arc:`smooth`,easing:`cubic-bezier(.22,.7,.28,1)`});IA(`discard`,1),cj(r.discard),jA();break}case`enemyAct`:{let t=r.enemies[e.idx],{x:i,y:a}=hA(e.idx);Lj=0;let o=Fu[n.enemies[e.idx].key]?.moves?.[e.move],s=Rj[Fu[n.enemies[e.idx].key]?.art?.kind]||`slash`;Pj={archetype:o?.intent?.startsWith(`attack`)?s:o?.intent===`debuff`?`void`:o?.intent===`buff`||o?.intent===`block`?`ward`:s,cardId:null,enemyIdx:e.idx},Fj=!1,Ij=!1,t.intent.classList.remove(`telegraph`),t.intent.offsetWidth,t.intent.classList.add(`telegraph`),Bf(i,a-90,e.name,`movef`),await Q(300),o?.intent?.startsWith(`attack`)?(await Hj(t.root,-1,Fu[n.enemies[e.idx].key]?.art?.kind),Ij=!0):await Q(320),t.intent.classList.remove(`telegraph`);break}case`intent`:jA();break;case`addCard`:Bf(_()/2,v()*.62,`${ku[e.id].name} added to ${e.where===`hand`?`hand`:`discard`}`,`notice`),Y.debuff(),jA(),UA(),await Q(240);break;case`relicProc`:{let t=Z(`.hud-relic[data-relic="${e.id}"]`);t&&(t.classList.remove(`proc`),t.offsetWidth,t.classList.add(`proc`)),await Q(90);break}case`maxHp`:{let{x:t,y:n}=gA();Bf(t,n-60,`+${e.n} MAX HP`,`healf`),Y.buff(),await Q(160);break}case`potion`:Y.potion(),await Q(120);break;case`powerConsumed`:{let t=Z(`.card[data-uid="${e.uid}"]`,r.hand),n=t?qf(t):{x:_()/2,y:v()-180};t&&t.remove();let{x:i,y:a}=gA();xj||(sj(n.x,n.y,i,a,{n:7,color:`#c9a8ff`,size:7,dur:560}),setTimeout(()=>{Lf(i,a,`#c9a8ff`,12,460,4),zf(i,a,`#c9a8ff`,8)},560)),Y.buff(),await Q(xj?40:300);break}case`victory`:if(X.lastPerfect=!!e.perfect,await Q(320),Y.victory(),Ff(`#ffe9ac`,.16,.6),e.perfect){let e=$(`div`,`turn-banner perfect-banner`,`PERFECT`);bk().appendChild(e),setTimeout(()=>e.remove(),1400),await Q(500)}break;case`defeat`:{await Q(400),Y.defeat(),Ff(`#300`,.5,1.2);let e=Z(`#lantern`);e.classList.add(`snuff`,`gutter`),e.style.setProperty(`--la`,`1`),e.style.setProperty(`--lr`,`160px`);let t=Z(`.combat-screen .stage-dim`);t&&(t.style.setProperty(`--la`,`0`),t.classList.remove(`gutter`)),await Q(900);break}}}function Qj(){let e=X.cb;!e||!e.over||(e.result===`win`?$j():eM())}function $j(){eA(`victory-out`);let e=X.run,t=X.cb.kind,n=X.cb.affix;if(X.cb=null,e.pendingCombat=null,t===`boss`&&e.act>=2){let{newUnlocks:t}=pw(e,!0);dw(e),Mg(e,!0),tA(`end`,{won:!0,newUnlocks:t});return}t===`boss`&&VO(`victory`),tA(`reward`,{kind:t,rewards:Fh(e,t,n)})}function eM(){eA(`defeat`);let e=X.run,t=_w(e),n=e.map.nodes.find(t=>t.id===e.nodeId),r=n?n.row:Math.max(1,e.floorsClimbed-1),{newUnlocks:i}=pw(e,!1);dw(e),Mg(e,!1),tA(`end`,{won:!1,newUnlocks:i,offers:t,fallAct:e.act,fallRow:r})}function tM({kind:e,rewards:t}){let n=X.run,r=bk(),i=e===`boss`?`BOSS VANQUISHED`:e===`elite`?`ELITE SLAIN`:`VICTORY`,a=X.lastPerfect?`<div class="perfect-seal">✦ PERFECT — the glass untouched ✦</div>`:`<div class="ornament">✦ ✦ ✦</div>`;X.lastPerfect=!1,r.innerHTML=`<div class="center-panel screen-enter">${Ck()}<div class="panel">
  ...
  </div></div>`;let o=Z(`.reward-list`,r),s=(e,t,r,i=null)=>{let a=$(`button`,`reward-row`,`<span class="ric">${e}</span><span>${t}</span>`);return i&&(a._tip=i),a.onclick=()=>{r()!==!1&&(a.classList.add(`taken`),Og(n),zk())},o.appendChild(a),a};if(s(zC(`coin`,18),`<b class="gold-num">${t.gold}</b> gold`,()=>{n.player.gold+=t.gold,n.stats.goldEarned+=t.gold,Y.coin(),requestAnimationFrame(()=>{let e=Z(`#hud .gold-num`),r={x:_()/2,y:v()/2-40},i=e?qf(e):{x:120,y:24},a=n.player.gold-t.gold;e&&(e.textContent=a),sj(r.x,r.y,i.x,i.y,{n:Math.min(9,4+Math.floor(t.gold/12)),color:`#ffd76e`,dur:600,done:()=>Y.coin()}),e&&Sj(e,a,n.player.gold,640)})}),t.potion){let e=Pu[t.potion];s(Sk(`potions`,t.potion,jC(e.tone)),`${e.name}`,()=>{if(!Mh(n,t.potion))return Bf(_()/2,v()/2,`Potion slots full!`,`notice`),!1;Y.potion()},{title:e.name,body:e.text})}if(t.relic){let e=Mu[t.relic];s(`<span style="color:${e.tone};text-shadow:0 0 8px ${e.tone}">${Tk(t.relic,24)}</span>`,`<b>${e.name}</b>`,()=>{vh(n,t.relic),Y.relic(),requestAnimationFrame(()=>{let n=Z(`.hud-relic[data-relic="${t.relic}"]`);if(!n)return;let r=qf(n);sj(_()/2,v()/2-40,r.x,r.y,{n:1,glyph:e.glyph,color:e.tone,dur:680,done:()=>{n.classList.remove(`proc`),n.offsetWidth,n.classList.add(`proc`)}})})},{title:e.name,body:e.text})}s(zC(`cards`,26),`Add a card to your deck`,()=>(l(t.cards,()=>{}),!1));let c=o.lastElementChild;c.dataset.cardrow=`1`,Z(`[data-a="continue"]`,r).onclick=()=>{Y.click(),Og(n),tA(e===`boss`?`bossRelic`:`map`)};function l(e,t){Xk(`Choose a Card`,e.map(e=>({id:e,up:!1,uid:null})),{sub:`Add one card to your deck — or skip to keep it lean.`,pick:e=>{e&&(Sg(n,e.id),Y.upgrade(),Bf(_()/2,v()/2,`${sh(e).name} added`,`notice`)),c.classList.add(`taken`),Og(n),t()},canSkip:!0})}}function nM(){let e=X.run;if(e.bossRelicAct===e.act){rM();return}let t=Ih(e),n=bk();n.innerHTML=`<div class="center-panel screen-enter"><div class="panel" style="width:min(620px,94vw)">
  ...
  </div></div>`;let r=Z(`.big-choices`,n),i=!1,a=()=>{r.querySelectorAll(`button`).forEach(e=>{e.disabled=!0,e.onclick=null,e.style.pointerEvents=`none`})},o=t=>{if(!i){if(i=!0,a(),jh(e,t).already){rM();return}t?Y.relic():Y.click(),Og(e),rM()}};for(let e of t){let t=Mu[e],n=$(`button`,`relic-pick`);n.innerHTML=`<span class="relic-chip" style="--tone:${t.tone}">${Tk(e,26)}</span><span><b>${t.name}</b><span class="rd">${t.text}</span></span>`,n.onclick=()=>o(e),r.appendChild(n)}let s=$(`button`,`btn ghost`,`Take none`);s.style.marginTop=`10px`,s.onclick=()=>o(null),r.appendChild(s)}function rM(){let e=X.run;e.act++,e.omens.push(mh(e,`omens`)?rh(e):null),e.nodeId=null,e.map=lh(e),_h(e,Math.round(e.player.maxHp*.35)),nf(e.act),Ud(e.act,0),Og(e),eA(`act-change`),tA(`map`),Y.victory()}function iM(e){let t=Bu[e.omens?.[e.act]];if(!t||X.screen!==`map`)return;let n=e.omens[e.act],r=gC(`omens`,n),i=$(`div`,`turn-banner omen-banner`,`${r?`<img class="ob-art" src="${r}" alt="">`:`<span class="ob-glyph" style="color:${t.tone}">${zC(`omen-${n}`,22)}</span>`} OMEN — ${t.name.toUpperCase()}<div class="ob-sub">${t.text}</div>`);bk().appendChild(i),Y.omen(),setTimeout(()=>i.remove(),4200)}function aM(){let e=X.run,t=e.player.deck.some(e=>!e.up&&ku[e.id].up);bk().innerHTML=`<div class="center-panel screen-enter">${Ck()}<div class="panel">
    <div class="ov-title">REST SITE</div>
    <div class="art-lg">${Sk(`props`,`campfire`,NC())}</div>
    <div class="ov-sub">The fire crackles. For a moment, the Spire is quiet.</div>
    <div class="big-choices">
      <button class="btn btn-primary" data-a="rest">${zC(`flame`,18)} Rest <span style="font-size:13px;opacity:.8">— heal ${Math.round(e.player.maxHp*ah(e))} HP</span></button>
      <button class="btn" data-a="smith" ${t?``:`disabled`}>${zC(`hammer`,18)} Smith <span style="font-size:13px;opacity:.8">— upgrade a card</span></button>
    </div>
  </div></div>`,Z(`[data-a="rest"]`).onclick=t=>{t.currentTarget.disabled=!0,Z(`[data-a="smith"]`).disabled=!0,Y.heal();let n=_h(e,Math.round(e.player.maxHp*ah(e)));Ff(`#ff9a4d`,.12,.8),Bf(_()/2,v()/2-40,`+${n} HP`,`healf`),zf(_()/2,v()/2,`#8fe8a0`,22),zf(_()/2,v()/2+60,`#ffb066`,16),Og(e),setTimeout(()=>{X.screen===`rest`&&tA(`map`)},900)},Z(`[data-a="smith"]`).onclick=()=>{Y.click(),Xk(`Upgrade a Card`,e.player.deck.filter(e=>!e.up&&ku[e.id].up),{sub:`Forge one card into its + form.`,pick:t=>{t&&(wg(e,t.uid),Y.upgrade(),Ff(`#ffe9ac`,.12,.4),Xk(`Upgraded!`,[e.player.deck.find(e=>e.uid===t.uid)],{sub:`It gleams with new power.`}),Og(e),setTimeout(()=>{X.screen===`rest`&&(Yk(),tA(`map`))},1300))}})}}function oM(){let e=X.run,t=Eh(e),n=t=>{let n=Z(`.art-lg`);n.removeAttribute(`data-a`),n.style.cursor=``,n.innerHTML=Sk(`props`,`chest-open`,MC(!0)),t&&(Z(`.ov-sub`).innerHTML=t);let r=Z(`.big-choices`);r.innerHTML=``;let i=$(`button`,`btn btn-primary`,`Continue`);i.onclick=()=>{Y.click(),tA(`map`)},r.appendChild(i),zk(),Og(e)};if(bk().innerHTML=`<div class="center-panel screen-enter">${Ck()}<div class="panel">
    <div class="ov-title">TREASURE</div>
    <div class="art-lg" style="cursor:pointer" data-a="open">${Sk(`props`,`chest`,MC(!1))}</div>
  ...
  </div></div>`,t){n(`The chest lies empty.`);return}let r=()=>{if(t)return;t=!0,yk(`[data-a="open"]`).forEach(e=>{e.onclick=null,e.style.pointerEvents=`none`});let r=kh(e,{common:.55,uncommon:.35,rare:.1});if(r.already){n(`The chest lies empty.`);return}Ff(`#ffe9ac`,.2,.5),If(_()/2,v()/2,{color:`#ffd97a`,n:36,speed:380,grav:160});let i;if(r.relicId){Y.relic();let e=Mu[r.relicId];i=`You claim <b style="color:${e.tone}">${e.name}</b> — <i>${e.text}</i>`}else Y.coin(),i=`Only coins remain — <b class="gold-num">+60 gold</b>.`;n(i)};yk(`[data-a="open"]`).forEach(e=>e.onclick=r)}function sM(){let e=X.run,t=X.shopData||={};(X.screen!==`shop`||!t.stock||t.forNode!==e.nodeId)&&(t.stock=Lh(e),t.forNode=e.nodeId);let n=t.stock,r=bk();r.innerHTML=`<div class="center-panel screen-enter">${Ck()}<div class="panel ov-panel" style="width:min(980px,96vw)">
    <div style="display:flex;align-items:center;justify-content:center;gap:18px">
      <div style="width:130px">${Sk(`props`,`merchant`,PC())}</div>
  ...
  </div></div>`;let i=Z(`.cards-row`,r),a=Z(`.misc-row`,r),o=Z(`.shop-grid`,r),s=!1,c=()=>e.player.gold,l=t=>{e.player.gold-=t,Y.coin(),Og(e),zk(),u()};function u(){o&&o.classList.toggle(`list-seq-done`,s),i.innerHTML=``,a.innerHTML=``;for(let t of n.cards){let n=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),r=Lk({id:t.id,up:!1,uid:null},{size:138});r.onclick=()=>{if(t.sold||c()<t.price)return Y.debuff();t.sold=!0,Sg(e,t.id),l(t.price)},n.appendChild(r),n.appendChild($(`div`,`price`,`${VC(`coin`,14)} ${t.price}`)),i.appendChild(n)}for(let t of n.relics){let n=Mu[t.id],r=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),i=$(`button`,`shop-relic`,`<span class="relic-chip" style="--tone:${n.tone}">${Tk(t.id,24)}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||c()<t.price)return Y.debuff();t.sold=!0,vh(e,t.id),Y.relic(),l(t.price)},r.appendChild(i),r.appendChild($(`div`,`price`,`${VC(`coin`,14)} ${t.price}`)),a.appendChild(r)}for(let t of n.potions){let n=Pu[t.id],r=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),i=$(`button`,`shop-relic`,`<span style="width:34px;height:44px">${Sk(`potions`,t.id,jC(n.tone))}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||c()<t.price)return Y.debuff();if(!Mh(e,t.id)){Bf(_()/2,v()/2,`Potion slots full!`,`notice`);return}t.sold=!0,Y.potion(),l(t.price)},r.appendChild(i),r.appendChild($(`div`,`price`,`${VC(`coin`,14)} ${t.price}`)),a.appendChild(r)}let t=$(`div`,`shop-item ${n.removed?`sold`:``} ${c()<n.removeCost?`cant`:``}`),r=$(`button`,`shop-relic`,`<span style="width:34px;display:inline-flex;justify-content:center">${zC(`scissors`,26)}</span><b>Card Removal</b>Remove a card from your deck forever.`);r.onclick=()=>{if(n.removed||c()<n.removeCost)return Y.debuff();Xk(`Remove a Card`,e.player.deck,{sub:`Cut the dead weight.`,pick:t=>{t&&(Cg(e,t.uid),n.removed=!0,e.player.gold-=n.removeCost,Y.card(),Og(e),zk(),u())},canSkip:!0,skipLabel:`Cancel`})},t.appendChild(r),t.appendChild($(`div`,`price`,`${VC(`coin`,14)} ${n.removeCost}`)),a.appendChild(t),s=!0}u(),Z(`[data-a="leave"]`,r).onclick=()=>{Y.click(),tA(`map`)}}function cM(e){let t=X.run,n=Lu[e],r=bk();r.innerHTML=`<div class="center-panel screen-enter">${Ck()}<div class="panel event-panel">
    <div class="ov-title">${n.name.toUpperCase()}</div>
    <div class="event-art">${Sk(`events`,e,FC(n.glyph,n.hue))}</div>
    <div class="event-text">${n.text}</div>
    <div class="event-log"></div>
    <div class="event-choices"></div>
  </div></div>`;let i=Z(`.event-choices`,r),a=()=>{i.innerHTML=``;let e=$(`button`,`btn btn-primary`,`Continue`);e.onclick=()=>{Y.click(),tA(`map`)},i.appendChild(e)};if(Eh(t)){a();return}if(Dh(t)){Oh(t),Og(t),a();return}let o=n.choices.filter(e=>mh(t,`phials`)||!e.ops.some(e=>e.potion));for(let[e,n]of o.entries()){let r=$(`button`,`event-choice${e===0?` btn-primary`:``}`,`<b>${n.label}</b>${n.sub?`<div class="sub">${n.sub}</div>`:``}`);n.needGold&&t.player.gold<n.needGold&&(r.disabled=!0),r.onclick=()=>c(n),i.appendChild(r)}let s=!1;async function c(e){if(!s){s=!0,i.querySelectorAll(`button`).forEach(e=>{e.disabled=!0});try{Y.click();let{pending:n,log:o,already:s}=Ah(t,e.ops);if(s){a();return}Og(t),zk();let c=Z(`.event-log`,r),u=[];for(let e of o)e.text&&u.push(e.text),e.relic&&u.push(`Gained <b style="color:${Mu[e.relic].tone}">${Mu[e.relic].name}</b> — <i>${Mu[e.relic].text}</i>`);u.length&&(c.innerHTML=u.join(`<br>`)),i.innerHTML=``;for(let e of n)await l(e);Oh(t),Og(t),zk(),a(),!u.length&&!n.length&&!e.ops.length&&tA(`map`)}catch(e){if(Dh(t)||Eh(t)){Dh(t)&&Oh(t),Og(t),a();return}throw s=!1,i.querySelectorAll(`button`).forEach(e=>{e.disabled=!1}),e}}}function l(e){return new Promise(n=>{if(e===`remove`)Xk(`Remove a Card`,t.player.deck,{sub:`Let it go.`,pick:e=>{e&&(Cg(t,e.uid),Y.card()),n()},canSkip:!1});else if(e===`upgrade`){let e=t.player.deck.filter(e=>!e.up&&ku[e.id].up);if(!e.length)return n();Xk(`Upgrade a Card`,e,{sub:`The forge hungers.`,pick:e=>{e&&(wg(t,e.uid),Y.upgrade()),n()}})}else e===`duplicate`?Xk(`Duplicate a Card`,t.player.deck,{sub:`The mirror remembers.`,pick:e=>{e&&(Tg(t,e.uid),Y.upgrade()),n()}}):e.pickCard?Xk(`Choose a Card`,Ph(t,e.pickCard).map(e=>({id:e,up:!1,uid:null})),{sub:`One page still glows.`,pick:e=>{e&&(Sg(t,e.id),Y.upgrade()),n()},canSkip:!0}):n()})}}function lM(e){let t=gC(`bequests`,e.kind),n=t?`<img class="bq-kind" src="${t}" alt="">`:`<span class="bq-kind-fallback">${zC(`bequest-${e.kind}`,22)}</span>`;return e.kind===`relic`?{icon:`${n}${Tk(e.id,20)}`,name:Mu[e.id]?.name||e.id,note:`your rarest relic`}:e.kind===`card`?{icon:`${n}<span class="bq-card">🂠</span>`,name:(ku[e.id]?.name||e.id)+(e.up?`+`:``),note:`your finest card`}:{icon:`${n}${zC(`coin`,20)}`,name:`${e.amount} gold`,note:`a cache of gold`}}function uM(e){if(e===`aspect2`)return{kind:`Aspect Unlocked`,name:`The Ashwarden`};let[t,n]=e.split(`:`);return t===`card`?{kind:`Card Unlocked`,name:ku[n]?.name||n}:{kind:`Relic Unlocked`,name:Mu[n]?.name||n}}function dM(e=[]){if(!e.length)return;let t=Z(`#toasts`);t||(t=$(`div`),t.id=`toasts`,b().appendChild(t)),e.forEach((e,n)=>{let r=uM(e);setTimeout(()=>{let e=$(`div`,`unlock-toast`,`<div class="ut-kind">✦ ${r.kind}</div><div class="ut-name">${r.name}</div>`);t.appendChild(e),requestAnimationFrame(()=>e.classList.add(`in`)),Y.relic(),setTimeout(()=>{e.classList.remove(`in`),setTimeout(()=>e.remove(),500)},3800)},700+n*800)})}function fM({won:e,newUnlocks:t=[],offers:n=[],fallAct:r=0,fallRow:i=1}){let a=X.run;qO(!!e);let o=a.stats,s=Math.max(1,Math.round((Date.now()-o.start)/6e4)),c=a.act*15+a.floorsClimbed,l=`<div class="stats-grid">
    ...
    </div>`;if(e){bk().innerHTML=`<div class="end-screen screen-enter">
      ${wk(`ascended`)}
      ...
      ${l}${u}
    </div>`,rf(),Y.victory(),Ff(`#ffe9ac`,.25,1);let e=setInterval(()=>If(Math.random()*_(),v()*.2,{color:[`#ffd97a`,`#c9b0ff`,`#8fe8a0`][Math.random()*3|0],n:16,speed:300,grav:260,life:1.2}),400);setTimeout(()=>clearInterval(e),4200)}else{let e=n.length?`<div class="bequest" id="bequest">
      ...
      </div>`:``,t=Array.from({length:14},()=>`<span class="ember" style="left:${(8+Math.random()*84).toFixed(1)}%;--ex:${((Math.random()-.5)*90).toFixed(0)}px;animation-delay:${(Math.random()*4).toFixed(2)}s;animation-duration:${(3+Math.random()*3).toFixed(2)}s"></span>`).join(``);bk().innerHTML=`<div class="end-screen grave">
      ${wk(`fallen`)}
      <div class="monument">
    ...
    </div>`}bk().onclick=e=>{let t=e.target.closest(`[data-a]`);if(!t)return;let o=t.dataset.a;if(o===`bequest`){Y.relic();let e=n[+t.dataset.i];mw(r,i,e);let a=lM(e);Z(`#bequest`).innerHTML=`<div class="bequest-done">✦ The stone keeps your <b>${a.name}</b>.<br>It will wait for you in ${Ou[r].name}.</div>`;return}Y.click(),o===`deck`&&Xk(`Final Deck`,a.player.deck,{}),o===`title`&&(X.run=null,X.lamp=null,tA(`title`))},dM(t)}var pM=!1;function mM(){if(pM)return;pM=!0;let e=Z(`#overlay`);e.addEventListener(`pointerdown`,t=>{t.target===e&&e._closable&&Yk()}),document.addEventListener(`keydown`,t=>{t.key===`Escape`&&e.classList.contains(`open`)&&e._closable&&Yk()})}function hM(e,t){let n=e.dataset.cat||``,r=e.dataset.id||``,i=e.dataset.url||``,a=e.querySelector(`.g-art-stage`),o=`${r} / ${n}`,s=a?.querySelector(`svg`),c=s?`data:image/svg+xml;charset=UTF-8,${encodeURIComponent(s.outerHTML)}`:``,l=i?`<img class="gallery-lightbox-img" src="${xk(i)}" alt="${xk(r)}">`:c?`<img class="gallery-lightbox-img" src="${xk(c)}" alt="${xk(r)}">`:a?a.innerHTML:``;Jk(`<div class="gallery-lightbox" role="dialog" aria-modal="true" aria-label="${xk(o)}">
    <button class="gallery-lightbox-close" type="button" data-a="close" aria-label="Close">&times;</button>
    <div class="gallery-lightbox-meta"><b>${xk(r)}</b><span>${xk(n)} - ${xk(hC(t))}</span></div>
    <div class="gallery-lightbox-art">${l}</div>
  </div>`,e=>{Z(`[data-a="close"]`,e).onclick=()=>Yk()},!0)}function gM(){mM();let e=new URLSearchParams(location.search),t=e.get(`set`)||e.get(`assetSet`)||`live`,n=mC().includes(t)?t:`live`,r=mC().map(e=>{let t=new URLSearchParams(location.search);return t.set(`gallery`,`1`),t.set(`set`,e),`<a class="${e===n?`active`:``}" href="?${t.toString()}">${hC(e)}</a>`}).join(``),i={omens:Object.keys(Bu).map(e=>[e,()=>zC(`omen-${e}`,64)]),boons:Object.keys(Yu).map(e=>[e,()=>zC(`boon-${e}`,64)]),arts:Object.keys(Hu).map(e=>[e,()=>zC(`art-${e}`,64)]),statuses:Object.keys(ju).map(e=>[e,()=>zC(`st-${e}`,64)]),heroes:qu.map((e,t)=>[e.id,()=>DC(t)]),enemies:Object.entries(Fu).map(([e,t])=>[e,()=>TC(t.art)]),cards:Object.entries(ku).map(([e,t])=>[e,()=>AC(e,t.type)]),potions:Object.entries(Pu).map(([e,t])=>[e,()=>jC(t.tone)]),props:[[`campfire`,NC],[`chest`,()=>MC(!1)],[`chest-open`,()=>MC(!0)],[`merchant`,PC]],events:Object.entries(Lu).map(([e,t])=>[e,()=>FC(t.glyph,t.hue)]),title:[[`title`,()=>`<div class="title-banner-ph">title</div>`]],"title-background":[[`background`,()=>`<div class="title-banner-ph">background</div>`]],stage:[`act1`,`act2`,`act3`].flatMap(e=>[`backdrop`,`mid`,`ledge`].map(t=>[`${e}-${t}`,()=>`<div class="title-banner-ph">stage</div>`])),relics:Object.entries(Mu).map(([e,t])=>[e,()=>`<div class="title-banner-ph" style="color:${t.tone}">${t.glyph}</div>`]),deeds:Object.keys(Uu).map(e=>[e,()=>zC(`deed-${e}`,64)]),bequests:[`relic`,`card`,`gold`].map(e=>[e,()=>zC(`bequest-${e}`,64)]),meta:[`fallen`,`ascended`,`monument-node`].map(e=>[e,()=>`<div class="title-banner-ph">${e}</div>`]),piles:[`draw`,`discard`,`ashes`].map(e=>[e,()=>`<div class="title-banner-ph">${e}</div>`]),ui:rC.map(e=>[e,()=>{let t=aC(e);return t?zC(t,64):`<div class="title-banner-ph">${e}</div>`}])};bk().className=`gallery-mode`,bk().innerHTML=`<div class="g-toolbar">
    <div><b>Asset set:</b> ${hC(n)}</div>
    <nav>${r}</nav>
  </div>`+Object.entries(i).map(([e,t])=>`<h2 class="g-head">${e} — ${t.filter(([t])=>gC(e,t,n)).length}/${t.length} generated</h2>
      <div class="gallery">${t.map(([t,r])=>{let i=gC(e,t,n);return`<div class="g-cell ${i?`g-png`:`g-svg`}"><button class="g-art g-open" type="button" data-cat="${xk(e)}" data-id="${xk(t)}" data-url="${i?xk(i):``}" aria-label="Enlarge ${xk(t)}"><span class="g-art-stage">${i?`<img class="raster-art" src="${xk(i)}" alt="">`:r()}</span></button>
          <div class="g-label">${xk(t)}<span class="g-badge">${i?`PNG`:`SVG`}</span></div></div>`}).join(``)}</div>`).join(``),bk().onclick=e=>{let t=e.target.closest(`.g-open`);t&&hM(t,n)}}function _M(){let e=bk();e.className=`gallery-mode audio-gallery-mode`;let t=AD(),n=jD(),r=(e,t)=>{let n=MD(e,t),r=n?.overridden?`override`:n?.fallback?`base fallback`:`pack`,i=n?.ref??`missing`;return`<span class="ag-source-read" title="${xk(r)}">${xk(i)}</span>`},i=()=>AD(),a=`<button type="button" class="ag-preview" data-a="preview" aria-label="Preview">▶</button>`,o={};for(let e of vw)(o[e.group]||=[]).push(e);let s=Object.entries(o).map(([e,t])=>`
    <h3 class="ag-sub">${xk(e)}</h3>
    <div class="ag-list">${t.map(e=>`
      <div class="ag-row" data-kind="sfx" data-id="${xk(e.id)}"
        ${e.play===`attack`?`data-attack-who="${xk(e.attack.who)}" data-attack-amount="${e.attack.amount}"`:``}>
        ${a}
        <span class="ag-id">${xk(e.id)}</span>
        <span class="ag-use">${xk(e.use)}</span>
        <span class="ag-badge ${e.note?``:`ag-badge-empty`}">${e.note?xk(e.note):``}</span>
        ${r(`sfx`,e.id)}
      </div>`).join(``)}</div>`).join(``),c=`<div class="ag-list">${yw.map(e=>`
    <div class="ag-row ${e.wired?``:`ag-unwired`}" data-kind="music" data-id="${xk(e.id)}">
      ${a}
      <span class="ag-id">${xk(e.id)}</span>
      <span class="ag-title">${xk(e.title)}</span>
      <span class="ag-use">${xk(e.use)}</span>
      <span class="ag-badge">${e.wired?`wired`:`unwired`}</span>
      ${r(`music`,e.id)}
    </div>`).join(``)}</div>`,l=n.length?`<div class="ag-config-errors">Using base packs: ${n.map(xk).join(` · `)}</div>`:``;e.innerHTML=`<div class="g-toolbar">
  ...
  ${`
    <p class="ag-note">Active packs: Music <code>${xk(t.music.version)}</code> · SFX <code>${xk(t.sfx.version)}</code>. Production is read-only; the host supplies <code>audio-selection.json</code>.</p>
    ${l}`}
  ...
  <h2 class="g-head" id="ag-sfx">SFX — ${vw.length}</h2>
  ${s}
  <h2 class="g-head" id="ag-music">Music — ${yw.length}</h2>
  ${c}`,e.onclick=async e=>{if(e.target.closest(`[data-a="stop"]`)){UO();return}let t=e.target.closest(`[data-a="preview"]`)?.closest(`.ag-row`);if(!t)return;YD();let n=t.dataset.id,r=i();if(t.dataset.kind===`sfx`){UO(),oO(n,r);return}HO(n,r)}}function vM(){let e=e=>{let t=document.querySelector(e);return t?C(t):null};window.__probe={stage:()=>x(),geometry(){let t=e(`.battlefield`);return!t||!X.cb||!X.ce?null:{stage:x(),viewport:{w:_(),h:v()},groundY:t.bottom,heroArtBottom:e(`.hero-wrap`)?.bottom??null,enemyArtBottoms:X.cb.enemies.map((e,t)=>e.hp>0&&X.ce.enemies[t]?C(X.ce.enemies[t].art).bottom:null),slLedgeTop:e(`.sl-ledge`)?.top??null,seamY:e(`.stage-ledge`)?.top??null}},invariants(){let e=[],t=(t,n,r=``)=>e.push({name:t,pass:n,detail:n?``:String(r)}),n=X.cb,r=X.ce;return n&&r&&X.screen===`combat`&&(n.enemies.forEach((e,n)=>{let i=r.enemies[n];if(i)if(e.hp<=0){let e=i.root.classList;t(`enemy${n}: dead body leaves the field`,e.contains(`gone`)||e.contains(`dying`)||getComputedStyle(i.root).visibility===`hidden`,`classes="${i.root.className}"`),t(`enemy${n}: dead body releases its mesh plane`,!i.root.querySelector(`.mesh-live`),`a WebGL warp plane still renders this corpse`)}else t(`enemy${n}: HP label matches engine`,i.hp.textContent===`${Math.max(0,e.hp)}/${e.maxHp}`,`dom="${i.hp.textContent}" engine=${e.hp}/${e.maxHp}`)}),t(`player: HP label matches engine`,r.pHp.textContent===`${Math.max(0,n.player.hp)}/${n.player.maxHp}`,`dom="${r.pHp.textContent}" engine=${n.player.hp}/${n.player.maxHp}`),t(`hand: DOM count matches engine`,yk(`.card`,r.hand).length===n.hand.length,`dom=${yk(`.card`,r.hand).length} engine=${n.hand.length}`),t(`energy: orb matches engine`,Z(`.num`,r.energy).textContent===String(n.player.energy),`dom="${Z(`.num`,r.energy).textContent}" engine=${n.player.energy}`),t(`embers: lantern count matches engine`,Z(`.lb-count`,r.lantern).textContent===String(n.embers),`dom="${Z(`.lb-count`,r.lantern).textContent}" engine=${n.embers}`)),e},state(){let e=X.cb;return{screen:X.screen,busy:X.busy,over:e?.over??null,result:e?.result??null,turn:e?.turn??null,player:e?{hp:e.player.hp,maxHp:e.player.maxHp,block:e.player.block,energy:e.player.energy}:null,embers:e?.embers??null,enemies:e?e.enemies.map(e=>({key:e.key,hp:e.hp,maxHp:e.maxHp,block:e.block})):null,hand:e?e.hand.map(e=>({uid:e.uid,id:e.id})):null}},settle:()=>new Promise(e=>{let t=()=>!X.busy&&(!X.cb||X.cb.queue.length===0),n=()=>t()?e(!0):setTimeout(n,50);n()}),async play(e,t=null){return X.busy||!X.cb||X.cb.over?!1:(await ij(e,t),!X.cb||X.cb.over||!X.cb.hand.some(t=>t.uid===e))},async endTurn(){await aj()},async useArt(){return X.busy||!X.cb||X.cb.over||!Xh(X.run,X.cb)?!1:(Zh(X.run,X.cb),await Kj(),Qj(),!0)},async usePotion(e,t=null){return X.busy||!mg(X.run,X.cb,e,t)?!1:(X.cb&&(await Kj(),Qj()),zk(),!0)},forceHand(e){return X.cb.hand=e.map(e=>oh(X.run,e)),UA(),X.cb.hand.map(e=>e.uid)},setEnergy(e){X.cb.player.energy=e,jA()},setEmbers(e){X.cb.embers=e,jA()},setEnemyHp(e,t){X.cb.enemies[e].hp=t,jA()},freeze(){document.documentElement.classList.add(`freeze`),jj=!0,kf(),sf()}}}function yM(){let e=new URLSearchParams(location.search);if(e.has(`gallery`))return gM();if(e.has(`audio`))return _M();Fk(),document.addEventListener(`pointerdown`,()=>YD(),{once:!0}),document.addEventListener(`contextmenu`,e=>{X.targeting&&(e.preventDefault(),nj())}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&(X.targeting?nj():Z(`#overlay`).classList.contains(`open`)&&Z(`#overlay`)._closable&&Yk()),(e.key===`e`||e.key===`E`)&&X.screen===`combat`&&!X.busy&&aj(),(e.key===`a`||e.key===`A`)&&X.screen===`combat`&&!X.busy&&X.ce?.lantern?.click()}),Z(`#overlay`).addEventListener(`pointerdown`,e=>{e.target===Z(`#overlay`)&&Z(`#overlay`)._closable&&Yk()}),window.spirebound={S:X,E:Xm,startCombatUI:pA,show:tA,meshEnabled:Cp,meshDebug:Ym,refitCombat:EA},vM(),requestAnimationFrame(Mj);let t=()=>{X.screen===`combat`&&X.cb&&X.ce&&EA()};lp(t),XO(t),fk(t),tA(`title`)}new URLSearchParams(location.search);async function bM(){await OD(),g(),ef(),Df(),jm(),yM()}bM();