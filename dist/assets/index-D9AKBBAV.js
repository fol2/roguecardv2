...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function No(e,t,n){let r=new Float32Array(yo),i=new B(0,1,0);return new aa({name:`SphericalGaussianBlur`,defines:{n:yo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Io(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Po(){return new aa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Io(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fo(){return new aa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Io(),fragmentShader:`
	...
	`}var Lo=class extends Zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new zi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var cc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function lc(e,t){let n=cc[t];return n===void 0?(I(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var uc=new B;function dc(){return H.getLuminanceCoefficients(uc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${uc.x.toFixed(4)}, ${uc.y.toFixed(4)}, ${uc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=ec(i,i.VERTEX_SHADER,y),S=ec(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=oc(i,x,`vertex`),n=oc(i,S,`fragment`);L(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Cl=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},wl=new Ra(-1,1,1,-1,0,1),Tl=new class extends Mr{constructor(){super(),this.setAttribute(`position`,new br([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new br([0,2,0,0,2,0],2))}},El=class{constructor(e){this._mesh=new bi(Tl,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,wl)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Dl=class extends Cl{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof aa?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=na.clone(e.uniforms),this.material=new aa({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new El(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Ol=class extends Cl{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},kl=class extends Cl{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Al=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new z);this._width=n.width,this._height=n.height,t=new Zt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:v}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Dl(Sl),this.copyPass.material.blending=0,this.timer=new Ua}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Ol!==void 0&&(r instanceof Ol?n=!0:r instanceof kl&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new z);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},jl=class extends Cl{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new U}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Ml={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new U(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Nl.BlurDirectionX=new z(1,0),Nl.BlurDirectionY=new z(0,1);var Pl={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Fl=class extends Cl{constructor(){super(),this.isOutputPass=!0,this.uniforms=na.clone(Pl.uniforms),this.material=new oa({name:Pl.name,uniforms:this.uniforms,vertexShader:Pl.vertexShader,fragmentShader:Pl.fragmentShader}),this._fsQuad=new El(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},H.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Il={id:`duskblade`,name:`The Duskblade`,blurb:`Glass honed to a killing edge. Strikes, shatters, and turns broken facets into fuel — a versatile climber for any night.`,hue:225,art:`flare`,maxHp:72,energy:3,handSize:5,potionSlots:3,startDeck:[`strike`,`strike`,`strike`,`strike`,`defend`,`defend`,`defend`,`eclipseSlash`,`chisel`,`firstSpark`],startRelic:`emberHeart`,startGold:99},Ll=[{name:`The Ashen Woods`,boss:`rootheart`,bossName:`The Rootheart`,theme:{sky:791568,fog:1254426,particles:16752717,glow:6750110,accent:`#7ddb8f`,ember:`#ff9a4d`}},{name:`The Sunken City`,boss:`leviathan`,bossName:`Leviathan's Maw`,theme:{sky:529440,fog:860723,particles:5499135,glow:3127551,accent:`#5fd6e8`,ember:`#53e8ff`}},{name:`The Obsidian Spire`,boss:`sovereign`,bossName:`The Eternal Sovereign`,theme:{sky:1182238,fog:1970736,particles:12745727,glow:16732120,accent:`#c99aff`,ember:`#ff6fe0`}}],Rl={strike:{name:`Edge`,type:`attack`,rarity:`starter`,cost:1,target:`enemy`,vfx:`slash`,text:`Deal @6@ damage.`,effects:[{kind:`dmg`,n:6}],up:{text:`Deal @9@ damage.`,effects:[{kind:`dmg`,n:9}]}},defend:{name:`Ward`,type:`skill`,rarity:`starter`,cost:1,target:`self`,vfx:`ward`,text:`Gain #5# Ward.`,effects:[{kind:`block`,n:5}],up:{text:`Gain #8# Ward.`,effects:[{kind:`block`,n:8}]}},eclipseSlash:{name:`Eclipse Slash`,type:`attack`,rarity:`starter`,cost:1,target:`enemy`,vfx:`slash`,text:`Deal @7@ damage. Apply 1 Cracked.`,effects:[{kind:`dmg`,n:7},{kind:`status`,who:`target`,id:`vulnerable`,n:1}],up:{text:`Deal @9@ damage. Apply 2 Cracked.`,effects:[{kind:`dmg`,n:9},{kind:`status`,who:`target`,id:`vulnerable`,n:2}]}},chisel:{name:`Chisel`,type:`attack`,rarity:`starter`,cost:1,target:`enemy`,chip:1,vfx:`pierce`,text:`Deal @4@ damage. Chip 1 extra Facet.`,effects:[{kind:`dmg`,n:4}],up:{text:`Deal @7@ damage. Chip 1 extra Facet.`,effects:[{kind:`dmg`,n:7}]}},firstSpark:{name:`First Spark`,type:`skill`,rarity:`starter`,cost:0,target:`self`,vfx:`fire`,text:`Draw 1 card. Kindle.`,exhaust:!0,effects:[{kind:`draw`,n:1}],up:{text:`Draw 2 cards. Kindle.`,effects:[{kind:`draw`,n:2}]}},ashBite:{name:`Ashbite`,type:`attack`,rarity:`starter`,cost:1,target:`enemy`,vfx:`fire`,text:`Deal @5@ damage. Apply 2 Smolder.`,effects:[{kind:`dmg`,n:5},{kind:`status`,who:`target`,id:`poison`,n:2}],up:{text:`Deal @7@ damage. Apply 3 Smolder.`,effects:[{kind:`dmg`,n:7},{kind:`status`,who:`target`,id:`poison`,n:3}]}},smother:{name:`Smother`,type:`skill`,rarity:`starter`,cost:1,target:`enemy`,vfx:`fire`,text:`Gain #5# Ward. Apply 2 Smolder.`,effects:[{kind:`block`,n:5},{kind:`status`,who:`target`,id:`poison`,n:2}],up:{text:`Gain #8# Ward. Apply 3 Smolder.`,effects:[{kind:`block`,n:8},{kind:`status`,who:`target`,id:`poison`,n:3}]}},twinFangs:{name:`Twin Shards`,type:`attack`,rarity:`common`,cost:1,target:`enemy`,vfx:`pierce`,text:`Deal @4@ damage twice.`,effects:[{kind:`dmg`,n:4,times:2}],up:{text:`Deal @6@ damage twice.`,effects:[{kind:`dmg`,n:6,times:2}]}},quickSlash:{name:`Flicker`,type:`attack`,rarity:`common`,cost:0,target:`enemy`,vfx:`slash`,text:`Deal @4@ damage. Draw 1 card.`,effects:[{kind:`dmg`,n:4},{kind:`draw`,n:1}],up:{text:`Deal @6@ damage. Draw 1 card.`,effects:[{kind:`dmg`,n:6},{kind:`draw`,n:1}]}},heavyBlow:{name:`Quarry Maul`,type:`attack`,rarity:`common`,cost:2,target:`enemy`,chip:1,vfx:`blunt`,text:`Deal @12@ damage. Chip 1 extra Facet.`,effects:[{kind:`dmg`,n:12}],up:{text:`Deal @16@ damage. Chip 2 extra Facets.`,chip:2,effects:[{kind:`dmg`,n:16}]}},cleave:{name:`Fan of Glass`,type:`attack`,rarity:`common`,cost:1,target:`allEnemies`,vfx:`slash`,text:`Deal @6@ damage to ALL enemies.`,effects:[{kind:`dmg`,n:6}],up:{text:`Deal @9@ damage to ALL enemies.`,effects:[{kind:`dmg`,n:9}]}},venomStrike:{name:`Emberbite`,type:`attack`,rarity:`common`,cost:1,target:`enemy`,vfx:`fire`,text:`Deal @4@ damage. Apply 3 Smolder.`,effects:[{kind:`dmg`,n:4},{kind:`status`,who:`target`,id:`poison`,n:3}],up:{text:`Deal @6@ damage. Apply 4 Smolder.`,effects:[{kind:`dmg`,n:6},{kind:`status`,who:`target`,id:`poison`,n:4}]}},lunge:{name:`Dimming Cut`,type:`attack`,rarity:`common`,cost:1,target:`enemy`,vfx:`slash`,text:`Deal @6@ damage. Apply 1 Dimmed.`,effects:[{kind:`dmg`,n:6},{kind:`status`,who:`target`,id:`weak`,n:1}],up:{text:`Deal @9@ damage. Apply 2 Dimmed.`,effects:[{kind:`dmg`,n:9},{kind:`status`,who:`target`,id:`weak`,n:2}]}},guardedStrike:{name:`Warden's Edge`,type:`attack`,rarity:`common`,cost:1,target:`enemy`,vfx:`slash`,text:`Deal @5@ damage. Gain #4# Ward.`,effects:[{kind:`dmg`,n:5},{kind:`block`,n:4}],up:{text:`Deal @7@ damage. Gain #6# Ward.`,effects:[{kind:`dmg`,n:7},{kind:`block`,n:6}]}},brace:{name:`Held Light`,type:`skill`,rarity:`common`,cost:1,target:`self`,vfx:`ward`,text:`Gain #8# Ward.`,effects:[{kind:`block`,n:8}],up:{text:`Gain #11# Ward.`,effects:[{kind:`block`,n:11}]}},sidestep:{name:`Glasstep`,type:`skill`,rarity:`common`,cost:0,target:`self`,vfx:`ward`,text:`Gain #3# Ward. Draw 1 card.`,effects:[{kind:`block`,n:3},{kind:`draw`,n:1}],up:{text:`Gain #5# Ward. Draw 1 card.`,effects:[{kind:`block`,n:5},{kind:`draw`,n:1}]}},preparation:{name:`Tinder`,type:`skill`,rarity:`common`,cost:0,target:`self`,vfx:`fire`,text:`Draw 2 cards. Kindle.`,exhaust:!0,effects:[{kind:`draw`,n:2}],up:{text:`Draw 2 cards.`,exhaust:!1,effects:[{kind:`draw`,n:2}]}},deflect:{name:`Refract`,type:`skill`,rarity:`common`,cost:1,target:`self`,vfx:`ward`,text:`Gain #6# Ward. Draw 1 card.`,effects:[{kind:`block`,n:6},{kind:`draw`,n:1}],up:{text:`Gain #9# Ward. Draw 1 card.`,effects:[{kind:`block`,n:9},{kind:`draw`,n:1}]}},leechBlade:{name:`Thirsting Shard`,type:`attack`,rarity:`uncommon`,cost:2,target:`enemy`,vfx:`void`,text:`Deal @9@ damage. Heal for half the unblocked damage.`,effects:[{kind:`special`,id:`leech`,n:9}],up:{text:`Deal @13@ damage. Heal for half the unblocked damage.`,effects:[{kind:`special`,id:`leech`,n:13}]}},tempest:{name:`Hailglass`,type:`attack`,rarity:`uncommon`,cost:2,target:`allEnemies`,vfx:`pierce`,text:`Deal @4@ damage to ALL enemies twice.`,effects:[{kind:`dmg`,n:4,times:2}],up:{text:`Deal @6@ damage to ALL enemies twice.`,effects:[{kind:`dmg`,n:6,times:2}]}},uppercut:{name:`Ringing Blow`,type:`attack`,rarity:`uncommon`,cost:2,target:`enemy`,chip:1,vfx:`blunt`,text:`Deal @10@ damage. Chip 1 extra Facet. Apply 1 Dimmed.`,effects:[{kind:`dmg`,n:10},{kind:`status`,who:`target`,id:`weak`,n:1}],up:{text:`Deal @13@ damage. Chip 2 extra Facets. Apply 2 Dimmed.`,chip:2,effects:[{kind:`dmg`,n:13},{kind:`status`,who:`target`,id:`weak`,n:2}]}},flurry:{name:`Splinterstorm`,type:`attack`,rarity:`uncommon`,cost:1,target:`enemy`,vfx:`pierce`,text:`Deal @2@ damage 3 times.`,effects:[{kind:`dmg`,n:2,times:3}],up:{text:`Deal @3@ damage 3 times.`,effects:[{kind:`dmg`,n:3,times:3}]}},executioner:{name:`Faultline`,type:`attack`,rarity:`uncommon`,cost:1,target:`enemy`,vfx:`blunt`,text:`Deal @8@ damage. Cracked enemies take 6 more.`,effects:[{kind:`special`,id:`execute`,n:8,bonus:6}],up:{text:`Deal @11@ damage. Cracked enemies take 8 more.`,effects:[{kind:`special`,id:`execute`,n:11,bonus:8}]}},momentum:{name:`Honing Edge`,type:`attack`,rarity:`uncommon`,cost:1,target:`enemy`,vfx:`slash`,text:`Deal @6@ damage. Each play, this card gains +4 damage this combat.`,effects:[{kind:`special`,id:`momentum`,n:6,grow:4}],up:{text:`Deal @8@ damage. Each play, this card gains +6 damage this combat.`,effects:[{kind:`special`,id:`momentum`,n:8,grow:6}]}},bulwark:{name:`Glasswall`,type:`skill`,rarity:`uncommon`,cost:2,target:`self`,vfx:`ward`,text:`Gain #13# Ward.`,effects:[{kind:`block`,n:13}],up:{text:`Gain #18# Ward.`,effects:[{kind:`block`,n:18}]}},surge:{name:`Struck Match`,type:`skill`,rarity:`uncommon`,cost:0,target:`self`,vfx:`fire`,text:`Gain 1 Energy. Draw 1 card. Kindle.`,exhaust:!0,effects:[{kind:`energy`,n:1},{kind:`draw`,n:1}],up:{text:`Gain 2 Energy. Draw 1 card. Kindle.`,effects:[{kind:`energy`,n:2},{kind:`draw`,n:1}]}},toxicMist:{name:`Ashcloud`,type:`skill`,rarity:`uncommon`,cost:1,target:`allEnemies`,vfx:`poison`,text:`Apply 3 Smolder to ALL enemies.`,effects:[{kind:`status`,who:`allEnemies`,id:`poison`,n:3}],up:{text:`Apply 5 Smolder to ALL enemies.`,effects:[{kind:`status`,who:`allEnemies`,id:`poison`,n:5}]}},cripple:{name:`Gutter`,type:`skill`,rarity:`uncommon`,cost:1,target:`enemy`,vfx:`void`,text:`Snuff an enemy's fire: it loses 2 Fervor. Kindle.`,exhaust:!0,effects:[{kind:`status`,who:`target`,id:`str`,n:-2}],up:{text:`Snuff an enemy's fire: it loses 3 Fervor. Kindle.`,effects:[{kind:`status`,who:`target`,id:`str`,n:-3}]}},warCry:{name:`Shatterhymn`,type:`skill`,rarity:`uncommon`,cost:1,target:`allEnemies`,vfx:`void`,text:`Apply 1 Dimmed and 1 Cracked to ALL enemies.`,effects:[{kind:`status`,who:`allEnemies`,id:`weak`,n:1},{kind:`status`,who:`allEnemies`,id:`vulnerable`,n:1}],up:{text:`Apply 2 Dimmed and 2 Cracked to ALL enemies.`,effects:[{kind:`status`,who:`allEnemies`,id:`weak`,n:2},{kind:`status`,who:`allEnemies`,id:`vulnerable`,n:2}]}},fortify:{name:`Mirrorlight`,type:`skill`,rarity:`uncommon`,cost:2,target:`self`,vfx:`ward`,text:`Double your Ward.`,effects:[{kind:`special`,id:`doubleBlock`}],up:{cost:1,text:`Double your Ward.`}},bloodRite:{name:`Blood for Oil`,type:`skill`,rarity:`uncommon`,cost:0,target:`self`,vfx:`void`,text:`Lose 3 HP. Gain 2 Energy.`,effects:[{kind:`loseHp`,n:3},{kind:`energy`,n:2}],up:{text:`Lose 3 HP. Gain 3 Energy.`,effects:[{kind:`loseHp`,n:3},{kind:`energy`,n:3}]}},empower:{name:`Inner Blaze`,type:`power`,rarity:`uncommon`,cost:1,target:`self`,vfx:`fire`,text:`Gain 2 Fervor.`,effects:[{kind:`status`,who:`self`,id:`str`,n:2}],up:{text:`Gain 3 Fervor.`,effects:[{kind:`status`,who:`self`,id:`str`,n:3}]}},agility:{name:`Glazier's Poise`,type:`power`,rarity:`uncommon`,cost:1,target:`self`,vfx:`ward`,text:`Gain 2 Poise.`,effects:[{kind:`status`,who:`self`,id:`dex`,n:2}],up:{text:`Gain 3 Poise.`,effects:[{kind:`status`,who:`self`,id:`dex`,n:3}]}},ironSkin:{name:`Vitrify`,type:`power`,rarity:`uncommon`,cost:1,target:`self`,vfx:`ward`,text:`At the end of your turn, gain 3 Ward.`,effects:[{kind:`status`,who:`self`,id:`metallicize`,n:3}],up:{text:`At the end of your turn, gain 4 Ward.`,effects:[{kind:`status`,who:`self`,id:`metallicize`,n:4}]}},regrowth:{name:`Hearthglow`,type:`power`,rarity:`uncommon`,cost:1,target:`self`,vfx:`fire`,text:`At the end of your turn, heal 2 HP.`,effects:[{kind:`status`,who:`self`,id:`regen`,n:2}],up:{text:`At the end of your turn, heal 3 HP.`,effects:[{kind:`status`,who:`self`,id:`regen`,n:3}]}},oblivionStrike:{name:`Bellstrike`,type:`attack`,rarity:`rare`,cost:3,target:`enemy`,chip:2,vfx:`blunt`,text:`Deal @30@ damage. Chip 2 extra Facets.`,effects:[{kind:`dmg`,n:30}],up:{text:`Deal @40@ damage. Chip 3 extra Facets.`,chip:3,effects:[{kind:`dmg`,n:40}]}},phantomBlades:{name:`Phantom Blades`,type:`attack`,rarity:`rare`,cost:1,target:`enemy`,vfx:`pierce`,text:`Deal @3@ damage for each card in your hand.`,effects:[{kind:`special`,id:`phantom`,n:3}],up:{text:`Deal @4@ damage for each card in your hand.`,effects:[{kind:`special`,id:`phantom`,n:4}]}},devour:{name:`Eat the Flame`,type:`attack`,rarity:`rare`,cost:1,target:`enemy`,vfx:`void`,text:`Deal @10@ damage. If this kills, swallow its fire: gain 3 Embers and heal 4. Kindle.`,exhaust:!0,effects:[{kind:`special`,id:`devour`,n:10,embers:3,heal:4}],up:{text:`Deal @13@ damage. If this kills, swallow its fire: gain 4 Embers and heal 6. Kindle.`,effects:[{kind:`special`,id:`devour`,n:13,embers:4,heal:6}]}},annihilate:{name:`Requiem`,type:`attack`,rarity:`rare`,cost:2,target:`allEnemies`,vfx:`fire`,text:`Deal @9@ damage and apply 3 Smolder to ALL enemies.`,effects:[{kind:`dmg`,n:9},{kind:`status`,who:`allEnemies`,id:`poison`,n:3}],up:{text:`Deal @12@ damage and apply 4 Smolder to ALL enemies.`,effects:[{kind:`dmg`,n:12},{kind:`status`,who:`allEnemies`,id:`poison`,n:4}]}},aegis:{name:`Cathedral Glass`,type:`skill`,rarity:`rare`,cost:2,target:`self`,vfx:`ward`,text:`Gain #30# Ward. Kindle.`,exhaust:!0,effects:[{kind:`block`,n:30}],up:{text:`Gain #40# Ward. Kindle.`,effects:[{kind:`block`,n:40}]}},offering:{name:`Pyre Tithe`,type:`skill`,rarity:`rare`,cost:1,target:`self`,vfx:`fire`,text:`Burn every other card in your hand — each feeds the lantern. Draw 3 cards. Kindle.`,exhaust:!0,effects:[{kind:`special`,id:`pyreTithe`,draw:3}],up:{text:`Burn every other card in your hand — each feeds the lantern. Draw 4 cards. Kindle.`,effects:[{kind:`special`,id:`pyreTithe`,draw:4}]}},limitBreak:{name:`Annealing Rite`,type:`skill`,rarity:`rare`,cost:1,target:`allEnemies`,vfx:`blunt`,text:`Chip 2 Facets of every enemy. Kindle.`,exhaust:!0,effects:[{kind:`chip`,n:2}],up:{text:`Chip 3 Facets of every enemy. Kindle.`,effects:[{kind:`chip`,n:3}]}},catalyst:{name:`Bellows`,type:`skill`,rarity:`rare`,cost:1,target:`enemy`,vfx:`poison`,text:`Double an enemy's Smolder. Kindle.`,exhaust:!0,effects:[{kind:`special`,id:`catalyst`,n:2}],up:{text:`Triple an enemy's Smolder. Kindle.`,effects:[{kind:`special`,id:`catalyst`,n:3}]}},ascension:{name:`Rising Litany`,type:`power`,rarity:`rare`,cost:3,target:`self`,vfx:`fire`,text:`At the start of each turn, gain 2 Fervor.`,effects:[{kind:`status`,who:`self`,id:`ritual`,n:2}],up:{text:`At the start of each turn, gain 3 Fervor.`,effects:[{kind:`status`,who:`self`,id:`ritual`,n:3}]}},bastion:{name:`Anneal`,type:`power`,rarity:`rare`,cost:3,target:`self`,vfx:`ward`,text:`Ward no longer expires at the start of your turn.`,effects:[{kind:`status`,who:`self`,id:`barricade`,n:1}],up:{cost:2}},frenzy:{name:`Overglow`,type:`power`,rarity:`rare`,cost:2,target:`self`,vfx:`fire`,text:`Your glass runs too hot: gain 2 Cracked. At the start of each turn, gain 1 Energy.`,effects:[{kind:`status`,who:`self`,id:`vulnerable`,n:2},{kind:`status`,who:`self`,id:`energized`,n:1}],up:{text:`Your glass runs too hot: gain 1 Cracked. At the start of each turn, gain 1 Energy.`,effects:[{kind:`status`,who:`self`,id:`vulnerable`,n:1},{kind:`status`,who:`self`,id:`energized`,n:1}]}},virulence:{name:`Emberfang`,type:`power`,rarity:`rare`,cost:2,target:`self`,vfx:`poison`,text:`Whenever you play an Attack, apply 1 Smolder to the enemy.`,effects:[{kind:`status`,who:`self`,id:`venomous`,n:1}],up:{cost:1}},quakeblow:{name:`Quakeblow`,type:`attack`,rarity:`uncommon`,cost:2,target:`enemy`,chip:2,locked:`paneBreaker`,vfx:`blunt`,text:`Deal @8@ damage. Chip 2 extra Facets.`,effects:[{kind:`dmg`,n:8}],up:{text:`Deal @11@ damage. Chip 3 extra Facets.`,chip:3,effects:[{kind:`dmg`,n:11}]}},resonantLance:{name:`Resonant Lance`,type:`attack`,rarity:`rare`,cost:1,target:`enemy`,locked:`paneBreaker`,vfx:`pierce`,text:`Deal @7@ damage. Deals double to Staggered or Cracked glass.`,effects:[{kind:`special`,id:`shatterEcho`,n:7}],up:{text:`Deal @10@ damage. Deals double to Staggered or Cracked glass.`,effects:[{kind:`special`,id:`shatterEcho`,n:10}]}},tithe:{name:`Tithe of Panes`,type:`skill`,rarity:`uncommon`,cost:1,target:`self`,locked:`lanternFed`,vfx:`fire`,text:`Gain 2 Embers. Draw 1 card.`,effects:[{kind:`ember`,n:2},{kind:`draw`,n:1}],up:{text:`Gain 3 Embers. Draw 1 card.`,effects:[{kind:`ember`,n:3},{kind:`draw`,n:1}]}},pyreheart:{name:`Pyreheart`,type:`power`,rarity:`rare`,cost:2,target:`self`,locked:`lanternFed`,vfx:`fire`,text:`At the start of each turn, gain 1 Ember.`,effects:[{kind:`status`,who:`self`,id:`emberflow`,n:1}],up:{cost:1}},ashenChoir:{name:`Ashen Choir`,type:`skill`,rarity:`uncommon`,cost:1,target:`enemy`,locked:`ashSermon`,vfx:`poison`,text:`Apply 4 Smolder. When smoldering glass dies, its fire leaps on.`,effects:[{kind:`status`,who:`target`,id:`poison`,n:4}],up:{text:`Apply 6 Smolder. When smoldering glass dies, its fire leaps on.`,effects:[{kind:`status`,who:`target`,id:`poison`,n:6}]}},flawlessForm:{name:`Flawless Form`,type:`skill`,rarity:`rare`,cost:1,target:`self`,locked:`untouched`,vfx:`ward`,text:`Gain #8# Ward. If your glass is untouched this combat, gain #8# more.`,effects:[{kind:`special`,id:`flawless`,n:8}],up:{text:`Gain #11# Ward. If your glass is untouched this combat, gain #11# more.`,effects:[{kind:`special`,id:`flawless`,n:11}]}},nightSight:{name:`Night Sight`,type:`power`,rarity:`uncommon`,cost:1,target:`self`,locked:`darkWalker`,vfx:`void`,text:`At the start of each turn, draw 1 extra card.`,effects:[{kind:`status`,who:`self`,id:`nightsight`,n:1}],up:{cost:0}},novaflare:{name:`Novaflare`,type:`attack`,rarity:`rare`,cost:2,target:`enemy`,locked:`spendthrift`,vfx:`fire`,text:`Deal @3@ damage for every Ember in your lantern.`,effects:[{kind:`special`,id:`emberNova`,n:3}],up:{text:`Deal @4@ damage for every Ember in your lantern.`,effects:[{kind:`special`,id:`emberNova`,n:4}]}},emberdance:{name:`Emberdance`,type:`skill`,rarity:`uncommon`,cost:0,target:`self`,locked:`spendthrift`,vfx:`fire`,text:`Spill your lantern: gain 3 Ward for each Ember spent. Kindle.`,exhaust:!0,effects:[{kind:`special`,id:`emberdance`,n:3}],up:{text:`Spill your lantern: gain 4 Ward for each Ember spent. Kindle.`,effects:[{kind:`special`,id:`emberdance`,n:4}]}},shardstorm:{name:`Shardstorm`,type:`attack`,rarity:`rare`,cost:3,target:`allEnemies`,vfx:`pierce`,locked:`hundredShards`,text:`Deal @5@ damage to ALL enemies twice.`,effects:[{kind:`dmg`,n:5,times:2}],up:{text:`Deal @7@ damage to ALL enemies twice.`,effects:[{kind:`dmg`,n:7,times:2}]}},wound:{name:`Shard`,type:`status`,rarity:`special`,cost:null,target:`none`,vfx:`pierce`,text:`Unplayable. Broken glass rattling in your deck.`,unplayable:!0,effects:[]},burn:{name:`Cinder`,type:`status`,rarity:`special`,cost:null,target:`none`,vfx:`fire`,text:`Unplayable. At the end of your turn, take 2 damage if this is in your hand.`,unplayable:!0,endTurnDmg:2,effects:[]},hex:{name:`Hex`,type:`curse`,rarity:`special`,cost:null,target:`none`,vfx:`void`,text:`Unplayable. At the end of your turn, lose 1 HP if this is in your hand. Refuses the fire.`,unplayable:!0,endTurnLoseHp:1,effects:[]}},zl=(()=>{let e={common:[],uncommon:[],rare:[]};for(let[t,n]of Object.entries(Rl))e[n.rarity]&&!n.locked&&e[n.rarity].push(t);return e})(),Bl={str:{name:`Fervor`,icon:`⚔`,kind:`buff`,desc:`The inner fire stoked: attacks deal +N damage.`},dex:{name:`Poise`,icon:`🛡`,kind:`buff`,desc:`Ward cards grant +N Ward.`},vulnerable:{name:`Cracked`,icon:`◎`,kind:`debuff`,desc:`The glass is scored: takes 50% more attack damage. Wears off each turn.`},weak:{name:`Dimmed`,icon:`↓`,kind:`debuff`,desc:`The fire gutters: deals 25% less attack damage. Wears off each turn.`},frail:{name:`Brittle`,icon:`✖`,kind:`debuff`,desc:`Ward gained reduced 25%. Wears off each turn.`},poison:{name:`Smolder`,icon:`☠`,kind:`debuff`,desc:`Burns from within: loses N HP at the start of its turn, then Smolder falls by 1. When smoldering glass shatters or dies, the Smolder leaps to another enemy.`},thorns:{name:`Splinters`,icon:`❈`,kind:`buff`,desc:`Attackers take N damage back.`},ritual:{name:`Litany`,icon:`☽`,kind:`buff`,desc:`Gains N Fervor at the start of each turn.`},metallicize:{name:`Vitrified`,icon:`⬡`,kind:`buff`,desc:`Gains N Ward at the end of each turn.`},regen:{name:`Warmth`,icon:`❋`,kind:`buff`,desc:`Heals N HP at the end of each turn.`},barricade:{name:`Annealed`,icon:`☗`,kind:`buff`,desc:`Ward no longer expires.`},energized:{name:`Alight`,icon:`✦`,kind:`buff`,desc:`Gain N extra Energy at the start of each turn.`},venomous:{name:`Emberfang`,icon:`☠`,kind:`buff`,desc:`Attacks apply N Smolder.`},rampage:{name:`Crescendo`,icon:`⤴`,kind:`buff`,desc:`Attack grows stronger with each use.`},beacon:{name:`Beacon`,icon:`☀`,kind:`buff`,desc:`Attacks chip N extra Facet(s). Fades at end of turn.`},emberflow:{name:`Pyreheart`,icon:`♥`,kind:`buff`,desc:`Gain N Ember(s) at the start of each turn.`},nightsight:{name:`Night Sight`,icon:`☾`,kind:`buff`,desc:`Draw N extra card(s) at the start of each turn.`}},Vl={emberHeart:{name:`Emberheart`,rarity:`starter`,glyph:`♥`,tone:`#ff5964`,text:`At the end of combat, heal 6 HP.`},ashenCore:{name:`Ashen Core`,rarity:`starter`,glyph:`☁`,tone:`#d3a15a`,text:`Enemies begin each combat with 3 Smolder.`},basaltIdol:{name:`Basalt Idol`,rarity:`common`,glyph:`☗`,tone:`#9aa7b8`,text:`Begin each combat with 10 Ward.`},warFetish:{name:`War Fetish`,rarity:`common`,glyph:`⚔`,tone:`#ff8c5a`,text:`Begin each combat with 1 Fervor.`},riverPearl:{name:`River Pearl`,rarity:`common`,glyph:`◉`,tone:`#6fd6e8`,text:`Begin each combat with 1 Poise.`},travelersPack:{name:`Traveler's Pack`,rarity:`common`,glyph:`⌘`,tone:`#c9a86a`,text:`Draw 2 extra cards on your first turn.`},emberLantern:{name:`Ember Lantern`,rarity:`common`,glyph:`☀`,tone:`#ffd166`,text:`Gain 1 extra Energy on your first turn.`},vialOfLife:{name:`Vial of Life`,rarity:`common`,glyph:`♣`,tone:`#7ddb8f`,text:`Heal 2 HP at the start of each combat.`},thornBand:{name:`Thorn Band`,rarity:`common`,glyph:`❈`,tone:`#a3e06c`,text:`Begin each combat with 2 Splinters.`},sweetRoot:{name:`Sweet Root`,rarity:`common`,glyph:`✿`,tone:`#ff9ecb`,text:`On pickup: gain 8 Max HP.`,instant:!0},gravebloom:{name:`Gravebloom`,rarity:`uncommon`,glyph:`❀`,tone:`#b18cff`,text:`After combat, if at or below 50% HP, heal 10.`},silkFan:{name:`Silk Fan`,rarity:`uncommon`,glyph:`⛉`,tone:`#8fd0ff`,text:`Every 3rd card you play each combat grants 3 Ward.`},reapersBell:{name:`Reaper's Bell`,rarity:`uncommon`,glyph:`♫`,tone:`#d8c27a`,text:`When an enemy dies, gain 1 Energy and draw 1 card.`},executionersSeal:{name:`Executioner's Seal`,rarity:`uncommon`,glyph:`✠`,tone:`#ff6b6b`,text:`Every 10th Attack you play deals double damage.`},ironTalisman:{name:`Iron Talisman`,rarity:`uncommon`,glyph:`◈`,tone:`#c0c8d4`,text:`Every 3rd Attack you play grants 1 Fervor.`},merchantsMark:{name:`Merchant's Mark`,rarity:`uncommon`,glyph:`¤`,tone:`#f2c14e`,text:`Shop prices are 25% lower.`},seersOrb:{name:`Seer's Orb`,rarity:`uncommon`,glyph:`☉`,tone:`#9be8d8`,text:`Card rewards offer 1 additional choice.`},frozenCore:{name:`Frozen Core`,rarity:`rare`,glyph:`❆`,tone:`#a8e6ff`,text:`Unspent Energy carries over between turns.`},verdantBranch:{name:`Verdant Branch`,rarity:`rare`,glyph:`⚕`,tone:`#7ddb8f`,text:`Whenever a card is Kindled or burned away, draw 1 card.`},sunBlossom:{name:`Sun Blossom`,rarity:`rare`,glyph:`❂`,tone:`#ffd166`,text:`All healing is increased by 50%.`},wardingCharm:{name:`Warding Charm`,rarity:`rare`,glyph:`⛨`,tone:`#8fa8ff`,text:`Enemy attacks that would deal 5 or less damage deal 1.`},duskmirror:{name:`Duskmirror`,rarity:`rare`,glyph:`◐`,tone:`#c99aff`,text:`The first card you play each turn costs 0.`},smolderingCoal:{name:`Smoldering Coal`,rarity:`uncommon`,glyph:`♨`,tone:`#ff9a4d`,locked:`ashSermon`,text:`Enemies begin each combat with 2 Smolder.`},thiefOfWicks:{name:`Thief of Wicks`,rarity:`uncommon`,glyph:`☄`,tone:`#c9a86a`,locked:`darkWalker`,text:`Unlit lanterns pay double bounty.`},prismCharm:{name:`Prism Charm`,rarity:`rare`,glyph:`◬`,tone:`#9be8d8`,locked:`untouched`,text:`Your first Shatter each combat spills 2 extra Embers.`},bellOfEndings:{name:`Bell of Endings`,rarity:`rare`,glyph:`♪`,tone:`#dfeaff`,locked:`hundredShards`,text:`Whenever glass Shatters, every other enemy takes 4 damage.`},crownOfCinders:{name:`Crown of Cinders`,rarity:`boss`,glyph:`♛`,tone:`#ff9a4d`,text:`Your lantern holds 12 Embers and begins each combat holding 2.`},hollowCrown:{name:`Hollow Crown`,rarity:`boss`,glyph:`♕`,tone:`#b18cff`,text:`Gain 1 Energy each turn. The glass dims: on pickup, lose 10 Max HP.`,instant:!0},crownOfTithes:{name:`Crown of Tithes`,rarity:`boss`,glyph:`♜`,tone:`#d8c27a`,text:`You may kindle twice each turn, and each kindling grants 3 Ward.`},shatterersCrown:{name:`Shatterer's Crown`,rarity:`boss`,glyph:`♚`,tone:`#8fd0ff`,text:`Enemy glass runs thin: all facet gauges are 1 smaller. Enemies begin with 1 Fervor.`},crownOfTheHearth:{name:`Crown of the Hearth`,rarity:`boss`,glyph:`♥`,tone:`#ff5964`,text:`At the end of combat, heal 3 HP for every Ember still in your lantern.`}},Hl=(()=>{let e={common:[],uncommon:[],rare:[],boss:[]};for(let[t,n]of Object.entries(Vl))e[n.rarity]&&!n.locked&&e[n.rarity].push(t);return e})(),Ul={healing:{name:`Phial of Dawn`,tone:`#ff6b81`,glyph:`♥`,text:`Heal 20 HP.`,combatOnly:!1},strength:{name:`Phial of Fervor`,tone:`#ff8c5a`,glyph:`⚔`,text:`Gain 2 Fervor.`,combatOnly:!0},swift:{name:`Inkdraught`,tone:`#8fd0ff`,glyph:`»`,text:`Draw 3 cards.`,combatOnly:!0},block:{name:`Phial of Held Light`,tone:`#9aa7b8`,glyph:`☗`,text:`Gain 12 Ward.`,combatOnly:!0},fire:{name:`Stormglass Phial`,tone:`#ffd166`,glyph:`✹`,text:`Deal 20 damage to an enemy.`,combatOnly:!0,needsTarget:!0},venom:{name:`Smolderphial`,tone:`#a3e06c`,glyph:`☠`,text:`Apply 7 Smolder to an enemy.`,combatOnly:!0,needsTarget:!0},energy:{name:`Emberphial`,tone:`#ff9a4d`,glyph:`✦`,text:`Gain 3 Embers.`,combatOnly:!0}},Wl={sporeling:{name:`Sporeling`,hp:[13,17],facets:3,art:{kind:`wisp`,hue:95,size:.72},moves:{spit:{name:`Spore Spit`,intent:`attack`,dmg:4},grow:{name:`Bloom`,intent:`buff`,fx:[{who:`self`,id:`str`,n:1}]}},ai:({turn:e})=>e%3==2?`grow`:`spit`},duskfang:{name:`Duskfang`,hp:[26,30],art:{kind:`beast`,hue:22,size:1},moves:{howl:{name:`Howl`,intent:`buff`,fx:[{who:`self`,id:`str`,n:2}]},bite:{name:`Bite`,intent:`attack`,dmg:7},rend:{name:`Rend`,intent:`attack`,dmg:4,times:2}},ai:({turn:e,last:t,rng:n})=>e===1||t!==`howl`&&n()<.18?`howl`:t===`bite`?`rend`:`bite`},gloomslime:{name:`Gloomslime`,hp:[30,34],art:{kind:`slime`,hue:150,size:1},moves:{slam:{name:`Slam`,intent:`attack`,dmg:8},ooze:{name:`Corrosive Ooze`,intent:`attack_debuff`,dmg:3,fx:[{who:`player`,id:`weak`,n:2}]},harden:{name:`Congeal`,intent:`attack_block`,dmg:4,block:6}},ai:({turn:e})=>[`ooze`,`slam`,`harden`][(e-1)%3]},waylayer:{name:`Waylayer`,hp:[28,32],art:{kind:`rogue`,hue:0,size:.95},moves:{stab:{name:`Stab`,intent:`attack`,dmg:9},smoke:{name:`Smokescreen`,intent:`block`,block:8},trick:{name:`Dirty Trick`,intent:`attack_debuff`,dmg:4,fx:[{who:`player`,id:`frail`,n:2}]}},ai:({turn:e,rng:t})=>e===1?`trick`:t()<.55?`stab`:t()<.5?`smoke`:`trick`},thornling:{name:`Thornling`,hp:[18,22],facets:3,art:{kind:`plant`,hue:80,size:.85},startStatus:{thorns:2},moves:{prick:{name:`Prick`,intent:`attack`,dmg:6},bristle:{name:`Bristle`,intent:`buff`,fx:[{who:`self`,id:`thorns`,n:2}]},burst:{name:`Spike Burst`,intent:`attack`,dmg:10}},ai:({turn:e})=>e%4==0?`burst`:e%2==1?`prick`:`bristle`},ashAcolyte:{name:`Ash Acolyte`,hp:[34,38],art:{kind:`cultist`,hue:28,size:1},moves:{ritual:{name:`Dark Ritual`,intent:`buff`,fx:[{who:`self`,id:`ritual`,n:2}]},scorch:{name:`Scorch`,intent:`attack`,dmg:6}},ai:({turn:e})=>e===1?`ritual`:`scorch`},gravewarden:{name:`Gravewarden`,hp:[70,76],elite:!0,art:{kind:`golem`,hue:210,size:1.25},moves:{crush:{name:`Crush`,intent:`attack`,dmg:12},entomb:{name:`Entomb`,intent:`debuff`,fx:[{who:`player`,id:`frail`,n:2},{who:`player`,id:`vulnerable`,n:2}]},bulwark:{name:`Bulwark`,intent:`attack_block`,dmg:6,block:12}},ai:({turn:e})=>[`entomb`,`crush`,`bulwark`,`crush`][(e-1)%4]},alphaFang:{name:`Alpha Duskfang`,hp:[64,70],elite:!0,art:{kind:`beast`,hue:350,size:1.3},moves:{howl:{name:`Alpha Howl`,intent:`buff`,fx:[{who:`self`,id:`str`,n:3}]},savage:{name:`Savage`,intent:`attack`,dmg:5,times:2},throat:{name:`Throat Rip`,intent:`attack`,dmg:13}},ai:({turn:e,last:t})=>e===1||e%4==0?`howl`:t===`savage`?`throat`:`savage`},rootheart:{name:`The Rootheart`,hp:[150,150],boss:!0,art:{kind:`treeboss`,hue:100,size:1.6},moves:{awaken:{name:`Awaken`,intent:`buff`,block:10,fx:[{who:`self`,id:`str`,n:2}]},lash:{name:`Root Lash`,intent:`attack`,dmg:12},spores:{name:`Choking Spores`,intent:`attack_debuff`,dmg:5,fx:[{who:`player`,id:`poison`,n:4},{who:`player`,id:`weak`,n:2}]},entangle:{name:`Entangle`,intent:`attack_debuff`,dmg:7,addCards:{id:`wound`,n:2}},slam:{name:`Colossal Slam`,intent:`attack`,dmg:22}},ai:({turn:e})=>e===1?`awaken`:e%4==0?`slam`:[`lash`,`spores`,`entangle`][(e-2)%3]},drownedOne:{name:`Drowned One`,hp:[38,44],art:{kind:`zombie`,hue:185,size:1},moves:{claw:{name:`Claw`,intent:`attack`,dmg:11},frenzy:{name:`Frenzy`,intent:`attack`,dmg:4,times:3},gurgle:{name:`Gurgle`,intent:`attack_debuff`,dmg:5,fx:[{who:`player`,id:`weak`,n:2}]}},ai:({hpFrac:e,last:t,rng:n})=>e<.5&&t!==`frenzy`?`frenzy`:n()<.6?`claw`:`gurgle`},voltEel:{name:`Voltaic Eel`,hp:[30,36],art:{kind:`serpent`,hue:190,size:.9},moves:{shock:{name:`Shock`,intent:`attack_block`,dmg:7,block:5},discharge:{name:`Discharge`,intent:`attack`,dmg:12},coil:{name:`Coil`,intent:`buff`,block:8,fx:[{who:`self`,id:`str`,n:1}]}},ai:({turn:e})=>[`shock`,`coil`,`discharge`][(e-1)%3]},mirelurker:{name:`Mirelurker`,hp:[34,40],art:{kind:`crawler`,hue:160,size:.95},moves:{sting:{name:`Venom Sting`,intent:`attack_debuff`,dmg:6,fx:[{who:`player`,id:`poison`,n:3}]},burrow:{name:`Burrow`,intent:`block`,block:10},barb:{name:`Barb`,intent:`attack`,dmg:9}},ai:({turn:e,rng:t})=>e%3==0?`burrow`:t()<.55?`sting`:`barb`},tidecaller:{name:`Tidecaller`,hp:[42,48],art:{kind:`cultist`,hue:195,size:1.05},moves:{surge:{name:`Tidal Blessing`,intent:`buff`,fx:[{who:`allies`,id:`str`,n:2}]},bolt:{name:`Water Bolt`,intent:`attack`,dmg:9},undertow:{name:`Undertow`,intent:`attack_debuff`,dmg:4,fx:[{who:`player`,id:`frail`,n:2}]}},ai:({turn:e})=>e===1?`surge`:e%3==0?`undertow`:`bolt`},shellback:{name:`Shellback`,hp:[50,56],art:{kind:`crab`,hue:15,size:1.15},moves:{snap:{name:`Snap`,intent:`attack`,dmg:10},shell:{name:`Shell Up`,intent:`block`,block:13,fx:[{who:`self`,id:`thorns`,n:1}]},jet:{name:`Water Jet`,intent:`attack`,dmg:6,times:2}},ai:({turn:e})=>[`snap`,`shell`,`jet`,`shell`][(e-1)%4]},deepmaw:{name:`Deepmaw`,hp:[54,60],art:{kind:`maw`,hue:200,size:1.2},moves:{bite:{name:`Bite`,intent:`attack`,dmg:14},lure:{name:`Luminous Lure`,intent:`debuff`,fx:[{who:`player`,id:`vulnerable`,n:2}]},swallow:{name:`Swallow`,intent:`attack_buff`,dmg:8,heal:8}},ai:({turn:e})=>[`lure`,`bite`,`swallow`][(e-1)%3]},abyssalKnight:{name:`Abyssal Knight`,hp:[108,116],elite:!0,art:{kind:`knight`,hue:215,size:1.3},moves:{blade:{name:`Voidblade`,intent:`attack`,dmg:15},oath:{name:`Dark Oath`,intent:`buff`,block:14,fx:[{who:`self`,id:`str`,n:2}]},condemn:{name:`Condemn`,intent:`debuff`,fx:[{who:`player`,id:`vulnerable`,n:2},{who:`player`,id:`weak`,n:2}]},execute:{name:`Execute`,intent:`attack`,dmg:9,times:2}},ai:({turn:e})=>[`condemn`,`blade`,`oath`,`execute`][(e-1)%4]},siren:{name:`Siren`,hp:[92,100],elite:!0,art:{kind:`siren`,hue:280,size:1.15},moves:{song:{name:`Dirge`,intent:`debuff`,fx:[{who:`player`,id:`weak`,n:2},{who:`player`,id:`frail`,n:2}]},rend:{name:`Talon Rend`,intent:`attack`,dmg:12},mend:{name:`Mend`,intent:`heal`,heal:12,block:6},shriek:{name:`Shriek`,intent:`attack`,dmg:7,times:2}},ai:({turn:e,hpFrac:t,last:n})=>t<.55&&n!==`mend`?`mend`:[`song`,`rend`,`shriek`][(e-1)%3]},leviathan:{name:`Leviathan's Maw`,hp:[260,260],boss:!0,art:{kind:`leviathan`,hue:195,size:1.7},moves:{tide:{name:`Rising Tide`,intent:`buff`,block:15,fx:[{who:`self`,id:`str`,n:1}]},crush:{name:`Crushing Jaws`,intent:`attack`,dmg:17},brine:{name:`Black Brine`,intent:`attack_debuff`,dmg:6,fx:[{who:`player`,id:`poison`,n:5},{who:`player`,id:`weak`,n:2}]},consume:{name:`Consume the Deep`,intent:`heal`,heal:20,block:10},cataclysm:{name:`Cataclysm`,intent:`attack`,dmg:30}},ai:({turn:e})=>e===1?`tide`:e%4==0?`cataclysm`:[`crush`,`brine`,`consume`][(e-2)%3]},voidWisp:{name:`Void Wisp`,hp:[26,30],facets:3,art:{kind:`wisp`,hue:275,size:.78},moves:{zap:{name:`Void Zap`,intent:`attack`,dmg:7},siphon:{name:`Siphon`,intent:`attack_buff`,dmg:5,heal:5}},ai:({rng:e})=>e()<.6?`zap`:`siphon`},obsidianGolem:{name:`Obsidian Golem`,hp:[64,72],art:{kind:`golem`,hue:270,size:1.3},moves:{pound:{name:`Pound`,intent:`attack`,dmg:14},harden:{name:`Harden`,intent:`block`,block:14},quake:{name:`Quake`,intent:`attack_debuff`,dmg:10,fx:[{who:`player`,id:`frail`,n:2}]}},ai:({turn:e})=>[`pound`,`harden`,`quake`][(e-1)%3]},starCultist:{name:`Star Cultist`,hp:[46,52],art:{kind:`cultist`,hue:290,size:1.05},moves:{ritual:{name:`Star Ritual`,intent:`buff`,fx:[{who:`self`,id:`ritual`,n:3}]},scorch:{name:`Starfire`,intent:`attack`,dmg:9}},ai:({turn:e})=>e===1?`ritual`:`scorch`},shade:{name:`Shade`,hp:[42,48],art:{kind:`shade`,hue:260,size:1},moves:{slash:{name:`Dual Slash`,intent:`attack`,dmg:6,times:2},gloom:{name:`Gloom`,intent:`attack_debuff`,dmg:6,fx:[{who:`player`,id:`weak`,n:2}]},vanish:{name:`Vanish`,intent:`block`,block:12}},ai:({turn:e,rng:t})=>e%3==0?`vanish`:t()<.5?`slash`:`gloom`},chaosHound:{name:`Chaos Hound`,hp:[56,64],art:{kind:`beast`,hue:315,size:1.1},startStatus:{rampage:1},moves:{bite:{name:`Chaos Bite`,intent:`attack`,dmg:9,ramp:3},howl:{name:`Warp Howl`,intent:`buff`,fx:[{who:`self`,id:`str`,n:2}]}},ai:({turn:e})=>e%4==0?`howl`:`bite`},watcherEye:{name:`Watcher Eye`,hp:[48,56],art:{kind:`eye`,hue:250,size:1.05},moves:{gaze:{name:`Piercing Gaze`,intent:`attack_debuff`,dmg:8,fx:[{who:`player`,id:`vulnerable`,n:2}]},beam:{name:`Ruin Beam`,intent:`attack`,dmg:15},blink:{name:`Blink`,intent:`attack_block`,dmg:5,block:10}},ai:({turn:e})=>[`gaze`,`beam`,`blink`][(e-1)%3]},voidColossus:{name:`Voidforged Colossus`,hp:[155,168],elite:!0,art:{kind:`golem`,hue:305,size:1.5},moves:{slam:{name:`Void Slam`,intent:`attack`,dmg:20},fortify:{name:`Fortify`,intent:`buff`,block:18,fx:[{who:`self`,id:`str`,n:2}]},shatter:{name:`Shatter`,intent:`attack_debuff`,dmg:8,fx:[{who:`player`,id:`frail`,n:3}]}},ai:({turn:e})=>[`shatter`,`slam`,`fortify`,`slam`][(e-1)%4]},heraldOfEnd:{name:`Herald of the End`,hp:[128,142],elite:!0,art:{kind:`shade`,hue:335,size:1.4},moves:{doom:{name:`Doomsong`,intent:`debuff`,fx:[{who:`player`,id:`poison`,n:7}]},reave:{name:`Reave`,intent:`attack`,dmg:16},flame:{name:`Black Flame`,intent:`attack`,dmg:8,times:2},rise:{name:`Apotheosis`,intent:`buff`,fx:[{who:`self`,id:`str`,n:3}]}},ai:({turn:e})=>e%4==0?`rise`:[`doom`,`reave`,`flame`][(e-1)%3]},sovereign:{name:`The Eternal Sovereign`,hp:[330,330],boss:!0,art:{kind:`sovereign`,hue:285,size:1.8},moves:{scepter:{name:`Scepter Strike`,intent:`attack`,dmg:18},gravitas:{name:`Gravitas`,intent:`buff`,block:20,fx:[{who:`self`,id:`str`,n:2}]},starfall:{name:`Starfall`,intent:`attack`,dmg:11,times:2},ruin:{name:`Word of Ruin`,intent:`attack_debuff`,dmg:4,fx:[{who:`player`,id:`poison`,n:4},{who:`player`,id:`weak`,n:2},{who:`player`,id:`frail`,n:2}]},ascend:{name:`Ascend`,intent:`buff`,block:30,fx:[{who:`self`,id:`str`,n:4}]},annihilation:{name:`Annihilation`,intent:`attack`,dmg:34}},ai:e=>{let t=e.self;return e.hpFrac<=.5&&!t.flags.ascended?(t.flags.ascended=!0,`ascend`):t.flags.ascended?(t.flags.p2=(t.flags.p2||0)+1,t.flags.p2%3==0?`annihilation`:[`scepter`,`starfall`,`ruin`,`gravitas`][t.flags.p2%4]):[`scepter`,`gravitas`,`starfall`,`ruin`][(e.turn-1)%4]}}},Gl=[{weak:[[`sporeling`,`sporeling`],[`duskfang`],[`gloomslime`],[`sporeling`,`sporeling`,`sporeling`]],normal:[[`duskfang`,`sporeling`],[`ashAcolyte`],[`waylayer`],[`thornling`,`thornling`],[`gloomslime`,`sporeling`],[`duskfang`,`duskfang`],[`waylayer`,`sporeling`]],elite:[[`gravewarden`],[`alphaFang`]],boss:[[`rootheart`]]},{weak:[[`voltEel`],[`mirelurker`],[`drownedOne`]],normal:[[`drownedOne`,`voltEel`],[`tidecaller`,`mirelurker`],[`shellback`],[`deepmaw`],[`drownedOne`,`drownedOne`],[`tidecaller`,`voltEel`],[`mirelurker`,`mirelurker`]],elite:[[`abyssalKnight`],[`siren`]],boss:[[`leviathan`]]},{weak:[[`voidWisp`,`voidWisp`],[`shade`],[`starCultist`]],normal:[[`obsidianGolem`],[`shade`,`voidWisp`],[`chaosHound`],[`watcherEye`],[`starCultist`,`voidWisp`],[`shade`,`shade`],[`chaosHound`,`voidWisp`],[`watcherEye`,`starCultist`]],elite:[[`voidColossus`],[`heraldOfEnd`]],boss:[[`sovereign`]]}],Kl={forgottenShrine:{name:`Forgotten Shrine`,glyph:`⛩`,hue:45,text:`A moss-eaten shrine hums with old power. Offerings of bone and silver litter its base. Something watches from inside the stone.`,choices:[{label:`Pray`,sub:`Remove a card from your deck.`,ops:[{pickRemove:!0}]},{label:`Desecrate`,sub:`Gain 90 gold. Gain a Hex.`,ops:[{gold:90},{addCard:`hex`}]},{label:`Leave`,sub:``,ops:[]}]},woundedKnight:{name:`The Wounded Knight`,glyph:`⚔`,hue:210,text:`A knight slumps against a shattered pillar, breath rattling behind a crushed visor. One gauntlet clutches a relic; the other beckons you closer.`,choices:[{label:`Aid him`,sub:`Lose 8 HP. He rewards you with a relic.`,ops:[{hp:-8},{addRelic:`random`}]},{label:`Loot him`,sub:`Gain 65 gold. Gain a Hex.`,ops:[{gold:65},{addCard:`hex`}]},{label:`Leave`,sub:``,ops:[]}]},voidChest:{name:`Humming Chest`,glyph:`▣`,hue:280,text:`A black iron chest sits alone in the gloom, humming a note you feel in your teeth. Its lock is already broken.`,choices:[{label:`Open it`,sub:`It might hold a relic... or teeth.`,ops:[{roll:[{p:.55,ops:[{addRelic:`random`}],text:`Inside: a relic, warm as a heartbeat.`},{p:.45,ops:[{hp:-12}],text:`Teeth. You pull back a mangled hand. (-12 HP)`}]}]},{label:`Leave`,sub:``,ops:[]}]},emberFountain:{name:`Fountain of Embers`,glyph:`❂`,hue:30,text:`Liquid light pools in a cracked basin, throwing sparks that do not burn. It smells of summer and old victories.`,choices:[{label:`Bathe`,sub:`Heal 35% of your Max HP.`,ops:[{heal:.35}]},{label:`Bottle it`,sub:`Gain a Phial of Dawn.`,ops:[{potion:`healing`}]},{label:`Leave`,sub:``,ops:[]}]},forge:{name:`The Forgotten Forge`,glyph:`⚒`,hue:15,text:`An anvil of black star-metal, still warm. Hammers hang in racks, waiting for hands that died an age ago.`,choices:[{label:`Temper`,sub:`Upgrade a card.`,ops:[{pickUpgrade:!0}]},{label:`Leave`,sub:``,ops:[]}]},gambler:{name:`The Bone Gambler`,glyph:`⚄`,hue:50,text:`A grinning figure rattles a cup of knuckle-bones. "One throw, stranger. Fortune loves the reckless."`,choices:[{label:`Bet 40 gold`,sub:`45% chance to win 110 gold.`,needGold:40,ops:[{gold:-40},{roll:[{p:.45,ops:[{gold:110}],text:`The bones land your way. +110 gold.`},{p:.55,ops:[],text:`The bones betray you. The gambler grins wider.`}]}]},{label:`Walk away`,sub:``,ops:[]}]},mirror:{name:`The Silvered Mirror`,glyph:`◐`,hue:220,text:`A tall mirror stands in the rubble, unbroken. Your reflection moves half a breath behind you — and it is smiling.`,choices:[{label:`Reflect`,sub:`Duplicate a card in your deck.`,ops:[{pickDuplicate:!0}]},{label:`Shatter it`,sub:`Lose 6 HP. Remove a card from your deck.`,ops:[{hp:-6},{pickRemove:!0}]},{label:`Leave`,sub:``,ops:[]}]},library:{name:`The Drowned Library`,glyph:`❦`,hue:190,text:`Shelves of waterlogged grimoires stretch into the dark. Most are pulp — but a few pages still glow faintly.`,choices:[{label:`Study`,sub:`Choose 1 of 5 cards to add to your deck.`,ops:[{pickCard:5}]},{label:`Rest among the stacks`,sub:`Heal 20% of your Max HP.`,ops:[{heal:.2}]}]},fleshTrader:{name:`The Flesh Trader`,glyph:`♠`,hue:320,text:`"Vitality is a currency," purrs a thing wearing a merchant's coat. "And you look flush with it." Long fingers open to reveal a relic.`,choices:[{label:`Trade`,sub:`Lose 8 Max HP. Gain a relic.`,ops:[{maxHp:-8},{addRelic:`random`}]},{label:`Refuse`,sub:``,ops:[]}]},cursedIdol:{name:`The Cursed Idol`,glyph:`☿`,hue:100,text:`A jade idol sits on a plinth of skulls, radiating a soft warmth. It has clearly been left here for a reason.`,choices:[{label:`Take it`,sub:`Gain a relic. Gain a Hex.`,ops:[{addRelic:`random`},{addCard:`hex`}]},{label:`Leave it`,sub:``,ops:[]}]},ruinedCamp:{name:`Ruined Camp`,glyph:`⛺`,hue:35,text:`A campfire, still smoldering. Bedrolls, torn. Whoever slept here left in a hurry — and left their packs behind.`,choices:[{label:`Rest`,sub:`Heal 15% of your Max HP.`,ops:[{heal:.15}]},{label:`Scavenge`,sub:`Gain 45 gold and a random potion.`,ops:[{gold:45},{potion:`random`}]}]}},ql=[{normal:[12,20],elite:[28,38],boss:[70,80]},{normal:[18,28],elite:[35,48],boss:[85,100]},{normal:[24,36],elite:[45,60],boss:[100,120]}],Jl={removeCost:75,cardPrice:{common:[45,55],uncommon:[68,82],rare:[135,160]},relicPrice:{common:[140,160],uncommon:[220,250],rare:[270,300]},potionPrice:[48,62]},Yl={ashfall:{name:`Ashfall`,glyph:`☁`,tone:`#d3f2a1`,text:`Ash chokes every fire: enemies begin combat with 2 Smolder, but their blows leave 1 Smolder on you.`,mods:{enemyStartStatus:{poison:2},playerHitApplies:{poison:1}}},heavyAir:{name:`Heavy Air`,glyph:`☗`,tone:`#8fd0ff`,text:`The air holds light like water: all Ward gained is increased by a quarter — yours and theirs.`,mods:{wardMult:1.25}},thinGlass:{name:`Thin Glass`,glyph:`◬`,tone:`#dfeaff`,text:`Tonight all glass runs thin: every facet gauge is 1 smaller, but enemy blows strike 2 harder.`,mods:{facetDelta:-1,enemyDmgBonus:2}},hungryDark:{name:`The Hungry Dark`,glyph:`☾`,tone:`#c99aff`,text:`The dark eats coin but sharpens choice: shop prices are a quarter higher, and card rewards offer 1 more choice.`,mods:{shopMult:1.25,rewardChoiceBonus:1}},emberWind:{name:`Ember Wind`,glyph:`✦`,tone:`#ff9a4d`,text:`Sparks ride the wind into your lantern: begin each combat with 2 Embers, but draw 4 cards instead of 5.`,mods:{startEmbers:2,drawDelta:-1}},longNight:{name:`The Long Night`,glyph:`★`,tone:`#b18cff`,text:`The climb stretches on: enemies carry 12% more life, but every victory pays 40% more gold.`,mods:{hpMult:1.12,goldMult:1.4}},waningMoon:{name:`Waning Moon`,glyph:`◐`,tone:`#ffe9ac`,text:`The moon spends her last light on you: your first card each turn costs 1 less, but rest sites heal only 20%.`,mods:{firstCardDiscount:1,restHealFrac:.2}}},Xl={vitrified:{name:`Vitrified`,tone:`#8fd0ff`,text:`Thicker glass: +2 facets and +15% HP.`,mods:{facetDelta:2,hpMult:1.15}},cinderVeined:{name:`Cinder-Veined`,tone:`#ff9a4d`,text:`Its blows leave 1 Smolder on you.`,mods:{attackApplies:{poison:1}}},adamant:{name:`Adamant`,tone:`#d8c27a`,text:`The first time its glass would shatter, it holds.`,mods:{adamant:!0}},emberFat:{name:`Ember-Fat`,tone:`#ffe9ac`,text:`Slaying it pays double gold.`,mods:{goldMult:2}},veiled:{name:`Veiled`,tone:`#9aa7b8`,text:`Begins the fight behind 15 Ward.`,mods:{startBlock:15}},fervent:{name:`Fervent`,tone:`#ff8d8d`,text:`Begins the fight with 2 Fervor.`,mods:{startStatus:{str:2}}}},Zl={flare:{name:`Flare`,glyph:`✹`,tone:`#ff9a4d`,cost:3,text:`The lantern vents. Deal 7 damage to ALL enemies and apply 2 Smolder.`,effects:[{kind:`dmg`,n:7},{kind:`status`,who:`allEnemies`,id:`poison`,n:2}]},mendglass:{name:`Mendglass`,glyph:`❋`,tone:`#8fe8a0`,cost:4,text:`Warm light knits the cracks. Heal 8 HP.`,effects:[{kind:`heal`,n:8}]},beacon:{name:`Beacon`,glyph:`☀`,tone:`#ffe9ac`,cost:2,text:`Raise the light. Your attacks chip 1 extra facet this turn.`,effects:[{kind:`status`,who:`self`,id:`beacon`,n:1}]},emberveil:{name:`Emberveil`,glyph:`⛨`,tone:`#8fd0ff`,cost:3,text:`A curtain of held fire. Gain 12 Ward.`,effects:[{kind:`block`,n:12}]},stoke:{name:`Stoke`,glyph:`✦`,tone:`#c99aff`,cost:4,text:`Feed the flame to the hand that carries it. Gain 1 Energy and draw 2 cards.`,effects:[{kind:`energy`,n:1},{kind:`draw`,n:2}]},ashfall:{name:`Ashfall`,glyph:`☁`,tone:`#d3f2a1`,cost:3,text:`The Ashwarden's breath. Apply 3 Smolder to ALL enemies and gain 5 Ward.`,effects:[{kind:`status`,who:`allEnemies`,id:`poison`,n:3},{kind:`block`,n:5}]}},Ql={paneBreaker:{name:`Breaker of Panes`,desc:`Shatter 15 facets`,stat:`shatters`,n:15,unlocks:[`card:quakeblow`,`card:resonantLance`]},lanternFed:{name:`The Lantern Fed`,desc:`Kindle 20 cards by hand`,stat:`kindles`,n:20,unlocks:[`card:tithe`,`card:pyreheart`]},ashSermon:{name:`Sermon of Ash`,desc:`Let Smolder claim 10 lives`,stat:`smolderKills`,n:10,unlocks:[`card:ashenChoir`,`relic:smolderingCoal`]},untouched:{name:`The Glass Untouched`,desc:`Win 3 fights without a scratch`,stat:`perfects`,n:3,unlocks:[`card:flawlessForm`,`relic:prismCharm`]},darkWalker:{name:`Walker of Unlit Ways`,desc:`Enter 6 unlit lanterns`,stat:`unlitVisited`,n:6,unlocks:[`card:nightSight`,`relic:thiefOfWicks`]},spendthrift:{name:`Fire Given Freely`,desc:`Spend 30 embers on Lantern Arts`,stat:`embersSpent`,n:30,unlocks:[`card:novaflare`,`card:emberdance`]},hundredShards:{name:`A Hundred Shards`,desc:`Slay 100 creatures`,stat:`slain`,n:100,unlocks:[`card:shardstorm`,`relic:bellOfEndings`]},firstDawn:{name:`The First Dawn`,desc:`Reach the sunrise once`,stat:`wins`,n:1,unlocks:[`aspect2`]}},$l=[Il,{id:`ashwarden`,name:`The Ashwarden`,blurb:`Smoke given a shape. Lets the Smolder do the killing and kindles its own hand to feed the lantern. Slower, but it endures — and everything it touches burns.`,hue:26,art:`ashfall`,unlock:`aspect2`,maxHp:80,energy:3,handSize:5,potionSlots:3,startDeck:[`ashBite`,`ashBite`,`ashBite`,`ashBite`,`defend`,`defend`,`defend`,`smother`,`smother`,`firstSpark`],startRelic:`ashenCore`,startGold:99}],eu=[{name:`Vow of Iron`,desc:`Every creature is harder to break — enemy HP +12%.`,mods:{hpMult:1.12}},{name:`Vow of Malice`,desc:`Their blows land heavier — enemy attacks deal +1.`,mods:{enemyDmgBonus:1}},{name:`Vow of the Deep`,desc:`Bosses armor their cores — boss Facets +1.`,mods:{bossFacetDelta:1}},{name:`Vow of the Mark`,desc:`You climb already cursed — begin every run with a Hex.`,mods:{startHex:!0}},{name:`Vow of the Waning`,desc:`The dark drinks your rest — campfires heal 20%, not 30%.`,mods:{restHealFrac:.2}}],tu={fullPurse:{name:`A Full Purse`,text:`Set out with 120 extra gold.`,ops:[{gold:120}]},temperedGlass:{name:`Tempered Glass`,text:`Raise your Max HP by 14.`,ops:[{maxHp:14}]},keenEye:{name:`A Keeper's Eye`,text:`Begin with a random relic.`,ops:[{addRelic:`random`}]},warmHearth:{name:`A Warm Hearth`,text:`Mend to full and gain 6 Max HP.`,ops:[{maxHp:6},{heal:1}]},emberFlask:{name:`Ember Flask`,text:`Pack a Fire Phial and a Draught of Vigor.`,ops:[{potion:`fire`},{potion:`healing`}]},twinPhials:{name:`Twin Phials`,text:`Pack a Swift Phial and an Energy Phial.`,ops:[{potion:`swift`},{potion:`energy`}]},pilgrimsCache:{name:`Pilgrim's Cache`,text:`Gain 60 gold and a Ward Phial.`,ops:[{gold:60},{potion:`block`}]},venomPouch:{name:`A Pouch of Ash`,text:`Gain 40 gold and a Venom Phial.`,ops:[{gold:40},{potion:`venom`}]}},nu,ru,iu,au,ou,su,cu,lu=[],uu,du,fu,pu,mu,hu,gu,_u=[],vu,yu=0,bu=.5,xu=0,Su,Cu,wu=[],Tu=matchMedia(`(prefers-reduced-motion: reduce)`).matches,Eu={sky:new U(724506),fog:new U(1317422),particles:new U(16752717),glow:new U(6750110)},Du={sky:Eu.sky.clone(),fog:Eu.fog.clone(),particles:Eu.particles.clone(),glow:Eu.glow.clone()},Ou={x:0,y:0},ku=0,Au=1,ju={x:7,z:-20,bottom:-16,top:54,baseY:-6,rowH:1.06,actGap:4.2,azBase:Math.atan2(30,-7),colSpread:.34},Mu=15,Nu=e=>ju.baseY+e*((Mu-1)*ju.rowH+ju.actGap);function Pu(e){let t=jt.clamp((e-ju.bottom)/(ju.top-ju.bottom),0,1),n=1+Math.sin(t*21)*.07+Math.sin(t*57)*.05+Math.sin(t*9+1.7)*.06;return(1-t)**1.15*6.2*n+.85}function Fu(e,t){let n=Nu(e)+t.row*ju.rowH+t.jy*.5,r=ju.azBase+(t.col-3+t.jx)*ju.colSpread,i=Math.max(Pu(n)+.5,3.6);return new B(ju.x+Math.cos(r)*i,n,ju.z+Math.sin(r)*i)}var Iu=`ambient`,Lu=Nu(0),Ru=Nu(0),zu=0,Bu=0,Vu=0,Hu=new B(0,Nu(0),-6),Uu=new B,Wu=new B,Gu=new B,Ku=new U(16777215),qu=new U,Ju=new U(12571903);function Yu(e,t){Ru=Nu(e)+Math.max(0,t)*ju.rowH}function Xu(e,t){Iu=`map`,zu=e,Bu=Math.max(0,t),Vu=0}function Zu(){Iu=`ambient`}function Qu(e){Vu=jt.clamp(Vu+e,-Bu-1,15.5-Bu)}var $u=null,ed=null;function td(e,t){$u=e,ed=t}function nd(){$u=null,ed=null}function rd(e){let t=document.createElement(`canvas`);t.width=t.height=128;let n=t.getContext(`2d`),r=n.createRadialGradient(64,64,0,64,64,64);for(let[t,n]of e)r.addColorStop(t,n);return n.fillStyle=r,n.fillRect(0,0,128,128),new Bi(t)}function id(e,t,n,r,i,a){let o=new Mr,s=new Float32Array(e*3),c=new Float32Array(e);for(let t=0;t<e;t++)s[t*3]=(Math.random()-.5)*n,s[t*3+1]=(Math.random()-.5)*r,s[t*3+2]=-Math.random()*i,c[t]=Math.random()*Math.PI*2;return o.setAttribute(`position`,new _r(s,3)),o.userData.seeds=c,new Li(o,new Mi({size:t,map:rd([[0,`rgba(255,255,255,1)`],[.35,`rgba(255,255,255,.6)`],[1,`rgba(255,255,255,0)`]]),transparent:!0,opacity:a,depthWrite:!1,blending:2,sizeAttenuation:!0}))}var ad=new URLSearchParams(location.search).get(`input`)===`touch`||matchMedia(`(pointer: coarse)`).matches;function od(){nu=new xl({canvas:document.getElementById(`bg3d`),antialias:!ad,alpha:!1}),nu.setPixelRatio(Math.min(devicePixelRatio,ad?1.35:1.75)),ru=new Rn,ru.fog=new Ln(Eu.fog.getHex(),.055),iu=new La(58,1,.1,120),iu.position.set(0,Lu,10),su=id(ad?480:900,.16,46,26,40,.75),cu=id(ad?130:240,.32,46,26,34,.5),ru.add(su,cu),uu=new kn,ru.add(uu);let e=rd([[0,`rgba(255,255,255,.75)`],[.4,`rgba(255,255,255,.25)`],[1,`rgba(255,255,255,0)`]]);for(let t=0;t<(ad?5:7);t++){let t=new Qr(new Rr({map:e,transparent:!0,opacity:.1+Math.random()*.1,depthWrite:!1,blending:2})),n=14+Math.random()*22;t.scale.set(n,n*.7,1),t.position.set((Math.random()-.5)*40,(Math.random()-.5)*18-3,-12-Math.random()*22),t.userData.wob=Math.random()*Math.PI*2,uu.add(t),lu.push(t)}let t=[];for(let e=0;e<=56;e++){let n=e/56,r=ju.bottom+n*(ju.top-ju.bottom);t.push(new z(Pu(r),r))}du=new ci({color:263435,fog:!1});let n=new bi(new Ji(t,9),du);n.position.set(ju.x,0,ju.z),n.rotation.y=.35,ru.add(n);let r=new bi(new Ji(t.map(e=>new z(e.x*.5,e.y*.5-10)),6),du);r.position.set(-15,0,-30),ru.add(r);{let e=ad?70:120;mu=new Rr({map:rd([[0,`rgba(255,255,255,.95)`],[.4,`rgba(255,255,255,.35)`],[1,`rgba(255,255,255,0)`]]),transparent:!0,opacity:.55,depthWrite:!1,blending:2});for(let t=0;t<e;t++){let e=ju.bottom+6+Math.random()*(ju.top-ju.bottom-10),t=ju.azBase+(Math.random()-.5)*2.4,n=Pu(e)+.12,r=new Qr(mu),i=.16+Math.random()*.26;r.scale.set(i,i,1),r.position.set(ju.x+Math.cos(t)*n,e,ju.z+Math.sin(t)*n),ru.add(r)}}fu=new bi(new Xi(.32,12,12),new ci({color:16777215,fog:!1})),fu.position.set(ju.x,ju.top+.9,ju.z),ru.add(fu),pu=new Qr(new Rr({map:rd([[0,`rgba(255,255,255,.9)`],[.3,`rgba(255,255,255,.3)`],[1,`rgba(255,255,255,0)`]]),transparent:!0,opacity:.8,depthWrite:!1,blending:2,fog:!1})),pu.scale.set(4,4,1),pu.position.copy(fu.position),ru.add(pu),gu=new ci({color:329485});let i=new bi(new Gi(70,24),gu);i.rotation.x=-Math.PI/2,i.position.y=-9.6,ru.add(i),hu=new ci({color:395792});let a=new qi(1,1,6);for(let e=0;e<(ad?32:52);e++){let e=new bi(a,hu),t,n,r;do t=Math.random()*Math.PI*2,n=7+Math.random()*28,r=Math.sin(t)*n-8;while(r>4);let i=2+Math.random()*3.4;e.scale.set(.5+Math.random()*.9,i,.5+Math.random()*.9),e.position.set(Math.cos(t)*n,-9.6+i/2,r),ru.add(e)}{let e=rd([[0,`rgba(255,255,255,.55)`],[.5,`rgba(255,255,255,.22)`],[1,`rgba(255,255,255,0)`]]);for(let t of[Nu(1)-2.2,Nu(2)-2.2]){let n=new Rr({map:e,transparent:!0,opacity:.34,depthWrite:!1});_u.push(n);for(let e=0;e<(ad?10:16);e++){let e=new Qr(n),r=10+Math.random()*14;e.scale.set(r,r*.32,1);let i,a,o;do i=Math.random()*Math.PI*2,a=5+Math.random()*22,o=ju.z+Math.sin(i)*a;while(o>-7);e.position.set(ju.x+Math.cos(i)*a,t+(Math.random()-.5)*1.6,o),e.userData.wob=Math.random()*Math.PI*2,e.userData.cloud=!0,ru.add(e),lu.push(e)}}}vu=id(ad?170:300,.13,44,26,34,.5),ru.add(vu),Su=new kn,Su.position.y=Lu,Cu=new ci({color:131848,transparent:!0,opacity:.96,fog:!1});let o=(e,t,n,r,i)=>{let a=new bi(e,Cu);return a.position.set(t,n,r),a.rotation.z=i,Su.add(a),a},s=new qi(.55,7.5,5);o(s,-4.5,-3.1,5.3,.42),o(s,-5.3,-2.6,4.5,.78),o(s,4.7,-3.3,5.1,-.4),o(s,5.5,-2.4,4.3,-.82);let c=new Ki(.032,.032,8,5);wu=[o(c,-4.1,5.9,5.7,.05),o(c,4.7,6.1,5.5,-.07)],ru.add(Su),au=new Al(nu),au.addPass(new jl(ru,iu)),ou=new Nl(new z(innerWidth,innerHeight),.85,.55,.16),au.addPass(ou),au.addPass(new Fl);let l=()=>{nu.setSize(innerWidth,innerHeight),au.setSize(innerWidth,innerHeight),ad&&ou.setSize(innerWidth/2,innerHeight/2),iu.aspect=innerWidth/innerHeight,iu.updateProjectionMatrix()};l(),addEventListener(`resize`,l),addEventListener(`pointermove`,e=>{Ou.x=(e.clientX/innerWidth-.5)*2,Ou.y=(e.clientY/innerHeight-.5)*2}),cd(0,!0),requestAnimationFrame(fd)}var sd=.85;function cd(e,t=!1){let n=Ll[Math.min(e,Ll.length-1)].theme;if(Du.sky.setHex(n.sky),Du.fog.setHex(n.fog),Du.particles.setHex(n.particles),Du.glow.setHex(n.glow),sd=.85,yu=Math.min(e,2),bu=[.5,.42,.62][yu],t)for(let e of Object.keys(Eu))Eu[e].copy(Du[e])}function ld(){Du.sky.setHex(5911634),Du.fog.setHex(9062997),Du.particles.setHex(16767392),Du.glow.setHex(16761976),sd=1.2,bu=.12}function ud(e=1){ku=Math.min(2.2,ku+e),Au=Math.min(7,Au+e*2.4)}var dd=0;function fd(e){requestAnimationFrame(fd);let t=Math.min(.05,(e-dd)/1e3||.016);dd=e;let n=e/1e3;for(let e of Object.keys(Eu))Eu[e].lerp(Du[e],Math.min(1,t*1.4));yu===2&&!Tu&&Math.random()<t/11&&(xu=.7+Math.random()*.5),xu*=.008**t,ru.background=qu.copy(Eu.sky).lerp(Ju,Math.min(.6,xu*.5)),ru.fog.color.copy(Eu.fog).lerp(Ju,Math.min(.4,xu*.3)),su.material.color.copy(Eu.particles),cu.material.color.copy(Eu.glow);for(let e of lu)e.userData.cloud||e.material.color.copy(Eu.fog).lerp(Eu.particles,.5),e.position.x+=Math.sin(n*.08+e.userData.wob)*.004;du.color.copy(Eu.sky).multiplyScalar(.42),gu.color.copy(Eu.sky).multiplyScalar(.3),hu.color.copy(Eu.sky).multiplyScalar(.38),mu.color.copy(Eu.glow);for(let e of _u)e.color.copy(Eu.fog).lerp(Ku,.42);fu.material.color.copy(Eu.glow),pu.material.color.copy(Eu.glow);let r=.65+Math.sin(n*1.7)*.25;pu.material.opacity=r,pu.scale.setScalar(3.2+r*1.6),cu.material.opacity=.42+Math.sin(n*.9)*.12,Au+=(1-Au)*Math.min(1,t*2.5);let i=iu.position.y;for(let[e,r]of[[su,1],[cu,.55]]){let a=e.geometry.attributes.position,o=e.geometry.userData.seeds;for(let e=0;e<a.count;e++){let s=a.getY(e)+t*r*Au*(.35+o[e]%1*.5),c=a.getX(e)+Math.sin(n*.5+o[e])*t*.18;s>i+14&&(s=i-14,c=(Math.random()-.5)*46),s<i-15&&(s=i-14),a.setY(e,s),a.setX(e,c)}a.needsUpdate=!0}ku*=.02**t;{vu.material.opacity+=(bu-vu.material.opacity)*Math.min(1,t*1.2),yu===0?vu.material.color.copy(Eu.particles).lerp(Ku,.55):yu===1?vu.material.color.copy(Eu.glow).lerp(Ku,.25):vu.material.color.copy(Eu.particles);let e=vu.geometry.attributes.position,r=vu.geometry.userData.seeds;for(let a=0;a<e.count;a++){let o=e.getX(a),s=e.getY(a),c=r[a]%1;yu===0?(s-=t*(.45+c*.55),o+=Math.sin(n*.7+r[a])*t*.5):yu===1?(s-=t*(.14+c*.2),o+=Math.sin(n*.35+r[a])*t*.9):(o-=t*(3.4+c*2.8),s-=t*(.5+c*.5)),s<i-14&&(s+=28),s>i+14&&(s-=28),o<-23&&(o+=46),o>23&&(o-=46),e.setX(a,o),e.setY(a,s)}e.needsUpdate=!0}Lu+=(Ru-Lu)*Math.min(1,t*1.6),uu.position.y=i*.93+Math.sin(n*.3)*.2;let a=Math.max(1,1.05/iu.aspect);if(Iu===`map`){let e=jt.clamp(Bu+1.6+Vu,1.2,15.4),t=Nu(zu)+e*ju.rowH,n=(Math.max(Pu(t),3.1)+8.2)*a-ku*.4,r=ju.azBase+Ou.x*.06;Uu.set(ju.x+Math.cos(r)*n,t+1.1-Ou.y*.5,ju.z+Math.sin(r)*n),Wu.set(ju.x,t+1.9,ju.z)}else Uu.set(Ou.x*.9,Lu-Ou.y*.55+Math.sin(n*.22)*.25,10+Math.sin(n*.1)*.3-ku*.9),Wu.set(0,Lu,-6);if(Su.position.y+=(i-Su.position.y)*Math.min(1,t*2.2),Cu.opacity+=((Iu===`map`?0:.96)-Cu.opacity)*Math.min(1,t*3),wu[0].rotation.z=.05+Math.sin(n*.5)*.028,wu[1].rotation.z=-.07+Math.sin(n*.42+2)*.024,iu.position.lerp(Uu,Math.min(1,t*2.2)),Hu.lerp(Wu,Math.min(1,t*2.2)),iu.lookAt(Hu),iu.rotation.z+=Math.sin(n*.13)*.012+ku*(Math.random()-.5)*.012,ed&&$u){let e=[];for(let t of $u){Gu.copy(t.pos).project(iu);let n=iu.position.distanceTo(t.pos);e.push({id:t.id,x:(Gu.x*.5+.5)*innerWidth,y:(-Gu.y*.5+.5)*innerHeight,s:jt.clamp(9*a/n,.4,1.3),fade:Gu.z>1?0:jt.clamp(1.3-Math.abs(t.pos.y-Hu.y)/(7.5*a),.1,1)})}ed(e)}ou.strength=sd+ku*.55+xu*.45,au.render()}var pd=matchMedia(`(prefers-reduced-motion: reduce)`).matches,md,hd,gd,_d,vd=[],yd=[],bd=0,xd=0,Sd=0,Cd=0,wd=()=>Math.min(devicePixelRatio,2),Td=matchMedia(`(pointer: coarse)`).matches,Ed=e=>Td?Math.max(3,Math.round(e*.6)):e;function Dd(){md=document.getElementById(`vfx`),hd=md.getContext(`2d`),gd=document.getElementById(`floaties`),_d=document.getElementById(`shake`);let e=()=>{md.width=innerWidth*wd(),md.height=innerHeight*wd()};e(),addEventListener(`resize`,e),requestAnimationFrame(kd)}var Od=0;function kd(e){requestAnimationFrame(kd);let t=Math.min(.05,(e-Od)/1e3||.016);if(Od=e,e<Cd)return;let n=wd();hd.clearRect(0,0,md.width,md.height),hd.save(),hd.scale(n,n),vd=vd.filter(e=>(e.life-=t)>0);for(let e of vd){e.x+=e.vx*t,e.y+=e.vy*t,e.vy+=(e.grav||0)*t,e.vx*=1-(e.drag||0)*t,e.vy*=1-(e.drag||0)*t;let n=Math.min(1,e.life/(e.fade||.3));if(hd.globalAlpha=n*(e.alpha??1),hd.globalCompositeOperation=e.add?`lighter`:`source-over`,e.kind===`spark`){let t=Math.hypot(e.vx,e.vy)*.045+2,r=Math.atan2(e.vy,e.vx);hd.strokeStyle=e.color,hd.lineWidth=e.size*n,hd.beginPath(),hd.moveTo(e.x,e.y),hd.lineTo(e.x-Math.cos(r)*t,e.y-Math.sin(r)*t),hd.stroke()}else if(e.kind===`ring`)e.r+=e.vr*t,hd.strokeStyle=e.color,hd.lineWidth=Math.max(.5,e.size*n),hd.beginPath(),hd.arc(e.x,e.y,e.r,0,Math.PI*2),hd.stroke();else if(e.kind===`slash`){e.prog=Math.min(1,(e.prog||0)+t/e.dur);let r=e.arc*e.prog;hd.strokeStyle=e.color,hd.lineCap=`round`;for(let t=0;t<3;t++)hd.globalAlpha=n*(.9-t*.3),hd.lineWidth=(e.size-t*3)*(1-e.prog*.6),hd.beginPath(),hd.arc(e.x,e.y,e.r+t*7,e.a0,e.a0+r),hd.stroke()}else hd.fillStyle=e.color,hd.beginPath(),hd.arc(e.x,e.y,e.size*n,0,Math.PI*2),hd.fill()}hd.globalCompositeOperation=`source-over`,hd.globalAlpha=1,yd=yd.filter(e=>(e.life-=t)>0);for(let e of yd)hd.globalAlpha=e.life/e.dur*e.alpha,hd.fillStyle=e.color,hd.fillRect(0,0,innerWidth,innerHeight);hd.restore(),bd>.1||Math.abs(xd)>.1?(xd=(Math.random()-.5)*bd,Sd=(Math.random()-.5)*bd,bd*=.001**t,_d.style.transform=`translate(${xd.toFixed(1)}px,${Sd.toFixed(1)}px)`):_d.style.transform&&(_d.style.transform=``,bd=0)}function Ad(e=8){pd||(bd=Math.max(bd,e))}function jd(e=60){pd||(Cd=performance.now()+e)}function Md(e=`#fff`,t=.18,n=.25){pd||yd.push({color:e,alpha:t,dur:n,life:n})}function Nd(e,t,{color:n=`#ffd166`,n:r=18,speed:i=260,spread:a=Math.PI*2,angle:o=0,size:s=3,grav:c=300,kind:l=`spark`,add:u=!0,life:d=.5}={}){if(!pd)for(let f=0;f<r;f++){let r=o+(Math.random()-.5)*a,f=i*(.35+Math.random()*.75);vd.push({kind:l,x:e,y:t,vx:Math.cos(r)*f,vy:Math.sin(r)*f,size:s*(.6+Math.random()*.8),color:n,grav:c,drag:1.6,life:d*(.6+Math.random()*.8),fade:.25,add:u})}}function Pd(e,t,n,r=8,i=420,a=4){pd||vd.push({kind:`ring`,x:e,y:t,r,vr:i,size:a,color:n,life:.45,fade:.45,add:!0})}function Fd(e,t,n=`#fff`){if(pd)return;let r=-Math.PI*.85+(Math.random()-.5)*.6;vd.push({kind:`slash`,x:e,y:t,r:46+Math.random()*18,a0:r,arc:Math.PI*.8,prog:0,dur:.14,size:13,color:n,life:.3,fade:.18,add:!0})}function Id(e,t,n,r=10){if(!pd)for(let i=0;i<r;i++)vd.push({kind:`dot`,x:e+(Math.random()-.5)*60,y:t+(Math.random()-.5)*40,vx:(Math.random()-.5)*30,vy:-40-Math.random()*60,size:2.5+Math.random()*2.5,color:n,grav:-20,life:.9+Math.random()*.5,fade:.5,add:!0,alpha:.9})}function Ld(e,t,n,r=``){let i=document.createElement(`div`);i.className=`floaty ${r}`,i.innerHTML=n,i.style.left=`${e}px`,i.style.top=`${t}px`,gd.appendChild(i);let a=(Math.random()-.5)*40,o=r.includes(`crit`),s=o?(Math.random()-.5)*16:r.includes(`dmg`)?(Math.random()-.5)*8:0,c,l=1100;o?(l=1250,c=[{transform:`translate(-50%,-50%) scale(0.5)`,opacity:0,filter:`brightness(3)`},{transform:`translate(-50%,-92%) scale(1.45) rotate(${s}deg)`,opacity:1,filter:`brightness(1.9)`,offset:.13},{transform:`translate(-50%,-110%) scale(1.05) rotate(${s}deg)`,opacity:1,filter:`brightness(1)`,offset:.34},{transform:`translate(calc(-50% + ${a}px),-230%) scale(0.98) rotate(${s}deg)`,opacity:0,filter:`brightness(1)`}]):c=r.includes(`poisonf`)?[{transform:`translate(-50%,-50%) scale(0.7)`,opacity:0},{transform:`translate(-50%,-26%) scale(1.05)`,opacity:1,offset:.2},{transform:`translate(calc(-50% + ${a*.4}px),80%) scale(0.88)`,opacity:0}]:[{transform:`translate(-50%,-50%) scale(0.6)`,opacity:0},{transform:`translate(-50%,-90%) scale(1.15) rotate(${s}deg)`,opacity:1,offset:.18},{transform:`translate(calc(-50% + ${a}px),-230%) scale(0.95) rotate(${s}deg)`,opacity:0}],i.animate(c,{duration:l,easing:`cubic-bezier(.2,.7,.3,1)`}).onfinish=()=>i.remove()}function Rd(e){let t=e.querySelector(`svg`)||e.querySelector(`img.raster-art`),n=e.getBoundingClientRect();if(!t||!n.width)return;if(pd){e.style.visibility=`hidden`;return}let r=t.tagName===`svg`?t.outerHTML:`<img src="${t.src}" alt="" style="width:100%;height:100%;object-fit:contain;display:block">`,i=50+(Math.random()-.5)*14,a=52+(Math.random()-.5)*14,o=[];for(let e=0;e<11;e++){let t=e/11*Math.PI*2+(Math.random()-.5)*.34,n=78+Math.random()*22;o.push([i+Math.cos(t)*n,a+Math.sin(t)*n,t])}for(let e=0;e<11;e++){let[t,s]=o[e],[c,l]=o[(e+1)%11],u=document.createElement(`div`);u.style.cssText=`position:fixed;left:${n.left}px;top:${n.top}px;width:${n.width}px;height:${n.height}px;pointer-events:none;z-index:57;clip-path:polygon(${i}% ${a}%,${t.toFixed(1)}% ${s.toFixed(1)}%,${c.toFixed(1)}% ${l.toFixed(1)}%);`,u.innerHTML=r,gd.appendChild(u);let d=o[e][2]+Math.PI/11,f=55+Math.random()*120,p=Math.cos(d)*f,m=Math.sin(d)*f*.7,h=(Math.random()-.5)*110;u.animate([{transform:`translate(0,0) rotate(0deg)`,opacity:1},{transform:`translate(${(p*.55).toFixed(0)}px,${(m*.55-16).toFixed(0)}px) rotate(${(h*.5).toFixed(0)}deg)`,opacity:.95,offset:.4},{transform:`translate(${p.toFixed(0)}px,${(m+110).toFixed(0)}px) rotate(${h.toFixed(0)}deg)`,opacity:0}],{duration:780+Math.random()*300,easing:`cubic-bezier(.3,.3,.6,1)`}).onfinish=()=>u.remove()}e.style.visibility=`hidden`}var zd=e=>{let t=e.getBoundingClientRect();return{x:t.left+t.width/2,y:t.top+t.height/2}},Bd={slash:`#ffffff`,pierce:`#cfe6ff`,blunt:`#ffd8a0`,fire:`#ff9a4d`,poison:`#d3a15a`,void:`#c99aff`,ward:`#9fd4ff`};function Vd(e,t,n,r,i=`#ff9a4d`){if(pd)return;let a=Ed(14);for(let o=0;o<a;o++){let s=o/a,c=(Math.random()-.5)*26,l=(Math.random()-.5)*26;vd.push({kind:`dot`,x:e+(n-e)*s+c,y:t+(r-t)*s+l,vx:(Math.random()-.5)*40,vy:-30-Math.random()*50,size:2+Math.random()*2.4,color:i,grav:-30,life:.5+s*.4,fade:.3,add:!0,alpha:.9})}}function Hd(e,t,n=`#d3a15a`,r=12){if(!pd)for(let i=0;i<Ed(r);i++)vd.push({kind:`dot`,x:e+(Math.random()-.5)*54,y:t-10+(Math.random()-.5)*30,vx:(Math.random()-.5)*26,vy:60+Math.random()*120,size:2+Math.random()*2,color:n,grav:420,drag:.4,life:.6+Math.random()*.3,fade:.35,add:!0})}function Ud(e,t,n=`#c99aff`){if(!pd){vd.push({kind:`ring`,x:e,y:t,r:64,vr:-160,size:3.5,color:n,life:.4,fade:.4,add:!0});for(let r=0;r<Ed(16);r++){let r=Math.random()*Math.PI*2,i=46+Math.random()*30;vd.push({kind:`spark`,x:e+Math.cos(r)*i,y:t+Math.sin(r)*i,vx:-Math.cos(r)*(220+Math.random()*120),vy:-Math.sin(r)*(220+Math.random()*120),size:2.2,color:n,grav:0,drag:2.4,life:.34,fade:.2,add:!0})}}}function Wd(e,t,n=`#dfeaff`,r=12){if(!pd)for(let i=0;i<Ed(r);i++){let r=-Math.PI/2+(Math.random()-.5)*1.8;vd.push({kind:`spark`,x:e,y:t,vx:Math.cos(r)*(200+Math.random()*260),vy:Math.sin(r)*(200+Math.random()*260),size:2.6+Math.random()*1.6,color:n,grav:520,drag:.6,life:.5+Math.random()*.3,fade:.22,add:!0})}}function Gd(e,t,n=`slash`,r=.3){if(pd)return;let i=Bd[n]||`#ffffff`,a=r>.55;switch(n){case`slash`:Fd(e,t,a?`#ffd8a0`:`#ffffff`),Nd(e,t,{color:`#ff9a6a`,n:Ed(a?26:12),speed:a?420:260});break;case`pierce`:{let n=-Math.PI*.78;for(let r=0;r<(a?3:2);r++)vd.push({kind:`spark`,x:e-Math.cos(n)*70,y:t-Math.sin(n)*70,vx:Math.cos(n)*900,vy:Math.sin(n)*900,size:3.4,color:i,grav:0,drag:0,life:.16+r*.03,fade:.1,add:!0});Nd(e,t,{color:i,n:Ed(a?18:9),speed:300,spread:1.4,angle:n+Math.PI});break}case`blunt`:Pd(e,t,i,6,a?720:520,6),Nd(e,t+6,{color:`#e8d8b8`,n:Ed(a?24:12),speed:a?380:240,spread:Math.PI,angle:-Math.PI/2,grav:620,kind:`dot`}),Ad(a?14:8);break;case`fire`:Nd(e,t,{color:`#ffd166`,n:Ed(a?22:12),speed:240,grav:-120,life:.7}),Nd(e,t,{color:`#ff6a3a`,n:Ed(a?14:8),speed:160,grav:-60,size:3.6,kind:`dot`,life:.8});break;case`poison`:Hd(e,t,`#d3a15a`,a?18:10),Id(e,t,`#b8b0a0`,Ed(8));break;case`void`:Ud(e,t,i),a&&Md(`#c99aff`,.08,.25);break;case`ward`:Pd(e,t,i,12,460,4),Id(e,t,i,Ed(8));break}}var Kd=()=>{!pd&&!Td&&(Md(`#ffffff`,.28,.09),jd(90))},qd={annihilate:(e,t)=>{Kd(),Md(`#ff6a3a`,.16,.5);for(let n of[-140,0,140])Nd(e+n,t,{color:`#ffd166`,n:Ed(18),speed:300,grav:-100,life:.8});Ad(16)},oblivionStrike:(e,t)=>{Kd(),jd(140),Pd(e,t,`#ffd8a0`,8,900,7),Pd(e,t,`#ffffff`,4,1200,4),Wd(e,t,`#dfeaff`,22),Ad(20)},tempest:(e,t)=>{for(let n=0;n<3;n++)setTimeout(()=>Wd(e+(Math.random()-.5)*160,t-60,`#cfe6ff`,12),n*90)},executioner:(e,t)=>{Kd(),Fd(e,t,`#ffffff`),Pd(e,t,`#ff6b6b`,10,700,5),Ad(14)},novaflare:(e,t)=>{Kd(),Md(`#ffd166`,.2,.45),Pd(e,t,`#ffd166`,6,1e3,6),Nd(e,t,{color:`#fff3d6`,n:Ed(30),speed:520,grav:-40,life:.9})},shardstorm:(e,t)=>{for(let n=0;n<4;n++)setTimeout(()=>Wd(e+(Math.random()-.5)*200,t-40,`#dfeaff`,10),n*70)},ascension:(e,t)=>{Vd(e,t+120,e,t-120,`#ffd166`),Id(e,t-40,`#ffe9ac`,Ed(16))},limitBreak:(e,t)=>{Kd(),Pd(e,t,`#8fd0ff`,10,800,6),Wd(e,t,`#cfe6ff`,18),Ad(12)},phantomBlades:(e,t)=>{for(let n=0;n<4;n++)setTimeout(()=>Fd(e+(Math.random()-.5)*60,t+(Math.random()-.5)*40,`#c9b0ff`),n*70)},pyreheart:(e,t)=>{Nd(e,t,{color:`#ff5964`,n:Ed(14),speed:180,grav:-80,kind:`dot`,life:.9}),Id(e,t,`#ffd166`,Ed(10))},emberdance:(e,t)=>{for(let n=0;n<3;n++)setTimeout(()=>Vd(e-80+n*80,t+60,e+80-n*80,t-60,`#ff9a4d`),n*100)},devour:(e,t)=>{Ud(e,t,`#c99aff`),setTimeout(()=>Nd(e,t,{color:`#ff9a4d`,n:Ed(16),speed:260,grav:-120}),180)},"art:flare":(e,t)=>{Md(`#ff9a4d`,.18,.4),Nd(e,t,{color:`#ffd166`,n:Ed(26),speed:420,grav:-60}),Ad(10)},"art:mendglass":(e,t)=>{Pd(e,t,`#7ddb8f`,14,420,4),Id(e,t,`#d9fbe7`,Ed(14))},"art:beacon":(e,t)=>{Md(`#ffe9ac`,.14,.5),Vd(e,t+100,e,t-140,`#ffe9ac`)},"art:emberveil":(e,t)=>{Pd(e,t,`#9fd4ff`,10,520,5),Pd(e,t,`#ffd166`,20,380,3)},"art:stoke":(e,t)=>{Nd(e,t,{color:`#ff6a3a`,n:Ed(18),speed:220,grav:-140,life:.8})},"art:ashfall":(e,t)=>{for(let n=0;n<3;n++)setTimeout(()=>Hd(e+(Math.random()-.5)*220,t-80,`#b8b0a0`,12),n*120)}},Jd=24,Yd=36,Xd=.45,Zd=matchMedia(`(prefers-reduced-motion: reduce)`).matches,Qd=new URLSearchParams(location.search).get(`input`)===`touch`,$d=()=>{let e=new URLSearchParams(location.search);return e.get(`mesh`)===`0`?!1:e.get(`mesh`)===`1`?!0:!Zd&&!Qd},ef=(e,t,n)=>Math.exp(-((e-t)**2)/(2*n*n)),tf={wisp:{sway:.55,bob:1.85,breathe:.95,head:.4,cloth:0,pin:1.05,float:1.35},beast:{sway:1.15,bob:.85,breathe:.65,head:.55,cloth:.2,float:0},slime:{sway:.55,bob:.55,breathe:1.35,head:0,cloth:.55,pin:1.2,float:.25},rogue:{sway:1,bob:1,breathe:1,head:1,cloth:.8,float:0},plant:{sway:.7,bob:.75,breathe:.85,head:.25,cloth:1.15,pin:1.1,float:.55},cultist:{sway:.95,bob:.95,breathe:1,head:.85,cloth:.7,float:0},golem:{sway:.28,bob:.25,breathe:.35,head:.15,cloth:0,float:0},treeboss:{sway:.4,bob:.3,breathe:.5,head:.2,cloth:.6,float:0},zombie:{sway:.7,bob:.5,breathe:.6,head:.4,cloth:.3,float:0},serpent:{sway:.95,bob:.65,breathe:.45,head:.35,cloth:.15,float:.15},crawler:{sway:.9,bob:.6,breathe:.55,head:.45,cloth:.1,float:0},crab:{sway:.5,bob:.35,breathe:.4,head:.2,cloth:0,float:0},maw:{sway:.65,bob:.45,breathe:.7,head:.5,cloth:0,float:.1},knight:{sway:.85,bob:.7,breathe:.75,head:.7,cloth:.5,float:0},siren:{sway:1.05,bob:1.25,breathe:.8,head:.6,cloth:.9,pin:1.1,float:.85},leviathan:{sway:.35,bob:.25,breathe:.45,head:.3,cloth:.2,float:0},shade:{sway:.9,bob:1.05,breathe:.7,head:.5,cloth:.6,pin:1.1,float:.7},eye:{sway:.35,bob:1.45,breathe:1,head:0,cloth:0,pin:.95,float:1.2},sovereign:{sway:.45,bob:.35,breathe:.55,head:.45,cloth:.35,float:0},humanoid:{sway:1,bob:1,breathe:1,head:1,cloth:.85,float:0}},nf,rf,af,of=[],sf=0,cf=1,lf=1,uf=new Map,df=new ka;function ff(e,t){if(uf.has(e)){let n=uf.get(e);return n.image?.width&&t?.(n),n}let n=df.load(e,e=>{e.colorSpace=He,t?.(e)});return uf.set(e,n),n}function pf(e,t){if(e?.naturalWidth>0)return e.naturalWidth/e.naturalHeight;let n=t?.image;return n?.width>0?n.width/n.height:1}function mf(e,t,n){return!n||n<=0?{w:e,h:t}:n>=e/t?{w:e,h:e/n}:{w:t*n,h:t}}function hf(e,t,n,r){let i=new Yi(2,2,Jd,Yd),a={geo:i,base:i.attributes.position.array.slice(),profile:t,seed:n,el:null,aspect:pf(r,null)||2/3},o=ff(e,e=>{a.aspect=pf(r,e)}),s=new bi(i,new ci({map:o,transparent:!0,depthTest:!1}));return s.renderOrder=1,rf.add(s),a.mesh=s,r&&!r.complete&&r.addEventListener(`load`,()=>{a.aspect=pf(r,o)},{once:!0}),a}function gf(e,t){let n=e.geo.attributes.position,r=e.profile;for(let i=0;i<n.count;i++){let a=e.base[i*3],o=e.base[i*3+1],s=(o+1)/2,c=s**+(r.pin??1.6),l=0,u=0;l+=.028*c*r.sway*Math.sin(t*.9+e.seed),l+=.01*c*c*r.sway*Math.sin(t*1.7+1+e.seed*.3);let d=ef(s,.62,.12);l+=a*.02*d*r.breathe*Math.sin(t*2.2+e.seed*.5),u+=.012*d*r.breathe*Math.sin(t*2.2+e.seed*.5),u+=.014*c*r.bob*Math.sin(t*1.1+.4+e.seed),l+=.012*Math.max(0,(s-.8)/.2)*r.head*Math.sin(t*.7+e.seed),l+=.01*Math.max(0,(.45-s)/.45)*c*r.cloth*Math.sin(s*12-t*2.5+e.seed),n.array[i*3]=a+l*Xd,n.array[i*3+1]=o+u*Xd}n.needsUpdate=!0}function _f(e,t=0){let n=e.el.getBoundingClientRect();if(n.width<2||n.height<2){e.mesh.visible=!1;return}e.aspect=pf(e.el.querySelector(`.raster-art`),e.mesh.material.map)||e.aspect||1;let{w:r,h:i}=mf(n.width,n.height,e.aspect),a=(e.profile.float||0)*Math.sin(t*1.15+e.seed*.7)*12*Xd;e.mesh.visible=!0,e.mesh.position.set(n.left+n.width/2-cf/2,-(n.top+n.height/2-lf/2)+a,0),e.mesh.scale.set((e.flip?-1:1)*r/2,i/2,1)}function vf(){cf=innerWidth,lf=innerHeight,nf.setSize(cf,lf,!1),af.left=-cf/2,af.right=cf/2,af.top=lf/2,af.bottom=-lf/2,af.updateProjectionMatrix()}function yf(e){if(!of.length)return;let t=e*.001;for(let e of of)gf(e,t),_f(e,t);nf.render(rf,af)}function bf(){let e=document.getElementById(`mesh`);!e||nf||(nf=new xl({canvas:e,alpha:!0,antialias:!0,powerPreference:`high-performance`}),nf.setClearColor(0,0),nf.setPixelRatio(Math.min(devicePixelRatio,2)),rf=new Rn,af=new Ra(-1,1,1,-1,.1,100),af.position.z=10,vf(),addEventListener(`resize`,vf))}function xf(){cancelAnimationFrame(sf),sf=0;for(let e of of)e.el?.classList.remove(`mesh-live`),rf.remove(e.mesh),e.geo.dispose(),e.mesh.material.dispose();of=[],document.documentElement.classList.remove(`mesh-on`),nf?.render(rf,af)}function Sf(e){if(xf(),!$d()||(nf||bf(),!nf))return;for(let{el:t,url:n,kind:r,flip:i}of e){if(!n||!t)continue;let e=t.querySelector(`.raster-art`);if(!e)continue;t.classList.add(`mesh-live`);let a=tf[r]||tf.humanoid,o=hf(n,a,Math.random()*10,e);o.el=t,o.flip=!!i,o.profile=a,of.push(o)}if(!of.length)return;document.documentElement.classList.add(`mesh-on`);let t=e=>{sf=requestAnimationFrame(t),yf(e)};sf=requestAnimationFrame(t)}var Cf=()=>({enabled:$d(),planes:of.length,renderer:!!nf,looping:!!sf,intensity:Xd}),wf=t({MAP_COLS:()=>7,MAP_ROWS:()=>15,addCardToDeck:()=>Lp,addStatus:()=>ip,applyEventOps:()=>Jp,availableNodes:()=>Rf,canKindle:()=>mp,canPlay:()=>Tp,canUseArt:()=>dp,cardData:()=>Ff,cardPool:()=>Hf,claimMonument:()=>Bf,clamp:()=>Of,clearSave:()=>Gp,drawCards:()=>xp,duplicateCardInDeck:()=>Bp,effCost:()=>wp,endTurn:()=>Ap,enemyMove:()=>op,gainEmbers:()=>sp,gainPotion:()=>qf,gainRelic:()=>Gf,genCombatRewards:()=>Xf,genMap:()=>Lf,genShop:()=>Qf,hasRelic:()=>Vf,healPlayer:()=>Wf,kindleFromHand:()=>gp,loadRun:()=>Wp,loadStats:()=>Kp,makeCard:()=>Pf,makeRng:()=>Tf,newRun:()=>kf,omenMods:()=>Mf,playCard:()=>Ep,previewAttack:()=>Np,previewBlock:()=>Pp,previewEnemyDmg:()=>Fp,previewPlay:()=>Ip,randomRelic:()=>Kf,recordRunEnd:()=>qp,relicPool:()=>Uf,removeCardFromDeck:()=>Rp,restHealFrac:()=>Nf,rollBossRelics:()=>Zf,rollCardReward:()=>Jf,rollEncounter:()=>ep,rollEvent:()=>$f,rollEventCards:()=>Yf,rollOmen:()=>jf,runRng:()=>If,saveRun:()=>Up,startCombat:()=>tp,upgradeCardInDeck:()=>zp,useArt:()=>fp,usePotion:()=>kp,visitNode:()=>zf,vowMods:()=>Af});function Tf(e){let t=()=>{e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296};return t.getState=()=>e,t}var Ef=(e,t)=>t[Math.floor(e()*t.length)],Df=(e,[t,n])=>t+Math.floor(e()*(n-t+1)),Of=(e,t,n)=>Math.max(t,Math.min(n,e));function kf(e=Math.random()*2**31|0,t={}){let n=Of(t.aspect||0,0,$l.length-1),r=$l[n],i={v:2,seed:e,rngState:e,uid:1,act:0,nodeId:null,floorsClimbed:0,aspect:n,vow:Of(t.vow||0,0,eu.length),art:t.art||r.art||`flare`,omens:[],boon:t.boon||null,unlocks:[...t.unlocks||[]],monument:t.monument?{...t.monument,claimed:!1}:null,player:{hp:r.maxHp,maxHp:r.maxHp,gold:r.startGold,energyMax:r.energy,relics:[r.startRelic],potions:Array(r.potionSlots||3).fill(null),deck:[]},stats:{slain:0,elites:0,bosses:0,dmgDealt:0,dmgTaken:0,cardsPlayed:0,goldEarned:0,shatters:0,kindles:0,perfects:0,smolderKills:0,unlitVisited:0,embersSpent:0,start:Date.now()},map:null};t.lamplighter&&(i.pendingLamplighter=!0);for(let e of r.startDeck)i.player.deck.push(Pf(i,e));return Af(i).startHex&&i.player.deck.push(Pf(i,`hex`)),i.omens.push(jf(i)),i.map=Lf(i),i}function Af(e){let t={hpMult:1,enemyDmgBonus:0,bossFacetDelta:0,startHex:!1},n=Of(e.vow||0,0,eu.length);for(let e=0;e<n;e++){let n=eu[e].mods;n.hpMult&&(t.hpMult*=n.hpMult),n.enemyDmgBonus&&(t.enemyDmgBonus+=n.enemyDmgBonus),n.bossFacetDelta&&(t.bossFacetDelta+=n.bossFacetDelta),n.startHex&&(t.startHex=!0),n.restHealFrac!=null&&(t.restHealFrac=Math.min(t.restHealFrac??1,n.restHealFrac))}return t}function jf(e){return Ef(If(e),Object.keys(Yl))}function Mf(e){return Yl[e.omens?.[e.act]]?.mods||{}}function Nf(e){return Math.min(.3,Mf(e).restHealFrac??.3,Af(e).restHealFrac??.3)}function Pf(e,t,n=!1){return{uid:e.uid++,id:t,up:n,bonus:0}}function Ff(e){let t=Rl[e.id];return e.up&&t.up?{...t,...t.up,name:t.name+`+`}:t}function If(e){let t=Tf(e.rngState);return()=>{let n=t();return e.rngState=t.getState(),n}}function Lf(e){let t=If(e),n={},r=(e,t)=>`${e},${t}`,i=(e,i)=>(n[r(e,i)]||(n[r(e,i)]={id:r(e,i),row:e,col:i,type:`monster`,next:[],jx:(t()-.5)*.5,jy:(t()-.5)*.4}),n[r(e,i)]),a=new Set;for(let e=0;e<6;e++){let n;do n=Math.floor(t()*7);while(e<2&&a.has(n));a.add(n);let r=i(0,n);for(let e=1;e<14;e++){let n=Of(r.col+(Math.floor(t()*3)-1),0,6),a=i(e,n);r.next.includes(a.id)||r.next.push(a.id),r=a}let o=i(14,3);r.next.includes(o.id)||r.next.push(o.id)}let o=Object.values(n),s=!1;for(let e of o){if(e.row===0)e.type=`monster`;else if(e.row===14)e.type=`boss`;else if(e.row===13)e.type=`rest`;else if(e.row===8)e.type=`treasure`;else{let n=t();n<.46?e.type=`monster`:n<.68?e.type=`event`:n<.81&&e.row>=5?e.type=`elite`:n<.91&&e.row>=4&&e.row<12?e.type=`rest`:e.row>=4?e.type=`shop`:e.type=`monster`}e.type===`shop`&&(s=!0)}if(!s){let e=o.filter(e=>e.type===`monster`&&e.row>=5&&e.row<=11);e.length&&(Ef(t,e).type=`shop`)}for(let n of o)n.row===0||n.row===8||n.row>=13||t()<.15&&(n.unlit=!0,n.bounty=Df(t,[12,22])+e.act*6);if(e.monument&&!e.monument.claimed&&e.monument.act===e.act){let t=Of(e.monument.row||5,1,12),n=o.filter(e=>e.type===`shop`).length===1,r=o.filter(e=>e.row>0&&e.row<13&&e.row!==8&&e.type!==`boss`&&!(n&&e.type===`shop`));if(r.length){let e=r.reduce((e,n)=>Math.abs(n.row-t)<Math.abs(e.row-t)?n:e);e.type=`monument`,delete e.unlit,delete e.bounty}}return{nodes:o,visited:[]}}function Rf(e){let{nodes:t,visited:n}=e.map;if(!e.nodeId)return t.filter(e=>e.row===0);let r=t.find(t=>t.id===e.nodeId);return t.filter(e=>r.next.includes(e.id))}function zf(e,t){e.nodeId=t.id,e.floorsClimbed=t.row+1,e.map.visited.includes(t.id)||e.map.visited.push(t.id);let n=0;return t.unlit&&(delete t.unlit,n=(t.bounty||0)*(Vf(e,`thiefOfWicks`)?2:1),delete t.bounty,e.player.gold+=n,e.stats.goldEarned+=n,e.stats.unlitVisited++),{type:t.type,bounty:n}}function Bf(e){let t=e.monument;if(!t||t.claimed||!t.bequest)return null;t.claimed=!0;let n=t.bequest;return n.kind===`card`?Lp(e,n.id,n.up):n.kind===`relic`?Gf(e,n.id):n.kind===`gold`&&(e.player.gold+=n.amount,e.stats.goldEarned+=n.amount),n}var Vf=(e,t)=>e.player.relics.includes(t);function Hf(e,t){let n=(e.unlocks||[]).filter(e=>e.startsWith(`card:`)).map(e=>e.slice(5)).filter(e=>Rl[e]&&Rl[e].rarity===t);return n.length?[...zl[t],...n]:zl[t]}function Uf(e,t){let n=(e.unlocks||[]).filter(e=>e.startsWith(`relic:`)).map(e=>e.slice(6)).filter(e=>Vl[e]&&Vl[e].rarity===t);return n.length?[...Hl[t],...n]:Hl[t]}function Wf(e,t,n=null){Vf(e,`sunBlossom`)&&(t=Math.round(t*1.5));let r=n?n.player:e.player,i=r.hp;r.hp=Of(r.hp+t,0,r.maxHp);let a=r.hp-i;return n&&a>0&&n.queue.push({t:`heal`,who:`player`,n:a}),a}function Gf(e,t,n=null){let r=Vl[t];if(r){if(r.replaces){let t=e.player.relics.indexOf(r.replaces);t>=0&&e.player.relics.splice(t,1)}e.player.relics.push(t),t===`sweetRoot`&&(e.player.maxHp+=8,e.player.hp+=8),t===`hollowCrown`&&(e.player.energyMax+=1,e.player.maxHp=Math.max(1,e.player.maxHp-10),e.player.hp=Math.min(e.player.hp,e.player.maxHp))}}function Kf(e,t={common:.5,uncommon:.35,rare:.15}){let n=If(e),r=new Set(e.player.relics),i=[`common`,`uncommon`,`rare`],a=n(),o=`common`,s=0;for(let e of i)if(s+=t[e]||0,a<s){o=e;break}let c=i.indexOf(o);for(let t=0;t<i.length;t++){let a=i[(c+t)%i.length],o=Uf(e,a).filter(e=>!r.has(e));if(o.length)return Ef(n,o)}return null}function qf(e,t){t===`random`&&(t=Ef(If(e),Object.keys(Ul)));let n=e.player.potions.indexOf(null);return n<0?!1:(e.player.potions[n]=t,!0)}function Jf(e,t=`normal`){let n=If(e),r=3+ +!!Vf(e,`seersOrb`)+(Mf(e).rewardChoiceBonus||0),i=[],a=new Set;for(;i.length<r&&a.size<40;){let r;if(t===`boss`)r=`rare`;else{let e=n();r=t===`elite`?e<.45?`common`:e<.85?`uncommon`:`rare`:e<.6?`common`:e<.92?`uncommon`:`rare`}let o=Ef(n,Hf(e,r));a.add(o+Math.floor(n()*4)),i.includes(o)||i.push(o)}return i}function Yf(e,t){let n=If(e),r=[...Hf(e,`common`),...Hf(e,`common`),...Hf(e,`uncommon`),...Hf(e,`uncommon`),...Hf(e,`rare`)],i=[],a=0;for(;i.length<t&&a++<60;){let e=r[Math.floor(n()*r.length)];i.includes(e)||i.push(e)}return i}function Xf(e,t,n=null){let r=If(e),i=Df(r,ql[e.act][t===`boss`?`boss`:t===`elite`?`elite`:`normal`]);i=Math.round(i*(Mf(e).goldMult||1)*(Xl[n]?.mods.goldMult||1));let a={gold:i,cards:Jf(e,t),potion:null,relic:null};return t!==`boss`&&r()<.4&&(a.potion=Ef(r,Object.keys(Ul))),t===`elite`&&(a.relic=Kf(e)),a}function Zf(e){let t=If(e),n=new Set(e.player.relics),r=Uf(e,`boss`).filter(e=>!n.has(e)),i=[];for(;i.length<Math.min(3,r.length);){let e=Ef(t,r);i.includes(e)||i.push(e)}return i}function Qf(e){let t=If(e),n=([e,n],r)=>Math.round(Df(t,[e,n])*r),r=(Vf(e,`merchantsMark`)?.75:1)*(Mf(e).shopMult||1),i=[];for(let a of[`common`,`common`,`uncommon`,`uncommon`,`rare`]){let o,s=0;do o=Ef(t,Hf(e,a));while(i.some(e=>e.id===o)&&++s<20);i.push({id:o,price:n(Jl.cardPrice[a],r),sold:!1})}let a=new Set(e.player.relics),o=[];for(let i of[`common`,`uncommon`]){let s=Uf(e,i).filter(e=>!a.has(e)&&!o.some(t=>t.id===e));s.length&&o.push({id:Ef(t,s),price:n(Jl.relicPrice[i],r),sold:!1})}let s=[];for(let e=0;e<2;e++)s.push({id:Ef(t,Object.keys(Ul)),price:n(Jl.potionPrice,r),sold:!1});return{cards:i,relics:o,potions:s,removeCost:Math.round(Jl.removeCost*r),removed:!1}}function $f(e){let t=If(e),n=e.seenEvents||=[],r=Object.keys(Kl).filter(e=>!n.includes(e));r.length||(e.seenEvents=[],r=Object.keys(Kl));let i=Ef(t,r);return n.push(i),i}function ep(e,t,n){let r=If(e),i=Gl[e.act],a=t===`boss`?i.boss:t===`elite`?i.elite:n<3?i.weak:i.normal,o=e.lastEnc,s,c=0;do s=Ef(r,a);while(a.length>1&&s.join()===o&&++c<8);return e.lastEnc=s.join(),s}function tp(e,t,n=`normal`,r={}){let i=If(e),a=Mf(e),o=Af(e),s=n===`elite`?r.affix||Ef(i,Object.keys(Xl)):null,c=s?Xl[s].mods:{},l={kind:n,affix:s,turn:0,over:!1,result:null,queue:[],player:{hp:e.player.hp,maxHp:e.player.maxHp,block:0,energy:0,energyMax:e.player.energyMax,statuses:{}},enemies:t.map((e,t)=>{let n=Wl[e];return{key:e,idx:t,name:n.name,maxHp:Math.round(Df(i,n.hp)*(a.hpMult||1)*(c.hpMult||1)*(o.hpMult||1)),block:c.startBlock||0,statuses:{...n.startStatus||{}},flags:c.adamant?{adamant:!0}:{},lastMoves:[],moveKey:null,elite:!!n.elite,boss:!!n.boss,facetMax:Math.max(2,(n.facets??(n.boss?6:n.elite?5:4))+(a.facetDelta||0)+(c.facetDelta||0)+(n.boss&&o.bossFacetDelta||0)),chips:0}}),draw:[],hand:[],discard:[],exhaust:[],embers:0,emberCap:9,artUsedTurn:0,kindledTurn:0,kindlesThisTurn:0,pendingChips:null,counters:{played:0,attacks:0,firstCardPlayed:!1,hpLost:0}};l.enemies.forEach(e=>e.hp=e.maxHp);for(let e of l.enemies)for(let[t,n]of Object.entries({...a.enemyStartStatus||{},...c.startStatus||{}}))e.statuses[t]=(e.statuses[t]||0)+n;a.startEmbers&&(l.embers=Of(a.startEmbers,0,l.emberCap)),l.draw=e.player.deck.map(e=>({...e,bonus:0})),np(i,l.draw);let u=l.player;return Vf(e,`basaltIdol`)&&(u.block+=10,rp(l,`basaltIdol`)),Vf(e,`warFetish`)&&(ip(l,u,`str`,1),rp(l,`warFetish`)),Vf(e,`riverPearl`)&&(ip(l,u,`dex`,1),rp(l,`riverPearl`)),Vf(e,`thornBand`)&&(ip(l,u,`thorns`,2),rp(l,`thornBand`)),Vf(e,`vialOfLife`)&&(Wf(e,2,l),rp(l,`vialOfLife`)),Vf(e,`crownOfCinders`)&&(l.emberCap=12,l.embers=Of(l.embers+2,0,l.emberCap),rp(l,`crownOfCinders`)),Vf(e,`shatterersCrown`)&&(l.enemies.forEach(e=>{e.facetMax=Math.max(2,e.facetMax-1),e.statuses.str=(e.statuses.str||0)+1}),rp(l,`shatterersCrown`)),Vf(e,`smolderingCoal`)&&(l.enemies.forEach(e=>e.statuses.poison=(e.statuses.poison||0)+2),rp(l,`smolderingCoal`)),Vf(e,`ashenCore`)&&(l.enemies.forEach(e=>e.statuses.poison=(e.statuses.poison||0)+3),rp(l,`ashenCore`)),ap(e,l),Cp(e,l),l}function np(e,t){for(let n=t.length-1;n>0;n--){let r=Math.floor(e()*(n+1));[t[n],t[r]]=[t[r],t[n]]}}function rp(e,t){e.queue.push({t:`relicProc`,id:t})}function ip(e,t,n,r){t.statuses[n]=(t.statuses[n]||0)+r,t.statuses[n]===0&&delete t.statuses[n],e.queue.push({t:`status`,who:t===e.player?`player`:t.idx,id:n,n:r})}function ap(e,t){let n=If(e);for(let e of t.enemies)e.hp<=0||(e.moveKey=Wl[e.key].ai({turn:t.turn+1,last:e.lastMoves[e.lastMoves.length-1],prev:e.lastMoves[e.lastMoves.length-2],rng:n,hpFrac:e.hp/e.maxHp,self:e}),t.queue.push({t:`intent`,idx:e.idx,move:e.moveKey}))}function op(e){return Wl[e.key].moves[e.moveKey]}function sp(e,t,n){let r=Of(t.embers+n,0,t.emberCap),i=r-t.embers;return i?(t.embers=r,t.queue.push({t:`ember`,n:i,total:t.embers}),i):0}function cp(e,t,n,r){if(!(t.over||n.hp<=0||r<=0))for(n.chips+=r,t.queue.push({t:`chip`,idx:n.idx,n:r,chips:Math.min(n.chips,n.facetMax),facetMax:n.facetMax});n.chips>=n.facetMax&&n.hp>0;)n.chips-=n.facetMax,lp(e,t,n)}function lp(e,t,n){if(n.facetMax+=1,n.flags.adamant&&!n.flags.adamantSpent){n.flags.adamantSpent=!0,t.queue.push({t:`adamantHold`,idx:n.idx});return}e.stats.shatters++,n.flags.staggered=!0,t.queue.push({t:`shatter`,idx:n.idx,facetMax:n.facetMax}),ip(t,n,`vulnerable`,2),sp(e,t,2),Vf(e,`prismCharm`)&&!t.prismProcd&&(t.prismProcd=!0,sp(e,t,2),rp(t,`prismCharm`));let r=n.statuses.poison||0;if(r&&t.enemies.some(e=>e!==n&&e.hp>0)&&(delete n.statuses.poison,up(e,t,n,r)),Vf(e,`bellOfEndings`)){rp(t,`bellOfEndings`);for(let r of t.enemies.filter(e=>e!==n&&e.hp>0)){if(t.over)break;_p(e,t,r,4,{isAttack:!1})}}}function up(e,t,n,r){if(!r)return;let i=t.enemies.filter(e=>e!==n&&e.hp>0);if(!i.length)return;let a=Ef(If(e),i);ip(t,a,`poison`,r),t.queue.push({t:`smolderJump`,from:n.idx,to:a.idx,n:r})}function dp(e,t){let n=Zl[e.art];return!!n&&!t.over&&t.artUsedTurn!==t.turn&&t.embers>=n.cost}function fp(e,t){if(!dp(e,t))return!1;let n=Zl[e.art];t.artUsedTurn=t.turn,e.stats.embersSpent+=n.cost,sp(e,t,-n.cost),t.queue.push({t:`art`,id:e.art});for(let r of n.effects){if(t.over)break;pp(e,t,r)}return!0}function pp(e,t,n){let r=t.player,i=()=>t.enemies.filter(e=>e.hp>0);switch(n.kind){case`dmg`:for(let r of i())t.over||_p(e,t,r,n.n,{isAttack:!1});break;case`status`:if(n.who===`self`)ip(t,r,n.id,n.n);else for(let e of i())ip(t,e,n.id,n.n);break;case`block`:bp(e,t,r,n.n,!1);break;case`heal`:Wf(e,n.n,t);break;case`energy`:r.energy+=n.n,t.queue.push({t:`energy`,n:r.energy});break;case`draw`:xp(e,t,n.n);break;case`chip`:for(let r of i())cp(e,t,r,n.n);break;case`ember`:sp(e,t,n.n);break}}function mp(e,t,n){return!n||t.over||Ff(n).type===`curse`?!1:!(t.kindledTurn===t.turn&&t.kindlesThisTurn>=hp(e))}function hp(e){return Vf(e,`crownOfTithes`)?2:1}function gp(e,t,n){let r=t.hand.findIndex(e=>e.uid===n);if(r<0)return!1;let i=t.hand[r];return mp(e,t,i)?(t.kindledTurn!==t.turn&&(t.kindledTurn=t.turn,t.kindlesThisTurn=0),t.kindlesThisTurn++,t.hand.splice(r,1),e.stats.kindles++,t.queue.push({t:`kindle`,uid:i.uid,id:i.id}),Sp(e,t,i),Vf(e,`crownOfTithes`)&&(bp(e,t,t.player,3,!1),rp(t,`crownOfTithes`)),!0):!1}function _p(e,t,n,r,{isAttack:i=!0,mult:a=1}={}){if(n.hp<=0||t.over)return 0;let o=t.player,s=r;i&&(s+=o.statuses.str||0,o.statuses.weak&&(s=Math.floor(s*.75)),n.statuses.vulnerable&&(s=Math.floor(s*1.5))),s=Math.max(0,Math.floor(s*a));let c=Math.min(n.block,s);n.block-=c;let l=s-c;if(n.hp-=l,e.stats.dmgDealt+=l,t.queue.push({t:`hitEnemy`,idx:n.idx,amount:l,blocked:c,hpAfter:Math.max(0,n.hp),dead:n.hp<=0,killingBlow:n.hp<=0&&l>0,overkill:Math.max(0,-n.hp)}),t.pendingChips&&i&&l>0){let e=t.pendingChips.get(n.idx)||{hit:!1,extra:0};e.hit=!0,t.pendingChips.set(n.idx,e)}return i&&n.statuses.thorns&&n.hp>0&&yp(e,t,n.statuses.thorns,{source:`thorns`,isAttack:!1}),n.hp<=0&&vp(e,t,n),l}function vp(e,t,n){n.hp=0;let r=n.statuses.poison||0;if(n.statuses={},n.flags.staggered=!1,t.queue.push({t:`die`,idx:n.idx}),e.stats.slain++,n.elite&&e.stats.elites++,n.boss&&e.stats.bosses++,t.enemies.every(e=>e.hp<=0)){jp(e,t);return}sp(e,t,1),up(e,t,n,r),Vf(e,`reapersBell`)&&(t.player.energy+=1,xp(e,t,1),rp(t,`reapersBell`),t.queue.push({t:`energy`,n:t.player.energy}))}function yp(e,t,n,{source:r=`self`,isAttack:i=!1,attacker:a=null}={}){if(t.over)return 0;let o=t.player,s=n;i&&a&&(s+=(a.statuses.str||0)+(a.flags.rampBonus||0)+(Mf(e).enemyDmgBonus||0)+(Af(e).enemyDmgBonus||0),a.statuses.weak&&(s=Math.floor(s*.75)),o.statuses.vulnerable&&(s=Math.floor(s*1.5)),Vf(e,`wardingCharm`)&&s<=5&&s>0&&(s=1,rp(t,`wardingCharm`))),s=Math.max(0,s);let c=0;(i||r===`thorns`)&&(c=Math.min(o.block,s),o.block-=c);let l=s-c;if(o.hp-=l,e.stats.dmgTaken+=Math.max(0,l),t.counters.hpLost+=Math.max(0,l),t.queue.push({t:`hitPlayer`,amount:l,blocked:c,hpAfter:Math.max(0,o.hp),source:r}),o.hp<=0)return Mp(e,t),l;if(i&&a){let n={...Mf(e).playerHitApplies||{},...t.affix&&Xl[t.affix].mods.attackApplies||{}};for(let[e,r]of Object.entries(n))ip(t,o,e,r);o.statuses.thorns&&a.hp>0&&_p(e,t,a,o.statuses.thorns,{isAttack:!1})}return l}function bp(e,t,n,r,i=!0){let a=r;return n===t.player&&i&&(a+=n.statuses.dex||0,n.statuses.frail&&(a=Math.floor(a*.75))),a=Math.round(Math.max(0,a)*(Mf(e).wardMult||1)),n.block+=a,t.queue.push({t:`blockGain`,who:n===t.player?`player`:n.idx,n:a,total:n.block}),a}function xp(e,t,n){let r=If(e);for(let e=0;e<n&&!(t.hand.length>=10);e++){if(!t.draw.length){if(!t.discard.length)break;t.draw=t.discard,t.discard=[],np(r,t.draw),t.queue.push({t:`reshuffle`})}let e=t.draw.pop();t.hand.push(e),t.queue.push({t:`draw`,uid:e.uid,id:e.id})}}function Sp(e,t,n){t.exhaust.push(n),t.queue.push({t:`exhaust`,uid:n.uid}),sp(e,t,1),Vf(e,`verdantBranch`)&&(xp(e,t,1),rp(t,`verdantBranch`))}function Cp(e,t){if(t.over)return;t.turn++;let n=t.player;if(t.queue.push({t:`turn`,n:t.turn}),n.statuses.poison&&(yp(e,t,n.statuses.poison,{source:`poison`}),n.statuses.poison--,n.statuses.poison||delete n.statuses.poison,t.over))return;n.statuses.barricade||(n.block=0),n.statuses.ritual&&ip(t,n,`str`,n.statuses.ritual),n.statuses.emberflow&&sp(e,t,n.statuses.emberflow);let r=n.energyMax+(n.statuses.energized||0);t.turn===1&&Vf(e,`emberLantern`)&&(r+=1,rp(t,`emberLantern`)),n.energy=(Vf(e,`frozenCore`)?n.energy:0)+r,t.counters.firstCardPlayed=!1,t.queue.push({t:`energy`,n:n.energy});let i=5+(n.statuses.nightsight||0)+(Mf(e).drawDelta||0);t.turn===1&&Vf(e,`travelersPack`)&&(i+=2,rp(t,`travelersPack`)),xp(e,t,Math.max(1,i))}function wp(e,t,n){let r=Ff(n);return r.cost==null?null:Vf(e,`duskmirror`)&&!t.counters.firstCardPlayed?0:Mf(e).firstCardDiscount&&!t.counters.firstCardPlayed?Math.max(0,r.cost-Mf(e).firstCardDiscount):r.cost}function Tp(e,t,n,r){if(t.over)return!1;let i=Ff(n);return!(i.unplayable||wp(e,t,n)>t.player.energy||i.target===`enemy`&&(r==null||!t.enemies[r]||t.enemies[r].hp<=0))}function Ep(e,t,n,r=null){let i=t.hand.findIndex(e=>e.uid===n);if(i<0)return!1;let a=t.hand[i],o=Ff(a);if(!Tp(e,t,a,r))return!1;let s=t.player,c=wp(e,t,a);s.energy-=c,Vf(e,`duskmirror`)&&!t.counters.firstCardPlayed&&o.cost>0&&rp(t,`duskmirror`),t.counters.firstCardPlayed=!0,t.hand.splice(i,1),t.counters.played++,e.stats.cardsPlayed++,t.queue.push({t:`play`,uid:a.uid,id:a.id,targetIdx:r}),t.queue.push({t:`energy`,n:s.energy});let l=1;o.type===`attack`&&(t.counters.attacks++,Vf(e,`ironTalisman`)&&t.counters.attacks%3==0&&(ip(t,s,`str`,1),rp(t,`ironTalisman`)),Vf(e,`executionersSeal`)&&t.counters.attacks%10==0&&(l=2,rp(t,`executionersSeal`)));let u=r==null?null:t.enemies[r],d=()=>t.enemies.filter(e=>e.hp>0);t.pendingChips=new Map;for(let n of o.effects){if(t.over)break;Dp(e,t,a,o,n,u,l)}if(t.pendingChips&&!t.over){let n=o.type===`attack`?1+(o.chip||0)+(s.statuses.beacon||0):0;for(let[r,i]of t.pendingChips){let a=t.enemies[r];if(!a||a.hp<=0||t.over)continue;let o=(i.hit?n:0)+i.extra;o>0&&cp(e,t,a,o)}}if(t.pendingChips=null,!t.over&&o.type===`attack`&&s.statuses.venomous){let e=o.target===`allEnemies`?d():u&&u.hp>0?[u]:[];for(let n of e)ip(t,n,`poison`,s.statuses.venomous)}return!t.over&&Vf(e,`silkFan`)&&t.counters.played%3==0&&(bp(e,t,s,3,!1),rp(t,`silkFan`)),o.type===`power`?t.queue.push({t:`powerConsumed`,uid:a.uid}):o.exhaust?Sp(e,t,a):t.discard.push(a),!0}function Dp(e,t,n,r,i,a,o){let s=t.player,c=r.target===`allEnemies`?t.enemies.filter(e=>e.hp>0):a?[a]:[];switch(i.kind){case`dmg`:{let n=i.times||1;for(let a=0;a<n;a++)for(let n of r.target===`allEnemies`?t.enemies.filter(e=>e.hp>0):c){if(t.over)return;_p(e,t,n,i.n,{mult:o})}break}case`block`:bp(e,t,s,i.n);break;case`draw`:xp(e,t,i.n);break;case`energy`:s.energy+=i.n,t.queue.push({t:`energy`,n:s.energy});break;case`heal`:Wf(e,i.n,t);break;case`loseHp`:yp(e,t,i.n,{source:`self`});break;case`status`:if(i.who===`self`)ip(t,s,i.id,i.n);else if(i.who===`allEnemies`)for(let e of t.enemies.filter(e=>e.hp>0))ip(t,e,i.id,i.n);else a&&a.hp>0&&ip(t,a,i.id,i.n);break;case`addCard`:for(let n=0;n<(i.n||1);n++){let n={uid:e.uid++,id:i.id,up:!1,bonus:0};(i.where===`hand`&&t.hand.length<10?t.hand:t.discard).push(n),t.queue.push({t:`addCard`,id:i.id,where:i.where||`discard`})}break;case`chip`:for(let n of c)if(!(n.hp<=0))if(t.pendingChips){let e=t.pendingChips.get(n.idx)||{hit:!1,extra:0};e.extra+=i.n,t.pendingChips.set(n.idx,e)}else cp(e,t,n,i.n);break;case`ember`:sp(e,t,i.n);break;case`special`:Op(e,t,n,r,i,a,o)}}function Op(e,t,n,r,i,a,o){let s=t.player;switch(i.id){case`leech`:{let n=_p(e,t,a,i.n,{mult:o});n>0&&Wf(e,Math.floor(n/2),t);break}case`execute`:{let n=a.statuses.vulnerable?i.bonus:0;_p(e,t,a,i.n+n,{mult:o});break}case`momentum`:_p(e,t,a,i.n+n.bonus,{mult:o}),n.bonus+=i.grow;break;case`phantom`:_p(e,t,a,i.n*t.hand.length,{mult:o});break;case`devour`:_p(e,t,a,i.n,{mult:o}),a.hp<=0&&(t.over?Wf(e,i.heal):(sp(e,t,i.embers),Wf(e,i.heal,t)));break;case`doubleBlock`:bp(e,t,s,s.block,!1);break;case`catalyst`:a.statuses.poison&&ip(t,a,`poison`,a.statuses.poison*(i.n-1));break;case`shatterEcho`:{let n=a.flags.staggered||a.statuses.vulnerable?2:1;_p(e,t,a,i.n*n,{mult:o});break}case`emberNova`:_p(e,t,a,i.n*t.embers,{mult:o});break;case`pyreTithe`:for(let r of[...t.hand]){if(r===n)continue;let i=t.hand.indexOf(r);t.hand.splice(i,1),t.queue.push({t:`kindle`,uid:r.uid,id:r.id}),Sp(e,t,r)}xp(e,t,i.draw);break;case`flawless`:bp(e,t,s,i.n),t.counters.hpLost===0&&bp(e,t,s,i.n);break;case`emberdance`:{let n=t.embers;n>0&&(e.stats.embersSpent+=n,sp(e,t,-n),bp(e,t,s,i.n*n,!1));break}}}function kp(e,t,n,r=null){let i=e.player.potions[n];if(!i)return!1;let a=Ul[i];if(a.combatOnly&&(!t||t.over)||a.needsTarget&&(r==null||!t.enemies[r]||t.enemies[r].hp<=0))return!1;switch(e.player.potions[n]=null,t&&t.queue.push({t:`potion`,id:i}),i){case`healing`:Wf(e,20,t),t||(e.player.hp=Of(e.player.hp,0,e.player.maxHp));break;case`strength`:ip(t,t.player,`str`,2);break;case`swift`:xp(e,t,3);break;case`block`:bp(e,t,t.player,12,!1);break;case`fire`:_p(e,t,t.enemies[r],20,{isAttack:!1});break;case`venom`:ip(t,t.enemies[r],`poison`,7);break;case`energy`:sp(e,t,3);break}return!0}function Ap(e,t){if(t.over)return;let n=t.player;t.queue.push({t:`endTurn`});for(let n of[...t.hand]){let r=Ff(n);if(r.endTurnDmg&&yp(e,t,r.endTurnDmg,{source:`burn`}),r.endTurnLoseHp&&yp(e,t,r.endTurnLoseHp,{source:`burn`}),t.over)return}n.statuses.metallicize&&bp(e,t,n,n.statuses.metallicize,!1),n.statuses.regen&&Wf(e,n.statuses.regen,t),t.discard.push(...t.hand),t.hand=[],t.queue.push({t:`discardHand`});for(let e of[`vulnerable`,`weak`,`frail`,`beacon`])n.statuses[e]&&(n.statuses[e]--,n.statuses[e]||delete n.statuses[e]);for(let r of t.enemies)if(!(r.hp<=0||t.over)){if(r.statuses.poison){let n=r.statuses.poison;if(r.hp-=n,e.stats.dmgDealt+=n,t.queue.push({t:`hitEnemy`,idx:r.idx,amount:n,blocked:0,hpAfter:Math.max(0,r.hp),dead:r.hp<=0,poison:!0}),r.statuses.poison--,r.statuses.poison||delete r.statuses.poison,r.hp<=0){e.stats.smolderKills++,vp(e,t,r);continue}}if(r.block=0,r.flags.staggered)r.flags.staggered=!1,r.lastMoves.push(r.moveKey),t.queue.push({t:`staggered`,idx:r.idx});else{let i=op(r);if(t.queue.push({t:`enemyAct`,idx:r.idx,move:r.moveKey,name:i.name}),r.lastMoves.push(r.moveKey),i.dmg!=null){for(let n=0;n<(i.times||1)&&!t.over;n++)yp(e,t,i.dmg,{source:r.idx,isAttack:!0,attacker:r});i.ramp&&(r.flags.rampBonus=(r.flags.rampBonus||0)+i.ramp)}if(t.over)return;if(i.block&&bp(e,t,r,i.block,!1),i.heal&&(r.hp=Math.min(r.maxHp,r.hp+i.heal),t.queue.push({t:`heal`,who:r.idx,n:i.heal})),i.fx){for(let e of i.fx)if(e.who===`player`)ip(t,n,e.id,e.n);else if(e.who===`self`)ip(t,r,e.id,e.n);else if(e.who===`allies`)for(let n of t.enemies.filter(e=>e.hp>0))ip(t,n,e.id,e.n)}if(i.addCards)for(let n=0;n<i.addCards.n;n++)t.discard.push({uid:e.uid++,id:i.addCards.id,up:!1,bonus:0}),t.queue.push({t:`addCard`,id:i.addCards.id,where:`discard`})}r.statuses.ritual&&ip(t,r,`str`,r.statuses.ritual);for(let e of[`vulnerable`,`weak`])r.statuses[e]&&(r.statuses[e]--,r.statuses[e]||delete r.statuses[e])}t.over||(ap(e,t),Cp(e,t))}function jp(e,t){t.over=!0,t.result=`win`,e.player.hp=Of(t.player.hp,1,e.player.maxHp),Vf(e,`emberHeart`)&&(Wf(e,6),rp(t,`emberHeart`)),Vf(e,`crownOfTheHearth`)&&t.embers>0&&(Wf(e,t.embers*3),rp(t,`crownOfTheHearth`)),Vf(e,`gravebloom`)&&e.player.hp<=e.player.maxHp*.5&&(Wf(e,10),rp(t,`gravebloom`)),e.player.hp=Of(e.player.hp,1,e.player.maxHp),t.queue.push({t:`victory`,perfect:t.counters.hpLost===0})}function Mp(e,t){t.over=!0,t.result=`loss`,t.player.hp=0,e.player.hp=0,t.queue.push({t:`defeat`})}function Np(e,t,n=null){let r=e.player,i=t+(r.statuses.str||0);r.statuses.weak&&(i=Math.floor(i*.75));let a=n==null?null:e.enemies[n];return a&&a.statuses.vulnerable&&(i=Math.floor(i*1.5)),Math.max(0,i)}function Pp(e,t,n){let r=t.player,i=n+(r.statuses.dex||0);return r.statuses.frail&&(i=Math.floor(i*.75)),Math.round(Math.max(0,i)*(Mf(e).wardMult||1))}function Fp(e,t,n){let r=op(n);if(r.dmg==null)return null;let i=r.dmg+(n.statuses.str||0)+(n.flags.rampBonus||0)+(Mf(e).enemyDmgBonus||0)+(Af(e).enemyDmgBonus||0);return n.statuses.weak&&(i=Math.floor(i*.75)),t.player.statuses.vulnerable&&(i=Math.floor(i*1.5)),{dmg:Math.max(0,i),times:r.times||1}}function Ip(e,t,n,r=null){let i=Ff(n),a=t.player,o=r==null?null:t.enemies[r],s=Vf(e,`executionersSeal`)&&i.type===`attack`&&(t.counters.attacks+1)%10==0?2:1,c=e=>{let t=e+(a.statuses.str||0);return a.statuses.weak&&(t=Math.floor(t*.75)),o&&o.statuses.vulnerable&&(t=Math.floor(t*1.5)),Math.max(0,Math.floor(t*s))},l=[],u=0;for(let r of i.effects)r.kind===`dmg`?l.push({dmg:c(r.n),times:r.times||1}):r.kind===`block`?u+=Pp(e,t,r.n):r.kind===`special`&&(r.id===`leech`||r.id===`devour`?l.push({dmg:c(r.n),times:1}):r.id===`execute`?l.push({dmg:c(r.n+(o?.statuses.vulnerable?r.bonus:0)),times:1}):r.id===`momentum`?l.push({dmg:c(r.n+(n.bonus||0)),times:1}):r.id===`phantom`?l.push({dmg:c(r.n*Math.max(0,t.hand.length-+!!t.hand.includes(n))),times:1}):r.id===`shatterEcho`?l.push({dmg:c(r.n*(o&&(o.flags.staggered||o.statuses.vulnerable)?2:1)),times:1}):r.id===`emberNova`?l.push({dmg:c(r.n*t.embers),times:1}):r.id===`doubleBlock`?u+=a.block:r.id===`flawless`?u+=Pp(e,t,r.n)*(t.counters.hpLost===0?2:1):r.id===`emberdance`&&(u+=r.n*t.embers));let d=0;for(let e of i.effects)e.kind===`chip`&&(d+=e.n);if(!l.length&&!u&&!d)return null;let f=l.reduce((e,t)=>e+t.dmg*t.times,0),p=f,m=!1,h=0,g=!1;if(o){let e=o.block;p=0;for(let t of l)for(let n=0;n<t.times;n++){let n=Math.min(e,t.dmg);e-=n,p+=t.dmg-n}m=p>=o.hp;let t=i.type===`attack`?1+(i.chip||0)+(a.statuses.beacon||0):0;h=(l.length&&p>0?t:0)+d,g=h>0&&o.chips+h>=o.facetMax&&!m}return{hits:l,total:f,loss:p,lethal:m,block:u,chips:h,willShatter:g}}function Lp(e,t,n=!1){let r=Pf(e,t,n);return e.player.deck.push(r),r}function Rp(e,t){let n=e.player.deck.findIndex(e=>e.uid===t);n>=0&&e.player.deck.splice(n,1)}function zp(e,t){let n=e.player.deck.find(e=>e.uid===t);n&&(n.up=!0)}function Bp(e,t){let n=e.player.deck.find(e=>e.uid===t);n&&e.player.deck.push(Pf(e,n.id,n.up))}var Vp=`spirebound_save_v2`,Hp=`spirebound_stats_v1`;function Up(e){try{localStorage.setItem(Vp,JSON.stringify(e))}catch{}}function Wp(){try{let e=localStorage.getItem(Vp);if(!e)return null;let t=JSON.parse(e);if(!t||t.v!==2||!t.player||!t.map||!t.player.deck.every(e=>Rl[e.id])||!t.player.relics.every(e=>Vl[e])||!t.player.potions.every(e=>e==null||Ul[e])||t.art!=null&&!Zl[t.art]||!(t.omens||[]).every(e=>Yl[e]))return null;for(t.art??=`flare`,t.aspect=Of(t.aspect??0,0,$l.length-1),t.vow=Of(t.vow??0,0,eu.length),t.unlocks??=[],t.omens??=[],t.boon??=null;t.omens.length<=t.act;)t.omens.push(jf(t));for(let e of[`shatters`,`kindles`,`perfects`,`smolderKills`,`unlitVisited`,`embersSpent`])t.stats[e]??=0;return t}catch{return null}}function Gp(){try{localStorage.removeItem(Vp),localStorage.removeItem(`spirebound_save_v1`)}catch{}}function Kp(){try{return JSON.parse(localStorage.getItem(Hp))||{runs:0,wins:0,best:0}}catch{return{runs:0,wins:0,best:0}}}function qp(e,t){let n=Kp();n.runs++,t&&n.wins++,n.best=Math.max(n.best,e.act*15+e.floorsClimbed);try{localStorage.setItem(Hp,JSON.stringify(n))}catch{}Gp()}function Jp(e,t,n=If(e)){let r=[],i=[];for(let a of t){if(a.gold&&(e.player.gold=Math.max(0,e.player.gold+a.gold),a.gold>0&&(e.stats.goldEarned+=a.gold)),a.hp&&(e.player.hp=Of(e.player.hp+a.hp,1,e.player.maxHp)),a.maxHp&&(e.player.maxHp=Math.max(1,e.player.maxHp+a.maxHp),e.player.hp=Of(e.player.hp+Math.max(0,a.maxHp),1,e.player.maxHp)),a.heal&&Wf(e,Math.round(e.player.maxHp*a.heal)),a.addCard&&Lp(e,a.addCard),a.addRelic){let t=a.addRelic===`random`?Kf(e):a.addRelic;t?(Gf(e,t),i.push({relic:t})):(e.player.gold+=50,i.push({text:`You find 50 gold instead.`}))}if(a.potion&&qf(e,a.potion),a.pickRemove&&r.push(`remove`),a.pickUpgrade&&r.push(`upgrade`),a.pickDuplicate&&r.push(`duplicate`),a.pickCard&&r.push({pickCard:a.pickCard}),a.roll){let t=n(),o=0;for(let s of a.roll)if(o+=s.p,t<o){i.push({text:s.text});let t=Jp(e,s.ops,n);r.push(...t.pending),i.push(...t.log);break}}}return{pending:r,log:i}}var Yp=Object.assign({"./assets/cards/aegis.png":`/assets/aegis-BbAK7DRy.png`,"./assets/cards/agility.png":`/assets/agility-D28Eu8MG.png`,"./assets/cards/annihilate.png":`/assets/annihilate-M3mspBDm.png`,"./assets/cards/ascension.png":`/assets/ascension-C2Pll28_.png`,"./assets/cards/ashBite.png":`/assets/ashBite-BBZrYNBt.png`,"./assets/cards/ashenChoir.png":`/assets/ashenChoir-Cjfn-BY1.png`,"./assets/cards/bastion.png":`/assets/bastion-D4uvW6Yu.png`,"./assets/cards/bloodRite.png":`/assets/bloodRite-xNaIV6FC.png`,"./assets/cards/brace.png":`/assets/brace-CDbc3WSx.png`,"./assets/cards/bulwark.png":`/assets/bulwark-DvQ82Xby.png`,"./assets/cards/burn.png":`/assets/burn-BVJa4vLy.png`,"./assets/cards/catalyst.png":`/assets/catalyst-C9UJqVfa.png`,"./assets/cards/chisel.png":`/assets/chisel-BHUdyvP2.png`,"./assets/cards/cleave.png":`/assets/cleave-Cs444Dst.png`,"./assets/cards/cripple.png":`/assets/cripple-CtSZS_Jx.png`,"./assets/cards/defend.png":`/assets/defend-BT8TAbMa.png`,"./assets/cards/deflect.png":`/assets/deflect-C25gbOwx.png`,"./assets/cards/devour.png":`/assets/devour-CXvHmKvA.png`,"./assets/cards/eclipseSlash.png":`/assets/eclipseSlash-B5W8xu8L.png`,"./assets/cards/emberdance.png":`/assets/emberdance-CBOqWIEl.png`,"./assets/cards/empower.png":`/assets/empower-DauCte29.png`,"./assets/cards/executioner.png":`/assets/executioner-DI8vj7EW.png`,"./assets/cards/firstSpark.png":`/assets/firstSpark-CaQ5-JAc.png`,"./assets/cards/flawlessForm.png":`/assets/flawlessForm-C34QTET6.png`,"./assets/cards/flurry.png":`/assets/flurry-D8kOQQ9x.png`,"./assets/cards/fortify.png":`/assets/fortify-DEACu-Zo.png`,"./assets/cards/frenzy.png":`/assets/frenzy-BgGGtYpf.png`,"./assets/cards/guardedStrike.png":`/assets/guardedStrike-BBAeWagI.png`,"./assets/cards/heavyBlow.png":`/assets/heavyBlow-Btb1hEmS.png`,"./assets/cards/hex.png":`/assets/hex-D3QIN_GY.png`,"./assets/cards/ironSkin.png":`/assets/ironSkin-DIcLMutG.png`,"./assets/cards/leechBlade.png":`/assets/leechBlade-BgoitLbP.png`,"./assets/cards/limitBreak.png":`/assets/limitBreak-D3VHagIC.png`,"./assets/cards/lunge.png":`/assets/lunge-BKNULJcP.png`,"./assets/cards/momentum.png":`/assets/momentum-D0hGLm2N.png`,"./assets/cards/nightSight.png":`/assets/nightSight-1ggiNsUe.png`,"./assets/cards/novaflare.png":`/assets/novaflare-BtAOF5B2.png`,"./assets/cards/oblivionStrike.png":`/assets/oblivionStrike-Ck8D7viT.png`,"./assets/cards/offering.png":`/assets/offering-BDnzVcbS.png`,"./assets/cards/phantomBlades.png":`/assets/phantomBlades-CZgzKQZJ.png`,"./assets/cards/preparation.png":`/assets/preparation-B0_lrDKo.png`,"./assets/cards/pyreheart.png":`/assets/pyreheart-BzRCI95J.png`,"./assets/cards/quakeblow.png":`/assets/quakeblow-DZuM_zei.png`,"./assets/cards/quickSlash.png":`/assets/quickSlash-BHIEN7hF.png`,"./assets/cards/regrowth.png":`/assets/regrowth-DCr6zV9b.png`,"./assets/cards/resonantLance.png":`/assets/resonantLance-DFyDlcY4.png`,"./assets/cards/shardstorm.png":`/assets/shardstorm-CtSThqM0.png`,"./assets/cards/sidestep.png":`/assets/sidestep-D-t2UoHV.png`,"./assets/cards/smother.png":`/assets/smother-Boa7xrCA.png`,"./assets/cards/strike.png":`/assets/strike-CmEr2qad.png`,"./assets/cards/surge.png":`/assets/surge-D5JDOylt.png`,"./assets/cards/tempest.png":`/assets/tempest-DosF7X1A.png`,"./assets/cards/tithe.png":`/assets/tithe-BNvDlR3N.png`,"./assets/cards/toxicMist.png":`/assets/toxicMist-BUGxQeK0.png`,"./assets/cards/twinFangs.png":`/assets/twinFangs-BUW2V2Kq.png`,"./assets/cards/uppercut.png":`/assets/uppercut-C0A2yndn.png`,"./assets/cards/venomStrike.png":`/assets/venomStrike-CXIglW-b.png`,"./assets/cards/virulence.png":`/assets/virulence-pwX1yrdH.png`,"./assets/cards/warCry.png":`/assets/warCry-C7Rsrd4u.png`,"./assets/cards/wound.png":`/assets/wound-BTcmqSFC.png`,"./assets/enemies/abyssalKnight.png":`/assets/abyssalKnight-BA9qPzL_.png`,"./assets/enemies/alphaFang.png":`/assets/alphaFang-CYs2MfQS.png`,"./assets/enemies/ashAcolyte.png":`/assets/ashAcolyte-W7Bx9eY3.png`,"./assets/enemies/chaosHound.png":`/assets/chaosHound-Cu1tbGXO.png`,"./assets/enemies/deepmaw.png":`/assets/deepmaw-BuZMfyUW.png`,"./assets/enemies/drownedOne.png":`/assets/drownedOne-762yKbrK.png`,"./assets/enemies/duskfang.png":`/assets/duskfang-kVQE2Vbx.png`,"./assets/enemies/gloomslime.png":`/assets/gloomslime-BYNIQKkd.png`,"./assets/enemies/gravewarden.png":`/assets/gravewarden-CYbqq2Uz.png`,"./assets/enemies/heraldOfEnd.png":`/assets/heraldOfEnd-B5j76nBL.png`,"./assets/enemies/leviathan.png":`/assets/leviathan-DUX2Oy2k.png`,"./assets/enemies/mirelurker.png":`/assets/mirelurker-Cs0-ryPe.png`,"./assets/enemies/obsidianGolem.png":`/assets/obsidianGolem-B2_vm835.png`,"./assets/enemies/rootheart.png":`/assets/rootheart-CoZqsgKs.png`,"./assets/enemies/shade.png":`/assets/shade-cFzxMAwm.png`,"./assets/enemies/shellback.png":`/assets/shellback-9j9gwuRI.png`,"./assets/enemies/siren.png":`/assets/siren-Boj63opF.png`,"./assets/enemies/sovereign.png":`/assets/sovereign-DlFMbPOe.png`,"./assets/enemies/sporeling.png":`/assets/sporeling-B8wAP_1e.png`,"./assets/enemies/starCultist.png":`/assets/starCultist-DrQ9SosS.png`,"./assets/enemies/thornling.png":`/assets/thornling-BJhkzjJz.png`,"./assets/enemies/tidecaller.png":`/assets/tidecaller-C3FvvD8d.png`,"./assets/enemies/voidColossus.png":`/assets/voidColossus-D1BBPiCC.png`,"./assets/enemies/voidWisp.png":`/assets/voidWisp-DqB4mImW.png`,"./assets/enemies/voltEel.png":`/assets/voltEel-BxcD87LR.png`,"./assets/enemies/watcherEye.png":`/assets/watcherEye-Cx0FZXO4.png`,"./assets/enemies/waylayer.png":`/assets/waylayer-DkHd5xp-.png`,"./assets/events/cursedIdol.png":`/assets/cursedIdol--s0qHWso.png`,"./assets/events/emberFountain.png":`/assets/emberFountain-D_Q0157p.png`,"./assets/events/fleshTrader.png":`/assets/fleshTrader-q8lAx2oa.png`,"./assets/events/forge.png":`/assets/forge-i5xE2DIv.png`,"./assets/events/forgottenShrine.png":`/assets/forgottenShrine-CYFo9R9B.png`,"./assets/events/gambler.png":`/assets/gambler-D4lmA3Yw.png`,"./assets/events/library.png":`/assets/library-CstvhNks.png`,"./assets/events/mirror.png":`/assets/mirror-Hp5O4ZPJ.png`,"./assets/events/ruinedCamp.png":`/assets/ruinedCamp-BvAZgrK0.png`,"./assets/events/voidChest.png":`/assets/voidChest-B34oBTge.png`,"./assets/events/woundedKnight.png":`/assets/woundedKnight-JN7kYI1u.png`,"./assets/heroes/ashwarden.png":`/assets/ashwarden-D21mg7QM.png`,"./assets/heroes/duskblade.png":`/assets/duskblade-DupP5i2p.png`,"./assets/potions/block.png":`/assets/block-DybnuP3a.png`,"./assets/potions/energy.png":`/assets/energy-CWJoumcv.png`,"./assets/potions/fire.png":`/assets/fire-Bc2Edgqg.png`,"./assets/potions/healing.png":`/assets/healing-Bf7MtUhk.png`,"./assets/potions/strength.png":`/assets/strength-Bp64zOFp.png`,"./assets/potions/swift.png":`/assets/swift-Da4aGqnZ.png`,"./assets/potions/venom.png":`/assets/venom-DzAfe6ZB.png`,"./assets/props/campfire.png":`/assets/campfire-C5hpDY2a.png`,"./assets/props/chest-open.png":`/assets/chest-open-CKTWCSJu.png`,"./assets/props/chest.png":`/assets/chest-BVVwYI2Z.png`,"./assets/props/merchant.png":`/assets/merchant-CRCPVNlm.png`,"./assets/relics/ashenCore.png":`/assets/ashenCore-BHw_xmlT.png`,"./assets/relics/basaltIdol.png":`/assets/basaltIdol-BLUsj7rE.png`,"./assets/relics/bellOfEndings.png":`/assets/bellOfEndings-CMuMud-J.png`,"./assets/relics/crownOfCinders.png":`/assets/crownOfCinders-B4iyR0zw.png`,"./assets/relics/crownOfTheHearth.png":`/assets/crownOfTheHearth-Cz96lab0.png`,"./assets/relics/crownOfTithes.png":`/assets/crownOfTithes-BCSNj05m.png`,"./assets/relics/duskmirror.png":`/assets/duskmirror-ChDahFDy.png`,"./assets/relics/emberHeart.png":`/assets/emberHeart-D8pWC_qd.png`,"./assets/relics/emberLantern.png":`/assets/emberLantern-CzFc-ESn.png`,"./assets/relics/executionersSeal.png":`/assets/executionersSeal-B-n0EUgT.png`,"./assets/relics/frozenCore.png":`/assets/frozenCore-JuT4c4Zg.png`,"./assets/relics/gravebloom.png":`/assets/gravebloom-CR3cDZz9.png`,"./assets/relics/hollowCrown.png":`/assets/hollowCrown-CHl2KxBg.png`,"./assets/relics/ironTalisman.png":`/assets/ironTalisman-CLgSHgbT.png`,"./assets/relics/merchantsMark.png":`/assets/merchantsMark-YaAPSe2m.png`,"./assets/relics/prismCharm.png":`/assets/prismCharm-CWUUYnXM.png`,"./assets/relics/reapersBell.png":`/assets/reapersBell-DK7zj2uj.png`,"./assets/relics/riverPearl.png":`/assets/riverPearl-1k1ZwvLB.png`,"./assets/relics/seersOrb.png":`/assets/seersOrb--o7V7uP4.png`,"./assets/relics/shatterersCrown.png":`/assets/shatterersCrown-VlDF7CT4.png`,"./assets/relics/silkFan.png":`/assets/silkFan-Co6ZNxqb.png`,"./assets/relics/smolderingCoal.png":`/assets/smolderingCoal-ESDuOXE3.png`,"./assets/relics/sunBlossom.png":`/assets/sunBlossom-GItTIWOb.png`,"./assets/relics/sweetRoot.png":`/assets/sweetRoot-DVIYyMAo.png`,"./assets/relics/thiefOfWicks.png":`/assets/thiefOfWicks-WD5HQJ9E.png`,"./assets/relics/thornBand.png":`/assets/thornBand-1rbgbbpR.png`,"./assets/relics/travelersPack.png":`/assets/travelersPack-Ctq6FXOL.png`,"./assets/relics/verdantBranch.png":`/assets/verdantBranch-BpapOPVN.png`,"./assets/relics/vialOfLife.png":`/assets/vialOfLife-CqH_Yzkc.png`,"./assets/relics/warFetish.png":`/assets/warFetish-BphYE_UB.png`,"./assets/relics/wardingCharm.png":`/assets/wardingCharm-DcyucUO6.png`,"./assets/stage/act1-backdrop.png":`/assets/act1-backdrop-CC5kcu8K.png`,"./assets/stage/act1-ledge.png":`/assets/act1-ledge-bJFlyNKx.png`,"./assets/stage/act1-mid.png":`/assets/act1-mid-B4s3OZuq.png`,"./assets/stage/act2-backdrop.png":`/assets/act2-backdrop-BtpNIaTG.png`,"./assets/stage/act2-ledge.png":`/assets/act2-ledge-CyxN7MQ0.png`,"./assets/stage/act2-mid.png":`/assets/act2-mid-BAevK0Pb.png`,"./assets/stage/act3-backdrop.png":`/assets/act3-backdrop-DFsKREnY.png`,"./assets/stage/act3-ledge.png":`/assets/act3-ledge-BCUKgBXQ.png`,"./assets/stage/act3-mid.png":`/assets/act3-mid-CukJ38oi.png`,"./assets/title/title.png":`/assets/title-BZbtHJmc.png`,"./assets/title-background/background.png":`/assets/background-cEVCcaPg.png`,"./assets-gpt-nano-pass/cards/ashBite.jpg":`/assets/ashBite-BYzdJfb7.jpg`,"./assets-gpt-nano-pass/cards/chisel.jpg":`/assets/chisel-DGrQWYAc.jpg`,"./assets-gpt-nano-pass/cards/defend.jpg":`/assets/defend-mmYA7HKX.jpg`,"./assets-gpt-nano-pass/cards/eclipseSlash.jpg":`/assets/eclipseSlash-DEA5FgEC.jpg`,"./assets-gpt-nano-pass/cards/firstSpark.jpg":`/assets/firstSpark-BpDCHsPu.jpg`,"./assets-gpt-nano-pass/cards/heavyBlow.jpg":`/assets/heavyBlow-XGOXUeSq.jpg`,"./assets-gpt-nano-pass/cards/quickSlash.jpg":`/assets/quickSlash-DMRFz6rj.jpg`,"./assets-gpt-nano-pass/cards/smother.jpg":`/assets/smother-DFWDS6kH.jpg`,"./assets-gpt-nano-pass/cards/strike.jpg":`/assets/strike-DfYIx_7x.jpg`,"./assets-gpt-nano-pass/cards/twinFangs.jpg":`/assets/twinFangs-C0lavWO6.jpg`,"./assets-legacy/cards/aegis.png":`/assets/aegis-C4yW72TQ.png`,"./assets-legacy/cards/agility.png":`/assets/agility-CI5YF-GX.png`,"./assets-legacy/cards/annihilate.png":`/assets/annihilate-BJ7gRR18.png`,"./assets-legacy/cards/ascension.png":`/assets/ascension-YSvo3EHU.png`,"./assets-legacy/cards/ashBite.png":`/assets/ashBite-GiUs8mSx.png`,"./assets-legacy/cards/ashenChoir.png":`/assets/ashenChoir-DPJ2hVdE.png`,"./assets-legacy/cards/bastion.png":`/assets/bastion-C4-IEju2.png`,"./assets-legacy/cards/bloodRite.png":`/assets/bloodRite-Dngc9iLG.png`,"./assets-legacy/cards/brace.png":`/assets/brace-C5luuyT6.png`,"./assets-legacy/cards/bulwark.png":`/assets/bulwark-Cg16G72s.png`,"./assets-legacy/cards/burn.png":`/assets/burn-DITCRtNT.png`,"./assets-legacy/cards/catalyst.png":`/assets/catalyst-BDxUOd5K.png`,"./assets-legacy/cards/chisel.png":`/assets/chisel-ByP6TOAs.png`,"./assets-legacy/cards/cleave.png":`/assets/cleave-0AOOs4ja.png`,"./assets-legacy/cards/cripple.png":`/assets/cripple-DWnayR1G.png`,"./assets-legacy/cards/defend.png":`/assets/defend-CBCl5jff.png`,"./assets-legacy/cards/deflect.png":`/assets/deflect-woHgEHmS.png`,"./assets-legacy/cards/devour.png":`/assets/devour-DXcXwBMk.png`,"./assets-legacy/cards/eclipseSlash.png":`/assets/eclipseSlash-D2SP8-Ya.png`,"./assets-legacy/cards/emberdance.png":`/assets/emberdance-BEz1L0x3.png`,"./assets-legacy/cards/empower.png":`/assets/empower-DWMunI0q.png`,"./assets-legacy/cards/executioner.png":`/assets/executioner-BBjpcz8R.png`,"./assets-legacy/cards/firstSpark.png":`/assets/firstSpark-s24i_29F.png`,"./assets-legacy/cards/flawlessForm.png":`/assets/flawlessForm-BbJ3dkp3.png`,"./assets-legacy/cards/flurry.png":`/assets/flurry-OF83ComZ.png`,"./assets-legacy/cards/fortify.png":`/assets/fortify-BkRfbJX2.png`,"./assets-legacy/cards/frenzy.png":`/assets/frenzy-CGalx6yi.png`,"./assets-legacy/cards/guardedStrike.png":`/assets/guardedStrike-BdR_uaIb.png`,"./assets-legacy/cards/heavyBlow.png":`/assets/heavyBlow-CYt4fsXe.png`,"./assets-legacy/cards/hex.png":`/assets/hex-DQOXXUM_.png`,"./assets-legacy/cards/ironSkin.png":`/assets/ironSkin-VaZo9AQM.png`,"./assets-legacy/cards/leechBlade.png":`/assets/leechBlade-BmS-D7fO.png`,"./assets-legacy/cards/limitBreak.png":`/assets/limitBreak-DN26OCuR.png`,"./assets-legacy/cards/lunge.png":`/assets/lunge-DmHAi-Ii.png`,"./assets-legacy/cards/momentum.png":`/assets/momentum-C6FA72BV.png`,"./assets-legacy/cards/nightSight.png":`/assets/nightSight-BMWfdlPA.png`,"./assets-legacy/cards/novaflare.png":`/assets/novaflare-BdlOFFUl.png`,"./assets-legacy/cards/oblivionStrike.png":`/assets/oblivionStrike-C7F5F5Eb.png`,"./assets-legacy/cards/offering.png":`/assets/offering-zAtpyRzi.png`,"./assets-legacy/cards/phantomBlades.png":`/assets/phantomBlades-DJiR4Y_z.png`,"./assets-legacy/cards/preparation.png":`/assets/preparation-Ds_IIj15.png`,"./assets-legacy/cards/pyreheart.png":`/assets/pyreheart-CnjhL-zh.png`,"./assets-legacy/cards/quakeblow.png":`/assets/quakeblow-C_eEICkm.png`,"./assets-legacy/cards/quickSlash.png":`/assets/quickSlash-CvlMKC0t.png`,"./assets-legacy/cards/regrowth.png":`/assets/regrowth-CBSeTuC1.png`,"./assets-legacy/cards/resonantLance.png":`/assets/resonantLance-Cfl2sj_6.png`,"./assets-legacy/cards/shardstorm.png":`/assets/shardstorm-CvTOZJ0-.png`,"./assets-legacy/cards/sidestep.png":`/assets/sidestep-Bj3qTCjM.png`,"./assets-legacy/cards/smother.png":`/assets/smother-bz2TFsma.png`,"./assets-legacy/cards/strike.png":`/assets/strike-dSCmD_GC.png`,"./assets-legacy/cards/surge.png":`/assets/surge-DzLcy2w-.png`,"./assets-legacy/cards/tempest.png":`/assets/tempest-CsyJhd10.png`,"./assets-legacy/cards/tithe.png":`/assets/tithe-DYMJcQLp.png`,"./assets-legacy/cards/toxicMist.png":`/assets/toxicMist-B8tOUwCR.png`,"./assets-legacy/cards/twinFangs.png":`/assets/twinFangs-CTQywNpA.png`,"./assets-legacy/cards/uppercut.png":`/assets/uppercut-CCTgShM_.png`,"./assets-legacy/cards/venomStrike.png":`/assets/venomStrike-C9IMQNTW.png`,"./assets-legacy/cards/virulence.png":`/assets/virulence-BEwD0i3o.png`,"./assets-legacy/cards/warCry.png":`/assets/warCry-DeiW2MRp.png`,"./assets-legacy/cards/wound.png":`/assets/wound-DAh7QhIS.png`,"./assets-legacy/enemies/abyssalKnight.png":`/assets/abyssalKnight-C-E-itbM.png`,"./assets-legacy/enemies/alphaFang.png":`/assets/alphaFang-DdGpQqF8.png`,"./assets-legacy/enemies/ashAcolyte.png":`/assets/ashAcolyte-BBrUUe1I.png`,"./assets-legacy/enemies/chaosHound.png":`/assets/chaosHound-D1R2CoW1.png`,"./assets-legacy/enemies/deepmaw.png":`/assets/deepmaw-la4seO5f.png`,"./assets-legacy/enemies/drownedOne.png":`/assets/drownedOne-BUBzJWlu.png`,"./assets-legacy/enemies/duskfang.png":`/assets/duskfang-CHUmjhPP.png`,"./assets-legacy/enemies/gloomslime.png":`/assets/gloomslime-BNhQuFFa.png`,"./assets-legacy/enemies/gravewarden.png":`/assets/gravewarden-BC9T04oe.png`,"./assets-legacy/enemies/heraldOfEnd.png":`/assets/heraldOfEnd-DZZiCKi_.png`,"./assets-legacy/enemies/leviathan.png":`/assets/leviathan-BhXEnJxl.png`,"./assets-legacy/enemies/mirelurker.png":`/assets/mirelurker-DidtJkek.png`,"./assets-legacy/enemies/obsidianGolem.png":`/assets/obsidianGolem-DkurqVoj.png`,"./assets-legacy/enemies/rootheart.png":`/assets/rootheart-B4o9Bf9P.png`,"./assets-legacy/enemies/shade.png":`/assets/shade-C2XrmBs-.png`,"./assets-legacy/enemies/shellback.png":`/assets/shellback-DCHXMl3u.png`,"./assets-legacy/enemies/siren.png":`/assets/siren-GVK3WWGi.png`,"./assets-legacy/enemies/sovereign.png":`/assets/sovereign-0p3wfa6T.png`,"./assets-legacy/enemies/sporeling.png":`/assets/sporeling-BeOaEEL0.png`,"./assets-legacy/enemies/starCultist.png":`/assets/starCultist-DQHXdHm5.png`,"./assets-legacy/enemies/thornling.png":`/assets/thornling-CqSviePj.png`,"./assets-legacy/enemies/tidecaller.png":`/assets/tidecaller-tGjufTlQ.png`,"./assets-legacy/enemies/voidColossus.png":`/assets/voidColossus-yr_eofA0.png`,"./assets-legacy/enemies/voidWisp.png":`/assets/voidWisp-D_7XlB9X.png`,"./assets-legacy/enemies/voltEel.png":`/assets/voltEel-CJeHty9B.png`,"./assets-legacy/enemies/watcherEye.png":`/assets/watcherEye---WypZip.png`,"./assets-legacy/enemies/waylayer.png":`/assets/waylayer-qynHTjuH.png`,"./assets-legacy/events/cursedIdol.png":`/assets/cursedIdol--s0qHWso.png`,"./assets-legacy/events/emberFountain.png":`/assets/emberFountain-D_Q0157p.png`,"./assets-legacy/events/fleshTrader.png":`/assets/fleshTrader-q8lAx2oa.png`,"./assets-legacy/events/forge.png":`/assets/forge-i5xE2DIv.png`,"./assets-legacy/events/forgottenShrine.png":`/assets/forgottenShrine-CYFo9R9B.png`,"./assets-legacy/events/gambler.png":`/assets/gambler-D4lmA3Yw.png`,"./assets-legacy/events/library.png":`/assets/library-CstvhNks.png`,"./assets-legacy/events/mirror.png":`/assets/mirror-Hp5O4ZPJ.png`,"./assets-legacy/events/ruinedCamp.png":`/assets/ruinedCamp-BvAZgrK0.png`,"./assets-legacy/events/voidChest.png":`/assets/voidChest-B34oBTge.png`,"./assets-legacy/events/woundedKnight.png":`/assets/woundedKnight-JN7kYI1u.png`,"./assets-legacy/heroes/ashwarden.png":`/assets/ashwarden-BjFdmgoK.png`,"./assets-legacy/heroes/duskblade.png":`/assets/duskblade-DBhvpfoa.png`,"./assets-legacy/potions/block.png":`/assets/block-CkTqIuTb.png`,"./assets-legacy/potions/energy.png":`/assets/energy-BNM23nR-.png`,"./assets-legacy/potions/fire.png":`/assets/fire-CAaEe0xi.png`,"./assets-legacy/potions/healing.png":`/assets/healing-KDHGTVtG.png`,"./assets-legacy/potions/strength.png":`/assets/strength-CIdQsSW6.png`,"./assets-legacy/potions/swift.png":`/assets/swift-xz-qROFX.png`,"./assets-legacy/potions/venom.png":`/assets/venom-D3l_eMKx.png`,"./assets-legacy/props/campfire.png":`/assets/campfire-B-OrO4zT.png`,"./assets-legacy/props/chest-open.png":`/assets/chest-open-B5Uzt-_6.png`,"./assets-legacy/props/chest.png":`/assets/chest-b-PO08AA.png`,"./assets-legacy/props/merchant.png":`/assets/merchant-COlFp5u3.png`,"./assets-legacy/title-background/background.png":`/assets/background-CqhrXvXS.png`,"./assets-nano-banana/cards/ashBite.jpg":`/assets/ashBite-Hi1YEUgO.jpg`,"./assets-nano-banana/cards/chisel.jpg":`/assets/chisel-BenJ1en4.jpg`,"./assets-nano-banana/cards/defend.jpg":`/assets/defend-BVv4Fhik.jpg`,"./assets-nano-banana/cards/eclipseSlash.jpg":`/assets/eclipseSlash-SOKSyKvC.jpg`,"./assets-nano-banana/cards/firstSpark.jpg":`/assets/firstSpark-BmnO3NFn.jpg`,"./assets-nano-banana/cards/heavyBlow.jpg":`/assets/heavyBlow-_4Gucjo7.jpg`,"./assets-nano-banana/cards/quickSlash.jpg":`/assets/quickSlash-u_QGR1-b.jpg`,"./assets-nano-banana/cards/smother.jpg":`/assets/smother-BKUtvsOz.jpg`,"./assets-nano-banana/cards/strike.jpg":`/assets/strike-BhuXr3c8.jpg`,"./assets-nano-banana/cards/twinFangs.jpg":`/assets/twinFangs-BCU-7hQ1.jpg`}),Xp=[`png`,`jpg`,`jpeg`,`webp`],Zp={live:{label:`Live`,root:`assets`},"nano-banana":{label:`Nano Banana Pro`,root:`assets-nano-banana`},"gpt-nano-pass":{label:`GPT -> Nano Pass`,root:`assets-gpt-nano-pass`},legacy:{label:`Legacy`,root:`assets-legacy`}},Qp=`live`,$p=(e=Qp)=>Zp[e]??Zp[Qp],em=()=>Object.keys(Zp),tm=(e=Qp)=>$p(e).label,nm=(e,t,n=Qp)=>{let{root:r}=$p(n);for(let n of Xp){let i=Yp[`./${r}/${e}/${t}.${n}`];if(i)return i}return null},rm=(e,t=Qp)=>{let{root:n}=$p(t);return Object.entries(Yp).filter(([t])=>t.startsWith(`./${n}/${e}/`)).map(([,e])=>e)},im=0,am=()=>`g${++im}`,K=(e,t,n,r=1)=>`hsla(${e},${t}%,${n}%,${r})`;function om(e,t,n){return`<defs>
  ...
  </defs>`}var sm=`stroke="#070a12" stroke-width="3.6" paint-order="stroke" stroke-linejoin="round"`;function cm(e){return e.replace(/<path(?![^>]*stroke=)(?![^>]*fill="none")([^>]*?)\/>/g,`<path$1 ${sm}/>`).replace(/<(circle|ellipse)([^>]*fill="url\(#[^"]+[bd]\)"[^>]*?)\/>/g,(e,t,n)=>n.includes(`stroke=`)?e:`<${t}${n} ${sm}/>`)}function lm(e=!1){let t=58+Math.random()*84,n=55+Math.random()*80,r=``,i=e?5:3;for(let a=0;a<i;a++){let i=Math.random()*Math.PI*2,a=t,o=n;r+=`M${a.toFixed(1)} ${o.toFixed(1)}`;let s=3+Math.floor(Math.random()*3);for(let t=0;t<s;t++){let t=(e?15:10)*(.6+Math.random());i+=(Math.random()-.5)*1.15,a+=Math.cos(i)*t,o+=Math.sin(i)*t,r+=`L${a.toFixed(1)} ${o.toFixed(1)}`}}return`<g class="crack"><path d="${r}" stroke="#0a0d18" stroke-width="3" fill="none" opacity=".75"/><path d="${r}" stroke="#dfeaff" stroke-width="1.3" fill="none" opacity=".8"/></g>`}var q=(e,t,n,r)=>`<circle class="eye" cx="${e}" cy="${t}" r="${n}" fill="${r}"/><circle cx="${e}" cy="${t}" r="${n*2.2}" fill="${r}" opacity="0.18"/>`,um={wisp(e,t,n){return`<g class="breathe">
    ...
    </g>`}};function dm(e){let t=am(),n=K(e.hue,90,66),r=cm((um[e.kind]||um.slime)(t,e.hue,n));return`<svg class="enemy-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${om(t,e.hue,n)}
    ...
    ${r}
    <g class="cracks"></g>
  </svg>`}var fm=[{hue:225,glow:`#7fd4ff`},{hue:26,glow:`#ffb15a`}];function pm(e=0){let t=am(),n=fm[e]||fm[0],r=n.hue,i=n.glow;return`<svg class="hero-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${om(t,r,i)}
    ...
    <g class="cracks"></g>
  </svg>`}var mm={strike:`⚔`,defend:`⛨`,eclipseSlash:`☾`,twinFangs:`⑂`,quickSlash:`≫`,heavyBlow:`⬇`,cleave:`⋔`,venomStrike:`☠`,lunge:`➹`,guardedStrike:`⛊`,brace:`⛨`,sidestep:`↯`,preparation:`♻`,deflect:`⛉`,leechBlade:`♆`,tempest:`≋`,uppercut:`⇑`,flurry:`⁂`,executioner:`✠`,momentum:`⤴`,bulwark:`☗`,surge:`✦`,toxicMist:`☁`,cripple:`⛓`,warCry:`♯`,fortify:`⧉`,bloodRite:`♥`,empower:`⚔`,agility:`❥`,ironSkin:`⬡`,regrowth:`❋`,oblivionStrike:`✸`,phantomBlades:`⚚`,devour:`♅`,annihilate:`✹`,aegis:`⛨`,offering:`♱`,limitBreak:`⚡`,catalyst:`⚗`,ascension:`☽`,bastion:`♜`,frenzy:`※`,virulence:`☣`,wound:`✂`,burn:`✹`,hex:`♄`,chisel:`◬`,firstSpark:`✧`,ashBite:`☄`,smother:`☁`,quakeblow:`⬲`,resonantLance:`↟`,tithe:`⚖`,pyreheart:`♥`,ashenChoir:`♬`,flawlessForm:`❖`,nightSight:`☾`,novaflare:`✺`,emberdance:`❂`,shardstorm:`❉`},hm=e=>{let t=9;for(let n of e)t=Math.imul(t^n.charCodeAt(0),387420489);return(t^t>>>9)>>>0};function gm(e,t){let n=am(),r=hm(e),i={attack:356,skill:205,power:268,status:160,curse:300}[t]??205,a=(i+30+r%40)%360,o=K(i,85,66),s=K(a,80,60),c=r%360,l=``;if(t===`attack`)l=`<path d="M30 120 Q75 40 150 28" stroke="${o}" stroke-width="7" fill="none" opacity=".9"/>
      ...
      <path d="M62 106 L118 50" stroke="${s}" stroke-width="5" opacity=".7"/>`;let u=mm[e]||`✦`;return`<svg viewBox="0 0 180 150" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}function _m(e){let t=am();return`<svg viewBox="0 0 40 52" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function vm(e=!1){let t=am();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function ym(){let e=am();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}function bm(){let e=am();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    ${om(e,40,`#ffd166`)}
  ...
  </svg>`}function xm(e,t){let n=am(),r=K(t,80,66);return`<svg viewBox="0 0 220 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
    ...
    <div class="card-rarity"></div>
      ...
      <div class="hud-right">
        ${t.potions.map((e,t)=>`<button class="potion-slot ${e?`full`:``}" data-slot="${t}">${e?ch(`potions`,e,_m(Ul[e].tone)):``}</button>`).join(``)}
    ...
    <div id="relicbar"></div>`;let i=Q(`#relicbar`,e),a=Yl[Z.run.omens?.[Z.run.act]];if(a){let e=$(`div`,`relic-chip omen-chip`,J(`omen-${Z.run.omens[Z.run.act]}`,18));e.style.setProperty(`--tone`,a.tone),e._tip={title:`Omen — ${a.name}`,body:a.text,sub:`hangs over Act ${Z.run.act+1}`},i.appendChild(e)}for(let e of t.relics){let t=Vl[e],n=$(`div`,`relic-chip`,lh(e,20));n.style.setProperty(`--tone`,t.tone),n.dataset.relic=e,n._tip={title:t.name,body:t.text,sub:t.rarity},i.appendChild(n)}t.potions.forEach((t,n)=>{if(!t)return;let r=Q(`.potion-slot[data-slot="${n}"]`,e);r._tip={title:Ul[t].name,body:Ul[t].text,sub:`Click to use or toss`}}),Q(`[data-act="deck"]`,e).onclick=()=>{X.click(),Oh(`Your Deck`,Z.run.player.deck,{sub:`${Z.run.player.deck.length} cards`})},Q(`[data-act="menu"]`,e).onclick=e=>{X.click(),bh(e.clientX,e.clientY)},ih(`.potion-slot.full`,e).forEach(e=>e.onclick=t=>Ch(+e.dataset.slot,t))}function bh(e,t){xh();let n=$(`div`,`pop-menu`);n.innerHTML=`<button data-m="help">How to Play</button><button data-m="mute">${Jm()?`Unmute`:`Mute`} Sound</button><button data-m="abandon" style="color:#ff8d8d">Abandon Run</button>`,document.body.appendChild(n),n.style.left=`${Math.min(e,innerWidth-200)}px`,n.style.top=`${t+8}px`,n.onclick=e=>{let t=e.target.dataset.m;xh(),t===`help`&&kh(),t===`mute`&&Ym(),t===`abandon`&&Th()},setTimeout(()=>document.addEventListener(`pointerdown`,Sh,{once:!0}),0)}var xh=()=>ih(`.pop-menu`).forEach(e=>e.remove()),Sh=e=>{e.target.closest(`.pop-menu`)||xh()};function Ch(e,t){if(Z.busy)return;xh();let n=Z.run.player.potions[e];if(!n)return;let r=Ul[n],i=Z.cb&&!Z.cb.over&&Z.screen===`combat`,a=!r.combatOnly||i,o=$(`div`,`pop-menu`);o.innerHTML=`<button data-m="use" ${a?``:`disabled style="opacity:.4"`}>Use ${r.name}</button><button data-m="toss">Toss it</button>`,document.body.appendChild(o),o.style.left=`${Math.min(t.clientX-60,innerWidth-220)}px`,o.style.top=`${t.clientY+10}px`,o.onclick=async t=>{let n=t.target.dataset.m;if(xh(),n===`toss`&&(Z.run.player.potions[e]=null,X.card(),yh(),Up(Z.run)),n===`use`&&a)if(r.needsTarget&&i){let t=Z.cb.enemies.filter(e=>e.hp>0);if(t.length===1)return wh(e,t[0].idx);ug({kind:`potion`,slot:e})}else wh(e,null)},setTimeout(()=>document.addEventListener(`pointerdown`,Sh,{once:!0}),0)}async function wh(e,t){dg(),X.potion(),Z.cb&&!Z.cb.over&&Z.screen===`combat`?(kp(Z.run,Z.cb,e,t),await Ig(),zg()):(kp(Z.run,null,e,null),yh(),Up(Z.run))}function Th(){Eh(`<div class="panel ov-panel" style="text-align:center">
  ...
  </div>`,e=>{e.onclick=e=>{let t=e.target.dataset.a;t===`yes`&&(qp(Z.run,!1),Z.run=null,Z.cb=null,Dh(),eh(),jh(`title`)),t===`no`&&Dh()}})}function Eh(e,t=null,n=!1){let r=Q(`#overlay`);r.innerHTML=e,r.classList.add(`open`),r._closable=n,t&&t(r.firstElementChild)}function Dh(){let e=Q(`#overlay`);e.classList.remove(`open`),e.innerHTML=``}function Oh(e,t,{sub:n=``,pick:r=null,canSkip:i=!1,skipLabel:a=`Skip`,inCombat:o=!1}={}){let s=$(`div`,`panel ov-panel`);s.innerHTML=`<div class="ov-title">${e}</div>${n?`<div class="ov-sub">${n}</div>`:``}`;let c=$(`div`,`card-grid ${r?`choice-cards`:``}`),l=r?t:[...t].sort((e,t)=>Ff(e).name.localeCompare(Ff(t).name));for(let e of l){let t=_h(e,{inCombat:o});r&&(t.onclick=()=>{X.click(),t.classList.add(`picked`),setTimeout(()=>{Dh(),r(e)},240)}),c.appendChild(t)}s.appendChild(c);let u=$(`div`,`ov-actions`);if(i&&r){let e=$(`button`,`btn ghost`,a);e.onclick=()=>{X.click(),Dh(),r(null)},u.appendChild(e)}if(!r){let e=$(`button`,`btn ghost`,`Close`);e.onclick=()=>{X.click(),Dh()},u.appendChild(e)}s.appendChild(u),Eh(``,null,!r),Q(`#overlay`).appendChild(s)}function kh(){Eh(`<div class="panel ov-panel howto">
  ...
  </div>`,e=>{Q(`[data-a="ok"]`,e).onclick=()=>{X.click(),Dh()}},!0)}function Ah(){if(_g)return;let e=Q(`#wipe`);e.classList.remove(`go`),e.offsetWidth,e.classList.add(`go`),setTimeout(()=>e.classList.remove(`go`),620)}function jh(e,t){Z.screen!==e&&Z.run&&Ah(),Z.screen=e,xh(),Q(`#tooltip`).style.display=`none`,e!==`map`&&(Zu(),nd());let n=oh();n.className=``,n.onclick=null,{title:Nh,map:zh,combat:()=>{},reward:Hg,rest:Kg,shop:Jg,event:Yg,treasure:qg,bossRelic:Ug,end:$g}[e](t),e===`map`&&fh(),e!==`combat`&&e!==`title`&&xf(),yh()}var Mh=[`0`,`I`,`II`,`III`,`IV`,`V`];function Nh(){eh(),cd(0);let e=Fm(),t=Wp(),n=Z.title||={aspect:0,vow:0};n.aspect>0&&$l[n.aspect].unlock&&!e.unlocks.includes($l[n.aspect].unlock)&&(n.aspect=0),n.vow=Math.max(0,Math.min(n.vow|0,e.vowUnlocked));let r=e.deeds,i=$l.map((t,r)=>{let i=r>0&&t.unlock&&!e.unlocks.includes(t.unlock);return`<button class="aspect-card${n.aspect===r?` on`:``}${i?` locked`:``}" data-a="asp" data-i="${r}"${i?` disabled`:``}>
      <div class="asp-hero">${uh(r)}</div>
      <div class="asp-name">${t.name}${i?` 🔒`:``}</div>
      <div class="asp-blurb">${i?`Reach the first dawn to walk as the Ashwarden.`:t.blurb}</div>
    </button>`}).join(``),a=n.vow===0?`The Spire as it is. No vows sworn.`:eu.slice(0,n.vow).map(e=>`<b style="color:#ff9a4d">${e.name}</b> — ${e.desc}`).join(`<br>`),o=e.vowUnlocked>0?`<div class="vow-block">
      <div class="vow-stepper">
        <button class="vow-btn" data-a="vow-"${n.vow===0?` disabled`:``}>−</button>
        <div class="vow-level">VOW ${Mh[n.vow]}<span class="vow-max"> / ${Mh[e.vowUnlocked]||`0`}</span></div>
        <button class="vow-btn" data-a="vow+"${n.vow<e.vowUnlocked?``:` disabled`}>+</button>
      </div>
      <div class="vow-desc">${a}</div>
    </div>`:``,s=nm(`title-background`,`background`),c=nm(`title`,`title`),l=oh();l.innerHTML=`<div class="title-screen screen-enter">
    ...
    <div class="title-btns">
      ...
      <button class="btn ghost" data-a="mute">${Jm()?`Unmute`:`Mute`}</button>
    </div>
    <div class="title-stats">${r.runs} climbs · ${r.wins} dawns · ${r.slain} slain${e.unlocks.length?` · ${e.unlocks.length} secrets unearthed`:``}</div>
  </div>`,l.onclick=r=>{let i=r.target.closest(`[data-a]`);if(!i||i.disabled)return;let a=i.dataset.a;qm(),X.click(),a===`asp`?(n.aspect=+i.dataset.i,Nh()):a===`vow-`?(n.vow=Math.max(0,n.vow-1),Nh()):a===`vow+`?(n.vow=Math.min(e.vowUnlocked,n.vow+1),Nh()):a===`new`?(t&&Gp(),Fh(kf(void 0,{aspect:n.aspect,vow:n.vow,lamplighter:!0,monument:e.lastFall}))):a===`continue`&&t?Fh(t,!0):a===`vigil`?Ph():a===`help`?kh():a===`mute`&&(Ym(),Nh())},Sg()}function Ph(){let e=Mm(),t=Object.values(Ql).map(t=>{let n=e.deeds[t.stat]||0,r=n>=t.n,i=Math.min(100,Math.round(n/t.n*100)),a=t.unlocks.map(e=>{if(e===`aspect2`)return`The Ashwarden`;let[t,n]=e.split(`:`);return t===`card`?Rl[n]?.name||n:Vl[n]?.name||n}).join(`, `);return`<div class="deed-row${r?` done`:``}">
    ...
    </div>`}).join(``);Eh(`<div class="panel ov-panel vigil-panel">
    <div class="ov-title">The Vigil</div>
    <div class="ov-sub">${e.deeds.runs} climbs · ${e.deeds.wins} dawns · deepest Vow: ${Mh[e.deeds.bestVow]||`—`}</div>
    <div class="deed-list">${t}</div>
    <div class="ov-actions"><button class="btn" data-a="ok">Close</button></div>
  </div>`,e=>{Q(`[data-a="ok"]`,e).onclick=()=>{X.click(),Dh()}},!0)}function Fh(e,t=!1){Z.run=e,Z.cb=null,cd(e.act);let n=e.nodeId?e.map.nodes.find(t=>t.id===e.nodeId):null;if(Yu(e.act,n?n.row:0),$m(e.act),t||Up(e),t&&e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);Z.screen=`combat`,Hh(ep(e,e.pendingCombat,t?t.row:5),e.pendingCombat),yh();return}if(e.pendingLamplighter){Ih();return}jh(`map`),t||setTimeout(()=>Gg(e),900)}function Ih(){let e=Z.run;if(Z.screen!==`lamplighter`&&Ah(),Z.screen=`lamplighter`,xh(),nd(),cd(0),oh().className=``,!Z.lamp){let t=If(e),n=Object.keys(tu),r=[];for(;r.length<3&&n.length;)r.push(n.splice(Math.floor(t()*n.length),1)[0]);Z.lamp={boons:r,boon:null,art:e.art},Up(e)}let t=Z.lamp,n=$l[e.aspect],r=t.boons.map(e=>{let n=tu[e];return`<button class="lamp-boon${t.boon===e?` on`:``}" data-a="boon" data-i="${e}">
      <div class="lb-name">${J(`boon-${e}`,20)} ${n.name}</div><div class="lb-text">${gh(n.text)}</div>
    </button>`}).join(``),i=Object.keys(Zl).map(e=>{let n=Zl[e];return`<button class="lamp-art${t.art===e?` on`:``}" data-a="art" data-i="${e}">
      <span class="la-glyph" style="color:${n.tone}">${J(`art-${e}`,18)}</span><span class="la-name">${n.name}</span>
    </button>`}).join(``),a=Zl[t.art],o=oh();o.innerHTML=`<div class="lamp-screen screen-enter">
    <div class="lamp-hero">${uh(e.aspect)}</div>
    ...
    <div class="lamp-art-desc">${a?`<b style="color:${a.tone}">${J(`art-${t.art}`,15)} ${a.name}</b> · ${gh(a.text)}`:``}</div>
    <div class="lamp-actions"><button class="btn" data-a="begin"${t.boon?``:` disabled`}>${t.boon?`Light the Way`:`Choose a boon`}</button></div>
  </div>`,yh(),o.onclick=e=>{let n=e.target.closest(`[data-a]`);if(!n||n.disabled)return;let r=n.dataset.a;qm(),X.click(),r===`boon`?(t.boon=n.dataset.i,Ih()):r===`art`?(t.art=n.dataset.i,X.hover(),Ih()):r===`begin`&&t.boon&&Lh()}}function Lh(){let e=Z.run,t=Z.lamp;e.art=t.art,e.boon=t.boon,Jp(e,tu[t.boon].ops),delete e.pendingLamplighter,Z.lamp=null,X.relic(),Up(e),jh(`map`),setTimeout(()=>Gg(e),900)}var Rh={monster:`sword`,elite:`skull`,event:`question`,rest:`flame`,shop:`coin`,treasure:`chest`,boss:`crown`,monument:`monument`};function zh(){let e=Z.run;if(e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);Z.screen=`combat`,Hh(ep(e,e.pendingCombat,t?t.row:5),e.pendingCombat);return}Up(e),Z.cb=null;let{nodes:t}=e.map,n=new Set(Rf(e).map(e=>e.id)),r=new Set(e.map.visited),i=e.nodeId?t.find(t=>t.id===e.nodeId).row:-1,a=``,o=``;for(let e of t)for(let t of e.next){let n=r.has(e.id)&&r.has(t)?`walked`:``;a+=`<path class="medge ${n}" style="--d:${e.row*34}ms" data-a="${e.id}" data-b="${t}" d="M0 0"/>`}for(let i of t){let t=i.unlit&&!r.has(i.id),a=[`mnode`,`type-${i.type}`,t?`unlit`:``,r.has(i.id)?`visited`:``,i.id===e.nodeId?`current`:``,n.has(i.id)?`avail`:``].join(` `),s=nh?1.3:1,c=(i.type===`boss`?26:i.type===`elite`||i.type===`treasure`?19:16)*s,l=Math.round((i.type===`boss`?26:i.type===`elite`||i.type===`treasure`?20:17)*s);o+=`<g class="${a}" data-node="${i.id}" style="--d:${i.row*34}ms">
      <g class="nwrap"><circle class="bg" r="${t?16*s:c}"/><g class="icg">${Tm(t?`unlitLantern`:Rh[i.type],t?Math.round(17*s):l)}</g></g>
    </g>`}let s=Ll[e.act],c=Yl[e.omens?.[e.act]];oh().innerHTML=`
    ...
    <div class="map-screen screen-enter">
      ...
      <div class="map-hint">${nh?`drag`:`scroll`} to survey the Spire</div>
    </div>`;let l=Q(`.map-svg`),u=!1;l.onclick=e=>{if(u)return;let n=e.target.closest(`.mnode.avail`);!n||Z.busy||(qm(),Bh(t.find(e=>e.id===n.dataset.node)))},ih(`.mnode`,l).forEach(i=>{let a=t.find(e=>e.id===i.dataset.node),o={monster:`Monster`,elite:`Elite — beware`,event:`Unknown event`,rest:`Rest site`,shop:`Merchant`,treasure:`Treasure`,boss:Ll[e.act].bossName};i._tip=a.unlit&&!r.has(a.id)?{title:`An unlit lantern`,body:`What waits here is unknown — but first light pays a bounty of gold.${n.has(a.id)?` ${nh?`Tap`:`Click`} to travel here.`:``}`}:{title:o[a.type],body:n.has(a.id)?`${nh?`Tap`:`Click`} to travel here.`:``}});let d=t.map(t=>({id:t.id,pos:Fu(e.act,t)})),f=new Map(ih(`.mnode`,l).map(e=>[e.dataset.node,e])),p=new Set(t.filter(e=>!n.has(e.id)&&!r.has(e.id)).map(e=>e.id)),m=ih(`.medge`,l).map(e=>({p:e,a:e.dataset.a,b:e.dataset.b}));Xu(e.act,Math.max(0,i)),td(d,e=>{let t=new Map(e.map(e=>[e.id,e]));for(let[e,n]of f){let r=t.get(e);n.setAttribute(`transform`,`translate(${r.x.toFixed(1)},${r.y.toFixed(1)}) scale(${r.s.toFixed(3)})`),n.style.opacity=(r.fade*(p.has(e)?.4:1)).toFixed(3)}for(let{p:e,a:n,b:r}of m){let i=t.get(n),a=t.get(r),o=9*(i.s+a.s)/2;e.setAttribute(`d`,`M${i.x.toFixed(1)} ${i.y.toFixed(1)} Q${((i.x+a.x)/2).toFixed(1)} ${((i.y+a.y)/2+o).toFixed(1)} ${a.x.toFixed(1)} ${a.y.toFixed(1)}`),e.style.opacity=Math.min(i.fade,a.fade).toFixed(3)}});let h=Q(`.map-screen`);h.addEventListener(`wheel`,e=>{e.preventDefault(),Qu(-e.deltaY*.006)},{passive:!1});let g=null,_=0,v=0,y=0;h.addEventListener(`pointerdown`,e=>{e.pointerType!==`mouse`&&(cancelAnimationFrame(v),g=e.clientY,_=0,y=0,u=!1)}),h.addEventListener(`pointermove`,e=>{if(g==null||e.pointerType===`mouse`)return;let t=e.clientY-g;g=e.clientY,y+=Math.abs(t),y>14&&(u=!0),_=t,Qu(t*.014)});let b=e=>{if(g==null||e.pointerType===`mouse`)return;g=null;let t=()=>{_*=.93,!(Math.abs(_)<.5||Z.screen!==`map`)&&(Qu(_*.014),v=requestAnimationFrame(t))};v=requestAnimationFrame(t),setTimeout(()=>u=!1,80)};h.addEventListener(`pointerup`,b),h.addEventListener(`pointercancel`,b)}function Bh(e){let t=Z.run;X.map(),Yu(t.act,e.row);let{type:n,bounty:r}=zf(t,e);if(Up(t),r){X.coin();let t=Q(`.mnode[data-node="${e.id}"]`),n=t?(()=>{let e=t.getBoundingClientRect();return{x:e.left+e.width/2,y:e.top+e.height/2}})():{x:innerWidth/2,y:innerHeight/2};Ld(n.x,n.y-34,`+${r} ¤`,`goldf`),gg(n.x,n.y,120,30,{n:5,color:`#ffe9ac`,size:7,dur:620})}n===`monster`||n===`elite`||n===`boss`?(t.pendingCombat=n,Up(t),Hh(ep(t,n,e.row),n)):n===`rest`?jh(`rest`):n===`shop`?jh(`shop`):n===`treasure`?jh(`treasure`):n===`event`?jh(`event`,$f(t)):n===`monument`&&Vh(e)}function Vh(e){let t=Z.run,n=Bf(t);if(n&&Rm(),Up(t),n){X.relic();let t=n.kind===`relic`?Vl[n.id]?.name:n.kind===`card`?Rl[n.id]?.name:`${n.amount} gold`,r=Q(`.mnode[data-node="${e.id}"]`),i=r?(()=>{let e=r.getBoundingClientRect();return{x:e.left+e.width/2,y:e.top+e.height/2}})():{x:innerWidth/2,y:innerHeight/2};Ld(i.x,i.y-34,`✦ ${t}`,`goldf`),gg(i.x,i.y,innerWidth/2,innerHeight*.5,{n:8,color:`#ffe9ac`,size:8,dur:720}),hg(`THE STONE REMEMBERS`)}jh(`map`)}function Hh(e,t){if(Zu(),nd(),Q(`#tooltip`).style.display=`none`,Z.screen!==`combat`&&Ah(),Z.cb=tp(Z.run,e,t),Z.screen=`combat`,Uh(),yh(),t===`boss`){let e=$(`div`,`rose-window`,`<div class="rw-rings"></div><div class="rw-spokes"></div>`);oh().appendChild(e),setTimeout(()=>e.remove(),2300);let t=$(`div`,`turn-banner boss-banner`,Z.cb.enemies[0].name.toUpperCase());oh().appendChild(t),setTimeout(()=>t.remove(),2100),Md(`#1a0a20`,.5,.9),ud(1.6),X.bigDeath()}Ig().then(zg)}function Uh(){let e=Z.cb,t=oh();t.onclick=null;let n=`#${Ll[Z.run.act].theme.glow.toString(16).padStart(6,`0`)}`;t.innerHTML=`<div class="combat-screen screen-enter intro">
    ${[`backdrop`,`mid`,`ledge`].map(e=>{let t=nm(`stage`,`act${Z.run.act+1}-${e}`);return t?`<img class="sl sl-${e}" src="${t}" alt="" aria-hidden="true">`:``}).join(``)}
    <div class="stage-ledge" style="--ledge:${n}"></div>
    <div class="battlefield">
      <div class="player-zone">
        <div class="hero-wrap">
          <div class="hero-name">${$l[Z.run.aspect].name.toUpperCase()}</div>
          ${uh(Z.run.aspect)}
        </div>
    ...
    <div class="hand-zone"></div>
  </div>`;let r=Q(`.enemy-zone`,t),i={enemies:[],root:Q(`.combat-screen`,t)},a=e.affix?Xl[e.affix]:null;e.enemies.forEach((t,n)=>{let o=Wl[t.key],s=Kh(o,e.enemies.length),c=$(`div`,`enemy${o.elite?` elite-e`:``}${o.boss?` boss-e`:``}${a?` affixed`:``}`);a&&c.style.setProperty(`--affix-tone`,a.tone),c.dataset.idx=n,c.style.animationDelay=`${160+n*130}ms`,c.innerHTML=`<div class="intent"></div>
      <div class="enemy-art" style="width:${s}px;height:${s}px"><div class="enemy-sprite">${ch(`enemies`,t.key,dm(o.art))}</div><div class="dmg-preview"></div></div>
      ...
      <div class="status-row"></div>`,r.appendChild(c),i.enemies.push({root:c,art:Q(`.enemy-art`,c),intent:Q(`.intent`,c),fill:Q(`.fill`,c),ghost:Q(`.ghost`,c),hp:Q(`.hp-label`,c),block:Q(`.block-chip`,c),statuses:Q(`.status-row`,c),pv:Q(`.pv`,c),prev:Q(`.dmg-preview`,c),facets:Q(`.facet-row`,c)}),i.enemies[n].facets._tip={title:`Facets`,body:`Every creature is glass. Attacks that draw unblocked blood chip a facet; fill the gauge and the glass <b>shatters</b> — it loses its next action, is Cracked, and spills Embers into your lantern.`},a&&(Q(`.name`,c)._tip={title:`${a.name} — an elite's title`,body:a.text}),c.onclick=()=>lg(n),c.addEventListener(`pointerenter`,e=>{e.pointerType===`mouse`&&Z.targeting&&(c.classList.add(`target-hover`),sg())}),c.addEventListener(`pointerleave`,()=>{c.classList.remove(`target-hover`),sg()})}),i.pHp=Q(`.p-hp`,t),i.pFill=Q(`.player-zone .fill`,t),i.pGhost=Q(`.player-zone .ghost`,t),i.pBlock=Q(`.p-block`,t),i.pStatus=Q(`.p-status`,t),i.hero=Q(`.hero-wrap`,t),i.energy=Q(`.energy-orb`,t),i.endTurn=Q(`.end-turn`,t),i.hand=Q(`.hand-zone`,t),i.draw=Q(`.pile-draw`,t),i.discard=Q(`.pile-discard`,t),i.exhaust=Q(`.pile-exhaust`,t),i.lantern=Q(`.lantern-btn`,t);let o=Zl[Z.run.art];o&&(Q(`.lb-art`,i.lantern).innerHTML=`<i>${J(`art-${Z.run.art}`,16)}</i>${o.cost}`,Q(`.lb-art`,i.lantern).style.color=o.tone),i.lantern._tip={title:o?`Lantern Art — ${o.name}`:`The Lantern`,body:`${o?`<b>${o.cost} Embers, once a turn:</b> ${o.text}<br><br>`:``}The lantern holds the <b>Embers</b> spilled by shattered and slain glass. Drag any card onto it to <b>kindle</b> — burn the card away for an ember, once a turn. Curses refuse the fire.`,sub:`A · use Art`},i.lantern.onclick=async()=>{if(!(Z.busy||!Z.cb||Z.cb.over)){if(qm(),!dp(Z.run,Z.cb)){i.lantern.classList.add(`nope`),setTimeout(()=>i.lantern.classList.remove(`nope`),350),X.debuff();return}dg(),fp(Z.run,Z.cb),await Ig(),zg()}},Z.ce=i,yg(),xg(),setTimeout(()=>i.root.classList.remove(`intro`),1300),i.endTurn.onclick=mg,i.draw.onclick=()=>{X.click(),Oh(`Draw Pile`,e.draw,{sub:`Order hidden — shown alphabetically`,inCombat:!0})},i.discard.onclick=()=>{X.click(),Oh(`Discard Pile`,e.discard,{inCombat:!0})},i.exhaust.onclick=()=>{X.click(),Oh(`The Ashes`,e.exhaust,{sub:`Burned away — each fed the lantern an ember`,inCombat:!0})},i.root.addEventListener(`pointerdown`,e=>{e.target.closest(`.enemy`)||e.target.closest(`.card`)||(Z.targeting?dg():Z.hoveredCard!=null&&(Z.hoveredCard=null,$h()))}),Zh(),Qh()}var Wh=e=>zd(Z.ce.enemies[e].art),Gh=()=>zd(Z.ce.hero);function Kh(e,t){let n=Math.min(innerWidth*.31,240),r=(innerWidth-n-innerWidth*.08)/t-12,i=(e.boss?280:e.elite?230:185)*(e.art.size>=1.4?1:e.art.size<.8?.86:.95)*Math.min(e.art.size,1.45);return Math.round(Math.min(i,innerHeight*(e.boss?.34:.3),Math.max(72,r*(e.boss?1.12:1))))}var qh=0;addEventListener(`resize`,()=>{clearTimeout(qh),qh=setTimeout(()=>{let e=Z.cb,t=Z.ce;!e||!t||Z.screen!==`combat`||(e.enemies.forEach((n,r)=>{let i=Kh(Wl[n.key],e.enemies.length);t.enemies[r].art.style.width=t.enemies[r].art.style.height=`${i}px`}),$h(),xg())},120)});function Jh(e,t,n){e.innerHTML=``;for(let[n,r]of Object.entries(t)){if(!r)continue;let t=Bl[n]||{name:n,icon:`?`,kind:`buff`,desc:``},i=n===`str`&&r<0?`debuff`:t.kind,a=$(`span`,`schip ${i}`,`${Cm(`st-${n}`)?J(`st-${n}`,13):t.icon} <span class="n">${r}</span>`);a._tip={title:t.name,body:t.desc.replace(/\bN\b/g,r),sub:i===`debuff`?`Debuff`:`Buff`},e.appendChild(a)}}function Yh(e){let t=Z.cb,n=op(e),r=Fp(Z.run,t,e),i={attack:J(`sword`,19),block:J(`shield`,19),buff:J(`up`,19),debuff:J(`cloud`,19),heal:J(`plus`,19)}[n.intent]||J(`sword`,19),a=``;n.intent.startsWith(`attack`)&&(i=J(`sword`,19),a=r.times>1?`${r.dmg}×${r.times}`:`${r.dmg}`,n.intent===`attack_debuff`&&(i+=J(`cloud`,14)),n.intent===`attack_block`&&(i+=J(`shield`,14)),n.intent===`attack_buff`&&(i+=J(`up`,14)));let o=[];return r&&o.push(`attack for <b>${r.dmg}${r.times>1?`×${r.times}`:``}</b>`),n.block&&o.push(`gain Ward`),n.heal&&o.push(`heal itself`),n.fx?.some(e=>e.who===`player`)&&o.push(`afflict you`),n.fx?.some(e=>e.who!==`player`)&&o.push(`empower`),n.addCards&&o.push(`add ${n.addCards.n} ${Rl[n.addCards.id].name}s to your discard`),{icon:i,txt:a,tip:{title:n.name,body:`Intends to ${o.join(`, `)||`act`}.`}}}function Xh(e,t=0){if(e.facetMax>8)return`<span class="pipnum">${J(`facet`,11)} ${e.chips}${t?`<i>+${t}</i>`:``}/${e.facetMax}</span>`;let n=``;for(let r=0;r<e.facetMax;r++)n+=`<span class="pip${r<e.chips?` filled`:r<e.chips+t?` willchip`:``}"></span>`;return n}function Zh(){let e=Z.cb,t=Z.ce;if(!t)return;e.enemies.forEach((e,n)=>{let r=t.enemies[n],i=`${100*Math.max(0,e.hp)/e.maxHp}%`;if(r.fill.style.width=i,r.ghost.style.width=i,r.hp.textContent=`${Math.max(0,e.hp)}/${e.maxHp}`,r.block.classList.toggle(`zero`,e.block<=0),r.block.innerHTML=`${J(`shield`,13)} ${e.block}`,r.art.classList.toggle(`warded`,e.block>0),r.root.classList.toggle(`lowhp`,e.hp>0&&e.hp/e.maxHp<=.3),Jh(r.statuses,e.statuses,!1),e.hp>0?r.facets.innerHTML=Xh(e):r.facets.innerHTML=``,e.hp<=0&&r.root.classList.add(`gone`),e.hp>0&&e.flags.staggered)r.intent.className=`intent i-staggered`,r.intent.innerHTML=`<span class="ic">${J(`stagger`,19)}</span>STAGGERED`,r.intent._tip={title:`Staggered`,body:`The glass has shattered — this creature loses its next action while it reseams.`};else if(e.hp>0&&e.moveKey){let t=Yh(e);r.intent.className=`intent i-${op(e).intent}`,r.intent.innerHTML=`<span class="ic">${t.icon}</span>${t.txt}`,r.intent._tip=t.tip}else r.intent.innerHTML=``}),t.lantern&&(Q(`.lb-count`,t.lantern).textContent=e.embers,Q(`.lb-pips`,t.lantern).innerHTML=Array.from({length:e.emberCap},(t,n)=>`<span class="lbp${n<e.embers?` lit`:``}" style="--a:${Math.round(n/(e.emberCap-1)*280-140)}deg"></span>`).join(``),t.lantern.classList.toggle(`unlit`,e.embers===0),t.lantern.classList.toggle(`ready`,dp(Z.run,e)),t.lantern.classList.toggle(`art-spent`,e.artUsedTurn===e.turn&&!e.over));let n=e.player,r=`${100*Math.max(0,n.hp)/n.maxHp}%`;t.pFill.style.width=r,t.pGhost.style.width=r,t.pHp.textContent=`${Math.max(0,n.hp)}/${n.maxHp}`,t.pBlock.classList.toggle(`zero`,n.block<=0),t.pBlock.innerHTML=`${J(`shield`,13)} ${n.block}`,t.hero.classList.toggle(`warded`,n.block>0),t.hero.classList.toggle(`lowhp`,n.hp/n.maxHp<=.3),Jh(t.pStatus,n.statuses,!0),Q(`.num`,t.energy).textContent=n.energy,t.energy.classList.toggle(`spent`,n.energy===0);let i=Q(`.candles`,t.energy),a=Math.max(n.energyMax,n.energy);i.children.length!==a&&(i.innerHTML=Array.from({length:a},()=>`<span class="candle"></span>`).join(``)),[...i.children].forEach((e,t)=>e.classList.toggle(`lit`,t<n.energy)),Q(`.cnt`,t.draw).textContent=e.draw.length,Q(`.cnt`,t.discard).textContent=e.discard.length,Q(`.cnt`,t.exhaust).textContent=e.exhaust.length}function Qh(){let e=Z.cb,t=Z.ce;if(!t)return;let n=t.hand,r=new Map(ih(`.card`,n).map(e=>[e.dataset.uid,e])),i=new Set(e.hand.map(e=>String(e.uid)));for(let[e,t]of r)i.has(e)||t.remove();for(let t of e.hand)if(r.has(String(t.uid))){let e=_h(t,{inCombat:!0}),n=r.get(String(t.uid));n.replaceChildren(...e.childNodes),n.className=e.className+(n.classList.contains(`armed`)?` armed`:``),n.onclick=e=>{e.stopPropagation(),cg(t.uid)},rh&&(n.onmouseenter=()=>{Z.hoveredCard=t.uid,$h()},n.onmouseleave=()=>{Z.hoveredCard===t.uid&&(Z.hoveredCard=null),$h()})}else{let e=_h(t,{inCombat:!0});e.classList.add(`draw-in`),setTimeout(()=>e.classList.remove(`draw-in`),400),e.onclick=e=>{e.stopPropagation(),cg(t.uid)},rh&&(e.onmouseenter=()=>{Z.hoveredCard=t.uid,X.hover(),$h()},e.onmouseleave=()=>{Z.hoveredCard===t.uid&&(Z.hoveredCard=null),$h()}),tg(e,t.uid),n.appendChild(e)}$h()}function $h(){let e=Z.cb,t=Z.ce;if(!t)return;let n=e.hand.map(e=>String(e.uid)),r=new Map(ih(`.card`,t.hand).map(e=>[e.dataset.uid,e])),i=n.length,a=Math.min(112,640/Math.max(i,1),(innerWidth-246)/Math.max(i-1,1));n.forEach((t,n)=>{let o=r.get(t);if(!o)return;let s=e.hand[n],c=!Ff(s).unplayable&&(wp(Z.run,e,s)??99)<=e.player.energy;o.classList.toggle(`unplayable-now`,!c);let l=Z.targeting?.kind===`card`&&String(Z.targeting.uid)===t,u=Z.hoveredCard!=null&&String(Z.hoveredCard)===t,d=i>1?(n-(i-1)/2)*Math.min(5,42/i):0,f=(n-(i-1)/2)*a,p=Math.abs(d)*3.2;o.classList.toggle(`armed`,l),o.classList.toggle(`lifted`,u&&!Z.busy&&!l),o.style.transform=`translateX(calc(-50% + ${l?f*.4:f}px)) translateY(${p+26}px) rotate(${l?d*.5:d}deg)`,o.style.zIndex=u||l?40:20+n}),sg()}var eg=0;function tg(e,t){e.addEventListener(`pointerdown`,n=>{if(!(Z.busy||!Z.cb||Z.cb.over||!n.isPrimary||Z.drag)){Z.drag={uid:t,id:n.pointerId,x0:n.clientX,y0:n.clientY,live:!1,free:!1};try{e.setPointerCapture(n.pointerId)}catch{}}}),e.addEventListener(`pointermove`,n=>{let r=Z.drag;if(!(!r||r.uid!==t||n.pointerId!==r.id)){if(!r.live){r.y0-n.clientY>26&&ig(r,e);return}if(r.free){e.style.transform=`translate(calc(-50% + ${n.clientX-innerWidth/2}px), ${n.clientY-innerHeight+130}px) scale(1.12)`;let t=!!rg(n.clientX,n.clientY)?.closest(`.lantern-btn`);e.classList.toggle(`will-burn`,t),e.classList.toggle(`will-cast`,!r.kindleOnly&&!t&&n.clientY<ng())}else fg(n),og(n.clientX,n.clientY)}});let n=(n,r)=>{let i=Z.drag;if(!i||i.uid!==t||n.pointerId!==i.id||(Z.drag=null,!i.live))return;if(eg=performance.now(),e.classList.remove(`dragging`,`will-cast`,`will-burn`),Z.ce?.lantern?.classList.remove(`kindle-target`),r){dg(),$h();return}if(rg(n.clientX,n.clientY)?.closest(`.lantern-btn`)){let e=Z.cb.hand.find(e=>e.uid===t);if(e&&mp(Z.run,Z.cb,e)){dg(),ag(t);return}dg(),$h();return}if(i.kindleOnly){Z.hoveredCard=null,$h();return}if(i.free){n.clientY<ng()?pg(t,null):(Z.hoveredCard=null,$h());return}let a=document.elementFromPoint(n.clientX,n.clientY)?.closest(`.enemy`),o=a?+a.dataset.idx:-1,s=Z.cb.enemies.filter(e=>e.hp>0);o>=0&&Z.cb.enemies[o].hp>0?pg(t,o):s.length===1&&n.clientY<ng()?pg(t,s[0].idx):(dg(),$h())};e.addEventListener(`pointerup`,e=>n(e,!1)),e.addEventListener(`pointercancel`,e=>n(e,!0))}var ng=()=>Z.ce?.hand?Z.ce.hand.getBoundingClientRect().top-24:innerHeight-260,rg=(e,t)=>document.elementsFromPoint(e,t).find(e=>!e.closest(`.card`));function ig(e,t){let n=Z.cb,r=n.hand.find(t=>t.uid===e.uid);if(!r){Z.drag=null;return}let i=Ff(r);if(i.unplayable||wp(Z.run,n,r)>n.player.energy){if(mp(Z.run,n,r)){e.live=!0,e.free=!0,e.kindleOnly=!0,Z.hoveredCard=null,X.hover(),t.classList.add(`dragging`),Z.ce?.lantern?.classList.add(`kindle-target`);return}Z.drag=null,t.classList.add(`nope`),setTimeout(()=>t.classList.remove(`nope`),350),X.debuff();return}e.live=!0,Z.hoveredCard=null,X.hover(),mp(Z.run,n,r)&&Z.ce?.lantern?.classList.add(`kindle-target`),i.target===`enemy`?ug({kind:`card`,uid:e.uid}):(e.free=!0,dg(),t.classList.add(`dragging`))}async function ag(e){if(Z.hoveredCard=null,!gp(Z.run,Z.cb,e)){$h();return}await Ig(),zg()}function og(e,t){let n=document.elementFromPoint(e,t)?.closest(`.enemy`);Z.ce?.enemies.forEach(e=>e.root.classList.toggle(`target-hover`,e.root===n&&e.root.classList.contains(`targetable`))),sg()}function sg(){let e=Z.ce,t=Z.cb;if(!e||!t)return;let n=null;Z.targeting?.kind===`card`?n=t.hand.find(e=>e.uid===Z.targeting.uid):Z.drag?.live?n=t.hand.find(e=>e.uid===Z.drag.uid):Z.hoveredCard!=null&&!Z.busy&&(n=t.hand.find(e=>e.uid===Z.hoveredCard));let r=n?Ff(n):null,i=Z.targeting?.kind===`card`||Z.drag?.live&&!Z.drag.free,a=t.enemies.filter(e=>e.hp>0).length;t.enemies.forEach((o,s)=>{let c=e.enemies[s],l=null,u=!1;if(n&&!t.over&&o.hp>0&&!r.unplayable&&(r.target===`allEnemies`?l=Ip(Z.run,t,n,s):r.target===`enemy`&&(i||a===1)&&(l=Ip(Z.run,t,n,s),u=i&&a>1&&!c.root.classList.contains(`target-hover`))),l&&(l.total>0||l.chips>0)){let e=l.hits[0],t=l.hits.length===1&&e&&e.times>1?`${e.dmg}×${e.times}`:`${l.total}`;c.prev.innerHTML=(l.lethal?`${J(`skull`,15)} `:``)+(l.total>0?t:``)+(l.willShatter&&!u?` <span class="pv-shatter">${J(`stagger`,14)}</span>`:``),c.prev.classList.add(`show`),c.prev.classList.toggle(`dim`,u),c.prev.classList.toggle(`lethal`,l.lethal),c.root.classList.toggle(`marked`,l.lethal&&!u);let n=Math.min(o.hp,l.loss)/o.maxHp;c.pv.style.left=`${Math.max(0,o.hp-l.loss)/o.maxHp*100}%`,c.pv.style.width=`${n*100}%`,c.pv.classList.toggle(`show`,l.loss>0),c.facets.innerHTML=Xh(o,u?0:l.chips),c.facets.classList.toggle(`willshatter`,l.willShatter&&!u)}else c.prev.classList.remove(`show`,`lethal`,`dim`),c.root.classList.remove(`marked`),c.pv.classList.remove(`show`),o.hp>0&&(c.facets.innerHTML=Xh(o)),c.facets.classList.remove(`willshatter`)})}function cg(e){if(Z.busy||!Z.cb||Z.cb.over||performance.now()-eg<350)return;let t=Z.cb,n=t.hand.find(t=>t.uid===e);if(!n)return;if(nh&&Z.hoveredCard!==e&&!(Z.targeting?.kind===`card`&&Z.targeting.uid===e)){Z.hoveredCard=e,X.hover(),$h();return}let r=Ff(n),i=wp(Z.run,t,n),a=Q(`.card[data-uid="${e}"]`,Z.ce.hand);if(r.unplayable||i>t.player.energy){a?.classList.add(`nope`),setTimeout(()=>a?.classList.remove(`nope`),350),X.debuff();return}if(Z.targeting?.kind===`card`&&Z.targeting.uid===e)return dg();if(r.target===`enemy`){let n=t.enemies.filter(e=>e.hp>0);if(n.length===1)return void pg(e,n[0].idx);ug({kind:`card`,uid:e})}else pg(e,null)}function lg(e){if(!Z.targeting||Z.busy)return;let t=Z.cb.enemies[e];if(!t||t.hp<=0)return;let n=Z.targeting;n.kind===`card`?pg(n.uid,e):n.kind===`potion`&&wh(n.slot,e)}function ug(e){if(Z.targeting=e,Z.ce.root.classList.add(`targeting`),Z.cb.enemies.forEach((e,t)=>Z.ce.enemies[t].root.classList.toggle(`targetable`,e.hp>0)),$h(),document.addEventListener(`pointermove`,fg),fg._last)fg(fg._last);else{let e=Z.cb.enemies.findIndex(e=>e.hp>0);if(e>=0){let t=Wh(e);fg({clientX:t.x,clientY:t.y,synthetic:!0})}}}function dg(){Z.targeting=null,Q(`#aim`).innerHTML=``,document.removeEventListener(`pointermove`,fg),Z.ce&&(Z.ce.root.classList.remove(`targeting`),Z.ce.enemies.forEach(e=>e.root.classList.remove(`targetable`,`target-hover`)),$h()),vh()}function fg(e){if(e.synthetic||(fg._last=e),!Z.targeting)return;let t;if(Z.targeting.kind===`card`){let e=Q(`.card[data-uid="${Z.targeting.uid}"]`);t=e?zd(e):{x:innerWidth/2,y:innerHeight-200}}else t={x:innerWidth/2,y:60};let n=e.clientX,r=e.clientY,i=(t.x+n)/2,a=Math.min(t.y,r)-120;if(Q(`#aim`).innerHTML=`<path d="M${t.x} ${t.y-80} Q${i} ${a} ${n} ${r}" fill="none" stroke="rgba(255,89,100,.85)" stroke-width="4" stroke-dasharray="4 10" stroke-linecap="round"/>
    <circle cx="${n}" cy="${r}" r="9" fill="none" stroke="rgba(255,89,100,.95)" stroke-width="3"/>`,Z.ce?.hero){let e=zd(Z.ce.hero),t=Q(`#lantern`);t.style.setProperty(`--lx`,`${Math.round(e.x+(n-e.x)*.3)}px`),t.style.setProperty(`--ly`,`${Math.round(e.y+(r-e.y)*.3)}px`)}}async function pg(e,t){dg(),Z.hoveredCard=null,Ep(Z.run,Z.cb,e,t)&&(await Ig(t),zg())}async function mg(){Z.busy||!Z.cb||Z.cb.over||(dg(),X.click(),Ap(Z.run,Z.cb),await Ig(),zg())}function hg(e){let t=$(`div`,`turn-banner`,e);oh().appendChild(t),setTimeout(()=>t.remove(),1150)}function gg(e,t,n,r,{n:i=6,color:a=`#ffe9ac`,size:o=8,dur:s=640,glyph:c=``,cls:l=`flymote`,done:u=null}={}){let d=Q(`#floaties`);for(let f=0;f<i;f++){let p=$(`div`,l,c);p.style.left=`${e}px`,p.style.top=`${t}px`,c?p.style.color=a:(p.style.width=`${o}px`,p.style.height=`${o}px`,p.style.background=`radial-gradient(circle at 35% 30%, #fff, ${a} 55%, transparent 85%)`),d.appendChild(p);let m=(e+n)/2+(Math.random()-.5)*140,h=Math.min(t,r)-50-Math.random()*80,g=p.animate([{transform:`translate(-50%,-50%) scale(0.5)`,opacity:0},{transform:`translate(calc(-50% + ${m-e}px), calc(-50% + ${h-t}px)) scale(1.05)`,opacity:1,offset:.45},{transform:`translate(calc(-50% + ${n-e}px), calc(-50% + ${r-t}px)) scale(0.55)`,opacity:.95}],{duration:s,delay:f*46,easing:`cubic-bezier(.32,.05,.35,1)`});g.onfinish=()=>{p.remove(),f===i-1&&u&&u()}}}var _g=matchMedia(`(prefers-reduced-motion: reduce)`).matches;function vg(e,t,n,r=640){if(t=Math.round(t),n=Math.round(n),_g||t===n){e.textContent=n;return}let i=performance.now(),a=o=>{let s=Math.min(1,(o-i)/r),c=1-(1-s)**3;e.textContent=Math.round(t+(n-t)*c),s<1?requestAnimationFrame(a):(e.textContent=n,e.classList.remove(`tick`),e.offsetWidth,e.classList.add(`tick`))};requestAnimationFrame(a)}function yg(){let e=Z.ce,t=Z.cb;e.rig=[];let n=(t,n,r,i,a,o,s=0)=>{let c=Q(`svg`,n),l=Q(`.enemy-sprite`,n)||n,u=Q(`.raster-art`,l);if(!c&&!u)return;let d=Math.random()*100;if(c){let e=Q(`.breathe`,c);e&&(e.style.animationDuration=`${(2.5+d%1.9).toFixed(2)}s`,e.style.animationDelay=`${(-(d%3.1)).toFixed(2)}s`,e.style.setProperty(`--brY`,(1.022+d%.024).toFixed(3)),e.style.setProperty(`--sw`,`${(d*7%1.7-.85).toFixed(2)}deg`)),ih(`.hover-float`,c).forEach(e=>e.style.animationDelay=`${(-(d%2.7)).toFixed(2)}s`)}else if(o&&(l.classList.add(`idle-${o}`),l.style.animationDelay=`${(-(d%2.8)).toFixed(2)}s`,o===`wisp`||o===`plant`)){let e=$(`div`,`idle-motes`);e.style.setProperty(`--mote`,`hsla(${s},85%,62%,0.6)`),l.appendChild(e)}let f=$(`div`,`lightpool`);f.style.background=`radial-gradient(ellipse at 50% 50%, ${r}, transparent 72%)`,n.appendChild(f),e.rig.push({root:t,art:n,sprite:l,svg:c,eyes:c?ih(`.eye`,c):[],fire:c?Q(`.innerfire`,c):null,pool:f,seed:d,isHero:i,idx:a,dx:0,dy:0})};t.enemies.forEach((t,r)=>{let i=Wl[t.key].art;n(e.enemies[r].root,e.enemies[r].art,`hsla(${i.hue},90%,66%,.72)`,!1,r,i.kind,i.hue)}),n(e.hero,e.hero,`rgba(127,212,255,.62)`,!0,0,`humanoid`,0)}function bg(){if(!$d())return;let e=Z.ce,t=Z.cb;if(!e||!t)return;let n=[],r=nm(`heroes`,$l[Z.run.aspect].id);r&&e.hero&&n.push({el:e.hero,url:r,kind:`humanoid`}),t.enemies.forEach((t,r)=>{let i=nm(`enemies`,t.key),a=e.enemies[r]?.art,o=a&&(Q(`.enemy-sprite`,a)||a);i&&o&&n.push({el:o,url:i,kind:Wl[t.key].art.kind})}),Sf(n)}function xg(){requestAnimationFrame(()=>requestAnimationFrame(bg))}function Sg(){xf()}function Cg(e){requestAnimationFrame(Cg);let t=Z.ce,n=Z.cb;if(_g||!n||Z.screen!==`combat`||!t?.rig)return;let r=null,i=n.enemies.findIndex(e=>e.hp>0);Z.targeting&&fg._last?r={x:fg._last.clientX,y:fg._last.clientY}:i>=0&&(r=Wh(i));let a=Gh();for(let i of t.rig){let t=i.isHero?n.player:n.enemies[i.idx];if(!i.isHero&&t.hp<=0){i.pool.style.opacity=0;continue}let o=i.isHero?r:a;if(o&&i.eyes.length){let e=zd(i.art),t=Math.atan2(o.y-e.y,o.x-e.x);i.dx+=(Math.cos(t)*2.4-i.dx)*.08,i.dy+=(Math.sin(t)*1.6-i.dy)*.08;let n=`translate(${i.dx.toFixed(2)}px,${i.dy.toFixed(2)}px)`;for(let e of i.eyes)e.style.transform=n}let s=.45+.55*(Math.max(0,t.hp)/t.maxHp);i.root.classList.contains(i.isHero?`lunge`:`acting`)&&(s+=1.1),(t.statuses?.str||0)>0&&(s+=.3);let c=.86+.14*Math.sin(e*.006+i.seed)*Math.sin(e*.0021+i.seed*3);i.fire&&(i.fire.style.opacity=Math.min(.55,(.05+.13*s)*c).toFixed(3)),i.pool.style.opacity=Math.min(.85,(.3+.4*s)*c).toFixed(3)}}var wg=!1,Tg={archetype:`slash`,cardId:null,enemyIdx:null},Eg=!1,Dg=!1,Og={beast:`slash`,rogue:`slash`,knight:`slash`,sovereign:`slash`,golem:`blunt`,treeboss:`blunt`,crab:`blunt`,leviathan:`blunt`,zombie:`blunt`,serpent:`pierce`,crawler:`pierce`,maw:`pierce`,plant:`pierce`,wisp:`void`,shade:`void`,eye:`void`,siren:`void`,cultist:`void`,slime:`poison`},kg=matchMedia(`(prefers-reduced-motion: reduce)`).matches,Ag=new Set([`golem`,`treeboss`,`leviathan`,`crab`]),jg=new Set([`wisp`,`shade`,`siren`,`eye`,`cultist`]);function Mg(e,t=1,n=`humanoid`){if(kg||!e)return Promise.resolve();let r=Ag.has(n),i=jg.has(n),a=r?10:i?26:34,o=[{transform:`translateX(0) scale(1,1)`},{transform:`translateX(${-8*t}px) scale(${r?1.03:.97},${r?.94:1.02})`,offset:.3},{transform:`translateX(${a*t}px) scale(1.02,0.99)`,offset:.62},{transform:`translateX(0) scale(1,1)`}];return e.animate(o,{duration:r?420:330,easing:`cubic-bezier(0.34, 1.56, 0.64, 1)`}).finished.catch(()=>{})}function Ng(e,t=1){kg||!e||e.animate([{transform:`translateX(0) scale(1,1)`,filter:`brightness(1)`},{transform:`translateX(${9*t}px) scale(0.97,1.03)`,filter:`brightness(1.9)`,offset:.25},{transform:`translateX(0) scale(1,1)`,filter:`brightness(1)`}],{duration:300,easing:`cubic-bezier(0.22, 1, 0.36, 1)`})}function Pg(e){return kg||!e?Promise.resolve():e.animate([{transform:`translateY(0) rotate(0deg)`,filter:`brightness(1)`},{transform:`translateY(5px) rotate(-2.5deg)`,filter:`brightness(0.6)`}],{duration:360,easing:`cubic-bezier(0.22, 1, 0.36, 1)`,fill:`forwards`}).finished.catch(()=>{})}function Fg(e,t){let n=e&&Q(`.cracks`,e);n&&n.children.length<8&&n.insertAdjacentHTML(`beforeend`,lm(t))}async function Ig(e=null){let t=Z.cb,n=Z.ce;Z.busy=!0,n.endTurn.classList.add(`enemy-phase`);let r=t.queue;for(;r.length;){let t=r.shift();try{await Rg(t,e)}catch(e){console.error(`vfx event error`,t,e)}}Z.busy=!1,t.over||n.endTurn.classList.remove(`enemy-phase`),Zh(),Qh(),yh()}var Lg=null;async function Rg(e,t){let n=Z.cb,r=Z.ce;switch(e.t){case`chip`:{let t=r.enemies[e.idx],{x:n,y:i}=Wh(e.idx);X.chip(),Nd(n,i,{color:`#e8f4ff`,n:5,speed:190,size:1.8,grav:240,kind:`spark`}),Zh(),t.facets.classList.remove(`pop`),t.facets.offsetWidth,t.facets.classList.add(`pop`),await ah(110);break}case`shatter`:{let t=r.enemies[e.idx],{x:n,y:i}=Wh(e.idx);Lg={x:n,y:i},X.shatter(),jd(90),Pd(n,i,`#dfeaff`,10,700,5),Nd(n,i,{color:`#dfeaff`,n:26,speed:430,size:2.4,grav:300,kind:`spark`}),Ld(n,i-58,`${J(`stagger`,20)} SHATTER`,`shatterf`),Ad(10),ud(.9),Fg(t.art,!0),t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),Zh(),await ah(380);break}case`adamantHold`:{let{x:t,y:n}=Wh(e.idx);X.blocked(),Ld(t,n-52,`THE GLASS HOLDS`,`blockedf`),Pd(t,n,`#d8c27a`,8,480,4),Zh(),await ah(260);break}case`ember`:if(e.n>0&&r.lantern){let t=Lg||Gh(),n=zd(r.lantern);gg(t.x,t.y,n.x,n.y,{n:Math.min(e.n*2,5),color:`#ffb35a`,size:6,dur:460}),X.ember(),setTimeout(()=>{r.lantern.classList.remove(`pop`),r.lantern.offsetWidth,r.lantern.classList.add(`pop`),Zh()},440),await ah(300)}else Zh();Lg=null;break;case`kindle`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand);t&&(Lg=zd(t)),X.kindle(),await ah(60);break}case`art`:{Tg={archetype:`fire`,cardId:`art:${e.id}`,enemyIdx:null},Eg=!1,Dg=!1;{let{x:t,y:n}=zd(r.lantern);qd[`art:${e.id}`]?.(t,n),Eg=!0}let t=Zl[e.id],{x:n,y:i}=Gh(),a=r.lantern?zd(r.lantern):{x:n,y:i};X.art(),Md(t.tone,.12,.5),Pd(a.x,a.y,t.tone,10,620,5),Id(n,i,t.tone,12),Ld(n,i-84,t.name.toUpperCase(),`artf`),ud(.7),Zh(),await ah(420);break}case`staggered`:{let t=r.enemies[e.idx],{x:n,y:i}=Wh(e.idx);X.stagger(),Ld(n,i-76,`STAGGERED`,`staggerf`),t.root.classList.add(`reseaming`),setTimeout(()=>t.root.classList.remove(`reseaming`),720),Zh(),await ah(520);break}case`smolderJump`:{let t=Wh(e.from),n=Wh(e.to);X.poison(),gg(t.x,t.y,n.x,n.y,{n:5,color:`#d3a15a`,size:7,dur:460}),await ah(400);break}case`turn`:e.n>1&&(hg(`YOUR TURN`),X.turn()),Zh(),await ah(e.n>1?500:120);break;case`endTurn`:wg=!1,hg(`ENEMY TURN`),await ah(480);break;case`draw`:Qh(),Zh(),X.draw(),await ah(75);break;case`reshuffle`:{X.card();let e=zd(r.discard),t=zd(r.draw);gg(e.x,e.y,t.x,t.y,{n:6,cls:`flycard`,dur:520}),Ld(t.x,t.y-46,`Reshuffle`,`notice`),await ah(420);break}case`play`:{let i=Q(`.card[data-uid="${e.uid}"]`,r.hand);if(X.card(),wg=!0,Tg={archetype:Rl[e.id]?.vfx||`slash`,cardId:e.id,enemyIdx:null},Eg=!1,Dg=!1,!Eg&&qd[e.id]&&[`ascension`,`pyreheart`,`emberdance`,`limitBreak`].includes(e.id)){let t=n.enemies.findIndex(e=>e.hp>0),r=e.id===`limitBreak`&&t>=0?Wh(t):Gh();qd[e.id](r.x,r.y),Eg=!0}if(i&&t!=null&&n.enemies[t]){let e=i.getBoundingClientRect(),{x:n,y:r}=Wh(t),a=i.cloneNode(!0);Object.assign(a.style,{position:`fixed`,left:`${e.left}px`,top:`${e.top}px`,width:`${e.width}px`,height:`${e.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(a),i.remove(),a.animate([{transform:`none`,opacity:1},{transform:`translate(${n-e.left-e.width/2}px,${r-e.top-e.height/2}px) scale(0.22) rotate(14deg)`,opacity:0}],{duration:270,easing:`cubic-bezier(.45,0,.9,.5)`}).onfinish=()=>a.remove()}else i&&(i.classList.add(`played-up`),setTimeout(()=>i.remove(),320));Zh(),await ah(200);break}case`hitEnemy`:{let t=r.enemies[e.idx],{x:n,y:i}=Wh(e.idx);if(e.poison)X.poison(),Id(n,i,`#d3a15a`,14),Ld(n,i-20,`${e.amount}`,`poisonf`);else{let a=e.amount>=16;wg&&(Dg||=(await Mg(r.hero,1,`humanoid`),!0)),X.slash(),e.amount>0&&X.hit(),!Eg&&Tg.cardId&&qd[Tg.cardId]&&(qd[Tg.cardId](n,i),Eg=!0),Gd(n,i,Tg.archetype,Math.min(1,e.amount/24)),Ng(t.root,1),e.blocked>0&&(X.blocked(),Ld(n,i+26,`${J(`shield`,19)}${e.blocked}`,`blockedf`),Nd(n,i+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`})),e.amount>0?Ld(n,i-24,`${e.amount}`,e.killingBlow||a?`crit`:`dmg`):e.blocked||Ld(n,i-24,`0`,`blockedf`),Ad(Math.min(4+e.amount*.5,15)),ud(Math.min(.2+e.amount/26,1)),a&&(jd(70),Pd(n,i,`#ffd8a0`,10,620,5)),e.killingBlow&&(jd(e.overkill>=8?130:90),ud(Math.min(1.6,.6+e.overkill*.06)),Pd(n,i,`#ffffff`,8,780,5),Pd(n,i,`#ffd8a0`,14,900,4),Md(`#ffe6b0`,.09,.28),e.overkill>=8&&(Md(`#ffffff`,.12,.24),Nd(n,i,{color:`#fff3d6`,n:26,speed:620,size:2.6,grav:200,kind:`spark`}),Nd(n,i,{color:`#ffd76e`,n:12,speed:300,size:3.4,grav:120,kind:`spark`}))),e.amount>0&&Fg(t.art,a)}t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),Zh(),await ah(230);break}case`die`:{let t=r.enemies[e.idx],i=n.enemies[e.idx],{x:a,y:o}=Wh(e.idx);Lg={x:a,y:o},i.boss&&(document.body.classList.add(`worldstop`),t.root.classList.add(`doomed`),jd(110),await ah(820),document.body.classList.remove(`worldstop`),t.root.classList.remove(`doomed`)),await Pg(t.art),(i.boss||i.elite?X.bigDeath:X.death)(),Rd(t.art),Nd(a,o,{color:`#dfeaff`,n:30,speed:480,size:2.6,grav:340,kind:`spark`}),Nd(a,o,{color:`#c9b0ff`,n:26,speed:380,size:3.2,grav:60}),Pd(a,o,`#e8dcff`,12,720,6),Md(`#ffffff`,i.boss?.24:.1,.3),Ad(i.boss?22:12),ud(i.boss?2:.9),t.root.classList.add(`dying`),setTimeout(()=>{t.root.classList.remove(`dying`),t.root.classList.add(`gone`)},830),await ah(i.boss?900:500);break}case`hitPlayer`:{let{x:t,y:n}=Gh();e.source===`poison`?(X.poison(),Id(t,n,`#d3a15a`,14)):e.source===`burn`||e.source===`self`?X.debuff():e.source===`thorns`?X.blocked():(X.slash(),e.amount>0&&(X.hit(),Md(`#ff2233`,Math.min(.05+e.amount*.012,.3),.3)),Gd(t,n,Tg.archetype,Math.min(1,e.amount/24)),Ng(r.hero,-1)),e.blocked>0&&(X.blocked(),Ld(t,n+30,`${J(`shield`,19)}${e.blocked}`,`blockedf`),Nd(t,n+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`})),e.amount>0?(Ld(t,n-30,`${e.amount}`,e.amount>=16?`crit`:`dmg`),Ad(Math.min(5+e.amount*.6,18)),ud(Math.min(.3+e.amount/22,1.2)),Fg(r.hero,e.amount>=16)):e.blocked||Ld(t,n-30,`0`,`blockedf`),Zh(),yh(),await ah(240);break}case`blockGain`:{let t=e.who===`player`,{x:n,y:i}=t?Gh():Wh(e.who);X.block(),Ld(n,i-10,`${J(`shield`,22)} ${e.n}`,`blockf`);let a=t?r.pBlock:r.enemies[e.who].block;a.classList.remove(`pulse`),a.offsetWidth,a.classList.add(`pulse`),Zh(),await ah(140);break}case`status`:{let{x:t,y:n}=e.who===`player`?Gh():Wh(e.who),r=Bl[e.id]||{name:e.id,kind:`buff`},i=r.kind===`debuff`||e.id===`str`&&e.n<0;(e.id===`poison`?X.poison:i?X.debuff:X.buff)(),Ld(t,n-46,`${e.n>0?`+`:``}${e.n} ${r.name}`,i?`debufff`:`bufff`),i||Id(t,n,`#9fc8ff`,6),Zh(),await ah(170);break}case`heal`:{let{x:t,y:n}=e.who===`player`?Gh():Wh(e.who);X.heal(),Id(t,n,`#8fe8a0`,14),Ld(t,n-30,`+${e.n}`,`healf`),Zh(),yh(),await ah(200);break}case`energy`:Zh(),r.energy.classList.remove(`pop`),r.energy.offsetWidth,r.energy.classList.add(`pop`);break;case`exhaust`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand);if(t){let e=t.getBoundingClientRect(),n=t.cloneNode(!0);Object.assign(n.style,{position:`fixed`,left:`${e.left}px`,top:`${e.top}px`,width:`${e.width}px`,height:`${e.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(n),t.remove(),n.animate([{clipPath:`circle(80% at 50% 55%)`,filter:`brightness(1)`},{clipPath:`circle(44% at 50% 55%)`,filter:`brightness(1.8) saturate(1.6) sepia(0.45)`,offset:.45},{clipPath:`circle(0% at 50% 55%)`,filter:`brightness(2.6) saturate(2) sepia(0.85)`}],{duration:540,easing:`ease-in`}).onfinish=()=>n.remove(),Nd(e.left+e.width/2,e.top+e.height/2,{color:`#ffb066`,n:22,speed:190,grav:-150,size:2.4,life:.85}),await ah(260)}Zh();break}case`discardHand`:{let e=ih(`.card`,r.hand);e.length&&(X.card(),e.forEach((e,t)=>{e.animate([{opacity:1},{transform:`${e.style.transform} translateX(340px) rotate(20deg)`,opacity:0}],{duration:260,delay:t*28,easing:`ease-in`}).onfinish=()=>e.remove()}),await ah(280+e.length*28)),Zh();break}case`enemyAct`:{let t=r.enemies[e.idx],{x:i,y:a}=Wh(e.idx),o=Wl[n.enemies[e.idx].key]?.moves?.[e.move],s=Og[Wl[n.enemies[e.idx].key]?.art?.kind]||`slash`;Tg={archetype:o?.intent?.startsWith(`attack`)?s:o?.intent===`debuff`?`void`:o?.intent===`buff`||o?.intent===`block`?`ward`:s,cardId:null,enemyIdx:e.idx},Eg=!1,Dg=!1,t.intent.classList.remove(`telegraph`),t.intent.offsetWidth,t.intent.classList.add(`telegraph`),t.root.classList.add(`acting`),setTimeout(()=>{t.root.classList.remove(`acting`),t.intent.classList.remove(`telegraph`)},650),Ld(i,a-90,e.name,`notice`),await ah(300),o?.intent?.startsWith(`attack`)?(await Mg(t.root,-1,Wl[n.enemies[e.idx].key]?.art?.kind),Dg=!0):await ah(320);break}case`intent`:Zh();break;case`addCard`:Ld(innerWidth/2,innerHeight*.62,`${Rl[e.id].name} added to ${e.where===`hand`?`hand`:`discard`}`,`notice`),X.debuff(),Zh(),Qh(),await ah(240);break;case`relicProc`:{let t=Q(`.relic-chip[data-relic="${e.id}"]`);t&&(t.classList.remove(`proc`),t.offsetWidth,t.classList.add(`proc`)),await ah(90);break}case`maxHp`:{let{x:t,y:n}=Gh();Ld(t,n-60,`+${e.n} MAX HP`,`healf`),X.buff(),await ah(160);break}case`potion`:X.potion(),await ah(120);break;case`powerConsumed`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand),n=t?zd(t):{x:innerWidth/2,y:innerHeight-180},{x:i,y:a}=Gh();gg(n.x,n.y,i,a,{n:7,color:`#c9a8ff`,size:7,dur:560}),X.buff(),setTimeout(()=>{Pd(i,a,`#c9a8ff`,12,460,4),Id(i,a,`#c9a8ff`,8)},560),await ah(300);break}case`victory`:if(Z.lastPerfect=!!e.perfect,await ah(320),X.victory(),Md(`#ffe9ac`,.16,.6),e.perfect){let e=$(`div`,`turn-banner perfect-banner`,`PERFECT`);oh().appendChild(e),setTimeout(()=>e.remove(),1400),await ah(500)}break;case`defeat`:{await ah(400),X.defeat(),Md(`#300`,.5,1.2);let e=Q(`#lantern`);e.classList.add(`gutter`),e.style.setProperty(`--la`,`1`),e.style.setProperty(`--lr`,`160px`),await ah(900);break}}}function zg(){let e=Z.cb;!e||!e.over||(e.result===`win`?Bg():Vg())}function Bg(){let e=Z.run,t=Z.cb.kind,n=Z.cb.affix;if(Z.cb=null,e.pendingCombat=null,t===`boss`&&e.act>=2){let{newUnlocks:t}=Im(e,!0);qp(e,!0),jh(`end`,{won:!0,newUnlocks:t});return}jh(`reward`,{kind:t,rewards:Xf(e,t,n)})}function Vg(){let e=Z.run,t=Bm(e),n=e.map.nodes.find(t=>t.id===e.nodeId),r=n?n.row:Math.max(1,e.floorsClimbed-1),{newUnlocks:i}=Im(e,!1);qp(e,!1),jh(`end`,{won:!1,newUnlocks:i,offers:t,fallAct:e.act,fallRow:r})}function Hg({kind:e,rewards:t}){let n=Z.run,r=oh(),i=e===`boss`?`BOSS VANQUISHED`:e===`elite`?`ELITE SLAIN`:`VICTORY`,a=Z.lastPerfect?`<div class="perfect-seal">✦ PERFECT — the glass untouched ✦</div>`:`<div class="ornament">✦ ✦ ✦</div>`;Z.lastPerfect=!1,r.innerHTML=`<div class="center-panel screen-enter"><div class="panel">
  ...
  </div></div>`;let o=Q(`.reward-list`,r),s=(e,t,r,i=null)=>{let a=$(`button`,`reward-row`,`<span class="ric">${e}</span><span>${t}</span>`);return i&&(a._tip=i),a.onclick=()=>{r()!==!1&&(a.classList.add(`taken`),Up(n),yh())},o.appendChild(a),a};if(s(`¤`,`<b class="gold-num">${t.gold}</b> gold`,()=>{n.player.gold+=t.gold,n.stats.goldEarned+=t.gold,X.coin(),requestAnimationFrame(()=>{let e=Q(`#hud .gold-num`),r={x:innerWidth/2,y:innerHeight/2-40},i=e?zd(e):{x:120,y:24},a=n.player.gold-t.gold;e&&(e.textContent=a),gg(r.x,r.y,i.x,i.y,{n:Math.min(9,4+Math.floor(t.gold/12)),color:`#ffd76e`,dur:600,done:()=>X.coin()}),e&&vg(e,a,n.player.gold,640)})}),t.potion){let e=Ul[t.potion];s(ch(`potions`,t.potion,_m(e.tone)),`${e.name}`,()=>{if(!qf(n,t.potion))return Ld(innerWidth/2,innerHeight/2,`Potion slots full!`,`notice`),!1;X.potion()},{title:e.name,body:e.text})}if(t.relic){let e=Vl[t.relic];s(`<span style="color:${e.tone};text-shadow:0 0 8px ${e.tone}">${lh(t.relic,24)}</span>`,`<b>${e.name}</b>`,()=>{Gf(n,t.relic),X.relic(),requestAnimationFrame(()=>{let n=Q(`.relic-chip[data-relic="${t.relic}"]`);if(!n)return;let r=zd(n);gg(innerWidth/2,innerHeight/2-40,r.x,r.y,{n:1,glyph:e.glyph,color:e.tone,dur:680,done:()=>{n.classList.remove(`proc`),n.offsetWidth,n.classList.add(`proc`)}})})},{title:e.name,body:e.text})}s(J(`cards`,26),`Add a card to your deck`,()=>(l(t.cards,()=>{}),!1));let c=o.lastElementChild;c.dataset.cardrow=`1`,Q(`[data-a="continue"]`,r).onclick=()=>{X.click(),Up(n),jh(e===`boss`?`bossRelic`:`map`)};function l(e,t){Oh(`Choose a Card`,e.map(e=>({id:e,up:!1,uid:null})),{sub:`Add one card to your deck — or skip to keep it lean.`,pick:e=>{e&&(Lp(n,e.id),X.upgrade(),Ld(innerWidth/2,innerHeight/2,`${Ff(e).name} added`,`notice`)),c.classList.add(`taken`),Up(n),t()},canSkip:!0})}}function Ug(){let e=Z.run,t=Zf(e),n=oh();n.innerHTML=`<div class="center-panel screen-enter"><div class="panel" style="width:min(620px,94vw)">
  ...
  </div></div>`;let r=Q(`.big-choices`,n);for(let n of t){let t=Vl[n],i=$(`button`,`relic-pick`);i.innerHTML=`<span class="relic-chip" style="--tone:${t.tone}">${lh(n,26)}</span><span><b>${t.name}</b><span class="rd">${t.text}</span></span>`,i.onclick=()=>{X.relic(),Gf(e,n),Wg()},r.appendChild(i)}let i=$(`button`,`btn ghost`,`Take none`);i.style.marginTop=`10px`,i.onclick=()=>{X.click(),Wg()},r.appendChild(i)}function Wg(){let e=Z.run;e.act++,e.omens.push(jf(e)),e.nodeId=null,e.map=Lf(e),Wf(e,Math.round(e.player.maxHp*.35)),cd(e.act),Yu(e.act,0),$m(e.act),Up(e),jh(`map`),hg(`ACT ${e.act+1}`),X.victory(),setTimeout(()=>Gg(e),1400)}function Gg(e){let t=Yl[e.omens?.[e.act]];if(!t||Z.screen!==`map`)return;let n=$(`div`,`turn-banner omen-banner`,`<span class="ob-glyph" style="color:${t.tone}">${J(`omen-${e.omens[e.act]}`,22)}</span> OMEN — ${t.name.toUpperCase()}<div class="ob-sub">${t.text}</div>`);oh().appendChild(n),X.omen(),setTimeout(()=>n.remove(),4200)}function Kg(){let e=Z.run,t=e.player.deck.some(e=>!e.up&&Rl[e.id].up);oh().innerHTML=`<div class="center-panel screen-enter"><div class="panel">
    <div class="ov-title">REST SITE</div>
    <div class="art-lg">${ch(`props`,`campfire`,ym())}</div>
    <div class="ov-sub">The fire crackles. For a moment, the Spire is quiet.</div>
    <div class="big-choices">
      <button class="btn" data-a="rest">${J(`flame`,18)} Rest <span style="font-size:13px;opacity:.8">— heal ${Math.round(e.player.maxHp*Nf(e))} HP</span></button>
  ...
  </div></div>`,Q(`[data-a="rest"]`).onclick=t=>{t.currentTarget.disabled=!0,Q(`[data-a="smith"]`).disabled=!0,X.heal();let n=Wf(e,Math.round(e.player.maxHp*Nf(e)));Md(`#ff9a4d`,.12,.8),Ld(innerWidth/2,innerHeight/2-40,`+${n} HP`,`healf`),Id(innerWidth/2,innerHeight/2,`#8fe8a0`,22),Id(innerWidth/2,innerHeight/2+60,`#ffb066`,16),Up(e),setTimeout(()=>{Z.screen===`rest`&&jh(`map`)},900)},Q(`[data-a="smith"]`).onclick=()=>{X.click(),Oh(`Upgrade a Card`,e.player.deck.filter(e=>!e.up&&Rl[e.id].up),{sub:`Forge one card into its + form.`,pick:t=>{t&&(zp(e,t.uid),X.upgrade(),Md(`#ffe9ac`,.12,.4),Oh(`Upgraded!`,[e.player.deck.find(e=>e.uid===t.uid)],{sub:`It gleams with new power.`}),Up(e),setTimeout(()=>{Z.screen===`rest`&&(Dh(),jh(`map`))},1300))}})}}function qg(){let e=Z.run;oh().innerHTML=`<div class="center-panel screen-enter"><div class="panel">
    <div class="ov-title">TREASURE</div>
    <div class="art-lg" style="cursor:pointer" data-a="open">${ch(`props`,`chest`,vm(!1))}</div>
  ...
  </div></div>`;let t=()=>{let t=Kf(e,{common:.55,uncommon:.35,rare:.1});Q(`.art-lg`).innerHTML=ch(`props`,`chest-open`,vm(!0)),X.relic(),Md(`#ffe9ac`,.2,.5),Nd(innerWidth/2,innerHeight/2,{color:`#ffd97a`,n:36,speed:380,grav:160});let n=Q(`.big-choices`);if(t){Gf(e,t);let n=Vl[t];Q(`.ov-sub`).innerHTML=`You claim <b style="color:${n.tone}">${n.name}</b> — <i>${n.text}</i>`}else e.player.gold+=60,Q(`.ov-sub`).innerHTML=`Only coins remain — <b class="gold-num">+60 gold</b>.`,X.coin();yh(),Up(e),n.innerHTML=``;let r=$(`button`,`btn`,`Continue`);r.onclick=()=>{X.click(),jh(`map`)},n.appendChild(r)};ih(`[data-a="open"]`).forEach(e=>e.onclick=t)}function Jg(){let e=Z.run,t=Z.shopData||={};(Z.screen!==`shop`||!t.stock||t.forNode!==e.nodeId)&&(t.stock=Qf(e),t.forNode=e.nodeId);let n=t.stock,r=oh();r.innerHTML=`<div class="center-panel screen-enter"><div class="panel ov-panel" style="width:min(980px,96vw)">
    <div style="display:flex;align-items:center;justify-content:center;gap:18px">
      <div style="width:130px">${ch(`props`,`merchant`,bm())}</div>
  ...
  </div></div>`;let i=Q(`.cards-row`,r),a=Q(`.misc-row`,r),o=Q(`.shop-grid`,r),s=!1,c=()=>e.player.gold,l=t=>{e.player.gold-=t,X.coin(),Up(e),yh(),u()};function u(){o&&o.classList.toggle(`list-seq-done`,s),i.innerHTML=``,a.innerHTML=``;for(let t of n.cards){let n=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),r=_h({id:t.id,up:!1,uid:null},{size:138});r.onclick=()=>{if(t.sold||c()<t.price)return X.debuff();t.sold=!0,Lp(e,t.id),l(t.price)},n.appendChild(r),n.appendChild($(`div`,`price`,`¤ ${t.price}`)),i.appendChild(n)}for(let t of n.relics){let n=Vl[t.id],r=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),i=$(`button`,`shop-relic`,`<span class="relic-chip" style="--tone:${n.tone}">${lh(t.id,24)}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||c()<t.price)return X.debuff();t.sold=!0,Gf(e,t.id),X.relic(),l(t.price)},r.appendChild(i),r.appendChild($(`div`,`price`,`¤ ${t.price}`)),a.appendChild(r)}for(let t of n.potions){let n=Ul[t.id],r=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),i=$(`button`,`shop-relic`,`<span style="width:34px;height:44px">${ch(`potions`,t.id,_m(n.tone))}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||c()<t.price)return X.debuff();if(!qf(e,t.id)){Ld(innerWidth/2,innerHeight/2,`Potion slots full!`,`notice`);return}t.sold=!0,X.potion(),l(t.price)},r.appendChild(i),r.appendChild($(`div`,`price`,`¤ ${t.price}`)),a.appendChild(r)}let t=$(`div`,`shop-item ${n.removed?`sold`:``} ${c()<n.removeCost?`cant`:``}`),r=$(`button`,`shop-relic`,`<span style="width:34px;display:inline-flex;justify-content:center">${J(`scissors`,26)}</span><b>Card Removal</b>Remove a card from your deck forever.`);r.onclick=()=>{if(n.removed||c()<n.removeCost)return X.debuff();Oh(`Remove a Card`,e.player.deck,{sub:`Cut the dead weight.`,pick:t=>{t&&(Rp(e,t.uid),n.removed=!0,e.player.gold-=n.removeCost,X.card(),Up(e),yh(),u())},canSkip:!0,skipLabel:`Cancel`})},t.appendChild(r),t.appendChild($(`div`,`price`,`¤ ${n.removeCost}`)),a.appendChild(t),s=!0}u(),Q(`[data-a="leave"]`,r).onclick=()=>{X.click(),jh(`map`)}}function Yg(e){let t=Z.run,n=Kl[e],r=oh();r.innerHTML=`<div class="center-panel screen-enter"><div class="panel event-panel">
    <div class="ov-title">${n.name.toUpperCase()}</div>
    <div class="event-art">${ch(`events`,e,xm(n.glyph,n.hue))}</div>
    <div class="event-text">${n.text}</div>
    <div class="event-log"></div>
    <div class="event-choices"></div>
  </div></div>`;let i=Q(`.event-choices`,r);for(let e of n.choices){let n=$(`button`,`event-choice`,`<b>${e.label}</b>${e.sub?`<div class="sub">${e.sub}</div>`:``}`);e.needGold&&t.player.gold<e.needGold&&(n.disabled=!0),n.onclick=()=>a(e),i.appendChild(n)}async function a(e){X.click();let{pending:n,log:a}=Jp(t,e.ops);yh();let s=Q(`.event-log`,r),c=[];for(let e of a)e.text&&c.push(e.text),e.relic&&c.push(`Gained <b style="color:${Vl[e.relic].tone}">${Vl[e.relic].name}</b> — <i>${Vl[e.relic].text}</i>`);c.length&&(s.innerHTML=c.join(`<br>`)),i.innerHTML=``;for(let e of n)await o(e);Up(t),yh();let l=$(`button`,`btn`,`Continue`);l.onclick=()=>{X.click(),jh(`map`)},i.appendChild(l),!c.length&&!n.length&&!e.ops.length&&jh(`map`)}function o(e){return new Promise(n=>{if(e===`remove`)Oh(`Remove a Card`,t.player.deck,{sub:`Let it go.`,pick:e=>{e&&(Rp(t,e.uid),X.card()),n()},canSkip:!1});else if(e===`upgrade`){let e=t.player.deck.filter(e=>!e.up&&Rl[e.id].up);if(!e.length)return n();Oh(`Upgrade a Card`,e,{sub:`The forge hungers.`,pick:e=>{e&&(zp(t,e.uid),X.upgrade()),n()}})}else e===`duplicate`?Oh(`Duplicate a Card`,t.player.deck,{sub:`The mirror remembers.`,pick:e=>{e&&(Bp(t,e.uid),X.upgrade()),n()}}):e.pickCard?Oh(`Choose a Card`,Yf(t,e.pickCard).map(e=>({id:e,up:!1,uid:null})),{sub:`One page still glows.`,pick:e=>{e&&(Lp(t,e.id),X.upgrade()),n()},canSkip:!0}):n()})}}function Xg(e){return e.kind===`relic`?{icon:lh(e.id,20),name:Vl[e.id]?.name||e.id,note:`your rarest relic`}:e.kind===`card`?{icon:`🂠`,name:(Rl[e.id]?.name||e.id)+(e.up?`+`:``),note:`your finest card`}:{icon:`¤`,name:`${e.amount} gold`,note:`a cache of gold`}}function Zg(e){if(e===`aspect2`)return{kind:`Aspect Unlocked`,name:`The Ashwarden`};let[t,n]=e.split(`:`);return t===`card`?{kind:`Card Unlocked`,name:Rl[n]?.name||n}:{kind:`Relic Unlocked`,name:Vl[n]?.name||n}}function Qg(e=[]){if(!e.length)return;let t=Q(`#toasts`);t||(t=$(`div`),t.id=`toasts`,document.body.appendChild(t)),e.forEach((e,n)=>{let r=Zg(e);setTimeout(()=>{let e=$(`div`,`unlock-toast`,`<div class="ut-kind">✦ ${r.kind}</div><div class="ut-name">${r.name}</div>`);t.appendChild(e),requestAnimationFrame(()=>e.classList.add(`in`)),X.relic(),setTimeout(()=>{e.classList.remove(`in`),setTimeout(()=>e.remove(),500)},3800)},700+n*800)})}function $g({won:e,newUnlocks:t=[],offers:n=[],fallAct:r=0,fallRow:i=1}){let a=Z.run;eh();let o=a.stats,s=Math.max(1,Math.round((Date.now()-o.start)/6e4)),c=a.act*15+a.floorsClimbed,l=`<div class="stats-grid">
    ...
    </div>`;if(e){oh().innerHTML=`<div class="end-screen screen-enter">
      ...
      ${l}${u}
    </div>`,ld(),X.victory(),Md(`#ffe9ac`,.25,1);let e=setInterval(()=>Nd(Math.random()*innerWidth,innerHeight*.2,{color:[`#ffd97a`,`#c9b0ff`,`#8fe8a0`][Math.random()*3|0],n:16,speed:300,grav:260,life:1.2}),400);setTimeout(()=>clearInterval(e),4200)}else{let e=n.length?`<div class="bequest" id="bequest">
        <div class="bequest-title">Carve one thing into the stone — the next climb may recover it in <b>${Ll[r].name}</b>.</div>
        <div class="bequest-opts">${n.map((e,t)=>{let n=Xg(e);return`<button class="bequest-opt" data-a="bequest" data-i="${t}"><span class="bq-icon">${n.icon}</span><span class="bq-name">${n.name}</span><span class="bq-note">${n.note}</span></button>`}).join(``)}</div>
      </div>`:``,t=Array.from({length:14},()=>`<span class="ember" style="left:${(8+Math.random()*84).toFixed(1)}%;--ex:${((Math.random()-.5)*90).toFixed(0)}px;animation-delay:${(Math.random()*4).toFixed(2)}s;animation-duration:${(3+Math.random()*3).toFixed(2)}s"></span>`).join(``);oh().innerHTML=`<div class="end-screen grave">
      <div class="monument">
    ...
    </div>`}oh().onclick=e=>{let t=e.target.closest(`[data-a]`);if(!t)return;let o=t.dataset.a;if(o===`bequest`){X.relic();let e=n[+t.dataset.i];Lm(r,i,e);let a=Xg(e);Q(`#bequest`).innerHTML=`<div class="bequest-done">✦ The stone keeps your <b>${a.name}</b>.<br>It will wait for you in ${Ll[r].name}.</div>`;return}X.click(),o===`deck`&&Oh(`Final Deck`,a.player.deck,{}),o===`title`&&(Z.run=null,Z.lamp=null,jh(`title`))},Qg(t)}var e_=!1;function t_(){if(e_)return;e_=!0;let e=Q(`#overlay`);e.addEventListener(`pointerdown`,t=>{t.target===e&&e._closable&&Dh()}),document.addEventListener(`keydown`,t=>{t.key===`Escape`&&e.classList.contains(`open`)&&e._closable&&Dh()})}function n_(e,t){let n=e.dataset.cat||``,r=e.dataset.id||``,i=e.dataset.url||``,a=e.querySelector(`.g-art-stage`),o=`${r} / ${n}`,s=a?.querySelector(`svg`),c=s?`data:image/svg+xml;charset=UTF-8,${encodeURIComponent(s.outerHTML)}`:``,l=i?`<img class="gallery-lightbox-img" src="${sh(i)}" alt="${sh(r)}">`:c?`<img class="gallery-lightbox-img" src="${sh(c)}" alt="${sh(r)}">`:a?a.innerHTML:``;Eh(`<div class="gallery-lightbox" role="dialog" aria-modal="true" aria-label="${sh(o)}">
    <button class="gallery-lightbox-close" type="button" data-a="close" aria-label="Close">&times;</button>
    <div class="gallery-lightbox-meta"><b>${sh(r)}</b><span>${sh(n)} - ${sh(tm(t))}</span></div>
    <div class="gallery-lightbox-art">${l}</div>
  </div>`,e=>{Q(`[data-a="close"]`,e).onclick=()=>Dh()},!0)}function r_(){t_();let e=new URLSearchParams(location.search),t=e.get(`set`)||e.get(`assetSet`)||`live`,n=em().includes(t)?t:`live`,r=em().map(e=>{let t=new URLSearchParams(location.search);return t.set(`gallery`,`1`),t.set(`set`,e),`<a class="${e===n?`active`:``}" href="?${t.toString()}">${tm(e)}</a>`}).join(``),i={heroes:$l.map((e,t)=>[e.id,()=>pm(t)]),enemies:Object.entries(Wl).map(([e,t])=>[e,()=>dm(t.art)]),cards:Object.entries(Rl).map(([e,t])=>[e,()=>gm(e,t.type)]),potions:Object.entries(Ul).map(([e,t])=>[e,()=>_m(t.tone)]),props:[[`campfire`,ym],[`chest`,()=>vm(!1)],[`chest-open`,()=>vm(!0)],[`merchant`,bm]],events:Object.entries(Kl).map(([e,t])=>[e,()=>xm(t.glyph,t.hue)]),title:[[`title`,()=>`<div class="title-banner-ph">title</div>`]],"title-background":[[`background`,()=>`<div class="title-banner-ph">background</div>`]],stage:[`act1`,`act2`,`act3`].flatMap(e=>[`backdrop`,`mid`,`ledge`].map(t=>[`${e}-${t}`,()=>`<div class="title-banner-ph">stage</div>`])),relics:Object.entries(Vl).map(([e,t])=>[e,()=>`<div class="title-banner-ph" style="color:${t.tone}">${t.glyph}</div>`])};oh().className=`gallery-mode`,oh().innerHTML=`<div class="g-toolbar">
    <div><b>Asset set:</b> ${tm(n)}</div>
    <nav>${r}</nav>
  </div>`+Object.entries(i).map(([e,t])=>`<h2 class="g-head">${e} — ${t.filter(([t])=>nm(e,t,n)).length}/${t.length} generated</h2>
      <div class="gallery">${t.map(([t,r])=>{let i=nm(e,t,n);return`<div class="g-cell ${i?`g-png`:`g-svg`}"><button class="g-art g-open" type="button" data-cat="${sh(e)}" data-id="${sh(t)}" data-url="${i?sh(i):``}" aria-label="Enlarge ${sh(t)}"><span class="g-art-stage">${i?`<img class="raster-art" src="${sh(i)}" alt="">`:r()}</span></button>
          <div class="g-label">${sh(t)}<span class="g-badge">${i?`PNG`:`SVG`}</span></div></div>`}).join(``)}</div>`).join(``),oh().onclick=e=>{let t=e.target.closest(`.g-open`);t&&n_(t,n)}}function i_(){if(new URLSearchParams(location.search).has(`gallery`))return r_();hh(),document.addEventListener(`pointerdown`,()=>qm(),{once:!0}),document.addEventListener(`contextmenu`,e=>{Z.targeting&&(e.preventDefault(),dg())}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&(Z.targeting?dg():Q(`#overlay`).classList.contains(`open`)&&Q(`#overlay`)._closable&&Dh()),(e.key===`e`||e.key===`E`)&&Z.screen===`combat`&&!Z.busy&&mg(),(e.key===`a`||e.key===`A`)&&Z.screen===`combat`&&!Z.busy&&Z.ce?.lantern?.click()}),Q(`#overlay`).addEventListener(`pointerdown`,e=>{e.target===Q(`#overlay`)&&Q(`#overlay`)._closable&&Dh()}),window.spirebound={S:Z,E:wf,startCombatUI:Hh,show:jh,meshEnabled:$d,meshDebug:Cf},requestAnimationFrame(Cg),jh(`title`)}od(),Dd(),bf(),i_();