...
`;function Np(e,t,n,r){let i=new Da(2,2,tp,np),a={geo:i,base:i.attributes.position.array.slice(),profile:t,seed:n,el:null,aspect:kp(r,null)||2/3,sites:[],death:0,glass:null,fire:null,beams:null,bodyPx:null},o=Op(e,e=>{a.aspect=kp(r,e)});a.tex=o;let s=new La({uniforms:{map:{value:o},uFlash:{value:0},uCut:{value:0}},vertexShader:jp,fragmentShader:Mp,transparent:!0,depthTest:!1,depthWrite:!1});a.mat=s;let c=new Ui(i,s);return c.renderOrder=1,yp.add(c),a.mesh=c,r&&!r.complete&&r.addEventListener(`load`,()=>{a.aspect=kp(r,o)},{once:!0}),a}function Pp(e){if(e.bodyPx)return e.bodyPx;let t=e.tex?.image;if(!t?.width)return null;let n=Object.assign(document.createElement(`canvas`),{width:hp,height:hp}).getContext(`2d`);return n.drawImage(t,0,0,hp,hp),e.bodyPx=n.getImageData(0,0,hp,hp).data,e.bodyPx}var Fp=e=>e.sites.map(e=>({x:e.u*hp,y:(1-e.v)*hp}));function Ip(e){let t=hp,n=Pp(e),r=Object.assign(document.createElement(`canvas`),{width:t,height:t}),i=r.getContext(`2d`),a=i.createImageData(t,t),o=Fp(e),s=cp*t,c=s*(1-.9*lp);for(let e=0;e<t;e++)for(let r=0;r<t;r++){let i=(e*t+r)*4,l=0;if(n[i+3]>90){let t=0xe8d4a51000;for(let n of o){let i=r-n.x,a=e-n.y,o=i*i+a*a;o<t&&(t=o)}let n=Math.sqrt(t);l=n<=c?1:n>=s?0:1-(n-c)/(s-c),l=l*l*(3-2*l)}let u=Math.round(255*l);a.data[i]=a.data[i+1]=a.data[i+2]=u,a.data[i+3]=255}return i.putImageData(a,0,0),r}function Lp(e){let t=hp,n=Object.assign(document.createElement(`canvas`),{width:t,height:t}),r=n.getContext(`2d`),i=r.createImageData(t,t),a=Fp(e);for(let e=0;e<t;e++)for(let n=0;n<t;n++){let r=0xe8d4a51000,o=0xe8d4a51000,s=null,c=null;for(let t of a){let i=n-t.x,a=e-t.y,l=i*i+a*a;l<r?(o=r,c=s,r=l,s=t):l<o&&(o=l,c=t)}let l=0,u=0,d=Math.sqrt(o)-Math.sqrt(r),f=t*.0137;if(c&&d<f){let e=s.x-c.x,t=s.y-c.y,n=Math.hypot(e,t)||1,r=(1-d/f)*.95;l=e/n*r,u=-(t/n)*r}let p=Math.sqrt(Math.max(.05,1-l*l-u*u)),m=(e*t+n)*4;i.data[m]=(l*.5+.5)*255,i.data[m+1]=(u*.5+.5)*255,i.data[m+2]=(p*.5+.5)*255,i.data[m+3]=255}return r.putImageData(i,0,0),n}function Rp(e){let t=hp,n=Pp(e),r=Object.assign(document.createElement(`canvas`),{width:t,height:t}),i=r.getContext(`2d`),a=i.createImageData(t,t),o=Fp(e);if(o.length>=2){let e=cp*t,r=e*(1-.9*lp),i=t*.0102,s=t*.0215;for(let c=0;c<t;c++)for(let l=0;l<t;l++){let u=(c*t+l)*4;if(n[u+3]<=90)continue;let d=0xe8d4a51000,f=0xe8d4a51000;for(let e of o){let t=l-e.x,n=c-e.y,r=t*t+n*n;r<d?(f=d,d=r):r<f&&(f=r)}let p=Math.sqrt(d),m=p<=r?1:p>=e?0:1-(p-r)/(e-r);if(m=m*m*(3-2*m),m<=0)continue;let h=Math.sqrt(f)-p,g=Math.max(0,1-h/i),_=Math.max(0,1-h/s)*.2,v=Math.min(1,g+_)*m;v<=.02||(a.data[u]=Math.round(255*v),a.data[u+1]=Math.round(158*v),a.data[u+2]=Math.round(56*v),a.data[u+3]=255)}}return i.putImageData(a,0,0),r}function zp(e){let t=Rp(e),n=Math.round(hp*mp),r=(n-hp)/2,i=Object.assign(document.createElement(`canvas`),{width:n,height:n}),a=i.getContext(`2d`),o=.5,s=.5;e.sites.length&&(o=e.sites.reduce((e,t)=>e+t.u,0)/e.sites.length,s=1-e.sites.reduce((e,t)=>e+t.v,0)/e.sites.length);let c=r+o*hp,l=r+s*hp;a.globalCompositeOperation=`lighter`;for(let e=1;e<=26;e++){let n=e/26,i=1+n*fp;a.globalAlpha=Math.min(1,.06*dp*(1-n)**pp),a.setTransform(i,0,0,i,c-c*i,l-l*i),a.drawImage(t,r,r)}return a.setTransform(1,0,0,1,0,0),a.globalAlpha=1,i}function Bp(){if(Tp||!vp)return;Tp=!0;let e=new ys(vp);yp.environment=e.fromScene(new $f,.04).texture,yp.environmentIntensity=.45;let t=new ko(14674687,1.8);t.position.set(-1.4,1.8,2),yp.add(t),yp.add(new Ao(2765894,.6))}var Vp=(e,t=!1)=>{let n=new va(e);return t&&(n.colorSpace=dt),n};function Hp(e,t){let n=e[t];if(n){yp.remove(n);for(let e of[`map`,`alphaMap`,`normalMap`])n.material[e]?.dispose?.();n.material.dispose(),e[t]=null}}function Up(e){Bp(),Hp(e,`glass`);let t=new Ba({transmission:1,ior:1.4,thickness:.12,roughness:.03,metalness:0,normalMap:Vp(Lp(e)),normalScale:new R(1.3,1.3),alphaMap:Vp(Ip(e)),transparent:!0,alphaTest:.01,opacity:up,clearcoat:.3,clearcoatRoughness:.2,envMapIntensity:.4,depthTest:!1,depthWrite:!1}),n=new Ui(e.geo,t);n.renderOrder=3,yp.add(n),e.glass=n}function Wp(e){Hp(e,`fire`);let t=new ji({map:Vp(Rp(e),!0),transparent:!1,blending:2,depthTest:!1,depthWrite:!1});t.color.setScalar(0);let n=new Ui(e.geo,t);n.renderOrder=2,yp.add(n),e.fire=n}function Gp(e){Hp(e,`beams`);let t=new ji({map:Vp(zp(e),!0),transparent:!0,blending:2,depthTest:!1,depthWrite:!1,opacity:0}),n=new Ui(new Da(2,2),t);n.renderOrder=4,yp.add(n),e.beams=n}function Kp(e,t){let n=e.geo.attributes.position,r=e.profile;for(let i=0;i<n.count;i++){let a=e.base[i*3],o=e.base[i*3+1],s=(o+1)/2,c=s**+(r.pin??1.6),l=0,u=0;l+=.028*c*r.sway*Math.sin(t*.9+e.seed),l+=.01*c*c*r.sway*Math.sin(t*1.7+1+e.seed*.3);let d=gp(s,.62,.12);l+=a*.02*d*r.breathe*Math.sin(t*2.2+e.seed*.5),u+=.012*d*r.breathe*Math.sin(t*2.2+e.seed*.5),u+=.014*c*r.bob*Math.sin(t*1.1+.4+e.seed),l+=.012*Math.max(0,(s-.8)/.2)*r.head*Math.sin(t*.7+e.seed),l+=.01*Math.max(0,(.45-s)/.45)*c*r.cloth*Math.sin(s*12-t*2.5+e.seed),n.array[i*3]=a+l*rp,n.array[i*3+1]=o+u*rp}n.needsUpdate=!0}function qp(e){return[e.mesh,e.fire,e.glass,e.beams].filter(Boolean)}var Jp=()=>{let e=vp?C(vp.domElement):{left:0,top:0};return{left:e.left,top:e.top}};function Yp(e,t=0,n={left:0,top:0}){let r=t=>{for(let n of qp(e))n.visible=t};if(!e.el.isConnected||!(e.el.checkVisibility?.({visibilityProperty:!0})??!0)){r(!1);return}let i=C(e.el);if(i.width<2||i.height<2){r(!1);return}e.aspect=kp(e.el.querySelector(`.raster-art`),e.tex)||e.aspect||1;let{w:a,h:o}=Ap(i.width,i.height,e.aspect),s=(e.profile.float||0)*Math.sin(t*1.15+e.seed*.7)*12*rp,c=i.left-n.left+i.width/2-Cp/2,l=-(i.top-n.top+i.height/2-wp/2)+s,u=(e.flip?-1:1)*a/2,d=o/2;r(!0);let f=Math.round(i.bottom);[e.mesh,e.fire,e.glass,e.beams].filter(Boolean).forEach((e,t)=>{e.renderOrder=f*4+t});let p=0;for(let t of qp(e)){t.position.set(c,l,p);let n=t===e.beams?mp:1;t.scale.set(u*n,d*n,1),p+=.01}}function Xp(){Cp=_(),wp=v(),vp.setPixelRatio(Math.min(devicePixelRatio*y(),2)),vp.setSize(Cp,wp,!1),bp.left=-Cp/2,bp.right=Cp/2,bp.top=wp/2,bp.bottom=-wp/2,bp.updateProjectionMatrix()}function Zp(e){if(!xp.length)return;let t=e*.001,n=Jp();for(let e of xp)Kp(e,t),Yp(e,t,n);vp.render(yp,bp)}function Qp(){let e=document.getElementById(`mesh`);!e||vp||(vp=new fu({canvas:e,alpha:!0,antialias:!0,powerPreference:`high-performance`}),vp.setClearColor(0,0),vp.toneMapping=4,vp.toneMappingExposure=1.1,yp=new sr,bp=new Do(-1,1,1,-1,.1,100),bp.position.z=10,Xp(),addEventListener(`resize`,Xp))}function $p(e){e.el?.classList.remove(`mesh-live`),Hp(e,`glass`),Hp(e,`fire`),Hp(e,`beams`),yp.remove(e.mesh),e.geo.dispose(),e.mesh.material.dispose()}function em(){cancelAnimationFrame(Sp),Sp=0;for(let e of xp)$p(e);xp=[],document.documentElement.classList.remove(`mesh-on`),vp?.render(yp,bp)}function tm(e){let t=xp.findIndex(t=>t.el===e||t.el&&e.contains&&e.contains(t.el));t<0||($p(xp[t]),xp.splice(t,1),xp.length||document.documentElement.classList.remove(`mesh-on`),vp?.render(yp,bp))}function nm(e,t=160){let n=am(e);n&&(n.mat.uniforms.uFlash.value=.9,setTimeout(()=>{n.mat&&(n.mat.uniforms.uFlash.value=0)},t))}var rm=56,im=e=>Math.max(.05,Math.min(.95,e));function am(e){return xp.find(t=>t.el===e||e.contains&&e.contains(t.el))}function om(e,t=.32+Math.random()*.36,n=.3+Math.random()*.4){if(op)return!1;let r=am(e);if(!r||!Pp(r))return!1;let i=5+(Math.random()*3|0);for(let e=0;e<i;e++){let e=Math.random()*Math.PI*2,i=Math.random()*.052;if(r.sites.length>=rm)break;r.sites.push({u:im(t+Math.cos(e)*i),v:im(n+Math.sin(e)*i)})}return r.mat.uniforms.uCut.value===0&&(r.mat.uniforms.uCut.value=.35,r.mat.transparent=!1,r.mat.needsUpdate=!0),Up(r),r.death>0&&Wp(r),!0}function sm(e,t){if(op)return!1;let n=am(e);return n?(t>0&&!n.fire&&(Wp(n),Gp(n)),n.death=t,n.fire&&n.fire.material.color.setScalar(t),n.beams&&(n.beams.material.opacity=Math.min(1,Math.max(0,t*1.35-.35))),!0):!1}function cm(e){let t=am(e);return t?t.sites.map(e=>({u:e.u,v:e.v})):[]}function lm(e){let t=am(e);if(!t||!vp||op)return null;let n=performance.now()*.001,r=Jp(),i=new Set(qp(t)),a=[];yp.traverse(e=>{e.isMesh&&(a.push([e,e.visible]),e.visible=i.has(e)&&e!==t.beams)}),Kp(t,n),Yp(t,n,r),t.beams&&(t.beams.visible=!1),vp.render(yp,bp);for(let[e,t]of a)e.visible=t;let o=C(t.el),{w:s,h:c}=Ap(o.width,o.height,t.aspect),l=vp.getPixelRatio(),u=(o.left-r.left+o.width/2-s/2)*l,d=(o.top-r.top+o.height/2-c/2)*l,f=Math.max(1,Math.round(s*l)),p=Math.max(1,Math.round(c*l)),m=document.createElement(`canvas`);m.width=f,m.height=p,m.getContext(`2d`).drawImage(vp.domElement,u,d,f,p,0,0,f,p);let h=cm(e),g={left:o.left,top:o.top,width:o.width,height:o.height},_=t.beams;if(_){t.beams=null;let e=performance.now(),n=_.material.opacity,r=t=>{let i=Math.min(1,(t-e)/200);_.material.opacity=n*(1-i),i<1?(xp.length||vp?.render(yp,bp),requestAnimationFrame(r)):(yp.remove(_),_.material.map?.dispose(),_.material.dispose(),vp?.render(yp,bp))};requestAnimationFrame(r)}return tm(e),{capture:m.toDataURL(`image/png`),sites:h,rect:g}}function um(e){if(em(),!sp()||(vp||Qp(),!vp))return;for(let{el:t,url:n,kind:r,flip:i}of e){if(!n||!t)continue;let e=t.querySelector(`.raster-art`);if(!e)continue;t.classList.add(`mesh-live`);let a=_p[r]||_p.humanoid,o=Np(n,a,Math.random()*10,e);o.el=t,o.flip=!!i,o.profile=a,xp.push(o)}if(!xp.length)return;document.documentElement.classList.add(`mesh-on`);let t=e=>{Sp=requestAnimationFrame(t),Zp(e)};Sp=requestAnimationFrame(t)}function dm(e){let t=am(e);if(!t)return 0;let n=performance.now()*.001;return Math.max(0,(t.profile.float||0)*Math.sin(n*1.15+t.seed*.7)*12*rp)}var fm=()=>({enabled:sp(),planes:xp.length,renderer:!!vp,looping:!!Sp,intensity:rp,sites:xp.reduce((e,t)=>Math.max(e,t.sites.length),0),death:xp.reduce((e,t)=>Math.max(e,t.death),0),glass:xp.filter(e=>e.glass).length}),pm=t({MAP_COLS:()=>7,MAP_ROWS:()=>15,addCardToDeck:()=>Nh,addStatus:()=>eh,applyEventOps:()=>Wh,applyNodeEventChoice:()=>Vm,availableNodes:()=>Dm,canKindle:()=>uh,canPlay:()=>xh,canUseArt:()=>sh,cardData:()=>wm,cardPool:()=>jm,claimBossRelic:()=>Hm,claimMonument:()=>km,claimTreasure:()=>Bm,clamp:()=>_m,clearSave:()=>Vh,drawCards:()=>_h,duplicateCardInDeck:()=>Ih,effCost:()=>bh,endTurn:()=>Eh,enemyMove:()=>nh,gainEmbers:()=>rh,gainPotion:()=>Um,gainRelic:()=>Pm,genCombatRewards:()=>Km,genMap:()=>Em,genShop:()=>Jm,hasRelic:()=>Am,healPlayer:()=>Nm,kindleFromHand:()=>fh,loadRun:()=>Bh,loadStats:()=>Hh,makeCard:()=>Cm,makeRng:()=>mm,newRun:()=>vm,nodeRewardClaimed:()=>zm,omenMods:()=>xm,playCard:()=>Sh,previewAttack:()=>kh,previewBlock:()=>Ah,previewEnemyDmg:()=>jh,previewPlay:()=>Mh,randomRelic:()=>Fm,recordRunEnd:()=>Uh,relicPool:()=>Mm,removeCardFromDeck:()=>Ph,restHealFrac:()=>Sm,rollBossRelics:()=>qm,rollCardReward:()=>Wm,rollEncounter:()=>Xm,rollEvent:()=>Ym,rollEventCards:()=>Gm,rollOmen:()=>bm,runRng:()=>Tm,saveRun:()=>zh,startCombat:()=>Zm,upgradeCardInDeck:()=>Fh,useArt:()=>ch,usePotion:()=>Th,visitNode:()=>Om,vowMods:()=>ym});function mm(e){let t=()=>{e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296};return t.getState=()=>e,t}var hm=(e,t)=>t[Math.floor(e()*t.length)],gm=(e,[t,n])=>t+Math.floor(e()*(n-t+1)),_m=(e,t,n)=>Math.max(t,Math.min(n,e));function vm(e=Math.random()*2**31|0,t={}){let n=_m(t.aspect||0,0,Wu.length-1),r=Wu[n],i={v:2,seed:e,rngState:e,uid:1,act:0,nodeId:null,floorsClimbed:0,bossRelicAct:-1,orphanRewardClaimed:!1,aspect:n,vow:_m(t.vow||0,0,Gu.length),art:t.art||r.art||`flare`,omens:[],boon:t.boon||null,unlocks:[...t.unlocks||[]],monument:t.monument?{...t.monument,claimed:!1}:null,player:{hp:r.maxHp,maxHp:r.maxHp,gold:r.startGold,energyMax:r.energy,relics:[r.startRelic],potions:Array(r.potionSlots||3).fill(null),deck:[]},stats:{slain:0,elites:0,bosses:0,dmgDealt:0,dmgTaken:0,cardsPlayed:0,goldEarned:0,shatters:0,kindles:0,perfects:0,smolderKills:0,unlitVisited:0,embersSpent:0,start:Date.now()},map:null};t.lamplighter&&(i.pendingLamplighter=!0);for(let e of r.startDeck)i.player.deck.push(Cm(i,e));return ym(i).startHex&&i.player.deck.push(Cm(i,`hex`)),i.omens.push(bm(i)),i.map=Em(i),i}function ym(e){let t={hpMult:1,enemyDmgBonus:0,bossFacetDelta:0,startHex:!1},n=_m(e.vow||0,0,Gu.length);for(let e=0;e<n;e++){let n=Gu[e].mods;n.hpMult&&(t.hpMult*=n.hpMult),n.enemyDmgBonus&&(t.enemyDmgBonus+=n.enemyDmgBonus),n.bossFacetDelta&&(t.bossFacetDelta+=n.bossFacetDelta),n.startHex&&(t.startHex=!0),n.restHealFrac!=null&&(t.restHealFrac=Math.min(t.restHealFrac??1,n.restHealFrac))}return t}function bm(e){return hm(Tm(e),Object.keys(Bu))}function xm(e){return Bu[e.omens?.[e.act]]?.mods||{}}function Sm(e){return Math.min(.3,xm(e).restHealFrac??.3,ym(e).restHealFrac??.3)}function Cm(e,t,n=!1){return{uid:e.uid++,id:t,up:n,bonus:0}}function wm(e){let t=ku[e.id];return e.up&&t.up?{...t,...t.up,name:t.name+`+`}:t}function Tm(e){let t=mm(e.rngState);return()=>{let n=t();return e.rngState=t.getState(),n}}function Em(e){let t=Tm(e),n={},r=(e,t)=>`${e},${t}`,i=(e,i)=>(n[r(e,i)]||(n[r(e,i)]={id:r(e,i),row:e,col:i,type:`monster`,next:[],jx:(t()-.5)*.5,jy:(t()-.5)*.4}),n[r(e,i)]),a=new Set;for(let e=0;e<6;e++){let n;do n=Math.floor(t()*7);while(e<2&&a.has(n));a.add(n);let r=i(0,n);for(let e=1;e<14;e++){let n=_m(r.col+(Math.floor(t()*3)-1),0,6),a=i(e,n);r.next.includes(a.id)||r.next.push(a.id),r=a}let o=i(14,3);r.next.includes(o.id)||r.next.push(o.id)}let o=Object.values(n),s=!1;for(let e of o){if(e.row===0)e.type=`monster`;else if(e.row===14)e.type=`boss`;else if(e.row===13)e.type=`rest`;else if(e.row===8)e.type=`treasure`;else{let n=t();n<.46?e.type=`monster`:n<.68?e.type=`event`:n<.81&&e.row>=5?e.type=`elite`:n<.91&&e.row>=4&&e.row<12?e.type=`rest`:e.row>=4?e.type=`shop`:e.type=`monster`}e.type===`shop`&&(s=!0)}if(!s){let e=o.filter(e=>e.type===`monster`&&e.row>=5&&e.row<=11);e.length&&(hm(t,e).type=`shop`)}for(let n of o)n.row===0||n.row===8||n.row>=13||t()<.15&&(n.unlit=!0,n.bounty=gm(t,[12,22])+e.act*6);if(e.monument&&!e.monument.claimed&&e.monument.act===e.act){let t=_m(e.monument.row||5,1,12),n=o.filter(e=>e.type===`shop`).length===1,r=o.filter(e=>e.row>0&&e.row<13&&e.row!==8&&e.type!==`boss`&&!(n&&e.type===`shop`));if(r.length){let e=r.reduce((e,n)=>Math.abs(n.row-t)<Math.abs(e.row-t)?n:e);e.type=`monument`,delete e.unlit,delete e.bounty}}return{nodes:o,visited:[]}}function Dm(e){let{nodes:t,visited:n}=e.map;if(!e.nodeId)return t.filter(e=>e.row===0);let r=t.find(t=>t.id===e.nodeId);return t.filter(e=>r.next.includes(e.id))}function Om(e,t){e.nodeId=t.id,e.orphanRewardClaimed&&=(t.rewardClaimed=!0,!1),e.floorsClimbed=t.row+1,e.map.visited.includes(t.id)||e.map.visited.push(t.id);let n=0;return t.unlit&&(delete t.unlit,n=(t.bounty||0)*(Am(e,`thiefOfWicks`)?2:1),delete t.bounty,e.player.gold+=n,e.stats.goldEarned+=n,e.stats.unlitVisited++),{type:t.type,bounty:n}}function km(e){let t=e.monument;if(!t||t.claimed||!t.bequest)return null;t.claimed=!0;let n=t.bequest;return n.kind===`card`?Nh(e,n.id,n.up):n.kind===`relic`?Pm(e,n.id):n.kind===`gold`&&(e.player.gold+=n.amount,e.stats.goldEarned+=n.amount),n}var Am=(e,t)=>e.player.relics.includes(t);function jm(e,t){let n=(e.unlocks||[]).filter(e=>e.startsWith(`card:`)).map(e=>e.slice(5)).filter(e=>ku[e]&&ku[e].rarity===t);return n.length?[...Au[t],...n]:Au[t]}function Mm(e,t){let n=(e.unlocks||[]).filter(e=>e.startsWith(`relic:`)).map(e=>e.slice(6)).filter(e=>Mu[e]&&Mu[e].rarity===t);return n.length?[...Nu[t],...n]:Nu[t]}function Nm(e,t,n=null){Am(e,`sunBlossom`)&&(t=Math.round(t*1.5));let r=n?n.player:e.player,i=r.hp;r.hp=_m(r.hp+t,0,r.maxHp);let a=r.hp-i;return n&&a>0&&n.queue.push({t:`heal`,who:`player`,n:a}),a}function Pm(e,t,n=null){let r=Mu[t];if(r){if(r.replaces){let t=e.player.relics.indexOf(r.replaces);t>=0&&e.player.relics.splice(t,1)}e.player.relics.push(t),t===`sweetRoot`&&(e.player.maxHp+=8,e.player.hp+=8),t===`hollowCrown`&&(e.player.energyMax+=1,e.player.maxHp=Math.max(1,e.player.maxHp-10),e.player.hp=Math.min(e.player.hp,e.player.maxHp))}}function Fm(e,t={common:.5,uncommon:.35,rare:.15}){let n=Tm(e),r=new Set(e.player.relics),i=[`common`,`uncommon`,`rare`],a=n(),o=`common`,s=0;for(let e of i)if(s+=t[e]||0,a<s){o=e;break}let c=i.indexOf(o);for(let t=0;t<i.length;t++){let a=i[(c+t)%i.length],o=Mm(e,a).filter(e=>!r.has(e));if(o.length)return hm(n,o)}return null}function Im(e){return!e.nodeId||!e.map?.nodes?null:e.map.nodes.find(t=>t.id===e.nodeId)||null}function Lm(e){let t=Im(e);return t?!!t.rewardClaimed:!!e.orphanRewardClaimed}function Rm(e){let t=Im(e);t?t.rewardClaimed=!0:e.orphanRewardClaimed=!0}function zm(e){return Lm(e)}function Bm(e,t={common:.55,uncommon:.35,rare:.1}){if(Lm(e))return{already:!0,relicId:null,gold:0};let n=Fm(e,t);return n?Pm(e,n):e.player.gold+=60,Rm(e),{already:!1,relicId:n,gold:n?0:60}}function Vm(e,t,n=Tm(e)){if(Lm(e))return{pending:[],log:[],already:!0};let{pending:r,log:i}=Wh(e,t,n);return Rm(e),{pending:r,log:i,already:!1}}function Hm(e,t){return e.bossRelicAct===e.act?{already:!0,id:null}:(e.bossRelicAct=e.act,t&&Pm(e,t),{already:!1,id:t||null})}function Um(e,t){t===`random`&&(t=hm(Tm(e),Object.keys(Pu)));let n=e.player.potions.indexOf(null);return n<0?!1:(e.player.potions[n]=t,!0)}function Wm(e,t=`normal`){let n=Tm(e),r=3+ +!!Am(e,`seersOrb`)+(xm(e).rewardChoiceBonus||0),i=[],a=new Set;for(;i.length<r&&a.size<40;){let r;if(t===`boss`)r=`rare`;else{let e=n();r=t===`elite`?e<.45?`common`:e<.85?`uncommon`:`rare`:e<.6?`common`:e<.92?`uncommon`:`rare`}let o=hm(n,jm(e,r));a.add(o+Math.floor(n()*4)),i.includes(o)||i.push(o)}return i}function Gm(e,t){let n=Tm(e),r=[...jm(e,`common`),...jm(e,`common`),...jm(e,`uncommon`),...jm(e,`uncommon`),...jm(e,`rare`)],i=[],a=0;for(;i.length<t&&a++<60;){let e=r[Math.floor(n()*r.length)];i.includes(e)||i.push(e)}return i}function Km(e,t,n=null){let r=Tm(e),i=gm(r,Ru[e.act][t===`boss`?`boss`:t===`elite`?`elite`:`normal`]);i=Math.round(i*(xm(e).goldMult||1)*(Vu[n]?.mods.goldMult||1));let a={gold:i,cards:Wm(e,t),potion:null,relic:null};return t!==`boss`&&r()<.4&&(a.potion=hm(r,Object.keys(Pu))),t===`elite`&&(a.relic=Fm(e)),a}function qm(e){let t=Tm(e),n=new Set(e.player.relics),r=Mm(e,`boss`).filter(e=>!n.has(e)),i=[];for(;i.length<Math.min(3,r.length);){let e=hm(t,r);i.includes(e)||i.push(e)}return i}function Jm(e){let t=Tm(e),n=([e,n],r)=>Math.round(gm(t,[e,n])*r),r=(Am(e,`merchantsMark`)?.75:1)*(xm(e).shopMult||1),i=[];for(let a of[`common`,`common`,`uncommon`,`uncommon`,`rare`]){let o,s=0;do o=hm(t,jm(e,a));while(i.some(e=>e.id===o)&&++s<20);i.push({id:o,price:n(zu.cardPrice[a],r),sold:!1})}let a=new Set(e.player.relics),o=[];for(let i of[`common`,`uncommon`]){let s=Mm(e,i).filter(e=>!a.has(e)&&!o.some(t=>t.id===e));s.length&&o.push({id:hm(t,s),price:n(zu.relicPrice[i],r),sold:!1})}let s=[];for(let e=0;e<2;e++)s.push({id:hm(t,Object.keys(Pu)),price:n(zu.potionPrice,r),sold:!1});return{cards:i,relics:o,potions:s,removeCost:Math.round(zu.removeCost*r),removed:!1}}function Ym(e){let t=Tm(e),n=e.seenEvents||=[],r=Object.keys(Lu).filter(e=>!n.includes(e));r.length||(e.seenEvents=[],r=Object.keys(Lu));let i=hm(t,r);return n.push(i),i}function Xm(e,t,n){let r=Tm(e),i=Iu[e.act],a=t===`boss`?i.boss:t===`elite`?i.elite:n<3?i.weak:i.normal,o=e.lastEnc,s,c=0;do s=hm(r,a);while(a.length>1&&s.join()===o&&++c<8);return e.lastEnc=s.join(),s}function Zm(e,t,n=`normal`,r={}){let i=Tm(e),a=xm(e),o=ym(e),s=n===`elite`?r.affix||hm(i,Object.keys(Vu)):null,c=s?Vu[s].mods:{},l={kind:n,affix:s,turn:0,over:!1,result:null,queue:[],player:{hp:e.player.hp,maxHp:e.player.maxHp,block:0,energy:0,energyMax:e.player.energyMax,statuses:{}},enemies:t.map((e,t)=>{let n=Fu[e];return{key:e,idx:t,name:n.name,maxHp:Math.round(gm(i,n.hp)*(a.hpMult||1)*(c.hpMult||1)*(o.hpMult||1)),block:c.startBlock||0,statuses:{...n.startStatus||{}},flags:c.adamant?{adamant:!0}:{},lastMoves:[],moveKey:null,elite:!!n.elite,boss:!!n.boss,facetMax:Math.max(2,(n.facets??(n.boss?6:n.elite?5:4))+(a.facetDelta||0)+(c.facetDelta||0)+(n.boss&&o.bossFacetDelta||0)),chips:0}}),draw:[],hand:[],discard:[],exhaust:[],embers:0,emberCap:9,artUsedTurn:0,kindledTurn:0,kindlesThisTurn:0,pendingChips:null,counters:{played:0,attacks:0,firstCardPlayed:!1,hpLost:0}};l.enemies.forEach(e=>e.hp=e.maxHp);for(let e of l.enemies)for(let[t,n]of Object.entries({...a.enemyStartStatus||{},...c.startStatus||{}}))e.statuses[t]=(e.statuses[t]||0)+n;a.startEmbers&&(l.embers=_m(a.startEmbers,0,l.emberCap)),l.draw=e.player.deck.map(e=>({...e,bonus:0})),Qm(i,l.draw);let u=l.player;return Am(e,`basaltIdol`)&&(u.block+=10,$m(l,`basaltIdol`)),Am(e,`warFetish`)&&(eh(l,u,`str`,1),$m(l,`warFetish`)),Am(e,`riverPearl`)&&(eh(l,u,`dex`,1),$m(l,`riverPearl`)),Am(e,`thornBand`)&&(eh(l,u,`thorns`,2),$m(l,`thornBand`)),Am(e,`vialOfLife`)&&(Nm(e,2,l),$m(l,`vialOfLife`)),Am(e,`crownOfCinders`)&&(l.emberCap=12,l.embers=_m(l.embers+2,0,l.emberCap),$m(l,`crownOfCinders`)),Am(e,`shatterersCrown`)&&(l.enemies.forEach(e=>{e.facetMax=Math.max(2,e.facetMax-1),e.statuses.str=(e.statuses.str||0)+1}),$m(l,`shatterersCrown`)),Am(e,`smolderingCoal`)&&(l.enemies.forEach(e=>e.statuses.poison=(e.statuses.poison||0)+2),$m(l,`smolderingCoal`)),Am(e,`ashenCore`)&&(l.enemies.forEach(e=>e.statuses.poison=(e.statuses.poison||0)+3),$m(l,`ashenCore`)),th(e,l),yh(e,l),l}function Qm(e,t){for(let n=t.length-1;n>0;n--){let r=Math.floor(e()*(n+1));[t[n],t[r]]=[t[r],t[n]]}}function $m(e,t){e.queue.push({t:`relicProc`,id:t})}function eh(e,t,n,r){t.statuses[n]=(t.statuses[n]||0)+r,t.statuses[n]===0&&delete t.statuses[n],e.queue.push({t:`status`,who:t===e.player?`player`:t.idx,id:n,n:r})}function th(e,t){let n=Tm(e);for(let e of t.enemies)e.hp<=0||(e.moveKey=Fu[e.key].ai({turn:t.turn+1,last:e.lastMoves[e.lastMoves.length-1],prev:e.lastMoves[e.lastMoves.length-2],rng:n,hpFrac:e.hp/e.maxHp,self:e}),t.queue.push({t:`intent`,idx:e.idx,move:e.moveKey}))}function nh(e){return Fu[e.key].moves[e.moveKey]}function rh(e,t,n){let r=_m(t.embers+n,0,t.emberCap),i=r-t.embers;return i?(t.embers=r,t.queue.push({t:`ember`,n:i,total:t.embers}),i):0}function ih(e,t,n,r){if(!(t.over||n.hp<=0||r<=0))for(n.chips+=r,t.queue.push({t:`chip`,idx:n.idx,n:r,chips:Math.min(n.chips,n.facetMax),facetMax:n.facetMax});n.chips>=n.facetMax&&n.hp>0;)n.chips-=n.facetMax,ah(e,t,n)}function ah(e,t,n){if(n.facetMax+=1,n.flags.adamant&&!n.flags.adamantSpent){n.flags.adamantSpent=!0,t.queue.push({t:`adamantHold`,idx:n.idx});return}e.stats.shatters++,n.flags.staggered=!0,t.queue.push({t:`shatter`,idx:n.idx,facetMax:n.facetMax}),eh(t,n,`vulnerable`,2),rh(e,t,2),Am(e,`prismCharm`)&&!t.prismProcd&&(t.prismProcd=!0,rh(e,t,2),$m(t,`prismCharm`));let r=n.statuses.poison||0;if(r&&t.enemies.some(e=>e!==n&&e.hp>0)&&(delete n.statuses.poison,oh(e,t,n,r)),Am(e,`bellOfEndings`)){$m(t,`bellOfEndings`);for(let r of t.enemies.filter(e=>e!==n&&e.hp>0)){if(t.over)break;ph(e,t,r,4,{isAttack:!1})}}}function oh(e,t,n,r){if(!r)return;let i=t.enemies.filter(e=>e!==n&&e.hp>0);if(!i.length)return;let a=hm(Tm(e),i);eh(t,a,`poison`,r),t.queue.push({t:`smolderJump`,from:n.idx,to:a.idx,n:r})}function sh(e,t){let n=Hu[e.art];return!!n&&!t.over&&t.artUsedTurn!==t.turn&&t.embers>=n.cost}function ch(e,t){if(!sh(e,t))return!1;let n=Hu[e.art];t.artUsedTurn=t.turn,e.stats.embersSpent+=n.cost,rh(e,t,-n.cost),t.queue.push({t:`art`,id:e.art});for(let r of n.effects){if(t.over)break;lh(e,t,r)}return!0}function lh(e,t,n){let r=t.player,i=()=>t.enemies.filter(e=>e.hp>0);switch(n.kind){case`dmg`:for(let r of i())t.over||ph(e,t,r,n.n,{isAttack:!1});break;case`status`:if(n.who===`self`)eh(t,r,n.id,n.n);else for(let e of i())eh(t,e,n.id,n.n);break;case`block`:gh(e,t,r,n.n,!1);break;case`heal`:Nm(e,n.n,t);break;case`energy`:r.energy+=n.n,t.queue.push({t:`energy`,n:r.energy});break;case`draw`:_h(e,t,n.n);break;case`chip`:for(let r of i())ih(e,t,r,n.n);break;case`ember`:rh(e,t,n.n);break}}function uh(e,t,n){return!n||t.over||wm(n).type===`curse`?!1:!(t.kindledTurn===t.turn&&t.kindlesThisTurn>=dh(e))}function dh(e){return Am(e,`crownOfTithes`)?2:1}function fh(e,t,n){let r=t.hand.findIndex(e=>e.uid===n);if(r<0)return!1;let i=t.hand[r];return uh(e,t,i)?(t.kindledTurn!==t.turn&&(t.kindledTurn=t.turn,t.kindlesThisTurn=0),t.kindlesThisTurn++,t.hand.splice(r,1),e.stats.kindles++,t.queue.push({t:`kindle`,uid:i.uid,id:i.id}),vh(e,t,i),Am(e,`crownOfTithes`)&&(gh(e,t,t.player,3,!1),$m(t,`crownOfTithes`)),!0):!1}function ph(e,t,n,r,{isAttack:i=!0,mult:a=1}={}){if(n.hp<=0||t.over)return 0;let o=t.player,s=r;i&&(s+=o.statuses.str||0,o.statuses.weak&&(s=Math.floor(s*.75)),n.statuses.vulnerable&&(s=Math.floor(s*1.5))),s=Math.max(0,Math.floor(s*a));let c=Math.min(n.block,s);n.block-=c;let l=s-c;if(n.hp-=l,e.stats.dmgDealt+=l,t.queue.push({t:`hitEnemy`,idx:n.idx,amount:l,blocked:c,hpAfter:Math.max(0,n.hp),dead:n.hp<=0,killingBlow:n.hp<=0&&l>0,overkill:Math.max(0,-n.hp)}),t.pendingChips&&i&&l>0){let e=t.pendingChips.get(n.idx)||{hit:!1,extra:0};e.hit=!0,t.pendingChips.set(n.idx,e)}return i&&n.statuses.thorns&&n.hp>0&&hh(e,t,n.statuses.thorns,{source:`thorns`,isAttack:!1}),n.hp<=0&&mh(e,t,n),l}function mh(e,t,n){n.hp=0;let r=n.statuses.poison||0;if(n.statuses={},n.flags.staggered=!1,t.queue.push({t:`die`,idx:n.idx}),e.stats.slain++,n.elite&&e.stats.elites++,n.boss&&e.stats.bosses++,t.enemies.every(e=>e.hp<=0)){Dh(e,t);return}rh(e,t,1),oh(e,t,n,r),Am(e,`reapersBell`)&&(t.player.energy+=1,_h(e,t,1),$m(t,`reapersBell`),t.queue.push({t:`energy`,n:t.player.energy}))}function hh(e,t,n,{source:r=`self`,isAttack:i=!1,attacker:a=null}={}){if(t.over)return 0;let o=t.player,s=n;i&&a&&(s+=(a.statuses.str||0)+(a.flags.rampBonus||0)+(xm(e).enemyDmgBonus||0)+(ym(e).enemyDmgBonus||0),a.statuses.weak&&(s=Math.floor(s*.75)),o.statuses.vulnerable&&(s=Math.floor(s*1.5)),Am(e,`wardingCharm`)&&s<=5&&s>0&&(s=1,$m(t,`wardingCharm`))),s=Math.max(0,s);let c=0;(i||r===`thorns`)&&(c=Math.min(o.block,s),o.block-=c);let l=s-c;if(o.hp-=l,e.stats.dmgTaken+=Math.max(0,l),t.counters.hpLost+=Math.max(0,l),t.queue.push({t:`hitPlayer`,amount:l,blocked:c,hpAfter:Math.max(0,o.hp),source:r}),o.hp<=0)return Oh(e,t),l;if(i&&a){let n={...xm(e).playerHitApplies||{},...t.affix&&Vu[t.affix].mods.attackApplies||{}};for(let[e,r]of Object.entries(n))eh(t,o,e,r);o.statuses.thorns&&a.hp>0&&ph(e,t,a,o.statuses.thorns,{isAttack:!1})}return l}function gh(e,t,n,r,i=!0){let a=r;return n===t.player&&i&&(a+=n.statuses.dex||0,n.statuses.frail&&(a=Math.floor(a*.75))),a=Math.round(Math.max(0,a)*(xm(e).wardMult||1)),n.block+=a,t.queue.push({t:`blockGain`,who:n===t.player?`player`:n.idx,n:a,total:n.block}),a}function _h(e,t,n){let r=Tm(e);for(let e=0;e<n&&!(t.hand.length>=10);e++){if(!t.draw.length){if(!t.discard.length)break;t.draw=t.discard,t.discard=[],Qm(r,t.draw),t.queue.push({t:`reshuffle`})}let e=t.draw.pop();t.hand.push(e),t.queue.push({t:`draw`,uid:e.uid,id:e.id})}}function vh(e,t,n){t.exhaust.push(n),t.queue.push({t:`exhaust`,uid:n.uid}),rh(e,t,1),Am(e,`verdantBranch`)&&(_h(e,t,1),$m(t,`verdantBranch`))}function yh(e,t){if(t.over)return;t.turn++;let n=t.player;if(t.queue.push({t:`turn`,n:t.turn}),n.statuses.poison&&(hh(e,t,n.statuses.poison,{source:`poison`}),n.statuses.poison--,n.statuses.poison||delete n.statuses.poison,t.over))return;n.statuses.barricade||(n.block=0),n.statuses.ritual&&eh(t,n,`str`,n.statuses.ritual),n.statuses.emberflow&&rh(e,t,n.statuses.emberflow);let r=n.energyMax+(n.statuses.energized||0);t.turn===1&&Am(e,`emberLantern`)&&(r+=1,$m(t,`emberLantern`)),n.energy=(Am(e,`frozenCore`)?n.energy:0)+r,t.counters.firstCardPlayed=!1,t.queue.push({t:`energy`,n:n.energy});let i=5+(n.statuses.nightsight||0)+(xm(e).drawDelta||0);t.turn===1&&Am(e,`travelersPack`)&&(i+=2,$m(t,`travelersPack`)),_h(e,t,Math.max(1,i))}function bh(e,t,n){let r=wm(n);return r.cost==null?null:Am(e,`duskmirror`)&&!t.counters.firstCardPlayed?0:xm(e).firstCardDiscount&&!t.counters.firstCardPlayed?Math.max(0,r.cost-xm(e).firstCardDiscount):r.cost}function xh(e,t,n,r){if(t.over)return!1;let i=wm(n);return!(i.unplayable||bh(e,t,n)>t.player.energy||i.target===`enemy`&&(r==null||!t.enemies[r]||t.enemies[r].hp<=0))}function Sh(e,t,n,r=null){let i=t.hand.findIndex(e=>e.uid===n);if(i<0)return!1;let a=t.hand[i],o=wm(a);if(!xh(e,t,a,r))return!1;let s=t.player,c=bh(e,t,a);s.energy-=c,Am(e,`duskmirror`)&&!t.counters.firstCardPlayed&&o.cost>0&&$m(t,`duskmirror`),t.counters.firstCardPlayed=!0,t.hand.splice(i,1),t.counters.played++,e.stats.cardsPlayed++,t.queue.push({t:`play`,uid:a.uid,id:a.id,targetIdx:r}),t.queue.push({t:`energy`,n:s.energy});let l=1;o.type===`attack`&&(t.counters.attacks++,Am(e,`ironTalisman`)&&t.counters.attacks%3==0&&(eh(t,s,`str`,1),$m(t,`ironTalisman`)),Am(e,`executionersSeal`)&&t.counters.attacks%10==0&&(l=2,$m(t,`executionersSeal`)));let u=r==null?null:t.enemies[r],d=()=>t.enemies.filter(e=>e.hp>0);t.pendingChips=new Map;for(let n of o.effects){if(t.over)break;Ch(e,t,a,o,n,u,l)}if(t.pendingChips&&!t.over){let n=o.type===`attack`?1+(o.chip||0)+(s.statuses.beacon||0):0;for(let[r,i]of t.pendingChips){let a=t.enemies[r];if(!a||a.hp<=0||t.over)continue;let o=(i.hit?n:0)+i.extra;o>0&&ih(e,t,a,o)}}if(t.pendingChips=null,!t.over&&o.type===`attack`&&s.statuses.venomous){let e=o.target===`allEnemies`?d():u&&u.hp>0?[u]:[];for(let n of e)eh(t,n,`poison`,s.statuses.venomous)}return!t.over&&Am(e,`silkFan`)&&t.counters.played%3==0&&(gh(e,t,s,3,!1),$m(t,`silkFan`)),o.type===`power`?t.queue.push({t:`powerConsumed`,uid:a.uid}):o.exhaust?vh(e,t,a):t.discard.push(a),!0}function Ch(e,t,n,r,i,a,o){let s=t.player,c=r.target===`allEnemies`?t.enemies.filter(e=>e.hp>0):a?[a]:[];switch(i.kind){case`dmg`:{let n=i.times||1;for(let a=0;a<n;a++)for(let n of r.target===`allEnemies`?t.enemies.filter(e=>e.hp>0):c){if(t.over)return;ph(e,t,n,i.n,{mult:o})}break}case`block`:gh(e,t,s,i.n);break;case`draw`:_h(e,t,i.n);break;case`energy`:s.energy+=i.n,t.queue.push({t:`energy`,n:s.energy});break;case`heal`:Nm(e,i.n,t);break;case`loseHp`:hh(e,t,i.n,{source:`self`});break;case`status`:if(i.who===`self`)eh(t,s,i.id,i.n);else if(i.who===`allEnemies`)for(let e of t.enemies.filter(e=>e.hp>0))eh(t,e,i.id,i.n);else a&&a.hp>0&&eh(t,a,i.id,i.n);break;case`addCard`:for(let n=0;n<(i.n||1);n++){let n={uid:e.uid++,id:i.id,up:!1,bonus:0};(i.where===`hand`&&t.hand.length<10?t.hand:t.discard).push(n),t.queue.push({t:`addCard`,id:i.id,where:i.where||`discard`})}break;case`chip`:for(let n of c)if(!(n.hp<=0))if(t.pendingChips){let e=t.pendingChips.get(n.idx)||{hit:!1,extra:0};e.extra+=i.n,t.pendingChips.set(n.idx,e)}else ih(e,t,n,i.n);break;case`ember`:rh(e,t,i.n);break;case`special`:wh(e,t,n,r,i,a,o)}}function wh(e,t,n,r,i,a,o){let s=t.player;switch(i.id){case`leech`:{let n=ph(e,t,a,i.n,{mult:o});n>0&&Nm(e,Math.floor(n/2),t);break}case`execute`:{let n=a.statuses.vulnerable?i.bonus:0;ph(e,t,a,i.n+n,{mult:o});break}case`momentum`:ph(e,t,a,i.n+n.bonus,{mult:o}),n.bonus+=i.grow;break;case`phantom`:ph(e,t,a,i.n*t.hand.length,{mult:o});break;case`devour`:ph(e,t,a,i.n,{mult:o}),a.hp<=0&&(t.over?Nm(e,i.heal):(rh(e,t,i.embers),Nm(e,i.heal,t)));break;case`doubleBlock`:gh(e,t,s,s.block,!1);break;case`catalyst`:a.statuses.poison&&eh(t,a,`poison`,a.statuses.poison*(i.n-1));break;case`shatterEcho`:{let n=a.flags.staggered||a.statuses.vulnerable?2:1;ph(e,t,a,i.n*n,{mult:o});break}case`emberNova`:ph(e,t,a,i.n*t.embers,{mult:o});break;case`pyreTithe`:for(let r of[...t.hand]){if(r===n)continue;let i=t.hand.indexOf(r);t.hand.splice(i,1),t.queue.push({t:`kindle`,uid:r.uid,id:r.id}),vh(e,t,r)}_h(e,t,i.draw);break;case`flawless`:gh(e,t,s,i.n),t.counters.hpLost===0&&gh(e,t,s,i.n);break;case`emberdance`:{let n=t.embers;n>0&&(e.stats.embersSpent+=n,rh(e,t,-n),gh(e,t,s,i.n*n,!1));break}}}function Th(e,t,n,r=null){let i=e.player.potions[n];if(!i)return!1;let a=Pu[i];if(a.combatOnly&&(!t||t.over)||a.needsTarget&&(r==null||!t.enemies[r]||t.enemies[r].hp<=0))return!1;switch(e.player.potions[n]=null,t&&t.queue.push({t:`potion`,id:i}),i){case`healing`:Nm(e,20,t),t||(e.player.hp=_m(e.player.hp,0,e.player.maxHp));break;case`strength`:eh(t,t.player,`str`,2);break;case`swift`:_h(e,t,3);break;case`block`:gh(e,t,t.player,12,!1);break;case`fire`:ph(e,t,t.enemies[r],20,{isAttack:!1});break;case`venom`:eh(t,t.enemies[r],`poison`,7);break;case`energy`:rh(e,t,3);break}return!0}function Eh(e,t){if(t.over)return;let n=t.player;t.queue.push({t:`endTurn`});for(let n of[...t.hand]){let r=wm(n);if(r.endTurnDmg&&hh(e,t,r.endTurnDmg,{source:`burn`}),r.endTurnLoseHp&&hh(e,t,r.endTurnLoseHp,{source:`burn`}),t.over)return}n.statuses.metallicize&&gh(e,t,n,n.statuses.metallicize,!1),n.statuses.regen&&Nm(e,n.statuses.regen,t),t.discard.push(...t.hand),t.hand=[],t.queue.push({t:`discardHand`});for(let e of[`vulnerable`,`weak`,`frail`,`beacon`])n.statuses[e]&&(n.statuses[e]--,n.statuses[e]||delete n.statuses[e]);for(let r of t.enemies)if(!(r.hp<=0||t.over)){if(r.statuses.poison){let n=r.statuses.poison;if(r.hp-=n,e.stats.dmgDealt+=n,t.queue.push({t:`hitEnemy`,idx:r.idx,amount:n,blocked:0,hpAfter:Math.max(0,r.hp),dead:r.hp<=0,poison:!0}),r.statuses.poison--,r.statuses.poison||delete r.statuses.poison,r.hp<=0){e.stats.smolderKills++,mh(e,t,r);continue}}if(r.block=0,r.flags.staggered)r.flags.staggered=!1,r.lastMoves.push(r.moveKey),t.queue.push({t:`staggered`,idx:r.idx});else{let i=nh(r);if(t.queue.push({t:`enemyAct`,idx:r.idx,move:r.moveKey,name:i.name}),r.lastMoves.push(r.moveKey),i.dmg!=null){for(let n=0;n<(i.times||1)&&!t.over;n++)hh(e,t,i.dmg,{source:r.idx,isAttack:!0,attacker:r});i.ramp&&(r.flags.rampBonus=(r.flags.rampBonus||0)+i.ramp)}if(t.over)return;if(i.block&&gh(e,t,r,i.block,!1),i.heal&&(r.hp=Math.min(r.maxHp,r.hp+i.heal),t.queue.push({t:`heal`,who:r.idx,n:i.heal})),i.fx){for(let e of i.fx)if(e.who===`player`)eh(t,n,e.id,e.n);else if(e.who===`self`)eh(t,r,e.id,e.n);else if(e.who===`allies`)for(let n of t.enemies.filter(e=>e.hp>0))eh(t,n,e.id,e.n)}if(i.addCards)for(let n=0;n<i.addCards.n;n++)t.discard.push({uid:e.uid++,id:i.addCards.id,up:!1,bonus:0}),t.queue.push({t:`addCard`,id:i.addCards.id,where:`discard`})}r.statuses.ritual&&eh(t,r,`str`,r.statuses.ritual);for(let e of[`vulnerable`,`weak`])r.statuses[e]&&(r.statuses[e]--,r.statuses[e]||delete r.statuses[e])}t.over||(th(e,t),yh(e,t))}function Dh(e,t){t.over=!0,t.result=`win`,e.player.hp=_m(t.player.hp,1,e.player.maxHp),Am(e,`emberHeart`)&&(Nm(e,6),$m(t,`emberHeart`)),Am(e,`crownOfTheHearth`)&&t.embers>0&&(Nm(e,t.embers*3),$m(t,`crownOfTheHearth`)),Am(e,`gravebloom`)&&e.player.hp<=e.player.maxHp*.5&&(Nm(e,10),$m(t,`gravebloom`)),e.player.hp=_m(e.player.hp,1,e.player.maxHp),t.queue.push({t:`victory`,perfect:t.counters.hpLost===0})}function Oh(e,t){t.over=!0,t.result=`loss`,t.player.hp=0,e.player.hp=0,t.queue.push({t:`defeat`})}function kh(e,t,n=null){let r=e.player,i=t+(r.statuses.str||0);r.statuses.weak&&(i=Math.floor(i*.75));let a=n==null?null:e.enemies[n];return a&&a.statuses.vulnerable&&(i=Math.floor(i*1.5)),Math.max(0,i)}function Ah(e,t,n){let r=t.player,i=n+(r.statuses.dex||0);return r.statuses.frail&&(i=Math.floor(i*.75)),Math.round(Math.max(0,i)*(xm(e).wardMult||1))}function jh(e,t,n){let r=nh(n);if(r.dmg==null)return null;let i=r.dmg+(n.statuses.str||0)+(n.flags.rampBonus||0)+(xm(e).enemyDmgBonus||0)+(ym(e).enemyDmgBonus||0);return n.statuses.weak&&(i=Math.floor(i*.75)),t.player.statuses.vulnerable&&(i=Math.floor(i*1.5)),{dmg:Math.max(0,i),times:r.times||1}}function Mh(e,t,n,r=null){let i=wm(n),a=t.player,o=r==null?null:t.enemies[r],s=Am(e,`executionersSeal`)&&i.type===`attack`&&(t.counters.attacks+1)%10==0?2:1,c=e=>{let t=e+(a.statuses.str||0);return a.statuses.weak&&(t=Math.floor(t*.75)),o&&o.statuses.vulnerable&&(t=Math.floor(t*1.5)),Math.max(0,Math.floor(t*s))},l=[],u=0;for(let r of i.effects)r.kind===`dmg`?l.push({dmg:c(r.n),times:r.times||1}):r.kind===`block`?u+=Ah(e,t,r.n):r.kind===`special`&&(r.id===`leech`||r.id===`devour`?l.push({dmg:c(r.n),times:1}):r.id===`execute`?l.push({dmg:c(r.n+(o?.statuses.vulnerable?r.bonus:0)),times:1}):r.id===`momentum`?l.push({dmg:c(r.n+(n.bonus||0)),times:1}):r.id===`phantom`?l.push({dmg:c(r.n*Math.max(0,t.hand.length-+!!t.hand.includes(n))),times:1}):r.id===`shatterEcho`?l.push({dmg:c(r.n*(o&&(o.flags.staggered||o.statuses.vulnerable)?2:1)),times:1}):r.id===`emberNova`?l.push({dmg:c(r.n*t.embers),times:1}):r.id===`doubleBlock`?u+=a.block:r.id===`flawless`?u+=Ah(e,t,r.n)*(t.counters.hpLost===0?2:1):r.id===`emberdance`&&(u+=r.n*t.embers));let d=0;for(let e of i.effects)e.kind===`chip`&&(d+=e.n);if(!l.length&&!u&&!d)return null;let f=l.reduce((e,t)=>e+t.dmg*t.times,0),p=f,m=!1,h=0,g=!1;if(o){let e=o.block;p=0;for(let t of l)for(let n=0;n<t.times;n++){let n=Math.min(e,t.dmg);e-=n,p+=t.dmg-n}m=p>=o.hp;let t=i.type===`attack`?1+(i.chip||0)+(a.statuses.beacon||0):0;h=(l.length&&p>0?t:0)+d,g=h>0&&o.chips+h>=o.facetMax&&!m}return{hits:l,total:f,loss:p,lethal:m,block:u,chips:h,willShatter:g}}function Nh(e,t,n=!1){let r=Cm(e,t,n);return e.player.deck.push(r),r}function Ph(e,t){let n=e.player.deck.findIndex(e=>e.uid===t);n>=0&&e.player.deck.splice(n,1)}function Fh(e,t){let n=e.player.deck.find(e=>e.uid===t);n&&(n.up=!0)}function Ih(e,t){let n=e.player.deck.find(e=>e.uid===t);n&&e.player.deck.push(Cm(e,n.id,n.up))}var Lh=`spirebound_save_v2`,Rh=`spirebound_stats_v1`;function zh(e){try{localStorage.setItem(Lh,JSON.stringify(e))}catch{}}function Bh(){try{let e=localStorage.getItem(Lh);if(!e)return null;let t=JSON.parse(e);if(!t||t.v!==2||!t.player||!t.map||!t.player.deck.every(e=>ku[e.id])||!t.player.relics.every(e=>Mu[e])||!t.player.potions.every(e=>e==null||Pu[e])||t.art!=null&&!Hu[t.art]||!(t.omens||[]).every(e=>Bu[e]))return null;for(t.art??=`flare`,t.aspect=_m(t.aspect??0,0,Wu.length-1),t.vow=_m(t.vow??0,0,Gu.length),t.unlocks??=[],t.omens??=[],t.boon??=null,t.bossRelicAct??=-1,t.orphanRewardClaimed??=!1;t.omens.length<=t.act;)t.omens.push(bm(t));for(let e of[`shatters`,`kindles`,`perfects`,`smolderKills`,`unlitVisited`,`embersSpent`])t.stats[e]??=0;return t}catch{return null}}function Vh(){try{localStorage.removeItem(Lh),localStorage.removeItem(`spirebound_save_v1`)}catch{}}function Hh(){try{return JSON.parse(localStorage.getItem(Rh))||{runs:0,wins:0,best:0}}catch{return{runs:0,wins:0,best:0}}}function Uh(e,t){let n=Hh();n.runs++,t&&n.wins++,n.best=Math.max(n.best,e.act*15+e.floorsClimbed);try{localStorage.setItem(Rh,JSON.stringify(n))}catch{}Vh()}function Wh(e,t,n=Tm(e)){let r=[],i=[];for(let a of t){if(a.gold&&(e.player.gold=Math.max(0,e.player.gold+a.gold),a.gold>0&&(e.stats.goldEarned+=a.gold)),a.hp&&(e.player.hp=_m(e.player.hp+a.hp,1,e.player.maxHp)),a.maxHp&&(e.player.maxHp=Math.max(1,e.player.maxHp+a.maxHp),e.player.hp=_m(e.player.hp+Math.max(0,a.maxHp),1,e.player.maxHp)),a.heal&&Nm(e,Math.round(e.player.maxHp*a.heal)),a.addCard&&Nh(e,a.addCard),a.addRelic){let t=a.addRelic===`random`?Fm(e):a.addRelic;t?(Pm(e,t),i.push({relic:t})):(e.player.gold+=50,i.push({text:`You find 50 gold instead.`}))}if(a.potion&&Um(e,a.potion),a.pickRemove&&r.push(`remove`),a.pickUpgrade&&r.push(`upgrade`),a.pickDuplicate&&r.push(`duplicate`),a.pickCard&&r.push({pickCard:a.pickCard}),a.roll){let t=n(),o=0;for(let s of a.roll)if(o+=s.p,t<o){i.push({text:s.text});let t=Wh(e,s.ops,n);r.push(...t.pending),i.push(...t.log);break}}}return{pending:r,log:i}}var Gh=Object.assign({"./assets/arts/ashfall.png":`/assets/ashfall-C0Z9oihA.png`,"./assets/arts/beacon.png":`/assets/beacon-CfpI4NvN.png`,"./assets/arts/emberveil.png":`/assets/emberveil-DRPFSPHg.png`,"./assets/arts/flare.png":`/assets/flare-Ca-5NBfJ.png`,"./assets/arts/mendglass.png":`/assets/mendglass-MxKA-x9I.png`,"./assets/arts/stoke.png":`/assets/stoke-D5pz9eOt.png`,"./assets/boons/emberFlask.png":`/assets/emberFlask-BlP1krpU.png`,"./assets/boons/fullPurse.png":`/assets/fullPurse-DcTqZ-nz.png`,"./assets/boons/keenEye.png":`/assets/keenEye-DPefaPGL.png`,"./assets/boons/pilgrimsCache.png":`/assets/pilgrimsCache-CsIcQUYT.png`,"./assets/boons/temperedGlass.png":`/assets/temperedGlass-BVjobJFG.png`,"./assets/boons/twinPhials.png":`/assets/twinPhials-D5-9T5W2.png`,"./assets/boons/venomPouch.png":`/assets/venomPouch-9GhvdgzC.png`,"./assets/boons/warmHearth.png":`/assets/warmHearth-DTnVpfFw.png`,"./assets/cards/aegis.jpg":`/assets/aegis-D665L0sd.jpg`,"./assets/cards/agility.jpg":`/assets/agility-CUG3xKOo.jpg`,"./assets/cards/annihilate.jpg":`/assets/annihilate-CXlkbExQ.jpg`,"./assets/cards/ascension.jpg":`/assets/ascension-S4GAfpbx.jpg`,"./assets/cards/ashBite.jpg":`/assets/ashBite-BYzdJfb7.jpg`,"./assets/cards/ashenChoir.jpg":`/assets/ashenChoir-DTfq4XXZ.jpg`,"./assets/cards/bastion.jpg":`/assets/bastion-CM0wK4Yy.jpg`,"./assets/cards/bloodRite.jpg":`/assets/bloodRite-ou1XgXoc.jpg`,"./assets/cards/brace.jpg":`/assets/brace-Dc4SYgdF.jpg`,"./assets/cards/bulwark.jpg":`/assets/bulwark-CjEcWZ-i.jpg`,"./assets/cards/burn.jpg":`/assets/burn-DJ4EegTp.jpg`,"./assets/cards/catalyst.jpg":`/assets/catalyst-ClagfpN0.jpg`,"./assets/cards/chisel.jpg":`/assets/chisel-DGrQWYAc.jpg`,"./assets/cards/cleave.jpg":`/assets/cleave-CvexqRxg.jpg`,"./assets/cards/cripple.jpg":`/assets/cripple-CRxGKuS4.jpg`,"./assets/cards/defend.jpg":`/assets/defend-mmYA7HKX.jpg`,"./assets/cards/deflect.jpg":`/assets/deflect-BKgfxyAn.jpg`,"./assets/cards/devour.jpg":`/assets/devour-CST2E0aP.jpg`,"./assets/cards/eclipseSlash.jpg":`/assets/eclipseSlash-DEA5FgEC.jpg`,"./assets/cards/emberdance.jpg":`/assets/emberdance-B_CKT6sd.jpg`,"./assets/cards/empower.jpg":`/assets/empower-D4P9cm_V.jpg`,"./assets/cards/executioner.jpg":`/assets/executioner-BOy4ovki.jpg`,"./assets/cards/firstSpark.jpg":`/assets/firstSpark-BpDCHsPu.jpg`,"./assets/cards/flawlessForm.jpg":`/assets/flawlessForm-Di6668jF.jpg`,"./assets/cards/flurry.jpg":`/assets/flurry-BgnBaWD-.jpg`,"./assets/cards/fortify.jpg":`/assets/fortify-BzU364vJ.jpg`,"./assets/cards/frenzy.jpg":`/assets/frenzy-qaLdgJOP.jpg`,"./assets/cards/guardedStrike.jpg":`/assets/guardedStrike-CesH5DLC.jpg`,"./assets/cards/heavyBlow.jpg":`/assets/heavyBlow-XGOXUeSq.jpg`,"./assets/cards/hex.jpg":`/assets/hex-CzQLIJW1.jpg`,"./assets/cards/ironSkin.jpg":`/assets/ironSkin-BOE1a1BZ.jpg`,"./assets/cards/leechBlade.jpg":`/assets/leechBlade-CFp6z-JI.jpg`,"./assets/cards/limitBreak.jpg":`/assets/limitBreak-BU_PNCuK.jpg`,"./assets/cards/lunge.jpg":`/assets/lunge-D9lgqjTD.jpg`,"./assets/cards/momentum.jpg":`/assets/momentum-Clbqs0on.jpg`,"./assets/cards/nightSight.jpg":`/assets/nightSight-DuZK4KbA.jpg`,"./assets/cards/novaflare.jpg":`/assets/novaflare-Dwvtjr_D.jpg`,"./assets/cards/oblivionStrike.jpg":`/assets/oblivionStrike-CXq1522m.jpg`,"./assets/cards/offering.jpg":`/assets/offering-BaVvule_.jpg`,"./assets/cards/phantomBlades.jpg":`/assets/phantomBlades-Bck63olt.jpg`,"./assets/cards/preparation.jpg":`/assets/preparation-BkmwWzr3.jpg`,"./assets/cards/pyreheart.jpg":`/assets/pyreheart-Cf86Pj1Y.jpg`,"./assets/cards/quakeblow.jpg":`/assets/quakeblow-DZPTH_O8.jpg`,"./assets/cards/quickSlash.jpg":`/assets/quickSlash-DMRFz6rj.jpg`,"./assets/cards/regrowth.jpg":`/assets/regrowth-C0gMpqIX.jpg`,"./assets/cards/resonantLance.jpg":`/assets/resonantLance-CCStaA3R.jpg`,"./assets/cards/shardstorm.jpg":`/assets/shardstorm-DIKHFs35.jpg`,"./assets/cards/sidestep.jpg":`/assets/sidestep-CeDzy6bs.jpg`,"./assets/cards/smother.jpg":`/assets/smother-DFWDS6kH.jpg`,"./assets/cards/strike.jpg":`/assets/strike-DfYIx_7x.jpg`,"./assets/cards/surge.jpg":`/assets/surge-Ci44wXor.jpg`,"./assets/cards/tempest.jpg":`/assets/tempest-K9Ub9Fd7.jpg`,"./assets/cards/tithe.jpg":`/assets/tithe-DvZ_GGtQ.jpg`,"./assets/cards/toxicMist.jpg":`/assets/toxicMist-DMOH0JOL.jpg`,"./assets/cards/twinFangs.jpg":`/assets/twinFangs-C0lavWO6.jpg`,"./assets/cards/uppercut.jpg":`/assets/uppercut-CY7mUqmx.jpg`,"./assets/cards/venomStrike.jpg":`/assets/venomStrike-DGTk3cTA.jpg`,"./assets/cards/virulence.jpg":`/assets/virulence-vlHxYWHm.jpg`,"./assets/cards/warCry.jpg":`/assets/warCry-BO21yVwc.jpg`,"./assets/cards/wound.jpg":`/assets/wound-B5mKVM4_.jpg`,"./assets/enemies/abyssalKnight.png":`/assets/abyssalKnight-BA9qPzL_.png`,"./assets/enemies/alphaFang.png":`/assets/alphaFang-CYs2MfQS.png`,"./assets/enemies/ashAcolyte.png":`/assets/ashAcolyte-W7Bx9eY3.png`,"./assets/enemies/chaosHound.png":`/assets/chaosHound-Cu1tbGXO.png`,"./assets/enemies/deepmaw.png":`/assets/deepmaw-BuZMfyUW.png`,"./assets/enemies/drownedOne.png":`/assets/drownedOne-762yKbrK.png`,"./assets/enemies/duskfang.png":`/assets/duskfang-kVQE2Vbx.png`,"./assets/enemies/gloomslime.png":`/assets/gloomslime-BYNIQKkd.png`,"./assets/enemies/gravewarden.png":`/assets/gravewarden-CYbqq2Uz.png`,"./assets/enemies/heraldOfEnd.png":`/assets/heraldOfEnd-B5j76nBL.png`,"./assets/enemies/leviathan.png":`/assets/leviathan-DUX2Oy2k.png`,"./assets/enemies/mirelurker.png":`/assets/mirelurker-Cs0-ryPe.png`,"./assets/enemies/obsidianGolem.png":`/assets/obsidianGolem-B2_vm835.png`,"./assets/enemies/rootheart.png":`/assets/rootheart-CoZqsgKs.png`,"./assets/enemies/shade.png":`/assets/shade-cFzxMAwm.png`,"./assets/enemies/shellback.png":`/assets/shellback-9j9gwuRI.png`,"./assets/enemies/siren.png":`/assets/siren-Boj63opF.png`,"./assets/enemies/sovereign.png":`/assets/sovereign-DlFMbPOe.png`,"./assets/enemies/sporeling.png":`/assets/sporeling-B8wAP_1e.png`,"./assets/enemies/starCultist.png":`/assets/starCultist-DrQ9SosS.png`,"./assets/enemies/thornling.png":`/assets/thornling-BJhkzjJz.png`,"./assets/enemies/tidecaller.png":`/assets/tidecaller-C3FvvD8d.png`,"./assets/enemies/voidColossus.png":`/assets/voidColossus-D1BBPiCC.png`,"./assets/enemies/voidWisp.png":`/assets/voidWisp-DqB4mImW.png`,"./assets/enemies/voltEel.png":`/assets/voltEel-BxcD87LR.png`,"./assets/enemies/watcherEye.png":`/assets/watcherEye-Cx0FZXO4.png`,"./assets/enemies/waylayer.png":`/assets/waylayer-DkHd5xp-.png`,"./assets/events/cursedIdol.png":`/assets/cursedIdol--s0qHWso.png`,"./assets/events/emberFountain.png":`/assets/emberFountain-D_Q0157p.png`,"./assets/events/fleshTrader.png":`/assets/fleshTrader-q8lAx2oa.png`,"./assets/events/forge.png":`/assets/forge-i5xE2DIv.png`,"./assets/events/forgottenShrine.png":`/assets/forgottenShrine-CYFo9R9B.png`,"./assets/events/gambler.png":`/assets/gambler-D4lmA3Yw.png`,"./assets/events/library.png":`/assets/library-CstvhNks.png`,"./assets/events/mirror.png":`/assets/mirror-Hp5O4ZPJ.png`,"./assets/events/ruinedCamp.png":`/assets/ruinedCamp-BvAZgrK0.png`,"./assets/events/voidChest.png":`/assets/voidChest-B34oBTge.png`,"./assets/events/woundedKnight.png":`/assets/woundedKnight-JN7kYI1u.png`,"./assets/heroes/ashwarden.png":`/assets/ashwarden-D21mg7QM.png`,"./assets/heroes/duskblade.png":`/assets/duskblade-DupP5i2p.png`,"./assets/omens/ashfall.png":`/assets/ashfall-T4uYvK8I.png`,"./assets/omens/emberWind.png":`/assets/emberWind-Cw83yf4v.png`,"./assets/omens/heavyAir.png":`/assets/heavyAir-CjAuZn0d.png`,"./assets/omens/hungryDark.png":`/assets/hungryDark-JCDxnDj4.png`,"./assets/omens/longNight.png":`/assets/longNight-C2g4JuMB.png`,"./assets/omens/thinGlass.png":`/assets/thinGlass-CCNgzO1U.png`,"./assets/omens/waningMoon.png":`/assets/waningMoon-DyGgMjmd.png`,"./assets/potions/block.png":`/assets/block-DybnuP3a.png`,"./assets/potions/energy.png":`/assets/energy-CWJoumcv.png`,"./assets/potions/fire.png":`/assets/fire-Bc2Edgqg.png`,"./assets/potions/healing.png":`/assets/healing-Bf7MtUhk.png`,"./assets/potions/strength.png":`/assets/strength-Bp64zOFp.png`,"./assets/potions/swift.png":`/assets/swift-Da4aGqnZ.png`,"./assets/potions/venom.png":`/assets/venom-DzAfe6ZB.png`,"./assets/props/campfire.png":`/assets/campfire-C5hpDY2a.png`,"./assets/props/chest-open.png":`/assets/chest-open-D2mfQAex.png`,"./assets/props/chest.png":`/assets/chest-Dz-t7vgq.png`,"./assets/props/merchant.png":`/assets/merchant-CRCPVNlm.png`,"./assets/relics/ashenCore.png":`/assets/ashenCore-BHw_xmlT.png`,"./assets/relics/basaltIdol.png":`/assets/basaltIdol-BLUsj7rE.png`,"./assets/relics/bellOfEndings.png":`/assets/bellOfEndings-CMuMud-J.png`,"./assets/relics/crownOfCinders.png":`/assets/crownOfCinders-B4iyR0zw.png`,"./assets/relics/crownOfTheHearth.png":`/assets/crownOfTheHearth-Cz96lab0.png`,"./assets/relics/crownOfTithes.png":`/assets/crownOfTithes-BCSNj05m.png`,"./assets/relics/duskmirror.png":`/assets/duskmirror-ChDahFDy.png`,"./assets/relics/emberHeart.png":`/assets/emberHeart-D8pWC_qd.png`,"./assets/relics/emberLantern.png":`/assets/emberLantern-CzFc-ESn.png`,"./assets/relics/executionersSeal.png":`/assets/executionersSeal-B-n0EUgT.png`,"./assets/relics/frozenCore.png":`/assets/frozenCore-JuT4c4Zg.png`,"./assets/relics/gravebloom.png":`/assets/gravebloom-CR3cDZz9.png`,"./assets/relics/hollowCrown.png":`/assets/hollowCrown-CHl2KxBg.png`,"./assets/relics/ironTalisman.png":`/assets/ironTalisman-CLgSHgbT.png`,"./assets/relics/merchantsMark.png":`/assets/merchantsMark-YaAPSe2m.png`,"./assets/relics/prismCharm.png":`/assets/prismCharm-CWUUYnXM.png`,"./assets/relics/reapersBell.png":`/assets/reapersBell-DK7zj2uj.png`,"./assets/relics/riverPearl.png":`/assets/riverPearl-1k1ZwvLB.png`,"./assets/relics/seersOrb.png":`/assets/seersOrb--o7V7uP4.png`,"./assets/relics/shatterersCrown.png":`/assets/shatterersCrown-VlDF7CT4.png`,"./assets/relics/silkFan.png":`/assets/silkFan-Co6ZNxqb.png`,"./assets/relics/smolderingCoal.png":`/assets/smolderingCoal-ESDuOXE3.png`,"./assets/relics/sunBlossom.png":`/assets/sunBlossom-GItTIWOb.png`,"./assets/relics/sweetRoot.png":`/assets/sweetRoot-DVIYyMAo.png`,"./assets/relics/thiefOfWicks.png":`/assets/thiefOfWicks-WD5HQJ9E.png`,"./assets/relics/thornBand.png":`/assets/thornBand-1rbgbbpR.png`,"./assets/relics/travelersPack.png":`/assets/travelersPack-Ctq6FXOL.png`,"./assets/relics/verdantBranch.png":`/assets/verdantBranch-BpapOPVN.png`,"./assets/relics/vialOfLife.png":`/assets/vialOfLife-CqH_Yzkc.png`,"./assets/relics/warFetish.png":`/assets/warFetish-BphYE_UB.png`,"./assets/relics/wardingCharm.png":`/assets/wardingCharm-DcyucUO6.png`,"./assets/stage/act1-backdrop.png":`/assets/act1-backdrop-CC5kcu8K.png`,"./assets/stage/act1-ledge.png":`/assets/act1-ledge-Xknu1EDQ.png`,"./assets/stage/act1-mid.png":`/assets/act1-mid-B4s3OZuq.png`,"./assets/stage/act2-backdrop.png":`/assets/act2-backdrop-BtpNIaTG.png`,"./assets/stage/act2-ledge.png":`/assets/act2-ledge-CVAyrxfF.png`,"./assets/stage/act2-mid.png":`/assets/act2-mid-BAevK0Pb.png`,"./assets/stage/act3-backdrop.png":`/assets/act3-backdrop-DFsKREnY.png`,"./assets/stage/act3-ledge.png":`/assets/act3-ledge-DuyDX66N.png`,"./assets/stage/act3-mid.png":`/assets/act3-mid-CukJ38oi.png`,"./assets/title/title.png":`/assets/title-BZbtHJmc.png`,"./assets/title-background/background.png":`/assets/background-cEVCcaPg.png`,"./assets-legacy/cards/aegis.png":`/assets/aegis-BbAK7DRy.png`,"./assets-legacy/cards/agility.png":`/assets/agility-D28Eu8MG.png`,"./assets-legacy/cards/annihilate.png":`/assets/annihilate-M3mspBDm.png`,"./assets-legacy/cards/ascension.png":`/assets/ascension-C2Pll28_.png`,"./assets-legacy/cards/ashBite.png":`/assets/ashBite-BBZrYNBt.png`,"./assets-legacy/cards/ashenChoir.png":`/assets/ashenChoir-Cjfn-BY1.png`,"./assets-legacy/cards/bastion.png":`/assets/bastion-D4uvW6Yu.png`,"./assets-legacy/cards/bloodRite.png":`/assets/bloodRite-xNaIV6FC.png`,"./assets-legacy/cards/brace.png":`/assets/brace-CDbc3WSx.png`,"./assets-legacy/cards/bulwark.png":`/assets/bulwark-DvQ82Xby.png`,"./assets-legacy/cards/burn.png":`/assets/burn-BVJa4vLy.png`,"./assets-legacy/cards/catalyst.png":`/assets/catalyst-C9UJqVfa.png`,"./assets-legacy/cards/chisel.png":`/assets/chisel-BHUdyvP2.png`,"./assets-legacy/cards/cleave.png":`/assets/cleave-Cs444Dst.png`,"./assets-legacy/cards/cripple.png":`/assets/cripple-CtSZS_Jx.png`,"./assets-legacy/cards/defend.png":`/assets/defend-BT8TAbMa.png`,"./assets-legacy/cards/deflect.png":`/assets/deflect-C25gbOwx.png`,"./assets-legacy/cards/devour.png":`/assets/devour-CXvHmKvA.png`,"./assets-legacy/cards/eclipseSlash.png":`/assets/eclipseSlash-B5W8xu8L.png`,"./assets-legacy/cards/emberdance.png":`/assets/emberdance-CBOqWIEl.png`,"./assets-legacy/cards/empower.png":`/assets/empower-DauCte29.png`,"./assets-legacy/cards/executioner.png":`/assets/executioner-DI8vj7EW.png`,"./assets-legacy/cards/firstSpark.png":`/assets/firstSpark-CaQ5-JAc.png`,"./assets-legacy/cards/flawlessForm.png":`/assets/flawlessForm-C34QTET6.png`,"./assets-legacy/cards/flurry.png":`/assets/flurry-D8kOQQ9x.png`,"./assets-legacy/cards/fortify.png":`/assets/fortify-DEACu-Zo.png`,"./assets-legacy/cards/frenzy.png":`/assets/frenzy-BgGGtYpf.png`,"./assets-legacy/cards/guardedStrike.png":`/assets/guardedStrike-BBAeWagI.png`,"./assets-legacy/cards/heavyBlow.png":`/assets/heavyBlow-Btb1hEmS.png`,"./assets-legacy/cards/hex.png":`/assets/hex-D3QIN_GY.png`,"./assets-legacy/cards/ironSkin.png":`/assets/ironSkin-DIcLMutG.png`,"./assets-legacy/cards/leechBlade.png":`/assets/leechBlade-BgoitLbP.png`,"./assets-legacy/cards/limitBreak.png":`/assets/limitBreak-D3VHagIC.png`,"./assets-legacy/cards/lunge.png":`/assets/lunge-BKNULJcP.png`,"./assets-legacy/cards/momentum.png":`/assets/momentum-D0hGLm2N.png`,"./assets-legacy/cards/nightSight.png":`/assets/nightSight-1ggiNsUe.png`,"./assets-legacy/cards/novaflare.png":`/assets/novaflare-BtAOF5B2.png`,"./assets-legacy/cards/oblivionStrike.png":`/assets/oblivionStrike-Ck8D7viT.png`,"./assets-legacy/cards/offering.png":`/assets/offering-BDnzVcbS.png`,"./assets-legacy/cards/phantomBlades.png":`/assets/phantomBlades-CZgzKQZJ.png`,"./assets-legacy/cards/preparation.png":`/assets/preparation-B0_lrDKo.png`,"./assets-legacy/cards/pyreheart.png":`/assets/pyreheart-BzRCI95J.png`,"./assets-legacy/cards/quakeblow.png":`/assets/quakeblow-DZuM_zei.png`,"./assets-legacy/cards/quickSlash.png":`/assets/quickSlash-BHIEN7hF.png`,"./assets-legacy/cards/regrowth.png":`/assets/regrowth-DCr6zV9b.png`,"./assets-legacy/cards/resonantLance.png":`/assets/resonantLance-DFyDlcY4.png`,"./assets-legacy/cards/shardstorm.png":`/assets/shardstorm-CtSThqM0.png`,"./assets-legacy/cards/sidestep.png":`/assets/sidestep-D-t2UoHV.png`,"./assets-legacy/cards/smother.png":`/assets/smother-Boa7xrCA.png`,"./assets-legacy/cards/strike.png":`/assets/strike-CmEr2qad.png`,"./assets-legacy/cards/surge.png":`/assets/surge-D5JDOylt.png`,"./assets-legacy/cards/tempest.png":`/assets/tempest-DosF7X1A.png`,"./assets-legacy/cards/tithe.png":`/assets/tithe-BNvDlR3N.png`,"./assets-legacy/cards/toxicMist.png":`/assets/toxicMist-BUGxQeK0.png`,"./assets-legacy/cards/twinFangs.png":`/assets/twinFangs-BUW2V2Kq.png`,"./assets-legacy/cards/uppercut.png":`/assets/uppercut-C0A2yndn.png`,"./assets-legacy/cards/venomStrike.png":`/assets/venomStrike-CXIglW-b.png`,"./assets-legacy/cards/virulence.png":`/assets/virulence-pwX1yrdH.png`,"./assets-legacy/cards/warCry.png":`/assets/warCry-C7Rsrd4u.png`,"./assets-legacy/cards/wound.png":`/assets/wound-BTcmqSFC.png`,"./assets-legacy/enemies/abyssalKnight.png":`/assets/abyssalKnight-C-E-itbM.png`,"./assets-legacy/enemies/alphaFang.png":`/assets/alphaFang-DdGpQqF8.png`,"./assets-legacy/enemies/ashAcolyte.png":`/assets/ashAcolyte-BBrUUe1I.png`,"./assets-legacy/enemies/chaosHound.png":`/assets/chaosHound-D1R2CoW1.png`,"./assets-legacy/enemies/deepmaw.png":`/assets/deepmaw-la4seO5f.png`,"./assets-legacy/enemies/drownedOne.png":`/assets/drownedOne-BUBzJWlu.png`,"./assets-legacy/enemies/duskfang.png":`/assets/duskfang-CHUmjhPP.png`,"./assets-legacy/enemies/gloomslime.png":`/assets/gloomslime-BNhQuFFa.png`,"./assets-legacy/enemies/gravewarden.png":`/assets/gravewarden-BC9T04oe.png`,"./assets-legacy/enemies/heraldOfEnd.png":`/assets/heraldOfEnd-DZZiCKi_.png`,"./assets-legacy/enemies/leviathan.png":`/assets/leviathan-BhXEnJxl.png`,"./assets-legacy/enemies/mirelurker.png":`/assets/mirelurker-DidtJkek.png`,"./assets-legacy/enemies/obsidianGolem.png":`/assets/obsidianGolem-DkurqVoj.png`,"./assets-legacy/enemies/rootheart.png":`/assets/rootheart-B4o9Bf9P.png`,"./assets-legacy/enemies/shade.png":`/assets/shade-C2XrmBs-.png`,"./assets-legacy/enemies/shellback.png":`/assets/shellback-DCHXMl3u.png`,"./assets-legacy/enemies/siren.png":`/assets/siren-GVK3WWGi.png`,"./assets-legacy/enemies/sovereign.png":`/assets/sovereign-0p3wfa6T.png`,"./assets-legacy/enemies/sporeling.png":`/assets/sporeling-BeOaEEL0.png`,"./assets-legacy/enemies/starCultist.png":`/assets/starCultist-DQHXdHm5.png`,"./assets-legacy/enemies/thornling.png":`/assets/thornling-CqSviePj.png`,"./assets-legacy/enemies/tidecaller.png":`/assets/tidecaller-tGjufTlQ.png`,"./assets-legacy/enemies/voidColossus.png":`/assets/voidColossus-yr_eofA0.png`,"./assets-legacy/enemies/voidWisp.png":`/assets/voidWisp-D_7XlB9X.png`,"./assets-legacy/enemies/voltEel.png":`/assets/voltEel-CJeHty9B.png`,"./assets-legacy/enemies/watcherEye.png":`/assets/watcherEye---WypZip.png`,"./assets-legacy/enemies/waylayer.png":`/assets/waylayer-qynHTjuH.png`,"./assets-legacy/events/cursedIdol.png":`/assets/cursedIdol--s0qHWso.png`,"./assets-legacy/events/emberFountain.png":`/assets/emberFountain-D_Q0157p.png`,"./assets-legacy/events/fleshTrader.png":`/assets/fleshTrader-q8lAx2oa.png`,"./assets-legacy/events/forge.png":`/assets/forge-i5xE2DIv.png`,"./assets-legacy/events/forgottenShrine.png":`/assets/forgottenShrine-CYFo9R9B.png`,"./assets-legacy/events/gambler.png":`/assets/gambler-D4lmA3Yw.png`,"./assets-legacy/events/library.png":`/assets/library-CstvhNks.png`,"./assets-legacy/events/mirror.png":`/assets/mirror-Hp5O4ZPJ.png`,"./assets-legacy/events/ruinedCamp.png":`/assets/ruinedCamp-BvAZgrK0.png`,"./assets-legacy/events/voidChest.png":`/assets/voidChest-B34oBTge.png`,"./assets-legacy/events/woundedKnight.png":`/assets/woundedKnight-JN7kYI1u.png`,"./assets-legacy/heroes/ashwarden.png":`/assets/ashwarden-BjFdmgoK.png`,"./assets-legacy/heroes/duskblade.png":`/assets/duskblade-DBhvpfoa.png`,"./assets-legacy/potions/block.png":`/assets/block-CkTqIuTb.png`,"./assets-legacy/potions/energy.png":`/assets/energy-BNM23nR-.png`,"./assets-legacy/potions/fire.png":`/assets/fire-CAaEe0xi.png`,"./assets-legacy/potions/healing.png":`/assets/healing-KDHGTVtG.png`,"./assets-legacy/potions/strength.png":`/assets/strength-CIdQsSW6.png`,"./assets-legacy/potions/swift.png":`/assets/swift-xz-qROFX.png`,"./assets-legacy/potions/venom.png":`/assets/venom-D3l_eMKx.png`,"./assets-legacy/props/campfire.png":`/assets/campfire-B-OrO4zT.png`,"./assets-legacy/props/chest-open.png":`/assets/chest-open-B5Uzt-_6.png`,"./assets-legacy/props/chest.png":`/assets/chest-b-PO08AA.png`,"./assets-legacy/props/merchant.png":`/assets/merchant-COlFp5u3.png`,"./assets-legacy/title-background/background.png":`/assets/background-CqhrXvXS.png`}),Kh=[`png`,`jpg`,`jpeg`,`webp`],qh={live:{label:`Live`,root:`assets`},legacy:{label:`Legacy`,root:`assets-legacy`}},Jh=`live`,Yh=(e=Jh)=>qh[e]??qh[Jh],Xh=()=>Object.keys(qh),Zh=(e=Jh)=>Yh(e).label,Qh=(e,t,n=Jh)=>{let{root:r}=Yh(n);for(let n of Kh){let i=Gh[`./${r}/${e}/${t}.${n}`];if(i)return i}return null},$h=(e,t=Jh)=>{let{root:n}=Yh(t);return Object.entries(Gh).filter(([t])=>t.startsWith(`./${n}/${e}/`)).map(([,e])=>e)},eg=0,tg=()=>`g${++eg}`,K=(e,t,n,r=1)=>`hsla(${e},${t}%,${n}%,${r})`;function ng(e,t,n){return`<defs>
    ...
    </g>`}};function sg(e){let t=tg(),n=K(e.hue,90,66),r=ig((og[e.kind]||og.slime)(t,e.hue,n));return`<svg class="enemy-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${ng(t,e.hue,n)}
    ...
    ${r}
    <g class="cracks"></g>
  </svg>`}var cg=[{hue:225,glow:`#7fd4ff`},{hue:26,glow:`#ffb15a`}];function lg(e=0){let t=tg(),n=cg[e]||cg[0],r=n.hue,i=n.glow;return`<svg class="hero-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${ng(t,r,i)}
    ...
    <g class="cracks"></g>
  </svg>`}var ug={strike:`⚔`,defend:`⛨`,eclipseSlash:`☾`,twinFangs:`⑂`,quickSlash:`≫`,heavyBlow:`⬇`,cleave:`⋔`,venomStrike:`☠`,lunge:`➹`,guardedStrike:`⛊`,brace:`⛨`,sidestep:`↯`,preparation:`♻`,deflect:`⛉`,leechBlade:`♆`,tempest:`≋`,uppercut:`⇑`,flurry:`⁂`,executioner:`✠`,momentum:`⤴`,bulwark:`☗`,surge:`✦`,toxicMist:`☁`,cripple:`⛓`,warCry:`♯`,fortify:`⧉`,bloodRite:`♥`,empower:`⚔`,agility:`❥`,ironSkin:`⬡`,regrowth:`❋`,oblivionStrike:`✸`,phantomBlades:`⚚`,devour:`♅`,annihilate:`✹`,aegis:`⛨`,offering:`♱`,limitBreak:`⚡`,catalyst:`⚗`,ascension:`☽`,bastion:`♜`,frenzy:`※`,virulence:`☣`,wound:`✂`,burn:`✹`,hex:`♄`,chisel:`◬`,firstSpark:`✧`,ashBite:`☄`,smother:`☁`,quakeblow:`⬲`,resonantLance:`↟`,tithe:`⚖`,pyreheart:`♥`,ashenChoir:`♬`,flawlessForm:`❖`,nightSight:`☾`,novaflare:`✺`,emberdance:`❂`,shardstorm:`❉`},dg=e=>{let t=9;for(let n of e)t=Math.imul(t^n.charCodeAt(0),387420489);return(t^t>>>9)>>>0};function fg(e,t){let n=tg(),r=dg(e),i={attack:356,skill:205,power:268,status:160,curse:300}[t]??205,a=(i+30+r%40)%360,o=K(i,85,66),s=K(a,80,60),c=r%360,l=``;if(t===`attack`)l=`<path d="M30 120 Q75 40 150 28" stroke="${o}" stroke-width="7" fill="none" opacity=".9"/>
      ...
      <path d="M62 106 L118 50" stroke="${s}" stroke-width="5" opacity=".7"/>`;let u=ug[e]||`✦`;return`<svg viewBox="0 0 180 150" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}function pg(e){let t=tg();return`<svg viewBox="0 0 40 52" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function mg(e=!1){let t=tg();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function hg(){let e=tg();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}function gg(){let e=tg();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    ${ng(e,40,`#ffd166`)}
  ...
  </svg>`}function _g(e,t){let n=tg(),r=K(t,80,66);return`<svg viewBox="0 0 220 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
    ...
    <div class="card-rarity"></div>
      ...
      <div class="hud-right">
        ${t.potions.map((e,t)=>`<button class="potion-slot ${e?`full`:``}" data-slot="${t}">${e?v_(`potions`,e,pg(Pu[e].tone)):``}</button>`).join(``)}
    ...
    <div id="relicbar"></div>`;let i=Q(`#relicbar`,e),a=Z.run.omens?.[Z.run.act],o=Bu[a];if(o){let e=$(`div`,`relic-chip omen-chip`,S_(a,`hud-omen-art`,`hud-omen-fallback`,24));e.style.setProperty(`--tone`,o.tone),e._tip={title:`Omen — ${o.name}`,body:o.text,sub:`hangs over Act ${Z.run.act+1}`},i.appendChild(e)}for(let e of t.relics){let t=Mu[e],n=$(`div`,`hud-relic`,x_(e));n.style.setProperty(`--tone`,t.tone),n.dataset.relic=e,n._tip={title:t.name,body:t.text,sub:t.rarity},i.appendChild(n)}t.potions.forEach((t,n)=>{if(!t)return;let r=Q(`.potion-slot[data-slot="${n}"]`,e);r._tip={title:Pu[t].name,body:Pu[t].text,sub:`Click to use or toss`}}),Q(`[data-act="deck"]`,e).onclick=()=>{X.click(),V_(`Your Deck`,Z.run.player.deck,{sub:`${Z.run.player.deck.length} cards`})},Q(`[data-act="menu"]`,e).onclick=e=>{X.click(),N_(e.clientX,e.clientY)},m_(`.potion-slot.full`,e).forEach(e=>e.onclick=t=>I_(+e.dataset.slot,t))}function N_(e,t){P_();let{x:n,y:r}=S(e,t),i=$(`div`,`pop-menu`);i.innerHTML=`<button data-m="help">How to Play</button><button data-m="mute">${Wg()?`Unmute`:`Mute`} Sound</button><button data-m="abandon" style="color:#ff8d8d">Abandon Run</button>`,b().appendChild(i),i.style.left=`${Math.min(n,_()-200)}px`,i.style.top=`${r+8}px`,i.onclick=e=>{let t=e.target.dataset.m;P_(),t===`help`&&H_(),t===`mute`&&Gg(),t===`abandon`&&R_()},setTimeout(()=>document.addEventListener(`pointerdown`,F_,{once:!0}),0)}var P_=()=>m_(`.pop-menu`).forEach(e=>e.remove()),F_=e=>{e.target.closest(`.pop-menu`)||P_()};function I_(e,t){if(Z.busy)return;P_();let n=Z.run.player.potions[e];if(!n)return;let r=Pu[n],i=Z.cb&&!Z.cb.over&&Z.screen===`combat`,a=!r.combatOnly||i,o=$(`div`,`pop-menu`);o.innerHTML=`<button data-m="use" ${a?``:`disabled style="opacity:.4"`}>Use ${r.name}</button><button data-m="toss">Toss it</button>`,b().appendChild(o);let s=S(t.clientX,t.clientY);o.style.left=`${Math.min(s.x-60,_()-220)}px`,o.style.top=`${s.y+10}px`,o.onclick=async t=>{let n=t.target.dataset.m;if(P_(),n===`toss`&&(Z.run.player.potions[e]=null,X.card(),M_(),zh(Z.run)),n===`use`&&a)if(r.needsTarget&&i){let t=Z.cb.enemies.filter(e=>e.hp>0);if(t.length===1)return L_(e,t[0].idx);Ev({kind:`potion`,slot:e})}else L_(e,null)},setTimeout(()=>document.addEventListener(`pointerdown`,F_,{once:!0}),0)}async function L_(e,t){Dv(),X.potion(),Z.cb&&!Z.cb.over&&Z.screen===`combat`?(Th(Z.run,Z.cb,e,t),await sy(),uy()):(Th(Z.run,null,e,null),M_(),zh(Z.run))}function R_(){z_(`<div class="panel ov-panel" style="text-align:center">
  ...
  </div>`,e=>{e.onclick=e=>{let t=e.target.dataset.a;t===`yes`&&(Uh(Z.run,!1),Z.run=null,Z.cb=null,B_(),Xg(),K_(`title`)),t===`no`&&B_()}})}function z_(e,t=null,n=!1){let r=Q(`#overlay`);r.innerHTML=e,r.classList.add(`open`),r._closable=n,t&&t(r.firstElementChild)}function B_(){let e=Q(`#overlay`);e.classList.remove(`open`),e.innerHTML=``}function V_(e,t,{sub:n=``,pick:r=null,canSkip:i=!1,skipLabel:a=`Skip`,inCombat:o=!1}={}){let s=$(`div`,`panel ov-panel`);s.innerHTML=`<div class="ov-title">${e}</div>${n?`<div class="ov-sub">${n}</div>`:``}`;let c=$(`div`,`card-grid ${r?`choice-cards`:``}`),l=r?t:[...t].sort((e,t)=>wm(e).name.localeCompare(wm(t).name));for(let e of l){let t=A_(e,{inCombat:o});r&&(t.onclick=()=>{X.click(),t.classList.add(`picked`),setTimeout(()=>{B_(),r(e)},240)}),c.appendChild(t)}s.appendChild(c);let u=$(`div`,`ov-actions`);if(i&&r){let e=$(`button`,`btn ghost`,a);e.onclick=()=>{X.click(),B_(),r(null)},u.appendChild(e)}if(!r){let e=$(`button`,`btn ghost`,`Close`);e.onclick=()=>{X.click(),B_()},u.appendChild(e)}s.appendChild(u),z_(``,null,!r),Q(`#overlay`).appendChild(s)}function H_(){z_(`<div class="panel ov-panel howto">
  ...
  </div>`,e=>{Q(`[data-a="ok"]`,e).onclick=()=>{X.click(),B_()}},!0)}function U_(){if(Nv)return;let e=Q(`#wipe`);e.classList.remove(`go`),e.offsetWidth,e.classList.add(`go`),setTimeout(()=>e.classList.remove(`go`),620)}var W_=0;async function G_(e,t={}){if(Nv)return;let n=Q(`#transit`);if(!n)return;let r=++W_,i=(e,t,i)=>(n.innerHTML=e,n.classList.add(`on`),n.firstElementChild.animate(t,{duration:i,easing:`cubic-bezier(0.4, 0, 0.2, 1)`}).finished.catch(()=>{}).finally(()=>{r===W_&&(n.classList.remove(`on`),n.innerHTML=``)}));if(e===`combat-in`){let e=t.x??_()/2,n=t.y??v()/2;return i(`<div class="tr-iris"></div>`,[{clipPath:`circle(150% at ${e}px ${n}px)`},{clipPath:`circle(0% at ${e}px ${n}px)`}],480)}if(e===`victory-out`)return i(`<div class="tr-bloom"></div>`,[{opacity:0},{opacity:1,offset:.4},{opacity:0}],900);if(e===`defeat`)return i(`<div class="tr-crack"></div>`,[{opacity:0},{opacity:1}],700);if(e===`act-change`){let e=Bu[Z.run.omens?.[Z.run.act]];return i(`<div class="tr-plate"><div class="tp-act">ACT ${Z.run.act+1} - ${Ou[Z.run.act].name.toUpperCase()}</div>
      ${e?`<div class="tp-omen" style="color:${e.tone}">${J(`omen-${Z.run.omens[Z.run.act]}`,16)} OMEN - ${e.name.toUpperCase()}</div>`:``}</div>`,[{opacity:0},{opacity:1,offset:.15},{opacity:1,offset:.8},{opacity:0}],2200)}}function K_(e,t){Z.screen!==e&&Z.run&&U_(),Z.screen=e,P_(),Q(`#tooltip`).style.display=`none`,e!==`map`&&(Hd(),qd()),Df(null);let n=g_();n.className=``,n.onclick=null,{title:J_,map:ev,combat:()=>{},reward:py,rest:_y,shop:yy,event:by,treasure:vy,bossRelic:my,end:wy}[e](t),e===`map`&&T_(),e!==`combat`&&e!==`title`&&em(),M_()}var q_=[`0`,`I`,`II`,`III`,`IV`,`V`];function J_(){Xg(),$d(0);let e=jg(),t=Bh(),n=Z.title||={aspect:0,vow:0};n.aspect>0&&Wu[n.aspect].unlock&&!e.unlocks.includes(Wu[n.aspect].unlock)&&(n.aspect=0),n.vow=Math.max(0,Math.min(n.vow|0,e.vowUnlocked));let r=e.deeds,i=Wu.map((t,r)=>{let i=r>0&&t.unlock&&!e.unlocks.includes(t.unlock);return`<button class="aspect-card${n.aspect===r?` on`:``}${i?` locked`:``}" data-a="asp" data-i="${r}"${i?` disabled`:``}>
      <div class="asp-hero">${C_(r)}</div>
    ...
    </div>`:``,s=Qh(`title-background`,`background`),c=Qh(`title`,`title`),l=g_();l.innerHTML=`<div class="title-screen screen-enter">
    ...
    <div class="title-btns">
      ...
      <button class="btn ghost" data-a="mute">${Wg()?`Unmute`:`Mute`}</button>
    </div>
    <div class="title-stats">${r.runs} climbs · ${r.wins} dawns · ${r.slain} slain${e.unlocks.length?` · ${e.unlocks.length} secrets unearthed`:``}</div>
  </div>`,l.onclick=r=>{let i=r.target.closest(`[data-a]`);if(!i||i.disabled)return;let a=i.dataset.a;Ug(),X.click(),a===`asp`?(n.aspect=+i.dataset.i,J_()):a===`vow-`?(n.vow=Math.max(0,n.vow-1),J_()):a===`vow+`?(n.vow=Math.min(e.vowUnlocked,n.vow+1),J_()):a===`new`?(t&&Vh(),X_(vm(void 0,{aspect:n.aspect,vow:n.vow,lamplighter:!0,monument:e.lastFall}))):a===`continue`&&t?X_(t,!0):a===`vigil`?Y_():a===`help`?H_():a===`mute`&&(Gg(),J_())},Gv()}function Y_(){let e=Og(),t=Object.values(Uu).map(t=>{let n=e.deeds[t.stat]||0,r=n>=t.n,i=Math.min(100,Math.round(n/t.n*100)),a=t.unlocks.map(e=>{if(e===`aspect2`)return`The Ashwarden`;let[t,n]=e.split(`:`);return t===`card`?ku[n]?.name||n:Mu[n]?.name||n}).join(`, `);return`<div class="deed-row${r?` done`:``}">
    ...
    </div>`}).join(``);z_(`<div class="panel ov-panel vigil-panel">
  ...
  </div>`,e=>{Q(`[data-a="ok"]`,e).onclick=()=>{X.click(),B_()}},!0)}function X_(e,t=!1){Z.run=e,Z.cb=null,$d(e.act);let n=e.nodeId?e.map.nodes.find(t=>t.id===e.nodeId):null;if(Bd(e.act,n?n.row:0),Yg(e.act),t||zh(e),t&&e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);Z.screen=`combat`,rv(Xm(e,e.pendingCombat,t?t.row:5),e.pendingCombat),M_();return}if(e.pendingLamplighter){Z_();return}K_(`map`),t||setTimeout(()=>gy(e),900)}function Z_(){let e=Z.run;if(Z.screen!==`lamplighter`&&U_(),Z.screen=`lamplighter`,P_(),qd(),$d(0),g_().className=``,!Z.lamp){let t=Tm(e),n=Object.keys(Ku),r=[];for(;r.length<3&&n.length;)r.push(n.splice(Math.floor(t()*n.length),1)[0]);Z.lamp={boons:r,boon:null,art:e.art},zh(e)}let t=Z.lamp,n=Wu[e.aspect],r=t.boons.map(e=>{let n=Ku[e],r=Qh(`boons`,e);return`<button class="lamp-boon${t.boon===e?` on`:``}" data-a="boon" data-i="${e}">
      ${r?`<img class="lb-art-img" src="${r}" alt="">`:``}
      <div class="lb-name">${J(`boon-${e}`,20)} ${n.name}</div><div class="lb-text">${k_(n.text)}</div>
    </button>`}).join(``),i=Object.keys(Hu).map(e=>{let n=Hu[e],r=Qh(`arts`,e);return`<button class="lamp-art${t.art===e?` on`:``}" data-a="art" data-i="${e}">
      ${r?`<img class="la-art-img" src="${r}" alt="">`:`<span class="la-glyph" style="color:${n.tone}">${J(`art-${e}`,18)}</span>`}<span class="la-name">${n.name}</span>
    </button>`}).join(``),a=Hu[t.art],o=g_();o.innerHTML=`<div class="lamp-screen screen-enter">
    ${y_()}
    <div class="lamp-hero">${C_(e.aspect)}</div>
    ...
    <div class="lamp-art-desc">${a?`<b style="color:${a.tone}">${J(`art-${t.art}`,15)} ${a.name}</b> · ${k_(a.text)}`:``}</div>
  ...
  </div>`,M_(),o.onclick=e=>{let n=e.target.closest(`[data-a]`);if(!n||n.disabled)return;let r=n.dataset.a;Ug(),X.click(),r===`boon`?(t.boon=n.dataset.i,Z_()):r===`art`?(t.art=n.dataset.i,X.hover(),Z_()):r===`begin`&&t.boon&&Q_()}}function Q_(){let e=Z.run,t=Z.lamp;e.art=t.art,e.boon=t.boon,Wh(e,Ku[t.boon].ops),delete e.pendingLamplighter,Z.lamp=null,X.relic(),zh(e),K_(`map`),setTimeout(()=>gy(e),900)}var $_={monster:`sword`,elite:`skull`,event:`question`,rest:`flame`,shop:`coin`,treasure:`chest`,boss:`crown`,monument:`monument`};function ev(){let e=Z.run;if(e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);Z.screen=`combat`,rv(Xm(e,e.pendingCombat,t?t.row:5),e.pendingCombat);return}zh(e),Z.cb=null;let{nodes:t}=e.map,n=new Set(Dm(e).map(e=>e.id)),r=new Set(e.map.visited),i=e.nodeId?t.find(t=>t.id===e.nodeId).row:-1,a=``,o=``;for(let e of t)for(let t of e.next){let n=r.has(e.id)&&r.has(t)?`walked`:``;a+=`<path class="medge ${n}" style="--d:${e.row*34}ms" data-a="${e.id}" data-b="${t}" d="M0 0"/>`}for(let i of t){let t=i.unlit&&!r.has(i.id),a=[`mnode`,`type-${i.type}`,t?`unlit`:``,r.has(i.id)?`visited`:``,i.id===e.nodeId?`current`:``,n.has(i.id)?`avail`:``].join(` `),s=f_?1.3:1,c=(i.type===`boss`?26:i.type===`elite`||i.type===`treasure`?19:16)*s,l=Math.round((i.type===`boss`?26:i.type===`elite`||i.type===`treasure`?20:17)*s);o+=`<g class="${a}" data-node="${i.id}" style="--d:${i.row*34}ms">
      <g class="nwrap"><circle class="bg" r="${t?16*s:c}"/><g class="icg">${xg(t?`unlitLantern`:$_[i.type],t?Math.round(17*s):l)}</g></g>
    </g>`}let s=Ou[e.act],c=e.omens?.[e.act],l=Bu[c];g_().innerHTML=`
    <div class="map-title">ACT ${e.act+1} — <b>${s.name.toUpperCase()}</b> — ${s.bossName} awaits${l?` &nbsp;·&nbsp; <span class="mt-omen" style="color:${l.tone}">${S_(c,`mt-omen-art`,`mt-omen-fallback`,18)}<span class="mt-omen-name">${l.name}</span></span>`:``}</div>
    <div class="map-screen screen-enter">
      ...
      <div class="map-hint">${f_?`drag`:`scroll`} to survey the Spire</div>
    </div>`;let u=Q(`.map-svg`),d=!1;u.onclick=e=>{if(d)return;let n=e.target.closest(`.mnode.avail`);!n||Z.busy||(Ug(),tv(t.find(e=>e.id===n.dataset.node)))},m_(`.mnode`,u).forEach(i=>{let a=t.find(e=>e.id===i.dataset.node),o={monster:`Monster`,elite:`Elite — beware`,event:`Unknown event`,rest:`Rest site`,shop:`Merchant`,treasure:`Treasure`,boss:Ou[e.act].bossName};i._tip=a.unlit&&!r.has(a.id)?{title:`An unlit lantern`,body:`What waits here is unknown — but first light pays a bounty of gold.${n.has(a.id)?` ${f_?`Tap`:`Click`} to travel here.`:``}`}:{title:o[a.type],body:n.has(a.id)?`${f_?`Tap`:`Click`} to travel here.`:``,sub:{monster:`A fight. Embers and gold for the swift.`,elite:`A titled foe - greater risk, a relic-grade purse.`,event:`Fate unwritten. Could be anything.`,rest:`Heal, or forge a card into its + form.`,shop:`Gold for cards, relics, phials.`,treasure:`A chest with no fight attached.`,boss:`The act ends here. Ready your deck.`}[a.type]}});let f=t.map(t=>({id:t.id,pos:Ed(e.act,t)})),p=new Map(m_(`.mnode`,u).map(e=>[e.dataset.node,e])),m=new Set(t.filter(e=>!n.has(e.id)&&!r.has(e.id)).map(e=>e.id)),h=m_(`.medge`,u).map(e=>({p:e,a:e.dataset.a,b:e.dataset.b}));Vd(e.act,Math.max(0,i)),Kd(f,e=>{let t=new Map(e.map(e=>[e.id,e]));for(let[e,n]of p){let r=t.get(e);n.setAttribute(`transform`,`translate(${r.x.toFixed(1)},${r.y.toFixed(1)}) scale(${r.s.toFixed(3)})`);let i=n.classList.contains(`visited`)&&!n.classList.contains(`current`)?.55:1;n.style.opacity=(r.fade*(m.has(e)?.4:1)*i).toFixed(3)}for(let{p:e,a:n,b:r}of h){let i=t.get(n),a=t.get(r),o=9*(i.s+a.s)/2;e.setAttribute(`d`,`M${i.x.toFixed(1)} ${i.y.toFixed(1)} Q${((i.x+a.x)/2).toFixed(1)} ${((i.y+a.y)/2+o).toFixed(1)} ${a.x.toFixed(1)} ${a.y.toFixed(1)}`),e.style.opacity=(Math.min(i.fade,a.fade)*(e.classList.contains(`walked`)?.25:1)).toFixed(3)}}),Df(e.act,{mult:.3});let g=Q(`.map-screen`);g.addEventListener(`wheel`,e=>{e.preventDefault(),Ud(-e.deltaY*.006)},{passive:!1});let _=null,v=0,y=0,b=0;g.addEventListener(`pointerdown`,e=>{e.pointerType!==`mouse`&&(cancelAnimationFrame(y),_=e.clientY,v=0,b=0,d=!1)}),g.addEventListener(`pointermove`,e=>{if(_==null||e.pointerType===`mouse`)return;let t=e.clientY-_;_=e.clientY,b+=Math.abs(t),b>14&&(d=!0),v=t,Ud(t*.014)});let x=e=>{if(_==null||e.pointerType===`mouse`)return;_=null;let t=()=>{v*=.93,!(Math.abs(v)<.5||Z.screen!==`map`)&&(Ud(v*.014),y=requestAnimationFrame(t))};y=requestAnimationFrame(t),setTimeout(()=>d=!1,80)};g.addEventListener(`pointerup`,x),g.addEventListener(`pointercancel`,x)}function tv(e){let t=Z.run;X.map(),Bd(t.act,e.row);let{type:n,bounty:r}=Om(t,e);if(zh(t),r){X.coin();let t=Q(`.mnode[data-node="${e.id}"]`),n=t?Wf(t):{x:_()/2,y:v()/2};Lf(n.x,n.y-34,`${J(`coin`,12)} +${r}`,`goldf`),Mv(n.x,n.y,120,30,{n:5,color:`#ffe9ac`,size:7,dur:620})}if(n===`monster`||n===`elite`||n===`boss`){t.pendingCombat=n,zh(t);let r=Q(`.mnode[data-node="${e.id}"]`);G_(`combat-in`,r?Wf(r):{}),rv(Xm(t,n,e.row),n)}else n===`rest`?K_(`rest`):n===`shop`?K_(`shop`):n===`treasure`?K_(`treasure`):n===`event`?K_(`event`,Ym(t)):n===`monument`&&nv(e)}function nv(e){let t=Z.run,n=km(t);if(n&&Pg(),zh(t),n){X.relic();let t=n.kind===`relic`?Mu[n.id]?.name:n.kind===`card`?ku[n.id]?.name:`${n.amount} gold`,r=Q(`.mnode[data-node="${e.id}"]`),i=r?Wf(r):{x:_()/2,y:v()/2};Lf(i.x,i.y-34,`✦ ${t}`,`goldf`),Mv(i.x,i.y,_()/2,v()*.5,{n:8,color:`#ffe9ac`,size:8,dur:720}),jv(`THE STONE REMEMBERS`)}K_(`map`)}function rv(e,t){if(Hd(),qd(),Q(`#tooltip`).style.display=`none`,Z.screen!==`combat`&&U_(),Z.cb=Zm(Z.run,e,t),Z.screen=`combat`,Df(Z.run.act,{boss:t===`boss`}),iv(),M_(),t===`boss`){let t=$(`div`,`rose-window`,`<div class="rw-rings"></div><div class="rw-spokes"></div><div class="boss-plate">${(Fu[e[0]]?.name??Z.cb.enemies[0].name).toUpperCase()}</div>`);g_().appendChild(t),setTimeout(()=>t.remove(),2300);let n=$(`div`,`turn-banner boss-banner`,Z.cb.enemies[0].name.toUpperCase());g_().appendChild(n),setTimeout(()=>n.remove(),2100),Mf(`#1a0a20`,.5,.9),tf(1.6),X.bigDeath()}sy().then(uy)}function iv(){let e=Z.cb,t=g_();t.onclick=null,t.innerHTML=`<div class="combat-screen screen-enter intro" style="--ledge:${`#${Ou[Z.run.act].theme.glow.toString(16).padStart(6,`0`)}`}">
    ${[`backdrop`,`mid`,`ledge`].map(e=>{let t=Qh(`stage`,`act${Z.run.act+1}-${e}`);return t?`<img class="sl sl-${e}" src="${t}" alt="" aria-hidden="true">`:``}).join(``)}
    ...
    <div class="hand-zone"></div>
  </div>`;let n=Q(`.enemy-zone`,t),r={enemies:[],root:Q(`.combat-screen`,t)},i=e.affix?Vu[e.affix]:null,a=r_(x().shape,Z.run.act),o=o_(a,e.enemies.length);e.enemies.forEach((e,t)=>{let s=Fu[e.key],c=u_(a,e.key,s.boss?`boss`:s.elite?`elite`:`normal`,o[t],_(),v()),l=$(`div`,`enemy${s.elite?` elite-e`:``}${s.boss?` boss-e`:``}${i?` affixed`:``}`);i&&l.style.setProperty(`--affix-tone`,i.tone),l.dataset.idx=t,l.style.animationDelay=`${160+t*130}ms`,l.innerHTML=`<div class="intent"></div>
      <div class="enemy-art" style="width:${c}px;height:${c}px"><div class="enemy-sprite">${v_(`enemies`,e.key,sg(s.art))}<div class="vessel-fire"></div>${Qh(`enemies`,e.key)?`<svg class="cracks-overlay" viewBox="0 0 200 200"><g class="cracks"></g></svg>`:``}</div><div class="dmg-preview"></div></div>
      <div class="cplate">
      ...
      </div>`,n.appendChild(l),r.enemies.push({root:l,art:Q(`.enemy-art`,l),intent:Q(`.intent`,l),fill:Q(`.fill`,l),ghost:Q(`.ghost`,l),hp:Q(`.hp-label`,l),block:Q(`.block-chip`,l),statuses:Q(`.status-row`,l),pv:Q(`.pv`,l),prev:Q(`.dmg-preview`,l),facets:Q(`.facet-row`,l)}),r.enemies[t].facets._tip={title:`Facets`,body:`Every creature is glass. Attacks that draw unblocked blood chip a facet; fill the gauge and the glass <b>shatters</b> — it loses its next action, is Cracked, and spills Embers into your lantern.`},i&&(Q(`.name`,l)._tip={title:`${i.name} — an elite's title`,body:i.text}),l.onclick=()=>Tv(t),l.addEventListener(`pointerenter`,e=>{e.pointerType===`mouse`&&Z.targeting&&(l.classList.add(`target-hover`),Cv())}),l.addEventListener(`pointerleave`,()=>{l.classList.remove(`target-hover`),Cv()})}),r.pHp=Q(`.p-hp`,t),r.pFill=Q(`.player-zone .fill`,t),r.pGhost=Q(`.player-zone .ghost`,t),r.pBlock=Q(`.p-block`,t),r.pStatus=Q(`.p-status`,t),r.hero=Q(`.hero-wrap`,t),r.energy=Q(`.energy-orb`,t),r.endTurn=Q(`.end-turn`,t),r.hand=Q(`.hand-zone`,t),r.draw=Q(`.pile-draw`,t),r.discard=Q(`.pile-discard`,t),r.exhaust=Q(`.pile-exhaust`,t),r.lantern=Q(`.lantern-btn`,t);let s=Hu[Z.run.art];s&&(Q(`.lb-art`,r.lantern).innerHTML=`<i>${J(`art-${Z.run.art}`,16)}</i>${s.cost}`,Q(`.lb-art`,r.lantern).style.color=s.tone),r.lantern._tip={title:s?`Lantern Art — ${s.name}`:`The Lantern`,body:`${s?`<b>${s.cost} Embers, once a turn:</b> ${s.text}<br><br>`:``}The lantern holds the <b>Embers</b> spilled by shattered and slain glass. Drag any card onto it to <b>kindle</b> — burn the card away for an ember, once a turn. Curses refuse the fire.`,sub:`A · use Art`},r.lantern.onclick=async()=>{if(!(Z.busy||!Z.cb||Z.cb.over)){if(Ug(),!sh(Z.run,Z.cb)){r.lantern.classList.add(`nope`),setTimeout(()=>r.lantern.classList.remove(`nope`),350),X.debuff();return}Dv(),ch(Z.run,Z.cb),await sy(),uy()}},Z.ce=r,sv(a),Hv(),Wv(),setTimeout(()=>r.root.classList.remove(`intro`),1300),r.endTurn.onclick=Av,r.draw.onclick=()=>{X.click(),V_(`Draw Pile`,e.draw,{sub:`Order hidden — shown alphabetically`,inCombat:!0})},r.discard.onclick=()=>{X.click(),V_(`Discard Pile`,e.discard,{inCombat:!0})},r.exhaust.onclick=()=>{X.click(),V_(`The Ashes`,e.exhaust,{sub:`Burned away — each fed the lantern an ember`,inCombat:!0})},r.root.addEventListener(`pointerdown`,e=>{e.target.closest(`.enemy`)||e.target.closest(`.card`)||(Z.targeting?Dv():Z.hoveredCard!=null&&(Z.hoveredCard=null,hv()))}),pv(),mv()}var av=e=>Wf(Z.ce.enemies[e].art),ov=()=>Wf(Z.ce.hero);function sv(e){let t=Z.cb,n=Z.ce;if(!t||!n||Z.screen!==`combat`)return;let r=e??r_(x().shape,Z.run.act);n.root.style.setProperty(`--ground-y`,`${r.groundY}px`),n.root.style.setProperty(`--ledge-lip`,`${r.ledgeLip}px`);for(let e of[`backdrop`,`mid`,`ledge`]){let t=n.root.querySelector(`.sl-${e}`);if(!t)continue;let i=r.layers[e];t.style.height=`${i.h}px`,t.style.left=i.x?`calc(50% + ${i.x}px)`:``,t.style.bottom=e===`ledge`?`${Math.max(0,r.groundY+r.ledgeLip-i.h+i.y)}px`:`${i.y}px`,t.style.opacity=i.opacity,t.style.scale=i.zoom===1?``:String(i.zoom),t.style.objectPosition=`${i.posX}% ${i.posY}%`,t.style.setProperty(`--amp`,`${i.drift}px`)}let i=a_(`heroes`,Wu[Z.run.aspect].id),a=Math.round(r.hero.w*i.scale),o=Math.round(r.hero.h*i.scale),s=n.root.querySelector(`.player-zone`);s.style.width=`${a}px`,s.style.height=`${o}px`,s.style.left=`${Math.round(r.hero.x-a/2)}px`,s.style.bottom=`${i_(r)+i.footY}px`;let c=o_(r,t.enemies.length),l=l_(c,t.enemies.map(e=>e.key));t.enemies.forEach((e,t)=>{let i=Fu[e.key],a=i.boss?`boss`:i.elite?`elite`:`normal`,o=u_(r,e.key,a,c[t],_(),v()),s=n.enemies[t].root;s.style.left=`${Math.round(c[t].x-o/2+s_(c[t],e.key))}px`,s.style.bottom=`${(c[t].y??0)+c_(c[t],e.key)}px`,s.style.width=s.style.height=`${o}px`,s.style.zIndex=String(l[t]),n.enemies[t].art.style.width=n.enemies[t].art.style.height=`${o}px`})}function cv(){sv(),hv(),Wv()}var lv=0;addEventListener(`resize`,()=>{clearTimeout(lv),lv=setTimeout(()=>{Z.cb&&Z.ce&&Z.screen===`combat`&&cv()},120)});function uv(e,t,n){e.innerHTML=``;for(let[n,r]of Object.entries(t)){if(!r)continue;let t=ju[n]||{name:n,icon:`?`,kind:`buff`,desc:``},i=n===`str`&&r<0?`debuff`:t.kind,a=$(`span`,`schip ${i}`,`${yg(`st-${n}`)?J(`st-${n}`,13):t.icon} <span class="n">${r}</span>`);a._tip={title:t.name,body:t.desc.replace(/\bN\b/g,r),sub:i===`debuff`?`Debuff`:`Buff`},e.appendChild(a)}}function dv(e){let t=Z.cb,n=nh(e),r=jh(Z.run,t,e),i={attack:J(`sword`,19),block:J(`shield`,19),buff:J(`up`,19),debuff:J(`cloud`,19),heal:J(`plus`,19)}[n.intent]||J(`sword`,19),a=``;n.intent.startsWith(`attack`)&&(i=J(`sword`,19),a=r.times>1?`${r.dmg}×${r.times}`:`${r.dmg}`,n.intent===`attack_debuff`&&(i+=J(`cloud`,14)),n.intent===`attack_block`&&(i+=J(`shield`,14)),n.intent===`attack_buff`&&(i+=J(`up`,14)));let o=[];return r&&o.push(`attack for <b>${r.dmg}${r.times>1?`×${r.times}`:``}</b>`),n.block&&o.push(`gain Ward`),n.heal&&o.push(`heal itself`),n.fx?.some(e=>e.who===`player`)&&o.push(`afflict you`),n.fx?.some(e=>e.who!==`player`)&&o.push(`empower`),n.addCards&&o.push(`add ${n.addCards.n} ${ku[n.addCards.id].name}s to your discard`),{icon:i,txt:a,tip:{title:n.name,body:`Intends to ${o.join(`, `)||`act`}.`}}}function fv(e,t=0){if(e.facetMax>8)return`<span class="pipnum">${J(`facet`,11)} ${e.chips}${t?`<i>+${t}</i>`:``}/${e.facetMax}</span>`;let n=``;for(let r=0;r<e.facetMax;r++)n+=`<span class="pip${r<e.chips?` filled`:r<e.chips+t?` willchip`:``}"></span>`;return n}function pv(){let e=Z.cb,t=Z.ce;if(!t)return;e.enemies.forEach((e,n)=>{let r=t.enemies[n],i=`${100*Math.max(0,e.hp)/e.maxHp}%`;if(r.fill.style.width=i,r.ghost.style.width=i,r.hp.textContent=`${Math.max(0,e.hp)}/${e.maxHp}`,r.block.classList.toggle(`zero`,e.block<=0),r.block.innerHTML=`${J(`shield`,13)} ${e.block}`,r.art.classList.toggle(`warded`,e.block>0),r.root.classList.toggle(`lowhp`,e.hp>0&&e.hp/e.maxHp<=.3),uv(r.statuses,e.statuses,!1),e.hp>0?r.facets.innerHTML=fv(e):r.facets.innerHTML=``,e.hp<=0&&r.reaped&&r.root.classList.add(`gone`),e.hp>0&&e.flags.staggered)r.intent.className=`intent i-staggered`,r.intent.innerHTML=`<span class="ic">${J(`stagger`,19)}</span>STAGGERED`,r.intent._tip={title:`Staggered`,body:`The glass has shattered — this creature loses its next action while it reseams.`};else if(e.hp>0&&e.moveKey){let t=dv(e);r.intent.className=`intent i-${nh(e).intent}`,r.intent.innerHTML=`<span class="ic">${t.icon}</span>${t.txt}`,r.intent._tip=t.tip}else r.intent.innerHTML=``}),t.lantern&&(Q(`.lb-count`,t.lantern).textContent=e.embers,Q(`.lb-pips`,t.lantern).innerHTML=Array.from({length:e.emberCap},(t,n)=>`<span class="lbp${n<e.embers?` lit`:``}" style="--a:${Math.round(n/(e.emberCap-1)*280-140)}deg"></span>`).join(``),t.lantern.classList.toggle(`unlit`,e.embers===0),t.lantern.classList.toggle(`ready`,sh(Z.run,e)),t.lantern.classList.toggle(`art-spent`,e.artUsedTurn===e.turn&&!e.over));let n=e.player,r=`${100*Math.max(0,n.hp)/n.maxHp}%`;t.pFill.style.width=r,t.pGhost.style.width=r,t.pHp.textContent=`${Math.max(0,n.hp)}/${n.maxHp}`,t.pBlock.classList.toggle(`zero`,n.block<=0),t.pBlock.innerHTML=`${J(`shield`,13)} ${n.block}`,t.hero.classList.toggle(`warded`,n.block>0),t.hero.classList.toggle(`lowhp`,n.hp/n.maxHp<=.3),uv(t.pStatus,n.statuses,!0),Q(`.num`,t.energy).textContent=n.energy,t.energy.classList.toggle(`spent`,n.energy===0);let i=Q(`.candles`,t.energy),a=Math.max(n.energyMax,n.energy);i.children.length!==a&&(i.innerHTML=Array.from({length:a},()=>`<span class="candle"></span>`).join(``)),[...i.children].forEach((e,t)=>e.classList.toggle(`lit`,t<n.energy)),Q(`.cnt`,t.draw).textContent=e.draw.length,Q(`.cnt`,t.discard).textContent=e.discard.length,Q(`.cnt`,t.exhaust).textContent=e.exhaust.length}function mv(){let e=Z.cb,t=Z.ce;if(!t)return;let n=t.hand,r=new Map(m_(`.card`,n).map(e=>[e.dataset.uid,e])),i=new Set(e.hand.map(e=>String(e.uid)));for(let[e,t]of r)i.has(e)||t.remove();for(let t of e.hand)if(r.has(String(t.uid))){let e=A_(t,{inCombat:!0}),n=r.get(String(t.uid));n.replaceChildren(...e.childNodes),n.className=e.className+(n.classList.contains(`armed`)?` armed`:``),n.onclick=e=>{e.stopPropagation(),wv(t.uid)},p_&&(n.onmouseenter=()=>{Z.hoveredCard=t.uid,hv()},n.onmouseleave=()=>{Z.hoveredCard===t.uid&&(Z.hoveredCard=null),hv()})}else{let e=A_(t,{inCombat:!0});e.classList.add(`draw-in`),setTimeout(()=>e.classList.remove(`draw-in`),400),e.onclick=e=>{e.stopPropagation(),wv(t.uid)},p_&&(e.onmouseenter=()=>{Z.hoveredCard=t.uid,X.hover(),hv()},e.onmouseleave=()=>{Z.hoveredCard===t.uid&&(Z.hoveredCard=null),hv()}),_v(e,t.uid),n.appendChild(e)}hv()}function hv(){let e=Z.cb,t=Z.ce;if(!t)return;let n=e.hand.map(e=>String(e.uid)),r=new Map(m_(`.card`,t.hand).map(e=>[e.dataset.uid,e])),i=n.length,a=Math.min(112,640/Math.max(i,1),(_()-246)/Math.max(i-1,1));n.forEach((t,n)=>{let o=r.get(t);if(!o)return;let s=e.hand[n],c=!wm(s).unplayable&&(bh(Z.run,e,s)??99)<=e.player.energy;o.classList.toggle(`unplayable-now`,!c);let l=Z.targeting?.kind===`card`&&String(Z.targeting.uid)===t,u=Z.hoveredCard!=null&&String(Z.hoveredCard)===t,d=i>1?(n-(i-1)/2)*Math.min(5,42/i):0,f=(n-(i-1)/2)*a,p=Math.abs(d)*3.2;o.classList.toggle(`armed`,l),o.classList.toggle(`lifted`,u&&!Z.busy&&!l),o.style.transform=`translateX(calc(-50% + ${l?f*.4:f}px)) translateY(${p+26}px) rotate(${l?d*.5:d}deg)`,o.style.zIndex=u||l?40:20+n}),Cv()}var gv=0;function _v(e,t){e.addEventListener(`pointerdown`,n=>{if(!(Z.busy||!Z.cb||Z.cb.over||!n.isPrimary||Z.drag)){Z.drag={uid:t,id:n.pointerId,x0:n.clientX,y0:n.clientY,live:!1,free:!1};try{e.setPointerCapture(n.pointerId)}catch{}}}),e.addEventListener(`pointermove`,n=>{let r=Z.drag;if(!(!r||r.uid!==t||n.pointerId!==r.id)){if(!r.live){r.y0-n.clientY>26&&bv(r,e);return}if(r.free){let t=S(n.clientX,n.clientY);e.style.transform=`translate(calc(-50% + ${t.x-_()/2}px), ${t.y-v()+130}px) scale(1.12)`;let i=!!yv(n.clientX,n.clientY)?.closest(`.lantern-btn`);e.classList.toggle(`will-burn`,i),e.classList.toggle(`will-cast`,!r.kindleOnly&&!i&&t.y<vv())}else Ov(n),Sv(n.clientX,n.clientY)}});let n=(n,r)=>{let i=Z.drag;if(!i||i.uid!==t||n.pointerId!==i.id||(Z.drag=null,!i.live))return;if(gv=performance.now(),e.classList.remove(`dragging`,`will-cast`,`will-burn`),Z.ce?.lantern?.classList.remove(`kindle-target`),r){Dv(),hv();return}if(yv(n.clientX,n.clientY)?.closest(`.lantern-btn`)){let e=Z.cb.hand.find(e=>e.uid===t);if(e&&uh(Z.run,Z.cb,e)){Dv(),xv(t);return}Dv(),hv();return}if(i.kindleOnly){Z.hoveredCard=null,hv();return}if(i.free){S(n.clientX,n.clientY).y<vv()?kv(t,null):(Z.hoveredCard=null,hv());return}let a=document.elementFromPoint(n.clientX,n.clientY)?.closest(`.enemy`),o=a?+a.dataset.idx:-1,s=Z.cb.enemies.filter(e=>e.hp>0);o>=0&&Z.cb.enemies[o].hp>0?kv(t,o):s.length===1&&S(n.clientX,n.clientY).y<vv()?kv(t,s[0].idx):(Dv(),hv())};e.addEventListener(`pointerup`,e=>n(e,!1)),e.addEventListener(`pointercancel`,e=>n(e,!0))}var vv=()=>Z.ce?.hand?C(Z.ce.hand).top-24:v()-260,yv=(e,t)=>document.elementsFromPoint(e,t).find(e=>!e.closest(`.card`));function bv(e,t){let n=Z.cb,r=n.hand.find(t=>t.uid===e.uid);if(!r){Z.drag=null;return}let i=wm(r);if(i.unplayable||bh(Z.run,n,r)>n.player.energy){if(uh(Z.run,n,r)){e.live=!0,e.free=!0,e.kindleOnly=!0,Z.hoveredCard=null,X.hover(),t.classList.add(`dragging`),Z.ce?.lantern?.classList.add(`kindle-target`);return}Z.drag=null,t.classList.add(`nope`),setTimeout(()=>t.classList.remove(`nope`),350),X.debuff();return}e.live=!0,Z.hoveredCard=null,X.hover(),uh(Z.run,n,r)&&Z.ce?.lantern?.classList.add(`kindle-target`),i.target===`enemy`?Ev({kind:`card`,uid:e.uid}):(e.free=!0,Dv(),t.classList.add(`dragging`))}async function xv(e){if(Z.hoveredCard=null,!fh(Z.run,Z.cb,e)){hv();return}await sy(),uy()}function Sv(e,t){let n=document.elementFromPoint(e,t)?.closest(`.enemy`);Z.ce?.enemies.forEach(e=>e.root.classList.toggle(`target-hover`,e.root===n&&e.root.classList.contains(`targetable`))),Cv()}function Cv(){let e=Z.ce,t=Z.cb;if(!e||!t)return;let n=null;Z.targeting?.kind===`card`?n=t.hand.find(e=>e.uid===Z.targeting.uid):Z.drag?.live?n=t.hand.find(e=>e.uid===Z.drag.uid):Z.hoveredCard!=null&&!Z.busy&&(n=t.hand.find(e=>e.uid===Z.hoveredCard));let r=n?wm(n):null,i=Z.targeting?.kind===`card`||Z.drag?.live&&!Z.drag.free,a=t.enemies.filter(e=>e.hp>0).length;t.enemies.forEach((o,s)=>{let c=e.enemies[s],l=null,u=!1;if(n&&!t.over&&o.hp>0&&!r.unplayable&&(r.target===`allEnemies`?l=Mh(Z.run,t,n,s):r.target===`enemy`&&(i||a===1)&&(l=Mh(Z.run,t,n,s),u=i&&a>1&&!c.root.classList.contains(`target-hover`))),l&&(l.total>0||l.chips>0)){c.prev.classList.remove(`show`,`lethal`,`dim`),c.prev.innerHTML=``,c.root.classList.toggle(`marked`,l.lethal&&!u);let e=Math.min(o.hp,l.loss)/o.maxHp;c.pv.style.left=`${Math.max(0,o.hp-l.loss)/o.maxHp*100}%`,c.pv.style.width=`${e*100}%`,c.pv.classList.toggle(`show`,l.loss>0),c.facets.innerHTML=fv(o,u?0:l.chips),c.facets.classList.toggle(`willshatter`,l.willShatter&&!u)}else c.prev.classList.remove(`show`,`lethal`,`dim`),c.root.classList.remove(`marked`),c.pv.classList.remove(`show`),o.hp>0&&(c.facets.innerHTML=fv(o)),c.facets.classList.remove(`willshatter`)})}function wv(e){if(Z.busy||!Z.cb||Z.cb.over||performance.now()-gv<350)return;let t=Z.cb,n=t.hand.find(t=>t.uid===e);if(!n)return;if(f_&&Z.hoveredCard!==e&&!(Z.targeting?.kind===`card`&&Z.targeting.uid===e)){Z.hoveredCard=e,X.hover(),hv();return}let r=wm(n),i=bh(Z.run,t,n),a=Q(`.card[data-uid="${e}"]`,Z.ce.hand);if(r.unplayable||i>t.player.energy){a?.classList.add(`nope`),setTimeout(()=>a?.classList.remove(`nope`),350),X.debuff();return}if(Z.targeting?.kind===`card`&&Z.targeting.uid===e)return Dv();if(r.target===`enemy`){let n=t.enemies.filter(e=>e.hp>0);if(n.length===1)return void kv(e,n[0].idx);Ev({kind:`card`,uid:e})}else kv(e,null)}function Tv(e){if(!Z.targeting||Z.busy)return;let t=Z.cb.enemies[e];if(!t||t.hp<=0)return;let n=Z.targeting;n.kind===`card`?kv(n.uid,e):n.kind===`potion`&&L_(n.slot,e)}function Ev(e){if(Z.targeting=e,Z.ce.root.classList.add(`targeting`),Z.cb.enemies.forEach((e,t)=>Z.ce.enemies[t].root.classList.toggle(`targetable`,e.hp>0)),hv(),document.addEventListener(`pointermove`,Ov),Ov._last)Ov(Ov._last);else{let e=Z.cb.enemies.findIndex(e=>e.hp>0);if(e>=0){let t=av(e);Ov({clientX:t.x,clientY:t.y,synthetic:!0})}}}function Dv(){Z.targeting=null,Q(`#aim`).innerHTML=``,document.removeEventListener(`pointermove`,Ov),Z.ce&&(Z.ce.root.classList.remove(`targeting`),Z.ce.enemies.forEach(e=>e.root.classList.remove(`targetable`,`target-hover`)),hv()),j_()}function Ov(e){if(e.synthetic||(Ov._last=e),!Z.targeting)return;let t;if(Z.targeting.kind===`card`){let e=Q(`.card[data-uid="${Z.targeting.uid}"]`);t=e?Wf(e):{x:_()/2,y:v()-200}}else t={x:_()/2,y:60};let{x:n,y:r}=e.synthetic?{x:e.clientX,y:e.clientY}:S(e.clientX,e.clientY),i=(t.x+n)/2,a=Math.min(t.y,r)-120;if(Q(`#aim`).innerHTML=`<path d="M${t.x} ${t.y-80} Q${i} ${a} ${n} ${r}" fill="none" stroke="rgba(255,89,100,.85)" stroke-width="4" stroke-dasharray="4 10" stroke-linecap="round"/>
    <circle cx="${n}" cy="${r}" r="9" fill="none" stroke="rgba(255,89,100,.95)" stroke-width="3"/>`,Z.ce?.hero){let e=Wf(Z.ce.hero),t=Q(`#lantern`);t.style.setProperty(`--lx`,`${Math.round(e.x+(n-e.x)*.3)}px`),t.style.setProperty(`--ly`,`${Math.round(e.y+(r-e.y)*.3)}px`)}}async function kv(e,t){Dv(),Z.hoveredCard=null,Sh(Z.run,Z.cb,e,t)&&(await sy(t),uy())}async function Av(){Z.busy||!Z.cb||Z.cb.over||(Dv(),X.click(),Eh(Z.run,Z.cb),await sy(),uy())}function jv(e){let t=$(`div`,`turn-banner`,e);g_().appendChild(t),setTimeout(()=>t.remove(),1150)}function Mv(e,t,n,r,{n:i=6,color:a=`#ffe9ac`,size:o=8,dur:s=640,glyph:c=``,cls:l=`flymote`,done:u=null}={}){let d=Q(`#floaties`);for(let f=0;f<i;f++){let p=$(`div`,l,c);p.style.left=`${e}px`,p.style.top=`${t}px`,c?p.style.color=a:(p.style.width=`${o}px`,p.style.height=`${o}px`,p.style.background=`radial-gradient(circle at 35% 30%, #fff, ${a} 55%, transparent 85%)`),d.appendChild(p);let m=(e+n)/2+(Math.random()-.5)*140,h=Math.min(t,r)-50-Math.random()*80,g=p.animate([{transform:`translate(-50%,-50%) scale(0.5)`,opacity:0},{transform:`translate(calc(-50% + ${m-e}px), calc(-50% + ${h-t}px)) scale(1.05)`,opacity:1,offset:.45},{transform:`translate(calc(-50% + ${n-e}px), calc(-50% + ${r-t}px)) scale(0.55)`,opacity:.95}],{duration:s,delay:f*46,easing:`cubic-bezier(.32,.05,.35,1)`});g.onfinish=()=>{p.remove(),f===i-1&&u&&u()}}}var Nv=matchMedia(`(prefers-reduced-motion: reduce)`).matches;function Pv(e,t,n,r=640){if(t=Math.round(t),n=Math.round(n),Nv||t===n){e.textContent=n;return}let i=performance.now(),a=o=>{let s=Math.min(1,(o-i)/r),c=1-(1-s)**3;e.textContent=Math.round(t+(n-t)*c),s<1?requestAnimationFrame(a):(e.textContent=n,e.classList.remove(`tick`),e.offsetWidth,e.classList.add(`tick`))};requestAnimationFrame(a)}var Fv=new Map;function Iv(e){if(!e)return Promise.resolve(null);if(Fv.has(e))return Fv.get(e);let t=new Promise(t=>{let n=new Image;n.onload=()=>{let e=n.naturalWidth,r=n.naturalHeight,i=Object.assign(document.createElement(`canvas`),{width:e,height:r}).getContext(`2d`);i.drawImage(n,0,0);let a=i.getImageData(0,0,e,r).data,o=-1,s=e,c=0;for(let t=r-1;t>=0;t--){let n=!1;for(let r=0;r<e;r++)a[(t*e+r)*4+3]>24&&(n=!0,s=Math.min(s,r),c=Math.max(c,r));if(n){o=t;break}}t(o<0?{nw:e,nh:r,footRow:r-1,footX:e*.5}:{nw:e,nh:r,footRow:o,footX:(s+c)*.5})},n.onerror=()=>t(null),n.src=e});return Fv.set(e,t),t}function Lv(e,t,n,r){let i=Math.min(n/e,r/t);return{s:i,dw:e*i,dh:t*i,ox:(n-e*i)/2,oy:(r-t*i)/2}}function Rv(e){let{feet:t,art:n,shadow:r,sprite:i}=e;if(!t?.nw||!n||!r)return;let a=n.clientWidth,o=n.clientHeight;if(a<4||o<4)return;let{nw:s,nh:c,footRow:l,footX:u}=t,{s:d,ox:f,oy:p}=Lv(s,c,a,o),m=o-p-l*d;e.footOx=(f+u*d)/a*100,e.footDrop=m,r.style.setProperty(`--foot-ox`,`${e.footOx.toFixed(2)}%`);let h=Q(`img`,r);h&&(h.style.transform=`translateY(${m.toFixed(2)}px)`);let g=Q(`.raster-art`,i);g&&(g.style.transform=`translateY(${m.toFixed(2)}px)`)}function zv(e){let t=getComputedStyle(e).transform;if(!t||t===`none`)return 0;let n=t.match(/matrix(?:3d)?\(([^)]+)\)/);if(!n)return 0;let r=n[1].split(`,`).map(e=>parseFloat(e.trim())),i=r.length===16?r[13]:r[5];return Math.max(0,-i)}function Bv(e,t,n){let r=$(`div`,`cast-shadow`);if(t){let e=document.createElement(`img`);e.src=t,e.alt=``,e.setAttribute(`aria-hidden`,`true`),r.appendChild(e)}else if(n){let e=n.cloneNode(!0);e.setAttribute(`aria-hidden`,`true`),r.appendChild(e)}else r.classList.add(`cast-shadow-blob`);return r}function Vv(e,t){if(!e.shadow)return;e.feet?.nw&&Rv(e);let n=e.shadowMax||16,r=Math.min(1,t/n);e.shadow.style.setProperty(`--foot-ox`,`${(e.footOx??50).toFixed(2)}%`),e.shadow.style.setProperty(`--foot-oy`,`100%`);let i=1-r*.26,a=.24-r*.12,o=.62-r*.34;e.shadow.style.setProperty(`--sh-sx`,i.toFixed(3)),e.shadow.style.setProperty(`--sh-sy`,a.toFixed(3)),e.shadow.style.setProperty(`--sh-o`,o.toFixed(3)),e.shadow.style.setProperty(`--sh-blur`,`${(1.2+r*2.8).toFixed(1)}px`),e.shadow.style.setProperty(`--sh-skew`,`${(e.skew*(1-r*.35)).toFixed(2)}deg`),e.shadow.style.setProperty(`--sh-x`,`${(e.skew*.35*(1-r*.5)).toFixed(1)}px`)}function Hv(){let e=Z.ce,t=Z.cb;e.rig=[];let n=(t,n,r,i,a,o,s=0,c=``)=>{let l=Q(`svg`,n),u=Q(`.enemy-sprite`,n)||n,d=Q(`.raster-art`,u);if(!l&&!d)return;let f=Math.random()*100;if(l){let e=Q(`.breathe`,l);e&&(e.style.animationDuration=`${(2.5+f%1.9).toFixed(2)}s`,e.style.animationDelay=`${(-(f%3.1)).toFixed(2)}s`,e.style.setProperty(`--brY`,(1.022+f%.024).toFixed(3)),e.style.setProperty(`--sw`,`${(f*7%1.7-.85).toFixed(2)}deg`)),m_(`.hover-float`,l).forEach(e=>e.style.animationDelay=`${(-(f%2.7)).toFixed(2)}s`)}else if(o&&(u.classList.add(`idle-${o}`),u.style.animationDelay=`${(-(f%2.8)).toFixed(2)}s`,o===`wisp`||o===`plant`)){let e=$(`div`,`idle-motes`);e.style.setProperty(`--mote`,`hsla(${s},85%,62%,0.6)`),u.appendChild(e)}let p=Bv(u,c||d?.src||``,l);n.insertBefore(p,n.firstChild);let m=$(`div`,`lightpool`);m.style.background=`radial-gradient(ellipse at 50% 50%, ${r}, transparent 72%)`,n.appendChild(m);let h={root:t,art:n,sprite:u,svg:l,eyes:l?m_(`.eye`,l):[],fire:l?Q(`.innerfire`,l):null,pool:m,shadow:p,shadowMax:{wisp:20,eye:20,siren:14,shade:14,plant:10,slime:6}[o]||12,skew:i?5:-4,seed:f,isHero:i,idx:a,dx:0,dy:0,feet:null,footOx:50};e.rig.push(h);let g=c||d?.src||``;g&&Iv(g).then(e=>{!e||!h.shadow||(h.feet=e,Rv(h),Vv(h,zv(h.sprite)+(h.sprite.classList.contains(`mesh-live`)?dm(h.sprite):0)))}),Vv(h,0)};t.enemies.forEach((t,r)=>{let i=Fu[t.key].art;n(e.enemies[r].root,e.enemies[r].art,`hsla(${i.hue},90%,66%,.72)`,!1,r,i.kind,i.hue,Qh(`enemies`,t.key))}),n(e.hero,e.hero,`rgba(127,212,255,.62)`,!0,0,`humanoid`,0,Qh(`heroes`,Wu[Z.run.aspect].id))}function Uv(){if(!sp())return;let e=Z.ce,t=Z.cb;if(!e||!t)return;let n=[],r=Qh(`heroes`,Wu[Z.run.aspect].id),i=e.hero&&(Q(`.hero-sprite`,e.hero)||e.hero);r&&i&&n.push({el:i,url:r,kind:`humanoid`}),t.enemies.forEach((t,r)=>{let i=Qh(`enemies`,t.key),a=e.enemies[r]?.art,o=a&&(Q(`.enemy-sprite`,a)||a);i&&o&&n.push({el:o,url:i,kind:Fu[t.key].art.kind})}),um(n)}function Wv(){requestAnimationFrame(()=>requestAnimationFrame(Uv))}function Gv(){em()}var Kv=!1;function qv(e){if(Kv)return;requestAnimationFrame(qv);let t=Z.ce,n=Z.cb;if(Nv||!n||Z.screen!==`combat`||!t?.rig)return;let r=null,i=n.enemies.findIndex(e=>e.hp>0);Z.targeting&&Ov._last?r=S(Ov._last.clientX,Ov._last.clientY):i>=0&&(r=av(i));let a=ov();for(let i of t.rig){let t=i.isHero?n.player:n.enemies[i.idx];if(!i.isHero&&t.hp<=0){i.pool.style.opacity=0,i.shadow&&(i.shadow.style.opacity=0);continue}let o=zv(i.sprite);i.sprite.classList.contains(`mesh-live`)&&(o+=dm(i.sprite)),Vv(i,o);let s=i.isHero?r:a;if(s&&i.eyes.length){let e=Wf(i.art),t=Math.atan2(s.y-e.y,s.x-e.x);i.dx+=(Math.cos(t)*2.4-i.dx)*.08,i.dy+=(Math.sin(t)*1.6-i.dy)*.08;let n=`translate(${i.dx.toFixed(2)}px,${i.dy.toFixed(2)}px)`;for(let e of i.eyes)e.style.transform=n}let c=.45+.55*(Math.max(0,t.hp)/t.maxHp);i.root.dataset.choreo===`attack`&&(c+=1.1),(t.statuses?.str||0)>0&&(c+=.3);let l=.86+.14*Math.sin(e*.006+i.seed)*Math.sin(e*.0021+i.seed*3);i.fire&&(i.fire.style.opacity=Math.min(.55,(.05+.13*c)*l).toFixed(3)),i.pool.style.opacity=Math.min(.85,(.3+.4*c)*l).toFixed(3)}}var Jv=!1,Yv={archetype:`slash`,cardId:null,enemyIdx:null},Xv=!1,Zv=!1,Qv=0,$v={beast:`slash`,rogue:`slash`,knight:`slash`,sovereign:`slash`,golem:`blunt`,treeboss:`blunt`,crab:`blunt`,leviathan:`blunt`,zombie:`blunt`,serpent:`pierce`,crawler:`pierce`,maw:`pierce`,plant:`pierce`,wisp:`void`,shade:`void`,eye:`void`,siren:`void`,cultist:`void`,slime:`poison`},ey=matchMedia(`(prefers-reduced-motion: reduce)`).matches,ty=new Set([`golem`,`treeboss`,`leviathan`,`crab`]),ny=new Set([`wisp`,`shade`,`siren`,`eye`,`cultist`]);function ry(e,t=1,n=`humanoid`){if(ey||!e)return Promise.resolve();let r=ty.has(n),i=ny.has(n),a=r?[{transform:`translateX(0) scale(1,1)`},{transform:`translateX(0) scale(1.08,0.86)`,offset:.35},{transform:`translateX(0) scale(1,1)`}]:i?[{transform:`translateX(0) translateY(0) scale(1,1)`},{transform:`translateX(${6*t}px) translateY(-5px) scale(0.98,1.02)`,offset:.4},{transform:`translateX(${10*t}px) translateY(-2px) scale(1,1)`,offset:.7},{transform:`translateX(0) translateY(0) scale(1,1)`}]:[{transform:`translateX(0) scale(1,1)`},{transform:`translateX(${-8*t}px) scale(0.97,1.02)`,offset:.3},{transform:`translateX(${34*t}px) scale(1.02,0.99)`,offset:.62},{transform:`translateX(0) scale(1,1)`}];return e.dataset.choreo=`attack`,e.animate(a,{duration:r?420:i?380:330,easing:`cubic-bezier(0.34, 1.56, 0.64, 1)`}).finished.finally(()=>{delete e.dataset.choreo}).catch(()=>{})}function iy(e,t=1){ey||!e||(nm(e),e.animate([{transform:`translateX(0) scale(1,1)`,filter:`brightness(1)`},{transform:`translateX(${9*t}px) scale(0.97,1.03)`,filter:`brightness(1.9)`,offset:.25},{transform:`translateX(0) scale(1,1)`,filter:`brightness(1)`}],{duration:300,easing:`cubic-bezier(0.22, 1, 0.36, 1)`}))}function ay(e){return ey||!e?Promise.resolve():e.animate([{transform:`translateY(0) rotate(0deg)`,filter:`brightness(1)`},{transform:`translateY(5px) rotate(-2.5deg)`,filter:`brightness(0.6)`}],{duration:360,easing:`cubic-bezier(0.22, 1, 0.36, 1)`,fill:`forwards`}).finished.catch(()=>{})}function oy(e,t=200){if(sp()&&sm(e.root,0)){for(let t=0;t<3;t++)om(e.art);let n=performance.now(),r=()=>{let i=Math.min(1,(performance.now()-n)/t),a=i*i*(3-2*i);sm(e.root,a)&&i<1&&requestAnimationFrame(r)};requestAnimationFrame(r);return}tm(e.root);let n=e.art&&Q(`.cracks`,e.art);n&&(n.insertAdjacentHTML(`beforeend`,ag(!0)),n.children.length<9&&n.insertAdjacentHTML(`beforeend`,ag(!0))),e.root.classList.add(`igniting`)}async function sy(e=null){let t=Z.cb,n=Z.ce;Z.busy=!0,n.endTurn.classList.add(`enemy-phase`);let r=t.queue;for(;r.length;){let t=r.shift();try{await ly(t,e)}catch(e){console.error(`vfx event error`,t,e)}}Z.busy=!1,t.over||n.endTurn.classList.remove(`enemy-phase`),pv(),mv(),M_()}var cy=null;async function ly(e,t){let n=Z.cb,r=Z.ce;switch(e.t){case`chip`:{let t=r.enemies[e.idx],{x:n,y:i}=av(e.idx);X.chip(),Nf(n,i,{color:`#e8f4ff`,n:5,speed:190,size:1.8,grav:240,kind:`spark`}),pv(),t.facets.classList.remove(`pop`),t.facets.offsetWidth,t.facets.classList.add(`pop`),await h_(110);break}case`shatter`:{let t=r.enemies[e.idx],{x:n,y:i}=av(e.idx);cy={x:n,y:i},X.shatter(),jf(90),Pf(n,i,`#dfeaff`,10,700,5),Nf(n,i,{color:`#dfeaff`,n:26,speed:430,size:2.4,grav:300,kind:`spark`}),Lf(n,i-58,`${J(`stagger`,20)} SHATTER`,`shatterf`),Af(10),tf(.9),t.art,t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),pv(),await h_(380);break}case`adamantHold`:{let{x:t,y:n}=av(e.idx);X.blocked(),Lf(t,n-52,`THE GLASS HOLDS`,`blockedf`),Pf(t,n,`#d8c27a`,8,480,4),pv(),await h_(260);break}case`ember`:if(e.n>0&&r.lantern){let t=cy||ov(),n=Wf(r.lantern);Mv(t.x,t.y,n.x,n.y,{n:Math.min(e.n*2,5),color:`#ffb35a`,size:6,dur:460}),X.ember(),setTimeout(()=>{r.lantern.classList.remove(`pop`),r.lantern.offsetWidth,r.lantern.classList.add(`pop`),pv()},440),await h_(300)}else pv();cy=null;break;case`kindle`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand);t&&(cy=Wf(t)),X.kindle(),await h_(60);break}case`art`:{Yv={archetype:`fire`,cardId:`art:${e.id}`,enemyIdx:null},Xv=!1;{let{x:t,y:n}=Wf(r.lantern);Qf[`art:${e.id}`]?.(t,n),Xv=!0}let t=Hu[e.id],{x:n,y:i}=ov(),a=r.lantern?Wf(r.lantern):{x:n,y:i};X.art(),Mf(t.tone,.12,.5),Pf(a.x,a.y,t.tone,10,620,5),If(n,i,t.tone,12),Lf(n,i-84,t.name.toUpperCase(),`artf`);let o=Qh(`arts`,e.id);if(o){let e=$(`img`,`art-cast`);e.src=o,Q(`#floaties`).appendChild(e),e.style.left=`${n}px`,e.style.top=`${i-30}px`,e.animate([{transform:`translate(-50%,-50%) scale(0.4)`,opacity:0},{transform:`translate(-50%,-58%) scale(1)`,opacity:1,offset:.3},{transform:`translate(-50%,-70%) scale(1.05)`,opacity:0}],{duration:900,easing:`cubic-bezier(.2,.7,.3,1)`}).onfinish=()=>e.remove()}tf(.7),pv(),await h_(420);break}case`staggered`:{let t=r.enemies[e.idx],{x:n,y:i}=av(e.idx);X.stagger(),Lf(n,i-76,`STAGGERED`,`staggerf`),t.root.classList.add(`reseaming`),setTimeout(()=>t.root.classList.remove(`reseaming`),720),pv(),await h_(520);break}case`smolderJump`:{let t=av(e.from),n=av(e.to);X.poison(),Mv(t.x,t.y,n.x,n.y,{n:5,color:`#d3a15a`,size:7,dur:460}),await h_(400);break}case`turn`:e.n>1&&(jv(`YOUR TURN`),X.turn()),pv(),await h_(e.n>1?500:120);break;case`endTurn`:Jv=!1,jv(`ENEMY TURN`),await h_(480);break;case`draw`:mv(),pv(),X.draw(),await h_(75);break;case`reshuffle`:{X.card();let e=Wf(r.discard),t=Wf(r.draw);Mv(e.x,e.y,t.x,t.y,{n:6,cls:`flycard`,dur:520}),Lf(t.x,t.y-46,`Reshuffle`,`notice`),await h_(420);break}case`play`:{let i=Q(`.card[data-uid="${e.uid}"]`,r.hand);if(X.card(),Jv=!0,Qv=0,Yv={archetype:ku[e.id]?.vfx||`slash`,cardId:e.id,enemyIdx:null},Xv=!1,Zv=!1,!Xv&&Qf[e.id]&&[`ascension`,`pyreheart`,`emberdance`,`limitBreak`].includes(e.id)){let t=n.enemies.findIndex(e=>e.hp>0),r=e.id===`limitBreak`&&t>=0?av(t):ov();Qf[e.id](r.x,r.y),Xv=!0}if(i&&t!=null&&n.enemies[t]){let e=C(i),{x:n,y:r}=av(t),a=i.cloneNode(!0);Object.assign(a.style,{position:`fixed`,left:`${e.left}px`,top:`${e.top}px`,width:`${e.width}px`,height:`${e.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(a),i.remove(),a.animate([{transform:`none`,opacity:1},{transform:`translate(${n-e.left-e.width/2}px,${r-e.top-e.height/2}px) scale(0.22) rotate(14deg)`,opacity:0}],{duration:270,easing:`cubic-bezier(.45,0,.9,.5)`}).onfinish=()=>a.remove()}else i&&(i.classList.add(`played-up`),setTimeout(()=>i.remove(),320));pv(),await h_(200);break}case`hitEnemy`:{let t=r.enemies[e.idx],{x:i,y:a}=av(e.idx);if(e.poison)X.poison(),If(i,a,`#d3a15a`,14),Lf(i,a-20,`${e.amount}`,`poisonf`);else{let o=e.amount>=16;if(Jv&&Yv.cardId&&!String(Yv.cardId).startsWith(`art:`)&&(Zv||=(await ry(r.hero,1,`humanoid`),!0)),X.slash(),e.amount>0&&X.hit(),!Xv&&Yv.cardId&&Qf[Yv.cardId]&&(Qf[Yv.cardId](i,a),Xv=!0),Xf(i,a,Yv.archetype,Math.min(1,e.amount/24)),iy(t.root,1),e.blocked>0&&(X.blocked(),Lf(i,a+26,`${J(`shield`,19)}${e.blocked}`,`blockedf`),Nf(i,a+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`}),n.enemies[e.idx].block===0&&e.amount===0&&(Lf(i,a-2,`GUARD SHATTERED`,`shatterf`),Yf(i,a,`#9fd4ff`,14))),e.amount>0){let t=e.killingBlow&&e.overkill>=8?`dmg-overkill`:e.killingBlow?`dmg-kill`:o?`dmg-big`:`dmg`;Lf(i,a-24,`${e.amount}`,t,{tint:Gf[Yv.archetype]||``,dx:(Qv++%3-1)*34})}else e.blocked||Lf(i,a-24,`0`,`blockedf`);Af(Math.min(4+e.amount*.5,15)),tf(Math.min(.2+e.amount/26,1)),o&&(jf(70),Pf(i,a,`#ffd8a0`,10,620,5)),e.killingBlow&&(jf(e.overkill>=8?130:90),tf(Math.min(1.6,.6+e.overkill*.06)),Pf(i,a,`#ffffff`,8,780,5),Pf(i,a,`#ffd8a0`,14,900,4),Mf(`#ffe6b0`,.09,.28),e.overkill>=8&&(Mf(`#ffffff`,.12,.24),Nf(i,a,{color:`#fff3d6`,n:26,speed:620,size:2.6,grav:200,kind:`spark`}),Nf(i,a,{color:`#ffd76e`,n:12,speed:300,size:3.4,grav:120,kind:`spark`}))),e.amount>0&&t.art}t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),pv(),await h_(230);break}case`die`:{let t=r.enemies[e.idx],i=n.enemies[e.idx],{x:a,y:o}=av(e.idx);cy={x:a,y:o},i.boss&&(document.body.classList.add(`worldstop`),t.root.classList.add(`doomed`),jf(110),await h_(820),document.body.classList.remove(`worldstop`),t.root.classList.remove(`doomed`)),await ay(t.art);let s=i.boss?320:200;Nv||(oy(t,s),await h_(s)),(i.boss||i.elite?X.bigDeath:X.death)(),Nv||sm(t.root,1);let c=sp()?lm(t.root):null;c||tm(t.root),Uf(t.art,c||{}),Nf(a,o,{color:`#dfeaff`,n:30,speed:480,size:2.6,grav:340,kind:`spark`}),Nf(a,o,{color:`#c9b0ff`,n:26,speed:380,size:3.2,grav:60}),Pf(a,o,`#e8dcff`,12,720,6),Mf(`#ffffff`,i.boss?.24:.1,.3),Af(i.boss?22:12),tf(i.boss?2:.9),t.root.classList.add(`dying`),setTimeout(()=>{t.root.classList.remove(`dying`),t.root.classList.add(`gone`),t.reaped=!0},830),await h_(i.boss?900:500);break}case`hitPlayer`:{let{x:t,y:i}=ov();if(e.source===`poison`?(X.poison(),If(t,i,`#d3a15a`,14)):e.source===`burn`||e.source===`self`?X.debuff():e.source===`thorns`?X.blocked():(X.slash(),e.amount>0&&(X.hit(),Mf(`#ff2233`,Math.min(.05+e.amount*.012,.3),.3)),Xf(t,i,Yv.archetype,Math.min(1,e.amount/24)),iy(r.hero,-1)),e.blocked>0&&(X.blocked(),Lf(t,i+30,`${J(`shield`,19)}${e.blocked}`,`blockedf`),Nf(t,i+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`}),n.player.block===0&&e.amount===0&&(Lf(t,i-2,`GUARD SHATTERED`,`shatterf`),Yf(t,i,`#9fd4ff`,14))),e.amount>0){let n=e.amount>=16;Lf(t,i-30,`${e.amount}`,n?`dmg-big`:`dmg`,{tint:Gf[Yv.archetype]||``,dx:(Qv++%3-1)*34}),Af(Math.min(5+e.amount*.6,18)),tf(Math.min(.3+e.amount/22,1.2))}else e.blocked||Lf(t,i-30,`0`,`blockedf`);pv(),M_(),await h_(240);break}case`blockGain`:{let t=e.who===`player`,{x:n,y:i}=t?ov():av(e.who);X.block(),Lf(n,i-10,`${J(`shield`,22)} ${e.n}`,`blockf`);let a=t?r.pBlock:r.enemies[e.who].block;a.classList.remove(`pulse`),a.offsetWidth,a.classList.add(`pulse`),pv(),await h_(140);break}case`status`:{let{x:t,y:n}=e.who===`player`?ov():av(e.who),r=ju[e.id]||{name:e.id,kind:`buff`},i=r.kind===`debuff`||e.id===`str`&&e.n<0;(e.id===`poison`?X.poison:i?X.debuff:X.buff)(),Lf(t,n-46,`${e.n>0?`+`:``}${e.n} ${r.name}`,i?`debufff`:`bufff`),i||If(t,n,`#9fc8ff`,6),pv(),await h_(170);break}case`heal`:{let{x:t,y:n}=e.who===`player`?ov():av(e.who);X.heal(),If(t,n,`#8fe8a0`,14),Lf(t,n-30,`+${e.n}`,`healf`),pv(),M_(),await h_(200);break}case`energy`:pv(),r.energy.classList.remove(`pop`),r.energy.offsetWidth,r.energy.classList.add(`pop`);break;case`exhaust`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand);if(t){let e=C(t),n=t.cloneNode(!0);Object.assign(n.style,{position:`fixed`,left:`${e.left}px`,top:`${e.top}px`,width:`${e.width}px`,height:`${e.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(n),t.remove(),n.animate([{clipPath:`circle(80% at 50% 55%)`,filter:`brightness(1)`},{clipPath:`circle(44% at 50% 55%)`,filter:`brightness(1.8) saturate(1.6) sepia(0.45)`,offset:.45},{clipPath:`circle(0% at 50% 55%)`,filter:`brightness(2.6) saturate(2) sepia(0.85)`}],{duration:540,easing:`ease-in`}).onfinish=()=>n.remove(),Nf(e.left+e.width/2,e.top+e.height/2,{color:`#ffb066`,n:22,speed:190,grav:-150,size:2.4,life:.85}),await h_(260)}pv();break}case`discardHand`:{let e=m_(`.card`,r.hand);e.length&&(X.card(),e.forEach((e,t)=>{e.animate([{opacity:1},{transform:`${e.style.transform} translateX(340px) rotate(20deg)`,opacity:0}],{duration:260,delay:t*28,easing:`ease-in`}).onfinish=()=>e.remove()}),await h_(280+e.length*28)),pv();break}case`enemyAct`:{let t=r.enemies[e.idx],{x:i,y:a}=av(e.idx);Qv=0;let o=Fu[n.enemies[e.idx].key]?.moves?.[e.move],s=$v[Fu[n.enemies[e.idx].key]?.art?.kind]||`slash`;Yv={archetype:o?.intent?.startsWith(`attack`)?s:o?.intent===`debuff`?`void`:o?.intent===`buff`||o?.intent===`block`?`ward`:s,cardId:null,enemyIdx:e.idx},Xv=!1,Zv=!1,t.intent.classList.remove(`telegraph`),t.intent.offsetWidth,t.intent.classList.add(`telegraph`),Lf(i,a-90,e.name,`movef`),await h_(300),o?.intent?.startsWith(`attack`)?(await ry(t.root,-1,Fu[n.enemies[e.idx].key]?.art?.kind),Zv=!0):await h_(320),t.intent.classList.remove(`telegraph`);break}case`intent`:pv();break;case`addCard`:Lf(_()/2,v()*.62,`${ku[e.id].name} added to ${e.where===`hand`?`hand`:`discard`}`,`notice`),X.debuff(),pv(),mv(),await h_(240);break;case`relicProc`:{let t=Q(`.hud-relic[data-relic="${e.id}"]`);t&&(t.classList.remove(`proc`),t.offsetWidth,t.classList.add(`proc`)),await h_(90);break}case`maxHp`:{let{x:t,y:n}=ov();Lf(t,n-60,`+${e.n} MAX HP`,`healf`),X.buff(),await h_(160);break}case`potion`:X.potion(),await h_(120);break;case`powerConsumed`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand),n=t?Wf(t):{x:_()/2,y:v()-180},{x:i,y:a}=ov();Mv(n.x,n.y,i,a,{n:7,color:`#c9a8ff`,size:7,dur:560}),X.buff(),setTimeout(()=>{Pf(i,a,`#c9a8ff`,12,460,4),If(i,a,`#c9a8ff`,8)},560),await h_(300);break}case`victory`:if(Z.lastPerfect=!!e.perfect,await h_(320),X.victory(),Mf(`#ffe9ac`,.16,.6),e.perfect){let e=$(`div`,`turn-banner perfect-banner`,`PERFECT`);g_().appendChild(e),setTimeout(()=>e.remove(),1400),await h_(500)}break;case`defeat`:{await h_(400),X.defeat(),Mf(`#300`,.5,1.2);let e=Q(`#lantern`);e.classList.add(`gutter`),e.style.setProperty(`--la`,`1`),e.style.setProperty(`--lr`,`160px`),await h_(900);break}}}function uy(){let e=Z.cb;!e||!e.over||(e.result===`win`?dy():fy())}function dy(){G_(`victory-out`);let e=Z.run,t=Z.cb.kind,n=Z.cb.affix;if(Z.cb=null,e.pendingCombat=null,t===`boss`&&e.act>=2){let{newUnlocks:t}=Mg(e,!0);Uh(e,!0),K_(`end`,{won:!0,newUnlocks:t});return}K_(`reward`,{kind:t,rewards:Km(e,t,n)})}function fy(){G_(`defeat`);let e=Z.run,t=Ig(e),n=e.map.nodes.find(t=>t.id===e.nodeId),r=n?n.row:Math.max(1,e.floorsClimbed-1),{newUnlocks:i}=Mg(e,!1);Uh(e,!1),K_(`end`,{won:!1,newUnlocks:i,offers:t,fallAct:e.act,fallRow:r})}function py({kind:e,rewards:t}){let n=Z.run,r=g_(),i=e===`boss`?`BOSS VANQUISHED`:e===`elite`?`ELITE SLAIN`:`VICTORY`,a=Z.lastPerfect?`<div class="perfect-seal">✦ PERFECT — the glass untouched ✦</div>`:`<div class="ornament">✦ ✦ ✦</div>`;Z.lastPerfect=!1,r.innerHTML=`<div class="center-panel screen-enter">${y_()}<div class="panel">
  ...
  </div></div>`;let o=Q(`.reward-list`,r),s=(e,t,r,i=null)=>{let a=$(`button`,`reward-row`,`<span class="ric">${e}</span><span>${t}</span>`);return i&&(a._tip=i),a.onclick=()=>{r()!==!1&&(a.classList.add(`taken`),zh(n),M_())},o.appendChild(a),a};if(s(J(`coin`,18),`<b class="gold-num">${t.gold}</b> gold`,()=>{n.player.gold+=t.gold,n.stats.goldEarned+=t.gold,X.coin(),requestAnimationFrame(()=>{let e=Q(`#hud .gold-num`),r={x:_()/2,y:v()/2-40},i=e?Wf(e):{x:120,y:24},a=n.player.gold-t.gold;e&&(e.textContent=a),Mv(r.x,r.y,i.x,i.y,{n:Math.min(9,4+Math.floor(t.gold/12)),color:`#ffd76e`,dur:600,done:()=>X.coin()}),e&&Pv(e,a,n.player.gold,640)})}),t.potion){let e=Pu[t.potion];s(v_(`potions`,t.potion,pg(e.tone)),`${e.name}`,()=>{if(!Um(n,t.potion))return Lf(_()/2,v()/2,`Potion slots full!`,`notice`),!1;X.potion()},{title:e.name,body:e.text})}if(t.relic){let e=Mu[t.relic];s(`<span style="color:${e.tone};text-shadow:0 0 8px ${e.tone}">${b_(t.relic,24)}</span>`,`<b>${e.name}</b>`,()=>{Pm(n,t.relic),X.relic(),requestAnimationFrame(()=>{let n=Q(`.hud-relic[data-relic="${t.relic}"]`);if(!n)return;let r=Wf(n);Mv(_()/2,v()/2-40,r.x,r.y,{n:1,glyph:e.glyph,color:e.tone,dur:680,done:()=>{n.classList.remove(`proc`),n.offsetWidth,n.classList.add(`proc`)}})})},{title:e.name,body:e.text})}s(J(`cards`,26),`Add a card to your deck`,()=>(l(t.cards,()=>{}),!1));let c=o.lastElementChild;c.dataset.cardrow=`1`,Q(`[data-a="continue"]`,r).onclick=()=>{X.click(),zh(n),K_(e===`boss`?`bossRelic`:`map`)};function l(e,t){V_(`Choose a Card`,e.map(e=>({id:e,up:!1,uid:null})),{sub:`Add one card to your deck — or skip to keep it lean.`,pick:e=>{e&&(Nh(n,e.id),X.upgrade(),Lf(_()/2,v()/2,`${wm(e).name} added`,`notice`)),c.classList.add(`taken`),zh(n),t()},canSkip:!0})}}function my(){let e=Z.run,t=qm(e),n=g_();n.innerHTML=`<div class="center-panel screen-enter"><div class="panel" style="width:min(620px,94vw)">
  ...
  </div></div>`;let r=Q(`.big-choices`,n),i=!1,a=()=>{r.querySelectorAll(`button`).forEach(e=>{e.disabled=!0,e.onclick=null,e.style.pointerEvents=`none`})},o=t=>{if(!i){if(i=!0,a(),Hm(e,t).already){hy();return}t?X.relic():X.click(),zh(e),hy()}};for(let e of t){let t=Mu[e],n=$(`button`,`relic-pick`);n.innerHTML=`<span class="relic-chip" style="--tone:${t.tone}">${b_(e,26)}</span><span><b>${t.name}</b><span class="rd">${t.text}</span></span>`,n.onclick=()=>o(e),r.appendChild(n)}let s=$(`button`,`btn ghost`,`Take none`);s.style.marginTop=`10px`,s.onclick=()=>o(null),r.appendChild(s)}function hy(){let e=Z.run;e.act++,e.omens.push(bm(e)),e.nodeId=null,e.map=Em(e),Nm(e,Math.round(e.player.maxHp*.35)),$d(e.act),Bd(e.act,0),Yg(e.act),zh(e),G_(`act-change`),K_(`map`),X.victory()}function gy(e){let t=Bu[e.omens?.[e.act]];if(!t||Z.screen!==`map`)return;let n=e.omens[e.act],r=Qh(`omens`,n),i=$(`div`,`turn-banner omen-banner`,`${r?`<img class="ob-art" src="${r}" alt="">`:`<span class="ob-glyph" style="color:${t.tone}">${J(`omen-${n}`,22)}</span>`} OMEN — ${t.name.toUpperCase()}<div class="ob-sub">${t.text}</div>`);g_().appendChild(i),X.omen(),setTimeout(()=>i.remove(),4200)}function _y(){let e=Z.run,t=e.player.deck.some(e=>!e.up&&ku[e.id].up);g_().innerHTML=`<div class="center-panel screen-enter">${y_()}<div class="panel">
    <div class="ov-title">REST SITE</div>
    <div class="art-lg">${v_(`props`,`campfire`,hg())}</div>
  ...
  </div></div>`,Q(`[data-a="rest"]`).onclick=t=>{t.currentTarget.disabled=!0,Q(`[data-a="smith"]`).disabled=!0,X.heal();let n=Nm(e,Math.round(e.player.maxHp*Sm(e)));Mf(`#ff9a4d`,.12,.8),Lf(_()/2,v()/2-40,`+${n} HP`,`healf`),If(_()/2,v()/2,`#8fe8a0`,22),If(_()/2,v()/2+60,`#ffb066`,16),zh(e),setTimeout(()=>{Z.screen===`rest`&&K_(`map`)},900)},Q(`[data-a="smith"]`).onclick=()=>{X.click(),V_(`Upgrade a Card`,e.player.deck.filter(e=>!e.up&&ku[e.id].up),{sub:`Forge one card into its + form.`,pick:t=>{t&&(Fh(e,t.uid),X.upgrade(),Mf(`#ffe9ac`,.12,.4),V_(`Upgraded!`,[e.player.deck.find(e=>e.uid===t.uid)],{sub:`It gleams with new power.`}),zh(e),setTimeout(()=>{Z.screen===`rest`&&(B_(),K_(`map`))},1300))}})}}function vy(){let e=Z.run,t=zm(e),n=t=>{Q(`.art-lg`).innerHTML=v_(`props`,`chest-open`,mg(!0)),t&&(Q(`.ov-sub`).innerHTML=t);let n=Q(`.big-choices`);n.innerHTML=``;let r=$(`button`,`btn btn-primary`,`Continue`);r.onclick=()=>{X.click(),K_(`map`)},n.appendChild(r),M_(),zh(e)};if(g_().innerHTML=`<div class="center-panel screen-enter">${y_()}<div class="panel">
    <div class="ov-title">TREASURE</div>
    <div class="art-lg" style="cursor:pointer" data-a="open">${v_(`props`,`chest`,mg(!1))}</div>
  ...
  </div></div>`,t){n(`The chest lies empty.`);return}let r=()=>{if(t)return;t=!0,m_(`[data-a="open"]`).forEach(e=>{e.onclick=null,e.style.pointerEvents=`none`});let r=Bm(e,{common:.55,uncommon:.35,rare:.1});if(r.already){n(`The chest lies empty.`);return}Mf(`#ffe9ac`,.2,.5),Nf(_()/2,v()/2,{color:`#ffd97a`,n:36,speed:380,grav:160});let i;if(r.relicId){X.relic();let e=Mu[r.relicId];i=`You claim <b style="color:${e.tone}">${e.name}</b> — <i>${e.text}</i>`}else X.coin(),i=`Only coins remain — <b class="gold-num">+60 gold</b>.`;n(i)};m_(`[data-a="open"]`).forEach(e=>e.onclick=r)}function yy(){let e=Z.run,t=Z.shopData||={};(Z.screen!==`shop`||!t.stock||t.forNode!==e.nodeId)&&(t.stock=Jm(e),t.forNode=e.nodeId);let n=t.stock,r=g_();r.innerHTML=`<div class="center-panel screen-enter">${y_()}<div class="panel ov-panel" style="width:min(980px,96vw)">
    <div style="display:flex;align-items:center;justify-content:center;gap:18px">
      <div style="width:130px">${v_(`props`,`merchant`,gg())}</div>
  ...
  </div></div>`;let i=Q(`.cards-row`,r),a=Q(`.misc-row`,r),o=Q(`.shop-grid`,r),s=!1,c=()=>e.player.gold,l=t=>{e.player.gold-=t,X.coin(),zh(e),M_(),u()};function u(){o&&o.classList.toggle(`list-seq-done`,s),i.innerHTML=``,a.innerHTML=``;for(let t of n.cards){let n=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),r=A_({id:t.id,up:!1,uid:null},{size:138});r.onclick=()=>{if(t.sold||c()<t.price)return X.debuff();t.sold=!0,Nh(e,t.id),l(t.price)},n.appendChild(r),n.appendChild($(`div`,`price`,`${J(`coin`,14)} ${t.price}`)),i.appendChild(n)}for(let t of n.relics){let n=Mu[t.id],r=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),i=$(`button`,`shop-relic`,`<span class="relic-chip" style="--tone:${n.tone}">${b_(t.id,24)}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||c()<t.price)return X.debuff();t.sold=!0,Pm(e,t.id),X.relic(),l(t.price)},r.appendChild(i),r.appendChild($(`div`,`price`,`${J(`coin`,14)} ${t.price}`)),a.appendChild(r)}for(let t of n.potions){let n=Pu[t.id],r=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),i=$(`button`,`shop-relic`,`<span style="width:34px;height:44px">${v_(`potions`,t.id,pg(n.tone))}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||c()<t.price)return X.debuff();if(!Um(e,t.id)){Lf(_()/2,v()/2,`Potion slots full!`,`notice`);return}t.sold=!0,X.potion(),l(t.price)},r.appendChild(i),r.appendChild($(`div`,`price`,`${J(`coin`,14)} ${t.price}`)),a.appendChild(r)}let t=$(`div`,`shop-item ${n.removed?`sold`:``} ${c()<n.removeCost?`cant`:``}`),r=$(`button`,`shop-relic`,`<span style="width:34px;display:inline-flex;justify-content:center">${J(`scissors`,26)}</span><b>Card Removal</b>Remove a card from your deck forever.`);r.onclick=()=>{if(n.removed||c()<n.removeCost)return X.debuff();V_(`Remove a Card`,e.player.deck,{sub:`Cut the dead weight.`,pick:t=>{t&&(Ph(e,t.uid),n.removed=!0,e.player.gold-=n.removeCost,X.card(),zh(e),M_(),u())},canSkip:!0,skipLabel:`Cancel`})},t.appendChild(r),t.appendChild($(`div`,`price`,`${J(`coin`,14)} ${n.removeCost}`)),a.appendChild(t),s=!0}u(),Q(`[data-a="leave"]`,r).onclick=()=>{X.click(),K_(`map`)}}function by(e){let t=Z.run,n=Lu[e],r=g_();r.innerHTML=`<div class="center-panel screen-enter">${y_()}<div class="panel event-panel">
    <div class="ov-title">${n.name.toUpperCase()}</div>
    <div class="event-art">${v_(`events`,e,_g(n.glyph,n.hue))}</div>
    <div class="event-text">${n.text}</div>
    <div class="event-log"></div>
    <div class="event-choices"></div>
  </div></div>`;let i=Q(`.event-choices`,r),a=()=>{i.innerHTML=``;let e=$(`button`,`btn btn-primary`,`Continue`);e.onclick=()=>{X.click(),K_(`map`)},i.appendChild(e)};if(zm(t)){a();return}for(let[e,r]of n.choices.entries()){let n=$(`button`,`event-choice${e===0?` btn-primary`:``}`,`<b>${r.label}</b>${r.sub?`<div class="sub">${r.sub}</div>`:``}`);r.needGold&&t.player.gold<r.needGold&&(n.disabled=!0),n.onclick=()=>s(r),i.appendChild(n)}let o=!1;async function s(e){if(!o){o=!0,i.querySelectorAll(`button`).forEach(e=>{e.disabled=!0});try{X.click();let{pending:n,log:o,already:s}=Vm(t,e.ops);if(s){a();return}M_();let l=Q(`.event-log`,r),u=[];for(let e of o)e.text&&u.push(e.text),e.relic&&u.push(`Gained <b style="color:${Mu[e.relic].tone}">${Mu[e.relic].name}</b> — <i>${Mu[e.relic].text}</i>`);u.length&&(l.innerHTML=u.join(`<br>`)),i.innerHTML=``;for(let e of n)await c(e);zh(t),M_(),a(),!u.length&&!n.length&&!e.ops.length&&K_(`map`)}catch(e){if(zm(t)){zh(t),a();return}throw o=!1,i.querySelectorAll(`button`).forEach(e=>{e.disabled=!1}),e}}}function c(e){return new Promise(n=>{if(e===`remove`)V_(`Remove a Card`,t.player.deck,{sub:`Let it go.`,pick:e=>{e&&(Ph(t,e.uid),X.card()),n()},canSkip:!1});else if(e===`upgrade`){let e=t.player.deck.filter(e=>!e.up&&ku[e.id].up);if(!e.length)return n();V_(`Upgrade a Card`,e,{sub:`The forge hungers.`,pick:e=>{e&&(Fh(t,e.uid),X.upgrade()),n()}})}else e===`duplicate`?V_(`Duplicate a Card`,t.player.deck,{sub:`The mirror remembers.`,pick:e=>{e&&(Ih(t,e.uid),X.upgrade()),n()}}):e.pickCard?V_(`Choose a Card`,Gm(t,e.pickCard).map(e=>({id:e,up:!1,uid:null})),{sub:`One page still glows.`,pick:e=>{e&&(Nh(t,e.id),X.upgrade()),n()},canSkip:!0}):n()})}}function xy(e){return e.kind===`relic`?{icon:b_(e.id,20),name:Mu[e.id]?.name||e.id,note:`your rarest relic`}:e.kind===`card`?{icon:`🂠`,name:(ku[e.id]?.name||e.id)+(e.up?`+`:``),note:`your finest card`}:{icon:J(`coin`,20),name:`${e.amount} gold`,note:`a cache of gold`}}function Sy(e){if(e===`aspect2`)return{kind:`Aspect Unlocked`,name:`The Ashwarden`};let[t,n]=e.split(`:`);return t===`card`?{kind:`Card Unlocked`,name:ku[n]?.name||n}:{kind:`Relic Unlocked`,name:Mu[n]?.name||n}}function Cy(e=[]){if(!e.length)return;let t=Q(`#toasts`);t||(t=$(`div`),t.id=`toasts`,b().appendChild(t)),e.forEach((e,n)=>{let r=Sy(e);setTimeout(()=>{let e=$(`div`,`unlock-toast`,`<div class="ut-kind">✦ ${r.kind}</div><div class="ut-name">${r.name}</div>`);t.appendChild(e),requestAnimationFrame(()=>e.classList.add(`in`)),X.relic(),setTimeout(()=>{e.classList.remove(`in`),setTimeout(()=>e.remove(),500)},3800)},700+n*800)})}function wy({won:e,newUnlocks:t=[],offers:n=[],fallAct:r=0,fallRow:i=1}){let a=Z.run;Xg();let o=a.stats,s=Math.max(1,Math.round((Date.now()-o.start)/6e4)),c=a.act*15+a.floorsClimbed,l=`<div class="stats-grid">
    ...
    </div>`;if(e){g_().innerHTML=`<div class="end-screen screen-enter">
      ...
      ${l}${u}
        ...
        <div class="bequest-opts">${n.map((e,t)=>{let n=xy(e);return`<button class="bequest-opt" data-a="bequest" data-i="${t}"><span class="bq-icon">${n.icon}</span><span class="bq-name">${n.name}</span><span class="bq-note">${n.note}</span></button>`}).join(``)}</div>
      </div>`:``,t=Array.from({length:14},()=>`<span class="ember" style="left:${(8+Math.random()*84).toFixed(1)}%;--ex:${((Math.random()-.5)*90).toFixed(0)}px;animation-delay:${(Math.random()*4).toFixed(2)}s;animation-duration:${(3+Math.random()*3).toFixed(2)}s"></span>`).join(``);g_().innerHTML=`<div class="end-screen grave">
      <div class="monument">
    ...
    </div>`}g_().onclick=e=>{let t=e.target.closest(`[data-a]`);if(!t)return;let o=t.dataset.a;if(o===`bequest`){X.relic();let e=n[+t.dataset.i];Ng(r,i,e);let a=xy(e);Q(`#bequest`).innerHTML=`<div class="bequest-done">✦ The stone keeps your <b>${a.name}</b>.<br>It will wait for you in ${Ou[r].name}.</div>`;return}X.click(),o===`deck`&&V_(`Final Deck`,a.player.deck,{}),o===`title`&&(Z.run=null,Z.lamp=null,K_(`title`))},Cy(t)}var Ty=!1;function Ey(){if(Ty)return;Ty=!0;let e=Q(`#overlay`);e.addEventListener(`pointerdown`,t=>{t.target===e&&e._closable&&B_()}),document.addEventListener(`keydown`,t=>{t.key===`Escape`&&e.classList.contains(`open`)&&e._closable&&B_()})}function Dy(e,t){let n=e.dataset.cat||``,r=e.dataset.id||``,i=e.dataset.url||``,a=e.querySelector(`.g-art-stage`),o=`${r} / ${n}`,s=a?.querySelector(`svg`),c=s?`data:image/svg+xml;charset=UTF-8,${encodeURIComponent(s.outerHTML)}`:``,l=i?`<img class="gallery-lightbox-img" src="${__(i)}" alt="${__(r)}">`:c?`<img class="gallery-lightbox-img" src="${__(c)}" alt="${__(r)}">`:a?a.innerHTML:``;z_(`<div class="gallery-lightbox" role="dialog" aria-modal="true" aria-label="${__(o)}">
    <button class="gallery-lightbox-close" type="button" data-a="close" aria-label="Close">&times;</button>
    <div class="gallery-lightbox-meta"><b>${__(r)}</b><span>${__(n)} - ${__(Zh(t))}</span></div>
    <div class="gallery-lightbox-art">${l}</div>
  </div>`,e=>{Q(`[data-a="close"]`,e).onclick=()=>B_()},!0)}function Oy(){Ey();let e=new URLSearchParams(location.search),t=e.get(`set`)||e.get(`assetSet`)||`live`,n=Xh().includes(t)?t:`live`,r=Xh().map(e=>{let t=new URLSearchParams(location.search);return t.set(`gallery`,`1`),t.set(`set`,e),`<a class="${e===n?`active`:``}" href="?${t.toString()}">${Zh(e)}</a>`}).join(``),i={omens:Object.keys(Bu).map(e=>[e,()=>J(`omen-${e}`,64)]),boons:Object.keys(Ku).map(e=>[e,()=>J(`boon-${e}`,64)]),arts:Object.keys(Hu).map(e=>[e,()=>J(`art-${e}`,64)]),heroes:Wu.map((e,t)=>[e.id,()=>lg(t)]),enemies:Object.entries(Fu).map(([e,t])=>[e,()=>sg(t.art)]),cards:Object.entries(ku).map(([e,t])=>[e,()=>fg(e,t.type)]),potions:Object.entries(Pu).map(([e,t])=>[e,()=>pg(t.tone)]),props:[[`campfire`,hg],[`chest`,()=>mg(!1)],[`chest-open`,()=>mg(!0)],[`merchant`,gg]],events:Object.entries(Lu).map(([e,t])=>[e,()=>_g(t.glyph,t.hue)]),title:[[`title`,()=>`<div class="title-banner-ph">title</div>`]],"title-background":[[`background`,()=>`<div class="title-banner-ph">background</div>`]],stage:[`act1`,`act2`,`act3`].flatMap(e=>[`backdrop`,`mid`,`ledge`].map(t=>[`${e}-${t}`,()=>`<div class="title-banner-ph">stage</div>`])),relics:Object.entries(Mu).map(([e,t])=>[e,()=>`<div class="title-banner-ph" style="color:${t.tone}">${t.glyph}</div>`])};g_().className=`gallery-mode`,g_().innerHTML=`<div class="g-toolbar">
    <div><b>Asset set:</b> ${Zh(n)}</div>
    <nav>${r}</nav>
  </div>`+Object.entries(i).map(([e,t])=>`<h2 class="g-head">${e} — ${t.filter(([t])=>Qh(e,t,n)).length}/${t.length} generated</h2>
      <div class="gallery">${t.map(([t,r])=>{let i=Qh(e,t,n);return`<div class="g-cell ${i?`g-png`:`g-svg`}"><button class="g-art g-open" type="button" data-cat="${__(e)}" data-id="${__(t)}" data-url="${i?__(i):``}" aria-label="Enlarge ${__(t)}"><span class="g-art-stage">${i?`<img class="raster-art" src="${__(i)}" alt="">`:r()}</span></button>
          <div class="g-label">${__(t)}<span class="g-badge">${i?`PNG`:`SVG`}</span></div></div>`}).join(``)}</div>`).join(``),g_().onclick=e=>{let t=e.target.closest(`.g-open`);t&&Dy(t,n)}}function ky(){let e=e=>{let t=document.querySelector(e);return t?C(t):null};window.__probe={stage:()=>x(),geometry(){let t=e(`.battlefield`);return!t||!Z.cb||!Z.ce?null:{stage:x(),viewport:{w:_(),h:v()},groundY:t.bottom,heroArtBottom:e(`.hero-wrap`)?.bottom??null,enemyArtBottoms:Z.cb.enemies.map((e,t)=>e.hp>0&&Z.ce.enemies[t]?C(Z.ce.enemies[t].art).bottom:null),slLedgeTop:e(`.sl-ledge`)?.top??null,seamY:e(`.stage-ledge`)?.top??null}},invariants(){let e=[],t=(t,n,r=``)=>e.push({name:t,pass:n,detail:n?``:String(r)}),n=Z.cb,r=Z.ce;return n&&r&&Z.screen===`combat`&&(n.enemies.forEach((e,n)=>{let i=r.enemies[n];if(i)if(e.hp<=0){let e=i.root.classList;t(`enemy${n}: dead body leaves the field`,e.contains(`gone`)||e.contains(`dying`)||getComputedStyle(i.root).visibility===`hidden`,`classes="${i.root.className}"`),t(`enemy${n}: dead body releases its mesh plane`,!i.root.querySelector(`.mesh-live`),`a WebGL warp plane still renders this corpse`)}else t(`enemy${n}: HP label matches engine`,i.hp.textContent===`${Math.max(0,e.hp)}/${e.maxHp}`,`dom="${i.hp.textContent}" engine=${e.hp}/${e.maxHp}`)}),t(`player: HP label matches engine`,r.pHp.textContent===`${Math.max(0,n.player.hp)}/${n.player.maxHp}`,`dom="${r.pHp.textContent}" engine=${n.player.hp}/${n.player.maxHp}`),t(`hand: DOM count matches engine`,m_(`.card`,r.hand).length===n.hand.length,`dom=${m_(`.card`,r.hand).length} engine=${n.hand.length}`),t(`energy: orb matches engine`,Q(`.num`,r.energy).textContent===String(n.player.energy),`dom="${Q(`.num`,r.energy).textContent}" engine=${n.player.energy}`),t(`embers: lantern count matches engine`,Q(`.lb-count`,r.lantern).textContent===String(n.embers),`dom="${Q(`.lb-count`,r.lantern).textContent}" engine=${n.embers}`)),e},state(){let e=Z.cb;return{screen:Z.screen,busy:Z.busy,over:e?.over??null,result:e?.result??null,turn:e?.turn??null,player:e?{hp:e.player.hp,maxHp:e.player.maxHp,block:e.player.block,energy:e.player.energy}:null,embers:e?.embers??null,enemies:e?e.enemies.map(e=>({key:e.key,hp:e.hp,maxHp:e.maxHp,block:e.block})):null,hand:e?e.hand.map(e=>({uid:e.uid,id:e.id})):null}},settle:()=>new Promise(e=>{let t=()=>!Z.busy&&(!Z.cb||Z.cb.queue.length===0),n=()=>t()?e(!0):setTimeout(n,50);n()}),async play(e,t=null){return Z.busy||!Z.cb||Z.cb.over?!1:(await kv(e,t),!Z.cb||Z.cb.over||!Z.cb.hand.some(t=>t.uid===e))},async endTurn(){await Av()},async useArt(){return Z.busy||!Z.cb||Z.cb.over||!sh(Z.run,Z.cb)?!1:(ch(Z.run,Z.cb),await sy(),uy(),!0)},async usePotion(e,t=null){return Z.busy||!Th(Z.run,Z.cb,e,t)?!1:(Z.cb&&(await sy(),uy()),M_(),!0)},forceHand(e){return Z.cb.hand=e.map(e=>Cm(Z.run,e)),mv(),Z.cb.hand.map(e=>e.uid)},setEnergy(e){Z.cb.player.energy=e,pv()},setEmbers(e){Z.cb.embers=e,pv()},setEnemyHp(e,t){Z.cb.enemies[e].hp=t,pv()},freeze(){document.documentElement.classList.add(`freeze`),Kv=!0,Ef(),rf()}}}function Ay(){if(new URLSearchParams(location.search).has(`gallery`))return Oy();O_(),document.addEventListener(`pointerdown`,()=>Ug(),{once:!0}),document.addEventListener(`contextmenu`,e=>{Z.targeting&&(e.preventDefault(),Dv())}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&(Z.targeting?Dv():Q(`#overlay`).classList.contains(`open`)&&Q(`#overlay`)._closable&&B_()),(e.key===`e`||e.key===`E`)&&Z.screen===`combat`&&!Z.busy&&Av(),(e.key===`a`||e.key===`A`)&&Z.screen===`combat`&&!Z.busy&&Z.ce?.lantern?.click()}),Q(`#overlay`).addEventListener(`pointerdown`,e=>{e.target===Q(`#overlay`)&&Q(`#overlay`)._closable&&B_()}),window.spirebound={S:Z,E:pm,startCombatUI:rv,show:K_,meshEnabled:sp,meshDebug:fm,refitCombat:cv},ky(),requestAnimationFrame(qv),K_(`title`)}g(),Zd(),wf(),Qp(),Ay();