...
`;function Kp(e,t,n,r){let i=new Da(2,2,pp,mp),a={geo:i,base:i.attributes.position.array.slice(),profile:t,seed:n,el:null,aspect:Vp(r,null)||2/3,sites:[],death:0,glass:null,fire:null,beams:null,bodyPx:null,outline:null,aimOn:!1},o=Bp(e,e=>{a.aspect=Vp(r,e)});a.tex=o;let s=new La({uniforms:{map:{value:o},uFlash:{value:0},uCut:{value:0}},vertexShader:Up,fragmentShader:Wp,transparent:!0,depthTest:!1,depthWrite:!1});a.mat=s;let c=new Ui(i,s);c.renderOrder=1,jp.add(c),a.mesh=c;let l=new La({uniforms:{map:{value:o},uColor:{value:new H(`#fff6ec`)},uWidth:{value:.018},uStyle:{value:1},uSpeed:{value:1},uTime:{value:0},uBeams:{value:1},uDashes:{value:2}},vertexShader:Up,fragmentShader:Gp,transparent:!0,depthTest:!1,depthWrite:!1}),u=new Ui(i,l);return u.visible=!1,u.renderOrder=0,jp.add(u),a.outline=u,a.aimMat=l,r&&!r.complete&&r.addEventListener(`load`,()=>{a.aspect=Vp(r,o)},{once:!0}),a}function qp(e){if(e.bodyPx)return e.bodyPx;let t=e.tex?.image;if(!t?.width)return null;let n=Object.assign(document.createElement(`canvas`),{width:Dp,height:Dp}).getContext(`2d`);return n.drawImage(t,0,0,Dp,Dp),e.bodyPx=n.getImageData(0,0,Dp,Dp).data,e.bodyPx}var Jp=e=>e.sites.map(e=>({x:e.u*Dp,y:(1-e.v)*Dp}));function Yp(e){let t=Dp,n=qp(e),r=Object.assign(document.createElement(`canvas`),{width:t,height:t}),i=r.getContext(`2d`),a=i.createImageData(t,t),o=Jp(e),s=bp*t,c=s*(1-.9*xp);for(let e=0;e<t;e++)for(let r=0;r<t;r++){let i=(e*t+r)*4,l=0;if(n[i+3]>90){let t=0xe8d4a51000;for(let n of o){let i=r-n.x,a=e-n.y,o=i*i+a*a;o<t&&(t=o)}let n=Math.sqrt(t);l=n<=c?1:n>=s?0:1-(n-c)/(s-c),l=l*l*(3-2*l)}let u=Math.round(255*l);a.data[i]=a.data[i+1]=a.data[i+2]=u,a.data[i+3]=255}return i.putImageData(a,0,0),r}function Xp(e){let t=Dp,n=Object.assign(document.createElement(`canvas`),{width:t,height:t}),r=n.getContext(`2d`),i=r.createImageData(t,t),a=Jp(e);for(let e=0;e<t;e++)for(let n=0;n<t;n++){let r=0xe8d4a51000,o=0xe8d4a51000,s=null,c=null;for(let t of a){let i=n-t.x,a=e-t.y,l=i*i+a*a;l<r?(o=r,c=s,r=l,s=t):l<o&&(o=l,c=t)}let l=0,u=0,d=Math.sqrt(o)-Math.sqrt(r),f=t*.0137;if(c&&d<f){let e=s.x-c.x,t=s.y-c.y,n=Math.hypot(e,t)||1,r=(1-d/f)*.95;l=e/n*r,u=-(t/n)*r}let p=Math.sqrt(Math.max(.05,1-l*l-u*u)),m=(e*t+n)*4;i.data[m]=(l*.5+.5)*255,i.data[m+1]=(u*.5+.5)*255,i.data[m+2]=(p*.5+.5)*255,i.data[m+3]=255}return r.putImageData(i,0,0),n}function Zp(e){let t=Dp,n=qp(e),r=Object.assign(document.createElement(`canvas`),{width:t,height:t}),i=r.getContext(`2d`),a=i.createImageData(t,t),o=Jp(e);if(o.length>=2){let e=bp*t,r=e*(1-.9*xp),i=t*.0102,s=t*.0215;for(let c=0;c<t;c++)for(let l=0;l<t;l++){let u=(c*t+l)*4;if(n[u+3]<=90)continue;let d=0xe8d4a51000,f=0xe8d4a51000;for(let e of o){let t=l-e.x,n=c-e.y,r=t*t+n*n;r<d?(f=d,d=r):r<f&&(f=r)}let p=Math.sqrt(d),m=p<=r?1:p>=e?0:1-(p-r)/(e-r);if(m=m*m*(3-2*m),m<=0)continue;let h=Math.sqrt(f)-p,g=Math.max(0,1-h/i),_=Math.max(0,1-h/s)*.2,v=Math.min(1,g+_)*m;v<=.02||(a.data[u]=Math.round(255*v),a.data[u+1]=Math.round(158*v),a.data[u+2]=Math.round(56*v),a.data[u+3]=255)}}return i.putImageData(a,0,0),r}function Qp(e){let t=Zp(e),n=Math.round(Dp*Ep),r=(n-Dp)/2,i=Object.assign(document.createElement(`canvas`),{width:n,height:n}),a=i.getContext(`2d`),o=.5,s=.5;e.sites.length&&(o=e.sites.reduce((e,t)=>e+t.u,0)/e.sites.length,s=1-e.sites.reduce((e,t)=>e+t.v,0)/e.sites.length);let c=r+o*Dp,l=r+s*Dp;a.globalCompositeOperation=`lighter`;for(let e=1;e<=26;e++){let n=e/26,i=1+n*wp;a.globalAlpha=Math.min(1,.06*Cp*(1-n)**Tp),a.setTransform(i,0,0,i,c-c*i,l-l*i),a.drawImage(t,r,r)}return a.setTransform(1,0,0,1,0,0),a.globalAlpha=1,i}function $p(){if(Lp||!Ap)return;Lp=!0;let e=new ys(Ap);jp.environment=e.fromScene(new $f,.04).texture,jp.environmentIntensity=.45;let t=new ko(14674687,1.8);t.position.set(-1.4,1.8,2),jp.add(t),jp.add(new Ao(2765894,.6))}var em=(e,t=!1)=>{let n=new va(e);return t&&(n.colorSpace=dt),n};function tm(e,t){let n=e[t];if(n){jp.remove(n);for(let e of[`map`,`alphaMap`,`normalMap`])n.material[e]?.dispose?.();n.material.dispose(),e[t]=null}}function nm(e){$p(),tm(e,`glass`);let t=new Ba({transmission:1,ior:1.4,thickness:.12,roughness:.03,metalness:0,normalMap:em(Xp(e)),normalScale:new R(1.3,1.3),alphaMap:em(Yp(e)),transparent:!0,alphaTest:.01,opacity:Sp,clearcoat:.3,clearcoatRoughness:.2,envMapIntensity:.4,depthTest:!1,depthWrite:!1}),n=new Ui(e.geo,t);n.renderOrder=3,jp.add(n),e.glass=n}function rm(e){tm(e,`fire`);let t=new ji({map:em(Zp(e),!0),transparent:!1,blending:2,depthTest:!1,depthWrite:!1});t.color.setScalar(0);let n=new Ui(e.geo,t);n.renderOrder=2,jp.add(n),e.fire=n}function im(e){tm(e,`beams`);let t=new ji({map:em(Qp(e),!0),transparent:!0,blending:2,depthTest:!1,depthWrite:!1,opacity:0}),n=new Ui(new Da(2,2),t);n.renderOrder=4,jp.add(n),e.beams=n}function am(e,t){let n=e.geo.attributes.position,r=e.profile;for(let i=0;i<n.count;i++){let a=e.base[i*3],o=e.base[i*3+1],s=(o+1)/2,c=s**+(r.pin??1.6),l=0,u=0;l+=.028*c*r.sway*Math.sin(t*.9+e.seed),l+=.01*c*c*r.sway*Math.sin(t*1.7+1+e.seed*.3);let d=Op(s,.62,.12);l+=a*.02*d*r.breathe*Math.sin(t*2.2+e.seed*.5),u+=.012*d*r.breathe*Math.sin(t*2.2+e.seed*.5),u+=.014*c*r.bob*Math.sin(t*1.1+.4+e.seed),l+=.012*Math.max(0,(s-.8)/.2)*r.head*Math.sin(t*.7+e.seed),l+=.01*Math.max(0,(.45-s)/.45)*c*r.cloth*Math.sin(s*12-t*2.5+e.seed),n.array[i*3]=a+l*hp,n.array[i*3+1]=o+u*hp}n.needsUpdate=!0}function om(e){return[e.outline,e.mesh,e.fire,e.glass,e.beams].filter(Boolean)}function sm(e){return[e.mesh,e.fire,e.glass,e.beams].filter(Boolean)}var cm=()=>{let e=Ap?C(Ap.domElement):{left:0,top:0};return{left:e.left,top:e.top}};function lm(e,t=0,n={left:0,top:0}){let r=t=>{for(let n of sm(e))n.visible=t;e.outline&&(e.outline.visible=t&&!!e.aimOn)};if(!e.el.isConnected||!(e.el.checkVisibility?.({visibilityProperty:!0})??!0)){r(!1);return}let i=C(e.el);if(i.width<2||i.height<2){r(!1);return}e.aspect=Vp(e.el.querySelector(`.raster-art`),e.tex)||e.aspect||1;let{w:a,h:o}=Hp(i.width,i.height,e.aspect),s=(e.profile.float||0)*Math.sin(t*1.15+e.seed*.7)*12*hp,c=i.left-n.left+i.width/2-Fp/2,l=-(i.top-n.top+i.height-o/2-Ip/2)+s,u=(e.flip?-1:1)*a/2,d=o/2;r(!0);let f=Math.round(i.bottom);e.outline&&(e.outline.renderOrder=f*4),sm(e).forEach((e,t)=>{e.renderOrder=f*4+1+t});let p=0;for(let t of om(e)){t.position.set(c,l,p);let n=t===e.beams?Ep:1;t.scale.set(u*n,d*n,1),p+=.01}}function um(){Fp=_(),Ip=v(),Ap.setPixelRatio(Math.min(devicePixelRatio*y(),2)),Ap.setSize(Fp,Ip,!1),Mp.left=-Fp/2,Mp.right=Fp/2,Mp.top=Ip/2,Mp.bottom=-Ip/2,Mp.updateProjectionMatrix()}function dm(e){if(!Np.length)return;let t=e*.001,n=cm();for(let e of Np)am(e,t),lm(e,t,n),e.aimMat&&e.aimOn&&(e.aimMat.uniforms.uTime.value=t);Ap.render(jp,Mp)}function fm(){let e=document.getElementById(`mesh`);!e||Ap||(Ap=new fu({canvas:e,alpha:!0,antialias:!0,powerPreference:`high-performance`}),Ap.setClearColor(0,0),Ap.toneMapping=4,Ap.toneMappingExposure=1.1,jp=new sr,Mp=new Do(-1,1,1,-1,.1,100),Mp.position.z=10,um(),addEventListener(`resize`,um))}function pm(e){e.el?.classList.remove(`mesh-live`),tm(e,`glass`),tm(e,`fire`),tm(e,`beams`),e.outline&&(jp.remove(e.outline),e.aimMat?.dispose(),e.outline=null,e.aimMat=null),jp.remove(e.mesh),e.geo.dispose(),e.mesh.material.dispose()}function mm(){cancelAnimationFrame(Pp),Pp=0;for(let e of Np)pm(e);Np=[],document.documentElement.classList.remove(`mesh-on`),Ap?.render(jp,Mp)}function hm(e){let t=Np.findIndex(t=>t.el===e||t.el&&e.contains&&e.contains(t.el));t<0||(pm(Np[t]),Np.splice(t,1),Np.length||document.documentElement.classList.remove(`mesh-on`),Ap?.render(jp,Mp))}function gm(e,t=160){let n=ym(e);n&&(n.mat.uniforms.uFlash.value=.9,setTimeout(()=>{n.mat&&(n.mat.uniforms.uFlash.value=0)},t))}var _m=56,vm=e=>Math.max(.05,Math.min(.95,e));function ym(e){return Np.find(t=>t.el===e||e.contains&&e.contains(t.el))}function bm(e,t=.32+Math.random()*.36,n=.3+Math.random()*.4){if(vp)return!1;let r=ym(e);if(!r||!qp(r))return!1;let i=5+(Math.random()*3|0);for(let e=0;e<i;e++){let e=Math.random()*Math.PI*2,i=Math.random()*.052;if(r.sites.length>=_m)break;r.sites.push({u:vm(t+Math.cos(e)*i),v:vm(n+Math.sin(e)*i)})}return r.mat.uniforms.uCut.value===0&&(r.mat.uniforms.uCut.value=.35,r.mat.transparent=!1,r.mat.needsUpdate=!0),nm(r),r.death>0&&rm(r),!0}function xm(e,t){if(vp)return!1;let n=ym(e);return n?(t>0&&!n.fire&&(rm(n),im(n)),n.death=t,n.fire&&n.fire.material.color.setScalar(t),n.beams&&(n.beams.material.opacity=Math.min(1,Math.max(0,t*1.35-.35))),!0):!1}function Sm(e){let t=ym(e);return t?t.sites.map(e=>({u:e.u,v:e.v})):[]}function Cm(e){let t=ym(e);if(!t||!Ap||vp)return null;let n=performance.now()*.001,r=cm(),i=new Set(om(t)),a=[];jp.traverse(e=>{e.isMesh&&(a.push([e,e.visible]),e.visible=i.has(e)&&e!==t.beams)}),am(t,n),lm(t,n,r),t.beams&&(t.beams.visible=!1),Ap.render(jp,Mp);for(let[e,t]of a)e.visible=t;let o=C(t.el),{w:s,h:c}=Hp(o.width,o.height,t.aspect),l=Ap.getPixelRatio(),u=(o.left-r.left+o.width/2-s/2)*l,d=(o.top-r.top+o.height-c)*l,f=Math.max(1,Math.round(s*l)),p=Math.max(1,Math.round(c*l)),m=document.createElement(`canvas`);m.width=f,m.height=p,m.getContext(`2d`).drawImage(Ap.domElement,u,d,f,p,0,0,f,p);let h=Sm(e),g={left:o.left,top:o.top,width:o.width,height:o.height},_=t.beams;if(_){t.beams=null;let e=performance.now(),n=_.material.opacity,r=t=>{let i=Math.min(1,(t-e)/200);_.material.opacity=n*(1-i),i<1?(Np.length||Ap?.render(jp,Mp),requestAnimationFrame(r)):(jp.remove(_),_.material.map?.dispose(),_.material.dispose(),Ap?.render(jp,Mp))};requestAnimationFrame(r)}return hm(e),{capture:m.toDataURL(`image/png`),sites:h,rect:g}}function wm(e,t){let n=kp[e]||kp.humanoid,r=t?up(t):{};return Object.keys(r).length?{...n,...r}:n}function Tm(e){if(mm(),!yp()||(Ap||fm(),!Ap))return;for(let{el:t,url:n,kind:r,id:i,flip:a}of e){if(!n||!t)continue;let e=t.querySelector(`.raster-art`);if(!e)continue;t.classList.add(`mesh-live`);let o=wm(r,i),s=Kp(n,o,Math.random()*10,e);s.el=t,s.flip=!!a,s.profile=o,Np.push(s)}if(!Np.length)return;document.documentElement.classList.add(`mesh-on`);let t=e=>{Pp=requestAnimationFrame(t),dm(e)};Pp=requestAnimationFrame(t)}function Em(e){let t=ym(e);if(!t)return 0;let n=performance.now()*.001;return Math.max(0,(t.profile.float||0)*Math.sin(n*1.15+t.seed*.7)*12*hp)}function Dm(e,t,n=null){let r=ym(e);if(!r?.outline)return!1;if(r.aimOn=!!t,r.outline.visible=!!t,t&&r.aimMat&&n){let e=n.style===`chase`?2:n.style===`solid`?0:1;r.aimMat.uniforms.uStyle.value=e,r.aimMat.uniforms.uSpeed.value=Number.isFinite(n.speed)?n.speed:1,r.aimMat.uniforms.uColor.value.set(n.color||`#fff6ec`);let t=Number.isFinite(n.width)?n.width:.018;r.aimMat.uniforms.uWidth.value=Math.min(.06,Math.max(.006,t));let i=Number.isInteger(n.beams)?n.beams:1,a=Number.isInteger(n.dashes)?n.dashes:2;r.aimMat.uniforms.uBeams.value=Math.min(4,Math.max(1,i)),r.aimMat.uniforms.uDashes.value=Math.min(4,Math.max(1,a))}return!0}function Om(){for(let e of Np)e.aimOn=!1,e.outline&&(e.outline.visible=!1)}var km=()=>({enabled:yp(),planes:Np.length,renderer:!!Ap,looping:!!Pp,intensity:hp,sites:Np.reduce((e,t)=>Math.max(e,t.sites.length),0),death:Np.reduce((e,t)=>Math.max(e,t.death),0),glass:Np.filter(e=>e.glass).length}),Am=t({MAP_COLS:()=>7,MAP_ROWS:()=>15,addCardToDeck:()=>tg,addStatus:()=>Sh,applyEventOps:()=>fg,applyNodeEventChoice:()=>lh,availableNodes:()=>Wm,canKindle:()=>Mh,canPlay:()=>Uh,canUseArt:()=>kh,cardData:()=>Vm,cardPool:()=>Jm,claimBossRelic:()=>uh,claimMonument:()=>Km,claimTreasure:()=>ch,clamp:()=>Pm,clearSave:()=>lg,drawCards:()=>zh,duplicateCardInDeck:()=>ig,effCost:()=>Hh,endTurn:()=>Jh,enemyMove:()=>wh,finalizeNodeEventChoice:()=>sh,gainEmbers:()=>Th,gainPotion:()=>dh,gainRelic:()=>Zm,genCombatRewards:()=>mh,genMap:()=>Um,genShop:()=>gh,hasRelic:()=>qm,healPlayer:()=>Xm,kindleFromHand:()=>Ph,loadRun:()=>cg,loadStats:()=>ug,makeCard:()=>Bm,makeRng:()=>jm,newRun:()=>Fm,nodeEventInFlight:()=>oh,nodeRewardClaimed:()=>ah,omenMods:()=>Rm,playCard:()=>Wh,previewAttack:()=>Zh,previewBlock:()=>Qh,previewEnemyDmg:()=>$h,previewPlay:()=>eg,randomRelic:()=>Qm,recordRunEnd:()=>dg,relicPool:()=>Ym,removeCardFromDeck:()=>ng,restHealFrac:()=>zm,rollBossRelics:()=>hh,rollCardReward:()=>fh,rollEncounter:()=>vh,rollEvent:()=>_h,rollEventCards:()=>ph,rollOmen:()=>Lm,runRng:()=>Hm,saveRun:()=>sg,startCombat:()=>yh,upgradeCardInDeck:()=>rg,useArt:()=>Ah,usePotion:()=>qh,visitNode:()=>Gm,vowMods:()=>Im});function jm(e){let t=()=>{e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296};return t.getState=()=>e,t}var Mm=(e,t)=>t[Math.floor(e()*t.length)],Nm=(e,[t,n])=>t+Math.floor(e()*(n-t+1)),Pm=(e,t,n)=>Math.max(t,Math.min(n,e));function Fm(e=Math.random()*2**31|0,t={}){let n=Pm(t.aspect||0,0,Wu.length-1),r=Wu[n],i={v:2,seed:e,rngState:e,uid:1,act:0,nodeId:null,floorsClimbed:0,bossRelicAct:-1,orphanRewardClaimed:!1,orphanRewardResolving:!1,aspect:n,vow:Pm(t.vow||0,0,Gu.length),art:t.art||r.art||`flare`,omens:[],boon:t.boon||null,unlocks:[...t.unlocks||[]],monument:t.monument?{...t.monument,claimed:!1}:null,player:{hp:r.maxHp,maxHp:r.maxHp,gold:r.startGold,energyMax:r.energy,relics:[r.startRelic],potions:Array(r.potionSlots||3).fill(null),deck:[]},stats:{slain:0,elites:0,bosses:0,dmgDealt:0,dmgTaken:0,cardsPlayed:0,goldEarned:0,shatters:0,kindles:0,perfects:0,smolderKills:0,unlitVisited:0,embersSpent:0,start:Date.now()},map:null};t.lamplighter&&(i.pendingLamplighter=!0);for(let e of r.startDeck)i.player.deck.push(Bm(i,e));return Im(i).startHex&&i.player.deck.push(Bm(i,`hex`)),i.omens.push(Lm(i)),i.map=Um(i),i}function Im(e){let t={hpMult:1,enemyDmgBonus:0,bossFacetDelta:0,startHex:!1},n=Pm(e.vow||0,0,Gu.length);for(let e=0;e<n;e++){let n=Gu[e].mods;n.hpMult&&(t.hpMult*=n.hpMult),n.enemyDmgBonus&&(t.enemyDmgBonus+=n.enemyDmgBonus),n.bossFacetDelta&&(t.bossFacetDelta+=n.bossFacetDelta),n.startHex&&(t.startHex=!0),n.restHealFrac!=null&&(t.restHealFrac=Math.min(t.restHealFrac??1,n.restHealFrac))}return t}function Lm(e){return Mm(Hm(e),Object.keys(Bu))}function Rm(e){return Bu[e.omens?.[e.act]]?.mods||{}}function zm(e){return Math.min(.3,Rm(e).restHealFrac??.3,Im(e).restHealFrac??.3)}function Bm(e,t,n=!1){return{uid:e.uid++,id:t,up:n,bonus:0}}function Vm(e){let t=ku[e.id];return e.up&&t.up?{...t,...t.up,name:t.name+`+`}:t}function Hm(e){let t=jm(e.rngState);return()=>{let n=t();return e.rngState=t.getState(),n}}function Um(e){let t=Hm(e),n={},r=(e,t)=>`${e},${t}`,i=(e,i)=>(n[r(e,i)]||(n[r(e,i)]={id:r(e,i),row:e,col:i,type:`monster`,next:[],jx:(t()-.5)*.5,jy:(t()-.5)*.4}),n[r(e,i)]),a=new Set;for(let e=0;e<6;e++){let n;do n=Math.floor(t()*7);while(e<2&&a.has(n));a.add(n);let r=i(0,n);for(let e=1;e<14;e++){let n=Pm(r.col+(Math.floor(t()*3)-1),0,6),a=i(e,n);r.next.includes(a.id)||r.next.push(a.id),r=a}let o=i(14,3);r.next.includes(o.id)||r.next.push(o.id)}let o=Object.values(n),s=!1;for(let e of o){if(e.row===0)e.type=`monster`;else if(e.row===14)e.type=`boss`;else if(e.row===13)e.type=`rest`;else if(e.row===8)e.type=`treasure`;else{let n=t();n<.46?e.type=`monster`:n<.68?e.type=`event`:n<.81&&e.row>=5?e.type=`elite`:n<.91&&e.row>=4&&e.row<12?e.type=`rest`:e.row>=4?e.type=`shop`:e.type=`monster`}e.type===`shop`&&(s=!0)}if(!s){let e=o.filter(e=>e.type===`monster`&&e.row>=5&&e.row<=11);e.length&&(Mm(t,e).type=`shop`)}for(let n of o)n.row===0||n.row===8||n.row>=13||t()<.15&&(n.unlit=!0,n.bounty=Nm(t,[12,22])+e.act*6);if(e.monument&&!e.monument.claimed&&e.monument.act===e.act){let t=Pm(e.monument.row||5,1,12),n=o.filter(e=>e.type===`shop`).length===1,r=o.filter(e=>e.row>0&&e.row<13&&e.row!==8&&e.type!==`boss`&&!(n&&e.type===`shop`));if(r.length){let e=r.reduce((e,n)=>Math.abs(n.row-t)<Math.abs(e.row-t)?n:e);e.type=`monument`,delete e.unlit,delete e.bounty}}return{nodes:o,visited:[]}}function Wm(e){let{nodes:t,visited:n}=e.map;if(!e.nodeId)return t.filter(e=>e.row===0);let r=t.find(t=>t.id===e.nodeId);return t.filter(e=>r.next.includes(e.id))}function Gm(e,t){e.nodeId=t.id,e.orphanRewardClaimed&&=(t.rewardClaimed=!0,!1),e.orphanRewardResolving&&=(t.rewardResolving=!0,!1),e.floorsClimbed=t.row+1,e.map.visited.includes(t.id)||e.map.visited.push(t.id);let n=0;return t.unlit&&(delete t.unlit,n=(t.bounty||0)*(qm(e,`thiefOfWicks`)?2:1),delete t.bounty,e.player.gold+=n,e.stats.goldEarned+=n,e.stats.unlitVisited++),{type:t.type,bounty:n}}function Km(e){let t=e.monument;if(!t||t.claimed||!t.bequest)return null;t.claimed=!0;let n=t.bequest;return n.kind===`card`?tg(e,n.id,n.up):n.kind===`relic`?Zm(e,n.id):n.kind===`gold`&&(e.player.gold+=n.amount,e.stats.goldEarned+=n.amount),n}var qm=(e,t)=>e.player.relics.includes(t);function Jm(e,t){let n=(e.unlocks||[]).filter(e=>e.startsWith(`card:`)).map(e=>e.slice(5)).filter(e=>ku[e]&&ku[e].rarity===t);return n.length?[...Au[t],...n]:Au[t]}function Ym(e,t){let n=(e.unlocks||[]).filter(e=>e.startsWith(`relic:`)).map(e=>e.slice(6)).filter(e=>Mu[e]&&Mu[e].rarity===t);return n.length?[...Nu[t],...n]:Nu[t]}function Xm(e,t,n=null){qm(e,`sunBlossom`)&&(t=Math.round(t*1.5));let r=n?n.player:e.player,i=r.hp;r.hp=Pm(r.hp+t,0,r.maxHp);let a=r.hp-i;return n&&a>0&&n.queue.push({t:`heal`,who:`player`,n:a}),a}function Zm(e,t,n=null){let r=Mu[t];if(r){if(r.replaces){let t=e.player.relics.indexOf(r.replaces);t>=0&&e.player.relics.splice(t,1)}e.player.relics.push(t),t===`sweetRoot`&&(e.player.maxHp+=8,e.player.hp+=8),t===`hollowCrown`&&(e.player.energyMax+=1,e.player.maxHp=Math.max(1,e.player.maxHp-10),e.player.hp=Math.min(e.player.hp,e.player.maxHp))}}function Qm(e,t={common:.5,uncommon:.35,rare:.15}){let n=Hm(e),r=new Set(e.player.relics),i=[`common`,`uncommon`,`rare`],a=n(),o=`common`,s=0;for(let e of i)if(s+=t[e]||0,a<s){o=e;break}let c=i.indexOf(o);for(let t=0;t<i.length;t++){let a=i[(c+t)%i.length],o=Ym(e,a).filter(e=>!r.has(e));if(o.length)return Mm(n,o)}return null}function $m(e){return!e.nodeId||!e.map?.nodes?null:e.map.nodes.find(t=>t.id===e.nodeId)||null}function eh(e){let t=$m(e);return t?!!t.rewardClaimed:!!e.orphanRewardClaimed}function th(e){let t=$m(e);return t?!!t.rewardResolving:!!e.orphanRewardResolving}function nh(e){return eh(e)||th(e)}function rh(e){let t=$m(e);t?t.rewardResolving=!0:e.orphanRewardResolving=!0}function ih(e){let t=$m(e);t?(t.rewardClaimed=!0,delete t.rewardResolving):(e.orphanRewardClaimed=!0,e.orphanRewardResolving=!1)}function ah(e){return eh(e)}function oh(e){return th(e)}function sh(e){ih(e)}function ch(e,t={common:.55,uncommon:.35,rare:.1}){if(eh(e))return{already:!0,relicId:null,gold:0};let n=Qm(e,t);return n?Zm(e,n):e.player.gold+=60,ih(e),{already:!1,relicId:n,gold:n?0:60}}function lh(e,t,n=Hm(e)){if(nh(e))return{pending:[],log:[],already:!0};let{pending:r,log:i}=fg(e,t,n);return rh(e),{pending:r,log:i,already:!1}}function uh(e,t){return e.bossRelicAct===e.act?{already:!0,id:null}:(e.bossRelicAct=e.act,t&&Zm(e,t),{already:!1,id:t||null})}function dh(e,t){t===`random`&&(t=Mm(Hm(e),Object.keys(Pu)));let n=e.player.potions.indexOf(null);return n<0?!1:(e.player.potions[n]=t,!0)}function fh(e,t=`normal`){let n=Hm(e),r=3+ +!!qm(e,`seersOrb`)+(Rm(e).rewardChoiceBonus||0),i=[],a=new Set;for(;i.length<r&&a.size<40;){let r;if(t===`boss`)r=`rare`;else{let e=n();r=t===`elite`?e<.45?`common`:e<.85?`uncommon`:`rare`:e<.6?`common`:e<.92?`uncommon`:`rare`}let o=Mm(n,Jm(e,r));a.add(o+Math.floor(n()*4)),i.includes(o)||i.push(o)}return i}function ph(e,t){let n=Hm(e),r=[...Jm(e,`common`),...Jm(e,`common`),...Jm(e,`uncommon`),...Jm(e,`uncommon`),...Jm(e,`rare`)],i=[],a=0;for(;i.length<t&&a++<60;){let e=r[Math.floor(n()*r.length)];i.includes(e)||i.push(e)}return i}function mh(e,t,n=null){let r=Hm(e),i=Nm(r,Ru[e.act][t===`boss`?`boss`:t===`elite`?`elite`:`normal`]);i=Math.round(i*(Rm(e).goldMult||1)*(Vu[n]?.mods.goldMult||1));let a={gold:i,cards:fh(e,t),potion:null,relic:null};return t!==`boss`&&r()<.4&&(a.potion=Mm(r,Object.keys(Pu))),t===`elite`&&(a.relic=Qm(e)),a}function hh(e){let t=Hm(e),n=new Set(e.player.relics),r=Ym(e,`boss`).filter(e=>!n.has(e)),i=[];for(;i.length<Math.min(3,r.length);){let e=Mm(t,r);i.includes(e)||i.push(e)}return i}function gh(e){let t=Hm(e),n=([e,n],r)=>Math.round(Nm(t,[e,n])*r),r=(qm(e,`merchantsMark`)?.75:1)*(Rm(e).shopMult||1),i=[];for(let a of[`common`,`common`,`uncommon`,`uncommon`,`rare`]){let o,s=0;do o=Mm(t,Jm(e,a));while(i.some(e=>e.id===o)&&++s<20);i.push({id:o,price:n(zu.cardPrice[a],r),sold:!1})}let a=new Set(e.player.relics),o=[];for(let i of[`common`,`uncommon`]){let s=Ym(e,i).filter(e=>!a.has(e)&&!o.some(t=>t.id===e));s.length&&o.push({id:Mm(t,s),price:n(zu.relicPrice[i],r),sold:!1})}let s=[];for(let e=0;e<2;e++)s.push({id:Mm(t,Object.keys(Pu)),price:n(zu.potionPrice,r),sold:!1});return{cards:i,relics:o,potions:s,removeCost:Math.round(zu.removeCost*r),removed:!1}}function _h(e){let t=Hm(e),n=e.seenEvents||=[],r=Object.keys(Lu).filter(e=>!n.includes(e));r.length||(e.seenEvents=[],r=Object.keys(Lu));let i=Mm(t,r);return n.push(i),i}function vh(e,t,n){let r=Hm(e),i=Iu[e.act],a=t===`boss`?i.boss:t===`elite`?i.elite:n<3?i.weak:i.normal,o=e.lastEnc,s,c=0;do s=Mm(r,a);while(a.length>1&&s.join()===o&&++c<8);return e.lastEnc=s.join(),s}function yh(e,t,n=`normal`,r={}){let i=Hm(e),a=Rm(e),o=Im(e),s=n===`elite`?r.affix||Mm(i,Object.keys(Vu)):null,c=s?Vu[s].mods:{},l={kind:n,affix:s,turn:0,over:!1,result:null,queue:[],player:{hp:e.player.hp,maxHp:e.player.maxHp,block:0,energy:0,energyMax:e.player.energyMax,statuses:{}},enemies:t.map((e,t)=>{let n=Fu[e];return{key:e,idx:t,name:n.name,maxHp:Math.round(Nm(i,n.hp)*(a.hpMult||1)*(c.hpMult||1)*(o.hpMult||1)),block:c.startBlock||0,statuses:{...n.startStatus||{}},flags:c.adamant?{adamant:!0}:{},lastMoves:[],moveKey:null,elite:!!n.elite,boss:!!n.boss,facetMax:Math.max(2,(n.facets??(n.boss?6:n.elite?5:4))+(a.facetDelta||0)+(c.facetDelta||0)+(n.boss&&o.bossFacetDelta||0)),chips:0}}),draw:[],hand:[],discard:[],exhaust:[],embers:0,emberCap:9,artUsedTurn:0,kindledTurn:0,kindlesThisTurn:0,pendingChips:null,counters:{played:0,attacks:0,firstCardPlayed:!1,hpLost:0}};l.enemies.forEach(e=>e.hp=e.maxHp);for(let e of l.enemies)for(let[t,n]of Object.entries({...a.enemyStartStatus||{},...c.startStatus||{}}))e.statuses[t]=(e.statuses[t]||0)+n;a.startEmbers&&(l.embers=Pm(a.startEmbers,0,l.emberCap)),l.draw=e.player.deck.map(e=>({...e,bonus:0})),bh(i,l.draw);let u=l.player;return qm(e,`basaltIdol`)&&(u.block+=10,xh(l,`basaltIdol`)),qm(e,`warFetish`)&&(Sh(l,u,`str`,1),xh(l,`warFetish`)),qm(e,`riverPearl`)&&(Sh(l,u,`dex`,1),xh(l,`riverPearl`)),qm(e,`thornBand`)&&(Sh(l,u,`thorns`,2),xh(l,`thornBand`)),qm(e,`vialOfLife`)&&(Xm(e,2,l),xh(l,`vialOfLife`)),qm(e,`crownOfCinders`)&&(l.emberCap=12,l.embers=Pm(l.embers+2,0,l.emberCap),xh(l,`crownOfCinders`)),qm(e,`shatterersCrown`)&&(l.enemies.forEach(e=>{e.facetMax=Math.max(2,e.facetMax-1),e.statuses.str=(e.statuses.str||0)+1}),xh(l,`shatterersCrown`)),qm(e,`smolderingCoal`)&&(l.enemies.forEach(e=>e.statuses.poison=(e.statuses.poison||0)+2),xh(l,`smolderingCoal`)),qm(e,`ashenCore`)&&(l.enemies.forEach(e=>e.statuses.poison=(e.statuses.poison||0)+3),xh(l,`ashenCore`)),Ch(e,l),Vh(e,l),l}function bh(e,t){for(let n=t.length-1;n>0;n--){let r=Math.floor(e()*(n+1));[t[n],t[r]]=[t[r],t[n]]}}function xh(e,t){e.queue.push({t:`relicProc`,id:t})}function Sh(e,t,n,r){t.statuses[n]=(t.statuses[n]||0)+r,t.statuses[n]===0&&delete t.statuses[n],e.queue.push({t:`status`,who:t===e.player?`player`:t.idx,id:n,n:r})}function Ch(e,t){let n=Hm(e);for(let e of t.enemies)e.hp<=0||(e.moveKey=Fu[e.key].ai({turn:t.turn+1,last:e.lastMoves[e.lastMoves.length-1],prev:e.lastMoves[e.lastMoves.length-2],rng:n,hpFrac:e.hp/e.maxHp,self:e}),t.queue.push({t:`intent`,idx:e.idx,move:e.moveKey}))}function wh(e){return Fu[e.key].moves[e.moveKey]}function Th(e,t,n){let r=Pm(t.embers+n,0,t.emberCap),i=r-t.embers;return i?(t.embers=r,t.queue.push({t:`ember`,n:i,total:t.embers}),i):0}function Eh(e,t,n,r){if(!(t.over||n.hp<=0||r<=0))for(n.chips+=r,t.queue.push({t:`chip`,idx:n.idx,n:r,chips:Math.min(n.chips,n.facetMax),facetMax:n.facetMax});n.chips>=n.facetMax&&n.hp>0;)n.chips-=n.facetMax,Dh(e,t,n)}function Dh(e,t,n){if(n.facetMax+=1,n.flags.adamant&&!n.flags.adamantSpent){n.flags.adamantSpent=!0,t.queue.push({t:`adamantHold`,idx:n.idx});return}e.stats.shatters++,n.flags.staggered=!0,t.queue.push({t:`shatter`,idx:n.idx,facetMax:n.facetMax}),Sh(t,n,`vulnerable`,2),Th(e,t,2),qm(e,`prismCharm`)&&!t.prismProcd&&(t.prismProcd=!0,Th(e,t,2),xh(t,`prismCharm`));let r=n.statuses.poison||0;if(r&&t.enemies.some(e=>e!==n&&e.hp>0)&&(delete n.statuses.poison,Oh(e,t,n,r)),qm(e,`bellOfEndings`)){xh(t,`bellOfEndings`);for(let r of t.enemies.filter(e=>e!==n&&e.hp>0)){if(t.over)break;Fh(e,t,r,4,{isAttack:!1})}}}function Oh(e,t,n,r){if(!r)return;let i=t.enemies.filter(e=>e!==n&&e.hp>0);if(!i.length)return;let a=Mm(Hm(e),i);Sh(t,a,`poison`,r),t.queue.push({t:`smolderJump`,from:n.idx,to:a.idx,n:r})}function kh(e,t){let n=Hu[e.art];return!!n&&!t.over&&t.artUsedTurn!==t.turn&&t.embers>=n.cost}function Ah(e,t){if(!kh(e,t))return!1;let n=Hu[e.art];t.artUsedTurn=t.turn,e.stats.embersSpent+=n.cost,Th(e,t,-n.cost),t.queue.push({t:`art`,id:e.art});for(let r of n.effects){if(t.over)break;jh(e,t,r)}return!0}function jh(e,t,n){let r=t.player,i=()=>t.enemies.filter(e=>e.hp>0);switch(n.kind){case`dmg`:for(let r of i())t.over||Fh(e,t,r,n.n,{isAttack:!1});break;case`status`:if(n.who===`self`)Sh(t,r,n.id,n.n);else for(let e of i())Sh(t,e,n.id,n.n);break;case`block`:Rh(e,t,r,n.n,!1);break;case`heal`:Xm(e,n.n,t);break;case`energy`:r.energy+=n.n,t.queue.push({t:`energy`,n:r.energy});break;case`draw`:zh(e,t,n.n);break;case`chip`:for(let r of i())Eh(e,t,r,n.n);break;case`ember`:Th(e,t,n.n);break}}function Mh(e,t,n){return!n||t.over||Vm(n).type===`curse`?!1:!(t.kindledTurn===t.turn&&t.kindlesThisTurn>=Nh(e))}function Nh(e){return qm(e,`crownOfTithes`)?2:1}function Ph(e,t,n){let r=t.hand.findIndex(e=>e.uid===n);if(r<0)return!1;let i=t.hand[r];return Mh(e,t,i)?(t.kindledTurn!==t.turn&&(t.kindledTurn=t.turn,t.kindlesThisTurn=0),t.kindlesThisTurn++,t.hand.splice(r,1),e.stats.kindles++,t.queue.push({t:`kindle`,uid:i.uid,id:i.id}),Bh(e,t,i),qm(e,`crownOfTithes`)&&(Rh(e,t,t.player,3,!1),xh(t,`crownOfTithes`)),!0):!1}function Fh(e,t,n,r,{isAttack:i=!0,mult:a=1}={}){if(n.hp<=0||t.over)return 0;let o=t.player,s=r;i&&(s+=o.statuses.str||0,o.statuses.weak&&(s=Math.floor(s*.75)),n.statuses.vulnerable&&(s=Math.floor(s*1.5))),s=Math.max(0,Math.floor(s*a));let c=Math.min(n.block,s);n.block-=c;let l=s-c;if(n.hp-=l,e.stats.dmgDealt+=l,t.queue.push({t:`hitEnemy`,idx:n.idx,amount:l,blocked:c,hpAfter:Math.max(0,n.hp),dead:n.hp<=0,killingBlow:n.hp<=0&&l>0,overkill:Math.max(0,-n.hp)}),t.pendingChips&&i&&l>0){let e=t.pendingChips.get(n.idx)||{hit:!1,extra:0};e.hit=!0,t.pendingChips.set(n.idx,e)}return i&&n.statuses.thorns&&n.hp>0&&Lh(e,t,n.statuses.thorns,{source:`thorns`,isAttack:!1}),n.hp<=0&&Ih(e,t,n),l}function Ih(e,t,n){n.hp=0;let r=n.statuses.poison||0;if(n.statuses={},n.flags.staggered=!1,t.queue.push({t:`die`,idx:n.idx}),e.stats.slain++,n.elite&&e.stats.elites++,n.boss&&e.stats.bosses++,t.enemies.every(e=>e.hp<=0)){Yh(e,t);return}Th(e,t,1),Oh(e,t,n,r),qm(e,`reapersBell`)&&(t.player.energy+=1,zh(e,t,1),xh(t,`reapersBell`),t.queue.push({t:`energy`,n:t.player.energy}))}function Lh(e,t,n,{source:r=`self`,isAttack:i=!1,attacker:a=null}={}){if(t.over)return 0;let o=t.player,s=n;i&&a&&(s+=(a.statuses.str||0)+(a.flags.rampBonus||0)+(Rm(e).enemyDmgBonus||0)+(Im(e).enemyDmgBonus||0),a.statuses.weak&&(s=Math.floor(s*.75)),o.statuses.vulnerable&&(s=Math.floor(s*1.5)),qm(e,`wardingCharm`)&&s<=5&&s>0&&(s=1,xh(t,`wardingCharm`))),s=Math.max(0,s);let c=0;(i||r===`thorns`)&&(c=Math.min(o.block,s),o.block-=c);let l=s-c;if(o.hp-=l,e.stats.dmgTaken+=Math.max(0,l),t.counters.hpLost+=Math.max(0,l),t.queue.push({t:`hitPlayer`,amount:l,blocked:c,hpAfter:Math.max(0,o.hp),source:r}),o.hp<=0)return Xh(e,t),l;if(i&&a){let n={...Rm(e).playerHitApplies||{},...t.affix&&Vu[t.affix].mods.attackApplies||{}};for(let[e,r]of Object.entries(n))Sh(t,o,e,r);o.statuses.thorns&&a.hp>0&&Fh(e,t,a,o.statuses.thorns,{isAttack:!1})}return l}function Rh(e,t,n,r,i=!0){let a=r;return n===t.player&&i&&(a+=n.statuses.dex||0,n.statuses.frail&&(a=Math.floor(a*.75))),a=Math.round(Math.max(0,a)*(Rm(e).wardMult||1)),n.block+=a,t.queue.push({t:`blockGain`,who:n===t.player?`player`:n.idx,n:a,total:n.block}),a}function zh(e,t,n){let r=Hm(e);for(let e=0;e<n&&!(t.hand.length>=10);e++){if(!t.draw.length){if(!t.discard.length)break;t.draw=t.discard,t.discard=[],bh(r,t.draw),t.queue.push({t:`reshuffle`})}let e=t.draw.pop();t.hand.push(e),t.queue.push({t:`draw`,uid:e.uid,id:e.id})}}function Bh(e,t,n){t.exhaust.push(n),t.queue.push({t:`exhaust`,uid:n.uid}),Th(e,t,1),qm(e,`verdantBranch`)&&(zh(e,t,1),xh(t,`verdantBranch`))}function Vh(e,t){if(t.over)return;t.turn++;let n=t.player;if(t.queue.push({t:`turn`,n:t.turn}),n.statuses.poison&&(Lh(e,t,n.statuses.poison,{source:`poison`}),n.statuses.poison--,n.statuses.poison||delete n.statuses.poison,t.over))return;n.statuses.barricade||(n.block=0),n.statuses.ritual&&Sh(t,n,`str`,n.statuses.ritual),n.statuses.emberflow&&Th(e,t,n.statuses.emberflow);let r=n.energyMax+(n.statuses.energized||0);t.turn===1&&qm(e,`emberLantern`)&&(r+=1,xh(t,`emberLantern`)),n.energy=(qm(e,`frozenCore`)?n.energy:0)+r,t.counters.firstCardPlayed=!1,t.queue.push({t:`energy`,n:n.energy});let i=5+(n.statuses.nightsight||0)+(Rm(e).drawDelta||0);t.turn===1&&qm(e,`travelersPack`)&&(i+=2,xh(t,`travelersPack`)),zh(e,t,Math.max(1,i))}function Hh(e,t,n){let r=Vm(n);return r.cost==null?null:qm(e,`duskmirror`)&&!t.counters.firstCardPlayed?0:Rm(e).firstCardDiscount&&!t.counters.firstCardPlayed?Math.max(0,r.cost-Rm(e).firstCardDiscount):r.cost}function Uh(e,t,n,r){if(t.over)return!1;let i=Vm(n);return!(i.unplayable||Hh(e,t,n)>t.player.energy||i.target===`enemy`&&(r==null||!t.enemies[r]||t.enemies[r].hp<=0))}function Wh(e,t,n,r=null){let i=t.hand.findIndex(e=>e.uid===n);if(i<0)return!1;let a=t.hand[i],o=Vm(a);if(!Uh(e,t,a,r))return!1;let s=t.player,c=Hh(e,t,a);s.energy-=c,qm(e,`duskmirror`)&&!t.counters.firstCardPlayed&&o.cost>0&&xh(t,`duskmirror`),t.counters.firstCardPlayed=!0,t.hand.splice(i,1),t.counters.played++,e.stats.cardsPlayed++,t.queue.push({t:`play`,uid:a.uid,id:a.id,targetIdx:r}),t.queue.push({t:`energy`,n:s.energy});let l=1;o.type===`attack`&&(t.counters.attacks++,qm(e,`ironTalisman`)&&t.counters.attacks%3==0&&(Sh(t,s,`str`,1),xh(t,`ironTalisman`)),qm(e,`executionersSeal`)&&t.counters.attacks%10==0&&(l=2,xh(t,`executionersSeal`)));let u=r==null?null:t.enemies[r],d=()=>t.enemies.filter(e=>e.hp>0);t.pendingChips=new Map;for(let n of o.effects){if(t.over)break;Gh(e,t,a,o,n,u,l)}if(t.pendingChips&&!t.over){let n=o.type===`attack`?1+(o.chip||0)+(s.statuses.beacon||0):0;for(let[r,i]of t.pendingChips){let a=t.enemies[r];if(!a||a.hp<=0||t.over)continue;let o=(i.hit?n:0)+i.extra;o>0&&Eh(e,t,a,o)}}if(t.pendingChips=null,!t.over&&o.type===`attack`&&s.statuses.venomous){let e=o.target===`allEnemies`?d():u&&u.hp>0?[u]:[];for(let n of e)Sh(t,n,`poison`,s.statuses.venomous)}return!t.over&&qm(e,`silkFan`)&&t.counters.played%3==0&&(Rh(e,t,s,3,!1),xh(t,`silkFan`)),o.type===`power`?t.queue.push({t:`powerConsumed`,uid:a.uid}):o.exhaust?Bh(e,t,a):t.discard.push(a),!0}function Gh(e,t,n,r,i,a,o){let s=t.player,c=r.target===`allEnemies`?t.enemies.filter(e=>e.hp>0):a?[a]:[];switch(i.kind){case`dmg`:{let n=i.times||1;for(let a=0;a<n;a++)for(let n of r.target===`allEnemies`?t.enemies.filter(e=>e.hp>0):c){if(t.over)return;Fh(e,t,n,i.n,{mult:o})}break}case`block`:Rh(e,t,s,i.n);break;case`draw`:zh(e,t,i.n);break;case`energy`:s.energy+=i.n,t.queue.push({t:`energy`,n:s.energy});break;case`heal`:Xm(e,i.n,t);break;case`loseHp`:Lh(e,t,i.n,{source:`self`});break;case`status`:if(i.who===`self`)Sh(t,s,i.id,i.n);else if(i.who===`allEnemies`)for(let e of t.enemies.filter(e=>e.hp>0))Sh(t,e,i.id,i.n);else a&&a.hp>0&&Sh(t,a,i.id,i.n);break;case`addCard`:for(let n=0;n<(i.n||1);n++){let n={uid:e.uid++,id:i.id,up:!1,bonus:0};(i.where===`hand`&&t.hand.length<10?t.hand:t.discard).push(n),t.queue.push({t:`addCard`,id:i.id,where:i.where||`discard`})}break;case`chip`:for(let n of c)if(!(n.hp<=0))if(t.pendingChips){let e=t.pendingChips.get(n.idx)||{hit:!1,extra:0};e.extra+=i.n,t.pendingChips.set(n.idx,e)}else Eh(e,t,n,i.n);break;case`ember`:Th(e,t,i.n);break;case`special`:Kh(e,t,n,r,i,a,o)}}function Kh(e,t,n,r,i,a,o){let s=t.player;switch(i.id){case`leech`:{let n=Fh(e,t,a,i.n,{mult:o});n>0&&Xm(e,Math.floor(n/2),t);break}case`execute`:{let n=a.statuses.vulnerable?i.bonus:0;Fh(e,t,a,i.n+n,{mult:o});break}case`momentum`:Fh(e,t,a,i.n+n.bonus,{mult:o}),n.bonus+=i.grow;break;case`phantom`:Fh(e,t,a,i.n*t.hand.length,{mult:o});break;case`devour`:Fh(e,t,a,i.n,{mult:o}),a.hp<=0&&(t.over?Xm(e,i.heal):(Th(e,t,i.embers),Xm(e,i.heal,t)));break;case`doubleBlock`:Rh(e,t,s,s.block,!1);break;case`catalyst`:a.statuses.poison&&Sh(t,a,`poison`,a.statuses.poison*(i.n-1));break;case`shatterEcho`:{let n=a.flags.staggered||a.statuses.vulnerable?2:1;Fh(e,t,a,i.n*n,{mult:o});break}case`emberNova`:Fh(e,t,a,i.n*t.embers,{mult:o});break;case`pyreTithe`:for(let r of[...t.hand]){if(r===n)continue;let i=t.hand.indexOf(r);t.hand.splice(i,1),t.queue.push({t:`kindle`,uid:r.uid,id:r.id}),Bh(e,t,r)}zh(e,t,i.draw);break;case`flawless`:Rh(e,t,s,i.n),t.counters.hpLost===0&&Rh(e,t,s,i.n);break;case`emberdance`:{let n=t.embers;n>0&&(e.stats.embersSpent+=n,Th(e,t,-n),Rh(e,t,s,i.n*n,!1));break}}}function qh(e,t,n,r=null){let i=e.player.potions[n];if(!i)return!1;let a=Pu[i];if(a.combatOnly&&(!t||t.over)||a.needsTarget&&(r==null||!t.enemies[r]||t.enemies[r].hp<=0))return!1;switch(e.player.potions[n]=null,t&&t.queue.push({t:`potion`,id:i}),i){case`healing`:Xm(e,20,t),t||(e.player.hp=Pm(e.player.hp,0,e.player.maxHp));break;case`strength`:Sh(t,t.player,`str`,2);break;case`swift`:zh(e,t,3);break;case`block`:Rh(e,t,t.player,12,!1);break;case`fire`:Fh(e,t,t.enemies[r],20,{isAttack:!1});break;case`venom`:Sh(t,t.enemies[r],`poison`,7);break;case`energy`:Th(e,t,3);break}return!0}function Jh(e,t){if(t.over)return;let n=t.player;t.queue.push({t:`endTurn`});for(let n of[...t.hand]){let r=Vm(n);if(r.endTurnDmg&&Lh(e,t,r.endTurnDmg,{source:`burn`}),r.endTurnLoseHp&&Lh(e,t,r.endTurnLoseHp,{source:`burn`}),t.over)return}n.statuses.metallicize&&Rh(e,t,n,n.statuses.metallicize,!1),n.statuses.regen&&Xm(e,n.statuses.regen,t),t.discard.push(...t.hand),t.hand=[],t.queue.push({t:`discardHand`});for(let e of[`vulnerable`,`weak`,`frail`,`beacon`])n.statuses[e]&&(n.statuses[e]--,n.statuses[e]||delete n.statuses[e]);for(let r of t.enemies)if(!(r.hp<=0||t.over)){if(r.statuses.poison){let n=r.statuses.poison;if(r.hp-=n,e.stats.dmgDealt+=n,t.queue.push({t:`hitEnemy`,idx:r.idx,amount:n,blocked:0,hpAfter:Math.max(0,r.hp),dead:r.hp<=0,poison:!0}),r.statuses.poison--,r.statuses.poison||delete r.statuses.poison,r.hp<=0){e.stats.smolderKills++,Ih(e,t,r);continue}}if(r.block=0,r.flags.staggered)r.flags.staggered=!1,r.lastMoves.push(r.moveKey),t.queue.push({t:`staggered`,idx:r.idx});else{let i=wh(r);if(t.queue.push({t:`enemyAct`,idx:r.idx,move:r.moveKey,name:i.name}),r.lastMoves.push(r.moveKey),i.dmg!=null){for(let n=0;n<(i.times||1)&&!t.over;n++)Lh(e,t,i.dmg,{source:r.idx,isAttack:!0,attacker:r});i.ramp&&(r.flags.rampBonus=(r.flags.rampBonus||0)+i.ramp)}if(t.over)return;if(i.block&&Rh(e,t,r,i.block,!1),i.heal&&(r.hp=Math.min(r.maxHp,r.hp+i.heal),t.queue.push({t:`heal`,who:r.idx,n:i.heal})),i.fx){for(let e of i.fx)if(e.who===`player`)Sh(t,n,e.id,e.n);else if(e.who===`self`)Sh(t,r,e.id,e.n);else if(e.who===`allies`)for(let n of t.enemies.filter(e=>e.hp>0))Sh(t,n,e.id,e.n)}if(i.addCards)for(let n=0;n<i.addCards.n;n++)t.discard.push({uid:e.uid++,id:i.addCards.id,up:!1,bonus:0}),t.queue.push({t:`addCard`,id:i.addCards.id,where:`discard`})}r.statuses.ritual&&Sh(t,r,`str`,r.statuses.ritual);for(let e of[`vulnerable`,`weak`])r.statuses[e]&&(r.statuses[e]--,r.statuses[e]||delete r.statuses[e])}t.over||(Ch(e,t),Vh(e,t))}function Yh(e,t){t.over=!0,t.result=`win`,e.player.hp=Pm(t.player.hp,1,e.player.maxHp),qm(e,`emberHeart`)&&(Xm(e,6),xh(t,`emberHeart`)),qm(e,`crownOfTheHearth`)&&t.embers>0&&(Xm(e,t.embers*3),xh(t,`crownOfTheHearth`)),qm(e,`gravebloom`)&&e.player.hp<=e.player.maxHp*.5&&(Xm(e,10),xh(t,`gravebloom`)),e.player.hp=Pm(e.player.hp,1,e.player.maxHp),t.queue.push({t:`victory`,perfect:t.counters.hpLost===0})}function Xh(e,t){t.over=!0,t.result=`loss`,t.player.hp=0,e.player.hp=0,t.queue.push({t:`defeat`})}function Zh(e,t,n=null){let r=e.player,i=t+(r.statuses.str||0);r.statuses.weak&&(i=Math.floor(i*.75));let a=n==null?null:e.enemies[n];return a&&a.statuses.vulnerable&&(i=Math.floor(i*1.5)),Math.max(0,i)}function Qh(e,t,n){let r=t.player,i=n+(r.statuses.dex||0);return r.statuses.frail&&(i=Math.floor(i*.75)),Math.round(Math.max(0,i)*(Rm(e).wardMult||1))}function $h(e,t,n){let r=wh(n);if(r.dmg==null)return null;let i=r.dmg+(n.statuses.str||0)+(n.flags.rampBonus||0)+(Rm(e).enemyDmgBonus||0)+(Im(e).enemyDmgBonus||0);return n.statuses.weak&&(i=Math.floor(i*.75)),t.player.statuses.vulnerable&&(i=Math.floor(i*1.5)),{dmg:Math.max(0,i),times:r.times||1}}function eg(e,t,n,r=null){let i=Vm(n),a=t.player,o=r==null?null:t.enemies[r],s=qm(e,`executionersSeal`)&&i.type===`attack`&&(t.counters.attacks+1)%10==0?2:1,c=e=>{let t=e+(a.statuses.str||0);return a.statuses.weak&&(t=Math.floor(t*.75)),o&&o.statuses.vulnerable&&(t=Math.floor(t*1.5)),Math.max(0,Math.floor(t*s))},l=[],u=0;for(let r of i.effects)r.kind===`dmg`?l.push({dmg:c(r.n),times:r.times||1}):r.kind===`block`?u+=Qh(e,t,r.n):r.kind===`special`&&(r.id===`leech`||r.id===`devour`?l.push({dmg:c(r.n),times:1}):r.id===`execute`?l.push({dmg:c(r.n+(o?.statuses.vulnerable?r.bonus:0)),times:1}):r.id===`momentum`?l.push({dmg:c(r.n+(n.bonus||0)),times:1}):r.id===`phantom`?l.push({dmg:c(r.n*Math.max(0,t.hand.length-+!!t.hand.includes(n))),times:1}):r.id===`shatterEcho`?l.push({dmg:c(r.n*(o&&(o.flags.staggered||o.statuses.vulnerable)?2:1)),times:1}):r.id===`emberNova`?l.push({dmg:c(r.n*t.embers),times:1}):r.id===`doubleBlock`?u+=a.block:r.id===`flawless`?u+=Qh(e,t,r.n)*(t.counters.hpLost===0?2:1):r.id===`emberdance`&&(u+=r.n*t.embers));let d=0;for(let e of i.effects)e.kind===`chip`&&(d+=e.n);if(!l.length&&!u&&!d)return null;let f=l.reduce((e,t)=>e+t.dmg*t.times,0),p=f,m=!1,h=0,g=!1;if(o){let e=o.block;p=0;for(let t of l)for(let n=0;n<t.times;n++){let n=Math.min(e,t.dmg);e-=n,p+=t.dmg-n}m=p>=o.hp;let t=i.type===`attack`?1+(i.chip||0)+(a.statuses.beacon||0):0;h=(l.length&&p>0?t:0)+d,g=h>0&&o.chips+h>=o.facetMax&&!m}return{hits:l,total:f,loss:p,lethal:m,block:u,chips:h,willShatter:g}}function tg(e,t,n=!1){let r=Bm(e,t,n);return e.player.deck.push(r),r}function ng(e,t){let n=e.player.deck.findIndex(e=>e.uid===t);n>=0&&e.player.deck.splice(n,1)}function rg(e,t){let n=e.player.deck.find(e=>e.uid===t);n&&(n.up=!0)}function ig(e,t){let n=e.player.deck.find(e=>e.uid===t);n&&e.player.deck.push(Bm(e,n.id,n.up))}var ag=`spirebound_save_v2`,og=`spirebound_stats_v1`;function sg(e){try{localStorage.setItem(ag,JSON.stringify(e))}catch{}}function cg(){try{let e=localStorage.getItem(ag);if(!e)return null;let t=JSON.parse(e);if(!t||t.v!==2||!t.player||!t.map||!t.player.deck.every(e=>ku[e.id])||!t.player.relics.every(e=>Mu[e])||!t.player.potions.every(e=>e==null||Pu[e])||t.art!=null&&!Hu[t.art]||!(t.omens||[]).every(e=>Bu[e]))return null;for(t.art??=`flare`,t.aspect=Pm(t.aspect??0,0,Wu.length-1),t.vow=Pm(t.vow??0,0,Gu.length),t.unlocks??=[],t.omens??=[],t.boon??=null,t.bossRelicAct??=-1,t.orphanRewardClaimed??=!1,t.orphanRewardResolving??=!1;t.omens.length<=t.act;)t.omens.push(Lm(t));for(let e of[`shatters`,`kindles`,`perfects`,`smolderKills`,`unlitVisited`,`embersSpent`])t.stats[e]??=0;return t}catch{return null}}function lg(){try{localStorage.removeItem(ag),localStorage.removeItem(`spirebound_save_v1`)}catch{}}function ug(){try{return JSON.parse(localStorage.getItem(og))||{runs:0,wins:0,best:0}}catch{return{runs:0,wins:0,best:0}}}function dg(e,t){let n=ug();n.runs++,t&&n.wins++,n.best=Math.max(n.best,e.act*15+e.floorsClimbed);try{localStorage.setItem(og,JSON.stringify(n))}catch{}lg()}function fg(e,t,n=Hm(e)){let r=[],i=[];for(let a of t){if(a.gold&&(e.player.gold=Math.max(0,e.player.gold+a.gold),a.gold>0&&(e.stats.goldEarned+=a.gold)),a.hp&&(e.player.hp=Pm(e.player.hp+a.hp,1,e.player.maxHp)),a.maxHp&&(e.player.maxHp=Math.max(1,e.player.maxHp+a.maxHp),e.player.hp=Pm(e.player.hp+Math.max(0,a.maxHp),1,e.player.maxHp)),a.heal&&Xm(e,Math.round(e.player.maxHp*a.heal)),a.addCard&&tg(e,a.addCard),a.addRelic){let t=a.addRelic===`random`?Qm(e):a.addRelic;t?(Zm(e,t),i.push({relic:t})):(e.player.gold+=50,i.push({text:`You find 50 gold instead.`}))}if(a.potion&&dh(e,a.potion),a.pickRemove&&r.push(`remove`),a.pickUpgrade&&r.push(`upgrade`),a.pickDuplicate&&r.push(`duplicate`),a.pickCard&&r.push({pickCard:a.pickCard}),a.roll){let t=n(),o=0;for(let s of a.roll)if(o+=s.p,t<o){i.push({text:s.text});let t=fg(e,s.ops,n);r.push(...t.pending),i.push(...t.log);break}}}return{pending:r,log:i}}var pg=Object.assign({"./assets/arts/ashfall.png":`/assets/ashfall-C0Z9oihA.png`,"./assets/arts/beacon.png":`/assets/beacon-CfpI4NvN.png`,"./assets/arts/emberveil.png":`/assets/emberveil-DRPFSPHg.png`,"./assets/arts/flare.png":`/assets/flare-Ca-5NBfJ.png`,"./assets/arts/mendglass.png":`/assets/mendglass-MxKA-x9I.png`,"./assets/arts/stoke.png":`/assets/stoke-D5pz9eOt.png`,"./assets/bequests/card.png":`/assets/card-CHxK2GTL.png`,"./assets/bequests/gold.png":`/assets/gold-CNm8Tont.png`,"./assets/bequests/relic.png":`/assets/relic-Bo0IZDwg.png`,"./assets/boons/emberFlask.png":`/assets/emberFlask-BlP1krpU.png`,"./assets/boons/fullPurse.png":`/assets/fullPurse-DcTqZ-nz.png`,"./assets/boons/keenEye.png":`/assets/keenEye-DPefaPGL.png`,"./assets/boons/pilgrimsCache.png":`/assets/pilgrimsCache-CsIcQUYT.png`,"./assets/boons/temperedGlass.png":`/assets/temperedGlass-BVjobJFG.png`,"./assets/boons/twinPhials.png":`/assets/twinPhials-D5-9T5W2.png`,"./assets/boons/venomPouch.png":`/assets/venomPouch-9GhvdgzC.png`,"./assets/boons/warmHearth.png":`/assets/warmHearth-DTnVpfFw.png`,"./assets/cards/aegis.jpg":`/assets/aegis-D665L0sd.jpg`,"./assets/cards/agility.jpg":`/assets/agility-CUG3xKOo.jpg`,"./assets/cards/annihilate.jpg":`/assets/annihilate-CXlkbExQ.jpg`,"./assets/cards/ascension.jpg":`/assets/ascension-S4GAfpbx.jpg`,"./assets/cards/ashBite.jpg":`/assets/ashBite-BYzdJfb7.jpg`,"./assets/cards/ashenChoir.jpg":`/assets/ashenChoir-DTfq4XXZ.jpg`,"./assets/cards/bastion.jpg":`/assets/bastion-CM0wK4Yy.jpg`,"./assets/cards/bloodRite.jpg":`/assets/bloodRite-ou1XgXoc.jpg`,"./assets/cards/brace.jpg":`/assets/brace-Dc4SYgdF.jpg`,"./assets/cards/bulwark.jpg":`/assets/bulwark-CjEcWZ-i.jpg`,"./assets/cards/burn.jpg":`/assets/burn-DJ4EegTp.jpg`,"./assets/cards/catalyst.jpg":`/assets/catalyst-ClagfpN0.jpg`,"./assets/cards/chisel.jpg":`/assets/chisel-DGrQWYAc.jpg`,"./assets/cards/cleave.jpg":`/assets/cleave-CvexqRxg.jpg`,"./assets/cards/cripple.jpg":`/assets/cripple-CRxGKuS4.jpg`,"./assets/cards/defend.jpg":`/assets/defend-mmYA7HKX.jpg`,"./assets/cards/deflect.jpg":`/assets/deflect-BKgfxyAn.jpg`,"./assets/cards/devour.jpg":`/assets/devour-CST2E0aP.jpg`,"./assets/cards/eclipseSlash.jpg":`/assets/eclipseSlash-DEA5FgEC.jpg`,"./assets/cards/emberdance.jpg":`/assets/emberdance-B_CKT6sd.jpg`,"./assets/cards/empower.jpg":`/assets/empower-D4P9cm_V.jpg`,"./assets/cards/executioner.jpg":`/assets/executioner-BOy4ovki.jpg`,"./assets/cards/firstSpark.jpg":`/assets/firstSpark-BpDCHsPu.jpg`,"./assets/cards/flawlessForm.jpg":`/assets/flawlessForm-Di6668jF.jpg`,"./assets/cards/flurry.jpg":`/assets/flurry-BgnBaWD-.jpg`,"./assets/cards/fortify.jpg":`/assets/fortify-BzU364vJ.jpg`,"./assets/cards/frenzy.jpg":`/assets/frenzy-qaLdgJOP.jpg`,"./assets/cards/guardedStrike.jpg":`/assets/guardedStrike-CesH5DLC.jpg`,"./assets/cards/heavyBlow.jpg":`/assets/heavyBlow-XGOXUeSq.jpg`,"./assets/cards/hex.jpg":`/assets/hex-CzQLIJW1.jpg`,"./assets/cards/ironSkin.jpg":`/assets/ironSkin-BOE1a1BZ.jpg`,"./assets/cards/leechBlade.jpg":`/assets/leechBlade-CFp6z-JI.jpg`,"./assets/cards/limitBreak.jpg":`/assets/limitBreak-BU_PNCuK.jpg`,"./assets/cards/lunge.jpg":`/assets/lunge-D9lgqjTD.jpg`,"./assets/cards/momentum.jpg":`/assets/momentum-Clbqs0on.jpg`,"./assets/cards/nightSight.jpg":`/assets/nightSight-DuZK4KbA.jpg`,"./assets/cards/novaflare.jpg":`/assets/novaflare-Dwvtjr_D.jpg`,"./assets/cards/oblivionStrike.jpg":`/assets/oblivionStrike-CXq1522m.jpg`,"./assets/cards/offering.jpg":`/assets/offering-BaVvule_.jpg`,"./assets/cards/phantomBlades.jpg":`/assets/phantomBlades-Bck63olt.jpg`,"./assets/cards/preparation.jpg":`/assets/preparation-BkmwWzr3.jpg`,"./assets/cards/pyreheart.jpg":`/assets/pyreheart-Cf86Pj1Y.jpg`,"./assets/cards/quakeblow.jpg":`/assets/quakeblow-DZPTH_O8.jpg`,"./assets/cards/quickSlash.jpg":`/assets/quickSlash-DMRFz6rj.jpg`,"./assets/cards/regrowth.jpg":`/assets/regrowth-C0gMpqIX.jpg`,"./assets/cards/resonantLance.jpg":`/assets/resonantLance-CCStaA3R.jpg`,"./assets/cards/shardstorm.jpg":`/assets/shardstorm-DIKHFs35.jpg`,"./assets/cards/sidestep.jpg":`/assets/sidestep-CeDzy6bs.jpg`,"./assets/cards/smother.jpg":`/assets/smother-DFWDS6kH.jpg`,"./assets/cards/strike.jpg":`/assets/strike-DfYIx_7x.jpg`,"./assets/cards/surge.jpg":`/assets/surge-Ci44wXor.jpg`,"./assets/cards/tempest.jpg":`/assets/tempest-K9Ub9Fd7.jpg`,"./assets/cards/tithe.jpg":`/assets/tithe-DvZ_GGtQ.jpg`,"./assets/cards/toxicMist.jpg":`/assets/toxicMist-DMOH0JOL.jpg`,"./assets/cards/twinFangs.jpg":`/assets/twinFangs-C0lavWO6.jpg`,"./assets/cards/uppercut.jpg":`/assets/uppercut-CY7mUqmx.jpg`,"./assets/cards/venomStrike.jpg":`/assets/venomStrike-DGTk3cTA.jpg`,"./assets/cards/virulence.jpg":`/assets/virulence-vlHxYWHm.jpg`,"./assets/cards/warCry.jpg":`/assets/warCry-BO21yVwc.jpg`,"./assets/cards/wound.jpg":`/assets/wound-B5mKVM4_.jpg`,"./assets/deeds/ashSermon.png":`/assets/ashSermon-CQLTV0YC.png`,"./assets/deeds/darkWalker.png":`/assets/darkWalker-BcUgRerv.png`,"./assets/deeds/firstDawn.png":`/assets/firstDawn-BGaCCejS.png`,"./assets/deeds/hundredShards.png":`/assets/hundredShards-BbMyoK2V.png`,"./assets/deeds/lanternFed.png":`/assets/lanternFed-BdesJDJD.png`,"./assets/deeds/paneBreaker.png":`/assets/paneBreaker-h0dWvGCV.png`,"./assets/deeds/spendthrift.png":`/assets/spendthrift-OT3LxCNB.png`,"./assets/deeds/untouched.png":`/assets/untouched-Q4-Em2Wy.png`,"./assets/enemies/abyssalKnight.png":`/assets/abyssalKnight-BA9qPzL_.png`,"./assets/enemies/alphaFang.png":`/assets/alphaFang-CYs2MfQS.png`,"./assets/enemies/ashAcolyte.png":`/assets/ashAcolyte-W7Bx9eY3.png`,"./assets/enemies/chaosHound.png":`/assets/chaosHound-Cu1tbGXO.png`,"./assets/enemies/deepmaw.png":`/assets/deepmaw-BuZMfyUW.png`,"./assets/enemies/drownedOne.png":`/assets/drownedOne-762yKbrK.png`,"./assets/enemies/duskfang.png":`/assets/duskfang-kVQE2Vbx.png`,"./assets/enemies/gloomslime.png":`/assets/gloomslime-BYNIQKkd.png`,"./assets/enemies/gravewarden.png":`/assets/gravewarden-CYbqq2Uz.png`,"./assets/enemies/heraldOfEnd.png":`/assets/heraldOfEnd-B5j76nBL.png`,"./assets/enemies/leviathan.png":`/assets/leviathan-DUX2Oy2k.png`,"./assets/enemies/mirelurker.png":`/assets/mirelurker-Cs0-ryPe.png`,"./assets/enemies/obsidianGolem.png":`/assets/obsidianGolem-B2_vm835.png`,"./assets/enemies/rootheart.png":`/assets/rootheart-CoZqsgKs.png`,"./assets/enemies/shade.png":`/assets/shade-cFzxMAwm.png`,"./assets/enemies/shellback.png":`/assets/shellback-9j9gwuRI.png`,"./assets/enemies/siren.png":`/assets/siren-Boj63opF.png`,"./assets/enemies/sovereign.png":`/assets/sovereign-DlFMbPOe.png`,"./assets/enemies/sporeling.png":`/assets/sporeling-B8wAP_1e.png`,"./assets/enemies/starCultist.png":`/assets/starCultist-DrQ9SosS.png`,"./assets/enemies/thornling.png":`/assets/thornling-BJhkzjJz.png`,"./assets/enemies/tidecaller.png":`/assets/tidecaller-C3FvvD8d.png`,"./assets/enemies/voidColossus.png":`/assets/voidColossus-D1BBPiCC.png`,"./assets/enemies/voidWisp.png":`/assets/voidWisp-DqB4mImW.png`,"./assets/enemies/voltEel.png":`/assets/voltEel-BxcD87LR.png`,"./assets/enemies/watcherEye.png":`/assets/watcherEye-Cx0FZXO4.png`,"./assets/enemies/waylayer.png":`/assets/waylayer-DkHd5xp-.png`,"./assets/events/cursedIdol.png":`/assets/cursedIdol--s0qHWso.png`,"./assets/events/emberFountain.png":`/assets/emberFountain-D_Q0157p.png`,"./assets/events/fleshTrader.png":`/assets/fleshTrader-q8lAx2oa.png`,"./assets/events/forge.png":`/assets/forge-i5xE2DIv.png`,"./assets/events/forgottenShrine.png":`/assets/forgottenShrine-CYFo9R9B.png`,"./assets/events/gambler.png":`/assets/gambler-D4lmA3Yw.png`,"./assets/events/library.png":`/assets/library-CstvhNks.png`,"./assets/events/mirror.png":`/assets/mirror-Hp5O4ZPJ.png`,"./assets/events/ruinedCamp.png":`/assets/ruinedCamp-BvAZgrK0.png`,"./assets/events/voidChest.png":`/assets/voidChest-B34oBTge.png`,"./assets/events/woundedKnight.png":`/assets/woundedKnight-JN7kYI1u.png`,"./assets/heroes/ashwarden.png":`/assets/ashwarden-D21mg7QM.png`,"./assets/heroes/duskblade.png":`/assets/duskblade-DupP5i2p.png`,"./assets/meta/ascended.png":`/assets/ascended-BmNUkA_D.png`,"./assets/meta/fallen.png":`/assets/fallen-D70fZZUD.png`,"./assets/meta/monument-node.png":`/assets/monument-node-CtuHi8tA.png`,"./assets/omens/ashfall.png":`/assets/ashfall-T4uYvK8I.png`,"./assets/omens/emberWind.png":`/assets/emberWind-Cw83yf4v.png`,"./assets/omens/heavyAir.png":`/assets/heavyAir-CjAuZn0d.png`,"./assets/omens/hungryDark.png":`/assets/hungryDark-JCDxnDj4.png`,"./assets/omens/longNight.png":`/assets/longNight-C2g4JuMB.png`,"./assets/omens/thinGlass.png":`/assets/thinGlass-CCNgzO1U.png`,"./assets/omens/waningMoon.png":`/assets/waningMoon-DyGgMjmd.png`,"./assets/piles/ashes.png":`/assets/ashes-BLbDyC5A.png`,"./assets/piles/discard.png":`/assets/discard-Ce0K8E4l.png`,"./assets/piles/draw.png":`/assets/draw-BDdFVICK.png`,"./assets/potions/block.png":`/assets/block-DybnuP3a.png`,"./assets/potions/energy.png":`/assets/energy-CWJoumcv.png`,"./assets/potions/fire.png":`/assets/fire-Bc2Edgqg.png`,"./assets/potions/healing.png":`/assets/healing-Bf7MtUhk.png`,"./assets/potions/strength.png":`/assets/strength-Bp64zOFp.png`,"./assets/potions/swift.png":`/assets/swift-Da4aGqnZ.png`,"./assets/potions/venom.png":`/assets/venom-DzAfe6ZB.png`,"./assets/props/campfire.png":`/assets/campfire-C5hpDY2a.png`,"./assets/props/chest-open.png":`/assets/chest-open-D2mfQAex.png`,"./assets/props/chest.png":`/assets/chest-Dz-t7vgq.png`,"./assets/props/merchant.png":`/assets/merchant-CRCPVNlm.png`,"./assets/relics/ashenCore.png":`/assets/ashenCore-BHw_xmlT.png`,"./assets/relics/basaltIdol.png":`/assets/basaltIdol-BLUsj7rE.png`,"./assets/relics/bellOfEndings.png":`/assets/bellOfEndings-CMuMud-J.png`,"./assets/relics/crownOfCinders.png":`/assets/crownOfCinders-B4iyR0zw.png`,"./assets/relics/crownOfTheHearth.png":`/assets/crownOfTheHearth-Cz96lab0.png`,"./assets/relics/crownOfTithes.png":`/assets/crownOfTithes-BCSNj05m.png`,"./assets/relics/duskmirror.png":`/assets/duskmirror-ChDahFDy.png`,"./assets/relics/emberHeart.png":`/assets/emberHeart-D8pWC_qd.png`,"./assets/relics/emberLantern.png":`/assets/emberLantern-CzFc-ESn.png`,"./assets/relics/executionersSeal.png":`/assets/executionersSeal-B-n0EUgT.png`,"./assets/relics/frozenCore.png":`/assets/frozenCore-JuT4c4Zg.png`,"./assets/relics/gravebloom.png":`/assets/gravebloom-CR3cDZz9.png`,"./assets/relics/hollowCrown.png":`/assets/hollowCrown-CHl2KxBg.png`,"./assets/relics/ironTalisman.png":`/assets/ironTalisman-CLgSHgbT.png`,"./assets/relics/merchantsMark.png":`/assets/merchantsMark-YaAPSe2m.png`,"./assets/relics/prismCharm.png":`/assets/prismCharm-CWUUYnXM.png`,"./assets/relics/reapersBell.png":`/assets/reapersBell-DK7zj2uj.png`,"./assets/relics/riverPearl.png":`/assets/riverPearl-1k1ZwvLB.png`,"./assets/relics/seersOrb.png":`/assets/seersOrb--o7V7uP4.png`,"./assets/relics/shatterersCrown.png":`/assets/shatterersCrown-VlDF7CT4.png`,"./assets/relics/silkFan.png":`/assets/silkFan-Co6ZNxqb.png`,"./assets/relics/smolderingCoal.png":`/assets/smolderingCoal-ESDuOXE3.png`,"./assets/relics/sunBlossom.png":`/assets/sunBlossom-GItTIWOb.png`,"./assets/relics/sweetRoot.png":`/assets/sweetRoot-DVIYyMAo.png`,"./assets/relics/thiefOfWicks.png":`/assets/thiefOfWicks-WD5HQJ9E.png`,"./assets/relics/thornBand.png":`/assets/thornBand-1rbgbbpR.png`,"./assets/relics/travelersPack.png":`/assets/travelersPack-Ctq6FXOL.png`,"./assets/relics/verdantBranch.png":`/assets/verdantBranch-BpapOPVN.png`,"./assets/relics/vialOfLife.png":`/assets/vialOfLife-CqH_Yzkc.png`,"./assets/relics/warFetish.png":`/assets/warFetish-BphYE_UB.png`,"./assets/relics/wardingCharm.png":`/assets/wardingCharm-DcyucUO6.png`,"./assets/stage/act1-backdrop.png":`/assets/act1-backdrop-CC5kcu8K.png`,"./assets/stage/act1-ledge.png":`/assets/act1-ledge-Xknu1EDQ.png`,"./assets/stage/act1-mid.png":`/assets/act1-mid-B4s3OZuq.png`,"./assets/stage/act2-backdrop.png":`/assets/act2-backdrop-BtpNIaTG.png`,"./assets/stage/act2-ledge.png":`/assets/act2-ledge-CVAyrxfF.png`,"./assets/stage/act2-mid.png":`/assets/act2-mid-BAevK0Pb.png`,"./assets/stage/act3-backdrop.png":`/assets/act3-backdrop-DFsKREnY.png`,"./assets/stage/act3-ledge.png":`/assets/act3-ledge-DuyDX66N.png`,"./assets/stage/act3-mid.png":`/assets/act3-mid-CukJ38oi.png`,"./assets/statuses/barricade.png":`/assets/barricade-TKMR6Ae6.png`,"./assets/statuses/beacon.png":`/assets/beacon-D6Cit09D.png`,"./assets/statuses/dex.png":`/assets/dex-N8ZMyTH1.png`,"./assets/statuses/emberflow.png":`/assets/emberflow-WaDB__mJ.png`,"./assets/statuses/energized.png":`/assets/energized-tpMiHiHG.png`,"./assets/statuses/frail.png":`/assets/frail-C1xWDqHa.png`,"./assets/statuses/metallicize.png":`/assets/metallicize-D8bZ-dPU.png`,"./assets/statuses/nightsight.png":`/assets/nightsight-bIBKLafH.png`,"./assets/statuses/poison.png":`/assets/poison-eOT81JHw.png`,"./assets/statuses/rampage.png":`/assets/rampage-ePkPHo3b.png`,"./assets/statuses/regen.png":`/assets/regen-3glMdJ9C.png`,"./assets/statuses/ritual.png":`/assets/ritual--xxBwmXw.png`,"./assets/statuses/str.png":`/assets/str-BceaR6bB.png`,"./assets/statuses/thorns.png":`/assets/thorns-tG3JnxUb.png`,"./assets/statuses/venomous.png":`/assets/venomous-C-ybwq21.png`,"./assets/statuses/vulnerable.png":`/assets/vulnerable-BQp8gTZ1.png`,"./assets/statuses/weak.png":`/assets/weak-BVqZWBOd.png`,"./assets/title/title.png":`/assets/title-BZbtHJmc.png`,"./assets/title-background/background.png":`/assets/background-cEVCcaPg.png`,"./assets/vfx/ward-gain.png":`/assets/ward-gain-D7LqGRWO.png`,"./assets/vfx/ward-loop.png":`/assets/ward-loop-Dz8O9xUS.png`,"./assets-legacy/cards/aegis.png":`/assets/aegis-BbAK7DRy.png`,"./assets-legacy/cards/agility.png":`/assets/agility-D28Eu8MG.png`,"./assets-legacy/cards/annihilate.png":`/assets/annihilate-M3mspBDm.png`,"./assets-legacy/cards/ascension.png":`/assets/ascension-C2Pll28_.png`,"./assets-legacy/cards/ashBite.png":`/assets/ashBite-BBZrYNBt.png`,"./assets-legacy/cards/ashenChoir.png":`/assets/ashenChoir-Cjfn-BY1.png`,"./assets-legacy/cards/bastion.png":`/assets/bastion-D4uvW6Yu.png`,"./assets-legacy/cards/bloodRite.png":`/assets/bloodRite-xNaIV6FC.png`,"./assets-legacy/cards/brace.png":`/assets/brace-CDbc3WSx.png`,"./assets-legacy/cards/bulwark.png":`/assets/bulwark-DvQ82Xby.png`,"./assets-legacy/cards/burn.png":`/assets/burn-BVJa4vLy.png`,"./assets-legacy/cards/catalyst.png":`/assets/catalyst-C9UJqVfa.png`,"./assets-legacy/cards/chisel.png":`/assets/chisel-BHUdyvP2.png`,"./assets-legacy/cards/cleave.png":`/assets/cleave-Cs444Dst.png`,"./assets-legacy/cards/cripple.png":`/assets/cripple-CtSZS_Jx.png`,"./assets-legacy/cards/defend.png":`/assets/defend-BT8TAbMa.png`,"./assets-legacy/cards/deflect.png":`/assets/deflect-C25gbOwx.png`,"./assets-legacy/cards/devour.png":`/assets/devour-CXvHmKvA.png`,"./assets-legacy/cards/eclipseSlash.png":`/assets/eclipseSlash-B5W8xu8L.png`,"./assets-legacy/cards/emberdance.png":`/assets/emberdance-CBOqWIEl.png`,"./assets-legacy/cards/empower.png":`/assets/empower-DauCte29.png`,"./assets-legacy/cards/executioner.png":`/assets/executioner-DI8vj7EW.png`,"./assets-legacy/cards/firstSpark.png":`/assets/firstSpark-CaQ5-JAc.png`,"./assets-legacy/cards/flawlessForm.png":`/assets/flawlessForm-C34QTET6.png`,"./assets-legacy/cards/flurry.png":`/assets/flurry-D8kOQQ9x.png`,"./assets-legacy/cards/fortify.png":`/assets/fortify-DEACu-Zo.png`,"./assets-legacy/cards/frenzy.png":`/assets/frenzy-BgGGtYpf.png`,"./assets-legacy/cards/guardedStrike.png":`/assets/guardedStrike-BBAeWagI.png`,"./assets-legacy/cards/heavyBlow.png":`/assets/heavyBlow-Btb1hEmS.png`,"./assets-legacy/cards/hex.png":`/assets/hex-D3QIN_GY.png`,"./assets-legacy/cards/ironSkin.png":`/assets/ironSkin-DIcLMutG.png`,"./assets-legacy/cards/leechBlade.png":`/assets/leechBlade-BgoitLbP.png`,"./assets-legacy/cards/limitBreak.png":`/assets/limitBreak-D3VHagIC.png`,"./assets-legacy/cards/lunge.png":`/assets/lunge-BKNULJcP.png`,"./assets-legacy/cards/momentum.png":`/assets/momentum-D0hGLm2N.png`,"./assets-legacy/cards/nightSight.png":`/assets/nightSight-1ggiNsUe.png`,"./assets-legacy/cards/novaflare.png":`/assets/novaflare-BtAOF5B2.png`,"./assets-legacy/cards/oblivionStrike.png":`/assets/oblivionStrike-Ck8D7viT.png`,"./assets-legacy/cards/offering.png":`/assets/offering-BDnzVcbS.png`,"./assets-legacy/cards/phantomBlades.png":`/assets/phantomBlades-CZgzKQZJ.png`,"./assets-legacy/cards/preparation.png":`/assets/preparation-B0_lrDKo.png`,"./assets-legacy/cards/pyreheart.png":`/assets/pyreheart-BzRCI95J.png`,"./assets-legacy/cards/quakeblow.png":`/assets/quakeblow-DZuM_zei.png`,"./assets-legacy/cards/quickSlash.png":`/assets/quickSlash-BHIEN7hF.png`,"./assets-legacy/cards/regrowth.png":`/assets/regrowth-DCr6zV9b.png`,"./assets-legacy/cards/resonantLance.png":`/assets/resonantLance-DFyDlcY4.png`,"./assets-legacy/cards/shardstorm.png":`/assets/shardstorm-CtSThqM0.png`,"./assets-legacy/cards/sidestep.png":`/assets/sidestep-D-t2UoHV.png`,"./assets-legacy/cards/smother.png":`/assets/smother-Boa7xrCA.png`,"./assets-legacy/cards/strike.png":`/assets/strike-CmEr2qad.png`,"./assets-legacy/cards/surge.png":`/assets/surge-D5JDOylt.png`,"./assets-legacy/cards/tempest.png":`/assets/tempest-DosF7X1A.png`,"./assets-legacy/cards/tithe.png":`/assets/tithe-BNvDlR3N.png`,"./assets-legacy/cards/toxicMist.png":`/assets/toxicMist-BUGxQeK0.png`,"./assets-legacy/cards/twinFangs.png":`/assets/twinFangs-BUW2V2Kq.png`,"./assets-legacy/cards/uppercut.png":`/assets/uppercut-C0A2yndn.png`,"./assets-legacy/cards/venomStrike.png":`/assets/venomStrike-CXIglW-b.png`,"./assets-legacy/cards/virulence.png":`/assets/virulence-pwX1yrdH.png`,"./assets-legacy/cards/warCry.png":`/assets/warCry-C7Rsrd4u.png`,"./assets-legacy/cards/wound.png":`/assets/wound-BTcmqSFC.png`,"./assets-legacy/enemies/abyssalKnight.png":`/assets/abyssalKnight-C-E-itbM.png`,"./assets-legacy/enemies/alphaFang.png":`/assets/alphaFang-DdGpQqF8.png`,"./assets-legacy/enemies/ashAcolyte.png":`/assets/ashAcolyte-BBrUUe1I.png`,"./assets-legacy/enemies/chaosHound.png":`/assets/chaosHound-D1R2CoW1.png`,"./assets-legacy/enemies/deepmaw.png":`/assets/deepmaw-la4seO5f.png`,"./assets-legacy/enemies/drownedOne.png":`/assets/drownedOne-BUBzJWlu.png`,"./assets-legacy/enemies/duskfang.png":`/assets/duskfang-CHUmjhPP.png`,"./assets-legacy/enemies/gloomslime.png":`/assets/gloomslime-BNhQuFFa.png`,"./assets-legacy/enemies/gravewarden.png":`/assets/gravewarden-BC9T04oe.png`,"./assets-legacy/enemies/heraldOfEnd.png":`/assets/heraldOfEnd-DZZiCKi_.png`,"./assets-legacy/enemies/leviathan.png":`/assets/leviathan-BhXEnJxl.png`,"./assets-legacy/enemies/mirelurker.png":`/assets/mirelurker-DidtJkek.png`,"./assets-legacy/enemies/obsidianGolem.png":`/assets/obsidianGolem-DkurqVoj.png`,"./assets-legacy/enemies/rootheart.png":`/assets/rootheart-B4o9Bf9P.png`,"./assets-legacy/enemies/shade.png":`/assets/shade-C2XrmBs-.png`,"./assets-legacy/enemies/shellback.png":`/assets/shellback-DCHXMl3u.png`,"./assets-legacy/enemies/siren.png":`/assets/siren-GVK3WWGi.png`,"./assets-legacy/enemies/sovereign.png":`/assets/sovereign-0p3wfa6T.png`,"./assets-legacy/enemies/sporeling.png":`/assets/sporeling-BeOaEEL0.png`,"./assets-legacy/enemies/starCultist.png":`/assets/starCultist-DQHXdHm5.png`,"./assets-legacy/enemies/thornling.png":`/assets/thornling-CqSviePj.png`,"./assets-legacy/enemies/tidecaller.png":`/assets/tidecaller-tGjufTlQ.png`,"./assets-legacy/enemies/voidColossus.png":`/assets/voidColossus-yr_eofA0.png`,"./assets-legacy/enemies/voidWisp.png":`/assets/voidWisp-D_7XlB9X.png`,"./assets-legacy/enemies/voltEel.png":`/assets/voltEel-CJeHty9B.png`,"./assets-legacy/enemies/watcherEye.png":`/assets/watcherEye---WypZip.png`,"./assets-legacy/enemies/waylayer.png":`/assets/waylayer-qynHTjuH.png`,"./assets-legacy/events/cursedIdol.png":`/assets/cursedIdol--s0qHWso.png`,"./assets-legacy/events/emberFountain.png":`/assets/emberFountain-D_Q0157p.png`,"./assets-legacy/events/fleshTrader.png":`/assets/fleshTrader-q8lAx2oa.png`,"./assets-legacy/events/forge.png":`/assets/forge-i5xE2DIv.png`,"./assets-legacy/events/forgottenShrine.png":`/assets/forgottenShrine-CYFo9R9B.png`,"./assets-legacy/events/gambler.png":`/assets/gambler-D4lmA3Yw.png`,"./assets-legacy/events/library.png":`/assets/library-CstvhNks.png`,"./assets-legacy/events/mirror.png":`/assets/mirror-Hp5O4ZPJ.png`,"./assets-legacy/events/ruinedCamp.png":`/assets/ruinedCamp-BvAZgrK0.png`,"./assets-legacy/events/voidChest.png":`/assets/voidChest-B34oBTge.png`,"./assets-legacy/events/woundedKnight.png":`/assets/woundedKnight-JN7kYI1u.png`,"./assets-legacy/heroes/ashwarden.png":`/assets/ashwarden-BjFdmgoK.png`,"./assets-legacy/heroes/duskblade.png":`/assets/duskblade-DBhvpfoa.png`,"./assets-legacy/potions/block.png":`/assets/block-CkTqIuTb.png`,"./assets-legacy/potions/energy.png":`/assets/energy-BNM23nR-.png`,"./assets-legacy/potions/fire.png":`/assets/fire-CAaEe0xi.png`,"./assets-legacy/potions/healing.png":`/assets/healing-KDHGTVtG.png`,"./assets-legacy/potions/strength.png":`/assets/strength-CIdQsSW6.png`,"./assets-legacy/potions/swift.png":`/assets/swift-xz-qROFX.png`,"./assets-legacy/potions/venom.png":`/assets/venom-D3l_eMKx.png`,"./assets-legacy/props/campfire.png":`/assets/campfire-B-OrO4zT.png`,"./assets-legacy/props/chest-open.png":`/assets/chest-open-B5Uzt-_6.png`,"./assets-legacy/props/chest.png":`/assets/chest-b-PO08AA.png`,"./assets-legacy/props/merchant.png":`/assets/merchant-COlFp5u3.png`,"./assets-legacy/title-background/background.png":`/assets/background-CqhrXvXS.png`}),mg=[`png`,`jpg`,`jpeg`,`webp`],hg={live:{label:`Live`,root:`assets`},legacy:{label:`Legacy`,root:`assets-legacy`}},gg=`live`,_g=(e=gg)=>hg[e]??hg[gg],vg=()=>Object.keys(hg),yg=(e=gg)=>_g(e).label,bg=(e,t,n=gg)=>{let{root:r}=_g(n);for(let n of mg){let i=pg[`./${r}/${e}/${t}.${n}`];if(i)return i}return null},xg=(e,t=gg)=>{let{root:n}=_g(t);return Object.entries(pg).filter(([t])=>t.startsWith(`./${n}/${e}/`)).map(([,e])=>e)},Sg=0,Cg=()=>`g${++Sg}`,K=(e,t,n,r=1)=>`hsla(${e},${t}%,${n}%,${r})`;function wg(e,t,n){return`<defs>
    ...
    </g>`}};function kg(e){let t=Cg(),n=K(e.hue,90,66),r=Eg((Og[e.kind]||Og.slime)(t,e.hue,n));return`<svg class="enemy-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${wg(t,e.hue,n)}
    ...
    ${r}
    <g class="cracks"></g>
  </svg>`}var Ag=[{hue:225,glow:`#7fd4ff`},{hue:26,glow:`#ffb15a`}];function jg(e=0){let t=Cg(),n=Ag[e]||Ag[0],r=n.hue,i=n.glow;return`<svg class="hero-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${wg(t,r,i)}
    ...
    <g class="cracks"></g>
  </svg>`}var Mg={strike:`⚔`,defend:`⛨`,eclipseSlash:`☾`,twinFangs:`⑂`,quickSlash:`≫`,heavyBlow:`⬇`,cleave:`⋔`,venomStrike:`☠`,lunge:`➹`,guardedStrike:`⛊`,brace:`⛨`,sidestep:`↯`,preparation:`♻`,deflect:`⛉`,leechBlade:`♆`,tempest:`≋`,uppercut:`⇑`,flurry:`⁂`,executioner:`✠`,momentum:`⤴`,bulwark:`☗`,surge:`✦`,toxicMist:`☁`,cripple:`⛓`,warCry:`♯`,fortify:`⧉`,bloodRite:`♥`,empower:`⚔`,agility:`❥`,ironSkin:`⬡`,regrowth:`❋`,oblivionStrike:`✸`,phantomBlades:`⚚`,devour:`♅`,annihilate:`✹`,aegis:`⛨`,offering:`♱`,limitBreak:`⚡`,catalyst:`⚗`,ascension:`☽`,bastion:`♜`,frenzy:`※`,virulence:`☣`,wound:`✂`,burn:`✹`,hex:`♄`,chisel:`◬`,firstSpark:`✧`,ashBite:`☄`,smother:`☁`,quakeblow:`⬲`,resonantLance:`↟`,tithe:`⚖`,pyreheart:`♥`,ashenChoir:`♬`,flawlessForm:`❖`,nightSight:`☾`,novaflare:`✺`,emberdance:`❂`,shardstorm:`❉`},Ng=e=>{let t=9;for(let n of e)t=Math.imul(t^n.charCodeAt(0),387420489);return(t^t>>>9)>>>0};function Pg(e,t){let n=Cg(),r=Ng(e),i={attack:356,skill:205,power:268,status:160,curse:300}[t]??205,a=(i+30+r%40)%360,o=K(i,85,66),s=K(a,80,60),c=r%360,l=``;if(t===`attack`)l=`<path d="M30 120 Q75 40 150 28" stroke="${o}" stroke-width="7" fill="none" opacity=".9"/>
      ...
      <path d="M62 106 L118 50" stroke="${s}" stroke-width="5" opacity=".7"/>`;let u=Mg[e]||`✦`;return`<svg viewBox="0 0 180 150" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}function Fg(e){let t=Cg();return`<svg viewBox="0 0 40 52" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function Ig(e=!1){let t=Cg();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function Lg(){let e=Cg();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}function Rg(){let e=Cg();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    ${wg(e,40,`#ffd166`)}
  ...
  </svg>`}function zg(e,t){let n=Cg(),r=K(t,80,66);return`<svg viewBox="0 0 220 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
    ...
    <div class="card-rarity"></div>
      ...
      <div class="hud-right">
        ${t.potions.map((e,t)=>`<button class="potion-slot ${e?`full`:``}" data-slot="${t}">${e?H_(`potions`,e,Fg(Pu[e].tone)):``}</button>`).join(``)}
    ...
    <div id="relicbar"></div>`;let i=Q(`#relicbar`,e),a=Z.run.omens?.[Z.run.act],o=Bu[a];if(o){let e=$(`div`,`relic-chip omen-chip`,q_(a,`hud-omen-art`,`hud-omen-fallback`,24));e.style.setProperty(`--tone`,o.tone),e._tip={title:`Omen — ${o.name}`,body:o.text,sub:`hangs over Act ${Z.run.act+1}`},i.appendChild(e)}for(let e of t.relics){let t=Mu[e],n=$(`div`,`hud-relic`,K_(e));n.style.setProperty(`--tone`,t.tone),n.dataset.relic=e,n._tip={title:t.name,body:t.text,sub:t.rarity},i.appendChild(n)}t.potions.forEach((t,n)=>{if(!t)return;let r=Q(`.potion-slot[data-slot="${n}"]`,e);r._tip={title:Pu[t].name,body:Pu[t].text,sub:`Click to use or toss`}}),Q(`[data-act="deck"]`,e).onclick=()=>{X.click(),hv(`Your Deck`,Z.run.player.deck,{sub:`${Z.run.player.deck.length} cards`})},Q(`[data-act="menu"]`,e).onclick=e=>{X.click(),sv(e.clientX,e.clientY)},R_(`.potion-slot.full`,e).forEach(e=>e.onclick=t=>uv(+e.dataset.slot,t))}function sv(e,t){cv();let{x:n,y:r}=S(e,t),i=$(`div`,`pop-menu`);i.innerHTML=`<button data-m="help">How to Play</button><button data-m="mute">${f_()?`Unmute`:`Mute`} Sound</button><button data-m="abandon" style="color:#ff8d8d">Abandon Run</button>`,b().appendChild(i),i.style.left=`${Math.min(n,_()-200)}px`,i.style.top=`${r+8}px`,i.onclick=e=>{let t=e.target.dataset.m;cv(),t===`help`&&gv(),t===`mute`&&p_(),t===`abandon`&&fv()},setTimeout(()=>document.addEventListener(`pointerdown`,lv,{once:!0}),0)}var cv=()=>R_(`.pop-menu`).forEach(e=>e.remove()),lv=e=>{e.target.closest(`.pop-menu`)||cv()};function uv(e,t){if(Z.busy)return;cv();let n=Z.run.player.potions[e];if(!n)return;let r=Pu[n],i=Z.cb&&!Z.cb.over&&Z.screen===`combat`,a=!r.combatOnly||i,o=$(`div`,`pop-menu`);o.innerHTML=`<button data-m="use" ${a?``:`disabled style="opacity:.4"`}>Use ${r.name}</button><button data-m="toss">Toss it</button>`,b().appendChild(o);let s=S(t.clientX,t.clientY);o.style.left=`${Math.min(s.x-60,_()-220)}px`,o.style.top=`${s.y+10}px`,o.onclick=async t=>{let n=t.target.dataset.m;if(cv(),n===`toss`&&(Z.run.player.potions[e]=null,X.card(),ov(),sg(Z.run)),n===`use`&&a)if(r.needsTarget&&i){let t=Z.cb.enemies.filter(e=>e.hp>0);if(t.length===1)return dv(e,t[0].idx);ey({kind:`potion`,slot:e})}else dv(e,null)},setTimeout(()=>document.addEventListener(`pointerdown`,lv,{once:!0}),0)}async function dv(e,t){ty(),X.potion(),Z.cb&&!Z.cb.over&&Z.screen===`combat`?(qh(Z.run,Z.cb,e,t),await My(),Fy()):(qh(Z.run,null,e,null),ov(),sg(Z.run))}function fv(){pv(`<div class="panel ov-panel" style="text-align:center">
  ...
  </div>`,e=>{e.onclick=e=>{let t=e.target.dataset.a;t===`yes`&&(dg(Z.run,!1),Z.run=null,Z.cb=null,mv(),v_(),bv(`title`)),t===`no`&&mv()}})}function pv(e,t=null,n=!1){let r=Q(`#overlay`);r.innerHTML=e,r.classList.add(`open`),r._closable=n,t&&t(r.firstElementChild)}function mv(){let e=Q(`#overlay`);e.classList.remove(`open`),e.innerHTML=``}function hv(e,t,{sub:n=``,pick:r=null,canSkip:i=!1,skipLabel:a=`Skip`,inCombat:o=!1}={}){let s=$(`div`,`panel ov-panel`);s.innerHTML=`<div class="ov-title">${e}</div>${n?`<div class="ov-sub">${n}</div>`:``}`;let c=$(`div`,`card-grid ${r?`choice-cards`:``}`),l=r?t:[...t].sort((e,t)=>Vm(e).name.localeCompare(Vm(t).name));for(let e of l){let t=iv(e,{inCombat:o});r&&(t.onclick=()=>{X.click(),t.classList.add(`picked`),setTimeout(()=>{mv(),r(e)},240)}),c.appendChild(t)}s.appendChild(c);let u=$(`div`,`ov-actions`);if(i&&r){let e=$(`button`,`btn ghost`,a);e.onclick=()=>{X.click(),mv(),r(null)},u.appendChild(e)}if(!r){let e=$(`button`,`btn ghost`,`Close`);e.onclick=()=>{X.click(),mv()},u.appendChild(e)}s.appendChild(u),pv(``,null,!r),Q(`#overlay`).appendChild(s)}function gv(){pv(`<div class="panel ov-panel howto">
    ...
    <div class="ov-actions"><button class="btn" data-a="ok">Fight On</button></div>
      ...
      <div class="vow-stepper">
        ...
        <div class="vow-level">VOW ${xv[n.vow]}<span class="vow-max"> / ${xv[e.vowUnlocked]||`0`}</span></div>
        <button class="vow-btn" data-a="vow+"${n.vow<e.vowUnlocked?``:` disabled`}>+</button>
      </div>
      <div class="vow-desc">${a}</div>
    </div>`:``,s=bg(`title-background`,`background`),c=bg(`title`,`title`),l=B_();l.innerHTML=`<div class="title-screen screen-enter">
    ...
    <div class="title-btns">
      ...
      <button class="btn ghost" data-a="mute">${f_()?`Unmute`:`Mute`}</button>
    </div>
    <div class="title-stats">${r.runs} climbs · ${r.wins} dawns · ${r.slain} slain${e.unlocks.length?` · ${e.unlocks.length} secrets unearthed`:``}</div>
  </div>`,l.onclick=r=>{let i=r.target.closest(`[data-a]`);if(!i||i.disabled)return;let a=i.dataset.a;d_(),X.click(),a===`asp`?(n.aspect=+i.dataset.i,Sv()):a===`vow-`?(n.vow=Math.max(0,n.vow-1),Sv()):a===`vow+`?(n.vow=Math.min(e.vowUnlocked,n.vow+1),Sv()):a===`new`?(t&&lg(),wv(Fm(void 0,{aspect:n.aspect,vow:n.vow,lamplighter:!0,monument:e.lastFall}))):a===`continue`&&t?wv(t,!0):a===`vigil`?Cv():a===`help`?gv():a===`mute`&&(p_(),Sv())},gy()}function Cv(){let e=Xg(),t=Object.entries(Uu).map(([t,n])=>{let r=e.deeds[n.stat]||0,i=r>=n.n,a=Math.min(100,Math.round(r/n.n*100)),o=n.unlocks.map(e=>{if(e===`aspect2`)return`The Ashwarden`;let[t,n]=e.split(`:`);return t===`card`?ku[n]?.name||n:Mu[n]?.name||n}).join(`, `),s=bg(`deeds`,t),c=s?`<img class="deed-art" src="${s}" alt="">`:`<span class="deed-art-fallback">${J(`deed-${t}`,40)}</span>`;return`<div class="deed-row${i?` done`:``}">
      ${c}
      <div class="deed-body">
    ...
    </div>`}).join(``);pv(`<div class="panel ov-panel vigil-panel">
    <div class="ov-title">The Vigil</div>
    <div class="ov-sub">${e.deeds.runs} climbs · ${e.deeds.wins} dawns · deepest Vow: ${xv[e.deeds.bestVow]||`—`}</div>
    <div class="deed-list">${t}</div>
    <div class="ov-actions"><button class="btn" data-a="ok">Close</button></div>
  </div>`,e=>{Q(`[data-a="ok"]`,e).onclick=()=>{X.click(),mv()}},!0)}function wv(e,t=!1){Z.run=e,Z.cb=null,$d(e.act);let n=e.nodeId?e.map.nodes.find(t=>t.id===e.nodeId):null;if(Bd(e.act,n?n.row:0),__(e.act),t||sg(e),t&&e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);Z.screen=`combat`,jv(vh(e,e.pendingCombat,t?t.row:5),e.pendingCombat),ov();return}if(e.pendingLamplighter){Tv();return}bv(`map`),t||setTimeout(()=>Vy(e),900)}function Tv(){let e=Z.run;if(Z.screen!==`lamplighter`&&_v(),Z.screen=`lamplighter`,cv(),qd(),$d(0),B_().className=``,!Z.lamp){let t=Hm(e),n=Object.keys(Ku),r=[];for(;r.length<3&&n.length;)r.push(n.splice(Math.floor(t()*n.length),1)[0]);Z.lamp={boons:r,boon:null,art:e.art},sg(e)}let t=Z.lamp,n=Wu[e.aspect],r=t.boons.map(e=>{let n=Ku[e],r=bg(`boons`,e);return`<button class="lamp-boon${t.boon===e?` on`:``}" data-a="boon" data-i="${e}">
      ${r?`<img class="lb-art-img" src="${r}" alt="">`:``}
      <div class="lb-name">${J(`boon-${e}`,20)} ${n.name}</div><div class="lb-text">${rv(n.text)}</div>
    </button>`}).join(``),i=Object.keys(Hu).map(e=>{let n=Hu[e],r=bg(`arts`,e);return`<button class="lamp-art${t.art===e?` on`:``}" data-a="art" data-i="${e}">
      ${r?`<img class="la-art-img" src="${r}" alt="">`:`<span class="la-glyph" style="color:${n.tone}">${J(`art-${e}`,18)}</span>`}<span class="la-name">${n.name}</span>
    </button>`}).join(``),a=Hu[t.art],o=B_();o.innerHTML=`<div class="lamp-screen screen-enter">
    ${U_()}
    <div class="lamp-hero">${Z_(e.aspect)}</div>
    ...
    <div class="lamp-art-desc">${a?`<b style="color:${a.tone}">${J(`art-${t.art}`,15)} ${a.name}</b> · ${rv(a.text)}`:``}</div>
  ...
  </div>`,ov(),o.onclick=e=>{let n=e.target.closest(`[data-a]`);if(!n||n.disabled)return;let r=n.dataset.a;d_(),X.click(),r===`boon`?(t.boon=n.dataset.i,Tv()):r===`art`?(t.art=n.dataset.i,X.hover(),Tv()):r===`begin`&&t.boon&&Ev()}}function Ev(){let e=Z.run,t=Z.lamp;e.art=t.art,e.boon=t.boon,fg(e,Ku[t.boon].ops),delete e.pendingLamplighter,Z.lamp=null,X.relic(),sg(e),bv(`map`),setTimeout(()=>Vy(e),900)}var Dv={monster:`sword`,elite:`skull`,event:`question`,rest:`flame`,shop:`coin`,treasure:`chest`,boss:`crown`,monument:`monument`};function Ov(){let e=Z.run;if(e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);Z.screen=`combat`,jv(vh(e,e.pendingCombat,t?t.row:5),e.pendingCombat);return}sg(e),Z.cb=null;let{nodes:t}=e.map,n=new Set(Wm(e).map(e=>e.id)),r=new Set(e.map.visited),i=e.nodeId?t.find(t=>t.id===e.nodeId).row:-1,a=``,o=``;for(let e of t)for(let t of e.next){let n=r.has(e.id)&&r.has(t)?`walked`:``;a+=`<path class="medge ${n}" style="--d:${e.row*34}ms" data-a="${e.id}" data-b="${t}" d="M0 0"/>`}for(let i of t){let t=i.unlit&&!r.has(i.id),a=[`mnode`,`type-${i.type}`,t?`unlit`:``,r.has(i.id)?`visited`:``,i.id===e.nodeId?`current`:``,n.has(i.id)?`avail`:``].join(` `),s=I_?1.3:1,c=(i.type===`boss`?26:i.type===`elite`||i.type===`treasure`?19:16)*s,l=Math.round((i.type===`boss`?26:i.type===`elite`||i.type===`treasure`?20:17)*s),u=i.type===`monument`?bg(`meta`,`monument-node`):null,d=u?`<image href="${u}" x="${-l/2}" y="${-l/2}" width="${l}" height="${l}" />`:Ug(t?`unlitLantern`:Dv[i.type],t?Math.round(17*s):l);o+=`<g class="${a}" data-node="${i.id}" style="--d:${i.row*34}ms">
      <g class="nwrap"><circle class="bg" r="${t?16*s:c}"/><g class="icg">${d}</g></g>
    </g>`}let s=Ou[e.act],c=e.omens?.[e.act],l=Bu[c];B_().innerHTML=`
    <div class="map-title">ACT ${e.act+1} — <b>${s.name.toUpperCase()}</b> — ${s.bossName} awaits${l?` &nbsp;·&nbsp; <span class="mt-omen" style="color:${l.tone}">${q_(c,`mt-omen-art`,`mt-omen-fallback`,18)}<span class="mt-omen-name">${l.name}</span></span>`:``}</div>
    <div class="map-screen screen-enter">
      ...
      <div class="map-hint">${I_?`drag`:`scroll`} to survey the Spire</div>
    </div>`;let u=Q(`.map-svg`),d=!1;u.onclick=e=>{if(d)return;let n=e.target.closest(`.mnode.avail`);!n||Z.busy||(d_(),kv(t.find(e=>e.id===n.dataset.node)))},R_(`.mnode`,u).forEach(i=>{let a=t.find(e=>e.id===i.dataset.node),o={monster:`Monster`,elite:`Elite — beware`,event:`Unknown event`,rest:`Rest site`,shop:`Merchant`,treasure:`Treasure`,boss:Ou[e.act].bossName};i._tip=a.unlit&&!r.has(a.id)?{title:`An unlit lantern`,body:`What waits here is unknown — but first light pays a bounty of gold.${n.has(a.id)?` ${I_?`Tap`:`Click`} to travel here.`:``}`}:{title:o[a.type],body:n.has(a.id)?`${I_?`Tap`:`Click`} to travel here.`:``,sub:{monster:`A fight. Embers and gold for the swift.`,elite:`A titled foe - greater risk, a relic-grade purse.`,event:`Fate unwritten. Could be anything.`,rest:`Heal, or forge a card into its + form.`,shop:`Gold for cards, relics, phials.`,treasure:`A chest with no fight attached.`,boss:`The act ends here. Ready your deck.`}[a.type]}});let f=t.map(t=>({id:t.id,pos:Ed(e.act,t)})),p=new Map(R_(`.mnode`,u).map(e=>[e.dataset.node,e])),m=new Set(t.filter(e=>!n.has(e.id)&&!r.has(e.id)).map(e=>e.id)),h=R_(`.medge`,u).map(e=>({p:e,a:e.dataset.a,b:e.dataset.b}));Vd(e.act,Math.max(0,i)),Kd(f,e=>{let t=new Map(e.map(e=>[e.id,e]));for(let[e,n]of p){let r=t.get(e);n.setAttribute(`transform`,`translate(${r.x.toFixed(1)},${r.y.toFixed(1)}) scale(${r.s.toFixed(3)})`);let i=n.classList.contains(`visited`)&&!n.classList.contains(`current`)?.55:1;n.style.opacity=(r.fade*(m.has(e)?.4:1)*i).toFixed(3)}for(let{p:e,a:n,b:r}of h){let i=t.get(n),a=t.get(r),o=9*(i.s+a.s)/2;e.setAttribute(`d`,`M${i.x.toFixed(1)} ${i.y.toFixed(1)} Q${((i.x+a.x)/2).toFixed(1)} ${((i.y+a.y)/2+o).toFixed(1)} ${a.x.toFixed(1)} ${a.y.toFixed(1)}`),e.style.opacity=(Math.min(i.fade,a.fade)*(e.classList.contains(`walked`)?.25:1)).toFixed(3)}}),Df(e.act,{mult:.3});let g=Q(`.map-screen`);g.addEventListener(`wheel`,e=>{e.preventDefault(),Ud(-e.deltaY*.006)},{passive:!1});let _=null,v=0,y=0,b=0;g.addEventListener(`pointerdown`,e=>{e.pointerType!==`mouse`&&(cancelAnimationFrame(y),_=e.clientY,v=0,b=0,d=!1)}),g.addEventListener(`pointermove`,e=>{if(_==null||e.pointerType===`mouse`)return;let t=e.clientY-_;_=e.clientY,b+=Math.abs(t),b>14&&(d=!0),v=t,Ud(t*.014)});let x=e=>{if(_==null||e.pointerType===`mouse`)return;_=null;let t=()=>{v*=.93,!(Math.abs(v)<.5||Z.screen!==`map`)&&(Ud(v*.014),y=requestAnimationFrame(t))};y=requestAnimationFrame(t),setTimeout(()=>d=!1,80)};g.addEventListener(`pointerup`,x),g.addEventListener(`pointercancel`,x)}function kv(e){let t=Z.run;X.map(),Bd(t.act,e.row);let{type:n,bounty:r}=Gm(t,e);if(sg(t),r){X.coin();let t=Q(`.mnode[data-node="${e.id}"]`),n=t?Wf(t):{x:_()/2,y:v()/2};Lf(n.x,n.y-34,`${J(`coin`,12)} +${r}`,`goldf`),oy(n.x,n.y,120,30,{n:5,color:`#ffe9ac`,size:7,dur:620})}if(n===`monster`||n===`elite`||n===`boss`){t.pendingCombat=n,sg(t);let r=Q(`.mnode[data-node="${e.id}"]`);yv(`combat-in`,r?Wf(r):{}),jv(vh(t,n,e.row),n)}else n===`rest`?bv(`rest`):n===`shop`?bv(`shop`):n===`treasure`?bv(`treasure`):n===`event`?bv(`event`,_h(t)):n===`monument`&&Av(e)}function Av(e){let t=Z.run,n=Km(t);if(n&&n_(),sg(t),n){X.relic();let t=n.kind===`relic`?Mu[n.id]?.name:n.kind===`card`?ku[n.id]?.name:`${n.amount} gold`,r=Q(`.mnode[data-node="${e.id}"]`),i=r?Wf(r):{x:_()/2,y:v()/2};Lf(i.x,i.y-34,`✦ ${t}`,`goldf`),oy(i.x,i.y,_()/2,v()*.5,{n:8,color:`#ffe9ac`,size:8,dur:720}),ay(`THE STONE REMEMBERS`)}bv(`map`)}function jv(e,t){if(Hd(),qd(),Q(`#tooltip`).style.display=`none`,Z.screen!==`combat`&&_v(),Z.cb=yh(Z.run,e,t),Z.screen=`combat`,Df(Z.run.act,{boss:t===`boss`}),Mv(),ov(),t===`boss`){let t=$(`div`,`rose-window`,`<div class="rw-rings"></div><div class="rw-spokes"></div><div class="boss-plate">${(Fu[e[0]]?.name??Z.cb.enemies[0].name).toUpperCase()}</div>`);B_().appendChild(t),setTimeout(()=>t.remove(),2300);let n=$(`div`,`turn-banner boss-banner`,Z.cb.enemies[0].name.toUpperCase());B_().appendChild(n),setTimeout(()=>n.remove(),2100),Mf(`#1a0a20`,.5,.9),tf(1.6),X.bigDeath()}My().then(Fy)}function Mv(){let e=Z.cb,t=B_();t.onclick=null,t.innerHTML=`<div class="combat-screen screen-enter intro" style="--ledge:${`#${Ou[Z.run.act].theme.glow.toString(16).padStart(6,`0`)}`}">
    ${[`backdrop`,`mid`,`ledge`].map(e=>{let t=bg(`stage`,`act${Z.run.act+1}-${e}`);return t?`<img class="sl sl-${e}" src="${t}" alt="" aria-hidden="true">`:``}).join(``)}
    ...
    <div class="hand-zone"></div>
  </div>`;let n=Q(`.enemy-zone`,t),r={enemies:[],root:Q(`.combat-screen`,t)},i=e.affix?Vu[e.affix]:null,a=D_(x().shape,Z.run.act),o=A_(a,e.enemies.length);e.enemies.forEach((e,t)=>{let s=Fu[e.key],c=P_(a,e.key,s.boss?`boss`:s.elite?`elite`:`normal`,o[t],_(),v()),l=$(`div`,`enemy${s.elite?` elite-e`:``}${s.boss?` boss-e`:``}${i?` affixed`:``}`);i&&l.style.setProperty(`--affix-tone`,i.tone),l.dataset.idx=t,l.style.animationDelay=`${160+t*130}ms`,l.innerHTML=`<div class="intent"></div>
      <div class="enemy-art" style="width:${c}px;height:${c}px"><div class="enemy-sprite">${Y_()}${J_(bg(`enemies`,e.key),`atk`)}${H_(`enemies`,e.key,kg(s.art))}<div class="vessel-fire"></div>${bg(`enemies`,e.key)?`<svg class="cracks-overlay" viewBox="0 0 200 200"><g class="cracks"></g></svg>`:``}</div><div class="dmg-preview"></div></div>
      <div class="cplate">
      ...
      </div>`,n.appendChild(l),r.enemies.push({root:l,art:Q(`.enemy-art`,l),intent:Q(`.intent`,l),fill:Q(`.fill`,l),ghost:Q(`.ghost`,l),hp:Q(`.hp-label`,l),block:Q(`.block-chip`,l),statuses:Q(`.status-row`,l),pv:Q(`.pv`,l),prev:Q(`.dmg-preview`,l),facets:Q(`.facet-row`,l)}),r.enemies[t].facets._tip={title:`Facets`,body:`Every creature is glass. Attacks that draw unblocked blood chip a facet; fill the gauge and the glass <b>shatters</b> — it loses its next action, is Cracked, and spills Embers into your lantern.`},i&&(Q(`.name`,l)._tip={title:`${i.name} — an elite's title`,body:i.text}),l.onclick=()=>$v(t),l.addEventListener(`pointerenter`,e=>{e.pointerType===`mouse`&&Z.targeting&&(l.classList.add(`target-hover`),Zv())}),l.addEventListener(`pointerleave`,()=>{l.classList.remove(`target-hover`),Zv()})}),r.pHp=Q(`.p-hp`,t),r.pFill=Q(`.player-zone .fill`,t),r.pGhost=Q(`.player-zone .ghost`,t),r.pBlock=Q(`.p-block`,t),r.pStatus=Q(`.p-status`,t),r.hero=Q(`.hero-wrap`,t),r.energy=Q(`.energy-orb`,t),r.endTurn=Q(`.end-turn`,t),r.hand=Q(`.hand-zone`,t),r.draw=Q(`.pile-draw`,t),r.discard=Q(`.pile-discard`,t),r.exhaust=Q(`.pile-exhaust`,t),r.lantern=Q(`.lantern-btn`,t);let s=Hu[Z.run.art];s&&(Q(`.lb-art`,r.lantern).innerHTML=`<i>${J(`art-${Z.run.art}`,16)}</i>${s.cost}`,Q(`.lb-art`,r.lantern).style.color=s.tone),r.lantern._tip={title:s?`Lantern Art — ${s.name}`:`The Lantern`,body:`${s?`<b>${s.cost} Embers, once a turn:</b> ${s.text}<br><br>`:``}The lantern holds the <b>Embers</b> spilled by shattered and slain glass. Drag any card onto it to <b>kindle</b> — burn the card away for an ember, once a turn. Curses refuse the fire.`,sub:`A · use Art`},r.lantern.onclick=async()=>{if(!(Z.busy||!Z.cb||Z.cb.over)){if(d_(),!kh(Z.run,Z.cb)){r.lantern.classList.add(`nope`),setTimeout(()=>r.lantern.classList.remove(`nope`),350),X.debuff();return}ty(),Ah(Z.run,Z.cb),await My(),Fy()}},Z.ce=r,Fv(a),py(),hy(),setTimeout(()=>r.root.classList.remove(`intro`),1300),r.endTurn.onclick=iy,r.draw.onclick=()=>{X.click(),hv(`Draw Pile`,e.draw,{sub:`Order hidden — shown alphabetically`,inCombat:!0})},r.discard.onclick=()=>{X.click(),hv(`Discard Pile`,e.discard,{inCombat:!0})},r.exhaust.onclick=()=>{X.click(),hv(`The Ashes`,e.exhaust,{sub:`Burned away — each fed the lantern an ember`,inCombat:!0})},r.root.addEventListener(`pointerdown`,e=>{e.target.closest(`.enemy`)||e.target.closest(`.card`)||(Z.targeting?ty():Z.hoveredCard!=null&&(Z.hoveredCard=null,Uv()))}),Vv(),Hv()}var Nv=e=>Wf(Z.ce.enemies[e].art),Pv=()=>Wf(Z.ce.hero);function Fv(e){let t=Z.cb,n=Z.ce;if(!t||!n||Z.screen!==`combat`)return;let r=e??D_(x().shape,Z.run.act);n.root.style.setProperty(`--ground-y`,`${r.groundY}px`),n.root.style.setProperty(`--ledge-lip`,`${r.ledgeLip}px`);for(let e of[`backdrop`,`mid`,`ledge`]){let t=n.root.querySelector(`.sl-${e}`);if(!t)continue;let i=r.layers[e];t.style.height=`${i.h}px`,t.style.left=i.x?`calc(50% + ${i.x}px)`:``,t.style.bottom=e===`ledge`?`${Math.max(0,r.groundY+r.ledgeLip-i.h+i.y)}px`:`${i.y}px`,t.style.opacity=i.opacity,t.style.scale=i.zoom===1?``:String(i.zoom),t.style.objectPosition=`${i.posX}% ${i.posY}%`,t.style.setProperty(`--amp`,`${i.drift}px`)}let i=k_(`heroes`,Wu[Z.run.aspect].id),a=Math.round(r.hero.w*i.scale),o=Math.round(r.hero.h*i.scale),s=n.root.querySelector(`.player-zone`);s.style.width=`${a}px`,s.style.height=`${o}px`,s.style.left=`${Math.round(r.hero.x-a/2)}px`,s.style.bottom=`${O_(r)+i.footY}px`;let c=A_(r,t.enemies.length),l=N_(c,t.enemies.map(e=>e.key));t.enemies.forEach((e,t)=>{let i=Fu[e.key],a=i.boss?`boss`:i.elite?`elite`:`normal`,o=P_(r,e.key,a,c[t],_(),v()),s=n.enemies[t].root;s.style.left=`${Math.round(c[t].x-o/2+j_(c[t],e.key))}px`,s.style.bottom=`${(c[t].y??0)+M_(c[t],e.key)}px`,s.style.width=s.style.height=`${o}px`,s.style.zIndex=String(l[t]),n.enemies[t].art.style.width=n.enemies[t].art.style.height=`${o}px`})}function Iv(){Fv(),Uv(),hy()}var Lv=0;addEventListener(`resize`,()=>{clearTimeout(Lv),Lv=setTimeout(()=>{Z.cb&&Z.ce&&Z.screen===`combat`&&Iv()},120)});function Rv(e,t,n){e.innerHTML=``;for(let[n,r]of Object.entries(t)){if(!r)continue;let t=ju[n]||{name:n,icon:`?`,kind:`buff`,desc:``},i=n===`str`&&r<0?`debuff`:t.kind,a=bg(`statuses`,n),o=a?`<img class="schip-art" src="${a}" alt="">`:Vg(`st-${n}`)?J(`st-${n}`,28):t.icon,s=Math.abs(r)>=2?`<span class="n">${r}</span>`:``,c=$(`span`,`schip ${i}`,`${o}${s}`);c._tip={title:t.name,body:t.desc.replace(/\bN\b/g,Math.abs(r)),sub:i===`debuff`?`Debuff`:`Buff`},e.appendChild(c)}}function zv(e){let t=Z.cb,n=wh(e),r=$h(Z.run,t,e),i={attack:J(`sword`,19),block:J(`shield`,19),buff:J(`up`,19),debuff:J(`cloud`,19),heal:J(`plus`,19)}[n.intent]||J(`sword`,19),a=``;n.intent.startsWith(`attack`)&&(i=J(`sword`,19),a=r.times>1?`${r.dmg}×${r.times}`:`${r.dmg}`,n.intent===`attack_debuff`&&(i+=J(`cloud`,14)),n.intent===`attack_block`&&(i+=J(`shield`,14)),n.intent===`attack_buff`&&(i+=J(`up`,14)));let o=[];return r&&o.push(`attack for <b>${r.dmg}${r.times>1?`×${r.times}`:``}</b>`),n.block&&o.push(`gain Ward`),n.heal&&o.push(`heal itself`),n.fx?.some(e=>e.who===`player`)&&o.push(`afflict you`),n.fx?.some(e=>e.who!==`player`)&&o.push(`empower`),n.addCards&&o.push(`add ${n.addCards.n} ${ku[n.addCards.id].name}s to your discard`),{icon:i,txt:a,tip:{title:n.name,body:`Intends to ${o.join(`, `)||`act`}.`}}}function Bv(e,t=0){if(e.facetMax>8)return`<span class="pipnum">${J(`facet`,11)} ${e.chips}${t?`<i>+${t}</i>`:``}/${e.facetMax}</span>`;let n=``;for(let r=0;r<e.facetMax;r++)n+=`<span class="pip${r<e.chips?` filled`:r<e.chips+t?` willchip`:``}"></span>`;return n}function Vv(){let e=Z.cb,t=Z.ce;if(!t)return;e.enemies.forEach((e,n)=>{let r=t.enemies[n],i=`${100*Math.max(0,e.hp)/e.maxHp}%`;if(r.fill.style.width=i,r.ghost.style.width=i,r.hp.textContent=`${Math.max(0,e.hp)}/${e.maxHp}`,r.block.classList.toggle(`zero`,e.block<=0),r.block.innerHTML=`${J(`shield`,13)} ${e.block}`,r.art.classList.toggle(`warded`,e.block>0),r.root.classList.toggle(`lowhp`,e.hp>0&&e.hp/e.maxHp<=.3),Rv(r.statuses,e.statuses,!1),e.hp>0?r.facets.innerHTML=Bv(e):r.facets.innerHTML=``,e.hp<=0&&r.reaped&&r.root.classList.add(`gone`),e.hp>0&&e.flags.staggered)r.intent.className=`intent i-staggered`,r.intent.innerHTML=`<span class="ic">${J(`stagger`,19)}</span>STAGGERED`,r.intent._tip={title:`Staggered`,body:`The glass has shattered — this creature loses its next action while it reseams.`};else if(e.hp>0&&e.moveKey){let t=zv(e);r.intent.className=`intent i-${wh(e).intent}`,r.intent.innerHTML=`<span class="ic">${t.icon}</span>${t.txt}`,r.intent._tip=t.tip}else r.intent.innerHTML=``}),t.lantern&&(Q(`.lb-count`,t.lantern).textContent=e.embers,Q(`.lb-pips`,t.lantern).innerHTML=Array.from({length:e.emberCap},(t,n)=>`<span class="lbp${n<e.embers?` lit`:``}" style="--a:${Math.round(n/(e.emberCap-1)*280-140)}deg"></span>`).join(``),t.lantern.classList.toggle(`unlit`,e.embers===0),t.lantern.classList.toggle(`ready`,kh(Z.run,e)),t.lantern.classList.toggle(`art-spent`,e.artUsedTurn===e.turn&&!e.over));let n=e.player,r=`${100*Math.max(0,n.hp)/n.maxHp}%`;t.pFill.style.width=r,t.pGhost.style.width=r,t.pHp.textContent=`${Math.max(0,n.hp)}/${n.maxHp}`,t.pBlock.classList.toggle(`zero`,n.block<=0),t.pBlock.innerHTML=`${J(`shield`,13)} ${n.block}`,t.hero.classList.toggle(`warded`,n.block>0),t.hero.classList.toggle(`lowhp`,n.hp/n.maxHp<=.3),Rv(t.pStatus,n.statuses,!0),Q(`.num`,t.energy).textContent=n.energy,t.energy.classList.toggle(`spent`,n.energy===0);let i=Q(`.candles`,t.energy),a=Math.max(n.energyMax,n.energy);i.children.length!==a&&(i.innerHTML=Array.from({length:a},()=>`<span class="candle"></span>`).join(``)),[...i.children].forEach((e,t)=>e.classList.toggle(`lit`,t<n.energy)),Q(`.cnt`,t.draw).textContent=e.draw.length,Q(`.cnt`,t.discard).textContent=e.discard.length,Q(`.cnt`,t.exhaust).textContent=e.exhaust.length}function Hv(){let e=Z.cb,t=Z.ce;if(!t)return;let n=t.hand,r=new Map(R_(`.card`,n).map(e=>[e.dataset.uid,e])),i=new Set(e.hand.map(e=>String(e.uid)));for(let[e,t]of r)i.has(e)||t.remove();for(let t of e.hand)if(r.has(String(t.uid))){let e=iv(t,{inCombat:!0}),n=r.get(String(t.uid));n.replaceChildren(...e.childNodes),n.className=e.className+(n.classList.contains(`armed`)?` armed`:``),n.onclick=e=>{e.stopPropagation(),Qv(t.uid)},L_&&(n.onmouseenter=()=>{Z.hoveredCard=t.uid,Uv()},n.onmouseleave=()=>{Z.hoveredCard===t.uid&&(Z.hoveredCard=null),Uv()})}else{let e=iv(t,{inCombat:!0});e.classList.add(`draw-in`),setTimeout(()=>e.classList.remove(`draw-in`),400),e.onclick=e=>{e.stopPropagation(),Qv(t.uid)},L_&&(e.onmouseenter=()=>{Z.hoveredCard=t.uid,X.hover(),Uv()},e.onmouseleave=()=>{Z.hoveredCard===t.uid&&(Z.hoveredCard=null),Uv()}),Gv(e,t.uid),n.appendChild(e)}Uv()}function Uv(){let e=Z.cb,t=Z.ce;if(!t)return;let n=e.hand.map(e=>String(e.uid)),r=new Map(R_(`.card`,t.hand).map(e=>[e.dataset.uid,e])),i=n.length,a=Math.min(112,640/Math.max(i,1),(_()-246)/Math.max(i-1,1));n.forEach((t,n)=>{let o=r.get(t);if(!o)return;let s=e.hand[n],c=!Vm(s).unplayable&&(Hh(Z.run,e,s)??99)<=e.player.energy;o.classList.toggle(`unplayable-now`,!c);let l=Z.targeting?.kind===`card`&&String(Z.targeting.uid)===t,u=Z.hoveredCard!=null&&String(Z.hoveredCard)===t,d=i>1?(n-(i-1)/2)*Math.min(5,42/i):0,f=(n-(i-1)/2)*a,p=Math.abs(d)*3.2;o.classList.toggle(`armed`,l),o.classList.toggle(`lifted`,u&&!Z.busy&&!l),o.style.transform=`translateX(calc(-50% + ${l?f*.4:f}px)) translateY(${p+26}px) rotate(${l?d*.5:d}deg)`,o.style.zIndex=u||l?40:20+n}),Zv()}var Wv=0;function Gv(e,t){e.addEventListener(`pointerdown`,n=>{if(!(Z.busy||!Z.cb||Z.cb.over||!n.isPrimary||Z.drag)){Z.drag={uid:t,id:n.pointerId,x0:n.clientX,y0:n.clientY,live:!1,free:!1};try{e.setPointerCapture(n.pointerId)}catch{}}}),e.addEventListener(`pointermove`,n=>{let r=Z.drag;if(!(!r||r.uid!==t||n.pointerId!==r.id)){if(!r.live){r.y0-n.clientY>26&&Jv(r,e);return}if(r.free){let t=S(n.clientX,n.clientY);e.style.transform=`translate(calc(-50% + ${t.x-_()/2}px), ${t.y-v()+130}px) scale(1.12)`;let i=!!qv(n.clientX,n.clientY)?.closest(`.lantern-btn`);e.classList.toggle(`will-burn`,i),e.classList.toggle(`will-cast`,!r.kindleOnly&&!i&&t.y<Kv())}else ny(n),Xv(n.clientX,n.clientY)}});let n=(n,r)=>{let i=Z.drag;if(!i||i.uid!==t||n.pointerId!==i.id||(Z.drag=null,!i.live))return;if(Wv=performance.now(),e.classList.remove(`dragging`,`will-cast`,`will-burn`),Z.ce?.lantern?.classList.remove(`kindle-target`),r){ty(),Uv();return}if(qv(n.clientX,n.clientY)?.closest(`.lantern-btn`)){let e=Z.cb.hand.find(e=>e.uid===t);if(e&&Mh(Z.run,Z.cb,e)){ty(),Yv(t);return}ty(),Uv();return}if(i.kindleOnly){Z.hoveredCard=null,Uv();return}if(i.free){S(n.clientX,n.clientY).y<Kv()?ry(t,null):(Z.hoveredCard=null,Uv());return}let a=document.elementFromPoint(n.clientX,n.clientY)?.closest(`.enemy`),o=a?+a.dataset.idx:-1,s=Z.cb.enemies.filter(e=>e.hp>0);o>=0&&Z.cb.enemies[o].hp>0?ry(t,o):s.length===1&&S(n.clientX,n.clientY).y<Kv()?ry(t,s[0].idx):(ty(),Uv())};e.addEventListener(`pointerup`,e=>n(e,!1)),e.addEventListener(`pointercancel`,e=>n(e,!0))}var Kv=()=>Z.ce?.hand?C(Z.ce.hand).top-24:v()-260,qv=(e,t)=>document.elementsFromPoint(e,t).find(e=>!e.closest(`.card`));function Jv(e,t){let n=Z.cb,r=n.hand.find(t=>t.uid===e.uid);if(!r){Z.drag=null;return}let i=Vm(r);if(i.unplayable||Hh(Z.run,n,r)>n.player.energy){if(Mh(Z.run,n,r)){e.live=!0,e.free=!0,e.kindleOnly=!0,Z.hoveredCard=null,X.hover(),t.classList.add(`dragging`),Z.ce?.lantern?.classList.add(`kindle-target`);return}Z.drag=null,t.classList.add(`nope`),setTimeout(()=>t.classList.remove(`nope`),350),X.debuff();return}e.live=!0,Z.hoveredCard=null,X.hover(),Mh(Z.run,n,r)&&Z.ce?.lantern?.classList.add(`kindle-target`),i.target===`enemy`?ey({kind:`card`,uid:e.uid}):(e.free=!0,ty(),t.classList.add(`dragging`))}async function Yv(e){if(Z.hoveredCard=null,!Ph(Z.run,Z.cb,e)){Uv();return}await My(),Fy()}function Xv(e,t){let n=document.elementFromPoint(e,t)?.closest(`.enemy`);Z.ce?.enemies.forEach(e=>e.root.classList.toggle(`target-hover`,e.root===n&&e.root.classList.contains(`targetable`))),Zv()}function Zv(){let e=Z.ce,t=Z.cb;if(!e||!t)return;let n=null;Z.targeting?.kind===`card`?n=t.hand.find(e=>e.uid===Z.targeting.uid):Z.drag?.live?n=t.hand.find(e=>e.uid===Z.drag.uid):Z.hoveredCard!=null&&!Z.busy&&(n=t.hand.find(e=>e.uid===Z.hoveredCard));let r=n?Vm(n):null,i=Z.targeting?.kind===`card`||Z.drag?.live&&!Z.drag.free,a=t.enemies.filter(e=>e.hp>0).length,o=!!(n&&!t.over&&!r.unplayable&&!i);Om();let s=o&&r.target===`self`;if(e.hero?.classList.toggle(`aim-target`,s),s){let t=Q(`.hero-sprite`,e.hero)||e.hero,n=Wu[Z.run.aspect].id;Dm(t,!0,fp(n))?e.hero.classList.add(`aim-mesh`):e.hero.classList.remove(`aim-mesh`)}else e.hero?.classList.remove(`aim-mesh`);t.enemies.forEach((s,c)=>{let l=e.enemies[c],u=null,d=!1;n&&!t.over&&s.hp>0&&!r.unplayable&&(r.target===`allEnemies`?u=eg(Z.run,t,n,c):r.target===`enemy`&&(i||a===1)&&(u=eg(Z.run,t,n,c),d=i&&a>1&&!l.root.classList.contains(`target-hover`)));let f=l.root.classList.contains(`target-hover`),p=r?.target===`allEnemies`&&(o||Z.drag?.live&&Z.drag.free),m=r?.target===`enemy`&&(a===1||i&&f),h=!!(n&&!t.over&&!r.unplayable&&s.hp>0&&(p||m));if(l.root.classList.toggle(`aim-target`,h),h&&Dm(Q(`.enemy-sprite`,l.art)||l.art,!0,fp(s.key))?l.root.classList.add(`aim-mesh`):l.root.classList.remove(`aim-mesh`),u&&(u.total>0||u.chips>0)){l.prev.classList.remove(`show`,`lethal`,`dim`),l.prev.innerHTML=``,l.root.classList.toggle(`marked`,u.lethal&&!d);let e=Math.min(s.hp,u.loss)/s.maxHp;l.pv.style.left=`${Math.max(0,s.hp-u.loss)/s.maxHp*100}%`,l.pv.style.width=`${e*100}%`,l.pv.classList.toggle(`show`,u.loss>0),l.facets.innerHTML=Bv(s,d?0:u.chips),l.facets.classList.toggle(`willshatter`,u.willShatter&&!d)}else l.prev.classList.remove(`show`,`lethal`,`dim`),l.root.classList.remove(`marked`),l.pv.classList.remove(`show`),s.hp>0&&(l.facets.innerHTML=Bv(s)),l.facets.classList.remove(`willshatter`)})}function Qv(e){if(Z.busy||!Z.cb||Z.cb.over||performance.now()-Wv<350)return;let t=Z.cb,n=t.hand.find(t=>t.uid===e);if(!n)return;if(I_&&Z.hoveredCard!==e&&!(Z.targeting?.kind===`card`&&Z.targeting.uid===e)){Z.hoveredCard=e,X.hover(),Uv();return}let r=Vm(n),i=Hh(Z.run,t,n),a=Q(`.card[data-uid="${e}"]`,Z.ce.hand);if(r.unplayable||i>t.player.energy){a?.classList.add(`nope`),setTimeout(()=>a?.classList.remove(`nope`),350),X.debuff();return}if(Z.targeting?.kind===`card`&&Z.targeting.uid===e)return ty();if(r.target===`enemy`){let n=t.enemies.filter(e=>e.hp>0);if(n.length===1)return void ry(e,n[0].idx);ey({kind:`card`,uid:e})}else ry(e,null)}function $v(e){if(!Z.targeting||Z.busy)return;let t=Z.cb.enemies[e];if(!t||t.hp<=0)return;let n=Z.targeting;n.kind===`card`?ry(n.uid,e):n.kind===`potion`&&dv(n.slot,e)}function ey(e){if(Z.targeting=e,Z.ce.root.classList.add(`targeting`),Z.cb.enemies.forEach((e,t)=>Z.ce.enemies[t].root.classList.toggle(`targetable`,e.hp>0)),Uv(),document.addEventListener(`pointermove`,ny),ny._last)ny(ny._last);else{let e=Z.cb.enemies.findIndex(e=>e.hp>0);if(e>=0){let t=Nv(e);ny({clientX:t.x,clientY:t.y,synthetic:!0})}}}function ty(){Z.targeting=null,Q(`#aim`).innerHTML=``,document.removeEventListener(`pointermove`,ny),Om(),Z.ce&&(Z.ce.root.classList.remove(`targeting`),Z.ce.enemies.forEach(e=>e.root.classList.remove(`targetable`,`target-hover`,`aim-target`,`aim-mesh`)),Z.ce.hero?.classList.remove(`aim-target`,`aim-mesh`),Uv()),av()}function ny(e){if(e.synthetic||(ny._last=e),!Z.targeting)return;let t;if(Z.targeting.kind===`card`){let e=Q(`.card[data-uid="${Z.targeting.uid}"]`);t=e?Wf(e):{x:_()/2,y:v()-200}}else t={x:_()/2,y:60};let{x:n,y:r}=e.synthetic?{x:e.clientX,y:e.clientY}:S(e.clientX,e.clientY),i=(t.x+n)/2,a=Math.min(t.y,r)-120;if(Q(`#aim`).innerHTML=`<path d="M${t.x} ${t.y-80} Q${i} ${a} ${n} ${r}" fill="none" stroke="rgba(255,89,100,.85)" stroke-width="4" stroke-dasharray="4 10" stroke-linecap="round"/>
    <circle cx="${n}" cy="${r}" r="9" fill="none" stroke="rgba(255,89,100,.95)" stroke-width="3"/>`,Z.ce?.hero){let e=Wf(Z.ce.hero),t=Q(`#lantern`);t.style.setProperty(`--lx`,`${Math.round(e.x+(n-e.x)*.3)}px`),t.style.setProperty(`--ly`,`${Math.round(e.y+(r-e.y)*.3)}px`)}}async function ry(e,t){ty(),Z.hoveredCard=null,Wh(Z.run,Z.cb,e,t)&&(await My(t),Fy())}async function iy(){Z.busy||!Z.cb||Z.cb.over||(ty(),X.click(),Jh(Z.run,Z.cb),await My(),Fy())}function ay(e){let t=$(`div`,`turn-banner`,e);B_().appendChild(t),setTimeout(()=>t.remove(),1150)}function oy(e,t,n,r,{n:i=6,color:a=`#ffe9ac`,size:o=8,dur:s=640,glyph:c=``,cls:l=`flymote`,done:u=null}={}){let d=Q(`#floaties`);for(let f=0;f<i;f++){let p=$(`div`,l,c);p.style.left=`${e}px`,p.style.top=`${t}px`,c?p.style.color=a:(p.style.width=`${o}px`,p.style.height=`${o}px`,p.style.background=`radial-gradient(circle at 35% 30%, #fff, ${a} 55%, transparent 85%)`),d.appendChild(p);let m=(e+n)/2+(Math.random()-.5)*140,h=Math.min(t,r)-50-Math.random()*80,g=p.animate([{transform:`translate(-50%,-50%) scale(0.5)`,opacity:0},{transform:`translate(calc(-50% + ${m-e}px), calc(-50% + ${h-t}px)) scale(1.05)`,opacity:1,offset:.45},{transform:`translate(calc(-50% + ${n-e}px), calc(-50% + ${r-t}px)) scale(0.55)`,opacity:.95}],{duration:s,delay:f*46,easing:`cubic-bezier(.32,.05,.35,1)`});g.onfinish=()=>{p.remove(),f===i-1&&u&&u()}}}var sy=matchMedia(`(prefers-reduced-motion: reduce)`).matches;function cy(e,t,n,r=640){if(t=Math.round(t),n=Math.round(n),sy||t===n){e.textContent=n;return}let i=performance.now(),a=o=>{let s=Math.min(1,(o-i)/r),c=1-(1-s)**3;e.textContent=Math.round(t+(n-t)*c),s<1?requestAnimationFrame(a):(e.textContent=n,e.classList.remove(`tick`),e.offsetWidth,e.classList.add(`tick`))};requestAnimationFrame(a)}function ly(e){let t=getComputedStyle(e).transform;if(!t||t===`none`)return 0;let n=t.match(/matrix(?:3d)?\(([^)]+)\)/);if(!n)return 0;let r=n[1].split(`,`).map(e=>parseFloat(e.trim())),i=r.length===16?r[13]:r[5];return Math.max(0,-i)}function uy(e,t){let n=$(`div`,`cast-shadow`);if(e){let t=document.createElement(`img`);t.src=e,t.alt=``,t.setAttribute(`aria-hidden`,`true`),n.appendChild(t)}else if(t){let e=t.cloneNode(!0);e.setAttribute(`aria-hidden`,`true`),n.appendChild(e)}else n.classList.add(`cast-shadow-blob`);return n}function dy(e){if(!e.shadow||!e.art)return;let t=C(e.art);e.shadow.style.left=`${t.left}px`,e.shadow.style.top=`${t.top}px`,e.shadow.style.width=`${t.width}px`,e.shadow.style.height=`${t.height}px`}function fy(e,t){if(!e.shadow||!e.shadowId)return;dy(e);let n=lp(e.shadowId),r=e.shadowMax||16,i=Math.min(1,t/r),a=n.sx*(1-i*.26),o=n.sy*(1-i*.5),s=n.opacity*(1-i*.55),c=n.blur+i*2.8,l=n.skew*(1-i*.35),u=n.dx+n.skew*.35*(1-i*.5),d=n.dy;e.shadow.style.setProperty(`--foot-ox`,`${n.ox}%`),e.shadow.style.setProperty(`--foot-oy`,`${n.oy}%`),e.shadow.style.setProperty(`--sh-sx`,a.toFixed(3)),e.shadow.style.setProperty(`--sh-sy`,o.toFixed(3)),e.shadow.style.setProperty(`--sh-o`,s.toFixed(3)),e.shadow.style.setProperty(`--sh-blur`,`${c.toFixed(1)}px`),e.shadow.style.setProperty(`--sh-skew`,`${l.toFixed(2)}deg`),e.shadow.style.setProperty(`--sh-x`,`${u.toFixed(1)}px`),e.shadow.style.setProperty(`--sh-y`,`${d}px`)}function py(){let e=Z.ce,t=Z.cb;e.rig=[];let n=Q(`.cast-shadow-layer`,e.root);n&&(n.innerHTML=``);let r=(t,r,i,a,o,s,c=0,l=``,u=``,d=0)=>{let f=Q(`svg`,r),p=Q(`.enemy-sprite`,r)||r,m=Q(`.raster-art`,p);if(!f&&!m)return;let h=Math.random()*100;if(f){let e=Q(`.breathe`,f);e&&(e.style.animationDuration=`${(2.5+h%1.9).toFixed(2)}s`,e.style.animationDelay=`${(-(h%3.1)).toFixed(2)}s`,e.style.setProperty(`--brY`,(1.022+h%.024).toFixed(3)),e.style.setProperty(`--sw`,`${(h*7%1.7-.85).toFixed(2)}deg`)),R_(`.hover-float`,f).forEach(e=>e.style.animationDelay=`${(-(h%2.7)).toFixed(2)}s`)}else if(s){p.classList.add(`idle-${s}`),p.style.animationDelay=`${(-(h%2.8)).toFixed(2)}s`;let e=u?dp(u):null;if(e!=null&&p.style.setProperty(`--float-y`,`${e}px`),s===`wisp`||s===`plant`){let e=$(`div`,`idle-motes`);e.style.setProperty(`--mote`,`hsla(${c},85%,62%,0.6)`),p.appendChild(e)}}let g=uy(l||m?.src||``,f);(n||r).appendChild(g);let _={root:t,art:r,sprite:p,svg:f,eyes:f?R_(`.eye`,f):[],fire:f?Q(`.innerfire`,f):null,pool:null,shadow:g,shadowId:u,footY:d,shadowMax:{wisp:20,eye:20,siren:14,shade:14,plant:10,slime:6}[s]||12,seed:h,isHero:a,idx:o,dx:0,dy:0};e.rig.push(_),fy(_,0)},i=A_(D_(x().shape,Z.run.act),t.enemies.length);t.enemies.forEach((t,n)=>{let a=Fu[t.key].art;r(e.enemies[n].root,e.enemies[n].art,`hsla(${a.hue},90%,66%,.72)`,!1,n,a.kind,a.hue,bg(`enemies`,t.key),t.key,M_(i[n],t.key))});let a=Wu[Z.run.aspect].id;r(e.hero,e.hero,`rgba(127,212,255,.62)`,!0,0,`humanoid`,0,bg(`heroes`,a),a,k_(`heroes`,a).footY)}function my(){if(!yp())return;let e=Z.ce,t=Z.cb;if(!e||!t)return;let n=[],r=bg(`heroes`,Wu[Z.run.aspect].id),i=e.hero&&(Q(`.hero-sprite`,e.hero)||e.hero);r&&i&&n.push({el:i,url:r,kind:`humanoid`,id:Wu[Z.run.aspect].id}),t.enemies.forEach((t,r)=>{let i=bg(`enemies`,t.key),a=e.enemies[r]?.art,o=a&&(Q(`.enemy-sprite`,a)||a);i&&o&&n.push({el:o,url:i,kind:Fu[t.key].art.kind,id:t.key})}),Tm(n)}function hy(){requestAnimationFrame(()=>requestAnimationFrame(my))}function gy(){mm()}var _y=!1;function vy(e){if(_y)return;requestAnimationFrame(vy);let t=Z.ce,n=Z.cb;if(sy||!n||Z.screen!==`combat`||!t?.rig)return;let r=null,i=n.enemies.findIndex(e=>e.hp>0);Z.targeting&&ny._last?r=S(ny._last.clientX,ny._last.clientY):i>=0&&(r=Nv(i));let a=Pv();for(let i of t.rig){let t=i.isHero?n.player:n.enemies[i.idx];if(!i.isHero&&t.hp<=0){i.pool&&(i.pool.style.opacity=0),i.shadow&&(i.shadow.style.opacity=0);continue}let o=ly(i.sprite);i.sprite.classList.contains(`mesh-live`)&&(o+=Em(i.sprite)),fy(i,o);let s=i.isHero?r:a;if(s&&i.eyes.length){let e=Wf(i.art),t=Math.atan2(s.y-e.y,s.x-e.x);i.dx+=(Math.cos(t)*2.4-i.dx)*.08,i.dy+=(Math.sin(t)*1.6-i.dy)*.08;let n=`translate(${i.dx.toFixed(2)}px,${i.dy.toFixed(2)}px)`;for(let e of i.eyes)e.style.transform=n}let c=.45+.55*(Math.max(0,t.hp)/t.maxHp);i.root.dataset.choreo===`attack`&&(c+=1.1),(t.statuses?.str||0)>0&&(c+=.3);let l=.86+.14*Math.sin(e*.006+i.seed)*Math.sin(e*.0021+i.seed*3);i.fire&&(i.fire.style.opacity=Math.min(.55,(.05+.13*c)*l).toFixed(3)),i.pool&&(i.pool.style.opacity=Math.min(.85,(.3+.4*c)*l).toFixed(3))}}var yy=!1,by={archetype:`slash`,cardId:null,enemyIdx:null},xy=!1,Sy=!1,Cy=0,wy={beast:`slash`,rogue:`slash`,knight:`slash`,sovereign:`slash`,golem:`blunt`,treeboss:`blunt`,crab:`blunt`,leviathan:`blunt`,zombie:`blunt`,serpent:`pierce`,crawler:`pierce`,maw:`pierce`,plant:`pierce`,wisp:`void`,shade:`void`,eye:`void`,siren:`void`,cultist:`void`,slime:`poison`},Ty=matchMedia(`(prefers-reduced-motion: reduce)`).matches,Ey=new Set([`golem`,`treeboss`,`leviathan`,`crab`]),Dy=new Set([`wisp`,`shade`,`siren`,`eye`,`cultist`]);function Oy(e,t=1,n=`humanoid`){if(Ty||!e)return Promise.resolve();let r=Ey.has(n),i=Dy.has(n),a=r?[{transform:`translateX(0) scale(1,1)`},{transform:`translateX(0) scale(1.08,0.86)`,offset:.35},{transform:`translateX(0) scale(1,1)`}]:i?[{transform:`translateX(0) translateY(0) scale(1,1)`},{transform:`translateX(${6*t}px) translateY(-5px) scale(0.98,1.02)`,offset:.4},{transform:`translateX(${10*t}px) translateY(-2px) scale(1,1)`,offset:.7},{transform:`translateX(0) translateY(0) scale(1,1)`}]:[{transform:`translateX(0) scale(1,1)`},{transform:`translateX(${-8*t}px) scale(0.97,1.02)`,offset:.3},{transform:`translateX(${34*t}px) scale(1.02,0.99)`,offset:.62},{transform:`translateX(0) scale(1,1)`}];return e.dataset.choreo=`attack`,e.animate(a,{duration:r?420:i?380:330,easing:`cubic-bezier(0.34, 1.56, 0.64, 1)`}).finished.finally(()=>{delete e.dataset.choreo}).catch(()=>{})}function ky(e,t=1){Ty||!e||(gm(e),e.animate([{transform:`translateX(0) scale(1,1)`,filter:`brightness(1)`},{transform:`translateX(${9*t}px) scale(0.97,1.03)`,filter:`brightness(1.9)`,offset:.25},{transform:`translateX(0) scale(1,1)`,filter:`brightness(1)`}],{duration:300,easing:`cubic-bezier(0.22, 1, 0.36, 1)`}))}function Ay(e){return Ty||!e?Promise.resolve():e.animate([{transform:`translateY(0) rotate(0deg)`,filter:`brightness(1)`},{transform:`translateY(5px) rotate(-2.5deg)`,filter:`brightness(0.6)`}],{duration:360,easing:`cubic-bezier(0.22, 1, 0.36, 1)`,fill:`forwards`}).finished.catch(()=>{})}function jy(e,t=200){if(yp()&&xm(e.root,0)){for(let t=0;t<3;t++)bm(e.art);let n=performance.now(),r=()=>{let i=Math.min(1,(performance.now()-n)/t),a=i*i*(3-2*i);xm(e.root,a)&&i<1&&requestAnimationFrame(r)};requestAnimationFrame(r);return}hm(e.root);let n=e.art&&Q(`.cracks`,e.art);n&&(n.insertAdjacentHTML(`beforeend`,Dg(!0)),n.children.length<9&&n.insertAdjacentHTML(`beforeend`,Dg(!0))),e.root.classList.add(`igniting`)}async function My(e=null){let t=Z.cb,n=Z.ce;Z.busy=!0,n.endTurn.classList.add(`enemy-phase`);let r=t.queue;for(;r.length;){let t=r.shift();try{await Py(t,e)}catch(e){console.error(`vfx event error`,t,e)}}Z.busy=!1,t.over||n.endTurn.classList.remove(`enemy-phase`),Vv(),Hv(),ov()}var Ny=null;async function Py(e,t){let n=Z.cb,r=Z.ce;switch(e.t){case`chip`:{let t=r.enemies[e.idx],{x:n,y:i}=Nv(e.idx);X.chip(),Nf(n,i,{color:`#e8f4ff`,n:5,speed:190,size:1.8,grav:240,kind:`spark`}),Vv(),t.facets.classList.remove(`pop`),t.facets.offsetWidth,t.facets.classList.add(`pop`),await z_(110);break}case`shatter`:{let t=r.enemies[e.idx],{x:n,y:i}=Nv(e.idx);Ny={x:n,y:i},X.shatter(),jf(90),Pf(n,i,`#dfeaff`,10,700,5),Nf(n,i,{color:`#dfeaff`,n:26,speed:430,size:2.4,grav:300,kind:`spark`}),Lf(n,i-58,`${J(`stagger`,20)} SHATTER`,`shatterf`),Af(10),tf(.9),t.art,t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),Vv(),await z_(380);break}case`adamantHold`:{let{x:t,y:n}=Nv(e.idx);X.blocked(),Lf(t,n-52,`THE GLASS HOLDS`,`blockedf`),Pf(t,n,`#d8c27a`,8,480,4),Vv(),await z_(260);break}case`ember`:if(e.n>0&&r.lantern){let t=Ny||Pv(),n=Wf(r.lantern);oy(t.x,t.y,n.x,n.y,{n:Math.min(e.n*2,5),color:`#ffb35a`,size:6,dur:460}),X.ember(),setTimeout(()=>{r.lantern.classList.remove(`pop`),r.lantern.offsetWidth,r.lantern.classList.add(`pop`),Vv()},440),await z_(300)}else Vv();Ny=null;break;case`kindle`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand);t&&(Ny=Wf(t)),X.kindle(),await z_(60);break}case`art`:{by={archetype:`fire`,cardId:`art:${e.id}`,enemyIdx:null},xy=!1;{let{x:t,y:n}=Wf(r.lantern);Qf[`art:${e.id}`]?.(t,n),xy=!0}let t=Hu[e.id],{x:n,y:i}=Pv(),a=r.lantern?Wf(r.lantern):{x:n,y:i};X.art(),Mf(t.tone,.12,.5),Pf(a.x,a.y,t.tone,10,620,5),If(n,i,t.tone,12),Lf(n,i-84,t.name.toUpperCase(),`artf`);let o=bg(`arts`,e.id);if(o){let e=$(`img`,`art-cast`);e.src=o,Q(`#floaties`).appendChild(e),e.style.left=`${n}px`,e.style.top=`${i-30}px`,e.animate([{transform:`translate(-50%,-50%) scale(0.4)`,opacity:0},{transform:`translate(-50%,-58%) scale(1)`,opacity:1,offset:.3},{transform:`translate(-50%,-70%) scale(1.05)`,opacity:0}],{duration:900,easing:`cubic-bezier(.2,.7,.3,1)`}).onfinish=()=>e.remove()}tf(.7),Vv(),await z_(420);break}case`staggered`:{let t=r.enemies[e.idx],{x:n,y:i}=Nv(e.idx);X.stagger(),Lf(n,i-76,`STAGGERED`,`staggerf`),t.root.classList.add(`reseaming`),setTimeout(()=>t.root.classList.remove(`reseaming`),720),Vv(),await z_(520);break}case`smolderJump`:{let t=Nv(e.from),n=Nv(e.to);X.poison(),oy(t.x,t.y,n.x,n.y,{n:5,color:`#d3a15a`,size:7,dur:460}),await z_(400);break}case`turn`:e.n>1&&(ay(`YOUR TURN`),X.turn()),Vv(),await z_(e.n>1?500:120);break;case`endTurn`:yy=!1,ay(`ENEMY TURN`),await z_(480);break;case`draw`:Hv(),Vv(),X.draw(),await z_(75);break;case`reshuffle`:{X.card();let e=Wf(r.discard),t=Wf(r.draw);oy(e.x,e.y,t.x,t.y,{n:6,cls:`flycard`,dur:520}),Lf(t.x,t.y-46,`Reshuffle`,`notice`),await z_(420);break}case`play`:{let i=Q(`.card[data-uid="${e.uid}"]`,r.hand);if(X.card(),yy=!0,Cy=0,by={archetype:ku[e.id]?.vfx||`slash`,cardId:e.id,enemyIdx:null},xy=!1,Sy=!1,!xy&&Qf[e.id]&&[`ascension`,`pyreheart`,`emberdance`,`limitBreak`].includes(e.id)){let t=n.enemies.findIndex(e=>e.hp>0),r=e.id===`limitBreak`&&t>=0?Nv(t):Pv();Qf[e.id](r.x,r.y),xy=!0}if(i&&t!=null&&n.enemies[t]){let e=C(i),{x:n,y:r}=Nv(t),a=i.cloneNode(!0);Object.assign(a.style,{position:`fixed`,left:`${e.left}px`,top:`${e.top}px`,width:`${e.width}px`,height:`${e.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(a),i.remove(),a.animate([{transform:`none`,opacity:1},{transform:`translate(${n-e.left-e.width/2}px,${r-e.top-e.height/2}px) scale(0.22) rotate(14deg)`,opacity:0}],{duration:270,easing:`cubic-bezier(.45,0,.9,.5)`}).onfinish=()=>a.remove()}else i&&(i.classList.add(`played-up`),setTimeout(()=>i.remove(),320));Vv(),await z_(200);break}case`hitEnemy`:{let t=r.enemies[e.idx],{x:i,y:a}=Nv(e.idx);if(e.poison)X.poison(),If(i,a,`#d3a15a`,14),Lf(i,a-20,`${e.amount}`,`poisonf`);else{let o=e.amount>=16;if(yy&&by.cardId&&!String(by.cardId).startsWith(`art:`)&&(Sy||=(await Oy(r.hero,1,`humanoid`),!0)),X.slash(),e.amount>0&&X.hit(),!xy&&by.cardId&&Qf[by.cardId]&&(Qf[by.cardId](i,a),xy=!0),Xf(i,a,by.archetype,Math.min(1,e.amount/24)),ky(t.root,1),e.blocked>0&&(X.blocked(),Lf(i,a+26,`${J(`shield`,19)}${e.blocked}`,`blockedf`),Nf(i,a+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`}),n.enemies[e.idx].block===0&&e.amount===0&&(Lf(i,a-2,`GUARD SHATTERED`,`shatterf`),Yf(i,a,`#9fd4ff`,14))),e.amount>0){let t=e.killingBlow&&e.overkill>=8?`dmg-overkill`:e.killingBlow?`dmg-kill`:o?`dmg-big`:`dmg`;Lf(i,a-24,`${e.amount}`,t,{tint:Gf[by.archetype]||``,dx:(Cy++%3-1)*34})}else e.blocked||Lf(i,a-24,`0`,`blockedf`);Af(Math.min(4+e.amount*.5,15)),tf(Math.min(.2+e.amount/26,1)),o&&(jf(70),Pf(i,a,`#ffd8a0`,10,620,5)),e.killingBlow&&(jf(e.overkill>=8?130:90),tf(Math.min(1.6,.6+e.overkill*.06)),Pf(i,a,`#ffffff`,8,780,5),Pf(i,a,`#ffd8a0`,14,900,4),Mf(`#ffe6b0`,.09,.28),e.overkill>=8&&(Mf(`#ffffff`,.12,.24),Nf(i,a,{color:`#fff3d6`,n:26,speed:620,size:2.6,grav:200,kind:`spark`}),Nf(i,a,{color:`#ffd76e`,n:12,speed:300,size:3.4,grav:120,kind:`spark`}))),e.amount>0&&t.art}t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),Vv(),await z_(230);break}case`die`:{let t=r.enemies[e.idx],i=n.enemies[e.idx],{x:a,y:o}=Nv(e.idx);Ny={x:a,y:o},i.boss&&(document.body.classList.add(`worldstop`),t.root.classList.add(`doomed`),jf(110),await z_(820),document.body.classList.remove(`worldstop`),t.root.classList.remove(`doomed`)),await Ay(t.art);let s=i.boss?320:200;sy||(jy(t,s),await z_(s)),(i.boss||i.elite?X.bigDeath:X.death)(),sy||xm(t.root,1);let c=yp()?Cm(t.root):null;c||hm(t.root),Uf(t.art,c||{}),Nf(a,o,{color:`#dfeaff`,n:30,speed:480,size:2.6,grav:340,kind:`spark`}),Nf(a,o,{color:`#c9b0ff`,n:26,speed:380,size:3.2,grav:60}),Pf(a,o,`#e8dcff`,12,720,6),Mf(`#ffffff`,i.boss?.24:.1,.3),Af(i.boss?22:12),tf(i.boss?2:.9),t.root.classList.add(`dying`),setTimeout(()=>{t.root.classList.remove(`dying`),t.root.classList.add(`gone`),t.reaped=!0},830),await z_(i.boss?900:500);break}case`hitPlayer`:{let{x:t,y:i}=Pv();if(e.source===`poison`?(X.poison(),If(t,i,`#d3a15a`,14)):e.source===`burn`||e.source===`self`?X.debuff():e.source===`thorns`?X.blocked():(X.slash(),e.amount>0&&(X.hit(),Mf(`#ff2233`,Math.min(.05+e.amount*.012,.3),.3)),Xf(t,i,by.archetype,Math.min(1,e.amount/24)),ky(r.hero,-1)),e.blocked>0&&(X.blocked(),Lf(t,i+30,`${J(`shield`,19)}${e.blocked}`,`blockedf`),Nf(t,i+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`}),n.player.block===0&&e.amount===0&&(Lf(t,i-2,`GUARD SHATTERED`,`shatterf`),Yf(t,i,`#9fd4ff`,14))),e.amount>0){let n=e.amount>=16;Lf(t,i-30,`${e.amount}`,n?`dmg-big`:`dmg`,{tint:Gf[by.archetype]||``,dx:(Cy++%3-1)*34}),Af(Math.min(5+e.amount*.6,18)),tf(Math.min(.3+e.amount/22,1.2))}else e.blocked||Lf(t,i-30,`0`,`blockedf`);Vv(),ov(),await z_(240);break}case`blockGain`:{let t=e.who===`player`,{x:n,y:i}=t?Pv():Nv(e.who);X.block(),X_(t?Q(`.hero-sprite`,r.hero)||r.hero:Q(`.enemy-sprite`,r.enemies[e.who]?.art)||r.enemies[e.who]?.art),Lf(n,i-10,`${J(`shield`,22)} ${e.n}`,`blockf`);let a=t?r.pBlock:r.enemies[e.who].block;a.classList.remove(`pulse`),a.offsetWidth,a.classList.add(`pulse`),Vv(),await z_(140);break}case`status`:{let{x:t,y:n}=e.who===`player`?Pv():Nv(e.who),r=ju[e.id]||{name:e.id,kind:`buff`},i=r.kind===`debuff`||e.id===`str`&&e.n<0;(e.id===`poison`?X.poison:i?X.debuff:X.buff)(),Lf(t,n-46,`${e.n>0?`+`:``}${e.n} ${r.name}`,i?`debufff`:`bufff`),i||If(t,n,`#9fc8ff`,6),Vv(),await z_(170);break}case`heal`:{let{x:t,y:n}=e.who===`player`?Pv():Nv(e.who);X.heal(),If(t,n,`#8fe8a0`,14),Lf(t,n-30,`+${e.n}`,`healf`),Vv(),ov(),await z_(200);break}case`energy`:Vv(),r.energy.classList.remove(`pop`),r.energy.offsetWidth,r.energy.classList.add(`pop`);break;case`exhaust`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand);if(t){let e=C(t),n=t.cloneNode(!0);Object.assign(n.style,{position:`fixed`,left:`${e.left}px`,top:`${e.top}px`,width:`${e.width}px`,height:`${e.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(n),t.remove(),n.animate([{clipPath:`circle(80% at 50% 55%)`,filter:`brightness(1)`},{clipPath:`circle(44% at 50% 55%)`,filter:`brightness(1.8) saturate(1.6) sepia(0.45)`,offset:.45},{clipPath:`circle(0% at 50% 55%)`,filter:`brightness(2.6) saturate(2) sepia(0.85)`}],{duration:540,easing:`ease-in`}).onfinish=()=>n.remove(),Nf(e.left+e.width/2,e.top+e.height/2,{color:`#ffb066`,n:22,speed:190,grav:-150,size:2.4,life:.85}),await z_(260)}Vv();break}case`discardHand`:{let e=R_(`.card`,r.hand);e.length&&(X.card(),e.forEach((e,t)=>{e.animate([{opacity:1},{transform:`${e.style.transform} translateX(340px) rotate(20deg)`,opacity:0}],{duration:260,delay:t*28,easing:`ease-in`}).onfinish=()=>e.remove()}),await z_(280+e.length*28)),Vv();break}case`enemyAct`:{let t=r.enemies[e.idx],{x:i,y:a}=Nv(e.idx);Cy=0;let o=Fu[n.enemies[e.idx].key]?.moves?.[e.move],s=wy[Fu[n.enemies[e.idx].key]?.art?.kind]||`slash`;by={archetype:o?.intent?.startsWith(`attack`)?s:o?.intent===`debuff`?`void`:o?.intent===`buff`||o?.intent===`block`?`ward`:s,cardId:null,enemyIdx:e.idx},xy=!1,Sy=!1,t.intent.classList.remove(`telegraph`),t.intent.offsetWidth,t.intent.classList.add(`telegraph`),Lf(i,a-90,e.name,`movef`),await z_(300),o?.intent?.startsWith(`attack`)?(await Oy(t.root,-1,Fu[n.enemies[e.idx].key]?.art?.kind),Sy=!0):await z_(320),t.intent.classList.remove(`telegraph`);break}case`intent`:Vv();break;case`addCard`:Lf(_()/2,v()*.62,`${ku[e.id].name} added to ${e.where===`hand`?`hand`:`discard`}`,`notice`),X.debuff(),Vv(),Hv(),await z_(240);break;case`relicProc`:{let t=Q(`.hud-relic[data-relic="${e.id}"]`);t&&(t.classList.remove(`proc`),t.offsetWidth,t.classList.add(`proc`)),await z_(90);break}case`maxHp`:{let{x:t,y:n}=Pv();Lf(t,n-60,`+${e.n} MAX HP`,`healf`),X.buff(),await z_(160);break}case`potion`:X.potion(),await z_(120);break;case`powerConsumed`:{let t=Q(`.card[data-uid="${e.uid}"]`,r.hand),n=t?Wf(t):{x:_()/2,y:v()-180},{x:i,y:a}=Pv();oy(n.x,n.y,i,a,{n:7,color:`#c9a8ff`,size:7,dur:560}),X.buff(),setTimeout(()=>{Pf(i,a,`#c9a8ff`,12,460,4),If(i,a,`#c9a8ff`,8)},560),await z_(300);break}case`victory`:if(Z.lastPerfect=!!e.perfect,await z_(320),X.victory(),Mf(`#ffe9ac`,.16,.6),e.perfect){let e=$(`div`,`turn-banner perfect-banner`,`PERFECT`);B_().appendChild(e),setTimeout(()=>e.remove(),1400),await z_(500)}break;case`defeat`:{await z_(400),X.defeat(),Mf(`#300`,.5,1.2);let e=Q(`#lantern`);e.classList.add(`gutter`),e.style.setProperty(`--la`,`1`),e.style.setProperty(`--lr`,`160px`),await z_(900);break}}}function Fy(){let e=Z.cb;!e||!e.over||(e.result===`win`?Iy():Ly())}function Iy(){yv(`victory-out`);let e=Z.run,t=Z.cb.kind,n=Z.cb.affix;if(Z.cb=null,e.pendingCombat=null,t===`boss`&&e.act>=2){let{newUnlocks:t}=e_(e,!0);dg(e,!0),bv(`end`,{won:!0,newUnlocks:t});return}bv(`reward`,{kind:t,rewards:mh(e,t,n)})}function Ly(){yv(`defeat`);let e=Z.run,t=i_(e),n=e.map.nodes.find(t=>t.id===e.nodeId),r=n?n.row:Math.max(1,e.floorsClimbed-1),{newUnlocks:i}=e_(e,!1);dg(e,!1),bv(`end`,{won:!1,newUnlocks:i,offers:t,fallAct:e.act,fallRow:r})}function Ry({kind:e,rewards:t}){let n=Z.run,r=B_(),i=e===`boss`?`BOSS VANQUISHED`:e===`elite`?`ELITE SLAIN`:`VICTORY`,a=Z.lastPerfect?`<div class="perfect-seal">✦ PERFECT — the glass untouched ✦</div>`:`<div class="ornament">✦ ✦ ✦</div>`;Z.lastPerfect=!1,r.innerHTML=`<div class="center-panel screen-enter">${U_()}<div class="panel">
  ...
  </div></div>`;let o=Q(`.reward-list`,r),s=(e,t,r,i=null)=>{let a=$(`button`,`reward-row`,`<span class="ric">${e}</span><span>${t}</span>`);return i&&(a._tip=i),a.onclick=()=>{r()!==!1&&(a.classList.add(`taken`),sg(n),ov())},o.appendChild(a),a};if(s(J(`coin`,18),`<b class="gold-num">${t.gold}</b> gold`,()=>{n.player.gold+=t.gold,n.stats.goldEarned+=t.gold,X.coin(),requestAnimationFrame(()=>{let e=Q(`#hud .gold-num`),r={x:_()/2,y:v()/2-40},i=e?Wf(e):{x:120,y:24},a=n.player.gold-t.gold;e&&(e.textContent=a),oy(r.x,r.y,i.x,i.y,{n:Math.min(9,4+Math.floor(t.gold/12)),color:`#ffd76e`,dur:600,done:()=>X.coin()}),e&&cy(e,a,n.player.gold,640)})}),t.potion){let e=Pu[t.potion];s(H_(`potions`,t.potion,Fg(e.tone)),`${e.name}`,()=>{if(!dh(n,t.potion))return Lf(_()/2,v()/2,`Potion slots full!`,`notice`),!1;X.potion()},{title:e.name,body:e.text})}if(t.relic){let e=Mu[t.relic];s(`<span style="color:${e.tone};text-shadow:0 0 8px ${e.tone}">${G_(t.relic,24)}</span>`,`<b>${e.name}</b>`,()=>{Zm(n,t.relic),X.relic(),requestAnimationFrame(()=>{let n=Q(`.hud-relic[data-relic="${t.relic}"]`);if(!n)return;let r=Wf(n);oy(_()/2,v()/2-40,r.x,r.y,{n:1,glyph:e.glyph,color:e.tone,dur:680,done:()=>{n.classList.remove(`proc`),n.offsetWidth,n.classList.add(`proc`)}})})},{title:e.name,body:e.text})}s(J(`cards`,26),`Add a card to your deck`,()=>(l(t.cards,()=>{}),!1));let c=o.lastElementChild;c.dataset.cardrow=`1`,Q(`[data-a="continue"]`,r).onclick=()=>{X.click(),sg(n),bv(e===`boss`?`bossRelic`:`map`)};function l(e,t){hv(`Choose a Card`,e.map(e=>({id:e,up:!1,uid:null})),{sub:`Add one card to your deck — or skip to keep it lean.`,pick:e=>{e&&(tg(n,e.id),X.upgrade(),Lf(_()/2,v()/2,`${Vm(e).name} added`,`notice`)),c.classList.add(`taken`),sg(n),t()},canSkip:!0})}}function zy(){let e=Z.run;if(e.bossRelicAct===e.act){By();return}let t=hh(e),n=B_();n.innerHTML=`<div class="center-panel screen-enter"><div class="panel" style="width:min(620px,94vw)">
  ...
  </div></div>`;let r=Q(`.big-choices`,n),i=!1,a=()=>{r.querySelectorAll(`button`).forEach(e=>{e.disabled=!0,e.onclick=null,e.style.pointerEvents=`none`})},o=t=>{if(!i){if(i=!0,a(),uh(e,t).already){By();return}t?X.relic():X.click(),sg(e),By()}};for(let e of t){let t=Mu[e],n=$(`button`,`relic-pick`);n.innerHTML=`<span class="relic-chip" style="--tone:${t.tone}">${G_(e,26)}</span><span><b>${t.name}</b><span class="rd">${t.text}</span></span>`,n.onclick=()=>o(e),r.appendChild(n)}let s=$(`button`,`btn ghost`,`Take none`);s.style.marginTop=`10px`,s.onclick=()=>o(null),r.appendChild(s)}function By(){let e=Z.run;e.act++,e.omens.push(Lm(e)),e.nodeId=null,e.map=Um(e),Xm(e,Math.round(e.player.maxHp*.35)),$d(e.act),Bd(e.act,0),__(e.act),sg(e),yv(`act-change`),bv(`map`),X.victory()}function Vy(e){let t=Bu[e.omens?.[e.act]];if(!t||Z.screen!==`map`)return;let n=e.omens[e.act],r=bg(`omens`,n),i=$(`div`,`turn-banner omen-banner`,`${r?`<img class="ob-art" src="${r}" alt="">`:`<span class="ob-glyph" style="color:${t.tone}">${J(`omen-${n}`,22)}</span>`} OMEN — ${t.name.toUpperCase()}<div class="ob-sub">${t.text}</div>`);B_().appendChild(i),X.omen(),setTimeout(()=>i.remove(),4200)}function Hy(){let e=Z.run,t=e.player.deck.some(e=>!e.up&&ku[e.id].up);B_().innerHTML=`<div class="center-panel screen-enter">${U_()}<div class="panel">
    <div class="ov-title">REST SITE</div>
    <div class="art-lg">${H_(`props`,`campfire`,Lg())}</div>
    <div class="ov-sub">The fire crackles. For a moment, the Spire is quiet.</div>
    <div class="big-choices">
      <button class="btn btn-primary" data-a="rest">${J(`flame`,18)} Rest <span style="font-size:13px;opacity:.8">— heal ${Math.round(e.player.maxHp*zm(e))} HP</span></button>
  ...
  </div></div>`,Q(`[data-a="rest"]`).onclick=t=>{t.currentTarget.disabled=!0,Q(`[data-a="smith"]`).disabled=!0,X.heal();let n=Xm(e,Math.round(e.player.maxHp*zm(e)));Mf(`#ff9a4d`,.12,.8),Lf(_()/2,v()/2-40,`+${n} HP`,`healf`),If(_()/2,v()/2,`#8fe8a0`,22),If(_()/2,v()/2+60,`#ffb066`,16),sg(e),setTimeout(()=>{Z.screen===`rest`&&bv(`map`)},900)},Q(`[data-a="smith"]`).onclick=()=>{X.click(),hv(`Upgrade a Card`,e.player.deck.filter(e=>!e.up&&ku[e.id].up),{sub:`Forge one card into its + form.`,pick:t=>{t&&(rg(e,t.uid),X.upgrade(),Mf(`#ffe9ac`,.12,.4),hv(`Upgraded!`,[e.player.deck.find(e=>e.uid===t.uid)],{sub:`It gleams with new power.`}),sg(e),setTimeout(()=>{Z.screen===`rest`&&(mv(),bv(`map`))},1300))}})}}function Uy(){let e=Z.run,t=ah(e),n=t=>{let n=Q(`.art-lg`);n.removeAttribute(`data-a`),n.style.cursor=``,n.innerHTML=H_(`props`,`chest-open`,Ig(!0)),t&&(Q(`.ov-sub`).innerHTML=t);let r=Q(`.big-choices`);r.innerHTML=``;let i=$(`button`,`btn btn-primary`,`Continue`);i.onclick=()=>{X.click(),bv(`map`)},r.appendChild(i),ov(),sg(e)};if(B_().innerHTML=`<div class="center-panel screen-enter">${U_()}<div class="panel">
    <div class="ov-title">TREASURE</div>
    <div class="art-lg" style="cursor:pointer" data-a="open">${H_(`props`,`chest`,Ig(!1))}</div>
  ...
  </div></div>`,t){n(`The chest lies empty.`);return}let r=()=>{if(t)return;t=!0,R_(`[data-a="open"]`).forEach(e=>{e.onclick=null,e.style.pointerEvents=`none`});let r=ch(e,{common:.55,uncommon:.35,rare:.1});if(r.already){n(`The chest lies empty.`);return}Mf(`#ffe9ac`,.2,.5),Nf(_()/2,v()/2,{color:`#ffd97a`,n:36,speed:380,grav:160});let i;if(r.relicId){X.relic();let e=Mu[r.relicId];i=`You claim <b style="color:${e.tone}">${e.name}</b> — <i>${e.text}</i>`}else X.coin(),i=`Only coins remain — <b class="gold-num">+60 gold</b>.`;n(i)};R_(`[data-a="open"]`).forEach(e=>e.onclick=r)}function Wy(){let e=Z.run,t=Z.shopData||={};(Z.screen!==`shop`||!t.stock||t.forNode!==e.nodeId)&&(t.stock=gh(e),t.forNode=e.nodeId);let n=t.stock,r=B_();r.innerHTML=`<div class="center-panel screen-enter">${U_()}<div class="panel ov-panel" style="width:min(980px,96vw)">
    <div style="display:flex;align-items:center;justify-content:center;gap:18px">
      <div style="width:130px">${H_(`props`,`merchant`,Rg())}</div>
  ...
  </div></div>`;let i=Q(`.cards-row`,r),a=Q(`.misc-row`,r),o=Q(`.shop-grid`,r),s=!1,c=()=>e.player.gold,l=t=>{e.player.gold-=t,X.coin(),sg(e),ov(),u()};function u(){o&&o.classList.toggle(`list-seq-done`,s),i.innerHTML=``,a.innerHTML=``;for(let t of n.cards){let n=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),r=iv({id:t.id,up:!1,uid:null},{size:138});r.onclick=()=>{if(t.sold||c()<t.price)return X.debuff();t.sold=!0,tg(e,t.id),l(t.price)},n.appendChild(r),n.appendChild($(`div`,`price`,`${J(`coin`,14)} ${t.price}`)),i.appendChild(n)}for(let t of n.relics){let n=Mu[t.id],r=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),i=$(`button`,`shop-relic`,`<span class="relic-chip" style="--tone:${n.tone}">${G_(t.id,24)}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||c()<t.price)return X.debuff();t.sold=!0,Zm(e,t.id),X.relic(),l(t.price)},r.appendChild(i),r.appendChild($(`div`,`price`,`${J(`coin`,14)} ${t.price}`)),a.appendChild(r)}for(let t of n.potions){let n=Pu[t.id],r=$(`div`,`shop-item ${t.sold?`sold`:``} ${c()<t.price?`cant`:``}`),i=$(`button`,`shop-relic`,`<span style="width:34px;height:44px">${H_(`potions`,t.id,Fg(n.tone))}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||c()<t.price)return X.debuff();if(!dh(e,t.id)){Lf(_()/2,v()/2,`Potion slots full!`,`notice`);return}t.sold=!0,X.potion(),l(t.price)},r.appendChild(i),r.appendChild($(`div`,`price`,`${J(`coin`,14)} ${t.price}`)),a.appendChild(r)}let t=$(`div`,`shop-item ${n.removed?`sold`:``} ${c()<n.removeCost?`cant`:``}`),r=$(`button`,`shop-relic`,`<span style="width:34px;display:inline-flex;justify-content:center">${J(`scissors`,26)}</span><b>Card Removal</b>Remove a card from your deck forever.`);r.onclick=()=>{if(n.removed||c()<n.removeCost)return X.debuff();hv(`Remove a Card`,e.player.deck,{sub:`Cut the dead weight.`,pick:t=>{t&&(ng(e,t.uid),n.removed=!0,e.player.gold-=n.removeCost,X.card(),sg(e),ov(),u())},canSkip:!0,skipLabel:`Cancel`})},t.appendChild(r),t.appendChild($(`div`,`price`,`${J(`coin`,14)} ${n.removeCost}`)),a.appendChild(t),s=!0}u(),Q(`[data-a="leave"]`,r).onclick=()=>{X.click(),bv(`map`)}}function Gy(e){let t=Z.run,n=Lu[e],r=B_();r.innerHTML=`<div class="center-panel screen-enter">${U_()}<div class="panel event-panel">
    <div class="ov-title">${n.name.toUpperCase()}</div>
    <div class="event-art">${H_(`events`,e,zg(n.glyph,n.hue))}</div>
    <div class="event-text">${n.text}</div>
    <div class="event-log"></div>
    <div class="event-choices"></div>
  </div></div>`;let i=Q(`.event-choices`,r),a=()=>{i.innerHTML=``;let e=$(`button`,`btn btn-primary`,`Continue`);e.onclick=()=>{X.click(),bv(`map`)},i.appendChild(e)};if(ah(t)){a();return}if(oh(t)){sh(t),sg(t),a();return}for(let[e,r]of n.choices.entries()){let n=$(`button`,`event-choice${e===0?` btn-primary`:``}`,`<b>${r.label}</b>${r.sub?`<div class="sub">${r.sub}</div>`:``}`);r.needGold&&t.player.gold<r.needGold&&(n.disabled=!0),n.onclick=()=>s(r),i.appendChild(n)}let o=!1;async function s(e){if(!o){o=!0,i.querySelectorAll(`button`).forEach(e=>{e.disabled=!0});try{X.click();let{pending:n,log:o,already:s}=lh(t,e.ops);if(s){a();return}sg(t),ov();let l=Q(`.event-log`,r),u=[];for(let e of o)e.text&&u.push(e.text),e.relic&&u.push(`Gained <b style="color:${Mu[e.relic].tone}">${Mu[e.relic].name}</b> — <i>${Mu[e.relic].text}</i>`);u.length&&(l.innerHTML=u.join(`<br>`)),i.innerHTML=``;for(let e of n)await c(e);sh(t),sg(t),ov(),a(),!u.length&&!n.length&&!e.ops.length&&bv(`map`)}catch(e){if(oh(t)||ah(t)){oh(t)&&sh(t),sg(t),a();return}throw o=!1,i.querySelectorAll(`button`).forEach(e=>{e.disabled=!1}),e}}}function c(e){return new Promise(n=>{if(e===`remove`)hv(`Remove a Card`,t.player.deck,{sub:`Let it go.`,pick:e=>{e&&(ng(t,e.uid),X.card()),n()},canSkip:!1});else if(e===`upgrade`){let e=t.player.deck.filter(e=>!e.up&&ku[e.id].up);if(!e.length)return n();hv(`Upgrade a Card`,e,{sub:`The forge hungers.`,pick:e=>{e&&(rg(t,e.uid),X.upgrade()),n()}})}else e===`duplicate`?hv(`Duplicate a Card`,t.player.deck,{sub:`The mirror remembers.`,pick:e=>{e&&(ig(t,e.uid),X.upgrade()),n()}}):e.pickCard?hv(`Choose a Card`,ph(t,e.pickCard).map(e=>({id:e,up:!1,uid:null})),{sub:`One page still glows.`,pick:e=>{e&&(tg(t,e.id),X.upgrade()),n()},canSkip:!0}):n()})}}function Ky(e){let t=bg(`bequests`,e.kind),n=t?`<img class="bq-kind" src="${t}" alt="">`:`<span class="bq-kind-fallback">${J(`bequest-${e.kind}`,22)}</span>`;return e.kind===`relic`?{icon:`${n}${G_(e.id,20)}`,name:Mu[e.id]?.name||e.id,note:`your rarest relic`}:e.kind===`card`?{icon:`${n}<span class="bq-card">🂠</span>`,name:(ku[e.id]?.name||e.id)+(e.up?`+`:``),note:`your finest card`}:{icon:`${n}${J(`coin`,20)}`,name:`${e.amount} gold`,note:`a cache of gold`}}function qy(e){if(e===`aspect2`)return{kind:`Aspect Unlocked`,name:`The Ashwarden`};let[t,n]=e.split(`:`);return t===`card`?{kind:`Card Unlocked`,name:ku[n]?.name||n}:{kind:`Relic Unlocked`,name:Mu[n]?.name||n}}function Jy(e=[]){if(!e.length)return;let t=Q(`#toasts`);t||(t=$(`div`),t.id=`toasts`,b().appendChild(t)),e.forEach((e,n)=>{let r=qy(e);setTimeout(()=>{let e=$(`div`,`unlock-toast`,`<div class="ut-kind">✦ ${r.kind}</div><div class="ut-name">${r.name}</div>`);t.appendChild(e),requestAnimationFrame(()=>e.classList.add(`in`)),X.relic(),setTimeout(()=>{e.classList.remove(`in`),setTimeout(()=>e.remove(),500)},3800)},700+n*800)})}function Yy({won:e,newUnlocks:t=[],offers:n=[],fallAct:r=0,fallRow:i=1}){let a=Z.run;v_();let o=a.stats,s=Math.max(1,Math.round((Date.now()-o.start)/6e4)),c=a.act*15+a.floorsClimbed,l=`<div class="stats-grid">
    ...
    </div>`;if(e){B_().innerHTML=`<div class="end-screen screen-enter">
      ${W_(`ascended`)}
      ...
      ${l}${u}
        ...
        <div class="bequest-opts">${n.map((e,t)=>{let n=Ky(e);return`<button class="bequest-opt" data-a="bequest" data-i="${t}"><span class="bq-icon">${n.icon}</span><span class="bq-name">${n.name}</span><span class="bq-note">${n.note}</span></button>`}).join(``)}</div>
      </div>`:``,t=Array.from({length:14},()=>`<span class="ember" style="left:${(8+Math.random()*84).toFixed(1)}%;--ex:${((Math.random()-.5)*90).toFixed(0)}px;animation-delay:${(Math.random()*4).toFixed(2)}s;animation-duration:${(3+Math.random()*3).toFixed(2)}s"></span>`).join(``);B_().innerHTML=`<div class="end-screen grave">
      ${W_(`fallen`)}
      <div class="monument">
    ...
    </div>`}B_().onclick=e=>{let t=e.target.closest(`[data-a]`);if(!t)return;let o=t.dataset.a;if(o===`bequest`){X.relic();let e=n[+t.dataset.i];t_(r,i,e);let a=Ky(e);Q(`#bequest`).innerHTML=`<div class="bequest-done">✦ The stone keeps your <b>${a.name}</b>.<br>It will wait for you in ${Ou[r].name}.</div>`;return}X.click(),o===`deck`&&hv(`Final Deck`,a.player.deck,{}),o===`title`&&(Z.run=null,Z.lamp=null,bv(`title`))},Jy(t)}var Xy=!1;function Zy(){if(Xy)return;Xy=!0;let e=Q(`#overlay`);e.addEventListener(`pointerdown`,t=>{t.target===e&&e._closable&&mv()}),document.addEventListener(`keydown`,t=>{t.key===`Escape`&&e.classList.contains(`open`)&&e._closable&&mv()})}function Qy(e,t){let n=e.dataset.cat||``,r=e.dataset.id||``,i=e.dataset.url||``,a=e.querySelector(`.g-art-stage`),o=`${r} / ${n}`,s=a?.querySelector(`svg`),c=s?`data:image/svg+xml;charset=UTF-8,${encodeURIComponent(s.outerHTML)}`:``,l=i?`<img class="gallery-lightbox-img" src="${V_(i)}" alt="${V_(r)}">`:c?`<img class="gallery-lightbox-img" src="${V_(c)}" alt="${V_(r)}">`:a?a.innerHTML:``;pv(`<div class="gallery-lightbox" role="dialog" aria-modal="true" aria-label="${V_(o)}">
    <button class="gallery-lightbox-close" type="button" data-a="close" aria-label="Close">&times;</button>
    <div class="gallery-lightbox-meta"><b>${V_(r)}</b><span>${V_(n)} - ${V_(yg(t))}</span></div>
    <div class="gallery-lightbox-art">${l}</div>
  </div>`,e=>{Q(`[data-a="close"]`,e).onclick=()=>mv()},!0)}function $y(){Zy();let e=new URLSearchParams(location.search),t=e.get(`set`)||e.get(`assetSet`)||`live`,n=vg().includes(t)?t:`live`,r=vg().map(e=>{let t=new URLSearchParams(location.search);return t.set(`gallery`,`1`),t.set(`set`,e),`<a class="${e===n?`active`:``}" href="?${t.toString()}">${yg(e)}</a>`}).join(``),i={omens:Object.keys(Bu).map(e=>[e,()=>J(`omen-${e}`,64)]),boons:Object.keys(Ku).map(e=>[e,()=>J(`boon-${e}`,64)]),arts:Object.keys(Hu).map(e=>[e,()=>J(`art-${e}`,64)]),statuses:Object.keys(ju).map(e=>[e,()=>J(`st-${e}`,64)]),heroes:Wu.map((e,t)=>[e.id,()=>jg(t)]),enemies:Object.entries(Fu).map(([e,t])=>[e,()=>kg(t.art)]),cards:Object.entries(ku).map(([e,t])=>[e,()=>Pg(e,t.type)]),potions:Object.entries(Pu).map(([e,t])=>[e,()=>Fg(t.tone)]),props:[[`campfire`,Lg],[`chest`,()=>Ig(!1)],[`chest-open`,()=>Ig(!0)],[`merchant`,Rg]],events:Object.entries(Lu).map(([e,t])=>[e,()=>zg(t.glyph,t.hue)]),title:[[`title`,()=>`<div class="title-banner-ph">title</div>`]],"title-background":[[`background`,()=>`<div class="title-banner-ph">background</div>`]],stage:[`act1`,`act2`,`act3`].flatMap(e=>[`backdrop`,`mid`,`ledge`].map(t=>[`${e}-${t}`,()=>`<div class="title-banner-ph">stage</div>`])),relics:Object.entries(Mu).map(([e,t])=>[e,()=>`<div class="title-banner-ph" style="color:${t.tone}">${t.glyph}</div>`]),deeds:Object.keys(Uu).map(e=>[e,()=>J(`deed-${e}`,64)]),bequests:[`relic`,`card`,`gold`].map(e=>[e,()=>J(`bequest-${e}`,64)]),meta:[`fallen`,`ascended`,`monument-node`].map(e=>[e,()=>`<div class="title-banner-ph">${e}</div>`]),vfx:[`ward-loop`,`ward-gain`].map(e=>[e,()=>`<div class="title-banner-ph">${e}</div>`])};B_().className=`gallery-mode`,B_().innerHTML=`<div class="g-toolbar">
    <div><b>Asset set:</b> ${yg(n)}</div>
    <nav>${r}</nav>
  </div>`+Object.entries(i).map(([e,t])=>`<h2 class="g-head">${e} — ${t.filter(([t])=>bg(e,t,n)).length}/${t.length} generated</h2>
      <div class="gallery">${t.map(([t,r])=>{let i=bg(e,t,n);return`<div class="g-cell ${i?`g-png`:`g-svg`}"><button class="g-art g-open" type="button" data-cat="${V_(e)}" data-id="${V_(t)}" data-url="${i?V_(i):``}" aria-label="Enlarge ${V_(t)}"><span class="g-art-stage">${i?`<img class="raster-art" src="${V_(i)}" alt="">`:r()}</span></button>
          <div class="g-label">${V_(t)}<span class="g-badge">${i?`PNG`:`SVG`}</span></div></div>`}).join(``)}</div>`).join(``),B_().onclick=e=>{let t=e.target.closest(`.g-open`);t&&Qy(t,n)}}function eb(){let e=e=>{let t=document.querySelector(e);return t?C(t):null};window.__probe={stage:()=>x(),geometry(){let t=e(`.battlefield`);return!t||!Z.cb||!Z.ce?null:{stage:x(),viewport:{w:_(),h:v()},groundY:t.bottom,heroArtBottom:e(`.hero-wrap`)?.bottom??null,enemyArtBottoms:Z.cb.enemies.map((e,t)=>e.hp>0&&Z.ce.enemies[t]?C(Z.ce.enemies[t].art).bottom:null),slLedgeTop:e(`.sl-ledge`)?.top??null,seamY:e(`.stage-ledge`)?.top??null}},invariants(){let e=[],t=(t,n,r=``)=>e.push({name:t,pass:n,detail:n?``:String(r)}),n=Z.cb,r=Z.ce;return n&&r&&Z.screen===`combat`&&(n.enemies.forEach((e,n)=>{let i=r.enemies[n];if(i)if(e.hp<=0){let e=i.root.classList;t(`enemy${n}: dead body leaves the field`,e.contains(`gone`)||e.contains(`dying`)||getComputedStyle(i.root).visibility===`hidden`,`classes="${i.root.className}"`),t(`enemy${n}: dead body releases its mesh plane`,!i.root.querySelector(`.mesh-live`),`a WebGL warp plane still renders this corpse`)}else t(`enemy${n}: HP label matches engine`,i.hp.textContent===`${Math.max(0,e.hp)}/${e.maxHp}`,`dom="${i.hp.textContent}" engine=${e.hp}/${e.maxHp}`)}),t(`player: HP label matches engine`,r.pHp.textContent===`${Math.max(0,n.player.hp)}/${n.player.maxHp}`,`dom="${r.pHp.textContent}" engine=${n.player.hp}/${n.player.maxHp}`),t(`hand: DOM count matches engine`,R_(`.card`,r.hand).length===n.hand.length,`dom=${R_(`.card`,r.hand).length} engine=${n.hand.length}`),t(`energy: orb matches engine`,Q(`.num`,r.energy).textContent===String(n.player.energy),`dom="${Q(`.num`,r.energy).textContent}" engine=${n.player.energy}`),t(`embers: lantern count matches engine`,Q(`.lb-count`,r.lantern).textContent===String(n.embers),`dom="${Q(`.lb-count`,r.lantern).textContent}" engine=${n.embers}`)),e},state(){let e=Z.cb;return{screen:Z.screen,busy:Z.busy,over:e?.over??null,result:e?.result??null,turn:e?.turn??null,player:e?{hp:e.player.hp,maxHp:e.player.maxHp,block:e.player.block,energy:e.player.energy}:null,embers:e?.embers??null,enemies:e?e.enemies.map(e=>({key:e.key,hp:e.hp,maxHp:e.maxHp,block:e.block})):null,hand:e?e.hand.map(e=>({uid:e.uid,id:e.id})):null}},settle:()=>new Promise(e=>{let t=()=>!Z.busy&&(!Z.cb||Z.cb.queue.length===0),n=()=>t()?e(!0):setTimeout(n,50);n()}),async play(e,t=null){return Z.busy||!Z.cb||Z.cb.over?!1:(await ry(e,t),!Z.cb||Z.cb.over||!Z.cb.hand.some(t=>t.uid===e))},async endTurn(){await iy()},async useArt(){return Z.busy||!Z.cb||Z.cb.over||!kh(Z.run,Z.cb)?!1:(Ah(Z.run,Z.cb),await My(),Fy(),!0)},async usePotion(e,t=null){return Z.busy||!qh(Z.run,Z.cb,e,t)?!1:(Z.cb&&(await My(),Fy()),ov(),!0)},forceHand(e){return Z.cb.hand=e.map(e=>Bm(Z.run,e)),Hv(),Z.cb.hand.map(e=>e.uid)},setEnergy(e){Z.cb.player.energy=e,Vv()},setEmbers(e){Z.cb.embers=e,Vv()},setEnemyHp(e,t){Z.cb.enemies[e].hp=t,Vv()},freeze(){document.documentElement.classList.add(`freeze`),_y=!0,Ef(),rf()}}}function tb(){if(new URLSearchParams(location.search).has(`gallery`))return $y();nv(),document.addEventListener(`pointerdown`,()=>d_(),{once:!0}),document.addEventListener(`contextmenu`,e=>{Z.targeting&&(e.preventDefault(),ty())}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&(Z.targeting?ty():Q(`#overlay`).classList.contains(`open`)&&Q(`#overlay`)._closable&&mv()),(e.key===`e`||e.key===`E`)&&Z.screen===`combat`&&!Z.busy&&iy(),(e.key===`a`||e.key===`A`)&&Z.screen===`combat`&&!Z.busy&&Z.ce?.lantern?.click()}),Q(`#overlay`).addEventListener(`pointerdown`,e=>{e.target===Q(`#overlay`)&&Q(`#overlay`)._closable&&mv()}),window.spirebound={S:Z,E:Am,startCombatUI:jv,show:bv,meshEnabled:yp,meshDebug:km,refitCombat:Iv},eb(),requestAnimationFrame(vy);let e=()=>{Z.screen===`combat`&&Z.cb&&Z.ce&&Iv()};op(e),x_(e),bv(`title`)}new URLSearchParams(location.search),g(),Zd(),wf(),fm(),tb();