...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Do(e,t,n){let r=new Float32Array(po),i=new V(0,1,0);return new ia({name:`SphericalGaussianBlur`,defines:{n:po,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ao(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oo(){return new ia({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ao(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ko(){return new ia({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ao(),fragmentShader:`
	...
	`}var jo=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ri(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},_l=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},vl=new Ma(-1,1,1,-1,0,1),yl=new class extends jr{constructor(){super(),this.setAttribute(`position`,new yr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new yr([0,2,0,0,2,0],2))}},bl=class{constructor(e){this._mesh=new yi(yl,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,vl)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},xl=class extends _l{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof ia?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ta.clone(e.uniforms),this.material=new ia({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new bl(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Sl=class extends _l{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Cl=class extends _l{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},wl=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new B);this._width=n.width,this._height=n.height,t=new Xt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:v}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new xl(gl),this.copyPass.material.blending=0,this.timer=new La}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Sl!==void 0&&(r instanceof Sl?n=!0:r instanceof Cl&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new B);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Tl=class extends _l{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new W}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},El={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new W(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Dl.BlurDirectionX=new B(1,0),Dl.BlurDirectionY=new B(0,1);var Ol={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},kl=class extends _l{constructor(){super(),this.isOutputPass=!0,this.uniforms=ta.clone(Ol.uniforms),this.material=new aa({name:Ol.name,uniforms:this.uniforms,vertexShader:Ol.vertexShader,fragmentShader:Ol.fragmentShader}),this._fsQuad=new bl(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},U.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Al={name:`The Duskblade`,maxHp:72,energy:3,handSize:5,potionSlots:3,startDeck:[`strike`,`strike`,`strike`,`strike`,`strike`,`defend`,`defend`,`defend`,`defend`,`eclipseSlash`],startRelic:`emberHeart`,startGold:99},jl=[{name:`The Ashen Woods`,boss:`rootheart`,bossName:`The Rootheart`,theme:{sky:791568,fog:1254426,particles:16752717,glow:6750110,accent:`#7ddb8f`,ember:`#ff9a4d`}},{name:`The Sunken City`,boss:`leviathan`,bossName:`Leviathan's Maw`,theme:{sky:529440,fog:860723,particles:5499135,glow:3127551,accent:`#5fd6e8`,ember:`#53e8ff`}},{name:`The Obsidian Spire`,boss:`sovereign`,bossName:`The Eternal Sovereign`,theme:{sky:1182238,fog:1970736,particles:12745727,glow:16732120,accent:`#c99aff`,ember:`#ff6fe0`}}],Ml={strike:{name:`Strike`,type:`attack`,rarity:`starter`,cost:1,target:`enemy`,text:`Deal @6@ damage.`,effects:[{kind:`dmg`,n:6}],up:{text:`Deal @9@ damage.`,effects:[{kind:`dmg`,n:9}]}},defend:{name:`Defend`,type:`skill`,rarity:`starter`,cost:1,target:`self`,text:`Gain #5# Block.`,effects:[{kind:`block`,n:5}],up:{text:`Gain #8# Block.`,effects:[{kind:`block`,n:8}]}},eclipseSlash:{name:`Eclipse Slash`,type:`attack`,rarity:`starter`,cost:1,target:`enemy`,text:`Deal @7@ damage. Apply 1 Vulnerable.`,effects:[{kind:`dmg`,n:7},{kind:`status`,who:`target`,id:`vulnerable`,n:1}],up:{text:`Deal @9@ damage. Apply 2 Vulnerable.`,effects:[{kind:`dmg`,n:9},{kind:`status`,who:`target`,id:`vulnerable`,n:2}]}},twinFangs:{name:`Twin Fangs`,type:`attack`,rarity:`common`,cost:1,target:`enemy`,text:`Deal @4@ damage twice.`,effects:[{kind:`dmg`,n:4,times:2}],up:{text:`Deal @6@ damage twice.`,effects:[{kind:`dmg`,n:6,times:2}]}},quickSlash:{name:`Quick Slash`,type:`attack`,rarity:`common`,cost:0,target:`enemy`,text:`Deal @4@ damage. Draw 1 card.`,effects:[{kind:`dmg`,n:4},{kind:`draw`,n:1}],up:{text:`Deal @6@ damage. Draw 1 card.`,effects:[{kind:`dmg`,n:6},{kind:`draw`,n:1}]}},heavyBlow:{name:`Heavy Blow`,type:`attack`,rarity:`common`,cost:2,target:`enemy`,text:`Deal @14@ damage.`,effects:[{kind:`dmg`,n:14}],up:{text:`Deal @20@ damage.`,effects:[{kind:`dmg`,n:20}]}},cleave:{name:`Cleave`,type:`attack`,rarity:`common`,cost:1,target:`allEnemies`,text:`Deal @6@ damage to ALL enemies.`,effects:[{kind:`dmg`,n:6}],up:{text:`Deal @9@ damage to ALL enemies.`,effects:[{kind:`dmg`,n:9}]}},venomStrike:{name:`Venom Strike`,type:`attack`,rarity:`common`,cost:1,target:`enemy`,text:`Deal @4@ damage. Apply 3 Poison.`,effects:[{kind:`dmg`,n:4},{kind:`status`,who:`target`,id:`poison`,n:3}],up:{text:`Deal @6@ damage. Apply 4 Poison.`,effects:[{kind:`dmg`,n:6},{kind:`status`,who:`target`,id:`poison`,n:4}]}},lunge:{name:`Lunge`,type:`attack`,rarity:`common`,cost:1,target:`enemy`,text:`Deal @6@ damage. Apply 1 Weak.`,effects:[{kind:`dmg`,n:6},{kind:`status`,who:`target`,id:`weak`,n:1}],up:{text:`Deal @9@ damage. Apply 2 Weak.`,effects:[{kind:`dmg`,n:9},{kind:`status`,who:`target`,id:`weak`,n:2}]}},guardedStrike:{name:`Guarded Strike`,type:`attack`,rarity:`common`,cost:1,target:`enemy`,text:`Deal @5@ damage. Gain #4# Block.`,effects:[{kind:`dmg`,n:5},{kind:`block`,n:4}],up:{text:`Deal @7@ damage. Gain #6# Block.`,effects:[{kind:`dmg`,n:7},{kind:`block`,n:6}]}},brace:{name:`Brace`,type:`skill`,rarity:`common`,cost:1,target:`self`,text:`Gain #8# Block.`,effects:[{kind:`block`,n:8}],up:{text:`Gain #11# Block.`,effects:[{kind:`block`,n:11}]}},sidestep:{name:`Sidestep`,type:`skill`,rarity:`common`,cost:0,target:`self`,text:`Gain #3# Block. Draw 1 card.`,effects:[{kind:`block`,n:3},{kind:`draw`,n:1}],up:{text:`Gain #5# Block. Draw 1 card.`,effects:[{kind:`block`,n:5},{kind:`draw`,n:1}]}},preparation:{name:`Preparation`,type:`skill`,rarity:`common`,cost:0,target:`self`,text:`Draw 2 cards. Exhaust.`,exhaust:!0,effects:[{kind:`draw`,n:2}],up:{text:`Draw 2 cards.`,exhaust:!1,effects:[{kind:`draw`,n:2}]}},deflect:{name:`Deflect`,type:`skill`,rarity:`common`,cost:1,target:`self`,text:`Gain #6# Block. Draw 1 card.`,effects:[{kind:`block`,n:6},{kind:`draw`,n:1}],up:{text:`Gain #9# Block. Draw 1 card.`,effects:[{kind:`block`,n:9},{kind:`draw`,n:1}]}},leechBlade:{name:`Leech Blade`,type:`attack`,rarity:`uncommon`,cost:2,target:`enemy`,text:`Deal @9@ damage. Heal for half the unblocked damage.`,effects:[{kind:`special`,id:`leech`,n:9}],up:{text:`Deal @13@ damage. Heal for half the unblocked damage.`,effects:[{kind:`special`,id:`leech`,n:13}]}},tempest:{name:`Tempest`,type:`attack`,rarity:`uncommon`,cost:2,target:`allEnemies`,text:`Deal @4@ damage to ALL enemies twice.`,effects:[{kind:`dmg`,n:4,times:2}],up:{text:`Deal @6@ damage to ALL enemies twice.`,effects:[{kind:`dmg`,n:6,times:2}]}},uppercut:{name:`Uppercut`,type:`attack`,rarity:`uncommon`,cost:2,target:`enemy`,text:`Deal @10@ damage. Apply 1 Weak and 1 Vulnerable.`,effects:[{kind:`dmg`,n:10},{kind:`status`,who:`target`,id:`weak`,n:1},{kind:`status`,who:`target`,id:`vulnerable`,n:1}],up:{text:`Deal @13@ damage. Apply 2 Weak and 2 Vulnerable.`,effects:[{kind:`dmg`,n:13},{kind:`status`,who:`target`,id:`weak`,n:2},{kind:`status`,who:`target`,id:`vulnerable`,n:2}]}},flurry:{name:`Flurry`,type:`attack`,rarity:`uncommon`,cost:1,target:`enemy`,text:`Deal @2@ damage 3 times.`,effects:[{kind:`dmg`,n:2,times:3}],up:{text:`Deal @3@ damage 3 times.`,effects:[{kind:`dmg`,n:3,times:3}]}},executioner:{name:`Executioner`,type:`attack`,rarity:`uncommon`,cost:1,target:`enemy`,text:`Deal @8@ damage. Vulnerable enemies take 6 more.`,effects:[{kind:`special`,id:`execute`,n:8,bonus:6}],up:{text:`Deal @11@ damage. Vulnerable enemies take 8 more.`,effects:[{kind:`special`,id:`execute`,n:11,bonus:8}]}},momentum:{name:`Momentum`,type:`attack`,rarity:`uncommon`,cost:1,target:`enemy`,text:`Deal @6@ damage. Each play, this card gains +4 damage this combat.`,effects:[{kind:`special`,id:`momentum`,n:6,grow:4}],up:{text:`Deal @8@ damage. Each play, this card gains +6 damage this combat.`,effects:[{kind:`special`,id:`momentum`,n:8,grow:6}]}},bulwark:{name:`Bulwark`,type:`skill`,rarity:`uncommon`,cost:2,target:`self`,text:`Gain #13# Block.`,effects:[{kind:`block`,n:13}],up:{text:`Gain #18# Block.`,effects:[{kind:`block`,n:18}]}},surge:{name:`Surge`,type:`skill`,rarity:`uncommon`,cost:0,target:`self`,text:`Gain 1 Energy. Draw 1 card. Exhaust.`,exhaust:!0,effects:[{kind:`energy`,n:1},{kind:`draw`,n:1}],up:{text:`Gain 2 Energy. Draw 1 card. Exhaust.`,effects:[{kind:`energy`,n:2},{kind:`draw`,n:1}]}},toxicMist:{name:`Toxic Mist`,type:`skill`,rarity:`uncommon`,cost:1,target:`allEnemies`,text:`Apply 3 Poison to ALL enemies.`,effects:[{kind:`status`,who:`allEnemies`,id:`poison`,n:3}],up:{text:`Apply 5 Poison to ALL enemies.`,effects:[{kind:`status`,who:`allEnemies`,id:`poison`,n:5}]}},cripple:{name:`Cripple`,type:`skill`,rarity:`uncommon`,cost:1,target:`enemy`,text:`Reduce an enemy's Strength by 2. Exhaust.`,exhaust:!0,effects:[{kind:`status`,who:`target`,id:`str`,n:-2}],up:{text:`Reduce an enemy's Strength by 3. Exhaust.`,effects:[{kind:`status`,who:`target`,id:`str`,n:-3}]}},warCry:{name:`War Cry`,type:`skill`,rarity:`uncommon`,cost:1,target:`allEnemies`,text:`Apply 1 Weak and 1 Vulnerable to ALL enemies.`,effects:[{kind:`status`,who:`allEnemies`,id:`weak`,n:1},{kind:`status`,who:`allEnemies`,id:`vulnerable`,n:1}],up:{text:`Apply 2 Weak and 2 Vulnerable to ALL enemies.`,effects:[{kind:`status`,who:`allEnemies`,id:`weak`,n:2},{kind:`status`,who:`allEnemies`,id:`vulnerable`,n:2}]}},fortify:{name:`Fortify`,type:`skill`,rarity:`uncommon`,cost:2,target:`self`,text:`Double your Block.`,effects:[{kind:`special`,id:`doubleBlock`}],up:{cost:1,text:`Double your Block.`}},bloodRite:{name:`Blood Rite`,type:`skill`,rarity:`uncommon`,cost:0,target:`self`,text:`Lose 3 HP. Gain 2 Energy.`,effects:[{kind:`loseHp`,n:3},{kind:`energy`,n:2}],up:{text:`Lose 3 HP. Gain 3 Energy.`,effects:[{kind:`loseHp`,n:3},{kind:`energy`,n:3}]}},empower:{name:`Empower`,type:`power`,rarity:`uncommon`,cost:1,target:`self`,text:`Gain 2 Strength.`,effects:[{kind:`status`,who:`self`,id:`str`,n:2}],up:{text:`Gain 3 Strength.`,effects:[{kind:`status`,who:`self`,id:`str`,n:3}]}},agility:{name:`Agility`,type:`power`,rarity:`uncommon`,cost:1,target:`self`,text:`Gain 2 Dexterity.`,effects:[{kind:`status`,who:`self`,id:`dex`,n:2}],up:{text:`Gain 3 Dexterity.`,effects:[{kind:`status`,who:`self`,id:`dex`,n:3}]}},ironSkin:{name:`Iron Skin`,type:`power`,rarity:`uncommon`,cost:1,target:`self`,text:`At the end of your turn, gain 3 Block.`,effects:[{kind:`status`,who:`self`,id:`metallicize`,n:3}],up:{text:`At the end of your turn, gain 4 Block.`,effects:[{kind:`status`,who:`self`,id:`metallicize`,n:4}]}},regrowth:{name:`Regrowth`,type:`power`,rarity:`uncommon`,cost:1,target:`self`,text:`At the end of your turn, heal 2 HP.`,effects:[{kind:`status`,who:`self`,id:`regen`,n:2}],up:{text:`At the end of your turn, heal 3 HP.`,effects:[{kind:`status`,who:`self`,id:`regen`,n:3}]}},oblivionStrike:{name:`Oblivion Strike`,type:`attack`,rarity:`rare`,cost:3,target:`enemy`,text:`Deal @30@ damage.`,effects:[{kind:`dmg`,n:30}],up:{text:`Deal @40@ damage.`,effects:[{kind:`dmg`,n:40}]}},phantomBlades:{name:`Phantom Blades`,type:`attack`,rarity:`rare`,cost:1,target:`enemy`,text:`Deal @3@ damage for each card in your hand.`,effects:[{kind:`special`,id:`phantom`,n:3}],up:{text:`Deal @4@ damage for each card in your hand.`,effects:[{kind:`special`,id:`phantom`,n:4}]}},devour:{name:`Devour`,type:`attack`,rarity:`rare`,cost:1,target:`enemy`,text:`Deal @10@ damage. If this kills the enemy, gain 3 Max HP. Exhaust.`,exhaust:!0,effects:[{kind:`special`,id:`devour`,n:10,maxHp:3}],up:{text:`Deal @13@ damage. If this kills the enemy, gain 4 Max HP. Exhaust.`,effects:[{kind:`special`,id:`devour`,n:13,maxHp:4}]}},annihilate:{name:`Annihilate`,type:`attack`,rarity:`rare`,cost:2,target:`allEnemies`,text:`Deal @9@ damage and apply 3 Poison to ALL enemies.`,effects:[{kind:`dmg`,n:9},{kind:`status`,who:`allEnemies`,id:`poison`,n:3}],up:{text:`Deal @12@ damage and apply 4 Poison to ALL enemies.`,effects:[{kind:`dmg`,n:12},{kind:`status`,who:`allEnemies`,id:`poison`,n:4}]}},aegis:{name:`Aegis`,type:`skill`,rarity:`rare`,cost:2,target:`self`,text:`Gain #30# Block. Exhaust.`,exhaust:!0,effects:[{kind:`block`,n:30}],up:{text:`Gain #40# Block. Exhaust.`,effects:[{kind:`block`,n:40}]}},offering:{name:`Offering`,type:`skill`,rarity:`rare`,cost:0,target:`self`,text:`Lose 6 HP. Gain 2 Energy. Draw 3 cards. Exhaust.`,exhaust:!0,effects:[{kind:`loseHp`,n:6},{kind:`energy`,n:2},{kind:`draw`,n:3}],up:{text:`Lose 6 HP. Gain 2 Energy. Draw 5 cards. Exhaust.`,effects:[{kind:`loseHp`,n:6},{kind:`energy`,n:2},{kind:`draw`,n:5}]}},limitBreak:{name:`Limit Break`,type:`skill`,rarity:`rare`,cost:1,target:`self`,text:`Double your Strength. Exhaust.`,exhaust:!0,effects:[{kind:`special`,id:`limitBreak`}],up:{text:`Double your Strength.`,exhaust:!1}},catalyst:{name:`Catalyst`,type:`skill`,rarity:`rare`,cost:1,target:`enemy`,text:`Double an enemy's Poison. Exhaust.`,exhaust:!0,effects:[{kind:`special`,id:`catalyst`,n:2}],up:{text:`Triple an enemy's Poison. Exhaust.`,effects:[{kind:`special`,id:`catalyst`,n:3}]}},ascension:{name:`Dark Ascension`,type:`power`,rarity:`rare`,cost:3,target:`self`,text:`At the start of each turn, gain 2 Strength.`,effects:[{kind:`status`,who:`self`,id:`ritual`,n:2}],up:{text:`At the start of each turn, gain 3 Strength.`,effects:[{kind:`status`,who:`self`,id:`ritual`,n:3}]}},bastion:{name:`Bastion`,type:`power`,rarity:`rare`,cost:3,target:`self`,text:`Block no longer expires at the start of your turn.`,effects:[{kind:`status`,who:`self`,id:`barricade`,n:1}],up:{cost:2}},frenzy:{name:`Frenzy`,type:`power`,rarity:`rare`,cost:2,target:`self`,text:`Gain 2 Vulnerable. At the start of each turn, gain 1 Energy.`,effects:[{kind:`status`,who:`self`,id:`vulnerable`,n:2},{kind:`status`,who:`self`,id:`energized`,n:1}],up:{text:`Gain 1 Vulnerable. At the start of each turn, gain 1 Energy.`,effects:[{kind:`status`,who:`self`,id:`vulnerable`,n:1},{kind:`status`,who:`self`,id:`energized`,n:1}]}},virulence:{name:`Virulence`,type:`power`,rarity:`rare`,cost:2,target:`self`,text:`Whenever you play an Attack, apply 1 Poison to the enemy.`,effects:[{kind:`status`,who:`self`,id:`venomous`,n:1}],up:{cost:1}},wound:{name:`Wound`,type:`status`,rarity:`special`,cost:null,target:`none`,text:`Unplayable.`,unplayable:!0,effects:[]},burn:{name:`Burn`,type:`status`,rarity:`special`,cost:null,target:`none`,text:`Unplayable. At the end of your turn, take 2 damage if this is in your hand.`,unplayable:!0,endTurnDmg:2,effects:[]},hex:{name:`Hex`,type:`curse`,rarity:`special`,cost:null,target:`none`,text:`Unplayable. At the end of your turn, lose 1 HP if this is in your hand.`,unplayable:!0,endTurnLoseHp:1,effects:[]}},Nl=(()=>{let e={common:[],uncommon:[],rare:[]};for(let[t,n]of Object.entries(Ml))e[n.rarity]&&e[n.rarity].push(t);return e})(),Pl={str:{name:`Strength`,icon:`⚔`,kind:`buff`,desc:`Attacks deal +N damage.`},dex:{name:`Dexterity`,icon:`🛡`,kind:`buff`,desc:`Block cards grant +N Block.`},vulnerable:{name:`Vulnerable`,icon:`◎`,kind:`debuff`,desc:`Takes 50% more attack damage. Wears off each turn.`},weak:{name:`Weak`,icon:`↓`,kind:`debuff`,desc:`Deals 25% less attack damage. Wears off each turn.`},frail:{name:`Frail`,icon:`✖`,kind:`debuff`,desc:`Block gained reduced 25%. Wears off each turn.`},poison:{name:`Poison`,icon:`☠`,kind:`debuff`,desc:`Loses N HP at the start of its turn, then Poison drops by 1.`},thorns:{name:`Thorns`,icon:`❈`,kind:`buff`,desc:`Attackers take N damage back.`},ritual:{name:`Ritual`,icon:`☽`,kind:`buff`,desc:`Gains N Strength at the start of each turn.`},metallicize:{name:`Iron Skin`,icon:`⬡`,kind:`buff`,desc:`Gains N Block at the end of each turn.`},regen:{name:`Regen`,icon:`❋`,kind:`buff`,desc:`Heals N HP at the end of each turn.`},barricade:{name:`Bastion`,icon:`☗`,kind:`buff`,desc:`Block no longer expires.`},energized:{name:`Energized`,icon:`✦`,kind:`buff`,desc:`Gain N extra Energy at the start of each turn.`},venomous:{name:`Venomous`,icon:`☠`,kind:`buff`,desc:`Attacks apply N Poison.`},rampage:{name:`Rampage`,icon:`⤴`,kind:`buff`,desc:`Attack grows stronger with each use.`}},Fl={emberHeart:{name:`Emberheart`,rarity:`starter`,glyph:`♥`,tone:`#ff5964`,text:`At the end of combat, heal 6 HP.`},basaltIdol:{name:`Basalt Idol`,rarity:`common`,glyph:`☗`,tone:`#9aa7b8`,text:`Begin each combat with 10 Block.`},warFetish:{name:`War Fetish`,rarity:`common`,glyph:`⚔`,tone:`#ff8c5a`,text:`Begin each combat with 1 Strength.`},riverPearl:{name:`River Pearl`,rarity:`common`,glyph:`◉`,tone:`#6fd6e8`,text:`Begin each combat with 1 Dexterity.`},travelersPack:{name:`Traveler's Pack`,rarity:`common`,glyph:`⌘`,tone:`#c9a86a`,text:`Draw 2 extra cards on your first turn.`},emberLantern:{name:`Ember Lantern`,rarity:`common`,glyph:`☀`,tone:`#ffd166`,text:`Gain 1 extra Energy on your first turn.`},vialOfLife:{name:`Vial of Life`,rarity:`common`,glyph:`♣`,tone:`#7ddb8f`,text:`Heal 2 HP at the start of each combat.`},thornBand:{name:`Thorn Band`,rarity:`common`,glyph:`❈`,tone:`#a3e06c`,text:`Begin each combat with 2 Thorns.`},sweetRoot:{name:`Sweet Root`,rarity:`common`,glyph:`✿`,tone:`#ff9ecb`,text:`On pickup: gain 8 Max HP.`,instant:!0},gravebloom:{name:`Gravebloom`,rarity:`uncommon`,glyph:`❀`,tone:`#b18cff`,text:`After combat, if at or below 50% HP, heal 10.`},silkFan:{name:`Silk Fan`,rarity:`uncommon`,glyph:`⛉`,tone:`#8fd0ff`,text:`Every 3rd card you play each combat grants 3 Block.`},reapersBell:{name:`Reaper's Bell`,rarity:`uncommon`,glyph:`♫`,tone:`#d8c27a`,text:`When an enemy dies, gain 1 Energy and draw 1 card.`},executionersSeal:{name:`Executioner's Seal`,rarity:`uncommon`,glyph:`✠`,tone:`#ff6b6b`,text:`Every 10th Attack you play deals double damage.`},ironTalisman:{name:`Iron Talisman`,rarity:`uncommon`,glyph:`◈`,tone:`#c0c8d4`,text:`Every 3rd Attack you play grants 1 Strength.`},merchantsMark:{name:`Merchant's Mark`,rarity:`uncommon`,glyph:`¤`,tone:`#f2c14e`,text:`Shop prices are 25% lower.`},seersOrb:{name:`Seer's Orb`,rarity:`uncommon`,glyph:`☉`,tone:`#9be8d8`,text:`Card rewards offer 1 additional choice.`},frozenCore:{name:`Frozen Core`,rarity:`rare`,glyph:`❆`,tone:`#a8e6ff`,text:`Unspent Energy carries over between turns.`},verdantBranch:{name:`Verdant Branch`,rarity:`rare`,glyph:`⚕`,tone:`#7ddb8f`,text:`Whenever a card is Exhausted, draw 1 card.`},sunBlossom:{name:`Sun Blossom`,rarity:`rare`,glyph:`❂`,tone:`#ffd166`,text:`All healing is increased by 50%.`},wardingCharm:{name:`Warding Charm`,rarity:`rare`,glyph:`⛨`,tone:`#8fa8ff`,text:`Enemy attacks that would deal 5 or less damage deal 1.`},duskmirror:{name:`Duskmirror`,rarity:`rare`,glyph:`◐`,tone:`#c99aff`,text:`The first card you play each turn costs 0.`},obsidianHeart:{name:`Obsidian Heart`,rarity:`boss`,glyph:`♦`,tone:`#b18cff`,text:`Gain 1 Energy each turn. On pickup: lose 8 Max HP.`,instant:!0},philosophersStone:{name:`Philosopher's Stone`,rarity:`boss`,glyph:`▣`,tone:`#ffd166`,text:`Gain 1 Energy each turn. All enemies start with 1 Strength.`},blackBlood:{name:`Black Blood`,rarity:`boss`,glyph:`♥`,tone:`#8c1d2f`,text:`Replaces Emberheart. At the end of combat, heal 12 HP.`,replaces:`emberHeart`},pandorasBox:{name:`Pandora's Box`,rarity:`boss`,glyph:`▩`,tone:`#d8a0ff`,text:`On pickup: transform all Strikes and Defends into random cards.`,instant:!0},voidCrown:{name:`Void Crown`,rarity:`boss`,glyph:`♛`,tone:`#ff4fd8`,text:`Gain 1 Energy each turn. Start each combat with a Wound in your draw pile.`}},Il=(()=>{let e={common:[],uncommon:[],rare:[],boss:[]};for(let[t,n]of Object.entries(Fl))e[n.rarity]&&e[n.rarity].push(t);return e})(),Ll={healing:{name:`Healing Potion`,tone:`#ff6b81`,glyph:`♥`,text:`Heal 20 HP.`,combatOnly:!1},strength:{name:`Potion of Might`,tone:`#ff8c5a`,glyph:`⚔`,text:`Gain 2 Strength.`,combatOnly:!0},swift:{name:`Swiftness Draught`,tone:`#8fd0ff`,glyph:`»`,text:`Draw 3 cards.`,combatOnly:!0},block:{name:`Stoneskin Tonic`,tone:`#9aa7b8`,glyph:`☗`,text:`Gain 12 Block.`,combatOnly:!0},fire:{name:`Flask of Fire`,tone:`#ffd166`,glyph:`✹`,text:`Deal 20 damage to an enemy.`,combatOnly:!0,needsTarget:!0},venom:{name:`Venom Vial`,tone:`#a3e06c`,glyph:`☠`,text:`Apply 7 Poison to an enemy.`,combatOnly:!0,needsTarget:!0},energy:{name:`Aether Philter`,tone:`#c99aff`,glyph:`✦`,text:`Gain 2 Energy.`,combatOnly:!0}},Rl={sporeling:{name:`Sporeling`,hp:[13,17],art:{kind:`wisp`,hue:95,size:.72},moves:{spit:{name:`Spore Spit`,intent:`attack`,dmg:4},grow:{name:`Bloom`,intent:`buff`,fx:[{who:`self`,id:`str`,n:1}]}},ai:({turn:e})=>e%3==2?`grow`:`spit`},duskfang:{name:`Duskfang`,hp:[26,30],art:{kind:`beast`,hue:22,size:1},moves:{howl:{name:`Howl`,intent:`buff`,fx:[{who:`self`,id:`str`,n:2}]},bite:{name:`Bite`,intent:`attack`,dmg:7},rend:{name:`Rend`,intent:`attack`,dmg:4,times:2}},ai:({turn:e,last:t,rng:n})=>e===1||t!==`howl`&&n()<.18?`howl`:t===`bite`?`rend`:`bite`},gloomslime:{name:`Gloomslime`,hp:[30,34],art:{kind:`slime`,hue:150,size:1},moves:{slam:{name:`Slam`,intent:`attack`,dmg:8},ooze:{name:`Corrosive Ooze`,intent:`attack_debuff`,dmg:3,fx:[{who:`player`,id:`weak`,n:2}]},harden:{name:`Congeal`,intent:`attack_block`,dmg:4,block:6}},ai:({turn:e})=>[`ooze`,`slam`,`harden`][(e-1)%3]},waylayer:{name:`Waylayer`,hp:[28,32],art:{kind:`rogue`,hue:0,size:.95},moves:{stab:{name:`Stab`,intent:`attack`,dmg:9},smoke:{name:`Smokescreen`,intent:`block`,block:8},trick:{name:`Dirty Trick`,intent:`attack_debuff`,dmg:4,fx:[{who:`player`,id:`frail`,n:2}]}},ai:({turn:e,rng:t})=>e===1?`trick`:t()<.55?`stab`:t()<.5?`smoke`:`trick`},thornling:{name:`Thornling`,hp:[18,22],art:{kind:`plant`,hue:80,size:.85},startStatus:{thorns:2},moves:{prick:{name:`Prick`,intent:`attack`,dmg:6},bristle:{name:`Bristle`,intent:`buff`,fx:[{who:`self`,id:`thorns`,n:2}]},burst:{name:`Spike Burst`,intent:`attack`,dmg:10}},ai:({turn:e})=>e%4==0?`burst`:e%2==1?`prick`:`bristle`},ashAcolyte:{name:`Ash Acolyte`,hp:[34,38],art:{kind:`cultist`,hue:28,size:1},moves:{ritual:{name:`Dark Ritual`,intent:`buff`,fx:[{who:`self`,id:`ritual`,n:2}]},scorch:{name:`Scorch`,intent:`attack`,dmg:6}},ai:({turn:e})=>e===1?`ritual`:`scorch`},gravewarden:{name:`Gravewarden`,hp:[70,76],elite:!0,art:{kind:`golem`,hue:210,size:1.25},moves:{crush:{name:`Crush`,intent:`attack`,dmg:12},entomb:{name:`Entomb`,intent:`debuff`,fx:[{who:`player`,id:`frail`,n:2},{who:`player`,id:`vulnerable`,n:2}]},bulwark:{name:`Bulwark`,intent:`attack_block`,dmg:6,block:12}},ai:({turn:e})=>[`entomb`,`crush`,`bulwark`,`crush`][(e-1)%4]},alphaFang:{name:`Alpha Duskfang`,hp:[64,70],elite:!0,art:{kind:`beast`,hue:350,size:1.3},moves:{howl:{name:`Alpha Howl`,intent:`buff`,fx:[{who:`self`,id:`str`,n:3}]},savage:{name:`Savage`,intent:`attack`,dmg:5,times:2},throat:{name:`Throat Rip`,intent:`attack`,dmg:13}},ai:({turn:e,last:t})=>e===1||e%4==0?`howl`:t===`savage`?`throat`:`savage`},rootheart:{name:`The Rootheart`,hp:[150,150],boss:!0,art:{kind:`treeboss`,hue:100,size:1.6},moves:{awaken:{name:`Awaken`,intent:`buff`,block:10,fx:[{who:`self`,id:`str`,n:2}]},lash:{name:`Root Lash`,intent:`attack`,dmg:12},spores:{name:`Choking Spores`,intent:`attack_debuff`,dmg:5,fx:[{who:`player`,id:`poison`,n:4},{who:`player`,id:`weak`,n:2}]},entangle:{name:`Entangle`,intent:`attack_debuff`,dmg:7,addCards:{id:`wound`,n:2}},slam:{name:`Colossal Slam`,intent:`attack`,dmg:22}},ai:({turn:e})=>e===1?`awaken`:e%4==0?`slam`:[`lash`,`spores`,`entangle`][(e-2)%3]},drownedOne:{name:`Drowned One`,hp:[38,44],art:{kind:`zombie`,hue:185,size:1},moves:{claw:{name:`Claw`,intent:`attack`,dmg:11},frenzy:{name:`Frenzy`,intent:`attack`,dmg:4,times:3},gurgle:{name:`Gurgle`,intent:`attack_debuff`,dmg:5,fx:[{who:`player`,id:`weak`,n:2}]}},ai:({hpFrac:e,last:t,rng:n})=>e<.5&&t!==`frenzy`?`frenzy`:n()<.6?`claw`:`gurgle`},voltEel:{name:`Voltaic Eel`,hp:[30,36],art:{kind:`serpent`,hue:190,size:.9},moves:{shock:{name:`Shock`,intent:`attack_block`,dmg:7,block:5},discharge:{name:`Discharge`,intent:`attack`,dmg:12},coil:{name:`Coil`,intent:`buff`,block:8,fx:[{who:`self`,id:`str`,n:1}]}},ai:({turn:e})=>[`shock`,`coil`,`discharge`][(e-1)%3]},mirelurker:{name:`Mirelurker`,hp:[34,40],art:{kind:`crawler`,hue:160,size:.95},moves:{sting:{name:`Venom Sting`,intent:`attack_debuff`,dmg:6,fx:[{who:`player`,id:`poison`,n:3}]},burrow:{name:`Burrow`,intent:`block`,block:10},barb:{name:`Barb`,intent:`attack`,dmg:9}},ai:({turn:e,rng:t})=>e%3==0?`burrow`:t()<.55?`sting`:`barb`},tidecaller:{name:`Tidecaller`,hp:[42,48],art:{kind:`cultist`,hue:195,size:1.05},moves:{surge:{name:`Tidal Blessing`,intent:`buff`,fx:[{who:`allies`,id:`str`,n:2}]},bolt:{name:`Water Bolt`,intent:`attack`,dmg:9},undertow:{name:`Undertow`,intent:`attack_debuff`,dmg:4,fx:[{who:`player`,id:`frail`,n:2}]}},ai:({turn:e})=>e===1?`surge`:e%3==0?`undertow`:`bolt`},shellback:{name:`Shellback`,hp:[50,56],art:{kind:`crab`,hue:15,size:1.15},moves:{snap:{name:`Snap`,intent:`attack`,dmg:10},shell:{name:`Shell Up`,intent:`block`,block:13,fx:[{who:`self`,id:`thorns`,n:1}]},jet:{name:`Water Jet`,intent:`attack`,dmg:6,times:2}},ai:({turn:e})=>[`snap`,`shell`,`jet`,`shell`][(e-1)%4]},deepmaw:{name:`Deepmaw`,hp:[54,60],art:{kind:`maw`,hue:200,size:1.2},moves:{bite:{name:`Bite`,intent:`attack`,dmg:14},lure:{name:`Luminous Lure`,intent:`debuff`,fx:[{who:`player`,id:`vulnerable`,n:2}]},swallow:{name:`Swallow`,intent:`attack_buff`,dmg:8,heal:8}},ai:({turn:e})=>[`lure`,`bite`,`swallow`][(e-1)%3]},abyssalKnight:{name:`Abyssal Knight`,hp:[108,116],elite:!0,art:{kind:`knight`,hue:215,size:1.3},moves:{blade:{name:`Voidblade`,intent:`attack`,dmg:15},oath:{name:`Dark Oath`,intent:`buff`,block:14,fx:[{who:`self`,id:`str`,n:2}]},condemn:{name:`Condemn`,intent:`debuff`,fx:[{who:`player`,id:`vulnerable`,n:2},{who:`player`,id:`weak`,n:2}]},execute:{name:`Execute`,intent:`attack`,dmg:9,times:2}},ai:({turn:e})=>[`condemn`,`blade`,`oath`,`execute`][(e-1)%4]},siren:{name:`Siren`,hp:[92,100],elite:!0,art:{kind:`siren`,hue:280,size:1.15},moves:{song:{name:`Dirge`,intent:`debuff`,fx:[{who:`player`,id:`weak`,n:2},{who:`player`,id:`frail`,n:2}]},rend:{name:`Talon Rend`,intent:`attack`,dmg:12},mend:{name:`Mend`,intent:`heal`,heal:12,block:6},shriek:{name:`Shriek`,intent:`attack`,dmg:7,times:2}},ai:({turn:e,hpFrac:t,last:n})=>t<.55&&n!==`mend`?`mend`:[`song`,`rend`,`shriek`][(e-1)%3]},leviathan:{name:`Leviathan's Maw`,hp:[260,260],boss:!0,art:{kind:`leviathan`,hue:195,size:1.7},moves:{tide:{name:`Rising Tide`,intent:`buff`,block:15,fx:[{who:`self`,id:`str`,n:1}]},crush:{name:`Crushing Jaws`,intent:`attack`,dmg:17},brine:{name:`Black Brine`,intent:`attack_debuff`,dmg:6,fx:[{who:`player`,id:`poison`,n:5},{who:`player`,id:`weak`,n:2}]},consume:{name:`Consume the Deep`,intent:`heal`,heal:20,block:10},cataclysm:{name:`Cataclysm`,intent:`attack`,dmg:30}},ai:({turn:e})=>e===1?`tide`:e%4==0?`cataclysm`:[`crush`,`brine`,`consume`][(e-2)%3]},voidWisp:{name:`Void Wisp`,hp:[26,30],art:{kind:`wisp`,hue:275,size:.78},moves:{zap:{name:`Void Zap`,intent:`attack`,dmg:7},siphon:{name:`Siphon`,intent:`attack_buff`,dmg:5,heal:5}},ai:({rng:e})=>e()<.6?`zap`:`siphon`},obsidianGolem:{name:`Obsidian Golem`,hp:[64,72],art:{kind:`golem`,hue:270,size:1.3},moves:{pound:{name:`Pound`,intent:`attack`,dmg:14},harden:{name:`Harden`,intent:`block`,block:14},quake:{name:`Quake`,intent:`attack_debuff`,dmg:10,fx:[{who:`player`,id:`frail`,n:2}]}},ai:({turn:e})=>[`pound`,`harden`,`quake`][(e-1)%3]},starCultist:{name:`Star Cultist`,hp:[46,52],art:{kind:`cultist`,hue:290,size:1.05},moves:{ritual:{name:`Star Ritual`,intent:`buff`,fx:[{who:`self`,id:`ritual`,n:3}]},scorch:{name:`Starfire`,intent:`attack`,dmg:9}},ai:({turn:e})=>e===1?`ritual`:`scorch`},shade:{name:`Shade`,hp:[42,48],art:{kind:`shade`,hue:260,size:1},moves:{slash:{name:`Dual Slash`,intent:`attack`,dmg:6,times:2},gloom:{name:`Gloom`,intent:`attack_debuff`,dmg:6,fx:[{who:`player`,id:`weak`,n:2}]},vanish:{name:`Vanish`,intent:`block`,block:12}},ai:({turn:e,rng:t})=>e%3==0?`vanish`:t()<.5?`slash`:`gloom`},chaosHound:{name:`Chaos Hound`,hp:[56,64],art:{kind:`beast`,hue:315,size:1.1},startStatus:{rampage:1},moves:{bite:{name:`Chaos Bite`,intent:`attack`,dmg:9,ramp:3},howl:{name:`Warp Howl`,intent:`buff`,fx:[{who:`self`,id:`str`,n:2}]}},ai:({turn:e})=>e%4==0?`howl`:`bite`},watcherEye:{name:`Watcher Eye`,hp:[48,56],art:{kind:`eye`,hue:250,size:1.05},moves:{gaze:{name:`Piercing Gaze`,intent:`attack_debuff`,dmg:8,fx:[{who:`player`,id:`vulnerable`,n:2}]},beam:{name:`Ruin Beam`,intent:`attack`,dmg:15},blink:{name:`Blink`,intent:`attack_block`,dmg:5,block:10}},ai:({turn:e})=>[`gaze`,`beam`,`blink`][(e-1)%3]},voidColossus:{name:`Voidforged Colossus`,hp:[155,168],elite:!0,art:{kind:`golem`,hue:305,size:1.5},moves:{slam:{name:`Void Slam`,intent:`attack`,dmg:20},fortify:{name:`Fortify`,intent:`buff`,block:18,fx:[{who:`self`,id:`str`,n:2}]},shatter:{name:`Shatter`,intent:`attack_debuff`,dmg:8,fx:[{who:`player`,id:`frail`,n:3}]}},ai:({turn:e})=>[`shatter`,`slam`,`fortify`,`slam`][(e-1)%4]},heraldOfEnd:{name:`Herald of the End`,hp:[128,142],elite:!0,art:{kind:`shade`,hue:335,size:1.4},moves:{doom:{name:`Doomsong`,intent:`debuff`,fx:[{who:`player`,id:`poison`,n:7}]},reave:{name:`Reave`,intent:`attack`,dmg:16},flame:{name:`Black Flame`,intent:`attack`,dmg:8,times:2},rise:{name:`Apotheosis`,intent:`buff`,fx:[{who:`self`,id:`str`,n:3}]}},ai:({turn:e})=>e%4==0?`rise`:[`doom`,`reave`,`flame`][(e-1)%3]},sovereign:{name:`The Eternal Sovereign`,hp:[330,330],boss:!0,art:{kind:`sovereign`,hue:285,size:1.8},moves:{scepter:{name:`Scepter Strike`,intent:`attack`,dmg:18},gravitas:{name:`Gravitas`,intent:`buff`,block:20,fx:[{who:`self`,id:`str`,n:2}]},starfall:{name:`Starfall`,intent:`attack`,dmg:11,times:2},ruin:{name:`Word of Ruin`,intent:`attack_debuff`,dmg:4,fx:[{who:`player`,id:`poison`,n:4},{who:`player`,id:`weak`,n:2},{who:`player`,id:`frail`,n:2}]},ascend:{name:`Ascend`,intent:`buff`,block:30,fx:[{who:`self`,id:`str`,n:4}]},annihilation:{name:`Annihilation`,intent:`attack`,dmg:34}},ai:e=>{let t=e.self;return e.hpFrac<=.5&&!t.flags.ascended?(t.flags.ascended=!0,`ascend`):t.flags.ascended?(t.flags.p2=(t.flags.p2||0)+1,t.flags.p2%3==0?`annihilation`:[`scepter`,`starfall`,`ruin`,`gravitas`][t.flags.p2%4]):[`scepter`,`gravitas`,`starfall`,`ruin`][(e.turn-1)%4]}}},zl=[{weak:[[`sporeling`,`sporeling`],[`duskfang`],[`gloomslime`],[`sporeling`,`sporeling`,`sporeling`]],normal:[[`duskfang`,`sporeling`],[`ashAcolyte`],[`waylayer`],[`thornling`,`thornling`],[`gloomslime`,`sporeling`],[`duskfang`,`duskfang`],[`waylayer`,`sporeling`]],elite:[[`gravewarden`],[`alphaFang`]],boss:[[`rootheart`]]},{weak:[[`voltEel`],[`mirelurker`],[`drownedOne`]],normal:[[`drownedOne`,`voltEel`],[`tidecaller`,`mirelurker`],[`shellback`],[`deepmaw`],[`drownedOne`,`drownedOne`],[`tidecaller`,`voltEel`],[`mirelurker`,`mirelurker`]],elite:[[`abyssalKnight`],[`siren`]],boss:[[`leviathan`]]},{weak:[[`voidWisp`,`voidWisp`],[`shade`],[`starCultist`]],normal:[[`obsidianGolem`],[`shade`,`voidWisp`],[`chaosHound`],[`watcherEye`],[`starCultist`,`voidWisp`],[`shade`,`shade`],[`chaosHound`,`voidWisp`],[`watcherEye`,`starCultist`]],elite:[[`voidColossus`],[`heraldOfEnd`]],boss:[[`sovereign`]]}],Bl={forgottenShrine:{name:`Forgotten Shrine`,glyph:`⛩`,hue:45,text:`A moss-eaten shrine hums with old power. Offerings of bone and silver litter its base. Something watches from inside the stone.`,choices:[{label:`Pray`,sub:`Remove a card from your deck.`,ops:[{pickRemove:!0}]},{label:`Desecrate`,sub:`Gain 90 gold. Gain a Hex.`,ops:[{gold:90},{addCard:`hex`}]},{label:`Leave`,sub:``,ops:[]}]},woundedKnight:{name:`The Wounded Knight`,glyph:`⚔`,hue:210,text:`A knight slumps against a shattered pillar, breath rattling behind a crushed visor. One gauntlet clutches a relic; the other beckons you closer.`,choices:[{label:`Aid him`,sub:`Lose 8 HP. He rewards you with a relic.`,ops:[{hp:-8},{addRelic:`random`}]},{label:`Loot him`,sub:`Gain 65 gold. Gain a Hex.`,ops:[{gold:65},{addCard:`hex`}]},{label:`Leave`,sub:``,ops:[]}]},voidChest:{name:`Humming Chest`,glyph:`▣`,hue:280,text:`A black iron chest sits alone in the gloom, humming a note you feel in your teeth. Its lock is already broken.`,choices:[{label:`Open it`,sub:`It might hold a relic... or teeth.`,ops:[{roll:[{p:.55,ops:[{addRelic:`random`}],text:`Inside: a relic, warm as a heartbeat.`},{p:.45,ops:[{hp:-12}],text:`Teeth. You pull back a mangled hand. (-12 HP)`}]}]},{label:`Leave`,sub:``,ops:[]}]},emberFountain:{name:`Fountain of Embers`,glyph:`❂`,hue:30,text:`Liquid light pools in a cracked basin, throwing sparks that do not burn. It smells of summer and old victories.`,choices:[{label:`Bathe`,sub:`Heal 35% of your Max HP.`,ops:[{heal:.35}]},{label:`Bottle it`,sub:`Gain a Healing Potion.`,ops:[{potion:`healing`}]},{label:`Leave`,sub:``,ops:[]}]},forge:{name:`The Forgotten Forge`,glyph:`⚒`,hue:15,text:`An anvil of black star-metal, still warm. Hammers hang in racks, waiting for hands that died an age ago.`,choices:[{label:`Temper`,sub:`Upgrade a card.`,ops:[{pickUpgrade:!0}]},{label:`Leave`,sub:``,ops:[]}]},gambler:{name:`The Bone Gambler`,glyph:`⚄`,hue:50,text:`A grinning figure rattles a cup of knuckle-bones. "One throw, stranger. Fortune loves the reckless."`,choices:[{label:`Bet 40 gold`,sub:`45% chance to win 110 gold.`,needGold:40,ops:[{gold:-40},{roll:[{p:.45,ops:[{gold:110}],text:`The bones land your way. +110 gold.`},{p:.55,ops:[],text:`The bones betray you. The gambler grins wider.`}]}]},{label:`Walk away`,sub:``,ops:[]}]},mirror:{name:`The Silvered Mirror`,glyph:`◐`,hue:220,text:`A tall mirror stands in the rubble, unbroken. Your reflection moves half a breath behind you — and it is smiling.`,choices:[{label:`Reflect`,sub:`Duplicate a card in your deck.`,ops:[{pickDuplicate:!0}]},{label:`Shatter it`,sub:`Lose 6 HP. Remove a card from your deck.`,ops:[{hp:-6},{pickRemove:!0}]},{label:`Leave`,sub:``,ops:[]}]},library:{name:`The Drowned Library`,glyph:`❦`,hue:190,text:`Shelves of waterlogged grimoires stretch into the dark. Most are pulp — but a few pages still glow faintly.`,choices:[{label:`Study`,sub:`Choose 1 of 5 cards to add to your deck.`,ops:[{pickCard:5}]},{label:`Rest among the stacks`,sub:`Heal 20% of your Max HP.`,ops:[{heal:.2}]}]},fleshTrader:{name:`The Flesh Trader`,glyph:`♠`,hue:320,text:`"Vitality is a currency," purrs a thing wearing a merchant's coat. "And you look flush with it." Long fingers open to reveal a relic.`,choices:[{label:`Trade`,sub:`Lose 8 Max HP. Gain a relic.`,ops:[{maxHp:-8},{addRelic:`random`}]},{label:`Refuse`,sub:``,ops:[]}]},cursedIdol:{name:`The Cursed Idol`,glyph:`☿`,hue:100,text:`A jade idol sits on a plinth of skulls, radiating a soft warmth. It has clearly been left here for a reason.`,choices:[{label:`Take it`,sub:`Gain a relic. Gain a Hex.`,ops:[{addRelic:`random`},{addCard:`hex`}]},{label:`Leave it`,sub:``,ops:[]}]},ruinedCamp:{name:`Ruined Camp`,glyph:`⛺`,hue:35,text:`A campfire, still smoldering. Bedrolls, torn. Whoever slept here left in a hurry — and left their packs behind.`,choices:[{label:`Rest`,sub:`Heal 15% of your Max HP.`,ops:[{heal:.15}]},{label:`Scavenge`,sub:`Gain 45 gold and a random potion.`,ops:[{gold:45},{potion:`random`}]}]}},Vl=[{normal:[12,20],elite:[28,38],boss:[70,80]},{normal:[18,28],elite:[35,48],boss:[85,100]},{normal:[24,36],elite:[45,60],boss:[100,120]}],Hl={removeCost:75,cardPrice:{common:[45,55],uncommon:[68,82],rare:[135,160]},relicPrice:{common:[140,160],uncommon:[220,250],rare:[270,300]},potionPrice:[48,62]},Ul,Wl,Gl,Kl,ql,Jl,Yl,Xl=[],Zl,Ql,$l,eu,tu,nu,ru,iu=[],au,ou=0,su=.5,cu=0,lu,uu,du=[],fu=matchMedia(`(prefers-reduced-motion: reduce)`).matches,pu={sky:new W(724506),fog:new W(1317422),particles:new W(16752717),glow:new W(6750110)},mu={sky:pu.sky.clone(),fog:pu.fog.clone(),particles:pu.particles.clone(),glow:pu.glow.clone()},hu={x:0,y:0},gu=0,_u=1,q={x:7,z:-20,bottom:-16,top:54,baseY:-6,rowH:1.06,actGap:4.2,azBase:Math.atan2(30,-7),colSpread:.34},vu=15,yu=e=>q.baseY+e*((vu-1)*q.rowH+q.actGap);function bu(e){let t=At.clamp((e-q.bottom)/(q.top-q.bottom),0,1),n=1+Math.sin(t*21)*.07+Math.sin(t*57)*.05+Math.sin(t*9+1.7)*.06;return(1-t)**1.15*6.2*n+.85}function xu(e,t){let n=yu(e)+t.row*q.rowH+t.jy*.5,r=q.azBase+(t.col-3+t.jx)*q.colSpread,i=Math.max(bu(n)+.5,3.6);return new V(q.x+Math.cos(r)*i,n,q.z+Math.sin(r)*i)}var Su=`ambient`,Cu=yu(0),wu=yu(0),Tu=0,Eu=0,Du=0,Ou=new V(0,yu(0),-6),ku=new V,Au=new V,ju=new V,Mu=new W(16777215),Nu=new W,Pu=new W(12571903);function Fu(e,t){wu=yu(e)+Math.max(0,t)*q.rowH}function Iu(e,t){Su=`map`,Tu=e,Eu=Math.max(0,t),Du=0}function Lu(){Su=`ambient`}function Ru(e){Du=At.clamp(Du+e,-Eu-1,15.5-Eu)}var zu=null,Bu=null;function Vu(e,t){zu=e,Bu=t}function Hu(){zu=null,Bu=null}function Uu(e){let t=document.createElement(`canvas`);t.width=t.height=128;let n=t.getContext(`2d`),r=n.createRadialGradient(64,64,0,64,64,64);for(let[t,n]of e)r.addColorStop(t,n);return n.fillStyle=r,n.fillRect(0,0,128,128),new zi(t)}function Wu(e,t,n,r,i,a){let o=new jr,s=new Float32Array(e*3),c=new Float32Array(e);for(let t=0;t<e;t++)s[t*3]=(Math.random()-.5)*n,s[t*3+1]=(Math.random()-.5)*r,s[t*3+2]=-Math.random()*i,c[t]=Math.random()*Math.PI*2;return o.setAttribute(`position`,new gr(s,3)),o.userData.seeds=c,new Ii(o,new ji({size:t,map:Uu([[0,`rgba(255,255,255,1)`],[.35,`rgba(255,255,255,.6)`],[1,`rgba(255,255,255,0)`]]),transparent:!0,opacity:a,depthWrite:!1,blending:2,sizeAttenuation:!0}))}var Gu=new URLSearchParams(location.search).get(`input`)===`touch`||matchMedia(`(pointer: coarse)`).matches;function Ku(){Ul=new hl({canvas:document.getElementById(`bg3d`),antialias:!Gu,alpha:!1}),Ul.setPixelRatio(Math.min(devicePixelRatio,Gu?1.35:1.75)),Wl=new Ln,Wl.fog=new In(pu.fog.getHex(),.055),Gl=new ja(58,1,.1,120),Gl.position.set(0,Cu,10),Jl=Wu(Gu?480:900,.16,46,26,40,.75),Yl=Wu(Gu?130:240,.32,46,26,34,.5),Wl.add(Jl,Yl),Zl=new On,Wl.add(Zl);let e=Uu([[0,`rgba(255,255,255,.75)`],[.4,`rgba(255,255,255,.25)`],[1,`rgba(255,255,255,0)`]]);for(let t=0;t<(Gu?5:7);t++){let t=new Zr(new Lr({map:e,transparent:!0,opacity:.1+Math.random()*.1,depthWrite:!1,blending:2})),n=14+Math.random()*22;t.scale.set(n,n*.7,1),t.position.set((Math.random()-.5)*40,(Math.random()-.5)*18-3,-12-Math.random()*22),t.userData.wob=Math.random()*Math.PI*2,Zl.add(t),Xl.push(t)}let t=[];for(let e=0;e<=56;e++){let n=e/56,r=q.bottom+n*(q.top-q.bottom);t.push(new B(bu(r),r))}Ql=new si({color:263435,fog:!1});let n=new yi(new qi(t,9),Ql);n.position.set(q.x,0,q.z),n.rotation.y=.35,Wl.add(n);let r=new yi(new qi(t.map(e=>new B(e.x*.5,e.y*.5-10)),6),Ql);r.position.set(-15,0,-30),Wl.add(r);{let e=Gu?70:120;tu=new Lr({map:Uu([[0,`rgba(255,255,255,.95)`],[.4,`rgba(255,255,255,.35)`],[1,`rgba(255,255,255,0)`]]),transparent:!0,opacity:.55,depthWrite:!1,blending:2});for(let t=0;t<e;t++){let e=q.bottom+6+Math.random()*(q.top-q.bottom-10),t=q.azBase+(Math.random()-.5)*2.4,n=bu(e)+.12,r=new Zr(tu),i=.16+Math.random()*.26;r.scale.set(i,i,1),r.position.set(q.x+Math.cos(t)*n,e,q.z+Math.sin(t)*n),Wl.add(r)}}$l=new yi(new Yi(.32,12,12),new si({color:16777215,fog:!1})),$l.position.set(q.x,q.top+.9,q.z),Wl.add($l),eu=new Zr(new Lr({map:Uu([[0,`rgba(255,255,255,.9)`],[.3,`rgba(255,255,255,.3)`],[1,`rgba(255,255,255,0)`]]),transparent:!0,opacity:.8,depthWrite:!1,blending:2,fog:!1})),eu.scale.set(4,4,1),eu.position.copy($l.position),Wl.add(eu),ru=new si({color:329485});let i=new yi(new Wi(70,24),ru);i.rotation.x=-Math.PI/2,i.position.y=-9.6,Wl.add(i),nu=new si({color:395792});let a=new Ki(1,1,6);for(let e=0;e<(Gu?32:52);e++){let e=new yi(a,nu),t,n,r;do t=Math.random()*Math.PI*2,n=7+Math.random()*28,r=Math.sin(t)*n-8;while(r>4);let i=2+Math.random()*3.4;e.scale.set(.5+Math.random()*.9,i,.5+Math.random()*.9),e.position.set(Math.cos(t)*n,-9.6+i/2,r),Wl.add(e)}{let e=Uu([[0,`rgba(255,255,255,.55)`],[.5,`rgba(255,255,255,.22)`],[1,`rgba(255,255,255,0)`]]);for(let t of[yu(1)-2.2,yu(2)-2.2]){let n=new Lr({map:e,transparent:!0,opacity:.34,depthWrite:!1});iu.push(n);for(let e=0;e<(Gu?10:16);e++){let e=new Zr(n),r=10+Math.random()*14;e.scale.set(r,r*.32,1);let i,a,o;do i=Math.random()*Math.PI*2,a=5+Math.random()*22,o=q.z+Math.sin(i)*a;while(o>-7);e.position.set(q.x+Math.cos(i)*a,t+(Math.random()-.5)*1.6,o),e.userData.wob=Math.random()*Math.PI*2,e.userData.cloud=!0,Wl.add(e),Xl.push(e)}}}au=Wu(Gu?170:300,.13,44,26,34,.5),Wl.add(au),lu=new On,lu.position.y=Cu,uu=new si({color:131848,transparent:!0,opacity:.96,fog:!1});let o=(e,t,n,r,i)=>{let a=new yi(e,uu);return a.position.set(t,n,r),a.rotation.z=i,lu.add(a),a},s=new Ki(.55,7.5,5);o(s,-4.5,-3.1,5.3,.42),o(s,-5.3,-2.6,4.5,.78),o(s,4.7,-3.3,5.1,-.4),o(s,5.5,-2.4,4.3,-.82);let c=new Gi(.032,.032,8,5);du=[o(c,-4.1,5.9,5.7,.05),o(c,4.7,6.1,5.5,-.07)],Wl.add(lu),Kl=new wl(Ul),Kl.addPass(new Tl(Wl,Gl)),ql=new Dl(new B(innerWidth,innerHeight),.85,.55,.16),Kl.addPass(ql),Kl.addPass(new kl);let l=()=>{Ul.setSize(innerWidth,innerHeight),Kl.setSize(innerWidth,innerHeight),Gu&&ql.setSize(innerWidth/2,innerHeight/2),Gl.aspect=innerWidth/innerHeight,Gl.updateProjectionMatrix()};l(),addEventListener(`resize`,l),addEventListener(`pointermove`,e=>{hu.x=(e.clientX/innerWidth-.5)*2,hu.y=(e.clientY/innerHeight-.5)*2}),Ju(0,!0),requestAnimationFrame(Qu)}var qu=.85;function Ju(e,t=!1){let n=jl[Math.min(e,jl.length-1)].theme;if(mu.sky.setHex(n.sky),mu.fog.setHex(n.fog),mu.particles.setHex(n.particles),mu.glow.setHex(n.glow),qu=.85,ou=Math.min(e,2),su=[.5,.42,.62][ou],t)for(let e of Object.keys(pu))pu[e].copy(mu[e])}function Yu(){mu.sky.setHex(5911634),mu.fog.setHex(9062997),mu.particles.setHex(16767392),mu.glow.setHex(16761976),qu=1.2,su=.12}function Xu(e=1){gu=Math.min(2.2,gu+e),_u=Math.min(7,_u+e*2.4)}var Zu=0;function Qu(e){requestAnimationFrame(Qu);let t=Math.min(.05,(e-Zu)/1e3||.016);Zu=e;let n=e/1e3;for(let e of Object.keys(pu))pu[e].lerp(mu[e],Math.min(1,t*1.4));ou===2&&!fu&&Math.random()<t/11&&(cu=.7+Math.random()*.5),cu*=.008**t,Wl.background=Nu.copy(pu.sky).lerp(Pu,Math.min(.6,cu*.5)),Wl.fog.color.copy(pu.fog).lerp(Pu,Math.min(.4,cu*.3)),Jl.material.color.copy(pu.particles),Yl.material.color.copy(pu.glow);for(let e of Xl)e.userData.cloud||e.material.color.copy(pu.fog).lerp(pu.particles,.5),e.position.x+=Math.sin(n*.08+e.userData.wob)*.004;Ql.color.copy(pu.sky).multiplyScalar(.42),ru.color.copy(pu.sky).multiplyScalar(.3),nu.color.copy(pu.sky).multiplyScalar(.38),tu.color.copy(pu.glow);for(let e of iu)e.color.copy(pu.fog).lerp(Mu,.42);$l.material.color.copy(pu.glow),eu.material.color.copy(pu.glow);let r=.65+Math.sin(n*1.7)*.25;eu.material.opacity=r,eu.scale.setScalar(3.2+r*1.6),Yl.material.opacity=.42+Math.sin(n*.9)*.12,_u+=(1-_u)*Math.min(1,t*2.5);let i=Gl.position.y;for(let[e,r]of[[Jl,1],[Yl,.55]]){let a=e.geometry.attributes.position,o=e.geometry.userData.seeds;for(let e=0;e<a.count;e++){let s=a.getY(e)+t*r*_u*(.35+o[e]%1*.5),c=a.getX(e)+Math.sin(n*.5+o[e])*t*.18;s>i+14&&(s=i-14,c=(Math.random()-.5)*46),s<i-15&&(s=i-14),a.setY(e,s),a.setX(e,c)}a.needsUpdate=!0}gu*=.02**t;{au.material.opacity+=(su-au.material.opacity)*Math.min(1,t*1.2),ou===0?au.material.color.copy(pu.particles).lerp(Mu,.55):ou===1?au.material.color.copy(pu.glow).lerp(Mu,.25):au.material.color.copy(pu.particles);let e=au.geometry.attributes.position,r=au.geometry.userData.seeds;for(let a=0;a<e.count;a++){let o=e.getX(a),s=e.getY(a),c=r[a]%1;ou===0?(s-=t*(.45+c*.55),o+=Math.sin(n*.7+r[a])*t*.5):ou===1?(s-=t*(.14+c*.2),o+=Math.sin(n*.35+r[a])*t*.9):(o-=t*(3.4+c*2.8),s-=t*(.5+c*.5)),s<i-14&&(s+=28),s>i+14&&(s-=28),o<-23&&(o+=46),o>23&&(o-=46),e.setX(a,o),e.setY(a,s)}e.needsUpdate=!0}Cu+=(wu-Cu)*Math.min(1,t*1.6),Zl.position.y=i*.93+Math.sin(n*.3)*.2;let a=Math.max(1,1.05/Gl.aspect);if(Su===`map`){let e=At.clamp(Eu+1.6+Du,1.2,15.4),t=yu(Tu)+e*q.rowH,n=(Math.max(bu(t),3.1)+8.2)*a-gu*.4,r=q.azBase+hu.x*.06;ku.set(q.x+Math.cos(r)*n,t+1.1-hu.y*.5,q.z+Math.sin(r)*n),Au.set(q.x,t+1.9,q.z)}else ku.set(hu.x*.9,Cu-hu.y*.55+Math.sin(n*.22)*.25,10+Math.sin(n*.1)*.3-gu*.9),Au.set(0,Cu,-6);if(lu.position.y+=(i-lu.position.y)*Math.min(1,t*2.2),uu.opacity+=((Su===`map`?0:.96)-uu.opacity)*Math.min(1,t*3),du[0].rotation.z=.05+Math.sin(n*.5)*.028,du[1].rotation.z=-.07+Math.sin(n*.42+2)*.024,Gl.position.lerp(ku,Math.min(1,t*2.2)),Ou.lerp(Au,Math.min(1,t*2.2)),Gl.lookAt(Ou),Gl.rotation.z+=Math.sin(n*.13)*.012+gu*(Math.random()-.5)*.012,Bu&&zu){let e=[];for(let t of zu){ju.copy(t.pos).project(Gl);let n=Gl.position.distanceTo(t.pos);e.push({id:t.id,x:(ju.x*.5+.5)*innerWidth,y:(-ju.y*.5+.5)*innerHeight,s:At.clamp(9*a/n,.4,1.3),fade:ju.z>1?0:At.clamp(1.3-Math.abs(t.pos.y-Ou.y)/(7.5*a),.1,1)})}Bu(e)}ql.strength=qu+gu*.55+cu*.45,Kl.render()}var $u,J,ed,td,nd=[],rd=[],id=0,ad=0,od=0,sd=0,cd=()=>Math.min(devicePixelRatio,2);function ld(){$u=document.getElementById(`vfx`),J=$u.getContext(`2d`),ed=document.getElementById(`floaties`),td=document.getElementById(`shake`);let e=()=>{$u.width=innerWidth*cd(),$u.height=innerHeight*cd()};e(),addEventListener(`resize`,e),requestAnimationFrame(dd)}var ud=0;function dd(e){requestAnimationFrame(dd);let t=Math.min(.05,(e-ud)/1e3||.016);if(ud=e,e<sd)return;let n=cd();J.clearRect(0,0,$u.width,$u.height),J.save(),J.scale(n,n),nd=nd.filter(e=>(e.life-=t)>0);for(let e of nd){e.x+=e.vx*t,e.y+=e.vy*t,e.vy+=(e.grav||0)*t,e.vx*=1-(e.drag||0)*t,e.vy*=1-(e.drag||0)*t;let n=Math.min(1,e.life/(e.fade||.3));if(J.globalAlpha=n*(e.alpha??1),J.globalCompositeOperation=e.add?`lighter`:`source-over`,e.kind===`spark`){let t=Math.hypot(e.vx,e.vy)*.045+2,r=Math.atan2(e.vy,e.vx);J.strokeStyle=e.color,J.lineWidth=e.size*n,J.beginPath(),J.moveTo(e.x,e.y),J.lineTo(e.x-Math.cos(r)*t,e.y-Math.sin(r)*t),J.stroke()}else if(e.kind===`ring`)e.r+=e.vr*t,J.strokeStyle=e.color,J.lineWidth=Math.max(.5,e.size*n),J.beginPath(),J.arc(e.x,e.y,e.r,0,Math.PI*2),J.stroke();else if(e.kind===`slash`){e.prog=Math.min(1,(e.prog||0)+t/e.dur);let r=e.arc*e.prog;J.strokeStyle=e.color,J.lineCap=`round`;for(let t=0;t<3;t++)J.globalAlpha=n*(.9-t*.3),J.lineWidth=(e.size-t*3)*(1-e.prog*.6),J.beginPath(),J.arc(e.x,e.y,e.r+t*7,e.a0,e.a0+r),J.stroke()}else J.fillStyle=e.color,J.beginPath(),J.arc(e.x,e.y,e.size*n,0,Math.PI*2),J.fill()}J.globalCompositeOperation=`source-over`,J.globalAlpha=1,rd=rd.filter(e=>(e.life-=t)>0);for(let e of rd)J.globalAlpha=e.life/e.dur*e.alpha,J.fillStyle=e.color,J.fillRect(0,0,innerWidth,innerHeight);J.restore(),id>.1||Math.abs(ad)>.1?(ad=(Math.random()-.5)*id,od=(Math.random()-.5)*id,id*=.001**t,td.style.transform=`translate(${ad.toFixed(1)}px,${od.toFixed(1)}px)`):td.style.transform&&(td.style.transform=``,id=0)}function fd(e=8){id=Math.max(id,e)}function pd(e=60){sd=performance.now()+e}function md(e=`#fff`,t=.18,n=.25){rd.push({color:e,alpha:t,dur:n,life:n})}function hd(e,t,{color:n=`#ffd166`,n:r=18,speed:i=260,spread:a=Math.PI*2,angle:o=0,size:s=3,grav:c=300,kind:l=`spark`,add:u=!0,life:d=.5}={}){for(let f=0;f<r;f++){let r=o+(Math.random()-.5)*a,f=i*(.35+Math.random()*.75);nd.push({kind:l,x:e,y:t,vx:Math.cos(r)*f,vy:Math.sin(r)*f,size:s*(.6+Math.random()*.8),color:n,grav:c,drag:1.6,life:d*(.6+Math.random()*.8),fade:.25,add:u})}}function gd(e,t,n,r=8,i=420,a=4){nd.push({kind:`ring`,x:e,y:t,r,vr:i,size:a,color:n,life:.45,fade:.45,add:!0})}function _d(e,t,n=`#fff`){let r=-Math.PI*.85+(Math.random()-.5)*.6;nd.push({kind:`slash`,x:e,y:t,r:46+Math.random()*18,a0:r,arc:Math.PI*.8,prog:0,dur:.14,size:13,color:n,life:.3,fade:.18,add:!0})}function vd(e,t,n,r=10){for(let i=0;i<r;i++)nd.push({kind:`dot`,x:e+(Math.random()-.5)*60,y:t+(Math.random()-.5)*40,vx:(Math.random()-.5)*30,vy:-40-Math.random()*60,size:2.5+Math.random()*2.5,color:n,grav:-20,life:.9+Math.random()*.5,fade:.5,add:!0,alpha:.9})}function yd(e,t,n,r=``){let i=document.createElement(`div`);i.className=`floaty ${r}`,i.innerHTML=n,i.style.left=`${e}px`,i.style.top=`${t}px`,ed.appendChild(i);let a=(Math.random()-.5)*40,o=r.includes(`crit`),s=o?(Math.random()-.5)*16:r.includes(`dmg`)?(Math.random()-.5)*8:0,c,l=1100;o?(l=1250,c=[{transform:`translate(-50%,-50%) scale(0.5)`,opacity:0,filter:`brightness(3)`},{transform:`translate(-50%,-92%) scale(1.45) rotate(${s}deg)`,opacity:1,filter:`brightness(1.9)`,offset:.13},{transform:`translate(-50%,-110%) scale(1.05) rotate(${s}deg)`,opacity:1,filter:`brightness(1)`,offset:.34},{transform:`translate(calc(-50% + ${a}px),-230%) scale(0.98) rotate(${s}deg)`,opacity:0,filter:`brightness(1)`}]):c=r.includes(`poisonf`)?[{transform:`translate(-50%,-50%) scale(0.7)`,opacity:0},{transform:`translate(-50%,-26%) scale(1.05)`,opacity:1,offset:.2},{transform:`translate(calc(-50% + ${a*.4}px),80%) scale(0.88)`,opacity:0}]:[{transform:`translate(-50%,-50%) scale(0.6)`,opacity:0},{transform:`translate(-50%,-90%) scale(1.15) rotate(${s}deg)`,opacity:1,offset:.18},{transform:`translate(calc(-50% + ${a}px),-230%) scale(0.95) rotate(${s}deg)`,opacity:0}],i.animate(c,{duration:l,easing:`cubic-bezier(.2,.7,.3,1)`}).onfinish=()=>i.remove()}function bd(e){let t=e.querySelector(`svg`),n=e.getBoundingClientRect();if(!t||!n.width)return;let r=t.outerHTML,i=50+(Math.random()-.5)*14,a=52+(Math.random()-.5)*14,o=[];for(let e=0;e<11;e++){let t=e/11*Math.PI*2+(Math.random()-.5)*.34,n=78+Math.random()*22;o.push([i+Math.cos(t)*n,a+Math.sin(t)*n,t])}for(let e=0;e<11;e++){let[t,s]=o[e],[c,l]=o[(e+1)%11],u=document.createElement(`div`);u.style.cssText=`position:fixed;left:${n.left}px;top:${n.top}px;width:${n.width}px;height:${n.height}px;pointer-events:none;z-index:57;clip-path:polygon(${i}% ${a}%,${t.toFixed(1)}% ${s.toFixed(1)}%,${c.toFixed(1)}% ${l.toFixed(1)}%);`,u.innerHTML=r,ed.appendChild(u);let d=o[e][2]+Math.PI/11,f=55+Math.random()*120,p=Math.cos(d)*f,m=Math.sin(d)*f*.7,h=(Math.random()-.5)*110;u.animate([{transform:`translate(0,0) rotate(0deg)`,opacity:1},{transform:`translate(${(p*.55).toFixed(0)}px,${(m*.55-16).toFixed(0)}px) rotate(${(h*.5).toFixed(0)}deg)`,opacity:.95,offset:.4},{transform:`translate(${p.toFixed(0)}px,${(m+110).toFixed(0)}px) rotate(${h.toFixed(0)}deg)`,opacity:0}],{duration:780+Math.random()*300,easing:`cubic-bezier(.3,.3,.6,1)`}).onfinish=()=>u.remove()}e.style.visibility=`hidden`}var xd=e=>{let t=e.getBoundingClientRect();return{x:t.left+t.width/2,y:t.top+t.height/2}},Sd=t({MAP_COLS:()=>7,MAP_ROWS:()=>15,addCardToDeck:()=>_f,addStatus:()=>qd,applyEventOps:()=>Of,availableNodes:()=>Md,canPlay:()=>af,cardData:()=>kd,clamp:()=>Ed,clearSave:()=>Tf,drawCards:()=>ef,duplicateCardInDeck:()=>bf,effCost:()=>rf,endTurn:()=>uf,enemyMove:()=>Yd,gainPotion:()=>Ld,gainRelic:()=>Fd,genCombatRewards:()=>zd,genMap:()=>jd,genShop:()=>Vd,hasRelic:()=>Nd,healPlayer:()=>Pd,loadRun:()=>wf,loadStats:()=>Ef,makeCard:()=>Od,makeRng:()=>Cd,newRun:()=>Dd,playCard:()=>of,previewAttack:()=>pf,previewBlock:()=>mf,previewEnemyDmg:()=>hf,previewPlay:()=>gf,randomRelic:()=>Id,recordRunEnd:()=>Df,removeCardFromDeck:()=>vf,rollBossRelics:()=>Bd,rollCardReward:()=>Rd,rollEncounter:()=>Ud,rollEvent:()=>Hd,runRng:()=>Ad,saveRun:()=>Cf,startCombat:()=>Wd,upgradeCardInDeck:()=>yf,usePotion:()=>lf});function Cd(e){let t=()=>{e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296};return t.getState=()=>e,t}var wd=(e,t)=>t[Math.floor(e()*t.length)],Td=(e,[t,n])=>t+Math.floor(e()*(n-t+1)),Ed=(e,t,n)=>Math.max(t,Math.min(n,e));function Dd(e=Math.random()*2**31|0){let t={seed:e,rngState:e,uid:1,act:0,nodeId:null,floorsClimbed:0,player:{hp:Al.maxHp,maxHp:Al.maxHp,gold:Al.startGold,energyMax:Al.energy,relics:[Al.startRelic],potions:[null,null,null],deck:[]},stats:{slain:0,elites:0,bosses:0,dmgDealt:0,dmgTaken:0,cardsPlayed:0,goldEarned:0,start:Date.now()},map:null};for(let e of Al.startDeck)t.player.deck.push(Od(t,e));return t.map=jd(t),t}function Od(e,t,n=!1){return{uid:e.uid++,id:t,up:n,bonus:0}}function kd(e){let t=Ml[e.id];return e.up&&t.up?{...t,...t.up,name:t.name+`+`}:t}function Ad(e){let t=Cd(e.rngState);return()=>{let n=t();return e.rngState=t.getState(),n}}function jd(e){let t=Ad(e),n={},r=(e,t)=>`${e},${t}`,i=(e,i)=>(n[r(e,i)]||(n[r(e,i)]={id:r(e,i),row:e,col:i,type:`monster`,next:[],jx:(t()-.5)*.5,jy:(t()-.5)*.4}),n[r(e,i)]),a=new Set;for(let e=0;e<6;e++){let n;do n=Math.floor(t()*7);while(e<2&&a.has(n));a.add(n);let r=i(0,n);for(let e=1;e<14;e++){let n=Ed(r.col+(Math.floor(t()*3)-1),0,6),a=i(e,n);r.next.includes(a.id)||r.next.push(a.id),r=a}let o=i(14,3);r.next.includes(o.id)||r.next.push(o.id)}let o=Object.values(n),s=!1;for(let e of o){if(e.row===0)e.type=`monster`;else if(e.row===14)e.type=`boss`;else if(e.row===13)e.type=`rest`;else if(e.row===8)e.type=`treasure`;else{let n=t();n<.46?e.type=`monster`:n<.68?e.type=`event`:n<.81&&e.row>=5?e.type=`elite`:n<.91&&e.row>=4&&e.row<12?e.type=`rest`:e.row>=4?e.type=`shop`:e.type=`monster`}e.type===`shop`&&(s=!0)}if(!s){let e=o.filter(e=>e.type===`monster`&&e.row>=5&&e.row<=11);e.length&&(wd(t,e).type=`shop`)}return{nodes:o,visited:[]}}function Md(e){let{nodes:t,visited:n}=e.map;if(!e.nodeId)return t.filter(e=>e.row===0);let r=t.find(t=>t.id===e.nodeId);return t.filter(e=>r.next.includes(e.id))}var Nd=(e,t)=>e.player.relics.includes(t);function Pd(e,t,n=null){Nd(e,`sunBlossom`)&&(t=Math.round(t*1.5));let r=n?n.player:e.player,i=r.hp;r.hp=Ed(r.hp+t,0,r.maxHp);let a=r.hp-i;return n&&a>0&&n.queue.push({t:`heal`,who:`player`,n:a}),a}function Fd(e,t,n=null){let r=Fl[t];if(r){if(r.replaces){let t=e.player.relics.indexOf(r.replaces);t>=0&&e.player.relics.splice(t,1)}if(e.player.relics.push(t),t===`sweetRoot`&&(e.player.maxHp+=8,e.player.hp+=8),t===`obsidianHeart`&&(e.player.energyMax+=1,e.player.maxHp=Math.max(1,e.player.maxHp-8),e.player.hp=Math.min(e.player.hp,e.player.maxHp)),(t===`philosophersStone`||t===`voidCrown`)&&(e.player.energyMax+=1),t===`pandorasBox`){let t=Ad(e),n=[...Nl.common,...Nl.uncommon,...Nl.rare];for(let r of e.player.deck)(r.id===`strike`||r.id===`defend`)&&(r.id=wd(t,n),r.up=!1)}}}function Id(e,t={common:.5,uncommon:.35,rare:.15}){let n=Ad(e),r=new Set(e.player.relics),i=[`common`,`uncommon`,`rare`],a=n(),o=`common`,s=0;for(let e of i)if(s+=t[e]||0,a<s){o=e;break}let c=i.indexOf(o);for(let e=0;e<i.length;e++){let t=Il[i[(c+e)%i.length]].filter(e=>!r.has(e));if(t.length)return wd(n,t)}return null}function Ld(e,t){t===`random`&&(t=wd(Ad(e),Object.keys(Ll)));let n=e.player.potions.indexOf(null);return n<0?!1:(e.player.potions[n]=t,!0)}function Rd(e,t=`normal`){let n=Ad(e),r=3+ +!!Nd(e,`seersOrb`),i=[],a=new Set;for(;i.length<r&&a.size<40;){let e;if(t===`boss`)e=`rare`;else{let r=n();e=t===`elite`?r<.45?`common`:r<.85?`uncommon`:`rare`:r<.6?`common`:r<.92?`uncommon`:`rare`}let r=wd(n,Nl[e]);a.add(r+Math.floor(n()*4)),i.includes(r)||i.push(r)}return i}function zd(e,t){let n=Ad(e),r={gold:Td(n,Vl[e.act][t===`boss`?`boss`:t===`elite`?`elite`:`normal`]),cards:Rd(e,t),potion:null,relic:null};return t!==`boss`&&n()<.4&&(r.potion=wd(n,Object.keys(Ll))),t===`elite`&&(r.relic=Id(e)),r}function Bd(e){let t=Ad(e),n=new Set(e.player.relics),r=Il.boss.filter(e=>!n.has(e)),i=[];for(;i.length<Math.min(3,r.length);){let e=wd(t,r);i.includes(e)||i.push(e)}return i}function Vd(e){let t=Ad(e),n=([e,n],r)=>Math.round(Td(t,[e,n])*r),r=Nd(e,`merchantsMark`)?.75:1,i=[];for(let e of[`common`,`common`,`uncommon`,`uncommon`,`rare`]){let a,o=0;do a=wd(t,Nl[e]);while(i.some(e=>e.id===a)&&++o<20);i.push({id:a,price:n(Hl.cardPrice[e],r),sold:!1})}let a=new Set(e.player.relics),o=[];for(let e of[`common`,`uncommon`]){let i=Il[e].filter(e=>!a.has(e)&&!o.some(t=>t.id===e));i.length&&o.push({id:wd(t,i),price:n(Hl.relicPrice[e],r),sold:!1})}let s=[];for(let e=0;e<2;e++)s.push({id:wd(t,Object.keys(Ll)),price:n(Hl.potionPrice,r),sold:!1});return{cards:i,relics:o,potions:s,removeCost:Math.round(Hl.removeCost*r),removed:!1}}function Hd(e){let t=Ad(e),n=e.seenEvents||=[],r=Object.keys(Bl).filter(e=>!n.includes(e));r.length||(e.seenEvents=[],r=Object.keys(Bl));let i=wd(t,r);return n.push(i),i}function Ud(e,t,n){let r=Ad(e),i=zl[e.act],a=t===`boss`?i.boss:t===`elite`?i.elite:n<3?i.weak:i.normal,o=e.lastEnc,s,c=0;do s=wd(r,a);while(a.length>1&&s.join()===o&&++c<8);return e.lastEnc=s.join(),s}function Wd(e,t,n=`normal`){let r=Ad(e),i={kind:n,turn:0,over:!1,result:null,queue:[],player:{hp:e.player.hp,maxHp:e.player.maxHp,block:0,energy:0,energyMax:e.player.energyMax,statuses:{}},enemies:t.map((e,t)=>{let n=Rl[e];return{key:e,idx:t,name:n.name,maxHp:Td(r,n.hp),block:0,statuses:{...n.startStatus||{}},flags:{},lastMoves:[],moveKey:null,elite:!!n.elite,boss:!!n.boss}}),draw:[],hand:[],discard:[],exhaust:[],counters:{played:0,attacks:0,firstCardPlayed:!1,hpLost:0}};i.enemies.forEach(e=>e.hp=e.maxHp),i.draw=e.player.deck.map(e=>({...e,bonus:0})),Gd(r,i.draw);let a=i.player;if(Nd(e,`basaltIdol`)&&(a.block+=10,Kd(i,`basaltIdol`)),Nd(e,`warFetish`)&&(qd(i,a,`str`,1),Kd(i,`warFetish`)),Nd(e,`riverPearl`)&&(qd(i,a,`dex`,1),Kd(i,`riverPearl`)),Nd(e,`thornBand`)&&(qd(i,a,`thorns`,2),Kd(i,`thornBand`)),Nd(e,`vialOfLife`)&&(Pd(e,2,i),Kd(i,`vialOfLife`)),Nd(e,`philosophersStone`)&&i.enemies.forEach(e=>e.statuses.str=(e.statuses.str||0)+1),Nd(e,`voidCrown`)){let t={uid:e.uid++,id:`wound`,up:!1,bonus:0};i.draw.splice(Math.floor(r()*(i.draw.length+1)),0,t)}return Jd(e,i),nf(e,i),i}function Gd(e,t){for(let n=t.length-1;n>0;n--){let r=Math.floor(e()*(n+1));[t[n],t[r]]=[t[r],t[n]]}}function Kd(e,t){e.queue.push({t:`relicProc`,id:t})}function qd(e,t,n,r){t.statuses[n]=(t.statuses[n]||0)+r,t.statuses[n]===0&&delete t.statuses[n],e.queue.push({t:`status`,who:t===e.player?`player`:t.idx,id:n,n:r})}function Jd(e,t){let n=Ad(e);for(let e of t.enemies)e.hp<=0||(e.moveKey=Rl[e.key].ai({turn:t.turn+1,last:e.lastMoves[e.lastMoves.length-1],prev:e.lastMoves[e.lastMoves.length-2],rng:n,hpFrac:e.hp/e.maxHp,self:e}),t.queue.push({t:`intent`,idx:e.idx,move:e.moveKey}))}function Yd(e){return Rl[e.key].moves[e.moveKey]}function Xd(e,t,n,r,{isAttack:i=!0,mult:a=1}={}){if(n.hp<=0||t.over)return 0;let o=t.player,s=r;i&&(s+=o.statuses.str||0,o.statuses.weak&&(s=Math.floor(s*.75)),n.statuses.vulnerable&&(s=Math.floor(s*1.5))),s=Math.max(0,Math.floor(s*a));let c=Math.min(n.block,s);n.block-=c;let l=s-c;return n.hp-=l,e.stats.dmgDealt+=l,t.queue.push({t:`hitEnemy`,idx:n.idx,amount:l,blocked:c,hpAfter:Math.max(0,n.hp),dead:n.hp<=0,killingBlow:n.hp<=0&&l>0,overkill:Math.max(0,-n.hp)}),i&&n.statuses.thorns&&n.hp>0&&Qd(e,t,n.statuses.thorns,{source:`thorns`,isAttack:!1}),n.hp<=0&&Zd(e,t,n),l}function Zd(e,t,n){if(n.hp=0,n.statuses={},t.queue.push({t:`die`,idx:n.idx}),e.stats.slain++,n.elite&&e.stats.elites++,n.boss&&e.stats.bosses++,t.enemies.every(e=>e.hp<=0)){df(e,t);return}Nd(e,`reapersBell`)&&(t.player.energy+=1,ef(e,t,1),Kd(t,`reapersBell`),t.queue.push({t:`energy`,n:t.player.energy}))}function Qd(e,t,n,{source:r=`self`,isAttack:i=!1,attacker:a=null}={}){if(t.over)return 0;let o=t.player,s=n;i&&a&&(s+=(a.statuses.str||0)+(a.flags.rampBonus||0),a.statuses.weak&&(s=Math.floor(s*.75)),o.statuses.vulnerable&&(s=Math.floor(s*1.5)),Nd(e,`wardingCharm`)&&s<=5&&s>0&&(s=1,Kd(t,`wardingCharm`))),s=Math.max(0,s);let c=0;(i||r===`thorns`)&&(c=Math.min(o.block,s),o.block-=c);let l=s-c;return o.hp-=l,e.stats.dmgTaken+=Math.max(0,l),t.counters.hpLost+=Math.max(0,l),t.queue.push({t:`hitPlayer`,amount:l,blocked:c,hpAfter:Math.max(0,o.hp),source:r}),i&&o.statuses.thorns&&a&&a.hp>0&&Xd(e,t,a,o.statuses.thorns,{isAttack:!1}),o.hp<=0&&ff(e,t),l}function $d(e,t,n,r=!0){let i=n;return t===e.player&&r&&(i+=t.statuses.dex||0,t.statuses.frail&&(i=Math.floor(i*.75))),i=Math.max(0,i),t.block+=i,e.queue.push({t:`blockGain`,who:t===e.player?`player`:t.idx,n:i,total:t.block}),i}function ef(e,t,n){let r=Ad(e);for(let e=0;e<n&&!(t.hand.length>=10);e++){if(!t.draw.length){if(!t.discard.length)break;t.draw=t.discard,t.discard=[],Gd(r,t.draw),t.queue.push({t:`reshuffle`})}let e=t.draw.pop();t.hand.push(e),t.queue.push({t:`draw`,uid:e.uid,id:e.id})}}function tf(e,t,n){t.exhaust.push(n),t.queue.push({t:`exhaust`,uid:n.uid}),Nd(e,`verdantBranch`)&&(ef(e,t,1),Kd(t,`verdantBranch`))}function nf(e,t){if(t.over)return;t.turn++;let n=t.player;if(t.queue.push({t:`turn`,n:t.turn}),n.statuses.poison&&(Qd(e,t,n.statuses.poison,{source:`poison`}),n.statuses.poison--,n.statuses.poison||delete n.statuses.poison,t.over))return;n.statuses.barricade||(n.block=0),n.statuses.ritual&&qd(t,n,`str`,n.statuses.ritual);let r=n.energyMax+(n.statuses.energized||0);t.turn===1&&Nd(e,`emberLantern`)&&(r+=1,Kd(t,`emberLantern`)),n.energy=(Nd(e,`frozenCore`)?n.energy:0)+r,t.counters.firstCardPlayed=!1,t.queue.push({t:`energy`,n:n.energy});let i=5;t.turn===1&&Nd(e,`travelersPack`)&&(i+=2,Kd(t,`travelersPack`)),ef(e,t,i)}function rf(e,t,n){let r=kd(n);return r.cost==null?null:Nd(e,`duskmirror`)&&!t.counters.firstCardPlayed?0:r.cost}function af(e,t,n,r){if(t.over)return!1;let i=kd(n);return!(i.unplayable||rf(e,t,n)>t.player.energy||i.target===`enemy`&&(r==null||!t.enemies[r]||t.enemies[r].hp<=0))}function of(e,t,n,r=null){let i=t.hand.findIndex(e=>e.uid===n);if(i<0)return!1;let a=t.hand[i],o=kd(a);if(!af(e,t,a,r))return!1;let s=t.player,c=rf(e,t,a);s.energy-=c,Nd(e,`duskmirror`)&&!t.counters.firstCardPlayed&&o.cost>0&&Kd(t,`duskmirror`),t.counters.firstCardPlayed=!0,t.hand.splice(i,1),t.counters.played++,e.stats.cardsPlayed++,t.queue.push({t:`play`,uid:a.uid,id:a.id,targetIdx:r}),t.queue.push({t:`energy`,n:s.energy});let l=1;o.type===`attack`&&(t.counters.attacks++,Nd(e,`ironTalisman`)&&t.counters.attacks%3==0&&(qd(t,s,`str`,1),Kd(t,`ironTalisman`)),Nd(e,`executionersSeal`)&&t.counters.attacks%10==0&&(l=2,Kd(t,`executionersSeal`)));let u=r==null?null:t.enemies[r],d=()=>t.enemies.filter(e=>e.hp>0);for(let n of o.effects){if(t.over)break;sf(e,t,a,o,n,u,l)}if(!t.over&&o.type===`attack`&&s.statuses.venomous){let e=o.target===`allEnemies`?d():u&&u.hp>0?[u]:[];for(let n of e)qd(t,n,`poison`,s.statuses.venomous)}return!t.over&&Nd(e,`silkFan`)&&t.counters.played%3==0&&($d(t,s,3,!1),Kd(t,`silkFan`)),o.type===`power`?t.queue.push({t:`powerConsumed`,uid:a.uid}):o.exhaust?tf(e,t,a):t.discard.push(a),!0}function sf(e,t,n,r,i,a,o){let s=t.player,c=r.target===`allEnemies`?t.enemies.filter(e=>e.hp>0):a?[a]:[];switch(i.kind){case`dmg`:{let n=i.times||1;for(let a=0;a<n;a++)for(let n of r.target===`allEnemies`?t.enemies.filter(e=>e.hp>0):c){if(t.over)return;Xd(e,t,n,i.n,{mult:o})}break}case`block`:$d(t,s,i.n);break;case`draw`:ef(e,t,i.n);break;case`energy`:s.energy+=i.n,t.queue.push({t:`energy`,n:s.energy});break;case`heal`:Pd(e,i.n,t);break;case`loseHp`:Qd(e,t,i.n,{source:`self`});break;case`status`:if(i.who===`self`)qd(t,s,i.id,i.n);else if(i.who===`allEnemies`)for(let e of t.enemies.filter(e=>e.hp>0))qd(t,e,i.id,i.n);else a&&a.hp>0&&qd(t,a,i.id,i.n);break;case`addCard`:for(let n=0;n<(i.n||1);n++){let n={uid:e.uid++,id:i.id,up:!1,bonus:0};(i.where===`hand`&&t.hand.length<10?t.hand:t.discard).push(n),t.queue.push({t:`addCard`,id:i.id,where:i.where||`discard`})}break;case`special`:cf(e,t,n,r,i,a,o)}}function cf(e,t,n,r,i,a,o){let s=t.player;switch(i.id){case`leech`:{let n=Xd(e,t,a,i.n,{mult:o});n>0&&Pd(e,Math.floor(n/2),t);break}case`execute`:{let n=a.statuses.vulnerable?i.bonus:0;Xd(e,t,a,i.n+n,{mult:o});break}case`momentum`:Xd(e,t,a,i.n+n.bonus,{mult:o}),n.bonus+=i.grow;break;case`phantom`:Xd(e,t,a,i.n*t.hand.length,{mult:o});break;case`devour`:Xd(e,t,a,i.n,{mult:o}),a.hp<=0&&(e.player.maxHp+=i.maxHp,t.player.maxHp+=i.maxHp,t.player.hp+=i.maxHp,t.queue.push({t:`maxHp`,n:i.maxHp}));break;case`doubleBlock`:$d(t,s,s.block,!1);break;case`limitBreak`:s.statuses.str>0&&qd(t,s,`str`,s.statuses.str);break;case`catalyst`:a.statuses.poison&&qd(t,a,`poison`,a.statuses.poison*(i.n-1));break}}function lf(e,t,n,r=null){let i=e.player.potions[n];if(!i)return!1;let a=Ll[i];if(a.combatOnly&&(!t||t.over)||a.needsTarget&&(r==null||!t.enemies[r]||t.enemies[r].hp<=0))return!1;switch(e.player.potions[n]=null,t&&t.queue.push({t:`potion`,id:i}),i){case`healing`:Pd(e,20,t),t||(e.player.hp=Ed(e.player.hp,0,e.player.maxHp));break;case`strength`:qd(t,t.player,`str`,2);break;case`swift`:ef(e,t,3);break;case`block`:$d(t,t.player,12,!1);break;case`fire`:Xd(e,t,t.enemies[r],20,{isAttack:!1});break;case`venom`:qd(t,t.enemies[r],`poison`,7);break;case`energy`:t.player.energy+=2,t.queue.push({t:`energy`,n:t.player.energy});break}return!0}function uf(e,t){if(t.over)return;let n=t.player;t.queue.push({t:`endTurn`});for(let n of[...t.hand]){let r=kd(n);if(r.endTurnDmg&&Qd(e,t,r.endTurnDmg,{source:`burn`}),r.endTurnLoseHp&&Qd(e,t,r.endTurnLoseHp,{source:`burn`}),t.over)return}n.statuses.metallicize&&$d(t,n,n.statuses.metallicize,!1),n.statuses.regen&&Pd(e,n.statuses.regen,t),t.discard.push(...t.hand),t.hand=[],t.queue.push({t:`discardHand`});for(let e of[`vulnerable`,`weak`,`frail`])n.statuses[e]&&(n.statuses[e]--,n.statuses[e]||delete n.statuses[e]);for(let r of t.enemies){if(r.hp<=0||t.over)continue;if(r.statuses.poison){let n=r.statuses.poison;if(r.hp-=n,e.stats.dmgDealt+=n,t.queue.push({t:`hitEnemy`,idx:r.idx,amount:n,blocked:0,hpAfter:Math.max(0,r.hp),dead:r.hp<=0,poison:!0}),r.statuses.poison--,r.statuses.poison||delete r.statuses.poison,r.hp<=0){Zd(e,t,r);continue}}r.block=0;let i=Yd(r);if(t.queue.push({t:`enemyAct`,idx:r.idx,move:r.moveKey,name:i.name}),r.lastMoves.push(r.moveKey),i.dmg!=null){for(let n=0;n<(i.times||1)&&!t.over;n++)Qd(e,t,i.dmg,{source:r.idx,isAttack:!0,attacker:r});i.ramp&&(r.flags.rampBonus=(r.flags.rampBonus||0)+i.ramp)}if(t.over)return;if(i.block&&$d(t,r,i.block,!1),i.heal&&(r.hp=Math.min(r.maxHp,r.hp+i.heal),t.queue.push({t:`heal`,who:r.idx,n:i.heal})),i.fx){for(let e of i.fx)if(e.who===`player`)qd(t,n,e.id,e.n);else if(e.who===`self`)qd(t,r,e.id,e.n);else if(e.who===`allies`)for(let n of t.enemies.filter(e=>e.hp>0))qd(t,n,e.id,e.n)}if(i.addCards)for(let n=0;n<i.addCards.n;n++)t.discard.push({uid:e.uid++,id:i.addCards.id,up:!1,bonus:0}),t.queue.push({t:`addCard`,id:i.addCards.id,where:`discard`});r.statuses.ritual&&qd(t,r,`str`,r.statuses.ritual);for(let e of[`vulnerable`,`weak`])r.statuses[e]&&(r.statuses[e]--,r.statuses[e]||delete r.statuses[e])}t.over||(Jd(e,t),nf(e,t))}function df(e,t){t.over=!0,t.result=`win`,e.player.hp=Ed(t.player.hp,1,e.player.maxHp),Nd(e,`blackBlood`)?(Pd(e,12),Kd(t,`blackBlood`)):Nd(e,`emberHeart`)&&(Pd(e,6),Kd(t,`emberHeart`)),Nd(e,`gravebloom`)&&e.player.hp<=e.player.maxHp*.5&&(Pd(e,10),Kd(t,`gravebloom`)),e.player.hp=Ed(e.player.hp,1,e.player.maxHp),t.queue.push({t:`victory`,perfect:t.counters.hpLost===0})}function ff(e,t){t.over=!0,t.result=`loss`,t.player.hp=0,e.player.hp=0,t.queue.push({t:`defeat`})}function pf(e,t,n=null){let r=e.player,i=t+(r.statuses.str||0);r.statuses.weak&&(i=Math.floor(i*.75));let a=n==null?null:e.enemies[n];return a&&a.statuses.vulnerable&&(i=Math.floor(i*1.5)),Math.max(0,i)}function mf(e,t){let n=e.player,r=t+(n.statuses.dex||0);return n.statuses.frail&&(r=Math.floor(r*.75)),Math.max(0,r)}function hf(e,t){let n=Yd(t);if(n.dmg==null)return null;let r=n.dmg+(t.statuses.str||0)+(t.flags.rampBonus||0);return t.statuses.weak&&(r=Math.floor(r*.75)),e.player.statuses.vulnerable&&(r=Math.floor(r*1.5)),{dmg:Math.max(0,r),times:n.times||1}}function gf(e,t,n,r=null){let i=kd(n),a=t.player,o=r==null?null:t.enemies[r],s=Nd(e,`executionersSeal`)&&i.type===`attack`&&(t.counters.attacks+1)%10==0?2:1,c=e=>{let t=e+(a.statuses.str||0);return a.statuses.weak&&(t=Math.floor(t*.75)),o&&o.statuses.vulnerable&&(t=Math.floor(t*1.5)),Math.max(0,Math.floor(t*s))},l=[],u=0;for(let e of i.effects)e.kind===`dmg`?l.push({dmg:c(e.n),times:e.times||1}):e.kind===`block`?u+=mf(t,e.n):e.kind===`special`&&(e.id===`leech`||e.id===`devour`?l.push({dmg:c(e.n),times:1}):e.id===`execute`?l.push({dmg:c(e.n+(o?.statuses.vulnerable?e.bonus:0)),times:1}):e.id===`momentum`?l.push({dmg:c(e.n+(n.bonus||0)),times:1}):e.id===`phantom`?l.push({dmg:c(e.n*Math.max(0,t.hand.length-+!!t.hand.includes(n))),times:1}):e.id===`doubleBlock`&&(u+=a.block));if(!l.length&&!u)return null;let d=l.reduce((e,t)=>e+t.dmg*t.times,0),f=d,p=!1;if(o){let e=o.block;f=0;for(let t of l)for(let n=0;n<t.times;n++){let n=Math.min(e,t.dmg);e-=n,f+=t.dmg-n}p=f>=o.hp}return{hits:l,total:d,loss:f,lethal:p,block:u}}function _f(e,t,n=!1){let r=Od(e,t,n);return e.player.deck.push(r),r}function vf(e,t){let n=e.player.deck.findIndex(e=>e.uid===t);n>=0&&e.player.deck.splice(n,1)}function yf(e,t){let n=e.player.deck.find(e=>e.uid===t);n&&(n.up=!0)}function bf(e,t){let n=e.player.deck.find(e=>e.uid===t);n&&e.player.deck.push(Od(e,n.id,n.up))}var xf=`spirebound_save_v1`,Sf=`spirebound_stats_v1`;function Cf(e){try{localStorage.setItem(xf,JSON.stringify(e))}catch{}}function wf(){try{let e=localStorage.getItem(xf);if(!e)return null;let t=JSON.parse(e);return t&&t.player&&t.map?t:null}catch{return null}}function Tf(){try{localStorage.removeItem(xf)}catch{}}function Ef(){try{return JSON.parse(localStorage.getItem(Sf))||{runs:0,wins:0,best:0}}catch{return{runs:0,wins:0,best:0}}}function Df(e,t){let n=Ef();n.runs++,t&&n.wins++,n.best=Math.max(n.best,e.act*15+e.floorsClimbed);try{localStorage.setItem(Sf,JSON.stringify(n))}catch{}Tf()}function Of(e,t,n=Ad(e)){let r=[],i=[];for(let a of t){if(a.gold&&(e.player.gold=Math.max(0,e.player.gold+a.gold),a.gold>0&&(e.stats.goldEarned+=a.gold)),a.hp&&(e.player.hp=Ed(e.player.hp+a.hp,1,e.player.maxHp)),a.maxHp&&(e.player.maxHp=Math.max(1,e.player.maxHp+a.maxHp),e.player.hp=Ed(e.player.hp+Math.max(0,a.maxHp),1,e.player.maxHp)),a.heal&&Pd(e,Math.round(e.player.maxHp*a.heal)),a.addCard&&_f(e,a.addCard),a.addRelic){let t=a.addRelic===`random`?Id(e):a.addRelic;t?(Fd(e,t),i.push({relic:t})):(e.player.gold+=50,i.push({text:`You find 50 gold instead.`}))}if(a.potion&&Ld(e,a.potion),a.pickRemove&&r.push(`remove`),a.pickUpgrade&&r.push(`upgrade`),a.pickDuplicate&&r.push(`duplicate`),a.pickCard&&r.push({pickCard:a.pickCard}),a.roll){let t=n(),o=0;for(let s of a.roll)if(o+=s.p,t<o){i.push({text:s.text});let t=Of(e,s.ops,n);r.push(...t.pending),i.push(...t.log);break}}}return{pending:r,log:i}}var kf=0,Af=()=>`g${++kf}`,Y=(e,t,n,r=1)=>`hsla(${e},${t}%,${n}%,${r})`;function jf(e,t,n){return`<defs>
    <linearGradient id="${e}b" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="${Y(t,55,38)}"/><stop offset="0.55" stop-color="${Y(t,50,20)}"/><stop offset="1" stop-color="${Y(t,55,9)}"/>
    </linearGradient>
    <linearGradient id="${e}d" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="${Y(t,45,24)}"/><stop offset="1" stop-color="${Y(t,50,5)}"/>
    </linearGradient>
    ...
    <filter id="${e}f" x="-40%" y="-40%" width="180%" height="180%"><feGaussianBlur stdDeviation="4" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
  </defs>`}var Mf=`stroke="#070a12" stroke-width="3.6" paint-order="stroke" stroke-linejoin="round"`;function Nf(e){return e.replace(/<path(?![^>]*stroke=)(?![^>]*fill="none")([^>]*?)\/>/g,`<path$1 ${Mf}/>`).replace(/<(circle|ellipse)([^>]*fill="url\(#[^"]+[bd]\)"[^>]*?)\/>/g,(e,t,n)=>n.includes(`stroke=`)?e:`<${t}${n} ${Mf}/>`)}function Pf(e=!1){let t=58+Math.random()*84,n=55+Math.random()*80,r=``,i=e?5:3;for(let a=0;a<i;a++){let i=Math.random()*Math.PI*2,a=t,o=n;r+=`M${a.toFixed(1)} ${o.toFixed(1)}`;let s=3+Math.floor(Math.random()*3);for(let t=0;t<s;t++){let t=(e?15:10)*(.6+Math.random());i+=(Math.random()-.5)*1.15,a+=Math.cos(i)*t,o+=Math.sin(i)*t,r+=`L${a.toFixed(1)} ${o.toFixed(1)}`}}return`<g class="crack"><path d="${r}" stroke="#0a0d18" stroke-width="3" fill="none" opacity=".75"/><path d="${r}" stroke="#dfeaff" stroke-width="1.3" fill="none" opacity=".8"/></g>`}var X=(e,t,n,r)=>`<circle class="eye" cx="${e}" cy="${t}" r="${n}" fill="${r}"/><circle cx="${e}" cy="${t}" r="${n*2.2}" fill="${r}" opacity="0.18"/>`,Ff={wisp(e,t,n){return`<g class="breathe">
      <path d="M100 78 q-26 44 -14 74 q6 16 14 26 q8-10 14-26 q12-30 -14-74Z" fill="url(#${e}d)" opacity=".7"/>
      <path d="M78 96 q-20 30 -8 52 M122 96 q20 30 8 52" stroke="${Y(t,40,24)}" stroke-width="7" fill="none" opacity=".6"/>
      ...
      <path d="M36 148 q-10-34 22-50" stroke="${Y(t,35,22)}" stroke-width="6" fill="none"/>
      <path d="M64 108 q20 14 48 6" stroke="${Y(t,30,8)}" stroke-width="5" fill="none" opacity=".7"/>
      ${X(128,74,5.5,n)}${X(112,70,5,n)}
      <path d="M138 92 l16 6 -14 8Z" fill="${Y(t,20,80)}"/>
      ...
      ${X(74,106,6,n)}${X(128,108,7,n)}
      <path d="M60 170 q4 14 -4 18 M140 170 q-2 16 6 18 M100 178 q0 12 -6 16" stroke="${Y(t,36,22)}" stroke-width="7" fill="none" opacity=".8"/>
      ...
      <path d="M76 80 q24 12 48 0 q-2 26 -24 30 q-22-4 -24-30Z" fill="${Y(t,30,4)}"/>
      ${X(88,88,4.5,n)}${X(112,88,4.5,n)}
      <path d="M142 108 l26-38 6 6 -22 40Z" fill="${Y(t,8,70)}" filter="url(#${e}f)"/>
      <path d="M58 110 q-16 20 -8 42" stroke="${Y(t,26,18)}" stroke-width="10" fill="none"/>
    </g>`},plant(e,t,n){let r=``;for(let e=0;e<9;e++){let n=-90+(e-4)*24,i=100+Math.cos(n*Math.PI/180)*62,a=118+Math.sin(n*Math.PI/180)*62;r+=`<path d="M${100+(i-100)*.55} ${118+(a-118)*.55} L${i} ${a} L${100+(i-100)*.62+8} ${118+(a-118)*.62}Z" fill="${Y(t,45,30)}"/>`}return`<g class="breathe">${r}
      <path d="M56 178 q-14-64 44-86 q58 22 44 86 q-22 10 -44 10 q-22 0 -44-10Z" fill="url(#${e}b)"/>
      <path d="M100 96 q30 14 34 52" stroke="${Y(t,40,18)}" stroke-width="6" fill="none" opacity=".7"/>
      <path d="M78 128 q22-12 44 0 q-8 18 -22 18 q-14 0 -22-18Z" fill="${Y(t,30,6)}"/>
      ${X(100,132,7,n)}
      ...
      <ellipse cx="100" cy="84" rx="22" ry="18" fill="${Y(t,30,4)}"/>
      ${X(91,84,4,n)}${X(109,84,4,n)}
      <path d="M48 128 q14-24 30-20 M152 128 q-14-24 -30-20" stroke="${Y(t,32,20)}" stroke-width="12" fill="none"/>
      ...
      ${X(84,88,6,n)}${X(118,88,6,n)}
      <path d="M30 150 q10-30 26-32 M170 150 q-10-30 -26-32" stroke="${Y(t,26,16)}" stroke-width="16" fill="none"/>
      ...
      <path d="M78 120 q22-14 44 0 q-4 34 -22 40 q-18-6 -22-40Z" fill="${Y(t,30,5)}"/>
      <circle cx="100" cy="138" r="16" fill="url(#${e}g)" opacity=".8" class="eye"/>
      ${X(88,108,5,n)}${X(112,108,5,n)}
      <path d="M60 190 q-2-18 8-28 M140 190 q2-18 -8-28" stroke="${Y(t,32,14)}" stroke-width="9" fill="none"/>
      ...
      ${X(86,74,5,n)}${X(112,78,4,n)}
      <path d="M84 96 q14 8 30 2" stroke="${Y(t,22,8)}" stroke-width="4" fill="none"/>
      <path d="M58 116 q-18 26 -10 54 M144 112 q16 28 8 56" stroke="${Y(t,28,18)}" stroke-width="11" fill="none"/>
      <path d="M92 130 l16 4 M88 148 l20 4" stroke="${Y(t,30,26)}" stroke-width="3" opacity=".8"/>
      ...
      ${X(138,32,5,n)}
      <path d="M60 128 l8-12 8 12 M92 124 l8-12 8 12" fill="none" stroke="${Y(t,40,34)}" stroke-width="4"/>
    </g>`},crawler(e,t,n){let r=``;for(let e=0;e<3;e++){let n=56+e*40;r+=`<path d="M${n} 148 q-18 14 -22 40 M${n+16} 148 q18 14 22 40" stroke="${Y(t,30,20)}" stroke-width="7" fill="none"/>`}return`<g class="breathe">${r}
      ...
      ${X(78,118,5,n)}${X(100,112,6.5,n)}${X(122,118,5,n)}
      <path d="M62 148 l-18 18 M138 148 l18 18" stroke="${Y(t,36,30)}" stroke-width="6"/>
      ...
      <path d="M22 98 l-10-16 14 2 6 12Z M178 98 l10-16 -14 2 -6 12Z" fill="${Y(t,40,34)}"/>
      ${X(86,112,5.5,n)}${X(114,112,5.5,n)}
      <path d="M76 152 q24 10 48 0" stroke="${Y(t,30,8)}" stroke-width="4" fill="none"/>
    </g>`},maw(e,t,n){let r=``;for(let e=0;e<6;e++)r+=`<path d="M${56+e*18} 118 l7 16 7-16Z" fill="${Y(t,12,85)}"/>`;for(let e=0;e<5;e++)r+=`<path d="M${66+e*18} 156 l7-14 7 14Z" fill="${Y(t,12,80)}"/>`;return`<g class="breathe">
      <path d="M40 120 q-8-58 60-62 q70 4 62 62 q4 10 -6 12 q10 30 -18 44 q-38 18 -76 0 q-28-14 -18-44 q-10-2 -4-12Z" fill="url(#${e}b)"/>
      <path d="M52 118 q48 14 96 0 q2 26 -14 36 q-34 14 -68 0 q-16-10 -14-36Z" fill="${Y(t,45,5)}"/>
      ${r}
      ${X(76,90,6,n)}${X(126,90,6,n)}
      <g class="hover-float"><path d="M100 58 q-4-26 18-30" stroke="${Y(t,30,26)}" stroke-width="4" fill="none"/><circle cx="121" cy="26" r="7" fill="${n}" filter="url(#${e}f)"/></g>
      ...
      <path d="M100 22 q16 6 14 24 l-28 0 q-2-18 14-24Z" fill="${Y(t,36,28)}"/>
      <path d="M148 60 l6 96 -12 4 -6-98Z" fill="${Y(t,10,72)}" filter="url(#${e}f)"/>
      <path d="M136 60 l30 0 -15 -14Z" fill="${Y(t,16,50)}"/>
      <path d="M54 112 q-14 18 -8 44" stroke="${Y(t,26,18)}" stroke-width="13" fill="none"/>
      ...
      ${X(96,66,4.5,n)}${X(114,66,4.5,n)}
      <path d="M92 84 q10 6 20 0" stroke="${n}" stroke-width="2.5" fill="none" opacity=".8"/>
      <path d="M66 132 q-22 8 -28 30 M136 128 q22 10 26 32" stroke="${Y(t,30,24)}" stroke-width="9" fill="none"/>
    </g>`},leviathan(e,t,n){let r=``;for(let e=0;e<8;e++)r+=`<path d="M${34+e*17} 108 l8 22 8-22Z" fill="${Y(t,14,88)}"/>`;for(let e=0;e<7;e++)r+=`<path d="M${44+e*17} 168 l8-20 8 20Z" fill="${Y(t,14,82)}"/>`;return`<g class="breathe">
      <path d="M22 108 q-10-72 78-76 q88 4 78 76 l8 10 -12 8 q12 38 -22 54 q-52 26 -104 0 q-34-16 -22-54 l-12-8Z" fill="url(#${e}b)"/>
      <path d="M34 106 q66 18 132 0 q4 34 -18 46 q-48 20 -96 0 q-22-12 -18-46Z" fill="${Y(t,50,4)}"/>
      ${r}
      ${X(62,74,8,n)}${X(138,74,8,n)}${X(100,56,5,n)}
      <path d="M10 130 q-8 24 8 40 M190 130 q8 24 -8 40" stroke="${Y(t,34,20)}" stroke-width="10" fill="none"/>
      <path d="M56 34 l10-22 12 18 M122 30 l12-20 10 20" fill="none" stroke="${Y(t,30,26)}" stroke-width="7"/>
      ...
      ${X(88,76,5,n)}${X(114,78,5,n)}
      <path d="M56 108 q-22 16 -26 44 q14-4 22-16 M146 104 q22 18 24 46 q-14-4 -22-16" fill="url(#${e}d)" opacity=".85"/>
      <path d="M40 148 l-8 14 M164 148 l8 14" stroke="${Y(t,34,40)}" stroke-width="4"/>
    </g>`},eye(e,t,n){let r=``;for(let e=0;e<7;e++){let n=-150+e*20,i=100+Math.cos(n*Math.PI/180)*62,a=100+Math.sin(n*Math.PI/180)*62,o=100+Math.cos(n*Math.PI/180)*84,s=100+Math.sin(n*Math.PI/180)*84;r+=`<path d="M${i} ${a} Q${o} ${s} ${o+6} ${s+10}" stroke="${Y(t,34,24)}" stroke-width="6" fill="none"/>`}return`<g class="breathe">${r}
      <circle cx="100" cy="100" r="58" fill="url(#${e}b)"/>
      <circle cx="100" cy="100" r="44" fill="${Y(t,20,88)}"/>
      <circle cx="100" cy="100" r="26" fill="${Y(t,60,30)}"/>
      ...
      <path d="M74 40 l10-22 8 14 8-20 8 20 8-14 10 22Z" fill="${Y(45,70,55)}" filter="url(#${e}f)"/>
      ${X(90,70,4.5,n)}${X(110,70,4.5,n)}
      <circle cx="100" cy="52" r="4" fill="${n}" class="eye"/>
      <path d="M146 78 l4 100 -10 2 -4-100Z" fill="${Y(t,20,60)}"/>
      <circle cx="148" cy="72" r="9" fill="${n}" filter="url(#${e}f)" class="eye"/>
      <path d="M56 110 q-16 22 -10 52" stroke="${Y(t,26,18)}" stroke-width="12" fill="none"/>
    </g>`}};function If(e){let t=Af(),n=Y(e.hue,90,66),r=Nf((Ff[e.kind]||Ff.slime)(t,e.hue,n));return`<svg class="enemy-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${jf(t,e.hue,n)}
    ...
    ${r}
    <g class="cracks"></g>
  </svg>`}function Lf(){let e=Af(),t=`#7fd4ff`;return`<svg class="hero-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ${jf(e,225,t)}
    <ellipse cx="100" cy="192" rx="56" ry="9" fill="#000" opacity=".45"/>
    <ellipse class="innerfire" cx="100" cy="118" rx="58" ry="66" fill="url(#${e}g)" opacity=".12"/>
    ${Nf(`<g class="breathe">
      <path d="M66 188 q-10-70 8-104 q10-20 26-24 q16 4 26 24 q18 34 8 104 q-17 7 -34 7 q-17 0 -34-7Z" fill="url(#${e}b)"/>
      <path d="M74 72 q26-16 52 0 q-4-24 -26-28 q-22 4 -26 28Z" fill="url(#${e}d)"/>
      <path d="M78 78 q22 10 44 0 q-2 24 -22 28 q-20-4 -22-28Z" fill="#0b0e18"/>
      ${X(90,86,4,t)}${X(110,86,4,t)}
      <path d="M144 118 l34-52 7 5 -30 54Z" fill="#cfe6ff" filter="url(#${e}f)"/>
      <path d="M141 124 l14-8 4 8 -12 8Z" fill="${Y(45,60,50)}"/>
      <path d="M56 112 q-14 20 -8 46" stroke="${Y(225,26,20)}" stroke-width="11" fill="none"/>
      <path d="M64 120 q36 18 72 0" stroke="${Y(225,40,30)}" stroke-width="5" fill="none" opacity=".6"/>
    </g>`)}
    <g class="cracks"></g>
  </svg>`}var Rf={strike:`⚔`,defend:`⛨`,eclipseSlash:`☾`,twinFangs:`⑂`,quickSlash:`≫`,heavyBlow:`⬇`,cleave:`⋔`,venomStrike:`☠`,lunge:`➹`,guardedStrike:`⛊`,brace:`⛨`,sidestep:`↯`,preparation:`♻`,deflect:`⛉`,leechBlade:`♆`,tempest:`≋`,uppercut:`⇑`,flurry:`⁂`,executioner:`✠`,momentum:`⤴`,bulwark:`☗`,surge:`✦`,toxicMist:`☁`,cripple:`⛓`,warCry:`♯`,fortify:`⧉`,bloodRite:`♥`,empower:`⚔`,agility:`❥`,ironSkin:`⬡`,regrowth:`❋`,oblivionStrike:`✸`,phantomBlades:`⚚`,devour:`♅`,annihilate:`✹`,aegis:`⛨`,offering:`♱`,limitBreak:`⚡`,catalyst:`⚗`,ascension:`☽`,bastion:`♜`,frenzy:`※`,virulence:`☣`,wound:`✂`,burn:`✹`,hex:`♄`},zf=e=>{let t=9;for(let n of e)t=Math.imul(t^n.charCodeAt(0),387420489);return(t^t>>>9)>>>0};function Bf(e,t){let n=Af(),r=zf(e),i={attack:356,skill:205,power:268,status:160,curse:300}[t]??205,a=(i+30+r%40)%360,o=Y(i,85,66),s=Y(a,80,60),c=r%360,l=``;if(t===`attack`)l=`<path d="M30 120 Q75 40 150 28" stroke="${o}" stroke-width="7" fill="none" opacity=".9"/>
      ...
      <path d="M62 106 L118 50" stroke="${s}" stroke-width="5" opacity=".7"/>`;let u=Rf[e]||`✦`;return`<svg viewBox="0 0 180 150" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <radialGradient id="${n}v" cx="0.5" cy="0.42"><stop offset="0" stop-color="${Y(i,45,22)}"/><stop offset="1" stop-color="${Y(i,50,7)}"/></radialGradient>
    ...
    <text x="90" y="97" text-anchor="middle" font-size="58" fill="${Y(i,30,88)}" opacity=".92" filter="url(#${n}f)" font-family="serif">${u}</text>
  </svg>`}function Vf(e){let t=Af();return`<svg viewBox="0 0 40 52" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function Hf(e=!1){let t=Af();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`}function Uf(){let e=Af();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`}function Wf(){let e=Af();return`<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
    ${jf(e,40,`#ffd166`)}
    ...
    <g class="breathe">
      ...
      ${X(92,76,3.5,`#ffd166`)}${X(108,76,3.5,`#ffd166`)}
  ...
  </svg>`}function Gf(e,t){let n=Af(),r=Y(t,80,66);return`<svg viewBox="0 0 220 160" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <radialGradient id="${n}v" cx="0.5" cy="0.4"><stop offset="0" stop-color="${Y(t,40,24)}"/><stop offset="1" stop-color="${Y(t,45,6)}"/></radialGradient>
  ...
  </svg>`}var Kf={sword:`<path d="M18.5 5 L10 13.5" stroke-width="3"/><path d="M6.8 11.6 L12.4 17.2" stroke-width="2.2"/><path d="M8.6 15.4 L4.8 19.2" stroke-width="2.6"/>`,skull:`<path d="M12 3.2 a6.8 6.8 0 0 1 6.8 6.8 c0 2.6-1.4 4.4-3 5.5 V18.5 h-7.6 V15.5 c-1.6-1.1-3-2.9-3-5.5 A6.8 6.8 0 0 1 12 3.2 Z" fill="currentColor" stroke="none"/><circle cx="9.4" cy="10" r="1.7" fill="rgba(0,0,0,.8)" stroke="none"/><circle cx="14.6" cy="10" r="1.7" fill="rgba(0,0,0,.8)" stroke="none"/><path d="M10.5 20.8 v-2 M13.5 20.8 v-2" stroke-width="1.8"/>`,crown:`<path d="M4.5 17.5 L5.2 8.5 L9 12 L12 6 L15 12 L18.8 8.5 L19.5 17.5 Z" fill="currentColor" stroke="none"/><path d="M4.5 20 h15" stroke-width="2.2"/>`,chest:`<rect x="4" y="6.5" width="16" height="13" rx="2.2" fill="none" stroke-width="2.2"/><path d="M4 12 h16" stroke-width="1.8"/><rect x="10.4" y="10.2" width="3.2" height="4.4" rx="1" fill="currentColor" stroke="none"/>`,flame:`<path d="M12 2.8 C9.4 7.4 6.8 9.8 6.8 13.6 a5.2 5.2 0 0 0 10.4 0 C17.2 9.8 14.6 7.4 12 2.8 Z" fill="currentColor" stroke="none"/><path d="M12 11.4 c-1.7 2.3-1.7 3.9 0 5.4 1.7-1.5 1.7-3.1 0-5.4 Z" fill="rgba(0,0,0,.5)" stroke="none"/>`,coin:`<circle cx="12" cy="12" r="5.6" fill="none" stroke-width="2.2"/><path d="M5.4 5.4 L8 8 M18.6 5.4 L16 8 M5.4 18.6 L8 16 M18.6 18.6 L16 16" stroke-width="2"/>`,shield:`<path d="M12 2.8 L19 5.8 v5.6 c0 4.6-3.1 7.6-7 9.8 -3.9-2.2-7-5.2-7-9.8 V5.8 Z" fill="none" stroke-width="2.3"/><path d="M12 6.4 v11" stroke-width="1.6" opacity=".55"/>`,cloud:`<path d="M7.2 16.5 a3.9 3.9 0 1 1 .7-7.7 A4.9 4.9 0 0 1 17.4 9.6 a3.4 3.4 0 0 1 -.6 6.9 Z" fill="currentColor" stroke="none"/>`,plus:`<path d="M12 5.2 v13.6 M5.2 12 h13.6" stroke-width="3.4"/>`,up:`<path d="M12 4 L19 12 h-4.1 v8 h-5.8 v-8 H5 Z" fill="currentColor" stroke="none"/>`,cards:`<rect x="4.4" y="5.6" width="9.4" height="13.4" rx="1.8" transform="rotate(-8 9 12.5)" fill="none" stroke-width="2"/><rect x="10.6" y="5" width="9.4" height="13.4" rx="1.8" transform="rotate(7 15.5 11.5)" fill="none" stroke-width="2"/>`,hammer:`<rect x="9.6" y="3.4" width="9.6" height="5.4" rx="1.2" transform="rotate(22 14.5 6)" fill="currentColor" stroke="none"/><path d="M11.6 10.2 L5.2 20" stroke-width="2.6"/>`,scissors:`<path d="M7.6 7.6 L17.5 17.8 M16.4 7.6 L6.5 17.8" stroke-width="2.2"/><circle cx="6" cy="19.2" r="2.2" fill="none" stroke-width="1.8"/><circle cx="18" cy="19.2" r="2.2" fill="none" stroke-width="1.8"/>`,question:`<path d="M8.6 8.6 a3.4 3.4 0 1 1 5 3 c-1.1 .7-1.6 1.4-1.6 2.8" fill="none" stroke-width="2.6"/><circle cx="12" cy="18.6" r="1.7" fill="currentColor" stroke="none"/>`},qf=e=>`<g fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">${Kf[e]||``}</g>`;function Jf(e,t=18){return`<svg class="gicon" width="${t}" height="${t}" viewBox="0 0 24 24" aria-hidden="true">${qf(e)}</svg>`}function Yf(e,t=18){let n=t/24;return`<g transform="translate(${-t/2},${-t/2}) scale(${n})">${qf(e)}</g>`}var Xf=null,Zf=null,Qf=null,$f=[],ep=localStorage.getItem(`spirebound_mute`)===`1`;function tp(){if(Xf)return!0;try{Xf=new(window.AudioContext||window.webkitAudioContext),Zf=Xf.createGain(),Zf.gain.value=ep?0:.5,Zf.connect(Xf.destination)}catch{return!1}return!0}function np(){tp()&&Xf.state===`suspended`&&Xf.resume()}function rp(){return ep}function ip(){return ep=!ep,localStorage.setItem(`spirebound_mute`,ep?`1`:`0`),Zf&&Zf.gain.linearRampToValueAtTime(ep?0:.5,Xf.currentTime+.1),ep}function ap(e,t,n,r,i){e.gain.setValueAtTime(1e-4,t),e.gain.exponentialRampToValueAtTime(r,t+n),e.gain.exponentialRampToValueAtTime(1e-4,t+n+i)}function op(e,{type:t=`sine`,a:n=.005,d:r=.2,peak:i=.3,slide:a=0,delay:o=0}={}){if(!tp())return;let s=Xf.currentTime+o,c=Xf.createOscillator(),l=Xf.createGain();c.type=t,c.frequency.setValueAtTime(e,s),a&&c.frequency.exponentialRampToValueAtTime(Math.max(20,e+a),s+n+r),ap(l,s,n,i,r),c.connect(l).connect(Zf),c.start(s),c.stop(s+n+r+.05)}function sp({a:e=.002,d:t=.15,peak:n=.25,f0:r=800,f1:i=300,q:a=1,type:o=`bandpass`,delay:s=0}={}){if(!tp())return;let c=Xf.currentTime+s,l=Math.ceil(Xf.sampleRate*(e+t+.05)),u=Xf.createBuffer(1,l,Xf.sampleRate),d=u.getChannelData(0);for(let e=0;e<l;e++)d[e]=Math.random()*2-1;let f=Xf.createBufferSource();f.buffer=u;let p=Xf.createBiquadFilter();p.type=o,p.Q.value=a,p.frequency.setValueAtTime(r,c),p.frequency.exponentialRampToValueAtTime(Math.max(40,i),c+e+t);let m=Xf.createGain();ap(m,c,e,n,t),f.connect(p).connect(m).connect(Zf),f.start(c),f.stop(c+e+t+.05)}var Z={click:()=>{op(660,{type:`triangle`,d:.05,peak:.12})},hover:()=>{op(880,{type:`sine`,d:.03,peak:.05})},card:()=>{sp({d:.12,f0:1800,f1:500,peak:.14})},draw:()=>{sp({d:.08,f0:2400,f1:900,peak:.08})},slash:()=>{sp({d:.18,f0:3200,f1:300,peak:.3,q:1.4}),op(180,{type:`sine`,d:.12,peak:.25,slide:-120})},hit:()=>{op(120,{type:`sine`,d:.22,peak:.4,slide:-70}),sp({d:.1,f0:500,f1:120,peak:.2,type:`lowpass`})},blocked:()=>{op(320,{type:`square`,d:.08,peak:.1}),sp({d:.1,f0:4e3,f1:2e3,peak:.1,q:6})},block:()=>{op(240,{type:`triangle`,d:.12,peak:.18}),op(360,{type:`triangle`,d:.1,peak:.1,delay:.03})},poison:()=>{op(300,{type:`sine`,d:.2,peak:.14,slide:-160}),sp({d:.22,f0:900,f1:300,peak:.08,q:3})},debuff:()=>{op(420,{type:`sawtooth`,d:.25,peak:.08,slide:-220})},buff:()=>{op(392,{type:`triangle`,d:.14,peak:.14}),op(523,{type:`triangle`,d:.16,peak:.14,delay:.07})},heal:()=>{op(523,{type:`sine`,d:.2,peak:.14}),op(659,{type:`sine`,d:.24,peak:.12,delay:.09}),op(784,{type:`sine`,d:.3,peak:.1,delay:.18})},energy:()=>{op(700,{type:`triangle`,d:.1,peak:.12,slide:300})},coin:()=>{op(988,{type:`square`,d:.06,peak:.08}),op(1319,{type:`square`,d:.12,peak:.08,delay:.06})},potion:()=>{op(500,{type:`sine`,d:.12,peak:.14,slide:300}),sp({d:.14,f0:1200,f1:2600,peak:.06})},death:()=>{op(90,{type:`sawtooth`,d:.5,peak:.22,slide:-50}),sp({d:.4,f0:600,f1:60,peak:.18,type:`lowpass`})},bigDeath:()=>{op(60,{type:`sawtooth`,d:1.1,peak:.32,slide:-30}),sp({d:.9,f0:900,f1:40,peak:.26,type:`lowpass`})},turn:()=>{op(392,{type:`triangle`,d:.1,peak:.1}),op(587,{type:`triangle`,d:.14,peak:.1,delay:.08})},victory:()=>{[523,659,784,1047].forEach((e,t)=>op(e,{type:`triangle`,d:.35,peak:.16,delay:t*.13}))},defeat:()=>{[330,277,220,165].forEach((e,t)=>op(e,{type:`sawtooth`,d:.5,peak:.12,delay:t*.22}))},relic:()=>{[659,831,988].forEach((e,t)=>op(e,{type:`sine`,d:.3,peak:.12,delay:t*.09}))},upgrade:()=>{op(440,{type:`triangle`,d:.15,peak:.14}),op(880,{type:`triangle`,d:.3,peak:.12,delay:.1})},map:()=>{sp({d:.25,f0:500,f1:1500,peak:.06}),op(330,{type:`sine`,d:.2,peak:.08})}},cp=[55,49,41.2];function lp(e){if(!tp())return;up(),Qf=Xf.createGain(),Qf.gain.value=0,Qf.connect(Zf);let t=cp[e]||55,n=Xf.createBiquadFilter();n.type=`lowpass`,n.frequency.value=320,n.Q.value=.6,n.connect(Qf);for(let[e,r,i]of[[1,0,.5],[1.5,3,.22],[2,-4,.3],[3,2,.1]]){let a=Xf.createOscillator(),o=Xf.createGain();a.type=`sawtooth`,a.frequency.value=t*e,a.detune.value=r,o.gain.value=i,a.connect(o).connect(n),a.start(),$f.push(a,o)}let r=Xf.createOscillator(),i=Xf.createGain();r.frequency.value=.07,i.gain.value=90,r.connect(i).connect(n.frequency),r.start(),$f.push(r,i,n),Qf.gain.linearRampToValueAtTime(.11,Xf.currentTime+3)}function up(){if(!Qf)return;let e=Qf,t=$f;e.gain.linearRampToValueAtTime(0,Xf.currentTime+1.2),setTimeout(()=>{t.forEach(e=>{try{e.stop?.()}catch{}try{e.disconnect()}catch{}});try{e.disconnect()}catch{}},1500),Qf=null,$f=[]}var Q={run:null,cb:null,screen:`title`,targeting:null,busy:!1,hoveredCard:null,ce:null,drag:null},dp=new URLSearchParams(location.search).get(`input`),fp=dp?dp===`touch`:matchMedia(`(pointer: coarse)`).matches,pp=dp?dp===`mouse`:matchMedia(`(hover: hover) and (pointer: fine)`).matches,$=(e,t=document)=>t.querySelector(e),mp=(e,t=document)=>[...t.querySelectorAll(e)],hp=e=>new Promise(t=>setTimeout(t,e)),gp=()=>$(`#screen`);function _p(e,t=``,n=``){let r=document.createElement(e);return t&&(r.className=t),n&&(r.innerHTML=n),r}var vp={Vulnerable:Pl.vulnerable.desc,Weak:Pl.weak.desc,Frail:Pl.frail.desc,Poison:Pl.poison.desc,Strength:Pl.str.desc,Dexterity:Pl.dex.desc,Exhaust:`Removed from your deck for the rest of this combat.`,Block:`Prevents damage. Expires at the start of your turn.`,Energy:`Spent to play cards. Refreshes each turn.`,Unplayable:`This card cannot be played.`,Wound:`Unplayable junk card.`,Hex:`Curse: lose 1 HP at end of turn while in hand.`,Burn:`Take 2 damage at end of turn while in hand.`};function yp(){let e=$(`#tooltip`),t=t=>{let n=t._tip;e.innerHTML=`${n.title?`<div class="tt-title">${n.title}</div>`:``}<div class="tt-body">${n.body||``}</div>${n.sub?`<div class="tt-sub">${n.sub}</div>`:``}`,e.style.display=`block`},n=e=>{let t=e;for(;t&&t!==document.body&&!t._tip;)t=t.parentElement;return t&&t._tip?t:null},r=(t,n,r)=>{if(e.style.display!==`block`)return;let i=e.offsetWidth,a=e.offsetHeight;r?(e.style.left=`${Math.max(8,Math.min(innerWidth-i-8,t-i/2))}px`,e.style.top=`${Math.max(8,n-a-26)}px`):(e.style.left=`${Math.min(innerWidth-i-12,t+16)}px`,e.style.top=`${Math.max(8,Math.min(innerHeight-a-12,n-a/2))}px`)};document.addEventListener(`pointerover`,i=>{if(!pp||i.pointerType!==`mouse`)return;let a=n(i.target);a?(t(a),r(i.clientX,i.clientY,!1)):e.style.display=`none`}),document.addEventListener(`pointermove`,e=>{pp&&e.pointerType===`mouse`?r(e.clientX,e.clientY,!1):i&&Math.hypot(e.clientX-a,e.clientY-o)>12&&(clearTimeout(i),i=0)});let i=0,a=0,o=0,s=0;document.addEventListener(`pointerdown`,c=>{if(c.pointerType===`mouse`)return;e.style.display=`none`,clearTimeout(s);let l=n(c.target);l&&(a=c.clientX,o=c.clientY,clearTimeout(i),i=setTimeout(()=>{i=0,t(l),r(a,o,!0)},380))},!0);let c=t=>{t.pointerType!==`mouse`&&(i&&=(clearTimeout(i),0),clearTimeout(s),s=setTimeout(()=>e.style.display=`none`,1700))};document.addEventListener(`pointerup`,c),document.addEventListener(`pointercancel`,c)}function bp(e,t){let n=e.replace(/@(\d+)@/g,(e,n)=>{let r=+n,i=t&&Q.cb?pf(Q.cb,r):r;return`<span class="val ${i>r?`boosted`:i<r?`reduced`:``}">${i}</span>`}).replace(/#(\d+)#/g,(e,n)=>{let r=+n,i=t&&Q.cb?mf(Q.cb,r):r;return`<span class="val ${i>r?`boosted`:i<r?`reduced`:``}">${i}</span>`});return n=n.replace(/\b(Vulnerable|Weak|Frail|Poison|Strength|Dexterity|Exhaust|Block|Energy|Unplayable)\b/g,`<span class="kw">$1</span>`),n}function xp(e,{inCombat:t=!1,size:n=null}={}){let r=kd(e),i=_p(`div`,`card t-${r.type} r-${r.rarity}${e.up?` upgraded`:``}`);n&&i.style.setProperty(`--cw`,`${n}px`),e.uid!=null&&(i.dataset.uid=e.uid);let a=``;if(r.cost!=null){let n=t&&Q.cb?rf(Q.run,Q.cb,e):r.cost;a=`<div class="card-cost ${n===0?`free`:``}">${n}</div>`}let o=bp(r.text,t);return e.bonus&&(o=o.replace(/<span class="val[^"]*">(\d+)<\/span>/,(t,n)=>t.replace(n,+n+e.bonus))),i.innerHTML=`${a}<div class="card-inner">
    <div class="card-art">${Bf(e.id,r.type)}</div>
    <div class="card-name">${r.name}</div>
    <div class="card-type">${r.type}</div>
    <div class="card-text"><span class="ct-inner">${o}</span></div>
    <div class="card-rarity"></div>
  </div>`,mp(`.kw`,i).forEach(e=>e._tip={title:e.textContent,body:vp[e.textContent]||``}),pp&&i.addEventListener(`mousemove`,e=>{let t=i.getBoundingClientRect(),n=(e.clientX-t.left)/t.width,r=(e.clientY-t.top)/t.height,a=$(`.card-inner`,i);a.style.setProperty(`--ry`,`${(n-.5)*16}deg`),a.style.setProperty(`--rx`,`${(.5-r)*12}deg`),a.style.setProperty(`--mx`,`${n*100}%`),a.style.setProperty(`--my`,`${r*100}%`),a.style.setProperty(`--gx`,(n-.5)*60)}),i.addEventListener(`mouseleave`,()=>{let e=$(`.card-inner`,i);e.style.setProperty(`--ry`,`0deg`),e.style.setProperty(`--rx`,`0deg`)}),i}function Sp(){let e=$(`#lantern`);if(!Q.run||Q.screen===`title`||Q.screen===`end`){e.style.setProperty(`--la`,0),e.classList.remove(`gutter`);return}let t=Q.run.player,n=Q.cb&&!Q.cb.over?Q.cb.player.hp:t.hp,r=Math.max(0,Math.min(1,(.68-n/t.maxHp)/.53));e.style.setProperty(`--la`,(r*.82).toFixed(3)),e.style.setProperty(`--lr`,`${Math.round(1500-r*1e3)}px`);let i=`50%`,a=`55%`;if(Q.screen===`combat`&&Q.ce?.hero){let e=xd(Q.ce.hero);i=`${Math.round(e.x)}px`,a=`${Math.round(e.y)}px`}e.style.setProperty(`--lx`,i),e.style.setProperty(`--ly`,a),e.classList.toggle(`gutter`,r>.55)}function Cp(){Sp();let e=$(`#hud`);if(!Q.run||Q.screen===`title`||Q.screen===`end`){e.classList.remove(`show`),document.body.classList.remove(`low-hp`);return}e.classList.add(`show`);let t=Q.run.player,n=Q.cb&&!Q.cb.over?Q.cb.player.hp:t.hp;document.body.classList.toggle(`low-hp`,n/t.maxHp<=.3);let r=jl[Q.run.act];e.innerHTML=`<div class="hud-bar">
      ...
      <div class="hud-mid"><b>${r.name.toUpperCase()}</b> &nbsp;·&nbsp; Act ${Q.run.act+1} &nbsp;·&nbsp; Floor ${Q.run.floorsClimbed} &nbsp;·&nbsp; ${r.bossName}</div>
      <div class="hud-right">
        ${t.potions.map((e,t)=>`<button class="potion-slot ${e?`full`:``}" data-slot="${t}">${e?Vf(Ll[e].tone):``}</button>`).join(``)}
        <button class="icon-btn" data-act="deck">${Jf(`cards`,19)}<span style="font-size:11px">${t.deck.length}</span></button>
        <button class="icon-btn" data-act="menu">≡</button>
      </div>
    </div>
    <div id="relicbar"></div>`;let i=$(`#relicbar`,e);for(let e of t.relics){let t=Fl[e],n=_p(`div`,`relic-chip`,t.glyph);n.style.setProperty(`--tone`,t.tone),n.dataset.relic=e,n._tip={title:t.name,body:t.text,sub:t.rarity},i.appendChild(n)}t.potions.forEach((t,n)=>{if(!t)return;let r=$(`.potion-slot[data-slot="${n}"]`,e);r._tip={title:Ll[t].name,body:Ll[t].text,sub:`Click to use or toss`}}),$(`[data-act="deck"]`,e).onclick=()=>{Z.click(),Mp(`Your Deck`,Q.run.player.deck,{sub:`${Q.run.player.deck.length} cards`})},$(`[data-act="menu"]`,e).onclick=e=>{Z.click(),wp(e.clientX,e.clientY)},mp(`.potion-slot.full`,e).forEach(e=>e.onclick=t=>Dp(+e.dataset.slot,t))}function wp(e,t){Tp();let n=_p(`div`,`pop-menu`);n.innerHTML=`<button data-m="help">How to Play</button><button data-m="mute">${rp()?`Unmute`:`Mute`} Sound</button><button data-m="abandon" style="color:#ff8d8d">Abandon Run</button>`,document.body.appendChild(n),n.style.left=`${Math.min(e,innerWidth-200)}px`,n.style.top=`${t+8}px`,n.onclick=e=>{let t=e.target.dataset.m;Tp(),t===`help`&&Np(),t===`mute`&&ip(),t===`abandon`&&kp()},setTimeout(()=>document.addEventListener(`pointerdown`,Ep,{once:!0}),0)}var Tp=()=>mp(`.pop-menu`).forEach(e=>e.remove()),Ep=e=>{e.target.closest(`.pop-menu`)||Tp()};function Dp(e,t){if(Q.busy)return;Tp();let n=Q.run.player.potions[e];if(!n)return;let r=Ll[n],i=Q.cb&&!Q.cb.over&&Q.screen===`combat`,a=!r.combatOnly||i,o=_p(`div`,`pop-menu`);o.innerHTML=`<button data-m="use" ${a?``:`disabled style="opacity:.4"`}>Use ${r.name}</button><button data-m="toss">Toss it</button>`,document.body.appendChild(o),o.style.left=`${Math.min(t.clientX-60,innerWidth-220)}px`,o.style.top=`${t.clientY+10}px`,o.onclick=async t=>{let n=t.target.dataset.m;if(Tp(),n===`toss`&&(Q.run.player.potions[e]=null,Z.card(),Cp(),Cf(Q.run)),n===`use`&&a)if(r.needsTarget&&i){let t=Q.cb.enemies.filter(e=>e.hp>0);if(t.length===1)return Op(e,t[0].idx);om({kind:`potion`,slot:e})}else Op(e,null)},setTimeout(()=>document.addEventListener(`pointerdown`,Ep,{once:!0}),0)}async function Op(e,t){sm(),Z.potion(),Q.cb&&!Q.cb.over&&Q.screen===`combat`?(lf(Q.run,Q.cb,e,t),await vm(),bm()):(lf(Q.run,null,e,null),Cp(),Cf(Q.run))}function kp(){Ap(`<div class="panel ov-panel" style="text-align:center">
  ...
  </div>`,e=>{e.onclick=e=>{let t=e.target.dataset.a;t===`yes`&&(Df(Q.run,!1),Q.run=null,Q.cb=null,jp(),up(),Fp(`title`)),t===`no`&&jp()}})}function Ap(e,t=null,n=!1){let r=$(`#overlay`);r.innerHTML=e,r.classList.add(`open`),r._closable=n,t&&t(r.firstElementChild)}function jp(){let e=$(`#overlay`);e.classList.remove(`open`),e.innerHTML=``}function Mp(e,t,{sub:n=``,pick:r=null,canSkip:i=!1,skipLabel:a=`Skip`,inCombat:o=!1}={}){let s=_p(`div`,`panel ov-panel`);s.innerHTML=`<div class="ov-title">${e}</div>${n?`<div class="ov-sub">${n}</div>`:``}`;let c=_p(`div`,`card-grid ${r?`choice-cards`:``}`),l=r?t:[...t].sort((e,t)=>kd(e).name.localeCompare(kd(t).name));for(let e of l){let t=xp(e,{inCombat:o});r&&(t.onclick=()=>{Z.click(),t.classList.add(`picked`),setTimeout(()=>{jp(),r(e)},240)}),c.appendChild(t)}s.appendChild(c);let u=_p(`div`,`ov-actions`);if(i&&r){let e=_p(`button`,`btn ghost`,a);e.onclick=()=>{Z.click(),jp(),r(null)},u.appendChild(e)}if(!r){let e=_p(`button`,`btn ghost`,`Close`);e.onclick=()=>{Z.click(),jp()},u.appendChild(e)}s.appendChild(u),Ap(``,null,!r),$(`#overlay`).appendChild(s)}function Np(){Ap(`<div class="panel ov-panel howto">
  ...
  </div>`,e=>{$(`[data-a="ok"]`,e).onclick=()=>{Z.click(),jp()}},!0)}function Pp(){if(pm)return;let e=$(`#wipe`);e.classList.remove(`go`),e.offsetWidth,e.classList.add(`go`),setTimeout(()=>e.classList.remove(`go`),620)}function Fp(e,t){Q.screen!==e&&Q.run&&Pp(),Q.screen=e,Tp(),$(`#tooltip`).style.display=`none`,e!==`map`&&(Lu(),Hu());let n=gp();n.className=``,n.onclick=null,{title:Ip,map:zp,combat:()=>{},reward:Cm,rest:Em,shop:Om,event:Am,treasure:Dm,bossRelic:wm,end:jm}[e](t),Cp()}function Ip(){up(),Ju(0);let e=Ef(),t=wf(),n=gp();n.innerHTML=`<div class="title-screen screen-enter">
    ...
    <div class="title-btns">
      ...
      <button class="btn ghost" data-a="mute">${rp()?`Unmute`:`Mute`} Sound</button>
    </div>
    <div class="title-stats">${e.runs} runs · ${e.wins} victories · deepest climb: floor ${e.best}</div>
  </div>`,n.onclick=e=>{let n=e.target.dataset?.a;n&&(np(),Z.click(),n===`new`&&(t&&Tf(),Lp(Dd())),n===`continue`&&t&&Lp(t,!0),n===`help`&&Np(),n===`mute`&&(ip(),Ip()))}}function Lp(e,t=!1){Q.run=e,Q.cb=null,Ju(e.act);let n=e.nodeId?e.map.nodes.find(t=>t.id===e.nodeId):null;if(Fu(e.act,n?n.row:0),lp(e.act),t||Cf(e),t&&e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);Q.screen=`combat`,Vp(Ud(e,e.pendingCombat,t?t.row:5),e.pendingCombat),Cp();return}Fp(`map`)}var Rp={monster:`sword`,elite:`skull`,event:`question`,rest:`flame`,shop:`coin`,treasure:`chest`,boss:`crown`};function zp(){let e=Q.run;if(e.pendingCombat){let t=e.map.nodes.find(t=>t.id===e.nodeId);Q.screen=`combat`,Vp(Ud(e,e.pendingCombat,t?t.row:5),e.pendingCombat);return}Cf(e),Q.cb=null;let{nodes:t}=e.map,n=new Set(Md(e).map(e=>e.id)),r=new Set(e.map.visited),i=e.nodeId?t.find(t=>t.id===e.nodeId).row:-1,a=``,o=``;for(let e of t)for(let t of e.next){let n=r.has(e.id)&&r.has(t)?`walked`:``;a+=`<path class="medge ${n}" style="--d:${e.row*34}ms" data-a="${e.id}" data-b="${t}" d="M0 0"/>`}for(let i of t){let t=[`mnode`,`type-${i.type}`,r.has(i.id)?`visited`:``,i.id===e.nodeId?`current`:``,n.has(i.id)?`avail`:``].join(` `),a=fp?1.3:1,s=(i.type===`boss`?26:i.type===`elite`||i.type===`treasure`?19:16)*a,c=Math.round((i.type===`boss`?26:i.type===`elite`||i.type===`treasure`?20:17)*a);o+=`<g class="${t}" data-node="${i.id}" style="--d:${i.row*34}ms">
      <g class="nwrap"><circle class="bg" r="${s}"/><g class="icg">${Yf(Rp[i.type],c)}</g></g>
    </g>`}let s=jl[e.act];gp().innerHTML=`
    <div class="map-title">ACT ${e.act+1} — <b>${s.name.toUpperCase()}</b> — ${s.bossName} awaits</div>
    <div class="map-screen screen-enter">
      <svg class="map-svg" width="100%" height="100%">${a}${o}</svg>
      <div class="map-hint">${fp?`drag`:`scroll`} to survey the Spire</div>
    </div>`;let c=$(`.map-svg`),l=!1;c.onclick=e=>{if(l)return;let n=e.target.closest(`.mnode.avail`);!n||Q.busy||(np(),Bp(t.find(e=>e.id===n.dataset.node)))},mp(`.mnode`,c).forEach(r=>{let i=t.find(e=>e.id===r.dataset.node);r._tip={title:{monster:`Monster`,elite:`Elite — beware`,event:`Unknown event`,rest:`Rest site`,shop:`Merchant`,treasure:`Treasure`,boss:jl[e.act].bossName}[i.type],body:n.has(i.id)?`${fp?`Tap`:`Click`} to travel here.`:``}});let u=t.map(t=>({id:t.id,pos:xu(e.act,t)})),d=new Map(mp(`.mnode`,c).map(e=>[e.dataset.node,e])),f=new Set(t.filter(e=>!n.has(e.id)&&!r.has(e.id)).map(e=>e.id)),p=mp(`.medge`,c).map(e=>({p:e,a:e.dataset.a,b:e.dataset.b}));Iu(e.act,Math.max(0,i)),Vu(u,e=>{let t=new Map(e.map(e=>[e.id,e]));for(let[e,n]of d){let r=t.get(e);n.setAttribute(`transform`,`translate(${r.x.toFixed(1)},${r.y.toFixed(1)}) scale(${r.s.toFixed(3)})`),n.style.opacity=(r.fade*(f.has(e)?.4:1)).toFixed(3)}for(let{p:e,a:n,b:r}of p){let i=t.get(n),a=t.get(r),o=9*(i.s+a.s)/2;e.setAttribute(`d`,`M${i.x.toFixed(1)} ${i.y.toFixed(1)} Q${((i.x+a.x)/2).toFixed(1)} ${((i.y+a.y)/2+o).toFixed(1)} ${a.x.toFixed(1)} ${a.y.toFixed(1)}`),e.style.opacity=Math.min(i.fade,a.fade).toFixed(3)}});let m=$(`.map-screen`);m.addEventListener(`wheel`,e=>{e.preventDefault(),Ru(-e.deltaY*.006)},{passive:!1});let h=null,g=0,_=0,v=0;m.addEventListener(`pointerdown`,e=>{e.pointerType!==`mouse`&&(cancelAnimationFrame(_),h=e.clientY,g=0,v=0,l=!1)}),m.addEventListener(`pointermove`,e=>{if(h==null||e.pointerType===`mouse`)return;let t=e.clientY-h;h=e.clientY,v+=Math.abs(t),v>14&&(l=!0),g=t,Ru(t*.014)});let y=e=>{if(h==null||e.pointerType===`mouse`)return;h=null;let t=()=>{g*=.93,!(Math.abs(g)<.5||Q.screen!==`map`)&&(Ru(g*.014),_=requestAnimationFrame(t))};_=requestAnimationFrame(t),setTimeout(()=>l=!1,80)};m.addEventListener(`pointerup`,y),m.addEventListener(`pointercancel`,y)}function Bp(e){let t=Q.run;Z.map(),Fu(t.act,e.row),t.nodeId=e.id,t.floorsClimbed=e.row+1,t.map.visited.push(e.id),Cf(t),e.type===`monster`||e.type===`elite`||e.type===`boss`?(t.pendingCombat=e.type,Cf(t),Vp(Ud(t,e.type,e.row),e.type)):e.type===`rest`?Fp(`rest`):e.type===`shop`?Fp(`shop`):e.type===`treasure`?Fp(`treasure`):e.type===`event`&&Fp(`event`,Hd(t))}function Vp(e,t){if(Lu(),Hu(),$(`#tooltip`).style.display=`none`,Q.screen!==`combat`&&Pp(),Q.cb=Wd(Q.run,e,t),Q.screen=`combat`,Hp(),Cp(),t===`boss`){let e=_p(`div`,`rose-window`,`<div class="rw-rings"></div><div class="rw-spokes"></div>`);gp().appendChild(e),setTimeout(()=>e.remove(),2300);let t=_p(`div`,`turn-banner boss-banner`,Q.cb.enemies[0].name.toUpperCase());gp().appendChild(t),setTimeout(()=>t.remove(),2100),md(`#1a0a20`,.5,.9),Xu(1.6),Z.bigDeath()}vm().then(bm)}function Hp(){let e=Q.cb,t=gp();t.onclick=null,t.innerHTML=`<div class="combat-screen screen-enter intro">
    <div class="stage-ledge" style="--ledge:${`#${jl[Q.run.act].theme.glow.toString(16).padStart(6,`0`)}`}"></div>
    <div class="battlefield">
      <div class="player-zone">
        <div class="hero-wrap">${Lf()}</div>
        <div class="hpbar-wrap"><span class="block-chip zero p-block">${Jf(`shield`,13)} 0</span><div class="hpbar"><div class="ghost"></div><div class="fill"></div></div><span class="hp-label p-hp"></span></div>
        <div class="status-row p-status"></div>
        <div class="name">${Al.name.toUpperCase()}</div>
      </div>
  ...
  </div>`;let n=$(`.enemy-zone`,t),r={enemies:[],root:$(`.combat-screen`,t)};e.enemies.forEach((t,i)=>{let a=Rl[t.key],o=Gp(a,e.enemies.length),s=_p(`div`,`enemy${a.elite?` elite-e`:``}${a.boss?` boss-e`:``}`);s.dataset.idx=i,s.style.animationDelay=`${160+i*130}ms`,s.innerHTML=`<div class="intent"></div>
      <div class="enemy-art" style="width:${o}px;height:${o}px">${If(a.art)}<div class="dmg-preview"></div></div>
      <div class="name">${t.name.toUpperCase()}</div>
      <div class="hpbar-wrap"><span class="block-chip zero">${Jf(`shield`,13)} 0</span><div class="hpbar"><div class="ghost"></div><div class="fill"></div><div class="pv"></div></div><span class="hp-label"></span></div>
      <div class="status-row"></div>`,n.appendChild(s),r.enemies.push({root:s,art:$(`.enemy-art`,s),intent:$(`.intent`,s),fill:$(`.fill`,s),ghost:$(`.ghost`,s),hp:$(`.hp-label`,s),block:$(`.block-chip`,s),statuses:$(`.status-row`,s),pv:$(`.pv`,s),prev:$(`.dmg-preview`,s)}),s.onclick=()=>am(i),s.addEventListener(`pointerenter`,e=>{e.pointerType===`mouse`&&Q.targeting&&(s.classList.add(`target-hover`),rm())}),s.addEventListener(`pointerleave`,()=>{s.classList.remove(`target-hover`),rm()})}),r.pHp=$(`.p-hp`,t),r.pFill=$(`.player-zone .fill`,t),r.pGhost=$(`.player-zone .ghost`,t),r.pBlock=$(`.p-block`,t),r.pStatus=$(`.p-status`,t),r.hero=$(`.hero-wrap`,t),r.energy=$(`.energy-orb`,t),r.endTurn=$(`.end-turn`,t),r.hand=$(`.hand-zone`,t),r.draw=$(`.pile-draw`,t),r.discard=$(`.pile-discard`,t),r.exhaust=$(`.pile-exhaust`,t),Q.ce=r,mm(),setTimeout(()=>r.root.classList.remove(`intro`),1300),r.endTurn.onclick=um,r.draw.onclick=()=>{Z.click(),Mp(`Draw Pile`,e.draw,{sub:`Order hidden — shown alphabetically`,inCombat:!0})},r.discard.onclick=()=>{Z.click(),Mp(`Discard Pile`,e.discard,{inCombat:!0})},r.exhaust.onclick=()=>{Z.click(),Mp(`Exhausted`,e.exhaust,{inCombat:!0})},r.root.addEventListener(`pointerdown`,e=>{e.target.closest(`.enemy`)||e.target.closest(`.card`)||(Q.targeting?sm():Q.hoveredCard!=null&&(Q.hoveredCard=null,Zp()))}),Yp(),Xp()}var Up=e=>xd(Q.ce.enemies[e].art),Wp=()=>xd(Q.ce.hero);function Gp(e,t){let n=Math.min(innerWidth*.31,240),r=(innerWidth-n-innerWidth*.08)/t-12,i=(e.boss?280:e.elite?230:185)*(e.art.size>=1.4?1:e.art.size<.8?.86:.95)*Math.min(e.art.size,1.45);return Math.round(Math.min(i,innerHeight*(e.boss?.34:.3),Math.max(72,r*(e.boss?1.12:1))))}var Kp=0;addEventListener(`resize`,()=>{clearTimeout(Kp),Kp=setTimeout(()=>{let e=Q.cb,t=Q.ce;!e||!t||Q.screen!==`combat`||(e.enemies.forEach((n,r)=>{let i=Gp(Rl[n.key],e.enemies.length);t.enemies[r].art.style.width=t.enemies[r].art.style.height=`${i}px`}),Zp())},120)});function qp(e,t,n){e.innerHTML=``;for(let[n,r]of Object.entries(t)){if(!r)continue;let t=Pl[n]||{name:n,icon:`?`,kind:`buff`,desc:``},i=n===`str`&&r<0?`debuff`:t.kind,a=_p(`span`,`schip ${i}`,`${t.icon} <span class="n">${r}</span>`);a._tip={title:t.name,body:t.desc.replace(/\bN\b/g,r),sub:i===`debuff`?`Debuff`:`Buff`},e.appendChild(a)}}function Jp(e){let t=Q.cb,n=Yd(e),r=hf(t,e),i={attack:Jf(`sword`,19),block:Jf(`shield`,19),buff:Jf(`up`,19),debuff:Jf(`cloud`,19),heal:Jf(`plus`,19)}[n.intent]||Jf(`sword`,19),a=``;n.intent.startsWith(`attack`)&&(i=Jf(`sword`,19),a=r.times>1?`${r.dmg}×${r.times}`:`${r.dmg}`,n.intent===`attack_debuff`&&(i+=Jf(`cloud`,14)),n.intent===`attack_block`&&(i+=Jf(`shield`,14)),n.intent===`attack_buff`&&(i+=Jf(`up`,14)));let o=[];return r&&o.push(`attack for <b>${r.dmg}${r.times>1?`×${r.times}`:``}</b>`),n.block&&o.push(`gain Block`),n.heal&&o.push(`heal itself`),n.fx?.some(e=>e.who===`player`)&&o.push(`afflict you`),n.fx?.some(e=>e.who!==`player`)&&o.push(`empower`),n.addCards&&o.push(`add ${n.addCards.n} ${Ml[n.addCards.id].name}s to your discard`),{icon:i,txt:a,tip:{title:n.name,body:`Intends to ${o.join(`, `)||`act`}.`}}}function Yp(){let e=Q.cb,t=Q.ce;if(!t)return;e.enemies.forEach((e,n)=>{let r=t.enemies[n],i=`${100*Math.max(0,e.hp)/e.maxHp}%`;if(r.fill.style.width=i,r.ghost.style.width=i,r.hp.textContent=`${Math.max(0,e.hp)}/${e.maxHp}`,r.block.classList.toggle(`zero`,e.block<=0),r.block.innerHTML=`${Jf(`shield`,13)} ${e.block}`,r.art.classList.toggle(`warded`,e.block>0),r.root.classList.toggle(`lowhp`,e.hp>0&&e.hp/e.maxHp<=.3),qp(r.statuses,e.statuses,!1),e.hp<=0&&r.root.classList.add(`gone`),e.hp>0&&e.moveKey){let t=Jp(e);r.intent.className=`intent i-${Yd(e).intent}`,r.intent.innerHTML=`<span class="ic">${t.icon}</span>${t.txt}`,r.intent._tip=t.tip}else r.intent.innerHTML=``});let n=e.player,r=`${100*Math.max(0,n.hp)/n.maxHp}%`;t.pFill.style.width=r,t.pGhost.style.width=r,t.pHp.textContent=`${Math.max(0,n.hp)}/${n.maxHp}`,t.pBlock.classList.toggle(`zero`,n.block<=0),t.pBlock.innerHTML=`${Jf(`shield`,13)} ${n.block}`,t.hero.classList.toggle(`warded`,n.block>0),t.hero.classList.toggle(`lowhp`,n.hp/n.maxHp<=.3),qp(t.pStatus,n.statuses,!0),$(`.num`,t.energy).textContent=n.energy,t.energy.classList.toggle(`spent`,n.energy===0);let i=$(`.candles`,t.energy),a=Math.max(n.energyMax,n.energy);i.children.length!==a&&(i.innerHTML=Array.from({length:a},()=>`<span class="candle"></span>`).join(``)),[...i.children].forEach((e,t)=>e.classList.toggle(`lit`,t<n.energy)),$(`.cnt`,t.draw).textContent=e.draw.length,$(`.cnt`,t.discard).textContent=e.discard.length,$(`.cnt`,t.exhaust).textContent=e.exhaust.length}function Xp(){let e=Q.cb,t=Q.ce;if(!t)return;let n=t.hand,r=new Map(mp(`.card`,n).map(e=>[e.dataset.uid,e])),i=new Set(e.hand.map(e=>String(e.uid)));for(let[e,t]of r)i.has(e)||t.remove();for(let t of e.hand)if(r.has(String(t.uid))){let e=xp(t,{inCombat:!0}),n=r.get(String(t.uid));n.replaceChildren(...e.childNodes),n.className=e.className+(n.classList.contains(`armed`)?` armed`:``),n.onclick=e=>{e.stopPropagation(),im(t.uid)},pp&&(n.onmouseenter=()=>{Q.hoveredCard=t.uid,Zp()},n.onmouseleave=()=>{Q.hoveredCard===t.uid&&(Q.hoveredCard=null),Zp()})}else{let e=xp(t,{inCombat:!0});e.classList.add(`draw-in`),setTimeout(()=>e.classList.remove(`draw-in`),400),e.onclick=e=>{e.stopPropagation(),im(t.uid)},pp&&(e.onmouseenter=()=>{Q.hoveredCard=t.uid,Z.hover(),Zp()},e.onmouseleave=()=>{Q.hoveredCard===t.uid&&(Q.hoveredCard=null),Zp()}),$p(e,t.uid),n.appendChild(e)}Zp()}function Zp(){let e=Q.cb,t=Q.ce;if(!t)return;let n=e.hand.map(e=>String(e.uid)),r=new Map(mp(`.card`,t.hand).map(e=>[e.dataset.uid,e])),i=n.length,a=Math.min(112,640/Math.max(i,1),(innerWidth-246)/Math.max(i-1,1));n.forEach((t,n)=>{let o=r.get(t);if(!o)return;let s=e.hand[n],c=!kd(s).unplayable&&(rf(Q.run,e,s)??99)<=e.player.energy;o.classList.toggle(`unplayable-now`,!c);let l=Q.targeting?.kind===`card`&&String(Q.targeting.uid)===t,u=Q.hoveredCard!=null&&String(Q.hoveredCard)===t,d=i>1?(n-(i-1)/2)*Math.min(5,42/i):0,f=(n-(i-1)/2)*a,p=Math.abs(d)*3.2;o.classList.toggle(`armed`,l),l?o.style.transform=`translateX(calc(-50% + ${f*.4}px)) translateY(-150px) scale(1.24)`:u&&!Q.busy?o.style.transform=`translateX(calc(-50% + ${f}px)) translateY(-92px) scale(1.38)`:o.style.transform=`translateX(calc(-50% + ${f}px)) translateY(${p+26}px) rotate(${d}deg)`,o.style.zIndex=u||l?40:20+n}),rm()}var Qp=0;function $p(e,t){e.addEventListener(`pointerdown`,n=>{if(!(Q.busy||!Q.cb||Q.cb.over||!n.isPrimary||Q.drag)){Q.drag={uid:t,id:n.pointerId,x0:n.clientX,y0:n.clientY,live:!1,free:!1};try{e.setPointerCapture(n.pointerId)}catch{}}}),e.addEventListener(`pointermove`,n=>{let r=Q.drag;if(!(!r||r.uid!==t||n.pointerId!==r.id)){if(!r.live){r.y0-n.clientY>26&&tm(r,e);return}r.free?(e.style.transform=`translate(calc(-50% + ${n.clientX-innerWidth/2}px), ${n.clientY-innerHeight+130}px) scale(1.12)`,e.classList.toggle(`will-cast`,n.clientY<em())):(cm(n),nm(n.clientX,n.clientY))}});let n=(n,r)=>{let i=Q.drag;if(!i||i.uid!==t||n.pointerId!==i.id||(Q.drag=null,!i.live))return;if(Qp=performance.now(),e.classList.remove(`dragging`,`will-cast`),r){sm(),Zp();return}if(i.free){n.clientY<em()?lm(t,null):(Q.hoveredCard=null,Zp());return}let a=document.elementFromPoint(n.clientX,n.clientY)?.closest(`.enemy`),o=a?+a.dataset.idx:-1,s=Q.cb.enemies.filter(e=>e.hp>0);o>=0&&Q.cb.enemies[o].hp>0?lm(t,o):s.length===1&&n.clientY<em()?lm(t,s[0].idx):(sm(),Zp())};e.addEventListener(`pointerup`,e=>n(e,!1)),e.addEventListener(`pointercancel`,e=>n(e,!0))}var em=()=>Q.ce?.hand?Q.ce.hand.getBoundingClientRect().top-24:innerHeight-260;function tm(e,t){let n=Q.cb,r=n.hand.find(t=>t.uid===e.uid);if(!r){Q.drag=null;return}let i=kd(r);if(i.unplayable||rf(Q.run,n,r)>n.player.energy){Q.drag=null,t.classList.add(`nope`),setTimeout(()=>t.classList.remove(`nope`),350),Z.debuff();return}e.live=!0,Q.hoveredCard=null,Z.hover(),i.target===`enemy`?om({kind:`card`,uid:e.uid}):(e.free=!0,sm(),t.classList.add(`dragging`))}function nm(e,t){let n=document.elementFromPoint(e,t)?.closest(`.enemy`);Q.ce?.enemies.forEach(e=>e.root.classList.toggle(`target-hover`,e.root===n&&e.root.classList.contains(`targetable`))),rm()}function rm(){let e=Q.ce,t=Q.cb;if(!e||!t)return;let n=null;Q.targeting?.kind===`card`?n=t.hand.find(e=>e.uid===Q.targeting.uid):Q.drag?.live?n=t.hand.find(e=>e.uid===Q.drag.uid):Q.hoveredCard!=null&&!Q.busy&&(n=t.hand.find(e=>e.uid===Q.hoveredCard));let r=n?kd(n):null,i=Q.targeting?.kind===`card`||Q.drag?.live&&!Q.drag.free,a=t.enemies.filter(e=>e.hp>0).length;t.enemies.forEach((o,s)=>{let c=e.enemies[s],l=null,u=!1;if(n&&!t.over&&o.hp>0&&!r.unplayable&&(r.target===`allEnemies`?l=gf(Q.run,t,n,s):r.target===`enemy`&&(i||a===1)&&(l=gf(Q.run,t,n,s),u=i&&a>1&&!c.root.classList.contains(`target-hover`))),l&&l.total>0){let e=l.hits[0],t=l.hits.length===1&&e.times>1?`${e.dmg}×${e.times}`:`${l.total}`;c.prev.innerHTML=l.lethal?`${Jf(`skull`,15)} ${t}`:t,c.prev.classList.add(`show`),c.prev.classList.toggle(`dim`,u),c.prev.classList.toggle(`lethal`,l.lethal),c.root.classList.toggle(`marked`,l.lethal&&!u);let n=Math.min(o.hp,l.loss)/o.maxHp;c.pv.style.left=`${Math.max(0,o.hp-l.loss)/o.maxHp*100}%`,c.pv.style.width=`${n*100}%`,c.pv.classList.add(`show`)}else c.prev.classList.remove(`show`,`lethal`,`dim`),c.root.classList.remove(`marked`),c.pv.classList.remove(`show`)})}function im(e){if(Q.busy||!Q.cb||Q.cb.over||performance.now()-Qp<350)return;let t=Q.cb,n=t.hand.find(t=>t.uid===e);if(!n)return;if(fp&&Q.hoveredCard!==e&&!(Q.targeting?.kind===`card`&&Q.targeting.uid===e)){Q.hoveredCard=e,Z.hover(),Zp();return}let r=kd(n),i=rf(Q.run,t,n),a=$(`.card[data-uid="${e}"]`,Q.ce.hand);if(r.unplayable||i>t.player.energy){a?.classList.add(`nope`),setTimeout(()=>a?.classList.remove(`nope`),350),Z.debuff();return}if(Q.targeting?.kind===`card`&&Q.targeting.uid===e)return sm();if(r.target===`enemy`){let n=t.enemies.filter(e=>e.hp>0);if(n.length===1)return void lm(e,n[0].idx);om({kind:`card`,uid:e})}else lm(e,null)}function am(e){if(!Q.targeting||Q.busy)return;let t=Q.cb.enemies[e];if(!t||t.hp<=0)return;let n=Q.targeting;n.kind===`card`?lm(n.uid,e):n.kind===`potion`&&Op(n.slot,e)}function om(e){if(Q.targeting=e,Q.ce.root.classList.add(`targeting`),Q.cb.enemies.forEach((e,t)=>Q.ce.enemies[t].root.classList.toggle(`targetable`,e.hp>0)),Zp(),document.addEventListener(`pointermove`,cm),cm._last)cm(cm._last);else{let e=Q.cb.enemies.findIndex(e=>e.hp>0);if(e>=0){let t=Up(e);cm({clientX:t.x,clientY:t.y,synthetic:!0})}}}function sm(){Q.targeting=null,$(`#aim`).innerHTML=``,document.removeEventListener(`pointermove`,cm),Q.ce&&(Q.ce.root.classList.remove(`targeting`),Q.ce.enemies.forEach(e=>e.root.classList.remove(`targetable`,`target-hover`)),Zp()),Sp()}function cm(e){if(e.synthetic||(cm._last=e),!Q.targeting)return;let t;if(Q.targeting.kind===`card`){let e=$(`.card[data-uid="${Q.targeting.uid}"]`);t=e?xd(e):{x:innerWidth/2,y:innerHeight-200}}else t={x:innerWidth/2,y:60};let n=e.clientX,r=e.clientY,i=(t.x+n)/2,a=Math.min(t.y,r)-120;if($(`#aim`).innerHTML=`<path d="M${t.x} ${t.y-80} Q${i} ${a} ${n} ${r}" fill="none" stroke="rgba(255,89,100,.85)" stroke-width="4" stroke-dasharray="4 10" stroke-linecap="round"/>
    <circle cx="${n}" cy="${r}" r="9" fill="none" stroke="rgba(255,89,100,.95)" stroke-width="3"/>`,Q.ce?.hero){let e=xd(Q.ce.hero),t=$(`#lantern`);t.style.setProperty(`--lx`,`${Math.round(e.x+(n-e.x)*.3)}px`),t.style.setProperty(`--ly`,`${Math.round(e.y+(r-e.y)*.3)}px`)}}async function lm(e,t){sm(),Q.hoveredCard=null,of(Q.run,Q.cb,e,t)&&(await vm(t),bm())}async function um(){Q.busy||!Q.cb||Q.cb.over||(sm(),Z.click(),uf(Q.run,Q.cb),await vm(),bm())}function dm(e){let t=_p(`div`,`turn-banner`,e);gp().appendChild(t),setTimeout(()=>t.remove(),1150)}function fm(e,t,n,r,{n:i=6,color:a=`#ffe9ac`,size:o=8,dur:s=640,glyph:c=``,cls:l=`flymote`,done:u=null}={}){let d=$(`#floaties`);for(let f=0;f<i;f++){let p=_p(`div`,l,c);p.style.left=`${e}px`,p.style.top=`${t}px`,c?p.style.color=a:(p.style.width=`${o}px`,p.style.height=`${o}px`,p.style.background=`radial-gradient(circle at 35% 30%, #fff, ${a} 55%, transparent 85%)`),d.appendChild(p);let m=(e+n)/2+(Math.random()-.5)*140,h=Math.min(t,r)-50-Math.random()*80,g=p.animate([{transform:`translate(-50%,-50%) scale(0.5)`,opacity:0},{transform:`translate(calc(-50% + ${m-e}px), calc(-50% + ${h-t}px)) scale(1.05)`,opacity:1,offset:.45},{transform:`translate(calc(-50% + ${n-e}px), calc(-50% + ${r-t}px)) scale(0.55)`,opacity:.95}],{duration:s,delay:f*46,easing:`cubic-bezier(.32,.05,.35,1)`});g.onfinish=()=>{p.remove(),f===i-1&&u&&u()}}}var pm=matchMedia(`(prefers-reduced-motion: reduce)`).matches;function mm(){let e=Q.ce,t=Q.cb;e.rig=[];let n=(t,n,r,i,a)=>{let o=$(`svg`,n);if(!o)return;let s=Math.random()*100,c=$(`.breathe`,o);c&&(c.style.animationDuration=`${(2.5+s%1.9).toFixed(2)}s`,c.style.animationDelay=`${(-(s%3.1)).toFixed(2)}s`,c.style.setProperty(`--brY`,(1.022+s%.024).toFixed(3)),c.style.setProperty(`--sw`,`${(s*7%1.7-.85).toFixed(2)}deg`)),mp(`.hover-float`,o).forEach(e=>e.style.animationDelay=`${(-(s%2.7)).toFixed(2)}s`);let l=_p(`div`,`lightpool`);l.style.background=`radial-gradient(ellipse at 50% 50%, ${r}, transparent 72%)`,n.appendChild(l),e.rig.push({root:t,art:n,svg:o,eyes:mp(`.eye`,o),fire:$(`.innerfire`,o),pool:l,seed:s,isHero:i,idx:a,dx:0,dy:0})};t.enemies.forEach((t,r)=>n(e.enemies[r].root,e.enemies[r].art,`hsla(${Rl[t.key].art.hue},90%,66%,.72)`,!1,r)),n(e.hero,e.hero,`rgba(127,212,255,.62)`,!0,0)}function hm(e){requestAnimationFrame(hm);let t=Q.ce,n=Q.cb;if(pm||!n||Q.screen!==`combat`||!t?.rig)return;let r=null,i=n.enemies.findIndex(e=>e.hp>0);Q.targeting&&cm._last?r={x:cm._last.clientX,y:cm._last.clientY}:i>=0&&(r=Up(i));let a=Wp();for(let i of t.rig){let t=i.isHero?n.player:n.enemies[i.idx];if(!i.isHero&&t.hp<=0){i.pool.style.opacity=0;continue}let o=i.isHero?r:a;if(o&&i.eyes.length){let e=xd(i.art),t=Math.atan2(o.y-e.y,o.x-e.x);i.dx+=(Math.cos(t)*2.4-i.dx)*.08,i.dy+=(Math.sin(t)*1.6-i.dy)*.08;let n=`translate(${i.dx.toFixed(2)}px,${i.dy.toFixed(2)}px)`;for(let e of i.eyes)e.style.transform=n}let s=.45+.55*(Math.max(0,t.hp)/t.maxHp);i.root.classList.contains(i.isHero?`lunge`:`acting`)&&(s+=1.1),(t.statuses?.str||0)>0&&(s+=.3);let c=.86+.14*Math.sin(e*.006+i.seed)*Math.sin(e*.0021+i.seed*3);i.fire&&(i.fire.style.opacity=Math.min(.55,(.05+.13*s)*c).toFixed(3)),i.pool.style.opacity=Math.min(.85,(.3+.4*s)*c).toFixed(3)}}var gm=!1;function _m(e,t){let n=e&&$(`.cracks`,e);n&&n.children.length<8&&n.insertAdjacentHTML(`beforeend`,Pf(t))}async function vm(e=null){let t=Q.cb,n=Q.ce;Q.busy=!0,n.endTurn.classList.add(`enemy-phase`);let r=t.queue;for(;r.length;){let t=r.shift();try{await ym(t,e)}catch(e){console.error(`vfx event error`,t,e)}}Q.busy=!1,t.over||n.endTurn.classList.remove(`enemy-phase`),Yp(),Xp(),Cp()}async function ym(e,t){let n=Q.cb,r=Q.ce;switch(e.t){case`turn`:e.n>1&&(dm(`YOUR TURN`),Z.turn()),Yp(),await hp(e.n>1?500:120);break;case`endTurn`:gm=!1,dm(`ENEMY TURN`),await hp(480);break;case`draw`:Xp(),Yp(),Z.draw(),await hp(75);break;case`reshuffle`:{Z.card();let e=xd(r.discard),t=xd(r.draw);fm(e.x,e.y,t.x,t.y,{n:6,cls:`flycard`,dur:520}),yd(t.x,t.y-46,`Reshuffle`,`notice`),await hp(420);break}case`play`:{let i=$(`.card[data-uid="${e.uid}"]`,r.hand);if(Z.card(),gm=!0,i&&t!=null&&n.enemies[t]){let e=i.getBoundingClientRect(),{x:n,y:r}=Up(t),a=i.cloneNode(!0);Object.assign(a.style,{position:`fixed`,left:`${e.left}px`,top:`${e.top}px`,width:`${e.width}px`,height:`${e.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(a),i.remove(),a.animate([{transform:`none`,opacity:1},{transform:`translate(${n-e.left-e.width/2}px,${r-e.top-e.height/2}px) scale(0.22) rotate(14deg)`,opacity:0}],{duration:270,easing:`cubic-bezier(.45,0,.9,.5)`}).onfinish=()=>a.remove()}else i&&(i.classList.add(`played-up`),setTimeout(()=>i.remove(),320));Yp(),await hp(200);break}case`hitEnemy`:{let t=r.enemies[e.idx],{x:n,y:i}=Up(e.idx);if(e.poison)Z.poison(),vd(n,i,`#a3e06c`,14),yd(n,i-20,`${e.amount}`,`poisonf`);else{let a=e.amount>=16;gm&&(r.hero.classList.remove(`lunge`),r.hero.offsetWidth,r.hero.classList.add(`lunge`)),Z.slash(),e.amount>0&&Z.hit(),_d(n,i,a?`#ffd8a0`:`#ffffff`),hd(n,i,{color:`#ff9a6a`,n:a?30:14,speed:a?420:260}),e.blocked>0&&(Z.blocked(),yd(n,i+26,`${Jf(`shield`,19)}${e.blocked}`,`blockedf`),hd(n,i+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`})),e.amount>0?yd(n,i-24,`${e.amount}`,a?`crit`:`dmg`):e.blocked||yd(n,i-24,`0`,`blockedf`),fd(Math.min(4+e.amount*.5,15)),Xu(Math.min(.2+e.amount/26,1)),a&&(pd(70),gd(n,i,`#ffd8a0`,10,620,5)),e.killingBlow&&(pd(e.overkill>=8?130:90),Xu(Math.min(1.6,.6+e.overkill*.06)),gd(n,i,`#ffffff`,8,780,5),e.overkill>=8&&(md(`#ffffff`,.1,.22),hd(n,i,{color:`#fff3d6`,n:18,speed:520,size:2.4,grav:200,kind:`spark`}))),e.amount>0&&_m(t.art,a)}t.root.classList.add(`hurt`),setTimeout(()=>t.root.classList.remove(`hurt`),320),Yp(),await hp(230);break}case`die`:{let t=r.enemies[e.idx],i=n.enemies[e.idx],{x:a,y:o}=Up(e.idx);i.boss&&(document.body.classList.add(`worldstop`),t.root.classList.add(`doomed`),pd(110),await hp(820),document.body.classList.remove(`worldstop`),t.root.classList.remove(`doomed`)),(i.boss||i.elite?Z.bigDeath:Z.death)(),bd(t.art),hd(a,o,{color:`#dfeaff`,n:30,speed:480,size:2.6,grav:340,kind:`spark`}),hd(a,o,{color:`#c9b0ff`,n:26,speed:380,size:3.2,grav:60}),gd(a,o,`#e8dcff`,12,720,6),md(`#ffffff`,i.boss?.24:.1,.3),fd(i.boss?22:12),Xu(i.boss?2:.9),t.root.classList.add(`dying`),setTimeout(()=>{t.root.classList.remove(`dying`),t.root.classList.add(`gone`)},830),await hp(i.boss?900:500);break}case`hitPlayer`:{let{x:t,y:n}=Wp();e.source===`poison`?(Z.poison(),vd(t,n,`#a3e06c`,14)):e.source===`burn`||e.source===`self`?Z.debuff():e.source===`thorns`?Z.blocked():(Z.slash(),e.amount>0&&(Z.hit(),md(`#ff2233`,Math.min(.05+e.amount*.012,.3),.3)),_d(t,n,`#ff8888`)),e.blocked>0&&(Z.blocked(),yd(t,n+30,`${Jf(`shield`,19)}${e.blocked}`,`blockedf`),hd(t,n+8,{color:`#9fd4ff`,n:9,speed:210,size:2,grav:260,kind:`spark`})),e.amount>0?(yd(t,n-30,`${e.amount}`,e.amount>=16?`crit`:`dmg`),fd(Math.min(5+e.amount*.6,18)),Xu(Math.min(.3+e.amount/22,1.2)),_m(r.hero,e.amount>=16)):e.blocked||yd(t,n-30,`0`,`blockedf`),Yp(),Cp(),await hp(240);break}case`blockGain`:{let t=e.who===`player`,{x:n,y:i}=t?Wp():Up(e.who);Z.block(),yd(n,i-10,`${Jf(`shield`,22)} ${e.n}`,`blockf`);let a=t?r.pBlock:r.enemies[e.who].block;a.classList.remove(`pulse`),a.offsetWidth,a.classList.add(`pulse`),Yp(),await hp(140);break}case`status`:{let{x:t,y:n}=e.who===`player`?Wp():Up(e.who),r=Pl[e.id]||{name:e.id,kind:`buff`},i=r.kind===`debuff`||e.id===`str`&&e.n<0;(e.id===`poison`?Z.poison:i?Z.debuff:Z.buff)(),yd(t,n-46,`${e.n>0?`+`:``}${e.n} ${r.name}`,i?`debufff`:`bufff`),i||vd(t,n,`#9fc8ff`,6),Yp(),await hp(170);break}case`heal`:{let{x:t,y:n}=e.who===`player`?Wp():Up(e.who);Z.heal(),vd(t,n,`#8fe8a0`,14),yd(t,n-30,`+${e.n}`,`healf`),Yp(),Cp(),await hp(200);break}case`energy`:Yp(),r.energy.classList.remove(`pop`),r.energy.offsetWidth,r.energy.classList.add(`pop`);break;case`exhaust`:{let t=$(`.card[data-uid="${e.uid}"]`,r.hand);if(t){let e=t.getBoundingClientRect(),n=t.cloneNode(!0);Object.assign(n.style,{position:`fixed`,left:`${e.left}px`,top:`${e.top}px`,width:`${e.width}px`,height:`${e.height}px`,margin:0,transform:`none`,zIndex:56,pointerEvents:`none`}),document.getElementById(`floaties`).appendChild(n),t.remove(),n.animate([{clipPath:`circle(80% at 50% 55%)`,filter:`brightness(1)`},{clipPath:`circle(44% at 50% 55%)`,filter:`brightness(1.8) saturate(1.6) sepia(0.45)`,offset:.45},{clipPath:`circle(0% at 50% 55%)`,filter:`brightness(2.6) saturate(2) sepia(0.85)`}],{duration:540,easing:`ease-in`}).onfinish=()=>n.remove(),hd(e.left+e.width/2,e.top+e.height/2,{color:`#ffb066`,n:22,speed:190,grav:-150,size:2.4,life:.85}),await hp(260)}Yp();break}case`discardHand`:{let e=mp(`.card`,r.hand);e.length&&(Z.card(),e.forEach((e,t)=>{e.animate([{opacity:1},{transform:`${e.style.transform} translateX(340px) rotate(20deg)`,opacity:0}],{duration:260,delay:t*28,easing:`ease-in`}).onfinish=()=>e.remove()}),await hp(280+e.length*28)),Yp();break}case`enemyAct`:{let t=r.enemies[e.idx],{x:n,y:i}=Up(e.idx);t.intent.classList.remove(`telegraph`),t.intent.offsetWidth,t.intent.classList.add(`telegraph`),t.root.classList.add(`acting`),setTimeout(()=>{t.root.classList.remove(`acting`),t.intent.classList.remove(`telegraph`)},650),yd(n,i-90,e.name,`notice`),await hp(620);break}case`intent`:Yp();break;case`addCard`:yd(innerWidth/2,innerHeight*.62,`${Ml[e.id].name} added to ${e.where===`hand`?`hand`:`discard`}`,`notice`),Z.debuff(),Yp(),Xp(),await hp(240);break;case`relicProc`:{let t=$(`.relic-chip[data-relic="${e.id}"]`);t&&(t.classList.remove(`proc`),t.offsetWidth,t.classList.add(`proc`)),await hp(90);break}case`maxHp`:{let{x:t,y:n}=Wp();yd(t,n-60,`+${e.n} MAX HP`,`healf`),Z.buff(),await hp(160);break}case`potion`:Z.potion(),await hp(120);break;case`powerConsumed`:{let t=$(`.card[data-uid="${e.uid}"]`,r.hand),n=t?xd(t):{x:innerWidth/2,y:innerHeight-180},{x:i,y:a}=Wp();fm(n.x,n.y,i,a,{n:7,color:`#c9a8ff`,size:7,dur:560}),Z.buff(),setTimeout(()=>{gd(i,a,`#c9a8ff`,12,460,4),vd(i,a,`#c9a8ff`,8)},560),await hp(300);break}case`victory`:if(Q.lastPerfect=!!e.perfect,await hp(320),Z.victory(),md(`#ffe9ac`,.16,.6),e.perfect){let e=_p(`div`,`turn-banner perfect-banner`,`PERFECT`);gp().appendChild(e),setTimeout(()=>e.remove(),1400),await hp(500)}break;case`defeat`:{await hp(400),Z.defeat(),md(`#300`,.5,1.2);let e=$(`#lantern`);e.classList.add(`gutter`),e.style.setProperty(`--la`,`1`),e.style.setProperty(`--lr`,`160px`),await hp(900);break}}}function bm(){let e=Q.cb;!e||!e.over||(e.result===`win`?xm():Sm())}function xm(){let e=Q.run,t=Q.cb.kind;if(Q.cb=null,e.pendingCombat=null,t===`boss`&&e.act>=2){Df(e,!0),Fp(`end`,{won:!0});return}Fp(`reward`,{kind:t,rewards:zd(e,t)})}function Sm(){Df(Q.run,!1),Fp(`end`,{won:!1})}function Cm({kind:e,rewards:t}){let n=Q.run,r=gp(),i=e===`boss`?`BOSS VANQUISHED`:e===`elite`?`ELITE SLAIN`:`VICTORY`,a=Q.lastPerfect?`<div class="perfect-seal">✦ PERFECT — the glass untouched ✦</div>`:`<div class="ornament">✦ ✦ ✦</div>`;Q.lastPerfect=!1,r.innerHTML=`<div class="center-panel screen-enter"><div class="panel">
  ...
  </div></div>`;let o=$(`.reward-list`,r),s=(e,t,r,i=null)=>{let a=_p(`button`,`reward-row`,`<span class="ric">${e}</span><span>${t}</span>`);return i&&(a._tip=i),a.onclick=()=>{r()!==!1&&(a.classList.add(`taken`),Cf(n),Cp())},o.appendChild(a),a};if(s(`¤`,`<b class="gold-num">${t.gold}</b> gold`,()=>{n.player.gold+=t.gold,n.stats.goldEarned+=t.gold,Z.coin(),requestAnimationFrame(()=>{let e=$(`#hud .gold-num`),n={x:innerWidth/2,y:innerHeight/2-40},r=e?xd(e):{x:120,y:24};fm(n.x,n.y,r.x,r.y,{n:Math.min(9,4+Math.floor(t.gold/12)),color:`#ffd76e`,dur:600,done:()=>Z.coin()})})}),t.potion){let e=Ll[t.potion];s(Vf(e.tone),`${e.name}`,()=>{if(!Ld(n,t.potion))return yd(innerWidth/2,innerHeight/2,`Potion slots full!`,`notice`),!1;Z.potion()},{title:e.name,body:e.text})}if(t.relic){let e=Fl[t.relic];s(`<span style="color:${e.tone};text-shadow:0 0 8px ${e.tone}">${e.glyph}</span>`,`<b>${e.name}</b>`,()=>{Fd(n,t.relic),Z.relic(),requestAnimationFrame(()=>{let n=$(`.relic-chip[data-relic="${t.relic}"]`);if(!n)return;let r=xd(n);fm(innerWidth/2,innerHeight/2-40,r.x,r.y,{n:1,glyph:e.glyph,color:e.tone,dur:680,done:()=>{n.classList.remove(`proc`),n.offsetWidth,n.classList.add(`proc`)}})})},{title:e.name,body:e.text})}s(Jf(`cards`,26),`Add a card to your deck`,()=>(l(t.cards,()=>{}),!1));let c=o.lastElementChild;c.dataset.cardrow=`1`,$(`[data-a="continue"]`,r).onclick=()=>{Z.click(),Cf(n),Fp(e===`boss`?`bossRelic`:`map`)};function l(e,t){Mp(`Choose a Card`,e.map(e=>({id:e,up:!1,uid:null})),{sub:`Add one card to your deck — or skip to keep it lean.`,pick:e=>{e&&(_f(n,e.id),Z.upgrade(),yd(innerWidth/2,innerHeight/2,`${kd(e).name} added`,`notice`)),c.classList.add(`taken`),Cf(n),t()},canSkip:!0})}}function wm(){let e=Q.run,t=Bd(e),n=gp();n.innerHTML=`<div class="center-panel screen-enter"><div class="panel" style="width:min(620px,94vw)">
  ...
  </div></div>`;let r=$(`.big-choices`,n);for(let n of t){let t=Fl[n],i=_p(`button`,`relic-pick`);i.innerHTML=`<span class="relic-chip" style="--tone:${t.tone}">${t.glyph}</span><span><b>${t.name}</b><span class="rd">${t.text}</span></span>`,i.onclick=()=>{Z.relic(),Fd(e,n),Tm()},r.appendChild(i)}let i=_p(`button`,`btn ghost`,`Take none`);i.style.marginTop=`10px`,i.onclick=()=>{Z.click(),Tm()},r.appendChild(i)}function Tm(){let e=Q.run;e.act++,e.nodeId=null,e.map=jd(e),Pd(e,Math.round(e.player.maxHp*.35)),Ju(e.act),Fu(e.act,0),lp(e.act),Cf(e),Fp(`map`),dm(`ACT ${e.act+1}`),Z.victory()}function Em(){let e=Q.run,t=e.player.deck.some(e=>!e.up&&Ml[e.id].up);gp().innerHTML=`<div class="center-panel screen-enter"><div class="panel">
    <div class="ov-title">REST SITE</div>
    <div class="art-lg">${Uf()}</div>
    <div class="ov-sub">The fire crackles. For a moment, the Spire is quiet.</div>
    <div class="big-choices">
      <button class="btn" data-a="rest">${Jf(`flame`,18)} Rest <span style="font-size:13px;opacity:.8">— heal ${Math.round(e.player.maxHp*.3)} HP</span></button>
      <button class="btn" data-a="smith" ${t?``:`disabled`}>${Jf(`hammer`,18)} Smith <span style="font-size:13px;opacity:.8">— upgrade a card</span></button>
    </div>
  </div></div>`,$(`[data-a="rest"]`).onclick=t=>{t.currentTarget.disabled=!0,$(`[data-a="smith"]`).disabled=!0,Z.heal();let n=Pd(e,Math.round(e.player.maxHp*.3));md(`#ff9a4d`,.12,.8),yd(innerWidth/2,innerHeight/2-40,`+${n} HP`,`healf`),vd(innerWidth/2,innerHeight/2,`#8fe8a0`,22),vd(innerWidth/2,innerHeight/2+60,`#ffb066`,16),Cf(e),setTimeout(()=>{Q.screen===`rest`&&Fp(`map`)},900)},$(`[data-a="smith"]`).onclick=()=>{Z.click(),Mp(`Upgrade a Card`,e.player.deck.filter(e=>!e.up&&Ml[e.id].up),{sub:`Forge one card into its + form.`,pick:t=>{t&&(yf(e,t.uid),Z.upgrade(),md(`#ffe9ac`,.12,.4),Mp(`Upgraded!`,[e.player.deck.find(e=>e.uid===t.uid)],{sub:`It gleams with new power.`}),Cf(e),setTimeout(()=>{Q.screen===`rest`&&(jp(),Fp(`map`))},1300))}})}}function Dm(){let e=Q.run;gp().innerHTML=`<div class="center-panel screen-enter"><div class="panel">
    <div class="ov-title">TREASURE</div>
    <div class="art-lg" style="cursor:pointer" data-a="open">${Hf(!1)}</div>
  ...
  </div></div>`;let t=()=>{let t=Id(e,{common:.55,uncommon:.35,rare:.1});$(`.art-lg`).innerHTML=Hf(!0),Z.relic(),md(`#ffe9ac`,.2,.5),hd(innerWidth/2,innerHeight/2,{color:`#ffd97a`,n:36,speed:380,grav:160});let n=$(`.big-choices`);if(t){Fd(e,t);let n=Fl[t];$(`.ov-sub`).innerHTML=`You claim <b style="color:${n.tone}">${n.name}</b> — <i>${n.text}</i>`}else e.player.gold+=60,$(`.ov-sub`).innerHTML=`Only coins remain — <b class="gold-num">+60 gold</b>.`,Z.coin();Cp(),Cf(e),n.innerHTML=``;let r=_p(`button`,`btn`,`Continue`);r.onclick=()=>{Z.click(),Fp(`map`)},n.appendChild(r)};mp(`[data-a="open"]`).forEach(e=>e.onclick=t)}function Om(){let e=Q.run,t=Q.shopData||={};(Q.screen!==`shop`||!t.stock||t.forNode!==e.nodeId)&&(t.stock=Vd(e),t.forNode=e.nodeId);let n=t.stock,r=gp();r.innerHTML=`<div class="center-panel screen-enter"><div class="panel ov-panel" style="width:min(980px,96vw)">
    <div style="display:flex;align-items:center;justify-content:center;gap:18px">
      <div style="width:130px">${Wf()}</div>
  ...
  </div></div>`;let i=$(`.cards-row`,r),a=$(`.misc-row`,r),o=()=>e.player.gold,s=t=>{e.player.gold-=t,Z.coin(),Cf(e),Cp(),c()};function c(){i.innerHTML=``,a.innerHTML=``;for(let t of n.cards){let n=_p(`div`,`shop-item ${t.sold?`sold`:``} ${o()<t.price?`cant`:``}`),r=xp({id:t.id,up:!1,uid:null},{size:138});r.onclick=()=>{if(t.sold||o()<t.price)return Z.debuff();t.sold=!0,_f(e,t.id),s(t.price)},n.appendChild(r),n.appendChild(_p(`div`,`price`,`¤ ${t.price}`)),i.appendChild(n)}for(let t of n.relics){let n=Fl[t.id],r=_p(`div`,`shop-item ${t.sold?`sold`:``} ${o()<t.price?`cant`:``}`),i=_p(`button`,`shop-relic`,`<span class="relic-chip" style="--tone:${n.tone}">${n.glyph}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||o()<t.price)return Z.debuff();t.sold=!0,Fd(e,t.id),Z.relic(),s(t.price)},r.appendChild(i),r.appendChild(_p(`div`,`price`,`¤ ${t.price}`)),a.appendChild(r)}for(let t of n.potions){let n=Ll[t.id],r=_p(`div`,`shop-item ${t.sold?`sold`:``} ${o()<t.price?`cant`:``}`),i=_p(`button`,`shop-relic`,`<span style="width:34px;height:44px">${Vf(n.tone)}</span><b>${n.name}</b>${n.text}`);i.onclick=()=>{if(t.sold||o()<t.price)return Z.debuff();if(!Ld(e,t.id)){yd(innerWidth/2,innerHeight/2,`Potion slots full!`,`notice`);return}t.sold=!0,Z.potion(),s(t.price)},r.appendChild(i),r.appendChild(_p(`div`,`price`,`¤ ${t.price}`)),a.appendChild(r)}let t=_p(`div`,`shop-item ${n.removed?`sold`:``} ${o()<n.removeCost?`cant`:``}`),r=_p(`button`,`shop-relic`,`<span style="width:34px;display:inline-flex;justify-content:center">${Jf(`scissors`,26)}</span><b>Card Removal</b>Remove a card from your deck forever.`);r.onclick=()=>{if(n.removed||o()<n.removeCost)return Z.debuff();Mp(`Remove a Card`,e.player.deck,{sub:`Cut the dead weight.`,pick:t=>{t&&(vf(e,t.uid),n.removed=!0,e.player.gold-=n.removeCost,Z.card(),Cf(e),Cp(),c())},canSkip:!0,skipLabel:`Cancel`})},t.appendChild(r),t.appendChild(_p(`div`,`price`,`¤ ${n.removeCost}`)),a.appendChild(t)}c(),$(`[data-a="leave"]`,r).onclick=()=>{Z.click(),Fp(`map`)}}function km(e,t){let n=Ad(e),r=[],i=[...Nl.common,...Nl.common,...Nl.uncommon,...Nl.uncommon,...Nl.rare],a=0;for(;r.length<t&&a++<60;){let e=i[Math.floor(n()*i.length)];r.includes(e)||r.push(e)}return r}function Am(e){let t=Q.run,n=Bl[e],r=gp();r.innerHTML=`<div class="center-panel screen-enter"><div class="panel event-panel">
    <div class="ov-title">${n.name.toUpperCase()}</div>
    <div class="event-art">${Gf(n.glyph,n.hue)}</div>
    <div class="event-text">${n.text}</div>
    <div class="event-log"></div>
    <div class="event-choices"></div>
  </div></div>`;let i=$(`.event-choices`,r);for(let e of n.choices){let n=_p(`button`,`event-choice`,`<b>${e.label}</b>${e.sub?`<div class="sub">${e.sub}</div>`:``}`);e.needGold&&t.player.gold<e.needGold&&(n.disabled=!0),n.onclick=()=>a(e),i.appendChild(n)}async function a(e){Z.click();let{pending:n,log:a}=Of(t,e.ops);Cp();let s=$(`.event-log`,r),c=[];for(let e of a)e.text&&c.push(e.text),e.relic&&c.push(`Gained <b style="color:${Fl[e.relic].tone}">${Fl[e.relic].name}</b> — <i>${Fl[e.relic].text}</i>`);c.length&&(s.innerHTML=c.join(`<br>`)),i.innerHTML=``;for(let e of n)await o(e);Cf(t),Cp();let l=_p(`button`,`btn`,`Continue`);l.onclick=()=>{Z.click(),Fp(`map`)},i.appendChild(l),!c.length&&!n.length&&!e.ops.length&&Fp(`map`)}function o(e){return new Promise(n=>{if(e===`remove`)Mp(`Remove a Card`,t.player.deck,{sub:`Let it go.`,pick:e=>{e&&(vf(t,e.uid),Z.card()),n()},canSkip:!1});else if(e===`upgrade`){let e=t.player.deck.filter(e=>!e.up&&Ml[e.id].up);if(!e.length)return n();Mp(`Upgrade a Card`,e,{sub:`The forge hungers.`,pick:e=>{e&&(yf(t,e.uid),Z.upgrade()),n()}})}else e===`duplicate`?Mp(`Duplicate a Card`,t.player.deck,{sub:`The mirror remembers.`,pick:e=>{e&&(bf(t,e.uid),Z.upgrade()),n()}}):e.pickCard?Mp(`Choose a Card`,km(t,e.pickCard).map(e=>({id:e,up:!1,uid:null})),{sub:`One page still glows.`,pick:e=>{e&&(_f(t,e.id),Z.upgrade()),n()},canSkip:!0}):n()})}}function jm({won:e}){let t=Q.run;up();let n=t.stats,r=Math.max(1,Math.round((Date.now()-n.start)/6e4)),i=t.act*15+t.floorsClimbed,a=`<div class="stats-grid">
      <div class="stat-cell"><div class="v">${i}</div><div class="k">Floors</div></div>
      <div class="stat-cell"><div class="v">${n.slain}</div><div class="k">Slain</div></div>
      <div class="stat-cell"><div class="v">${n.elites+n.bosses}</div><div class="k">Elites & Bosses</div></div>
      <div class="stat-cell"><div class="v">${t.player.deck.length}</div><div class="k">Deck Size</div></div>
      <div class="stat-cell"><div class="v">${n.dmgDealt}</div><div class="k">Damage Dealt</div></div>
      <div class="stat-cell"><div class="v">${n.dmgTaken}</div><div class="k">Damage Taken</div></div>
      <div class="stat-cell"><div class="v">${n.cardsPlayed}</div><div class="k">Cards Played</div></div>
      <div class="stat-cell"><div class="v">${r}m</div><div class="k">Run Time</div></div>
    </div>`,o=`<div style="display:flex;gap:14px">
      <button class="btn" data-a="deck">View Final Deck</button>
      <button class="btn" data-a="new">New Run</button>
      <button class="btn ghost" data-a="title">Title</button>
    </div>`;if(e){gp().innerHTML=`<div class="end-screen screen-enter">
      ...
      ${a}${o}
    </div>`,Yu(),Z.victory(),md(`#ffe9ac`,.25,1);let e=setInterval(()=>hd(Math.random()*innerWidth,innerHeight*.2,{color:[`#ffd97a`,`#c9b0ff`,`#8fe8a0`][Math.random()*3|0],n:16,speed:300,grav:260,life:1.2}),400);setTimeout(()=>clearInterval(e),4200)}else{let e=Array.from({length:14},()=>`<span class="ember" style="left:${(8+Math.random()*84).toFixed(1)}%;--ex:${((Math.random()-.5)*90).toFixed(0)}px;animation-delay:${(Math.random()*4).toFixed(2)}s;animation-duration:${(3+Math.random()*3).toFixed(2)}s"></span>`).join(``);gp().innerHTML=`<div class="end-screen grave">
      <div class="monument">
        <div class="mon-flame"></div>
        <div class="end-title lose">FALLEN</div>
        <div class="ov-sub" style="font-size:16px">Here ended a climb, on floor ${i}.<br>The Spire keeps what it takes.</div>
        ${a}${o}
      </div>
      <div class="embers">${e}</div>
    </div>`}gp().onclick=e=>{let n=e.target.dataset?.a;n&&(Z.click(),n===`deck`&&Mp(`Final Deck`,t.player.deck,{}),n===`new`&&(Q.run=null,Lp(Dd())),n===`title`&&(Q.run=null,Fp(`title`)))}}function Mm(){yp(),document.addEventListener(`pointerdown`,()=>np(),{once:!0}),document.addEventListener(`contextmenu`,e=>{Q.targeting&&(e.preventDefault(),sm())}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&(Q.targeting?sm():$(`#overlay`).classList.contains(`open`)&&$(`#overlay`)._closable&&jp()),(e.key===`e`||e.key===`E`)&&Q.screen===`combat`&&!Q.busy&&um()}),$(`#overlay`).addEventListener(`pointerdown`,e=>{e.target===$(`#overlay`)&&$(`#overlay`)._closable&&jp()}),window.spirebound={S:Q,E:Sd,startCombatUI:Vp,show:Fp},requestAnimationFrame(hm),Fp(`title`)}Ku(),ld(),Mm();