...
| P5 → P6 FE hand-off HEAD (hardened pin) | `7f01381711879f951ba8c0063bed5bba27dd1177` | Progress-ledger FE tip at harden close; FE fast-forwards to branch HEAD (may be this commit or a later pin-only docs commit) |
