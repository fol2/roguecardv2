...
| Fall phone-landscape FE CSS | `1681b6119dad2124c49982dce2c158867ba5c6bc` | Prior Task 36 Fall tip (superseded for owner package) |
| Owner FAIL remediations | `2a2e0432`…`5c1b39bc` | sceneBg, cards, map keepBg3d, dawn/embark/title layout |
| Capture freeze bound | `6bb2eb213eabfc9a25cda7c61e8bd8827a17d25b` | `fix: bound probe freeze during persistence-plate capture` |
| **P6 capture source** | `6bb2eb213eabfc9a25cda7c61e8bd8827a17d25b` | Clean HEAD for owner re-review package; equals `manifest.sourceSha` |
...
|---|---|
| `sourceSha` | `6bb2eb213eabfc9a25cda7c61e8bd8827a17d25b` |
| `generatedAt` | `2026-07-15T12:04:47.242Z` |
...
- Capture settle **and** `__probe.freeze` both race against 2.5s so intentional persistence-dialog terminals (`dawn-cursor-retry`, `dawn-final-clear-retry`, `usurper-item-save-blocked`, …) remain screenshotable while holding the barrier (`freezeForProbe` otherwise waits forever on barrier idle).
