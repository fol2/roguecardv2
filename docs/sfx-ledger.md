...
| `energy` | Energy gain sample; wired from combat `energy` events | 0.18-0.30s | Candle energy ignites: quick warm flame pop, tiny glass wick ping, clean magical charge. No voice, no music, no melody, no organ, dry game one-shot, silence trimmed. | Very short. Should not overlap heavily with turn cue. |
| `death` | Normal enemy death | 0.55-0.85s | Same shatter family as the signature glass shatter, but a smaller creature death: sharp stained-glass body bursts into shards with a brief ember release, brittle crack and scatter, mid register, dry and short. No voice, no music, no melody, no organ, no gore, dry game one-shot, silence trimmed. | Same family as `shatter`; slightly smaller / shorter than the SHATTER burst. |
| `bigDeath` | Elite / boss death; also boss intro sting when a boss fight starts | 1.10-1.60s | Same shatter family as the signature glass shatter, but much bigger and lower: massive stained-glass body shatters with a deep low brittle crack, heavy shard scatter, thick low-end glass collapse, ember release, denser and lower than normal shatter. No voice, no music, no melody, no choir, no organ, no long reverb, dry game one-shot, silence trimmed. | Same family as `shatter`, but lower = bigger. Also boss-intro sting. |
...
| `victory` | Fight-won SFX sting; BGM `victory` is Act 1/2 boss ceremony + final run-end | 0.90-1.30s | Small combat victory sting: glass shards settle safely, warm lantern flare, brief hopeful shimmer, elegant and restrained. No voice, no music, no melody, no choir, no organ, dry game one-shot, silence trimmed. | Not the final sunrise music. Keep it short. |
