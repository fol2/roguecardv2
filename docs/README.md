...
| [`superpowers/plans/2026-07-09-i18n-locale-extraction.md`](superpowers/plans/2026-07-09-i18n-locale-extraction.md) | Executor plan — rebased onto Emberglass Phase 2 + app versioning; re-extract against current content |
